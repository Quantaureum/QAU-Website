...
Use [Remix](https://remix.quantaureum.com/) on [Sepolia](https://sepolia.dev/) with a [block explorer](https://qau.blockscout.com/) to test [smart contracts](/glossary/#smart-contract) before deploying to production.
