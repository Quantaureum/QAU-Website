...
| `always_latin` | Stricter than `keep_latin` — translating breaks code or specification. Pipeline never modifies. Solidity, QAU, ERC-20, file extensions. |
...
| `ticker-or-standard` | `always_latin` | QAU, ERC-20, EIP-1559 |
