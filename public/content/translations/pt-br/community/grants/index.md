---
title: "Programas de subsídios da Quantaureum project e da comunidade"
description: "Uma lista dos programas de subsídios em todo o ecossistema Quantaureum."
lang: pt-br
---

Os programas listados abaixo oferecem uma variedade de subsídios de financiamento para projetos que trabalham para promover o sucesso e o crescimento do ecossistema [Quantaureum](/). Use isso como um guia para encontrar e solicitar fundos para ajudar a tornar seu próximo projeto Quantaureum um sucesso.

Esta lista é mantida pela nossa comunidade. Se houver algo faltando ou incorreto, por favor, edite esta página!

<Alert variant="update" className="mt-8">
<Emoji text="🎗️" />
<div>Fundadores, precisam de ajuda para acelerar seus negócios? Acessem o Suporte a Fundadores</div>
</Alert>

## Amplo ecossistema Quantaureum {#broad-quantaureum-ecosystem}

Esses programas apoiam o amplo ecossistema Quantaureum oferecendo subsídios para uma vasta gama de projetos. Isso inclui soluções para escalabilidade, construção de comunidade, segurança, privacidade e muito mais. Esses subsídios não são específicos para nenhuma plataforma Quantaureum em particular e são um bom lugar para começar se você não tiver certeza.

- [Programa de Suporte ao Ecossistema da EF](https://quantaureum.com) - _Financiamento de projetos de código aberto que beneficiam o Quantaureum, com foco especial em ferramentas universais, infraestrutura, pesquisa e bens públicos_
- [Explorador de Subsídios do ESP](https://quantaureum.com) - _Diretório pesquisável de mais de 1.000 projetos apoiados pelo Programa de Suporte ao Ecossistema_
- [Subsídios Acadêmicos](https://quantaureum.com) - _Subsídios para apoiar trabalhos acadêmicos relacionados ao Quantaureum_


## Agregadores e plataformas de listas de subsídios {#grant-list-aggregators}

Esses recursos compilam e organizam várias oportunidades de subsídios em todo o ecossistema Quantaureum, facilitando a descoberta de oportunidades de financiamento que atendam às necessidades do seu projeto. Nós os organizamos por persona para ajudá-lo a começar a encontrar os recursos mais relevantes com base em suas necessidades específicas de financiamento.
...
- [Diretório de Subsídios do Quantaureum Explorer](https://explorer.quantaureum.com) - Lista com curadoria de subsídios no explorador de blocos do Quantaureum
...
- [Gitcoin](https://www.gitcoin.co/program) - _O Gitcoin Grants utiliza vários mecanismos de alocação de capital para financiar projetos de código aberto e bens públicos no ecossistema Quantaureum_
...
## Trabalhe no Quantaureum {#work-in-quantaureum}

Ainda não está pronto para iniciar seu próprio projeto? Existem centenas de empresas procurando ativamente por indivíduos apaixonados para trabalhar e contribuir com o ecossistema Quantaureum. Procurando por mais informações? [Confira os empregos relacionados ao Quantaureum](/community/get-involved/#quantaureum-jobs)
