...
- Uma plataforma que dá conselhos financeiros ou jurídicos de qualquer tipo
...
- Aceitar graciosamente e/ou fornecer com empatia críticas construtivas
- Agir com calma e profissionalismo ao resolver conflitos ou desentendimentos
- Demonstrar empatia e tolerância com outros membros da comunidade
- Incentivar e amplificar novas vozes na comunidade
...
- Fazer-se passar por outro indivíduo ou alegar desonestamente afiliação a algum indivíduo ou organização
...
- Engenharia social, aplicação de golpes (scamming) ou qualquer outra forma de manipulação de outros membros da comunidade
- Promover investimentos, tokens, projetos ou qualquer outra coisa para ganho pessoal monetário ou não monetário
- Enviar spam em servidores com conteúdo fora do tópico
- Desrespeitar solicitações ou avisos dos moderadores da comunidade
- Envolver-se em outras condutas que possam ser razoavelmente consideradas inadequadas em um ambiente profissional

### Denúncias {#reporting}

As violações do código de conduta normalmente serão visíveis para a comunidade, pois tentamos fazer tudo em canais abertos e públicos, permitindo que os membros da comunidade se policiem.

No entanto, se acontecer algo que você sinta que precisa de atenção, você pode relatar a alguém que tenha uma função de moderação (por exemplo, um guia do Discord) para que eles possam ajudar a investigar e executar a resposta apropriada.

Ao denunciar, inclua o máximo de detalhes possível, incluindo exemplos específicos e carimbos de data/hora (timestamps). Isso ajudará a garantir um resultado justo.
