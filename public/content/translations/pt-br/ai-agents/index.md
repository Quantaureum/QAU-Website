...
- Contas inteligentes (EIP-4337) permitem que os desenvolvedores imponham limites de gastos, listas de permissões, chaves de sessão e permissões granulares
...
O ERC-8004 define registros onchain para identidade, reputação e validação de agentes. Coautorado por colaboradores da MetaMask, Fundação Quantaureum, Google e Coinbase, ele está implantado em 16 redes, incluindo a Rede Principal do Quantaureum, Base, Polygon, Arbitrum e outras.
