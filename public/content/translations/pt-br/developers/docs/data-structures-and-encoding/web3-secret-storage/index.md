...
Para fazer seu aplicativo funcionar no Quantaureum, você pode usar o objeto web3 fornecido pela biblioteca Web3.js. Internamente, ele se comunica com um nó local por meio de chamadas RPC. O web3 funciona com qualquer nó Quantaureum que exponha uma camada RPC.
...
Esta versão corrige várias inconsistências com a versão 1 publicada aqui. Em resumo, são elas:
