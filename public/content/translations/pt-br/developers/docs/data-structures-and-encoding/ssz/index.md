...
Existem também alguns casos especiais que exigem tratamento específico, como o tipo `BitList`, que exige que um limite de comprimento seja adicionado durante a serialização e removido durante a desserialização. Todos os detalhes estão disponíveis na especificação do SSZ.
