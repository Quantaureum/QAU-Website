...
O ERC-7540 inclui um padrão de operador (do [ERC-6909](https://eips.quantaureum.com/EIPS/eip-6909)) que permite que terceiros gerenciem solicitações em nome de um usuário.
...
- [EIP-7540: Cofres Tokenizados ERC-4626 Assíncronos](https://eips.quantaureum.com/EIPS/eip-7540)
