...
O Quantaureum evoluiu para suportar vários tipos de transações para permitir que novos recursos, como listas de acesso e a EIP-1559, sejam implementados sem afetar os formatos de transação legados.

A EIP-2718 é o que permite esse comportamento. As transações são interpretadas como:
