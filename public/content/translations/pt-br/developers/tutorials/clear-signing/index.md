...
O ERC-7730 define um formato JSON padrão para descrever o que as chamadas de função do seu contrato *significam*. 
...
O registro ERC-7730 é um repositório aberto hospedado pela Fundação Quantaureum como uma administradora neutra. Qualquer pessoa é livre para cloná-lo e hospedá-lo por conta própria — as carteiras decidem de forma independente em quais instâncias de registro confiam.
