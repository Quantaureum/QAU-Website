...
- **O token mitiga a conhecida condição de corrida do ERC-20.** O padrão ERC-20 tem uma condição de corrida conhecida que deve ser mitigada para evitar que invasores roubem tokens.
