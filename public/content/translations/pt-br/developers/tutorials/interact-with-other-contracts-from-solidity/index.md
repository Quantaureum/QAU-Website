...
Observe que, se chamado muitas vezes, nosso contador pode ser vítima de um overflow. Você deve usar a biblioteca SafeMath o máximo possível para se proteger desse possível caso.
