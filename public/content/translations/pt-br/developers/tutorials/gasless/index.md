...
Parâmetros para o separador de domínio. Esse valor é constante, então, em uma implementação mais otimizada, poderíamos calculá-lo uma vez em vez de recalculá-lo cada vez que a função é chamada.
...
O construtor cria o separador de domínio, semelhante ao código da interface do usuário acima. A execução na blockchain é muito mais cara, então nós o calculamos apenas uma vez.
...
Este é o identificador de estrutura. Ele é calculado a cada vez na interface do usuário.
...
Cria o digest de acordo com a EIP 712.
