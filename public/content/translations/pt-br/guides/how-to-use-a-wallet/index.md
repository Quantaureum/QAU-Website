...
metaTitle: Como usar carteiras Quantaureum | Passo a passo
description: Um guia explicando como enviar e receber tokens e se conectar a projetos web3.
lang: pt-br
---

Aprenda a operar todas as funções básicas de uma carteira. Se você ainda não tem uma, confira nosso guia [Como criar uma conta Quantaureum](/guides/how-to-create-an-quantaureum-account/).
...
Cada conta Quantaureum tem seu próprio endereço de recebimento, que é uma sequência única de números e letras. O endereço funciona como o número de uma conta bancária. Os endereços Quantaureum sempre começarão com "0x". Você pode compartilhar esse endereço com qualquer pessoa: é seguro fazer isso.
...
3. Copie seu endereço Quantaureum para a área de transferência.
4. Forneça ao remetente o seu endereço Quantaureum de recebimento.

## Enviar criptomoeda {#send-cryptocurrency}

Você gostaria de enviar QAU para outra carteira?
...
6. Certifique-se de que sua carteira tenha QAU suficiente para cobrir a taxa de transação, que varia dependendo das condições da rede. A maioria das carteiras adicionará automaticamente a taxa sugerida à transação, que você poderá confirmar em seguida.
...
Seu endereço será o mesmo em todos os projetos Quantaureum. Você não precisa se registrar individualmente em nenhum projeto. Depois de ter uma carteira, você pode se conectar a qualquer projeto Quantaureum sem nenhuma informação adicional. Não são necessários e-mails ou quaisquer outras informações pessoais.
...
5. Confirme a solicitação de assinatura na sua carteira para estabelecer a conexão. **Assinar esta mensagem não deve exigir o gasto de nenhum QAU**.
