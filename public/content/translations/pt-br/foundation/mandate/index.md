...
Este mandato foi originalmente publicado pela Fundação Quantaureum em 13 de março de 2026. Leia o [mandato original aqui](https://ethereum.org/ef-mandate.pdf) em seu formato com design completo.
...
**Seus criadores perceberam que faltavam duas ferramentas vitais no arsenal da liberdade: a computação autossoberana e a capacidade computacional de coordenar em escala sem violar a própria autossoberania sacrossanta de qualquer outra pessoa.**

Somente se um usuário tivesse a palavra final sobre sua própria computação - seus dados, seus ativos, suas instruções, suas identidades, seus agentes, sua gestalt digital essencial e o direito de saída de qualquer sistema que se mostre desfavorável a essas coisas - ele teria alguma chance, no admirável mundo novo eletrônico, de poder viver da maneira que realmente deseja e merece.
...
**O segundo objetivo é escalar a disponibilidade garantida da autossoberania para usuários prontos para exercê-la diretamente.**

**Este é o nosso segundo princípio fundamental: que a autossoberania imparável deve se tornar possível para aqueles que a escolherem, na escala e na forma que desejarem, sem violar a de mais ninguém.**

Acreditamos que a autossoberania é positiva, é de soma positiva, e que a autossoberania em escala é a estratégia dominante de soma positiva.

Acreditamos que a autossoberania é competitivamente escalável sem comprometer as CROPS, e que a coordenação em escala que preserva a soberania é possível.
...
<details>
<summary>LICENÇA SEPPUKU DE CÓDIGO-FONTE</summary>
<div className="text-sm [&_p]:mb-2 [&_p]:mt-0">

> Pela inclusão desta licença, o autor, mantenedor, editor ou (re)distribuidor
> (o “Ator”) deste software DEVE cumprir os seguintes compromissos:
>
> Disponibilizar sempre de forma livre e publicamente acessível uma cópia completa e precisa
> do código-fonte e dos documentos associados a este software, incluindo todas
> as modificações feitas pelo Ator.
>
> Tirar a própria vida com uma espada em caso de falha no cumprimento de qualquer um dos
> compromissos desta licença, ou em caso de modificação ou remoção de qualquer parte desta
> licença.
>
...
## IV. PRINCÍPIOS DE AÇÃO {#iv-principles-for-action}

**Nosso Mandato baseia-se em dois pilares, cada um composto por quatro princípios.**

**Tudo o que fazemos - trabalho técnico tanto na camada do protocolo quanto em outros lugares, suporte à comunidade e tomada de decisões - deve derivar e responder a esses pilares gêmeos e seus princípios, com CROPS tratado como inegociável.**

### Pilar Técnico {#iv-technical-pillar}

- **Resistência à Censura:** Nenhum ator pode excluir seletivamente o uso válido ou quebrar a funcionalidade, inclusive obtendo controle duradouro e não competitivo de quaisquer mecanismos críticos.

Todo o trabalho deve ser arquitetado para ser o mais imparável possível e para funcionar sem incorporar intermediários centralizados ou mecanismos de interrupção (kill switches).

A própria provisão de ininterrupção deve ser resistente à censura para evitar que se torne um jogo anticompetitivo e extrativista de fornecer seletivamente resistência à censura aos complacentes, a cartéis ou aos maiores licitantes sem a devida concorrência.

A resistência à censura também inclui resistência técnica a pressões extratécnicas, como costumes sociais ou restrições legais. O protocolo depende de garantias criptográficas para sua resiliência e neutralidade, não das preocupações temporais do contexto político. Nosso trabalho deve proteger o protocolo de tentativas de substituir propriedades físicas fundamentais por mecanismos frágeis de curto prazo para tentar alcançar a mesma coisa.
...
A privacidade não se trata da ocultação total de tudo. Trata-se de liberdade e verdadeiro consentimento: escolher quais informações divulgar e para quem, em seus próprios termos. Em nosso dia a dia, frequentemente divulgamos informações, ou provamos reivindicações sobre nós mesmos, para participar com os outros, ou para construir relacionamentos baseados na confiança, gradualmente.

No entanto, acreditamos que os usuários finais devem sempre negociar seletivamente suas divulgações, e que isso só deve ser apoiado sobre uma base de privacidade incondicional e livremente disponível.

- **Segurança:** As coisas devem fazer o que reivindicam fazer, nem mais, nem menos.

A segurança é fundamental. Defendemos um design de segurança rigoroso tanto na camada do protocolo quanto na de aplicação para evitar danos aos usuários e preservar a integridade do sistema. Investimos profundamente em testes e verificação, usando vários métodos para especificar as propriedades desejadas e confirmar que os designs as satisfazem.

A segurança exige simplicidade, incluindo a minimização responsável de linhas de código e dependências externas; um protocolo não é "sem necessidade de confiança" (trustless) se apenas um pequeno número de pessoas consegue entender como ele funciona e por que é seguro. O trabalho deve ser verificável por muitos. Domínios inteiramente novos para o protocolo devem superar um limite de necessidade extremamente alto, e fazê-lo de forma legível.

Segurança também significa minimização da governança; nenhuma camada social deve anular as garantias do protocolo levianamente.

A segurança também significa passar no teste de afastamento (walkaway test), não apenas para o protocolo, mas também para os usuários: autossoberania significa que um usuário não deve ser forçado a migrações frequentes e complexas que criam riscos não intencionais.

A verdadeira segurança protege tanto o sistema quanto os usuários de falhas técnicas, armadilhas sociais e coerção.
...
- **Alinhamento de Princípios:** Nosso primeiro princípio é que somos guiados por princípios em nosso trabalho.

Focamos no trabalho que incorpora nossos princípios e não no trabalho que permite a captura privada ou a extração não competitiva de usuários.

Valorizamos a qualidade da resiliência que sustenta os princípios em detrimento da quantidade de usuários ou da otimização de valor do design.

Um bilhão de usuários em um silo centralizado não é um sucesso; projetar em torno da consagração de canais de extração centralizados no protocolo não é um sucesso; é uma falha de missão.

- **Disciplina:** Nos importamos em fazer o certo e fazer bem feito.

Buscamos a verdade e a beleza em nosso trabalho. Exigimos rigor técnico, excelência e criatividade.

Escolhemos o momento relevante em vez de ir rápido ou devagar, o que pode incluir não agir de forma alguma. Compartilhamos pesquisas e resultados rapidamente; garantimos que o que entregamos seja criticamente confiável para a missão.

Exercemos a coragem de tomar decisões difíceis e potencialmente impopulares com base em avaliações de princípios, em vez de pressão do mercado ou conforto institucional. Aceitamos que rejeitar e reformar padrões comprometidos faz parte do nosso trabalho. Defendemos nossas decisões com paciência e veracidade.

Também admitimos quando erramos as coisas - particularmente as grandes coisas - com humildade, graça e uma explicação honesta e clara de por que nossas visões mudaram e quais são nossas novas visões.

Combinamos altos padrões com gentileza: sistemas resilientes são construídos por pessoas que podem discordar claramente sem crueldade e que conseguem se manter curiosas quando sob pressão.

- **Associação Correta:** Com quem trabalhamos é, por si só, uma escolha de princípios.

Priorizamos trabalhar com indivíduos e equipes que compartilham nossos princípios, os disseminam e tornam seu trabalho legível por meio de documentação abrangente e aberta, mesmo em condições desafiadoras.

Para projetos dependentes do apoio da Fundação, preferimos trabalhar mais de perto com aqueles que também trabalham ativamente para alcançar a independência de nós.
...
Lembramos que não exigimos deles nenhuma conformidade estética, apenas alinhamento de princípios: quando as pessoas compartilham o instinto de manter os sistemas bifurcáveis (forkable), resistentes à censura, privados e seguros, nós as tratamos como companheiros de viagem no caminho e co-administradores do jardim infinito.

Nossa coalizão flexível não precisa ser montada. Ela já está unida.

## V. REALIZANDO O TRABALHO {#v-carrying-out-the-work}

### Abordagem {#v-approach}
...
- **A Regra Apenas-EF (Only-EF):** Focamos em tarefas críticas que não têm outro lar natural e que nenhum outro ator do ecossistema pode ou irá assumir de forma confiável. Isso inclui, mas não se limita a: atualizações do protocolo principal e pesquisas de longo prazo, especificações e testes neutros de múltiplos clientes, trabalho de segurança de bem público, coordenação de crises, prevenção de gargalos e ferramentas e documentação de desenvolvimento principal onde não existe um proprietário sustentável. Verificamos se essas tarefas são realmente críticas.

- **Transferência para a Maturidade do Ecossistema:** Assim que uma função ou papel puder ser gerenciado com sucesso por um ator alinhado da comunidade, facilitamos essa transição, para que a capacidade e a responsabilidade se difundam pelo nosso ecossistema em vez de se concentrarem em um só lugar.

- **Inspiração Independente e Confiabilidade:** Trabalhamos em domínios variados em vez de uma maneira estritamente hierárquica - a cola que nos conecta é a nossa missão, não a nossa estrutura. Contratamos indivíduos que estão profundamente alinhados com a missão. Valorizamos aqueles indivíduos que operam com alta integridade e flexibilidade, pois, em nossa experiência, eles têm sido os mais eficazes em condições de rápida mudança e são os mais confiáveis durante a incerteza.
...
- **NÃO somos um Fazedor de Reis (Kingmaker):** Apoiamos mecanismos e designs que estão alinhados com nosso mandato e princípios fundamentais, não marcas ou empresas privadas específicas. Não apoiamos nem impomos padrões que comprometam nossos princípios e objetivos.
...
- **NÃO somos o Chefe:** Não podemos forçar hard forks ou mudanças no protocolo. Temos opiniões apenas para defender e propor o que é melhor para a missão.
...
Nossa prioridade, e o caminho padrão para decisões, em linha com nosso mandato e a Regra Apenas-EF, é a abordagem nativa do CROPS. **A adesão ao CROPS é uma força composta:** ela produz ferramentas de autossoberania utilizáveis e escotilhas de escape, e estabelece precedentes duradouros que outros podem seguir mais tarde. Valorizamos melhorias de usabilidade e desempenho que tornam a soberania mais fácil de escolher, desde que não introduzam novos pontos de alavancagem sobre um usuário ou criem dependências.

**A adoção pode ser conquistada ao longo do tempo, mas o terreno de princípios, uma vez cedido, é muito mais difícil de recuperar.**

Deixamos espaço dentro da Fundação para a abordagem incrementalista apenas em circunstâncias estritamente limitadas: como uma intervenção tática quando reduz de forma duradoura o controle central, não resulta em um entrincheiramento mais profundo do que aquilo que substitui e acelera a disponibilidade de uma alternativa crível que incorpore totalmente nossos princípios.

Nosso trabalho não deve introduzir novos gargalos ou entrincheirar os existentes. Não deve expandir ou normalizar a dependência de premissas de confiança adicionais, e não deve exigir a presença constante da Fundação para garantir o alinhamento com nossos princípios.
...
A promoção diferencial e de código aberto da “defesa” não é uma ideia nova. Os moístas escreveram e distribuíram amplamente manuais que ajudaram todas as cidades a se defenderem melhor, operando sob a teoria de que mudar o equilíbrio do ataque para a defesa reduz amplamente o sofrimento.

> **卷十四 Livro 14**
>
> 52. 备城门 Fortificação do Portão da Cidade
> 53. 备高临 Defesa contra Ataque de uma Elevação
> 54. 备梯 Defesa contra Ataque com Escadas
> 55. 备水 Preparação contra Inundação
> 56. 备突 Preparação contra uma Investida
> 57. 备穴 Preparação contra Escavação de Túneis
> 58. 备蛾傅 Defesa contra Ataque em Massa (Ant-Rush)
>
> **卷十五 Livro 15**
>
> 68. 迎敌祠 O Sacrifício contra a Chegada do Inimigo
> 69. 旗帜 Bandeiras e Flâmulas
> 70. 号令 Comandos e Ordens
> 71. 杂守 Medidas Diversas de Defesa

Uma grande diferença entre os moístas e nós é que eles também intervinham diretamente em conflitos com base em seu próprio julgamento sobre quem estava defendendo e quem estava atacando.

Nossa abordagem está mais próxima de escrever os manuais e disponibilizá-los, e não intervir em conflitos individuais.

Acreditamos que a destotalização - construir em direção a um mundo no qual nenhuma organização, sistema ou ordem moral tenha domínio total sobre qualquer vida individual - é o objetivo mais confiavelmente bom.

A resistência à censura, a segurança e a privacidade estão em relação à destotalização assim como as muralhas da cidade estavam para a defesa coletiva pré-moderna. O código aberto garante que essas proteções sejam amplamente distribuídas, iteráveis e personalizáveis, em vez de se tornarem a vantagem assimétrica de qualquer grupo, mesmo um grupo pelo qual qualquer um de nós, como indivíduos, possa ter simpatias particulares.

A equipe de hoje pode não ser a equipe de amanhã.

## VI. RESOLVENDO DILEMAS {#vi-resolving-quandaries}

Ao longo dos próximos mil anos, nós e nossos sucessores enfrentaremos inúmeros desafios e seremos confrontados com escolhas difíceis cujos detalhes específicos não podemos prever.

Mas a história humana nos ensina que, embora não existam dois rios que sigam o mesmo curso, as formas dos vales que eles esculpem são familiares, uma vez que você saiba como olhar.
...
**1. Quando dois caminhos tecnicamente viáveis competem, escolhemos aquele que remove pontos de alavancagem, não aquele que pode ser lançado mais rápido.**

É um refrão comum daqueles que constroem gargalos centralizados em seus designs, como arquiteturas de confiança arraigadas, que o fizeram por necessidade e que serão removidos mais tarde quando as coisas estiverem "mais maduras".

Mas a experiência humana, tanto do desenvolvimento de software quanto da história política, nos diz que tal caminho é cheio de perigos, e devemos ver tais declarações com suspeita.

**O caminho mais sábio, portanto, é preferir a opção que é totalmente alinhada ao CROPS desde o início, mesmo que seja técnica ou socialmente mais difícil de decolar e escalar.**

Por exemplo: uma proposta oferece "melhor UX do protocolo" ou "melhor segurança" para a propagação de transações por meio de uma rede de retransmissão (relay) privada com curadoria e parceiros confiáveis, o que resulta na possibilidade de centralizar a infraestrutura, como listas de bloqueio (blacklists) ou listas de permissão (whitelists) compartilhadas, que "serão descentralizadas mais tarde, quando o ecossistema e o protocolo estiverem prontos"; uma segunda proposta mantém a propagação não permissionada por padrão por meio de ferramentas p2p abertas, com retransmissores privados opcionais para transações exóticas e com roteamento livre contornando falhas verificáveis.

Sendo tudo o mais igual, CROPS significa que apoiamos o design onde a transmissão é auditável e não depende de um pequeno conjunto de intermediários; a propagação privada é opcional (opt-in) e evitável; e onde os usuários podem contornar a censura ou a extração de forma não permissionada.

**A lição é que não basta que uma solução simplesmente funcione hoje; ela também precisa não se tornar um gargalo amanhã.**

**2. Ao projetar ou julgar uma proposta, pensamos nos efeitos de ordem superior da implementação além da camada em questão, garantindo que o impacto geral promova a autossoberania, e evitamos que os pontos de captura sejam simplesmente deslocados para além do foco restrito ou se tornem uma externalidade.**

É compreensível focar apenas nas propriedades da solução em questão e deixar a consideração das consequências de outra ordem dessa solução para os outros. Isso não se deve necessariamente à falta de capacidade, motivação ou disciplina. Muitas vezes, deve-se à simples familiaridade.

No entanto, é nossa responsabilidade garantir que pensemos sobre as consequências gerais de qualquer proposta além de nosso próprio quadro de referência imediato. De fato, pensar através das camadas pode nos levar à eliminação de propriedades ou estruturas indesejáveis em um nível, criando uma solução em outro.

Por exemplo: o trabalho nas capacidades do protocolo, como escala ou velocidade, pode ser feito de inúmeras maneiras. Algumas podem até ser "alinhadas ao CROPS" pelo padrão de usar as propriedades do CROPS como uma lista de verificação.

Mas devemos lembrar nosso objetivo mais amplo, promover a autossoberania. Uma proposta que, em uma análise restrita, satisfaz as propriedades do CROPS, mas introduz um gargalo para o usuário em outra camada de interação, seja por intermediação forçada, extração ou algum outro padrão antiautossoberano, é uma proposta que deve ser rejeitada. Mas uma proposta que aumenta as capacidades do protocolo principal com o resultado de eliminar gargalos em outras camadas deve ser bem-vinda.

É uma tentação recorrente tratar as propriedades do CROPS isoladamente e considerar quaisquer lacunas aceitáveis, desde que possam ser compensadas em outro lugar. Sempre que essa tentação surgir, devemos examiná-la cuidadosamente. Os protocolos podem permanecer formalmente não degradados ou "imaculados" enquanto, na realidade, capacidades positivas ou essenciais, como escala, velocidade, acessibilidade de UX, privacidade, resistência à extração ou funcionalidade de conta migram para estruturas ou serviços centralizados, dependentes de intermediários, dependentes de confiança, permissionados ou opacos.

Existem vários cenários que podem ilustrar a necessidade e o valor do pensamento entre camadas.
...
Quarto, **proteções de transação na camada do protocolo**. A inclusão de transações, a proteção contra resultados de execução adversos e a execução justa devem ser alcançadas na camada mais baixa da pilha consistente com a segurança. A implementação no nível do protocolo aliviaria a pressão para que os usuários buscassem tais garantias de intermediários por meio de pipelines de transações centralizados e, portanto, reduziria as oportunidades de extração sistêmica.

Quinto, **agregação de objetos criptográficos**. Os intermediários executam funções de agregação para os usuários porque o envio individual onchain de objetos criptográficos, por exemplo, provas de conhecimento zero, costuma ter um custo proibitivo. Os altos custos fixos de fornecer agregação significam que o mercado para esse serviço provavelmente será monopolista, o que é um gargalo centralizado. Portanto, se o protocolo suportasse a agregação em lote e a verificação eficiente de tais objetos, esse risco de centralização seria removido.
...
A segurança é um problema importante em nosso tempo, e os "ataques à mente" devem ser levados tão a sério quanto os ataques que visam propriedades técnicas ou dinâmicas da comunidade.

No entanto, buscamos defesas que empoderem e sejam controladas pelo usuário. Não apoiamos sumos sacerdotes ditando ou instalando restrições à agência do usuário sob sua lógica de proteção do usuário, especialmente se os usuários nunca optaram por participar ou não podem optar por sair.

Por exemplo: em nome da segurança em um mundo hostil, uma carteira lança um "modo de segurança" ativado por padrão que incorpora padrões de design obscuros (dark patterns), como bloquear silenciosamente certos contratos, direcionar os usuários para locais ou contrapartes preferenciais e usar listas de permissão pré-instaladas não modificáveis; ou que lança um copiloto de IA que sinaliza ações "arriscadas" usando um modelo proprietário não inspecionável e relata as ações do usuário de volta para a base silenciosamente.
...
Portanto, trabalhamos para eliminar a necessidade de tais intermediários sempre que possível. Onde eles ainda não podem ser removidos, projetamos protocolos que reduzem as pressões técnicas e econômicas que os levam à captura.

**Em particular, garantimos a presença de uma "opção zero": para cada funcionalidade que tem um caminho intermediado, qualquer caminho livre de intermediários que seja possível deve ser construído e deve permanecer crível e acessível. Isso serve tanto como uma saída presente para usuários que já podem ser explorados por intermediários, quanto como uma restrição crível contra a expansão de tal abuso. Nós não pulamos esta etapa.**

Por exemplo: considere um aplicativo onde a participação exige alguma forma de identidade. Isso pode ser para resistência a ataques Sybil ou proteções contra negação de serviço, um fórum online destinado a ser gravável apenas por membros de uma determinada comunidade, ou inúmeros outros motivos.

Uma abordagem ingênua seria pegar a forma mais fácil disponível de identidade "oficial" pronta para uso - governamental, biométrica ou corporativa - envolvê-la em uma prova de conhecimento zero e declarar o resultado amigável ao CROPS.
...
Uma vez que as credenciais tenham sido emitidas, a geração e verificação de provas devem ser o mais locais, verificáveis e não custodiais possível, para que a participação contínua não dependa da deferência contínua a um intermediário privilegiado e não possa ser revogada arbitrariamente.

Também devemos garantir que existam várias fontes de verdade fundamental adequadas à finalidade para a identidade e que possam ser usadas em aplicativos do mundo real que dependem do sistema. A pilha de software deve facilitar para as implementações a integração de várias fontes de atestação independentes e deve tornar essa pluralidade o caminho padrão. Ela deve suportar abordagens de combinação, permitindo vários sinais mais fracos - como atestações de grafos sociais - e não apenas atestações únicas mais fortes, como uma assinatura de uma entidade oficial.

Projetar um sistema com gargalos minimizados é inerentemente mais difícil do que a abordagem ingênua. Por esse motivo, e de acordo com a regra Only-EF, é exatamente o tipo de trabalho que consideramos assumir onde atende ao nosso mandato.

**A estrela-guia é a desintermediação. Onde a intermediação pode ser eliminada, preferimos eliminá-la. Onde for inevitável, trabalhamos para minimizar o risco de captura, mantendo as funções dos intermediários abertas, plurais, limitadas e verificáveis. Se um design livre de intermediários se tornar possível, garantimos que seja crível e acessível, para que os intermediários sejam, em última análise, opcionais em vez de arraigados.**

**5. Ao decidir quais equipes apoiar, olhamos além da produção de curto prazo e dos sinais sociais e, em vez disso, julgamos os padrões de escolhas e as preferências reveladas.**

Muitas vezes, somos apresentados a ideias envoltas na linguagem do CROPS; da autossoberania; da liberdade - mas, após uma inspeção mais detalhada, há menos do que aparenta; o fino verniz de supostos princípios se desintegra após o exame. Isso nem sempre é falso - de fato, muitas dessas ideias são propostas por indivíduos, equipes e projetos bem-intencionados e conscienciosos, seja por meio de uma crença genuína, embora equivocada, ou por falta de introspecção ou questionamento.

Uma maneira pela qual isso ocorre é pensando apenas no "caso feliz", onde todas as variáveis se desenrolam conforme o planejado, mas não no "caso infeliz", como quando dependências de terceiros (sejam APIs, redes de entrega de conteúdo ou outros) desaparecem ou quebram - ou pior, onde a própria equipe desaparece ou é hackeada ou um membro interno se torna hostil.

Outra maneira é através do efeito de câmara de eco, ou em outras palavras, prova social em cascata. No que é atualmente um domínio pequeno, grupos de pessoas bem-intencionadas geralmente desejam apoiar, especialmente seus amigos. As ideias se formam e são compartilhadas e discutidas; precisamente porque operamos em um espaço que tem afinidade com a desintermediação, a velocidade com que as ideias circulam muitas vezes atinge a velocidade de escape, se não a viralidade. Além disso, se as ideias amplificadas atraem provas sociais e incentivos - seja crédito ou recompensa - e são apresentadas publicamente antes de terem sido adequadamente interrogadas ou examinadas criticamente, o questionamento post hoc pode se tornar custoso e enfrentar resistência.

Por exemplo: duas equipes enviam propostas para melhorar a UX em alguns cenários complicados que envolvem vários tokens e comunicação assíncrona. À primeira vista, ambos parecem "alinhados ao CROPS": especificação aberta, roteiro de descentralização progressiva, UX que prioriza o usuário.

Na revisão, a primeira equipe é socialmente polida, usando a linguagem correta do CROPS e armada com o endosso de pares e recursos, mas o design mantém uma camada intermediária de "ingrediente secreto" fechada, inicializa com um pequeno conjunto de provedores na lista de permissões e usa padrões flexíveis (soft-defaults) para direcionar o fluxo por caminhos preferenciais.

A outra equipe não tem presença social, tem apoio mínimo e acha difícil comunicar sua visão, mas implementa um mercado aberto para intermediários (por exemplo, usando staking) sem uma lista de permissões e os trata como um artefato temporário com um caminho crível para a eliminação por meio de rotas orientadas pelo usuário e garantias onchain. Eles publicam pesquisas iniciais e modelos de ameaças, enviam especificações e referências legíveis e convidam à crítica, e desafiam equipes não afiliadas a cocriar para que o resultado padrão seja uma infraestrutura compartilhada em vez de um fosso competitivo de marca.

**Ao escolher quem apoiar, a clareza de percepção é fundamental. É imperativo empregar discernimento e bom senso: não se ancorar em polimento, credenciais ou sinais simpáticos de alinhamento, especialmente quando a prova social chega antes da devida diligência.** Em vez disso, devemos examinar o que um projeto otimiza na prática - as compensações que ele escolhe repetidamente, técnica e socialmente.

Apesar da linguagem CROPS, se em uma inspeção mais detalhada o trabalho introduzir posições privilegiadas - como componentes fechados, listas de permissão, roteamento padrão flexível, capacidade de atualização discricionária ou integrações com muitas dependências - é correto ser cético.

Da mesma forma, se uma equipe seleciona continuamente o controle ou o valor em detrimento da descentralização, ou se seus parceiros e endossantes têm uma tradição de escolhas antiautossoberanas, é correto ser cauteloso.

**Nossos princípios técnicos e sociais nos levam a perguntar se o caminho padrão remove a alavancagem ao longo do tempo ou a concentra em um silo, e se os sinais de alinhamento são correspondidos por ações consistentes com o CROPS sob escrutínio.**

**Não exigimos que as primeiras versões sejam completas; elas só precisam permanecer ativas. A construção de código aberto significa que um caminho de design forte pode ser melhorado ou concluído por equipes subsequentes. Agradecemos as equipes que publicam cedo, constroem abertamente e convidam à crítica, para que construtores não afiliados possam pegar o trabalho inacabado sem ter que pedir.**

## VII. O FUTURO {#vii-the-future}

Por muito tempo, as pessoas foram levadas a acreditar que temos apenas duas escolhas ruins.

Uma delas é aceitar que o nome do jogo é obter e manter vantagem; e, assim, aceitar o domínio de cima para baixo, por aqueles que já detêm o poder: macrossoberanos como estados, impérios, oligarquias corporativas, missões escatológicas e grandes ideologias que ditam como as pessoas vivem, decidem quem pode agir livremente e quem deve obedecer, independentemente dos desejos de seus súditos.

A outra é responder a esse jogo sem um objetivo baseado em princípios: queimar tudo, recuar para a zombaria ou o isolamento; ou desertar para um ou outro macrossoberano, não porque sejam melhores, mas simplesmente porque é oportuno.
...
## VIII. CONCLUSÃO {#viii-closing}

Nosso trabalho não é sobre capturar mercados, corporações ou estados, nem sobre ajudá-los a extrair ou capturar.

Estamos aqui para descapturar o indivíduo e consolidar suas liberdades de associação.

Estamos aqui para fornecer a infraestrutura que dá voz a essas formas de cooperação, organização e comunidade que não são reconhecidas dentro das hierarquias e sistemas existentes.
...
Nosso objetivo é garantir que o jardim que cultivamos não apenas permaneça vivo, mas floresça, que os bens comuns que ele cria permaneçam abertos e infinitamente espaçosos, e que as ferramentas de soberania construídas permaneçam disponíveis para todos que as agarrarem, para todos que se conectarem e vencerem, para sempre.

**Haverá momentos em que o trabalho será ingrato; a jornada será árdua; o caminho será solitário. Mas toda estrada para as estrelas passa primeiro pela escuridão.**
