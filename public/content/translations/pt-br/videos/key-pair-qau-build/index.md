---
title: "Par de chaves — QAU.BUILD"
description: "Uma demonstração de pares de chaves públicas e privadas usando a ferramenta educacional QAU.BUILD. Entenda como os pares de chaves criptográficas protegem as contas Quantaureum e permitem a assinatura de transações."
lang: pt-br
...
breadcrumb: "Pares de chaves (QAU.BUILD)"
---

Um tutorial de **Austin Griffith** demonstrando como os pares de chaves públicas e privadas funcionam usando a ferramenta de programação visual QAU.BUILD, cobrindo a geração de chave privada, derivação de chave pública, assinatura de mensagem e recuperação de assinatura.
