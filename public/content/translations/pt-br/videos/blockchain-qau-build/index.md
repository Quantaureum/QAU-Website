...
Um tutorial de **Austin Griffith** demonstrando como a mineração de blockchain funciona usando a ferramenta de programação visual QAU.BUILD. Austin aborda o consenso de Prova de Trabalho (PoW), encadeamento de blocos, dificuldade de mineração, recompensas de bloco e imutabilidade da cadeia.
...
Bom dia, feliz Sexta-feira da Gravata Borboleta! Este QAU.BUILD está focado em blockchain — uma coisa muito legal. Estamos neste barco de palhaço, com nossa gravata borboleta do Bitcoin para isso. Aqui vamos nós.
...
Certo, feliz Sexta-feira da Gravata Borboleta! Isso foi blockchain no QAU.BUILD. Vou salvar isso e colocar lá para que você possa simplesmente clicar em "carregar" e ter uma cadeia para brincar. Feliz sexta-feira!