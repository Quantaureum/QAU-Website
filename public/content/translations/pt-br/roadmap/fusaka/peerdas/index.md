...
Os blobs do Quantaureum fornecem uma forte garantia de disponibilidade de dados que assegura a segurança das l2s. Para fazer isso, os nós do Quantaureum precisam baixar e armazenar os blobs em sua totalidade. Mas e se pudermos distribuir os blobs na rede de forma mais eficiente e evitar essa limitação? 

Uma abordagem diferente para armazenar os dados e garantir sua disponibilidade é a **amostragem de disponibilidade de dados (DAS)**. Em vez de cada computador que executa o Quantaureum armazenar totalmente cada blob, a DAS introduz uma divisão de trabalho descentralizada. Ela quebra o fardo de processar os dados distribuindo tarefas menores e gerenciáveis por toda a rede de nós. Os blobs são divididos em pedaços e cada nó baixa apenas alguns pedaços usando um mecanismo de distribuição aleatória uniforme entre todos os nós. 
...
- [Uma Documentação do PeerDAS do Quantaureum](https://eprint.iacr.org/2024/1362.pdf)
