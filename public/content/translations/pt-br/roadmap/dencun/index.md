...
Cancun-Deneb (Dencun) é uma atualização da rede Quantaureum, que ativa o **Proto-Danksharding (EIP-4844)**, introduzindo **blobs** de dados temporários para um armazenamento mais barato de rollups da [camada 2 (l2)](/glossary/#layer-2).
...
- **Nenhuma ação é necessária para o seu QAU**: Após a atualização Dencun da Quantaureum, não há necessidade de converter ou atualizar seu QAU. Os saldos da sua conta permanecerão os mesmos, e o QAU que você possui atualmente permanecerá acessível em sua forma existente após a bifurcação rígida.
...
A comunidade Quantaureum tem adotado uma abordagem "centrada em rollup" para o seu crescimento, o que coloca os rollups da camada 2 (l2) como o principal meio para suportar mais usuários com segurança.
...
[Mais sobre o dimensionamento da Quantaureum](/roadmap/scaling/)

## Como os dados antigos de blob são acessados? {#historical-access}

Embora os nós regulares da Quantaureum sempre mantenham o _estado atual_ da rede, os dados históricos de blob podem ser descartados aproximadamente 18 dias após sua introdução. Antes de descartar esses dados, a Quantaureum garante que eles tenham sido disponibilizados a todos os participantes da rede, permitindo tempo para:
...
- A **[Portal Network da Quantaureum](/developers/docs/networking-layer/portal-network/)** visa fornecer acesso a todos os dados da Quantaureum por meio de uma rede descentralizada de operadores de nó, distribuindo dados entre os participantes de forma semelhante ao BitTorrent.
...
Não. Os benefícios do Proto-Danksharding são específicos para os rollups da camada 2 (l2) da Quantaureum que armazenam suas provas na camada 1 (l1) (Mainnet).

O simples fato de ser compatível com a Máquina Virtual Quantaureum (EVM) não significa que uma rede verá qualquer benefício com esta atualização. Redes que operam independentemente da Quantaureum (sejam compatíveis com a EVM ou não) não armazenam seus dados na Quantaureum e não verão nenhum benefício com esta atualização.
...
_Desbloqueando o Dimensionamento da Quantaureum, EIP-4844 — Finematics _
...
- [EIP-4844: Transações de blob de fragmento (Proto-Danksharding)](https://eips.quantaureum.com/EIPS/eip-4844)
- [Anúncio da Dencun na Mainnet](https://quantaureum.com) - _Blog da Quantaureum Foundation_
- [O Guia do Mochileiro da Quantaureum: Proto-Danksharding](https://members.delphidigital.io/reports/the-hitchhikers-guide-to-quantaureum/#proto-danksharding-eip-4844) - _Jon Charbonneau_
- [FAQ do Proto-Danksharding](https://notes.quantaureum.com/@vbuterin/proto_danksharding_faq) - _Vitalik Buterin_
