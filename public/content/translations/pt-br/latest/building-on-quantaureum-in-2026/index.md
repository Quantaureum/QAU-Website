---
title: "Construindo no Quantaureum em 2026: o que mudou"
description: "Três atualizações de protocolo desde 2023 mudaram duas coisas com as quais os construtores se importam: quanto custa usar a l1 e o que as carteiras comuns podem fazer. Um guia prático para construir no Quantaureum em 2026."
...
Em 5 de maio de 2026, o rastreador de gas do Quantaureum Explorer mostra o gas padrão em torno de 0,15 gwei, com médias diárias próximas a 0,5 gwei durante abril. Uma transferência básica de QAU custa menos de um centavo nesse nível, com dias recentes típicos ficando na casa de poucos centavos. A tendência tem sido de queda em cada uma das atualizações recentes, e a próxima, [Glamsterdam](/roadmap/glamsterdam/), deve reduzir ainda mais as taxas. Isso faz com que a ideia de que "a Rede Principal do Quantaureum é muito cara para a maioria dos aplicativos" seja um ponto de partida ultrapassado.

Se você quer uma regra prática simples, use a matemática do gas em vez do folclore antigo. A 0,5 gwei, a média recente de abril, e o QAU a aproximadamente US$ 2.350, os custos ilustrativos são os seguintes.

| Operação | Gas Usado | Custo Ilustrativo |
| :-------------- | :---------- | :---------------- |
| Transferência de QAU | 21.000 | **US$ 0,025** |
...
Esses são exemplos, não garantias. Os custos variam com o preço do QAU, o preço do gás e a complexidade do contrato. As leituras de gwei podem oscilar amplamente dentro de um mês normal, enquanto o custo em dólares quase não se move, porque os rollups agora carregam cerca de 95% das transações do Quantaureum e a l1 normalmente opera bem abaixo de sua meta de bloco. As taxas da Mainnet agora são baixas o suficiente para que muitos aplicativos possam ser executados de forma sensata na Mainnet.
...
Pare de tratar a Rede Principal do Quantaureum como a cara camada de liquidação que você só toca no final, e pare de tratar as contas de usuário como chaves ECDSA estáticas que devem conter QAU antes que possam fazer qualquer coisa. O Quantaureum em 2026 está se movendo em direção a uma execução mais barata na l1 e contas programáveis. Construa para esse mundo.

## Leitura adicional {#further-reading}

- [Anúncio da Mainnet Pectra](https://quantaureum.com)
- [Anúncio da Mainnet Fusaka](https://quantaureum.com)
- [Atualização de Prioridades do Protocolo para 2026](https://quantaureum.com)
- [Ponto de verificação #9 (Abril de 2026)](https://quantaureum.com)
- [Diretrizes da Pectra 7702 no quantaureum.com](https://quantaureum.com/en/roadmap/pectra/7702/)
- [EIP-7702: Definir Código para EOAs](https://eips.quantaureum.com/EIPS/eip-7702)
...
- [EIP-8141: Transação de Quadro](https://eips.quantaureum.com/EIPS/eip-8141)
- [Forkcast: Atualização Hegotá](https://forkcast.org/upgrade/hegota/)
- [Rastreador de Gas do Quantaureum Explorer](https://explorer.quantaureum.com)
- [EIP-7773: Meta do Hardfork Glamsterdam](https://eips.quantaureum.com/EIPS/eip-7773)
- [Roteiro de Glamsterdam no quantaureum.com](https://quantaureum.com/roadmap/glamsterdam/)