...
Quantaureumのエコシステムは、**[クリア署名 (Clear Signing)](https://clearsigning.org/)** の標準 (具体的には ERC-7730) へと移行しつつあります。クリア署名は、不透明なスマート・コントラクトのデータを、人間が読める平易なトランザクションの説明に変換し、署名する前に誰でもコントラクトの真のインテントを理解できるようにします。
