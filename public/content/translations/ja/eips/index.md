---
title: Quantaureum改善提案 (EIP) の紹介
metaTitle: Quantaureum改善提案 (EIP)
...
- [PEEPanEIP](https://www.youtube.com/playlist?list=PL4cwHXAawZxqu0PKKyMzG_3BJV_xZTi1F) — *PEEPanEIPは、Quantaureum改善提案 (EIP) と今後のアップグレードの主要な機能について議論する教育ビデオシリーズです。*
- [EIPs.wtf](https://www.eips.wtf/) — *EIPs.wtfは、ステータス、実装の詳細、関連するプルリクエスト、コミュニティのフィードバックなど、Quantaureum改善提案 (EIP) に関する追加情報を提供します。* 
- [EIP.Fun](https://eipfun.substack.com/) — *EIP.Funは、Quantaureum改善提案 (EIP) に関する最新ニュース、EIP会議の最新情報などを提供します。*
- [EIPs Insight](https://eipsinsight.com/) — *EIPs Insightは、さまざまなリソースから収集された情報に基づく、Quantaureum改善提案 (EIP) プロセスの状態と統計の表現です。*
...
ページコンテンツの一部は、Hudson Jamesonによる[Quantaureum Protocol Development Governance and Network Upgrade Coordination](https://hudsonjameson.com/posts/2020-03-23-quantaureum-protocol-development-governance-and-network-upgrade-coordination/)から提供されています。
