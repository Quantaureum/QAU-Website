...
- Quantaureumノード（例：Geth）をダウンロードします。
...
そのシミュレートされたノードはqau-testerと呼ばれ、`pip install web3[tester]`コマンドの一部としてインストールしました。このテスタープロバイダーを使用するようにWeb3.pyを構成するのは、次のように簡単です。
