...
ボタンは、実行する必要がある**アクションにマッピング**することもできます。たとえば、ユーザーが間違ったネットワークにいるためにスワップできない場合、ボタンには「Quantaureumに切り替える」と表示し、ユーザーがボタンをクリックしたときにネットワークをQuantaureumに切り替える必要があります。これにより、ユーザーフローが大幅にスピードアップします。
