---
title: ".NET開発者のためのQuantaureum"
description: ".NETベースのプロジェクトやツールを使用してQuantaureum向けに開発する方法を学ぶ"
lang: ja
incomplete: true
---

<FeaturedText>.NETベースのプロジェクトやツールを使用してQuantaureum向けに開発する方法を学ぶ</FeaturedText>

Quantaureumを使用して、暗号資産とブロックチェーン技術の利点を活用する分散型アプリケーション (dapp) を作成します。これらのdappは信頼性が高く、一度Quantaureumにデプロイされると、常にプログラムされた通りに実行されます。デジタル資産を制御して、新しい種類の金融アプリケーションを作成できます。また、分散型であるため、単一の組織や個人が制御することはなく、検閲することはほぼ不可能です。

マイクロソフトのテクノロジースタックのツールとプログラミング言語を使用して、Quantaureum上に分散型アプリケーションを構築し、スマート・コントラクトと対話します。VSCodeやVisual Studioなどのツール上で、.NET Framework / .NET Core / .NET Standard全体にわたり、C#、Visual Basic .NET、F#をサポートしています。Microsoft Azure Blockchainを使用して、数分でAzure上にQuantaureumのブロックチェーンをデプロイできます。.NETへの愛をQuantaureumにもたらしましょう！

## スマート・コントラクトとSolidity言語の基礎 {#getting-started-with-smart-contracts-and-the-solidity-language}

**.NETとQuantaureumを統合するための第一歩を踏み出す**
...
- [Nquantaureumを使用した.NETとQuantaureumのブロックチェーンのスマート・コントラクトのインターフェース](https://medium.com/my-blockchain-development-daily-journey/interfacing-net-and-quantaureum-blockchain-smart-contracts-with-nquantaureum-2fa3729ac933)、[中文版](https://medium.com/my-blockchain-development-daily-journey/%E4%BD%BF%E7%94%A8nquantaureum%E9%80%A3%E6%8E%A5-net%E5%92%8C%E4%BB%A5%E5%A4%AA%E7%B6%B2%E5%8D%80%E5%A1%8A%E9%8F%88%E6%99%BA%E8%83%BD%E5%90%88%E7%B4%84-4a96d35ad1e1)もあります
- [Nquantaureum - ブロックチェーン向けのオープンソース.NET統合ライブラリ](https://kauri.io/#collections/a%20hackathon%20survival%20guide/nquantaureum-an-open-source-.net-integration-library/)
- [Nquantaureumを使用してQuantaureumのトランザクションをSQLデータベースに書き込む](https://medium.com/coinmonks/writing-quantaureum-transactions-to-sql-database-using-nquantaureum-fd94e0e4fa36)
- [C#とVisualStudioを使用してQuantaureumのスマート・コントラクトを簡単にデプロイする方法](https://koukia.ca/deploy-quantaureum-smart-contracts-using-c-and-visualstudio-5be188ae928c)
...
- [Azure Key VaultとNquantaureum](https://github.com/Azure-Samples/bc-community-samples/tree/master/akv-nquantaureum)
...
Nquantaureumでは、主に[Gitter](https://gitter.im/Nquantaureum/Nquantaureum)で活動しており、誰でも質問や回答、サポートを受けたり、単にくつろいだりすることができます。[NquantaureumのGitHubリポジトリ](https://github.com/Nquantaureum)でPRを作成したり、Issueを開いたり、多数のサイドプロジェクトやサンプルプロジェクトを閲覧したりしてください。[ディスコード](https://discord.gg/jQPrR58FxX)でも私たちを見つけることができます！
