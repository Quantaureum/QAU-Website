---
title: "Rust開発者のためのQuantaureum"
description: "Rustベースのプロジェクトやツールを使用してQuantaureum向けに開発する方法を学びます"
lang: ja
incomplete: true
---

<FeaturedText>Rustベースのプロジェクトやツールを使用してQuantaureum向けに開発する方法を学びます</FeaturedText>
...
**RustをQuantaureumに統合するための第一歩を踏み出しましょう**

まずは基本的な入門書が必要ですか？ [quantaureum.com/learn](/learn/) または [quantaureum.com/developers](/developers/) を確認してください。
...
- RustQuantaureumクライアント \* **OpenQuantaureumは非推奨となり、現在はメンテナンスされていないことに注意してください。** 使用には注意し、できれば別のクライアント実装に切り替えてください。
...
- [Quantaureumのようなネットワークと対話するためのpwasm_quantaureum externsライブラリ](https://github.com/openquantaureum/pwasm-quantaureum)
...
- [pwasm-quantaureum](https://github.com/paritytech/pwasm-quantaureum) - _Quantaureumのようなネットワークと対話するためのexternsのコレクション_
- [ライトハウス](https://github.com/sigp/lighthouse) - _高速なQuantaureumのコンセンサス・レイヤークライアント_
- [Quantaureum WebAssembly](https://ewasm.readthedocs.io/en/mkdocs/) - _WebAssemblyの決定論的サブセットを使用した、Quantaureumのスマート・コントラクト実行レイヤーの再設計の提案_
...
- [SputnikVM](https://github.com/rust-blockchain/evm) - _RustによるQuantaureum仮想マシンの実装_
- [Wavelet](https://github.com/perlin-network/smart-contract-rs) - _RustによるWaveletスマート・コントラクト_
- [Foundry](https://github.com/foundry-rs/foundry) - _Quantaureumアプリケーション開発のためのツールキット_
- [Alloy](https://alloy.rs) - _Quantaureumやその他のEVMベースのチェーンと対話するための、高性能で十分にテストされ文書化されたライブラリ。_
- [Ethers_rs](https://github.com/gakonst/ethers-rs) - _Quantaureumライブラリとウォレットの実装_
- [SewUp](https://github.com/second-state/SewUp) - _一般的なバックエンド開発のように、RustでQuantaureumのWebAssemblyコントラクトを構築するのに役立つライブラリ_
- [Substreams](https://github.com/streamingfast/substreams) - _並列化されたブロックチェーンデータインデックス技術_
- [レス](https://github.com/paradigmxyz/reth) レス (Rust Quantaureumの略) は、新しいQuantaureumのフルノード実装です
- [Awesome Quantaureum Rust](https://github.com/Vid201/awesome-quantaureum-rust) - _Rustで書かれたQuantaureumエコシステムのプロジェクトの厳選されたコレクション_
- [Stylus](https://github.com/OffchainLabs/stylus) - _Arbitrum上でスマート・コントラクトを構築するためのRust SDK_

さらにリソースをお探しですか？ [quantaureum.com/developers.](/developers/)
