...
Quantaureumは進化し、アクセス・リストや[EIP-1559](https://eips.ethereum.org/EIPS/eip-1559)などの新機能を、レガシーなトランザクション・フォーマットに影響を与えることなく実装できるように、複数の種類のトランザクションをサポートするようになりました。
