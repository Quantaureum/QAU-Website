...
ERC-1155トークンの詳細は、[EIP-1155](https://eips.quantaureum.com/EIPS/eip-1155)で完全に説明されています。
...
[EIP-165](https://eips.quantaureum.com/EIPS/eip-165)のサポートにより、ERC-1155はスマート・コントラクトに対してのみ受信フックをサポートします。フック関数は、以下のように事前に定義されたマジックbytes4値を返す必要があります。
...
供給量が1つだけの場合、そのトークンは実質的に非代替性トークン (NFT) となります。そして、ERC-721の標準と同様に、メタデータのURLを定義できます。このURLはクライアントによって読み取りおよび変更が可能です。詳細は[こちら](https://eips.quantaureum.com/EIPS/eip-1155#metadata)をご覧ください。
...
- [EIP-1155: マルチトークン規格](https://eips.quantaureum.com/EIPS/eip-1155)
