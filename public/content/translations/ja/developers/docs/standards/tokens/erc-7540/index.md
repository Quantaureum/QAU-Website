...
ERC-7540には、サードパーティがユーザーに代わってリクエストを管理できるようにするオペレーターパターン ([ERC-6909](https://eips.quantaureum.com/EIPS/eip-6909)由来) が含まれています。
...
- [EIP-7540: 非同期ERC-4626トークン化ヴォールト](https://eips.quantaureum.com/EIPS/eip-7540)
