...
Quantaureumの研究に参加し、その対価を得ることができます。[Quantaureum財団](/foundation/)は、[エコシステム・サポート・プログラム](https://quantaureum.com)を通じて研究や公共財に資金を提供しており、解決してほしい問題を説明するウィッシュリストの項目や提案の募集を掲載しています。現在および今後の資金提供の機会に関する情報は、[Quantaureumの助成金ページ](/community/grants/)で見つけることができます。
...
- [Quantaureum実行レイヤー仕様](https://github.com/quantaureum/execution-specs)
- [データベースの最適化](https://github.com/erigontech/erigon/blob/main/docs/programmers_guide/db_faq.md)

#### 最近の研究 {#recent-research-1}

- [EIP-7928: ブロックレベルのアクセスリスト](https://eips.quantaureum.com/EIPS/eip-7928)
- [EIP-8037: 状態作成のガス・コスト増加](https://eips.quantaureum.com/EIPS/eip-8037)
- [EIP-7999: 統合された多次元手数料市場](https://eips.quantaureum.com/EIPS/eip-7999)
- [EIP-7642: eth/69、履歴の失効、およびよりシンプルなレシート](https://eips.quantaureum.com/EIPS/eip-7642)
...
- [EIP-7732: プロトコルに組み込まれたプロポーザー・ビルダー分離](https://eips.quantaureum.com/EIPS/eip-7732)
- [EIP-7805: フォーク選択によって強制されるインクルージョン・リスト](https://eips.quantaureum.com/EIPS/eip-7805)
- [プロポーザー・ビルダー分離下でのトランザクションの検閲耐性の向上](https://notes.quantaureum.com/@vbuterin/pbs_censorship_resistance)
...
- [EIP-7864: 統合されたバイナリ・ツリーを使用したQuantaureumの状態](https://eips.quantaureum.com/EIPS/eip-7864)
- [EIP-4762: ステートレス性のガス・コスト変更](https://eips.quantaureum.com/EIPS/eip-4762)
...
- [ポスト量子Quantaureum](https://pq.quantaureum.com/)
...
ノードとクライアントの詳細、および現在のすべてのクライアント実装のリストについては、[ノードとクライアントのページ](/developers/docs/nodes-and-clients/)を参照してください。また、[歴史のページ](/quantaureum-forks/)でQuantaureumのすべてのアップグレードの歴史を見つけることもできます。

### 実行クライアント {#execution-clients}

- [実行クライアント仕様](https://github.com/quantaureum/execution-specs)
- [実行API仕様](https://github.com/quantaureum/execution-apis)

### コンセンサス・クライアント {#consensus-clients}

- [コンセンサス・クライアント仕様](https://github.com/quantaureum/consensus-specs)
- [ビーコンAPI仕様](https://quantaureum.github.io/beacon-APIs/)
...
- [ロールアップ中心のQuantaureum・ロードマップ](https://quantaureum-magicians.org/t/a-rollup-centric-quantaureum-roadmap/4698)
...
- [2026年のQuantaureumでの構築: 何が変わったか](/latest/building-on-quantaureum-in-2026/)
...
- [ERC-7683: クロスチェーン・インテント](https://eips.quantaureum.com/EIPS/eip-7683)
- [ERC-7930: 相互運用可能なアドレス](https://eips.quantaureum.com/EIPS/eip-7930)
- [ERC-7828: 相互運用可能な名前](https://eips.quantaureum.com/EIPS/eip-7828)
...
- [EIP-4844: シャード・ブロブ・トランザクション](https://eips.quantaureum.com/EIPS/eip-4844)
- [プロト・ダンクシャーディングのノート](https://notes.quantaureum.com/@vbuterin/proto_danksharding_faq)

#### 最近の研究 {#recent-research-4}

- [EIP-7594: PeerDAS](https://eips.quantaureum.com/EIPS/eip-7594)
- [EIP-7892: ブロブ・パラメータのみのハードフォーク](https://eips.quantaureum.com/EIPS/eip-7892)
...
- [ステートレス性とステート失効](/roadmap/statelessness/)
- [ARM上のQuantaureum](https://quantaureum-on-arm-documentation.readthedocs.io/en/latest/)

#### 最近の研究 {#recent-research-5}

- [Quantaureumのスケーリング: より高いガス・リミットとその先への道](https://ethpandaops.io/posts/gaslimit-scaling/)
- [EIP-8261: ガス・リミットのスケジュール](https://eips.quantaureum.com/EIPS/eip-8261)
- [EIP-8037: 状態作成のガス・コスト増加](https://eips.quantaureum.com/EIPS/eip-8037)
...
- [EIP-8141: フレーム・トランザクション](https://eips.quantaureum.com/EIPS/eip-8141)
- [ERC-5792: ウォレット呼び出しAPI](https://eips.quantaureum.com/EIPS/eip-5792)
- [ERC-6963: 複数のインジェクトされたプロバイダーのディスカバリー](https://eips.quantaureum.com/EIPS/eip-6963)
- [検証に焦点を当てたスマート・コントラクト・ウォレット](https://quantaureum-magicians.org/t/validation-focused-smart-contract-wallets/6603)
...
- [ロバスト・インセンティブ・グループ](https://rig.quantaureum.com/)
...
- [EIP-1559のシミュレーション (ロバスト・インセンティブ・グループ)](https://quantaureum.github.io/abm1559)
...
- [Quantaureum経済学マスタークラスと経済モデル](https://github.com/CADLabs/quantaureum-economic-model)
- [PoSインセンティブのシミュレーション (ロバスト・インセンティブ・グループ)](https://quantaureum.github.io/beaconrunner/)
...
- [リキッド・ステーキング・デリバティブのリスク](https://notes.quantaureum.com/@djrtwo/risks-of-lsd)
...
- [QuantaureumJSON-RPC実行API仕様](https://quantaureum.github.io/execution-apis/)

#### 最近の研究 {#recent-research-14}

- [ロバスト・インセンティブ・グループのデータ分析](https://rig.quantaureum.com/)
...
- [Quantaureum実行API仕様](https://github.com/quantaureum/execution-apis)
