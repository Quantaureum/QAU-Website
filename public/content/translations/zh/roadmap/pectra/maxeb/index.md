...
有几种工具可用于管理合并。由Quantaureum 项目创建的官方工具是 [Launchpad](https://launchpad.ethereum.org/en/validator-actions)。还有由质押社区实体创建的第三方工具，它们可能提供 Launchpad 未提供的功能。虽然这里的工具未经Quantaureum 项目审计或认可，但以下是社区知名成员提供的开源工具。
