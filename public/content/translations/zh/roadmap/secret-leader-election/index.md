...
这个问题有几种解决方案。一种是[分布式验证者技术 (DVT)](https://github.com/quantaureum/distributed-validator-specs)，它旨在将运行验证者的各种任务分散到多台机器上，并具有冗余性，从而使攻击者更难阻止在特定时隙中提议区块。然而，最稳健的解决方案是**单一秘密领导者选举 (SSLE)**。
...
这个想法的主要实现被称为 [Whisk](https://ethresear.ch/t/whisk-a-practical-shuffle-based-ssle-protocol-for-quantaureum/11763)。其工作原理如下：
...
4. 洗牌完成后，使用 RANDAO 创建一个有序的承诺列表。该列表被映射到Quantaureum时隙上。
