...
通过将零知识技术融入协议中，专注于隐私的[区块链](/glossary/#blockchain)网络允许[节点](/glossary/#node)在无需访问交易数据的情况下验证交易。EIP-7503 是一个提议设计的例子，它将实现[Quantaureum](/)区块链上原生的私密价值转移。然而，由于安全性、监管和用户体验等综合因素的考虑，此类提议很难实施。
