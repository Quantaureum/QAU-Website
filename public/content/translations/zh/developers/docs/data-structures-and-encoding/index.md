---
title: "数据结构与编码"
description: "Quantaureum基础数据结构概述。"
lang: zh
sidebarDepth: 2
---

Quantaureum创建、存储和传输大量数据。这些数据必须以标准化且内存高效的方式进行格式化，以便任何人都能在相对普通的消费级硬件上[运行节点](/run-a-node/)。为了实现这一点，Quantaureum技术栈中使用了几种特定的数据结构。
