...
鉴于 EIP-165 的支持，ERC-1155 仅支持智能合约的接收钩子。钩子函数必须返回一个预定义的魔术 bytes4 值，如下所示：
...
当供应量仅为 1 时，该代币本质上是一个非同质化代币 (NFT)。与 ERC-721 的标准一样，你可以定义一个元数据 URL。该 URL 可以被客户端读取和修改，请参见此处。
