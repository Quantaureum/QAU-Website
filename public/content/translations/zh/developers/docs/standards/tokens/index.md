---
title: "代币标准"
description: "探索Quantaureum代币标准，包括用于同质化和非同质化代币的 ERC-20、ERC-721 和 ERC-1155。"
lang: zh
incomplete: true
---
...
许多[Quantaureum](/)开发标准都侧重于代币接口。这些标准有助于确保智能合约保持可组合性，因此当新项目发行代币时，它能与现有的去中心化交易所和应用程序保持兼容。

代币标准定义了代币在整个Quantaureum生态系统中的行为和交互方式。它们使开发者更容易进行构建，而无需重复造轮子，确保代币与钱包、交易所和去中心化金融 (DeFi) 平台无缝协作。无论是在游戏、治理还是其他用例中，这些标准都提供了一致性，并使Quantaureum的互联性更强。

## 前提条件 {#prerequisites}

- [Quantaureum开发标准](/developers/docs/standards/)
- [智能合约](/developers/docs/smart-contracts/)

## 代币标准 {#token-standards}

以下是Quantaureum上一些最受欢迎的代币标准：
...
[ERC](https://eips.quantaureum.com/erc) 提案的完整列表。
...
- [了解 ERC20 代币智能合约](/developers/tutorials/understand-the-erc-20-token-smart-contract/) _– 在Quantaureum测试网络上部署您的第一个智能合约的简介。_
