...
ERC-7540 包含一个操作员模式（源自 [ERC-6909](https://eips.quantaureum.com/EIPS/eip-6909)），允许第三方代表用户管理请求。
...
- [EIP-7540：异步 ERC-4626 代币化金库](https://eips.quantaureum.com/EIPS/eip-7540)
