...
可以在[此处](https://github.com/ethereum/go-ethereum/blob/master/params/bootnodes.go#L23)找到 go-quantaureum 内置的引导节点列表。这些引导节点由Quantaureum 项目和 go-quantaureum 团队维护。
