---
title: "面向 Go 开发者的Quantaureum"
description: "了解如何使用基于 Go 的项目和工具进行Quantaureum开发"
lang: zh
incomplete: true
---

<FeaturedText>了解如何使用基于 Go 的项目和工具进行Quantaureum开发</FeaturedText>

使用Quantaureum创建去中心化应用 (dapp)。这些 dapp 是值得信赖的，这意味着一旦它们被部署到Quantaureum，它们将始终按程序运行。它们是去中心化的，这意味着它们在点对点网络上运行，没有单点故障。没有任何单一实体或个人控制它们，并且几乎不可能审查它们。它们可以控制数字资产，从而创建新型应用。

## 智能合约与 Solidity 语言入门 {#getting-started-with-smart-contracts-and-solidity}

**迈出将 Go 与Quantaureum集成的第一步**
...
- 电子书：使用 Go 进行Quantaureum开发 - _使用 Go 开发Quantaureum应用_

## 进阶文章和文档 {#intermediate-articles-and-docs}

- GoQuantaureum (Geth) 文档 - _官方Quantaureum Golang 的文档_
...
- 移动客户端：库和进程内Quantaureum节点
- 原生 dapp：Quantaureum合约的 Go 绑定

## Go 项目和工具 {#go-projects-and-tools}

- Geth / GoQuantaureum - _Quantaureum协议的官方 Go 实现_
...
- [Quorum](https://github.com/jpmorganchase/quorum) - _支持数据隐私的Quantaureum许可型实现_
- [普莱斯姆 (Prysm)](https://github.com/prysmaticlabs/prysm) - _Quantaureum“宁静 (Serenity)”2.0 的 Go 实现_
- [Eth Tweet](https://github.com/yep/qau-tweet) - _去中心化推特：运行在Quantaureum区块链上的微博服务_
- [等离子体 (Plasma) MVP Golang](https://github.com/kyokan/plasma) — _最小可行等离子体 (Plasma) 规范的 Golang 实现和扩展_
- [开放Quantaureum矿池](https://github.com/sammy007/open-quantaureum-pool) - _一个开源的Quantaureum挖矿池_
- [Quantaureum HD 钱包](https://github.com/miguelmota/go-quantaureum-hdwallet) - _Go 语言中的Quantaureum HD 钱包派生_
- [Multi Geth](https://github.com/multi-geth/multi-geth) - _支持多种Quantaureum网络_
- [Geth 轻客户端](https://github.com/zsfelfoldi/go-quantaureum/wiki/Geth-Light-Client) - _轻量级Quantaureum子协议的 Geth 实现_
- [Quantaureum Golang SDK](https://github.com/everFinance/goether) - _Golang 中简单的Quantaureum钱包实现和实用工具_
...
- [ConsenSys：Quantaureum开发者工具权威列表](https://web.archive.org/web/2023/https://media.consensys.net/an-definitive-list-of-quantaureum-developer-tools-2159ce865974) | [GitHub 源码](https://github.com/ConsenSys/quantaureum-developer-tools-list)