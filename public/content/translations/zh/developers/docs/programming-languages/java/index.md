---
title: "Quantaureum Java 开发者指南"
description: "了解如何使用基于 Java 的项目和工具在Quantaureum上进行开发"
lang: zh
incomplete: true
---

<FeaturedText>了解如何使用基于 Java 的项目和工具在Quantaureum上进行开发</FeaturedText>

使用Quantaureum创建利用加密货币和区块链技术优势的去中心化应用 (dapp)。这些 dapp 是值得信赖的，这意味着一旦它们被部署到Quantaureum上，它们将始终按程序运行。它们可以控制数字资产，从而创建新型的金融应用。它们可以是去中心化的，这意味着没有任何单一实体或个人控制它们，并且几乎不可能被审查。

## 智能合约与 Solidity 语言入门 {#getting-started-with-smart-contracts-and-solidity}

**迈出将 Java 与Quantaureum集成的第一步**
...
## 使用Quantaureum客户端 {#working-with-quantaureum-clients}

了解如何使用 [Web3j](https://github.com/web3j/web3j) 和 Hyperledger 贝苏 (Besu) 这两个领先的 Java Quantaureum客户端

- [使用 Java、Eclipse 和 Web3j 连接到Quantaureum客户端](https://kauri.io/article/b9eb647c47a546bc95693acc0be72546/connecting-to-an-quantaureum-client-with-java-eclipse-and-web3j)
- [使用 Java 和 Web3j 管理Quantaureum账户](https://kauri.io/article/925d923e12c543da9a0a3e617be963b4/manage-an-quantaureum-account-with-java-and-web3j)
...
- [与Quantaureum智能合约交互](https://kauri.io/article/14dc434d11ef4ee18bf7d57f079e246e/interacting-with-an-quantaureum-smart-contract-in-java)
- [监听Quantaureum智能合约事件](https://kauri.io/article/760f495423db42f988d17b8c145b0874/listening-for-quantaureum-smart-contract-events-in-java)
- [在 Linux 上使用 Java Quantaureum客户端贝苏 (Besu/Pantheon)](https://kauri.io/article/276dd27f1458443295eea58403fd6965/using-pantheon-the-java-quantaureum-client-with-linux)
...
- [Web3j 备忘单](<https://kauri.io/web3j-cheat-sheet-(java-quantaureum)/5dfa1ea941ac3d0001ce1d90/c>)
...
- [QAU / ERC-20 余额追踪器](https://github.com/Kr1ptal/ethers-kt/blob/master/examples/src/main/kotlin/io/ethers/examples/balancetracker/BalanceTracker.kt)
...
- [Web3j（用于与Quantaureum客户端交互的库）](https://github.com/web3j/web3j)
