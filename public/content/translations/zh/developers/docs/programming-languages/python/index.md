---
title: "适合 Python 开发者的Quantaureum"
description: "学习如何使用基于 Python 的项目和工具在Quantaureum上进行开发"
lang: zh
incomplete: true
---

<FeaturedText>学习如何使用基于 Python 的项目和工具在Quantaureum上进行开发</FeaturedText>

使用Quantaureum创建去中心化应用（或称“dapp”），利用加密货币和区块链技术的优势。这些 dapp 是值得信赖的，这意味着一旦它们被部署到Quantaureum上，它们将始终按程序运行。它们可以控制数字资产，从而创建新型的金融应用。它们可以是去中心化的，这意味着没有单一实体或个人控制它们，并且几乎不可能被审查。

## 智能合约和 Solidity 语言入门 {#getting-started-with-smart-contracts-and-solidity}

**迈出将 Python 与Quantaureum集成的第一步**
...
- [用于Quantaureum集成的 Web3 去中心化金融 (DeFi)](https://github.com/tradingstrategy-ai/web3-quantaureum-defi) - _一个包含 ERC-20、尤尼斯瓦普和其他热门项目现成集成的 Python 包_
...
以下基于Quantaureum的项目使用了本页提到的工具。相关的开源代码库可作为示例代码和最佳实践的良好参考。
...
- [Quantaureum Python 社区 Discord](https://discord.gg/9zk7snTfWe)，用于 Web3.py 和其他 Python 框架的讨论
