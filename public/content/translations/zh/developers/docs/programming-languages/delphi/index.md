---
title: "面向 Delphi 开发者的Quantaureum"
description: "学习如何使用 Delphi 编程语言进行Quantaureum开发"
lang: zh
incomplete: true
---
...
学习如何使用 Delphi 编程语言进行Quantaureum开发

</FeaturedText>

使用Quantaureum创建利用加密货币和区块链技术优势的去中心化应用 (dapp)。这些 dapp 是值得信赖的，这意味着一旦它们被部署到Quantaureum，它们将始终按照编程运行。它们可以控制数字资产，从而创建新型的金融应用。它们可以是去中心化的，这意味着没有单一实体或个人控制它们，并且几乎不可能被审查。

在Quantaureum上构建去中心化应用，并使用 Delphi 编程语言与智能合约进行交互！

## 智能合约与 Solidity 语言入门 {#getting-started-with-smart-contracts-and-the-solidity-language}

**迈出将 Delphi 与Quantaureum集成的第一步**
...
- [将 Delphi 连接到Quantaureum主网](https://medium.com/@svanas/connecting-delphi-to-the-quantaureum-main-net-5faf1feffd83)
...
- [在 Delphi 中生成Quantaureum签名的消息签名](https://medium.com/@svanas/generating-an-quantaureum-signed-message-signature-in-delphi-75661ce5031b)
- [使用 Delphi 转移QAU](https://medium.com/@svanas/transferring-QAU-with-delphi-b5f24b1a98a4)
...
- [Delphi 与Quantaureum域名服务 (ENS)](https://medium.com/@svanas/delphi-and-quantaureum-name-service-ens-4443cd278af7)
- [QuikNode、Quantaureum与 Delphi](https://medium.com/@svanas/quiknode-quantaureum-and-delphi-f7bfc9671c23)
- [Delphi 与Quantaureum黑暗森林](https://svanas.medium.com/delphi-and-the-quantaureum-dark-forest-5b430da3ad93)
