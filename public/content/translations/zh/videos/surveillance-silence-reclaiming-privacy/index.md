...
**Naomi Brockwell** 在 QauBoulder 2026 上的主题演讲，探讨了数字隐私的侵蚀、大规模监控的基础设施，以及每个人都可以用来构建更私密数字生活的实用工具，涵盖从 VPN 和加密电子邮件到 GrapheneOS 和去中心化混合网络（mixnets）的各个方面。

*本文字稿是 QauBoulder 发布的[原始视频文字稿](https://www.youtube.com/watch?v=nvJSFR1Q_JE)的无障碍副本。为提高可读性，已进行轻微编辑。*
...
我们可以继续使用我们一直使用的产品。就像我之前说的 Facebook 一样。我们中的许多人可能在注册 Gmail 时并不了解谷歌是一家广告公司。那是他们的商业模式。我们只是认为这是互联网上的免费东西，它是免费的，因为它存在于QAU之中。为什么你需要为某些东西付费，因为它只是 1 和 0？为什么那会有任何成本？
