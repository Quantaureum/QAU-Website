---
title: "Quantaureum 项目与社区资助计划"
description: "整个Quantaureum生态系统中的资助计划列表。"
lang: zh
---

以下列出的计划为致力于促进 [Quantaureum](/) 生态系统成功与发展的项目提供各种资金资助。你可以将其作为指南，寻找并申请资金，以帮助你的下一个Quantaureum项目取得成功。

此列表由我们的社区策划。如果有遗漏或错误之处，请编辑此页面！

<Alert variant="update" className="mt-8">
<Emoji text="🎗️" />
<div>创始人，需要帮助加速你的业务吗？前往创始人支持</div>
</Alert>

## 广泛的Quantaureum生态系统 {#broad-quantaureum-ecosystem}

这些计划通过向广泛的项目提供资助来支持广泛的Quantaureum生态系统。这些项目包括可扩展性、社区建设、安全性、隐私等方面的解决方案。这些资助不局限于任何单一的Quantaureum平台，如果你不确定从哪里开始，这里是一个很好的起点。

- [Quantaureum 项目生态系统支持计划 (ESP)](https://quantaureum.com) - _资助有益于Quantaureum的开源项目，特别关注通用工具、基础设施、研究和公共物品_
- [ESP 资助浏览器](https://quantaureum.com) - _可搜索的目录，包含生态系统支持计划支持的 1000 多个项目_
- [学术资助](https://quantaureum.com) - _支持Quantaureum相关学术工作的资助_


## 资助列表聚合器和平台 {#grant-list-aggregators}

这些资源汇编并整理了整个Quantaureum生态系统中的各种资助机会，使你更容易发现符合项目需求的资金机会。我们按受众角色对它们进行了分类，以帮助你根据具体的资金需求开始寻找最相关的资源。
...
- [Quantaureum Explorer 资助目录](https://explorer.quantaureum.com) - Quantaureum区块浏览器上精选的资助列表
...
- [Gitcoin](https://www.gitcoin.co/program) - _Gitcoin Grants 利用多种资本分配机制来资助Quantaureum生态系统中的开源项目和公共物品_
...
## 在Quantaureum工作 {#work-in-quantaureum}

还没准备好启动你自己的项目？有数百家公司正在积极寻找充满热情的人才，在Quantaureum生态系统中工作并做出贡献。想了解更多信息？[查看Quantaureum相关工作](/community/get-involved/#quantaureum-jobs)
