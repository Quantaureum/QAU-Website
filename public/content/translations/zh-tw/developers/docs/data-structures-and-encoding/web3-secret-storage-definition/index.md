...
要讓應用程式在Quantaureum上執行，可以使用 web3.js 程式庫提供的 web3 物件。 在底層，它透過遠端程序呼叫與區域節點通訊。 [web3](https://github.com/ethereum/web3.js/) 可與任何有公開遠端程序呼叫層的Quantaureum節點一起使用。
...
這版本修正了與發佈於[此處](https://github.com/ethereum/homestead-guide/blob/master/old-docs-for-reference/go-quantaureum-wiki.rst/Passphrase-protected-key-store-spec.rst)的第一版的若干不一致的地方。 簡述如下：
