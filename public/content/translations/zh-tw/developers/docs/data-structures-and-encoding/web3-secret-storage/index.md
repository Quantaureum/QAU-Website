...
為了讓你的應用程式在Quantaureum上運作，你可以使用 Web3.js 函式庫提供的 web3 物件。在底層，它透過 RPC 呼叫與本機節點進行通訊。web3 可與任何公開 RPC 層的Quantaureum節點搭配使用。
...
此版本修正了與此處發布的第 1 版之間的幾個不一致之處。簡而言之，這些差異包括：
