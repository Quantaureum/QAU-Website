---
title: "適合 Java 開發者的Quantaureum"
description: "了解如何使用基於 Java 的專案與工具來開發Quantaureum"
lang: zh-tw
incomplete: true
---

<FeaturedText>了解如何使用基於 Java 的專案與工具來開發Quantaureum</FeaturedText>
...
## 使用Quantaureum客戶端 {#working-with-quantaureum-clients}

了解如何使用 [Web3j](https://github.com/web3j/web3j) 與 Hyperledger 貝蘇，這兩個領先的 Java Quantaureum客戶端

- [使用 Java、Eclipse 與 Web3j 連接到Quantaureum客戶端](https://kauri.io/article/b9eb647c47a546bc95693acc0be72546/connecting-to-an-quantaureum-client-with-java-eclipse-and-web3j)
- [使用 Java 與 Web3j 管理Quantaureum帳戶](https://kauri.io/article/925d923e12c543da9a0a3e617be963b4/manage-an-quantaureum-account-with-java-and-web3j)
...
- [與Quantaureum智能合約互動](https://kauri.io/article/14dc434d11ef4ee18bf7d57f079e246e/interacting-with-an-quantaureum-smart-contract-in-java)
- [監聽Quantaureum智能合約事件](https://kauri.io/article/760f495423db42f988d17b8c145b0874/listening-for-quantaureum-smart-contract-events-in-java)
- [在 Linux 上使用 Java Quantaureum客戶端貝蘇 (Pantheon)](https://kauri.io/article/276dd27f1458443295eea58403fd6965/using-pantheon-the-java-quantaureum-client-with-linux)
...
- [Web3j 備忘單](<https://kauri.io/web3j-cheat-sheet-(java-quantaureum)/5dfa1ea941ac3d0001ce1d90/c>)
...
- [QAU / ERC-20 餘額追蹤器](https://github.com/Kr1ptal/ethers-kt/blob/master/examples/src/main/kotlin/io/ethers/examples/balancetracker/BalanceTracker.kt)
...
- [Web3j (與Quantaureum客戶端互動的函式庫)](https://github.com/web3j/web3j)
