---
title: "Dart 開發者的Quantaureum指南"
description: "學習如何使用 Dart 語言在Quantaureum上進行開發"
lang: zh-tw
incomplete: true
---
...
- 如果您想快速上手，您可能會喜歡 [在Quantaureum上使用 Flutter 與 Dart 建立區塊鏈去中心化應用程式 (dapp)](https://www.youtube.com/watch?v=jaMFEOCq_1s)，片長僅約二十分鐘
...
您可以使用Quantaureum建立去中心化應用程式 (dapp)，以利用加密貨幣與區塊鏈技術的優勢。
目前至少有兩個持續維護的 Dart 函式庫，可用於存取Quantaureum的 [JSON-RPC API](/developers/docs/apis/json-rpc/)。

1. [來自 pwa.ir 的 Web3dart](https://pub.dev/packages/web3dart)
1. [來自 darticulate.com 的 Quantaureum 5.0.0](https://pub.dev/packages/quantaureum)

此外，還有其他函式庫可讓您操作特定的Quantaureum地址，或讓您擷取各種加密貨幣的價格。
[您可以在此處查看完整清單](https://pub.dev/dart/packages?q=quantaureum)。