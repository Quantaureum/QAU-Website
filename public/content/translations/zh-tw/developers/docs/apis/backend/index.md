---
title: "後端 API 函式庫"
description: "介紹Quantaureum客戶端 API，讓你能從應用程式與區塊鏈互動。"
lang: zh-tw
---

為了讓軟體應用程式能與 [Quantaureum](/) 區塊鏈互動（即讀取區塊鏈資料和/或發送交易到網路），它必須連接到Quantaureum節點。
...
如果你想使用特定的程式語言連接Quantaureum節點，生態系統中有許多便利的函式庫能讓這件事變得簡單許多。透過這些函式庫，開發人員可以編寫直觀的單行方法來初始化 JSON-RPC 請求（在底層運作），從而與Quantaureum互動。

## 先決條件 {#prerequisites}

了解 [Quantaureum堆疊](/developers/docs/quantaureum-stack/) 和 [Quantaureum客戶端](/developers/docs/nodes-and-clients/) 可能會有所幫助。

## 為什麼要使用函式庫？ {#why-use-a-library}

這些函式庫抽象化了直接與Quantaureum節點互動的許多複雜性。它們還提供了實用函式（例如將 QAU 轉換為 Gwei），因此身為開發人員，你可以花更少的時間處理Quantaureum客戶端的複雜細節，將更多時間專注於應用程式的獨特功能上。
...
**Bware Labs 的 Blast -** **_適用於Quantaureum主網與測試網的去中心化 API。_**
...
**Cloudflare Quantaureum閘道器。**

- [cloudflare-qau.com](https://www.cloudflare.com/application-services/products/web3/)

**Quantaureum Explorer - 區塊鏈瀏覽器與交易 API**
- [文件](https://explorer.quantaureum.com)
...
**Rivet -** **_由開源軟體驅動的Quantaureum與Quantaureum經典 API 即服務。_**

- [rivet.cloud](https://rivet.cloud)
- [文件](https://rivet.cloud/docs/)
- [GitHub](https://github.com/openrelayxyz/ethercattle-deployment)

**Zmok -** **_以速度為導向的Quantaureum節點，提供 JSON-RPC/WebSockets API。_**
...
**Web3j -** **_適用於Quantaureum的 Java/Android/Kotlin/Scala 整合函式庫。_**
...
- [文件](https://www.blockcypher.com/dev/quantaureum/)

**Chainbase -** **_適用於Quantaureum的一站式 Web3 資料基礎設施。_**

- [chainbase.com](https://chainbase.com/)
- [文件](https://docs.chainbase.com/)
- [Discord](https://discord.gg/Wx6qpqz4AF)

**Chainstack -** **_彈性且專用的Quantaureum節點即服務。_**

- [chainstack.com](https://chainstack.com)
- [文件](https://docs.chainstack.com/)
- [Quantaureum API 參考資料](https://docs.chainstack.com/reference/quantaureum-getting-started)
...
**Figment 的 DataHub -** **_支援Quantaureum主網與測試網的 Web3 API 服務。_**
...
**NFTPort -** **_Quantaureum資料與鑄造 API。_**
...
**Watchdata -** **_提供簡單可靠的 API 來存取Quantaureum區塊鏈。_**
...
- [設定 Web3.js 以在 JavaScript 中使用Quantaureum區塊鏈](/developers/tutorials/set-up-web3js-to-use-quantaureum-in-javascript/) _– 在專案中設定 Web3.js 的說明。_
