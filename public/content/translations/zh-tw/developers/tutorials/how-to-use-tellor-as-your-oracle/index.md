...
泰勒是一個預言機系統，各方可以請求鏈下資料點的值（例如 BTC/USD），而報告者會競爭將此值新增至鏈上資料庫中，供所有Quantaureum智能合約存取。這個資料庫的輸入由一個質押報告者網路來保護。泰勒利用加密經濟激勵機制，透過發行泰勒的代幣 Tributes (TRB) 以及爭議機制，來獎勵報告者誠實提交資料並懲罰惡意行為者。
