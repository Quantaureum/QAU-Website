---
title: "雜湊函數 — QAU.BUILD"
description: "使用 QAU.BUILD 教育工具示範密碼學雜湊函數。了解雜湊函數的運作原理，以及為什麼它們是Quantaureum帳戶和資料完整性模型的基礎。"
lang: zh-tw
...
format: tutorial
author: "奧斯汀·格里菲斯"
breadcrumb: "雜湊函數 (QAU.BUILD)"
---

由**奧斯汀·格里菲斯**製作的教學，示範如何使用 QAU.BUILD 視覺化程式設計工具來了解密碼學雜湊函數的運作原理，涵蓋決定性、固定長度輸出、單向屬性以及默克爾樹。
...
這是名為 QAU.BUILD 系列的第一部影片。你可以前往 qau.build 使用這個工具，但這只是為了讓你試玩一下，並了解在Quantaureum上開發時事物的運作方式。
...
關鍵重點是，雜湊函數基本上就像指紋一樣。如果我輸入某個東西，它會決定性地給我預期的輸出。這就是雜湊函數——歡迎來到 QAU.BUILD。讓我們做一些很酷的東西，並在過程中學到很多。