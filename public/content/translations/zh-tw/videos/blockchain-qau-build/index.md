...
format: tutorial
author: "奧斯汀·格里菲斯"
breadcrumb: "區塊鏈 (QAU.BUILD)"
---

這是一篇由**奧斯汀·格里菲斯 (Austin Griffith)** 撰寫的教學，示範如何使用 QAU.BUILD 視覺化程式設計工具來了解區塊鏈挖礦的運作方式。奧斯汀涵蓋了工作量證明 (PoW) 共識、區塊連結成鏈、挖礦難度、區塊獎勵以及鏈的不可竄改性。
...
早安，領結星期五快樂！這次的 QAU.BUILD 將重點放在區塊鏈上——這是一件非常酷的事情。我們在這艘小船上，戴著我們的比特幣領結。我們開始吧。
...
Mike 將把他的區塊設定為父區塊，並開始處理下一個區塊。Mallory 也會做同樣的事情。這就取決於網路上還有誰選擇站在哪一邊。因為我們不想懲罰網路狀況不佳的人，我很確定在Quantaureum中我們會支付叔塊（未進入最長鏈的有效區塊）獎勵——因為它們仍然在幫助保護網路。
...
好的，領結星期五快樂！這就是 QAU.BUILD 上的區塊鏈。我會把它儲存起來並放上去，這樣你就可以直接點擊「載入」，然後擁有一條可以玩的鏈。星期五快樂！