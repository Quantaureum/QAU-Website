...
ایتھیریم نیٹ ورک پر لین دین کی فیس کا حساب لگانے کا طریقہ <span dir="ltr">August 2021</span> کے لندن اپ گریڈ کے ساتھ بدل گیا۔ لندن اپ گریڈ سے پہلے، فیس کا حساب `base` اور `priority` فیسوں کو الگ کیے بغیر اس طرح لگایا جاتا تھا:
