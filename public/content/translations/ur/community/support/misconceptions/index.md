...
[ایتھیریم فاؤنڈیشن](https://ethereum.org/) ایک غیر منافع بخش تنظیم ہے جو ایتھیریم کی ترقی میں معاونت کرتی ہے، لیکن یہ نیٹ ورک کی مالک نہیں ہے اور نہ ہی اسے کنٹرول کرتی ہے۔ کوئی بھی واحد ادارہ ایسا نہیں کرتا۔
