...
اس پروجیکٹ کے لیے ہم نے مکمل <span dir="ltr">ERC20 ABI</span> کو مختصر کر دیا ہے تاکہ صرف `balanceOf` اور `transfer` فنکشن کو رکھا جا سکے لیکن آپ مکمل <span dir="ltr">ERC20 ABI</span> یہاں تلاش کر سکتے ہیں۔
...
چونکہ فنکشن صرف ٹرانزیکشن کو بلاک چین میں جمع کراتا ہے، ہم اس وقت تک نتیجہ نہیں دیکھ سکتے جب تک ہمیں یہ معلوم نہ ہو جائے کہ اسے کب مائن کیا گیا ہے اور بلاک چین میں شامل کیا گیا ہے۔ اگلے ٹیوٹوریل میں ہم سیکھیں گے کہ کسی ٹرانزیکشن کا ہیش جان کر بلاک چین پر اس کے نافذ ہونے کا انتظار کیسے کیا جائے۔