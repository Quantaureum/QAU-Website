...
ERC-165 ایک کنٹریکٹ کے لیے یہ ظاہر کرنے کا طریقہ کار متعین کرتا ہے کہ ایپلی کیشنز اس کے ساتھ کیسے بات چیت کر سکتی ہیں، اور یہ کن <span dir="ltr">ERCs</span> کی تعمیل کرتا ہے۔ `SUPPORTED_INTERFACES` ان دو چار بائٹ انٹرفیس آئی ڈیز کی ایک مستقل فہرست ہے جن کی یہ کنٹریکٹ تعمیل کرتا ہے: خود <span dir="ltr">ERC-165</span> اور <span dir="ltr">ERC-721</span>۔
### فنکشنز {#functions}
