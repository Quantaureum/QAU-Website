...
- `@openzeppelin/contracts/token/ERC721/ERC721.sol` میں <span dir="ltr">ERC-721</span> معیار کا عمل درآمد شامل ہے، جسے ہمارا <span dir="ltr">NFT</span> سمارٹ کنٹریکٹ وراثت میں لے گا۔ (ایک درست <span dir="ltr">NFT</span> ہونے کے لیے، آپ کے سمارٹ کنٹریکٹ کو <span dir="ltr">ERC-721</span> معیار کے تمام طریقوں کو نافذ کرنا چاہیے۔) وراثت میں ملے <span dir="ltr">ERC-721</span> فنکشنز کے بارے میں مزید جاننے کے لیے، انٹرفیس کی تعریف یہاں دیکھیں۔
