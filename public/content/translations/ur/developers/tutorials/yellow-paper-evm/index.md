...
- اسے صرف انسان ہی سمجھ سکتے ہیں، جس کا مطلب ہے کہ تعمیل کے ٹیسٹ دستی طور پر لکھے جانے چاہئیں۔
- پروگرامرز کمپیوٹر کوڈ کو سمجھتے ہیں۔
  وہ ریاضیاتی اشارے کو سمجھ بھی سکتے ہیں اور نہیں بھی۔

شاید انہی وجوہات کی بنا پر، نئی اتفاق رائے کی تہہ کی تفصیلات Python میں لکھی گئی ہیں۔ Python میں عمل درآمد کی تہہ کی تفصیلات موجود ہیں، لیکن وہ مکمل نہیں ہیں۔ جب تک کہ پورا یلو پیپر بھی Python یا اس جیسی کسی زبان میں ترجمہ نہیں ہو جاتا، یلو پیپر سروس میں رہے گا، اور اسے پڑھنے کے قابل ہونا مددگار ہے۔
