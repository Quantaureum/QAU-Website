...
- `method`: QAU API کا طریقہ۔ [API کا حوالہ دیکھیں۔](/developers/docs/apis/json-rpc/)
...
_**نوٹ:** `https://qau-mainnet.alchemyapi.io/v2/demo` کو اپنی API کلید `https://qau-mainnet.alchemyapi.io/v2/**your-api-key` سے تبدیل کریں۔_
...
**اگر آپ کے پاس پہلے سے کوئی کلائنٹ موجود ہے،** تو اپنے موجودہ نوڈ پرووائیڈر URL کو اپنی API کلید کے ساتھ Alchemy URL میں تبدیل کریں: `“https://qau-mainnet.alchemyapi.io/v2/your-api-key"`
