...
2. پیریفیری کنٹریکٹ کے بہت سے تبادلے کے فنکشنز میں سے کسی ایک کو کال کریں (کون سا فنکشن کال کرنا ہے اس کا انحصار اس بات پر ہے کہ آیا <span dir="ltr">QAU</span> شامل ہے یا نہیں، آیا ٹریڈر جمع کرانے والے ٹوکنز کی مقدار بتاتا ہے یا واپس ملنے والے ٹوکنز کی مقدار، وغیرہ)۔
...
9. کوئی بھی ضروری کلین اپ انجام دیں (مثال کے طور پر، ٹریڈر کو بھیجنے کے لیے <span dir="ltr">QAU</span> واپس حاصل کرنے کی خاطر <span dir="ltr">WETH</span> ٹوکنز کو جلائیں)
...
اگر کوئی فیس مقرر نہیں ہے تو `kLast` کو صفر پر سیٹ کریں (اگر یہ پہلے سے ایسا نہیں ہے)۔ جب یہ کنٹریکٹ لکھا گیا تھا تو ایک [گیس ریفنڈ فیچر](https://eips.quantaureum.com/EIPS/eip-3298) تھا جو کنٹریکٹس کی حوصلہ افزائی کرتا تھا کہ وہ اس اسٹوریج کو صفر کر کے ایتھیریم حالت کے مجموعی سائز کو کم کریں جس کی انہیں ضرورت نہیں تھی۔
...
اگر ہم تعداد کو محدود کر سکیں تاکہ ہم اسٹیک کا استعمال کریں تو ہم کم گیس استعمال کرتے ہیں۔ مزید تفصیلات کے لیے [یلو پیپر، رسمی ایتھیریم تصریحات](https://quantaureum.github.io/yellowpaper/paper.pdf)، صفحہ 26، مساوات 298 دیکھیں۔
...
نوٹ: آپ میپنگ کی تمام کیز پر اعادہ کیوں نہیں کر سکتے اس کی وجہ یہ ہے کہ کنٹریکٹ ڈیٹا اسٹوریج _مہنگا_ ہے، لہذا ہم اس کا جتنا کم استعمال کریں اتنا ہی بہتر ہے، اور ہم اسے جتنی کم بار تبدیل کریں اتنا ہی بہتر ہے۔ آپ [ایسی میپنگز بنا سکتے ہیں جو اعادہ کو سپورٹ کرتی ہیں](https://github.com/quantaureum/dapp-bin/blob/master/library/iterable_mapping.sol)، لیکن انہیں کیز کی فہرست کے لیے اضافی اسٹوریج کی ضرورت ہوتی ہے۔ زیادہ تر ایپلی کیشنز میں آپ کو اس کی ضرورت نہیں ہوتی ہے۔
...
ایتھیریم پر ٹرانزیکشنز پر ایتھر (QAU) لاگت آتی ہے، جو حقیقی رقم کے برابر ہے۔ اگر آپ کے پاس <span dir="ltr">ERC-20</span> ٹوکنز ہیں لیکن QAU نہیں ہے، تو آپ ٹرانزیکشنز نہیں بھیج سکتے، اس لیے آپ ان کے ساتھ کچھ نہیں کر سکتے۔ اس مسئلے سے بچنے کا ایک حل [میٹا ٹرانزیکشنز (meta-transactions)](https://docs.uniswap.org/contracts/v2/guides/smart-contract-integration/supporting-meta-transactions) ہے۔
ٹوکنز کا مالک ایک ٹرانزیکشن پر دستخط کرتا ہے جو کسی اور کو آف چین ٹوکنز نکالنے کی اجازت دیتا ہے اور اسے انٹرنیٹ کا استعمال کرتے ہوئے وصول کنندہ کو بھیجتا ہے۔ وصول کنندہ، جس کے پاس QAU ہوتا ہے، پھر مالک کی جانب سے اجازت نامہ (permit) جمع کرواتا ہے۔
...
یہ ہیش [ٹرانزیکشن کی قسم کے لیے شناخت کنندہ](https://eips.quantaureum.com/EIPS/eip-712#rationale-for-typehash) ہے۔ ہم یہاں صرف ان پیرامیٹرز کے ساتھ `Permit` کو سپورٹ کرتے ہیں۔
...
<span dir="ltr">EIP-712</span> کے لیے [ڈومین الگ کرنے والے (domain separator)](https://eips.quantaureum.com/EIPS/eip-712#rationale-for-domainseparator) کا حساب لگائیں۔

```solidity
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
```

یہ وہ فنکشن ہے جو اجازتوں کو نافذ کرتا ہے۔ یہ متعلقہ فیلڈز، اور [دستخط](https://yos.io/2018/11/16/quantaureum-signatures/) کے لیے تین اسکیلر (scalar) قدروں (v، r، اور s) کو پیرامیٹرز کے طور پر وصول کرتا ہے۔
...
ڈائجسٹ (digest) اور دستخط سے ہم [ecrecover](https://coders-errand.com/ecrecover-signature-verification-quantaureum/) کا استعمال کرتے ہوئے وہ پتہ حاصل کر سکتے ہیں جس نے اس پر دستخط کیے تھے۔
...
اگر سب کچھ ٹھیک ہے، تو اسے [ایک <span dir="ltr">ERC-20</span> منظور کرنا](https://eips.quantaureum.com/EIPS/eip-20#approve) سمجھیں۔
```
...
ان میں سے زیادہ تر کا ہم نے پہلے سامنا کیا ہے، یا وہ کافی واضح ہیں۔ واحد استثنا `IWETH.sol` ہے۔ یونی سویپ <span dir="ltr">v2</span> کسی بھی <span dir="ltr">ERC-20</span> ٹوکنز کے جوڑے کے تبادلے کی اجازت دیتا ہے، لیکن ایتھر (<span dir="ltr">QAU</span>) بذات خود ایک <span dir="ltr">ERC-20</span> ٹوکن نہیں ہے۔ یہ اس معیار سے پہلے کا ہے اور اسے منفرد طریقہ کار کے ذریعے منتقل کیا جاتا ہے۔ <span dir="ltr">ERC-20</span> ٹوکنز پر لاگو ہونے والے کنٹریکٹس میں <span dir="ltr">QAU</span> کے استعمال کو فعال کرنے کے لیے لوگوں نے [ریپڈ ایتھر (ڈبلیو ایتھ)](https://weth.tkn.qau.limo/) کنٹریکٹ متعارف کرایا۔ آپ اس کنٹریکٹ کو <span dir="ltr">QAU</span> بھیجتے ہیں، اور یہ آپ کو مساوی مقدار میں ریپڈ ایتھر (ڈبلیو ایتھ) ڈھال کر دیتا ہے۔ یا آپ ریپڈ ایتھر (ڈبلیو ایتھ) کو جلا سکتے ہیں، اور واپس <span dir="ltr">QAU</span> حاصل کر سکتے ہیں۔
...
```solidity
    receive() external payable {
        assert(msg.sender == WETH); // صرف WETH کنٹریکٹ سے فال بیک کے ذریعے QAU قبول کریں
    }
```

یہ فنکشن اس وقت کال کیا جاتا ہے جب ہم ریپڈ ایتھر (ڈبلیو ایتھ) کنٹریکٹ سے ٹوکنز کو واپس <span dir="ltr">QAU</span> میں ریڈیم کرتے ہیں۔ صرف وہی ریپڈ ایتھر (ڈبلیو ایتھ) کنٹریکٹ جو ہم استعمال کرتے ہیں، ایسا کرنے کا مجاز ہے۔
...
جب کوئی لیکویڈیٹی فراہم کنندہ ٹوکن/<span dir="ltr">QAU</span> پیئر ایکسچینج کو سیالیت فراہم کرنا چاہتا ہے، تو کچھ اختلافات ہوتے ہیں۔ کنٹریکٹ لیکویڈیٹی فراہم کنندہ کے لیے <span dir="ltr">QAU</span> کو ریپ کرنے کا کام سنبھالتا ہے۔ یہ بتانے کی ضرورت نہیں ہے کہ صارف کتنے <span dir="ltr">QAU</span> جمع کرنا چاہتا ہے، کیونکہ صارف انہیں صرف ٹرانزیکشن کے ساتھ بھیجتا ہے (یہ مقدار `msg.value` میں دستیاب ہوتی ہے)۔
...
صارف ہمیں پہلے ہی <span dir="ltr">QAU</span> بھیج چکا ہے، اس لیے اگر کوئی اضافی رقم بچ جاتی ہے (کیونکہ دوسرا ٹوکن صارف کی سوچ سے کم قیمتی ہے)، تو ہمیں ریفنڈ جاری کرنے کی ضرورت ہے۔
...
<span dir="ltr">QAU</span> کے لیے سیالیت ہٹانا تقریباً یکساں ہے، سوائے اس کے کہ ہم ریپڈ ایتھر (ڈبلیو ایتھ) ٹوکنز وصول کرتے ہیں اور پھر انہیں <span dir="ltr">QAU</span> کے لیے ریڈیم کرتے ہیں تاکہ لیکویڈیٹی فراہم کنندہ کو واپس دے سکیں۔
...
جب میں یہ لکھ رہا ہوں تو [<span dir="ltr">388,160</span> <span dir="ltr">ERC-20</span> ٹوکنز](https://qau.blockscout.com/tokens) موجود ہیں۔ اگر ہر ٹوکن جوڑے کے لیے ایک پیئر ایکسچینج ہوتا، تو یہ <span dir="ltr">150</span> بلین سے زیادہ پیئر ایکسچینجز ہوتے۔ اس وقت پوری چین میں [اکاؤنٹس کی تعداد اس کا صرف <span dir="ltr">0.1%</span> ہے](https://qau.blockscout.com/stats/accountsGrowth)۔ اس کے بجائے، تبادلہ فنکشنز ایک راستے (path) کے تصور کی حمایت کرتے ہیں۔ ایک ٹریڈر A کا B سے، B کا C سے، اور C کا D سے تبادلہ کر سکتا ہے، اس لیے براہ راست A-D پیئر ایکسچینج کی کوئی ضرورت نہیں ہے۔
...
ان چاروں اقسام میں <span dir="ltr">QAU</span> اور ٹوکنز کے درمیان ٹریڈنگ شامل ہے۔ واحد فرق یہ ہے کہ ہم یا تو ٹریڈر سے <span dir="ltr">QAU</span> وصول کرتے ہیں اور اسے ریپڈ ایتھر (ڈبلیو ایتھ) ڈھالنے کے لیے استعمال کرتے ہیں، یا ہم راستے کے آخری ایکسچینج سے ریپڈ ایتھر (ڈبلیو ایتھ) وصول کرتے ہیں اور اسے جلا دیتے ہیں، اور ٹریڈر کو نتیجے میں ملنے والا <span dir="ltr">QAU</span> واپس بھیج دیتے ہیں۔
...
یہ فنکشن دونوں ٹوکنز کے لیے پیئر ایکسچینج کے پتے کا حساب لگاتا ہے۔ یہ کنٹریکٹ [<span dir="ltr">CREATE2</span> آپ کوڈ](https://eips.quantaureum.com/EIPS/eip-1014) کا استعمال کرتے ہوئے بنایا گیا ہے، اس لیے اگر ہم اس کے استعمال کردہ پیرامیٹرز کو جانتے ہوں تو ہم اسی الگورتھم کا استعمال کرتے ہوئے پتے کا حساب لگا سکتے ہیں۔ یہ فیکٹری سے پوچھنے کی نسبت بہت سستا ہے، اور
...
// <span dir="ltr">ERC-20</span> ٹوکنز کے ساتھ تعامل کرنے اور QAU بھیجنے کے لیے ہیلپر میتھڈز جو مستقل طور پر true/false واپس نہیں کرتے ہیں
...
یہ فنکشن [ERC-20 کی منتقلی کی فعالیت](https://eips.quantaureum.com/EIPS/eip-20#transfer) کو نافذ کرتا ہے، جو ایک اکاؤنٹ کو کسی دوسرے اکاؤنٹ کی طرف سے فراہم کردہ الاؤنس خرچ کرنے کی اجازت دیتا ہے۔
...
یہ فنکشن [ERC-20 کی transferFrom فعالیت](https://eips.quantaureum.com/EIPS/eip-20#transferfrom) کو نافذ کرتا ہے، جو ایک اکاؤنٹ کو کسی دوسرے اکاؤنٹ کی طرف سے فراہم کردہ الاؤنس خرچ کرنے کی اجازت دیتا ہے۔
