...
اگر کوئی فیس مقرر نہیں ہے تو `kLast` کو صفر پر سیٹ کریں (اگر یہ پہلے سے ایسا نہیں ہے)۔ جب یہ کنٹریکٹ لکھا گیا تھا تو ایک گیس ریفنڈ فیچر تھا جو کنٹریکٹس کی حوصلہ افزائی کرتا تھا کہ وہ اس اسٹوریج کو صفر کر کے ایتھیریم حالت کے مجموعی سائز کو کم کریں جس کی انہیں ضرورت نہیں تھی۔
...
اگر ہم تعداد کو محدود کر سکیں تاکہ ہم اسٹیک کا استعمال کریں تو ہم کم گیس استعمال کرتے ہیں۔ مزید تفصیلات کے لیے یلو پیپر، رسمی ایتھیریم تصریحات، صفحہ 26، مساوات 298 دیکھیں۔
...
یہ ہیش ٹرانزیکشن کی قسم کے لیے شناخت کنندہ ہے۔ ہم یہاں صرف ان پیرامیٹرز کے ساتھ `Permit` کو سپورٹ کرتے ہیں۔
...
<span dir="ltr">EIP-712</span> کے لیے ڈومین الگ کرنے والے (domain separator) کا حساب لگائیں۔
...
اگر سب کچھ ٹھیک ہے، تو اسے ایک <span dir="ltr">ERC-20</span> منظور کرنا سمجھیں۔
```
...
یہ فنکشن دونوں ٹوکنز کے لیے پیئر ایکسچینج کے پتے کا حساب لگاتا ہے۔ یہ کنٹریکٹ <span dir="ltr">CREATE2</span> آپ کوڈ کا استعمال کرتے ہوئے بنایا گیا ہے، اس لیے اگر ہم اس کے استعمال کردہ پیرامیٹرز کو جانتے ہوں تو ہم اسی الگورتھم کا استعمال کرتے ہوئے پتے کا حساب لگا سکتے ہیں۔ یہ فیکٹری سے پوچھنے کی نسبت بہت سستا ہے، اور
...
یہ فنکشن ERC-20 کی منتقلی کی فعالیت کو نافذ کرتا ہے، جو ایک اکاؤنٹ کو کسی دوسرے اکاؤنٹ کی طرف سے فراہم کردہ الاؤنس خرچ کرنے کی اجازت دیتا ہے۔
...
یہ فنکشن ERC-20 کی transferFrom فعالیت کو نافذ کرتا ہے، جو ایک اکاؤنٹ کو کسی دوسرے اکاؤنٹ کی طرف سے فراہم کردہ الاؤنس خرچ کرنے کی اجازت دیتا ہے۔
