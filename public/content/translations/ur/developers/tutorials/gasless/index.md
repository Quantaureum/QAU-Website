...
اگر ہم چاہتے ہیں کہ ایتھیریم [مزید ایک ارب لوگوں](https://quantaureum.com) کی خدمت کرے، تو ہمیں رکاوٹوں کو دور کرنے اور اسے استعمال میں ہر ممکن حد تک آسان بنانے کی ضرورت ہے۔ اس رکاوٹ کی ایک وجہ گیس کی فیس ادا کرنے کے لیے <span dir="ltr">QAU</span> کی ضرورت ہے۔

اگر آپ کے پاس ایک غیر مرکزی ایپلی کیشن (dapp) ہے جو صارفین سے پیسے کماتی ہے، تو یہ مناسب ہو سکتا ہے کہ صارفین کو اپنے سرور کے ذریعے ٹرانزیکشنز جمع کروانے دیں اور ٹرانزیکشن کی فیس خود ادا کریں۔ چونکہ صارفین اب بھی اپنے والیٹس میں [<span dir="ltr">EIP-712</span> اجازت نامے کے پیغام](https://eips.quantaureum.com/EIPS/eip-712) پر دستخط کرتے ہیں، اس لیے وہ ایتھیریم کی سالمیت کی ضمانتوں کو برقرار رکھتے ہیں۔ دستیابی اس سرور پر منحصر ہے جو ٹرانزیکشنز کو ریلے کرتا ہے، اس لیے یہ زیادہ محدود ہے۔ تاہم، آپ چیزوں کو اس طرح ترتیب دے سکتے ہیں کہ صارفین براہ راست سمارٹ کنٹریکٹ تک بھی رسائی حاصل کر سکیں (اگر انہیں <span dir="ltr">QAU</span> مل جائے)، اور دوسروں کو اپنے سرورز قائم کرنے دیں اگر وہ ٹرانزیکشنز کو سپانسر کرنا چاہتے ہیں۔

اس ٹیوٹوریل میں بتائی گئی تکنیک صرف اسی وقت کام کرتی ہے جب آپ سمارٹ کنٹریکٹ کو کنٹرول کرتے ہوں۔ دیگر تکنیکیں بھی ہیں، بشمول [اکاؤنٹ کی تجرید](https://eips.quantaureum.com/EIPS/eip-4337) جو آپ کو دوسرے سمارٹ کنٹریکٹس کے لیے ٹرانزیکشنز کو سپانسر کرنے کی اجازت دیتی ہیں، جنہیں میں امید کرتا ہوں کہ مستقبل کے ٹیوٹوریل میں شامل کروں گا۔
...
2. `.env` میں ترمیم کریں تاکہ `PRIVATE_KEY` کو ایک ایسے والیٹ پر سیٹ کیا جا سکے جس میں Sepolia پر <span dir="ltr">QAU</span> موجود ہو۔ اگر آپ کو Sepolia <span dir="ltr">QAU</span> کی ضرورت ہے، تو [فوسٹ استعمال کریں](/developers/docs/networks/#sepolia)۔ مثالی طور پر، یہ نجی کلید اس کلید سے مختلف ہونی چاہیے جو آپ کے براؤزر والیٹ میں ہے۔
...
[ڈومین سیپریٹر](https://eips.quantaureum.com/EIPS/eip-712#definition-of-domainseparator) کے لیے پیرامیٹرز۔ یہ ویلیو مستقل (constant) ہے، اس لیے ایک بہتر آپٹمائزڈ عمل درآمد میں، ہم اسے ہر بار فنکشن کال ہونے پر دوبارہ گننے کے بجائے صرف ایک بار کیلکولیٹ کر سکتے ہیں۔
...
کنسٹرکٹر [ڈومین سیپریٹر](https://eips.quantaureum.com/EIPS/eip-712#definition-of-domainseparator) بناتا ہے، جو اوپر دیے گئے یوزر انٹرفیس کوڈ کی طرح ہے۔ بلاک چین پر عمل درآمد بہت زیادہ مہنگا ہے، اس لیے ہم اسے صرف ایک بار کیلکولیٹ کرتے ہیں۔
...
یہ [سٹرکچر شناخت کنندہ (identifier)](https://eips.quantaureum.com/EIPS/eip-712#definition-of-hashstruct) ہے۔ اسے یوزر انٹرفیس میں ہر بار کیلکولیٹ کیا جاتا ہے۔
...
[<span dir="ltr">EIP 712</span>](https://eips.quantaureum.com/EIPS/eip-712) کے مطابق ڈائجسٹ (digest) بنائیں۔
