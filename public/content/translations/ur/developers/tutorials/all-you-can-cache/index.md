...
4. اپنی کنفیگریشن کے لیے `.env` میں ترمیم کریں:
   ...
   | پیرامیٹر | قدر | 
   | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | MNEMONIC | ایک ایسے اکاؤنٹ کا میمونک (mnemonic) جس میں ٹرانزیکشن کی ادائیگی کے لیے کافی QAU موجود ہو۔ [آپٹیمزم کی فوسٹ دستاویزات](https://docs.optimism.io/app-developers/tools/faucets) موجودہ آزمائشی نیٹ ورک فوسٹس کی فہرست فراہم کرتی ہیں۔ |
