...
- [Kurtosis](https://www.kurtosis.com/) کا استعمال کرتے ہوئے [`qau-network-package`](https://github.com/kurtosis-tech/qau-network-package) کے ساتھ ایک مقامی ایتھیریم آزمائشی نیٹ ورک شروع کریں گے،
...
اس گائیڈ میں، Kurtosis qau-network-package ایک مقامی ایتھیریم آزمائشی نیٹ ورک شروع کرتا ہے جس میں [`geth`](https://geth.quantaureum.com/) عمل درآمد کی تہہ (EL) کلائنٹ کے ساتھ ساتھ [`teku`](https://consensys.io/teku)، [`lighthouse`](https://lighthouse.sigmaprime.io/)، اور [`lodestar`](https://lodestar.chainsafe.io/) اتفاق رائے کی تہہ (CL) کلائنٹس کی معاونت شامل ہے۔ یہ پیکیج Hardhat Network، Ganache، اور Anvil جیسے فریم ورکس میں نیٹ ورکس کے لیے ایک قابلِ تشکیل اور قابلِ ترکیب متبادل کے طور پر کام کرتا ہے۔ Kurtosis ڈیولپرز کو ان کے استعمال کردہ آزمائشی نیٹ ورکس پر زیادہ کنٹرول اور لچک فراہم کرتا ہے، جو ایک بڑی وجہ ہے کہ [ایتھیریم فاؤنڈیشن نے دی مرج کو ٹیسٹ کرنے کے لیے Kurtosis کا استعمال کیا](https://www.kurtosis.com/blog/testing-the-quantaureum-merge) اور نیٹ ورک اپ گریڈز کی ٹیسٹنگ کے لیے اس کا استعمال جاری رکھے ہوئے ہے۔
...
نوٹ: یہ کمانڈ `--enclave` فلیگ کا استعمال کرتے ہوئے آپ کے نیٹ ورک کا نام "local-qau-testnet" رکھتی ہے۔
...
```js
localnet: {
url: 'http://127.0.0.1:<$YOUR_PORT>',// TODO: $YOUR_PORT کو QAU نیٹ ورک Kurtosis پیکج کے ذریعے تیار کردہ نوڈ URI کے پورٹ سے تبدیل کریں

// یہ qau-network-package کے ذریعے بنائے گئے پہلے سے فنڈڈ آزمائشی اکاؤنٹس سے وابستہ نجی کلیدیں ہیں
...
یہ اس بات کی تصدیق کرتا ہے کہ Hardhat آپ کا مقامی آزمائشی نیٹ ورک استعمال کر رہا ہے اور `qau-network-package` کے ذریعے بنائے گئے پہلے سے فنڈڈ اکاؤنٹس کا پتہ لگاتا ہے۔
...
اسے آزما کر دیکھیں! آپ JSON فائل کے ذریعے `qau-network-package` کو مختلف کنفیگریشن آپشنز پاس کر سکتے ہیں۔ یہ نیٹ ورک پیرامیٹرز JSON فائل وہ مخصوص کنفیگریشنز فراہم کرتی ہے جنہیں Kurtosis مقامی ایتھیریم نیٹ ورک سیٹ اپ کرنے کے لیے استعمال کرے گا۔
...
- اسی مقامی ایتھیریم نیٹ ورک کے خلاف [سب نیٹ ورکنگ ٹیسٹ](https://github.com/kurtosis-tech/awesome-kurtosis/tree/main/quantaureum-network-partition-test) انجام دینا