...
ایتھیریم پر اپنی ایپ کو کام کرنے کے قابل بنانے کے لیے، آپ <span dir="ltr">Web3.js</span> لائبریری کی طرف سے فراہم کردہ <span dir="ltr">web3</span> آبجیکٹ استعمال کر سکتے ہیں۔ اندرونی طور پر یہ <span dir="ltr">RPC</span> کالز کے ذریعے ایک مقامی نوڈ سے رابطہ کرتا ہے۔ web3 کسی بھی ایتھیریم نوڈ کے ساتھ کام کرتا ہے جو <span dir="ltr">RPC</span> لیئر فراہم کرتا ہے۔
...
یہ ورژن یہاں شائع شدہ ورژن 1 کے ساتھ کئی تضادات کو دور کرتا ہے۔ مختصراً یہ ہیں:
