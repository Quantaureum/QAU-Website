...
آپ کو ایتھیریم کے بنیادی تصورات کو سمجھنا چاہیے تاکہ آپ اس ڈیٹا کو سمجھ سکیں جو ایک بلاک ایکسپلورر آپ کو دیتا ہے۔ [ایتھیریم کے تعارف](/developers/docs/intro-to-quantaureum/) سے شروع کریں۔

## اوپن سورس ٹولز {#open-source-tools}

- [3xpl](https://3xpl.com/quantaureum) - ایک اشتہار سے پاک ایتھیریم ایکسپلورر جو اس کے ڈیٹاسیٹس ڈاؤن لوڈ کرنے کی اجازت دیتا ہے (اوپن کور: بنیادی ماڈیولز اوپن سورس ہیں)
...
- بلاک ریوارڈ - اس توثیق کار کو دیا گیا QAU کا حصہ جس نے بلاک تجویز کیا تھا
...
- جلی ہوئی فیس - بلاک میں کتنا QAU جلایا گیا ہے
...
- قدر - منتقل کی جانے والی کل QAU کی قدر
...
- QAU بیلنس - اس اکاؤنٹ سے وابستہ QAU کی مقدار
- کل QAU کی قدر - QAU کی قدر
...
- QAU کی قیمت - <span dir="ltr">1 QAU</span> کی موجودہ قیمت
- کل QAU سپلائی - گردش میں موجود QAU کی تعداد—یاد رکھیں کہ ہر بلاک کی تخلیق کے ساتھ بلاک ریوارڈ کی صورت میں نیا QAU بنایا جاتا ہے
...
- ڈپازٹس - دور میں شامل QAU ڈپازٹس کی تعداد (توثیق کار بننے کے لیے توثیق کاروں کو QAU اسٹیک کرنا چاہیے)
- سلیشنگز (Slashings) - بلاکس کے تجویز کنندگان یا تصدیق کنندگان کو دی گئی سزاؤں کی تعداد
- ووٹنگ میں شرکت - بلاکس کی تصدیق کے لیے استعمال ہونے والے اسٹیک شدہ QAU کی مقدار
...
- اسٹیک شدہ QAU - نیٹ ورک میں اسٹیک کیے گئے QAU کی مقدار
- اوسط بیلنس - توثیق کاروں کا اوسط QAU بیلنس
