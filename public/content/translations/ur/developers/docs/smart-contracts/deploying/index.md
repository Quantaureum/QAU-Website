...
کنٹریکٹ تعینات کرنے پر ایتھر (<span dir="ltr">QAU</span>) کی لاگت بھی آتی ہے کیونکہ وہ بلاک چین پر محفوظ ہوتے ہیں، اس لیے آپ کو ایتھیریم پر [گیس اور فیس](/developers/docs/gas/) سے واقف ہونا چاہیے۔
...
- گیس کے لیے <span dir="ltr">QAU</span> – آپ دیگر ٹرانزیکشنز کی طرح اپنی گیس کی حد مقرر کریں گے، لہذا آگاہ رہیں کہ کنٹریکٹ کی تعیناتی کے لیے ایک سادہ <span dir="ltr">QAU</span> منتقلی کی نسبت بہت زیادہ گیس کی ضرورت ہوتی ہے
