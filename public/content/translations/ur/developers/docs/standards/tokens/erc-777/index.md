...
ہکس کو <span dir="ltr">ERC-1820</span> سٹینڈرڈ کا استعمال کرتے ہوئے رجسٹر اور دریافت کیا جاتا ہے۔

#### ہکس کیوں شاندار ہیں؟ {#why-are-hooks-great}

1. ہکس ایک ہی ٹرانزیکشن میں کنٹریکٹ کو ٹوکن بھیجنے اور کنٹریکٹ کو مطلع کرنے کی اجازت دیتے ہیں، برخلاف <span dir="ltr">ERC-20</span> کے، جسے یہ حاصل کرنے کے لیے ڈبل کال (`approve`/`transferFrom`) کی ضرورت ہوتی ہے۔
...
<span dir="ltr">EIP-777</span>: ٹوکن سٹینڈرڈ