...
عام طور پر معیارات کو ایتھیریم امپروومنٹ پروپوزلز (<span dir="ltr">EIPs</span>) کے طور پر متعارف کرایا جاتا ہے، جن پر کمیونٹی ممبران ایک [معیاری عمل](https://eips.ethereum.org/EIPS/eip-1) کے ذریعے تبادلہ خیال کرتے ہیں۔

- <span dir="ltr">EIPs</span> کا تعارف
...
- ایتھیریم امپروومنٹ پروپوزلز (<span dir="ltr">EIPs</span>)
