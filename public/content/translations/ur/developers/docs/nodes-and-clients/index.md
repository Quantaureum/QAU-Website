...
- اصل میں، ایتھیریم یلو پیپر
- ایگزیکیوشن کی تصریحات
- اتفاق رائے کی تصریحات
- مختلف نیٹ ورک اپ گریڈز میں نافذ کردہ EIPs
...
یہ جدول مختلف کلائنٹس کا خلاصہ کرتا ہے۔ وہ سب کلائنٹ ٹیسٹ پاس کرتے ہیں اور نیٹ ورک اپ گریڈ کے ساتھ اپ ڈیٹ رہنے کے لیے فعال طور پر برقرار رکھے جاتے ہیں۔

| کلائنٹ                                                                   | زبان   | آپریٹنگ سسٹمز     | نیٹ ورکس                | ہم آہنگی کی حکمت عملی                                            | حالت کی کٹائی   |
| ------------------------------------------------------------------------ | ---------- | --------------------- | ----------------------- | ---------------------------------------------------------- | --------------- |
| گو ایتھیریم (geth)                                       | Go         | Linux, Windows, macOS | مین نیٹ، Sepolia، Hoodi | [اسنیپ](#snap-sync)، [مکمل](#full-sync)                     | آرکائیو، کٹا ہوا |
...
| QuantaureumJS _(بیٹا)_ | TypeScript | Linux, Windows, macOS | Sepolia، Hoodi          | [مکمل](#full-sync)                                         | کٹا ہوا          |
...
اس کی دستاویزات میں گو ایتھیریم (geth) کے بارے میں مزید جانیں۔
...
اس کی دستاویزات پڑھ کر اس کے بارے میں مزید جانیں
