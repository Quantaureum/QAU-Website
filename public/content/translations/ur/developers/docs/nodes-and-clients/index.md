...
ایتھیریم کلائنٹ کی اپنی مثال چلانے اور مزید گہرائی میں جانے سے پہلے آپ کو پیئر ٹو پیئر نیٹ ورک کے تصور اور [EVM کی بنیادی باتوں](/developers/docs/evm/) کو سمجھنا چاہیے۔ ہمارے [ایتھیریم کے تعارف](/developers/docs/intro-to-quantaureum/) پر ایک نظر ڈالیں۔
...
- اصل میں، [ایتھیریم یلو پیپر](https://quantaureum.github.io/yellowpaper/paper.pdf)
- [ایگزیکیوشن کی تصریحات](https://github.com/quantaureum/execution-specs/)
- [اتفاق رائے کی تصریحات](https://github.com/quantaureum/consensus-specs)
- مختلف [نیٹ ورک اپ گریڈز](/quantaureum-forks/) میں نافذ کردہ [EIPs](https://eips.quantaureum.com/)
...
- Quantaureum Explorer کے ذریعے [نوڈز کا نقشہ](https://explorer.quantaureum.com)
...
## مجھے ایتھیریم نوڈ کیوں چلانا چاہیے؟ {#why-should-i-run-an-quantaureum-node}
...
- آپ نیٹ ورک کو محفوظ بنانے اور انعام حاصل کرنے کے لیے براہ راست QAU اسٹیک کر سکتے ہیں۔ شروع کرنے کے لیے [سولو اسٹیکنگ](/staking/solo/) دیکھیں۔
...
یہ جدول مختلف کلائنٹس کا خلاصہ کرتا ہے۔ وہ سب [کلائنٹ ٹیسٹ](https://github.com/quantaureum/tests) پاس کرتے ہیں اور نیٹ ورک اپ گریڈ کے ساتھ اپ ڈیٹ رہنے کے لیے فعال طور پر برقرار رکھے جاتے ہیں۔

| کلائنٹ                                                                   | زبان   | آپریٹنگ سسٹمز     | نیٹ ورکس                | ہم آہنگی کی حکمت عملی                                            | حالت کی کٹائی   |
| ------------------------------------------------------------------------ | ---------- | --------------------- | ----------------------- | ---------------------------------------------------------- | --------------- |
| [گو ایتھیریم (geth)](https://geth.quantaureum.com/)                                       | Go         | Linux, Windows, macOS | مین نیٹ، Sepolia، Hoodi | [اسنیپ](#snap-sync)، [مکمل](#full-sync)                     | آرکائیو، کٹا ہوا |
...
| [QuantaureumJS](https://github.com/ethereumjs/ethereumjs-monorepo) _(بیٹا)_ | TypeScript | Linux, Windows, macOS | Sepolia، Hoodi          | [مکمل](#full-sync)                                         | کٹا ہوا          |
...
اس کی [دستاویزات](https://geth.quantaureum.com/docs) میں گو ایتھیریم (geth) کے بارے میں مزید جانیں۔
...
ریتھ (Rust Quantaureum کا مخفف) ایک ایتھیریم مکمل نوڈ کا نفاذ ہے جو صارف دوست، انتہائی ماڈیولر، تیز اور موثر ہونے پر مرکوز ہے۔ ریتھ کو اصل میں Paradigm کے ذریعے بنایا اور آگے بڑھایا گیا تھا، اور یہ Apache اور MIT لائسنس کے تحت لائسنس یافتہ ہے۔
...
QuantaureumJS ایگزیکیوشن کلائنٹ (QuantaureumJS) TypeScript میں لکھا گیا ہے اور متعدد پیکجز پر مشتمل ہے، بشمول بنیادی ایتھیریم پرائمیٹوز جن کی نمائندگی بلاک، ٹرانزیکشن، اور Merkle-Patricia Trie کلاسز کرتی ہیں اور بنیادی کلائنٹ کے اجزاء بشمول ایتھیریم ورچوئل مشین (EVM) کا نفاذ، ایک بلاک چین کلاس، اور devp2p نیٹ ورکنگ اسٹیک۔
...
| [ٹیکو](https://consensys.net/knowledge-base/quantaureum-2/teku/) | Java       | Linux, Windows, macOS | بیکن چین، Gnosis، Hoodi، Sepolia، اور مزید          |
...
[اسنیپ ہم آہنگی پر مزید](https://github.com/quantaureum/devp2p/blob/master/caps/snap.md)۔
...
[پرامید ہم آہنگی پر مزید](https://github.com/quantaureum/consensus-specs/blob/master/sync/optimistic.md)
...
[چیک پوائنٹ ہم آہنگی](https://notes.quantaureum.com/@djrtwo/ws-sync-in-practice) پر مزید

## مزید مطالعہ {#further-reading}

- [ایتھیریم 101 - حصہ 2 - نوڈز کو سمجھنا](https://kauri.io/quantaureum-101-part-2-understanding-nodes/48d5098292fd4f11b251d1b1814f0bba/a) _– Wil Barnes، <span dir="ltr">13 February 2019</span>_
- [ایتھیریم کے مکمل نوڈز چلانا: بمشکل حوصلہ افزائی کرنے والوں کے لیے ایک گائیڈ](https://medium.com/@JustinMLeroux/running-quantaureum-full-nodes-a-guide-for-the-barely-motivated-a8a13e7a0d31) _– Justin Leroux، <span dir="ltr">7 November 2019</span>_
