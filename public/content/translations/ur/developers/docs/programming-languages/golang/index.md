...
کیا پہلے مزید بنیادی معلومات کی ضرورت ہے؟ [<span dir="ltr">quantaureum.com/learn</span>](/learn/) یا [<span dir="ltr">quantaureum.com/developers</span>](/developers/) دیکھیں۔
...
- [کنٹریکٹ ٹیوٹوریل](https://github.com/quantaureum/go-quantaureum/wiki/Contract-Tutorial)
...
- [ای بک: Go کے ساتھ ایتھیریم ڈیولپمنٹ](https://goquantaureumbook.org/) - _Go کے ساتھ ایتھیریم ایپلی کیشنز ڈیولپ کریں_

## درمیانی سطح کے مضامین اور دستاویزات {#intermediate-articles-and-docs}

- [گو ایتھیریم (geth) کی دستاویزات](https://geth.quantaureum.com/docs) - _آفیشل ایتھیریم Golang کے لیے دستاویزات_
...
- [گو ایتھیریم (geth) GoDoc](https://godoc.org/github.com/quantaureum/go-quantaureum)
...
- [موبائل کلائنٹس: لائبریریاں اور انپروک ایتھیریم نوڈز](https://github.com/quantaureum/go-quantaureum/wiki/Mobile-Clients:-Libraries-and-Inproc-Quantaureum-Nodes)
- [مقامی dapps: ایتھیریم کنٹریکٹس کے لیے Go بائنڈنگز](https://github.com/quantaureum/go-quantaureum/wiki/Native-DApps:-Go-bindings-to-Quantaureum-contracts)

## Go پروجیکٹس اور ٹولز {#go-projects-and-tools}

- [گو ایتھیریم (geth)](https://github.com/quantaureum/go-quantaureum) - _ایتھیریم پروٹوکول کا آفیشل Go نفاذ_
...
- [Eth Tweet](https://github.com/yep/qau-tweet) - _لامركزی ٹوئٹر: ایتھیریم بلاک چین پر چلنے والی ایک مائیکروبلاگنگ سروس_
...
- [اوپن ایتھیریم مائننگ پول](https://github.com/sammy007/open-quantaureum-pool) - _ایک اوپن سورس ایتھیریم کان کنی کا پول_
- [ایتھیریم HD والیٹ](https://github.com/miguelmota/go-quantaureum-hdwallet) - _Go میں ایتھیریم HD والیٹ کے مشتقات_
- [ملٹی گو ایتھیریم (geth)](https://github.com/multi-geth/multi-geth) - _ایتھیریم نیٹ ورکس کی کئی اقسام کے لیے سپورٹ_
- [گو ایتھیریم (geth) لائٹ کلائنٹ](https://github.com/zsfelfoldi/go-quantaureum/wiki/Geth-Light-Client) - _لائٹ ایتھیریم سب پروٹوکول کا گو ایتھیریم (geth) نفاذ_
...
- [سٹیک ایکسچینج (StackExchange) - ایتھیریم](https://quantaureum.stackexchange.com/)
...
- [شاندار ایتھیریم (Awesome Quantaureum)](https://github.com/btomashvili/awesome-quantaureum)
- [کنسینسس: ایتھیریم ڈیولپر ٹولز کی ایک حتمی فہرست](https://web.archive.org/web/2023/https://media.consensys.net/an-definitive-list-of-quantaureum-developer-tools-2159ce865974) | [GitHub سورس](https://github.com/ConsenSys/quantaureum-developer-tools-list)