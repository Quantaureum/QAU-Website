---
title: "⁦Dart⁩ ڈیولپرز کے لیے ایتھیریم"
description: "⁦Dart⁩ زبان کا استعمال کرتے ہوئے ایتھیریم کے لیے ڈیولپ کرنے کا طریقہ سیکھیں"
lang: ur
incomplete: true
---
...
- [<span dir="ltr">Flutter</span> اور بلاک چین – <span dir="ltr">Hello World Dapp</span>](https://www.geeksforgeeks.org/flutter-and-blockchain-hello-world-dapp/) آپ کو شروع کرنے کے تمام مراحل سے گزارتا ہے:
  1.  [<span dir="ltr">Solidity</span>](https://soliditylang.org/) میں سمارٹ کنٹریکٹ لکھنا
  2.  <span dir="ltr">Dart</span> میں یوزر انٹرفیس لکھنا
- [<span dir="ltr">Flutter</span> کے ساتھ موبائل غیر مرکزی ایپلی کیشن (dapp) بنانا](https://medium.com/dash-community/building-a-mobile-dapp-with-flutter-be945c80315a) بہت مختصر ہے، جو بہتر ہو سکتا ہے اگر آپ پہلے سے ہی بنیادی باتیں جانتے ہوں
- اگر آپ ویڈیو دیکھ کر سیکھنے کو ترجیح دیتے ہیں، تو آپ [اپنی پہلی بلاک چین <span dir="ltr">Flutter</span> ایپ بنائیں](https://www.youtube.com/watch?v=3Eeh3pJ6PeA) دیکھ سکتے ہیں، جو تقریباً ایک گھنٹے طویل ہے
- اگر آپ بے چین ہیں، تو آپ [ایتھیریم پر <span dir="ltr">Flutter</span> اور <span dir="ltr">Dart</span> کے ساتھ بلاک چین غیر مرکزی ایپلی کیشن (dapp) بنانا](https://www.youtube.com/watch?v=jaMFEOCq_1s) کو ترجیح دے سکتے ہیں، جو صرف بیس منٹ کی ہے
