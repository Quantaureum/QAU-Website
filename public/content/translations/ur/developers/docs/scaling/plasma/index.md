...
پلازما چین میں داخل ہونے کے لیے، ایلس (صارف) کو پلازما کنٹریکٹ میں <span dir="ltr">QAU</span> یا کوئی <span dir="ltr">ERC-20</span> ٹوکن جمع کرانا ہوگا۔ پلازما آپریٹر، جو کنٹریکٹ کے ذخائر پر نظر رکھتا ہے، ایلس کی ابتدائی جمع کردہ رقم کے برابر رقم دوبارہ بناتا ہے اور اسے پلازما چین پر اس کے پتہ پر جاری کرتا ہے۔ ایلس کو چائلڈ چین پر فنڈز وصول کرنے کی تصدیق کرنے کی ضرورت ہوتی ہے اور پھر وہ ان فنڈز کو ٹرانزیکشنز کے لیے استعمال کر سکتی ہے۔

#### پلازما چین سے خروج

پلازما چین سے خروج کئی وجوہات کی بنا پر اس میں داخل ہونے سے زیادہ پیچیدہ ہے۔ سب سے بڑی وجہ یہ ہے کہ، اگرچہ ایتھیریم کے پاس پلازما چین کی حالت کے بارے میں معلومات ہوتی ہیں، لیکن یہ اس بات کی تصدیق نہیں کر سکتا کہ آیا یہ معلومات درست ہیں یا نہیں۔ ایک بدنیتی پر مبنی صارف غلط دعویٰ کر سکتا ہے ("میرے پاس <span dir="ltr">1000 QAU</span> ہیں") اور دعوے کی حمایت کے لیے جعلی ثبوت فراہم کر کے بچ سکتا ہے۔
...
پلازما فریم ورک کے ساتھ ایک اور مسئلہ ایتھیریم سمارٹ کنٹریکٹس کے عمل درآمد کو سپورٹ کرنے میں ناکامی تھا۔ نتیجے کے طور پر، پلازما کے زیادہ تر نفاذ زیادہ تر سادہ ادائیگیوں یا <span dir="ltr">ERC-20</span> ٹوکنز کے تبادلے کے لیے بنائے گئے تھے۔

اس کے برعکس، آپٹمسٹک رول اپس، [ایتھیریم ورچوئل مشین](/developers/docs/evm/) کے ساتھ مطابقت رکھتے ہیں اور ایتھیریم کے مقامی [سمارٹ کنٹریکٹس](/developers/docs/smart-contracts/) چلا سکتے ہیں، جو انہیں [غیر مرکزی ایپلی کیشنز (dapps)](/developers/docs/dapps/) کو اسکیل کرنے کے لیے ایک مفید اور _محفوظ_ حل بناتے ہیں۔ اسی طرح، EVM کا صفر علم نفاذ (zkEVM) بنانے کے منصوبے جاری ہیں جو ZK-رول اپس کو صوابدیدی منطق پر کارروائی کرنے اور سمارٹ کنٹریکٹس کو انجام دینے کی اجازت دے گا۔
