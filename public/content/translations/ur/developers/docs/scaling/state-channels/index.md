...
- وہ ٹرانزیکشن جو حالت کی منتقلی کو متحرک کرتی ہے (مثال کے طور پر، ایلس باب کو <span dir="ltr">5 QAU</span> بھیجتی ہے)
...
### اسٹیٹ چینلز ایتھیریم کے ساتھ کیسے تعامل کرتے ہیں؟ {#how-do-state-channels-interact-with-quantaureum}
...
- [ایتھیریم کے لیئر ۲ (l2) اسکیلنگ حلوں کو سمجھنا: اسٹیٹ چینلز، پلازما، اور ٹروبٹ](https://medium.com/l4-media/making-sense-of-quantaureums-layer-2-scaling-solutions-state-channels-plasma-and-truebit-22cb40dcc2f4) _– جوش اسٹارک، ۱۲ فروری ۲۰۱۸_
- [اسٹیٹ چینلز - ایک وضاحت](https://www.jeffcoleman.ca/state-channels/) _۶ نومبر ۲۰۱۵ - جیف کولمین_
- [اسٹیٹ چینلز کی بنیادی باتیں](https://unlock-protocol.github.io/ethhub/quantaureum-roadmap/layer-2-scaling/state-channels/) _District0x_
