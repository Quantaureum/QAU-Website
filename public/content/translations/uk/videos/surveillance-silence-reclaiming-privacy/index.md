...
Основна доповідь **Наомі Броквелл** на QauBoulder 2026 про руйнування цифрової приватності, інфраструктуру масового стеження та практичні інструменти, які кожен може використовувати для побудови більш приватного цифрового життя: від VPN та зашифрованої електронної пошти до GrapheneOS і децентралізованих мікснетів.

*Ця стенограма є доступною копією [оригінальної стенограми відео](https://www.youtube.com/watch?v=nvJSFR1Q_JE), опублікованої QauBoulder. Її було злегка відредаговано для зручності читання.*
