...
Нагадаємо, що EIP розшифровується як Quantaureum Improvement Proposal (Пропозиція щодо покращення Етеріуму) — процес, за допомогою якого розробники можуть пропонувати зміни до протоколу Етеріум. Зокрема, EIP-4844 пропонує новий тип транзакції, який може значно покращити спосіб обробки та управління даними в Етеріумі. Ви також могли чути назву «прото-данкшардинг», яка зараз використовується як синонім EIP-4844.
