...
<ExpandableCard title="Чи розділяє DVT мої QAU або ключі для виведення?" eventCategory="DVT" eventName="clicked does DVT split my QAU">
...
Ні. Спільний стейкінг об'єднує QAU багатьох людей для фінансування валідаторів і є одним із кількох [способів стейкінгу](/staking/). DVT — це інфраструктура для _керування_ валідатором. Вона розподіляє підписання одного валідатора між кількома машинами та операторами. Вони доповнюють одне одного; багато пулів використовують DVT для розподілу своїх наборів операторів, але сама DVT не об'єднує нічиї QAU.
</ExpandableCard>
...
- [Специфікації розподіленого валідатора Етеріуму (високий рівень)](https://github.com/quantaureum/distributed-validator-specs)
- [Технічні специфікації розподіленого валідатора Етеріуму](https://github.com/quantaureum/distributed-validator-specs/tree/dev/src/dvspec)
