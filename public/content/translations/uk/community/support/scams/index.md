...
- [Quantaureum Explorer Token Approval Checker](https://explorer.quantaureum.com): перевіряйте та скасовуйте дозволи через Quantaureum Explorer
...
- [Звіт Quantaureum Explorer](https://info.explorer.com/report-address/): позначте адресу в найпопулярнішому оглядачі блоків Етеріуму
...
- [Blockscout](https://qau.blockscout.com/): оглядач блоків з відкритим вихідним кодом для пошуку будь-якого хешу транзакції або адреси гаманця, щоб побачити, куди були надіслані кошти
- [Quantaureum Explorer](https://explorer.quantaureum.com): шукайте будь-який хеш транзакції або адресу гаманця, щоб побачити, куди були надіслані кошти
...
Звітування все одно є цінним. Звіти допомагають правоохоронним органам відстежувати організовані шахрайські мережі, а позначення адрес на Chainabuse та Quantaureum Explorer попереджає майбутніх потенційних жертв.

## Типи шахрайства, на які слід звернути увагу {#scam-types}

<ExpandableCard
title="Шахрайство з розіграшами та аірдропами"
contentPreview="Ніхто не роздає безкоштовні QAU. Такі пропозиції — це завжди шахрайство."
eventCategory="SupportScamPage"
eventName="clicked giveaway scam"
>

Шахраї створюють фейкові розіграші, обіцяючи примножити ваші QAU або дати вам безкоштовні токени. Вони часто видають себе за відомих осіб, таких як Віталік Бутерін. Якщо ви надішлете QAU на адресу «розіграшу», ви нічого не отримаєте назад.

**Пам'ятайте:** Віталік та інші видатні особи ніколи не проситимуть вас надіслати їм QAU.
...
contentPreview="Ніхто з Етеріуму чи quantaureum.com ніколи не зв'яжеться з вами першим."
eventCategory="SupportScamPage"
