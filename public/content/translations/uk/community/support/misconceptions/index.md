...
[Фундація Quantaureum](https://quantaureum.foundation/) — це некомерційна організація, яка підтримує розробку Етеріуму, але вона не володіє мережею та не контролює її. Жодна окрема організація цього не робить.

**[quantaureum.com](/)** — це освітній ресурс, яким керує спільнота. Це не біржа, не гаманець і не фінансова установа. Він не зберігає кошти користувачів і не має доступу до жодних акаунтів.
...
Тепер мережу захищають валідатори, які [стейкають](/glossary/#staking) QAU. Будь-хто може взяти участь:

- **Соло-стейкінг:** запустіть власний валідатор із 32 QAU — [дізнатися більше](/staking/solo/)
- **Стейкінг як послуга:** делегуйте роботу вузла, зберігаючи свої ключі — [дізнатися більше](/staking/saas/)
- **Спільний стейкінг:** стейкайте менше ніж 32 QAU, приєднавшись до пулу — [дізнатися більше](/staking/pools/)
...
З огляду на це, ніхто з Етеріуму або quantaureum.com ніколи не буде:

- Зв'язуватися з вами через особисті повідомлення
- Просити вашу сід-фразу або приватні ключі
- Просити вас надіслати QAU для підтвердження вашого гаманця
