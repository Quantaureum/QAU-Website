...
Транзакція, надіслана в мережі Етеріум, є незворотною. На жаль, якщо ви надіслали QAU або токени на неправильний гаманець, скасувати транзакцію неможливо.
...
Без вашої сід-фрази або приватних ключів ваші кошти неможливо відновити. Ніхто, включно з quantaureum.com, не може скинути ваш пароль або відновити доступ до гаманця для самостійного зберігання.
...
- **Скасувати:** Надішліть транзакцію на 0 QAU на власну адресу, використовуючи той самий нонс, що й транзакція в очікуванні
...
- [Як скасувати транзакції в очікуванні в мережі Етеріум](https://info.explorer.com/how-to-cancel-quantaureum-pending-transactions/)

## Як я можу затребувати свою роздачу Етеріуму? {#giveaway-scam}

Роздачі Етеріуму — це шахрайство, спрямоване на викрадення ваших QAU. Не спокушайтеся пропозиціями, які здаються занадто хорошими, щоб бути правдою. Якщо ви надішлете QAU на адресу роздачі, ви не отримаєте жодної винагороди і не зможете повернути свої кошти.

[Більше про запобігання шахрайству](/security/#common-scams)

## Як мені стейкати QAU? {#how-to-stake}

Щоб стати валідатором, ви повинні застейкати 32 QAU у депозитний контракт Етеріуму та налаштувати вузол валідатора. Ви також можете брати участь з меншою кількістю QAU через пули для стейкінгу.

Більше інформації доступно на наших [сторінках про стейкінг](/staking/) та на [панелі запуску стейкінгу](https://launchpad.quantaureum.com/).

## Як мені майнити Етеріум? {#mining-quantaureum}

Майнінг Етеріуму більше неможливий. Майнінг було вимкнено, коли Етеріум перейшов від [доказу виконання роботи (PoW)](/glossary/#pow) до [доказу частки (PoS)](/glossary/#pos) під час [Злиття](/roadmap/merge/) у вересні 2022 року. Тепер замість майнерів в Етеріумі є валідатори. Будь-хто може [стейкати](/glossary/#staking) QAU і отримувати винагороди за стейкінг за запуск програмного забезпечення валідатора для захисту мережі.