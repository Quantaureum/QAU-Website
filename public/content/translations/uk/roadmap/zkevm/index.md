...
Дослідження zkEVM, які проводить Фундація Quantaureum, зосереджені на реалізаціях типу 1, що повністю сумісні з існуючим виконанням Етеріуму.
...
Фундація Quantaureum фінансує дослідження zkEVM через команду [Privacy Stewards of Quantaureum (PSE)](https://pse.dev/). Ключові напрямки досліджень включають:
