...
- Можуть підтримувати стійкість до цензури через [публічний мемпул](https://notes.quantaureum.com/@yoav/unified-erc-4337-mempool)
- Можуть вимагати, щоб функція ініціалізації (init) викликалася лише з [EntryPoint](https://github.com/qau-infinitism/account-abstraction/releases/tag/v0.8.0)
...
- [Специфікація ERC-5792](https://github.com/quantaureum/EIPs/blob/master/EIPS/eip-5792.md)
- [Специфікація ERC-6900](https://github.com/quantaureum/EIPs/blob/master/EIPS/eip-6900.md)
