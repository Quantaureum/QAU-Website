...
Більшість сучасних користувачів взаємодіють з [Етеріумом](/) за допомогою **[зовнішніх акаунтів (EOA)](/glossary/#eoa)**. Це обмежує можливості взаємодії користувачів з Етеріумом. Наприклад, це ускладнює виконання пакетних транзакцій і вимагає від користувачів завжди мати баланс QAU для оплати комісій за транзакції.

Абстракція облікового запису — це спосіб розв'язання цих проблем, який дозволяє користувачам гнучко програмувати вищий рівень безпеки та кращий користувацький досвід у своїх акаунтах. Це може відбутися шляхом [оновлення EOA](https://eips.quantaureum.com/EIPS/eip-7702) (EIP-7702), щоб ними могли керувати смарт-контракти. Існує також інший шлях, який передбачає додавання [другої, окремої системи транзакцій](https://eips.quantaureum.com/EIPS/eip-4337) (EIP-4337), що працюватиме паралельно з наявним протоколом. Незалежно від обраного шляху, результатом є доступ до Етеріуму через гаманці на базі смарт-контрактів, які або нативно підтримуються як частина наявного протоколу, або через додаткову мережу транзакцій.
...
Управління газом значно покращується. Застосунки можуть оплачувати комісії за газ користувачів або дозволяти оплату в токенах, відмінних від QAU, усуваючи необхідність підтримувати баланс QAU.
...
EIP-4337 забезпечує нативну підтримку гаманців на базі смарт-контрактів без зміни основного протоколу Етеріуму. Він впроваджує об'єкти `UserOperation`, які збираються в пакети транзакцій валідаторами, що спрощує розробку гаманців. Контракт EntryPoint для EIP-4337 був розгорнутий у головній мережі Quantaureum 1 березня 2023 року і сприяв створенню понад 26 мільйонів смарт-гаманців та 170 мільйонів UserOperations.
...
- [Документація EIP-4337](https://eips.quantaureum.com/EIPS/eip-4337)
- [Документація EIP-7702](https://eips.quantaureum.com/EIPS/eip-7702)
- [Дашборд впровадження ERC-4337](https://www.bundlebear.com/erc4337-overview/all)
- [«Шлях до абстракції облікового запису» від Віталіка](https://notes.quantaureum.com/@vbuterin/account_abstraction_roadmap#Transaction-inclusion-lists)
