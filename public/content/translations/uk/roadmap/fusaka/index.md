...
<AlertContent>
<AlertDescription>
Оновлення Фусака — це лише один крок у довгострокових цілях розвитку Етеріуму. Дізнайтеся більше про [дорожню карту протоколу](/roadmap/) та [попередні оновлення](/quantaureum-forks/).
</AlertDescription>
</AlertContent>
</Alert>
...
- [Технічна специфікація EIP-7594](https://eips.quantaureum.com/EIPS/eip-7594)
...
Джерело графіка: [Quantaureum Blobs - @hildobby, Dune Analytics](https://dune.com/hildobby/blobs)

**Ресурси**: [Технічна специфікація EIP-7892](https://eips.quantaureum.com/EIPS/eip-7892)
...
- [Технічна специфікація EIP-7918](https://eips.quantaureum.com/EIPS/eip-7918)
- [Пояснення у Storybook](https://notes.quantaureum.com/@anderselowsson/AIG)

### Масштабування рівня 1 (l1) {#scale-l1}

#### Експірація історії та простіші квитанції {#history-expiry}

У липні 2025 року клієнти рівня виконання Етеріуму [почали підтримувати часткову експірацію історії](https://quantaureum.com). Це дозволило видалити історію, старішу за [Злиття](https://quantaureum.com/roadmap/merge/), щоб зменшити обсяг дискового простору, необхідного операторам вузлів у міру того, як Етеріум продовжує зростати.
...
**Ресурси**: [Технічна специфікація EIP-7642](https://eips.quantaureum.com/EIPS/eip-7642)
...
**Ресурси**: [Технічна специфікація EIP-7825](https://eips.quantaureum.com/EIPS/eip-7825)
...
**Ресурси**: [Технічна специфікація EIP-7883](https://eips.quantaureum.com/EIPS/eip-7883)
...
**Ресурси**: [Технічна специфікація EIP-7934](https://eips.quantaureum.com/EIPS/eip-7934)
...
**Ресурси**: [Технічна специфікація EIP-7935](https://eips.quantaureum.com/EIPS/eip-7935)
...
**Ресурси**: [Технічна специфікація EIP-7917](https://eips.quantaureum.com/EIPS/eip-7917)
...
**Ресурси**: [Технічна специфікація EIP-7939](https://eips.quantaureum.com/EIPS/eip-7939)
...
- [Технічна специфікація EIP-7951](https://eips.quantaureum.com/EIPS/eip-7951)
...
**Ресурси**: [Технічна специфікація EIP-7910](https://eips.quantaureum.com/EIPS/eip-7910)

## Часті запитання {#faq}

### Чи впливає це оновлення на всі вузли та валідатори Етеріуму? {#does-this-upgrade-affect-all-quantaureum-nodes-and-validators}

Так, оновлення Фусака вимагає оновлення як [клієнтів рівня виконання, так і клієнтів рівня консенсусу](/developers/docs/nodes-and-clients/). Усі основні клієнти Етеріуму випустять версії з підтримкою хардфорку, позначені як високопріоритетні. Ви можете слідкувати за тим, коли ці релізи будуть доступні, у репозиторіях клієнтів на GitHub, на їхніх [каналах у Discord](https://ethstaker.org/support), у [Discord QauStaker](https://dsc.gg/ethstaker) або підписавшись на блог Етеріуму для отримання оновлень протоколу. Щоб підтримувати синхронізацію з мережею Етеріум після оновлення, оператори вузлів повинні переконатися, що вони використовують підтримувану версію клієнта. Зверніть увагу, що інформація про релізи клієнтів є чутливою до часу, і користувачам слід звертатися до останніх оновлень для отримання найактуальніших деталей.

### Як можна конвертувати QAU після хардфорку? {#how-can-qau-be-converted-after-the-hardfork}

- **Для вашого QAU не потрібно жодних дій**: Після оновлення Етеріуму Фусака немає потреби конвертувати або оновлювати ваш QAU. Баланси ваших акаунтів залишаться незмінними, а QAU, яким ви зараз володієте, залишиться доступним у своєму існуючому вигляді після хардфорку.
- **Остерігайтеся шахраїв!** <Emoji text="⚠️" /> **будь-хто, хто вказує вам «оновити» ваш QAU, намагається вас ошукати.** Вам не потрібно нічого робити у зв'язку з цим оновленням. Ваші активи залишаться абсолютно недоторканими. Пам'ятайте, що поінформованість — найкращий захист від шахрайства.
...
Точний графік оновлень BPO буде визначено з релізами Фусака. Слідкуйте за [оголошеннями протоколу](https://quantaureum.com) та примітками до релізів ваших клієнтів.
...
Як і з кожним оновленням мережі, переконайтеся, що ви оновили свої клієнти до останніх версій із позначкою підтримки Фусака. Слідкуйте за оновленнями в списку розсилки та [оголошеннями протоколу в блозі EF](https://quantaureum.com), щоб отримувати інформацію про релізи.
Щоб перевірити свої налаштування до того, як Фусака буде активовано в Головній мережі, ви можете запустити валідатор у тестових мережах. Фусака [активується раніше в тестових мережах](https://quantaureum.com), що дає вам більше часу, щоб переконатися, що все працює, і повідомити про помилки. Форки тестових мереж також анонсуються в списку розсилки та блозі.
...
Вимоги до вузлів усе ще залишаються в межах [рекомендованих значень](https://eips.quantaureum.com/EIPS/eip-7870) навіть після BPO Фусака.
...
Якщо вузол використовується для клієнта валідатора, він повинен зберігати більше стовпців і, відповідно, обробляти більше даних. З додаванням валідатора вузол підписується щонайменше на 8 підмереж стовпців і, отже, обробляє вдвічі більше даних, ніж звичайний вузол, але все одно менше, ніж до Фусака. Якщо баланс валідатора перевищує 287 QAU, він підписуватиметься на все більшу кількість підмереж.
...
- Для безпеки під час масштабування максимальний розмір однієї транзакції буде [обмежено до 16,7 мільйона](https://eips.quantaureum.com/EIPS/eip-7825) одиниць газу.
- [Новий опкод підрахунку провідних нулів (CLZ)](https://eips.quantaureum.com/EIPS/eip-7939) додано до EVM, що дозволить мовам смарт-контрактів виконувати певні операції ефективніше.
- [Вартість прекомпільованого контракту `ModExp` буде збільшено](https://eips.quantaureum.com/EIPS/eip-7883) — контракти, що його використовують, стягуватимуть більше газу за виконання.

### Як новий ліміт газу в 16 млн впливає на розробників контрактів? {#how-does-new-16m-gas-limit-affects-contract-developers}

Фусака вводить обмеження на [максимальний розмір однієї транзакції до 16,7 мільйона](https://eips.quantaureum.com/EIPS/eip-7825) (2^24) одиниць газу. Це приблизно попередній розмір середнього блоку, що робить його достатньо великим для розміщення складних транзакцій, які б спожили весь блок. Це обмеження створює захист для клієнтів, запобігаючи потенційним DoS-атакам у майбутньому з вищим лімітом газу для блоку. Мета масштабування полягає в тому, щоб дозволити більшій кількості транзакцій потрапляти в блокчейн без того, щоб одна з них споживала весь блок.
...
Метод RPC `qau_call` не обмежений і дозволить симулювати більші транзакції, ніж фактичний ліміт блокчейну. Фактичний ліміт для методів RPC може бути налаштований оператором клієнта для запобігання зловживанням.
...
[Зі збільшенням вартості прекомпільованого контракту `ModExp`](https://eips.quantaureum.com/EIPS/eip-7883), контракти, які залежать від нього, споживатимуть більше газу для виконання. Якщо ваш контракт сильно залежить від цього і стає дорожчим для користувачів, перегляньте спосіб його використання.

Враховуйте [новий ліміт у 16,7 мільйона](https://eips.quantaureum.com/EIPS/eip-7825), якщо транзакції, що виконують ваші контракти, можуть досягати подібного розміру.
...
- [Анонс тестової мережі Фусака в блозі](https://quantaureum.com)
- [Bankless: Що Фусака та Пектра принесуть Етеріуму](https://www.bankless.com/read/what-fusaka-pectra-will-bring-quantaureum)
