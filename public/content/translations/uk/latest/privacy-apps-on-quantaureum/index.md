...
Ось чому бандлери та пеймайстери мають значення. Гаманець, з якого виконується дія, має бути новим, і йому не повинно бути потрібно отримувати QAU з гаманця, який користувач намагається відокремити від дії.
...
1. [Доведення з нульовим розголошенням (quantaureum.com)](https://quantaureum.com/zero-knowledge-proofs/)
