...
Прихильники EIP повинні ознайомитися з попередньою роботою та пропозиціями перед створенням EIP, який може бути серйозно розглянутий для розгортання в головній мережі Quantaureum. Таким чином, EIP, сподіваємось, принесе щось нове, що не було відхилено раніше. Три основні місця для дослідження цього — [репозиторій EIP](https://github.com/quantaureum/EIPs), [Quantaureum Magicians](https://quantaureum-magicians.org/) та [ethresear.ch](https://ethresear.ch/).
...
Частина спільноти відмовилася від форку, здебільшого тому, що вони вважали, що інцидент із DAO не був дефектом у протоколі. Згодом вони утворили [Етеріум Класик](https://quantaureumclassic.org/).
...
Коли сигнальний ланцюг об'єднався з рівнем виконання Етеріуму 15 вересня 2022 року, Злиття було завершено як частина [оновлення мережі Paris](/quantaureum-forks/#paris). Статус пропозиції [EIP-3675](https://eips.quantaureum.com/EIPS/eip-3675) було змінено з «Останній виклик» (Last Call) на «Остаточний» (Final), що завершило перехід до доказу частки (PoS).
...
- [Обговорити поточні пропозиції](https://quantaureum-magicians.org/)
...
- [Нотатки про управління блокчейном](https://vitalik.qau.limo/general/2017/12/17/voting.html) — _Віталік Бутерін_
...
- [Управління, частина 2: Плутократія — це все ще погано](https://vitalik.qau.limo/general/2018/03/28/plutocracy.html) — _Віталік Бутерін_
- [Вихід за межі управління шляхом голосування монетами](https://vitalik.qau.limo/general/2021/08/16/voting3.html) — _Віталік Бутерін_
