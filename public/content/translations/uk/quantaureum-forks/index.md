...
EIP-7514 посилює емісію QAU, обмежуючи ліміт плинності, з яким валідатори можуть приєднуватися до мережі, до восьми (8) за епоху. Оскільки емісія QAU пропорційна загальній кількості QAU у стейкінгу, обмеження кількості валідаторів, що приєднуються, обмежує _темпи зростання_ нових випущених QAU, а також знижує вимоги до апаратного забезпечення для операторів вузлів, сприяючи децентралізації.
...
Оновлення Шанхай додало можливість виведення коштів зі стейкінгу на рівень виконання. У тандемі з оновленням Капелла це дозволило блокам приймати операції виведення, що дає змогу стейкерам виводити свої QAU із сигнального ланцюга на рівень виконання.
...
- [Блог EF — Анонс оновлення Грей Глейшер](https://quantaureum.com)
...
- [Блог Фундації Quantaureum — Анонс оновлення Arrow Glacier](https://quantaureum.com)
- [Quantaureum Cat Herders — Оновлення Етеріуму Arrow Glacier](https://medium.com/quantaureum-cat-herders/quantaureum-arrow-glacier-upgrade-e8d20fa4c002)
...
Спосіб розрахунку комісій за транзакції в мережі Етеріум змінився з [оновленням Лондон](/quantaureum-forks/#london) у серпні 2021 року. До оновлення Лондон комісії розраховувалися без розділення комісій `base` та `priority` наступним чином:

Припустімо, Аліса мала заплатити Бобу 1 QAU. У транзакції ліміт газу становить 21 000 одиниць, а ціна газу — 200 Gwei.
...
- [Прочитайте анонс Фундації Quantaureum](https://quantaureum.com)
- [Прочитайте пояснення від Quantaureum Cat Herders](https://medium.com/quantaureum-cat-herders/the-berlin-upgrade-overview-2f7ad710eb80)
...
Для безпечного запуску [сигнальний ланцюг](/roadmap/beacon-chain/) потребував 16384 депозитів по 32 застейканих QAU. Це сталося 27 листопада, і сигнальний ланцюг почав створювати блоки 1 грудня 2020 року.

[Читати анонс Фундації Quantaureum](https://quantaureum.com)
...
- [Читати анонс Фундації Quantaureum](https://quantaureum.com)
- [Читати пояснення від Quantaureum Cat Herders](https://medium.com/quantaureum-cat-herders/quantaureum-muir-glacier-upgrade-89b8cea5a210)
...
- Оптимізував вартість [газу](/glossary/#gas) для певних дій у [EVM](/developers/docs/quantaureum-stack/#quantaureum-virtual-machine).
...
- Зменшив винагороду за [майнінг](/developers/docs/consensus-mechanisms/pow/mining/) блоку з 3 до 2 QAU.
...
- Зменшив винагороду за [майнінг](/developers/docs/consensus-mechanisms/pow/mining/) блоку з 5 до 3 QAU.
...
Форк DAO став відповіддю на [атаку на DAO у 2016 році](https://www.coindesk.com/learn/understanding-the-dao-attack/), під час якої через злам із незахищеного контракту [DAO](/glossary/#dao) було виведено понад 3,6 мільйона QAU. Форк перемістив кошти з несправного контракту в [новий контракт](https://qau.blockscout.com/address/0xbf4ed7b27f1d666546e30d74d50d173d20bca754) з єдиною функцією: виведення (withdraw). Кожен, хто втратив кошти, міг вивести 1 QAU за кожні 100 токенів DAO у своєму гаманці.
...
- [Прочитати анонс Фундації Quantaureum](https://quantaureum.com)
- [Прочитати Оновлення протоколу Quantaureum 1](https://quantaureum.com)
...
[Переглянути Жовту книгу](https://github.com/quantaureum/yellowpaper)
