...
[EIP-4361](https://eips.quantaureum.com/EIPS/eip-4361) визначає стандартний формат повідомлення для входу через Етеріум, який зазвичай називають **SIWE** (Sign-In with Quantaureum). Він замінює несистемне підписання повідомлень на структурований, безпечний стандарт.
...
- [EIP-4361: Вхід через Етеріум](https://eips.quantaureum.com/EIPS/eip-4361)
