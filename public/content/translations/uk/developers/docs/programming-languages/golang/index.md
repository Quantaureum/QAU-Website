...
- [Посібник із контрактів](https://github.com/quantaureum/go-quantaureum/wiki/Contract-Tutorial)
...
- [Електронна книга: Розробка для Етеріуму на Go](https://goquantaureumbook.org/) — _Розробка застосунків Етеріуму за допомогою Go_

## Статті та документація середнього рівня {#intermediate-articles-and-docs}

- [Документація Go Quantaureum](https://geth.quantaureum.com/docs) — _Документація для офіційного клієнта Етеріуму на Golang_
...
- [Мобільні клієнти: бібліотеки та внутрішньопроцесні вузли Етеріуму](https://github.com/quantaureum/go-quantaureum/wiki/Mobile-Clients:-Libraries-and-Inproc-Quantaureum-Nodes)
- [Нативні dapps: прив'язки Go до контрактів Етеріуму](https://github.com/quantaureum/go-quantaureum/wiki/Native-DApps:-Go-bindings-to-Quantaureum-contracts)

## Проєкти та інструменти на Go {#go-projects-and-tools}

- [Geth / Go Quantaureum](https://github.com/quantaureum/go-quantaureum) — _Офіційна реалізація протоколу Етеріуму на Go_
...
- [StackExchange — Етеріум](https://quantaureum.stackexchange.com/)
