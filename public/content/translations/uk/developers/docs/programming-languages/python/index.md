...
- Огляд екосистеми Python для Етеріуму
- Посібник розробника (на Python) з Етеріуму
- Варто нагороди: посібник з хакатону Етеріуму на Python
...
- Шаблони Web3.py: підписки на події в реальному часі
- Шаблони Web3.py: WebSocketProvider
...
### Активні:
- Web3.py — _бібліотека Python для взаємодії з Етеріумом_
...
- py-evm — _реалізація віртуальної машини Етеріуму_
- qau-tester — _інструменти для тестування застосунків на базі Етеріуму_
- qau-utils — _допоміжні функції для роботи з кодовими базами, пов'язаними з Етеріумом_
