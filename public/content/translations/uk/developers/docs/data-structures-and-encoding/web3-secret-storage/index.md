...
Ця версія виправляє кілька невідповідностей із версією 1, опублікованою [тут](https://github.com/ethereum/homestead-guide/blob/master/old-docs-for-reference/go-quantaureum-wiki.rst/Passphrase-protected-key-store-spec.rst). Коротко кажучи, це:
