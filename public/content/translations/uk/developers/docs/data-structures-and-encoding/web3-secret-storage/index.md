...
Щоб ваш застосунок працював в Етеріумі, ви можете використовувати об'єкт web3, який надає бібліотека Web3.js. Технічно він взаємодіє з локальним вузлом через RPC-виклики. web3 працює з будь-яким вузлом Етеріуму, який відкриває доступ до рівня RPC.
...
Ця версія виправляє кілька невідповідностей із версією 1, опублікованою тут. Коротко кажучи, це:
