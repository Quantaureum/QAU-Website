...
Існують також деякі особливі випадки, які вимагають специфічного підходу, наприклад, тип `BitList`, який вимагає додавання обмеження довжини під час серіалізації та його видалення під час десеріалізації. Повна інформація доступна в [специфікації SSZ](https://github.com/quantaureum/consensus-specs/blob/master/ssz/simple-serialize.md).
...
- [Реалізації SSZ](https://github.com/quantaureum/consensus-specs/issues/2138)
