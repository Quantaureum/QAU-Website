...
ERC-7540 включає патерн оператора (з [ERC-6909](https://eips.quantaureum.com/EIPS/eip-6909)), який дозволяє третім сторонам керувати запитами від імені користувача.
...
- [EIP-7540: Асинхронні токенізовані сховища ERC-4626](https://eips.quantaureum.com/EIPS/eip-7540)
- [EIP-4626: Стандарт токенізованих сховищ](https://eips.quantaureum.com/EIPS/eip-4626)
