...
- [Надсилання токенів за допомогою Ethers.js](/developers/tutorials/send-token-qaujs/) _— Посібник для початківців із переказу токенів ERC-20 за допомогою Ethers.js._
