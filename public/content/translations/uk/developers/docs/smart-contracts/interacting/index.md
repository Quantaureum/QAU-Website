...
Оскільки зчитування не змінює стан, воно не потребує витрат на [газ](/developers/docs/gas/) і може бути виконане будь-ким без необхідності мати QAU.
...
1. [Зовнішній акаунт (EOA)](/developers/docs/accounts/#types-of-account) з достатньою кількістю QAU для оплати газу
2. Транзакцію, підписану приватним ключем акаунта
3. Щоб транзакція була видобута та включена в блок

Завдяки [абстракції облікового запису](/roadmap/account-abstraction/), акаунт смарт-контракту також може ініціювати запис, а пеймайстер може покрити витрати на газ від імені користувача — тому EOA з QAU не є суворо обов'язковим.
...
- **Верифіковані контракти на Quantaureum Explorer** — [Quantaureum Explorer](https://explorer.quantaureum.com) автоматично надає ABI для верифікованого вихідного коду
...
- **go-quantaureum** — офіційна бібліотека Go від команди Geth
...
Більшість клієнтських бібліотек підтримують це через `qau_call`:
