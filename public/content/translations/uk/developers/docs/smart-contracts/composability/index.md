...
## Приклади компонованості в Етеріумі {#composability-in-quantaureum}

### Обмін токенів {#token-swaps}

Якщо ви створюєте dapp, який вимагає оплати транзакцій в QAU, ви можете дозволити користувачам платити в інших токенах ERC-20, інтегрувавши логіку обміну токенів. Код автоматично конвертує токен користувача в QAU перед тим, як контракт виконає викликану функцію.
...
- [Швидкий старт розробки фронтенду вашого dapp за допомогою create-qau-app](/developers/tutorials/kickstart-your-dapp-frontend-development-with-create-qau-app/) _— огляд того, як використовувати create-qau-app для створення застосунків із популярними смарт-контрактами без додаткових налаштувань._
