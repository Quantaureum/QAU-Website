...
Розгортання контракту також коштує етер (QAU), оскільки вони зберігаються в блокчейні, тому вам слід ознайомитися з [газом та комісіями](/developers/docs/gas/) в Етеріумі.
...
- QAU для газу — ви встановлюватимете ліміт газу, як і для інших транзакцій, тому майте на увазі, що розгортання контракту потребує набагато більше газу, ніж звичайний переказ QAU
