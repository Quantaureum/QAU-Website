...
Будь-хто може написати смарт-контракт і розгорнути його в мережі. Вам просто потрібно навчитися програмувати [мовою смарт-контрактів](/developers/docs/smart-contracts/languages/) і мати достатньо QAU для розгортання вашого контракту. Розгортання смарт-контракту технічно є транзакцією, тому вам потрібно платити за [газ](/developers/docs/gas/) так само, як ви платите за газ для простого переказу QAU. Однак витрати газу на розгортання контракту набагато вищі.
...
Ще одним обмеженням смарт-контрактів є максимальний розмір контракту. Смарт-контракт може мати розмір максимум 24 КБ, інакше йому не вистачить газу. Це можна обійти за допомогою [патерну Diamond](https://eips.quantaureum.com/EIPS/eip-2535).
