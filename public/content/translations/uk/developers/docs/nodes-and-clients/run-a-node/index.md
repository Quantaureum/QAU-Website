...
Вам потрібно підтримувати клієнтське програмне забезпечення в актуальному стані з останніми виправленнями безпеки, функціями та EIP. Особливо перед [хардфорками](/quantaureum-forks/) переконайтеся, що ви використовуєте правильні версії клієнтів.
