...
Список вбудованих завантажувальних вузлів у go-quantaureum можна знайти [тут](https://github.com/quantaureum/go-quantaureum/blob/master/params/bootnodes.go#L23). Ці завантажувальні вузли підтримуються Фундацією Quantaureum та командою go-quantaureum.
