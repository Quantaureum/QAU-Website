...
- [Geth](https://github.com/quantaureum/go-quantaureum/tree/master/beacon/light): легкий режим для клієнта виконання (у розробці) на Go
...
- [Пайпер Мерріам (Piper Merriam): Звивистий шлях до функціональних легких клієнтів](https://snakecharmers.quantaureum.com/the-winding-road-to-functional-light-clients/)