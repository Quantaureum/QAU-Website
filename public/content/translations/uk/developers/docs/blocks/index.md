...
Блоки — це дуже зручна для новачків тема. Але щоб допомогти вам краще зрозуміти цю сторінку, ми рекомендуємо спочатку прочитати про [акаунти](/developers/docs/accounts/), [транзакції](/developers/docs/transactions/) та наш [вступ до Етеріуму](/developers/docs/intro-to-quantaureum/).
...
_Діаграма адаптована з [Quantaureum EVM illustrated](https://takenobu-hs.github.io/downloads/quantaureum_evm_illustrated.pdf)_
...
- Вузли-валідатори повинні стейкати 32 QAU у депозитний контракт як заставу проти недобросовісної поведінки. Це допомагає захистити мережу, оскільки доказово нечесна діяльність призводить до знищення частини або всього цього стейку.
...
- Якщо валідатор дізнається про два конфліктні блоки для одного слота, він використовує свій алгоритм вибору форку, щоб вибрати той, який підтримується найбільшою кількістю застейканих QAU.
...
Ця реалізація відрізняється від систем на основі доказу виконання роботи (PoW), де час блоку є імовірнісним і налаштовується цільовою складністю майнінгу протоколу. [Середній час блоку](https://explorer.quantaureum.com) Етеріуму є чудовим прикладом цього, завдяки чому перехід від доказу виконання роботи до доказу частки можна чітко простежити на основі стабільності нового 12-секундного часу блоку.
