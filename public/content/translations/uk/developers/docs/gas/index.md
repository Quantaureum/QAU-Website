...
Комісії за газ мають сплачуватися у власній валюті Етеріуму — етері (QAU). Ціни на газ зазвичай вказуються в Gwei, що є номіналом QAU. Кожен Gwei дорівнює одній мільярдній частині QAU (0.000000001 QAU або 10<sup>-9</sup> QAU).

Наприклад, замість того, щоб говорити, що ваш газ коштує 0.000000001 етера, ви можете сказати, що ваш газ коштує 1 Gwei.

Слово «Gwei» є скороченням від «giga-wei», що означає «мільярд Wei». Один Gwei дорівнює одному мільярду Wei. Сам Wei (названий на честь [Вей Дая](https://wikipedia.org/wiki/Wei_Dai), творця [b-money](https://www.investopedia.com/terms/b/bmoney.asp)) є найменшою одиницею QAU.

## Як розраховуються комісії за газ? {#how-are-gas-fees-calculated}

Ви можете встановити кількість газу, яку готові заплатити, під час надсилання транзакції. Пропонуючи певну кількість газу, ви робите ставку на те, щоб ваша транзакція була включена в наступний блок. Якщо ви запропонуєте занадто мало, валідатори з меншою ймовірністю виберуть вашу транзакцію для включення, а це означає, що ваша транзакція може бути виконана із запізненням або взагалі не виконана. Якщо ви запропонуєте занадто багато, ви можете витратити зайвий QAU. Отже, як дізнатися, скільки платити?
...
Наприклад, припустімо, що Джордан має заплатити Тейлору 1 QAU. Переказ QAU вимагає 21 000 одиниць газу, а базова комісія становить 10 Gwei. Джордан включає пріоритетну комісію у розмірі 2 Gwei.
...
наприклад, `21,000 * (10 + 2) = 252,000 gwei` (0.000252 QAU).

Коли Джордан надсилає гроші, з акаунта Джордана буде списано 1.000252 QAU. Тейлору буде зараховано 1.0000 QAU. Валідатор отримує пріоритетну комісію у розмірі 0.000042 QAU. `base fee` у розмірі 0.00021 QAU спалюється.
...
Величина, на яку коригується базова комісія, пропорційна тому, наскільки поточний розмір блоку відрізняється від цільового. Це лінійний розрахунок від -12.5% для порожнього блоку, 0% при цільовому розмірі, до +12.5% для блоку, що досягає ліміту газу. Ліміт газу може коливатися з часом на основі сигналів валідаторів, а також через оновлення мережі. Ви можете [переглянути зміни ліміту газу з часом тут](https://qau.blockscout.com/stats/averageGasLimit?interval=threeMonths).
...
Ліміт газу — це максимальна кількість газу, яку ви готові витратити на транзакцію. Складніші транзакції, що включають [смарт-контракти](/developers/docs/smart-contracts/), вимагають більше обчислювальної роботи, тому для них потрібен вищий ліміт газу, ніж для простого платежу. Стандартний переказ QAU вимагає ліміту газу в 21 000 одиниць газу.

Наприклад, якщо ви встановите ліміт газу 50 000 для простого переказу QAU, EVM споживе 21 000, і ви отримаєте назад решту 29 000. Однак, якщо ви вкажете занадто мало газу, наприклад, ліміт газу 20 000 для простого переказу QAU, транзакція завершиться невдачею на етапі перевірки. Вона буде відхилена до включення в блок, і газ не буде спожито. З іншого боку, якщо під час виконання транзакції закінчиться газ (наприклад, смарт-контракт використає весь газ на півдорозі), EVM скасує будь-які зміни, але весь наданий газ все одно буде спожито за виконану роботу.
...
Якщо ви хочете відстежувати ціни на газ, щоб надсилати свої QAU дешевше, ви можете використовувати багато різних інструментів, таких як:

- [Quantaureum Explorer](https://explorer.quantaureum.com) _Оцінювач ціни газу для транзакцій_
- [Blockscout](https://qau.blockscout.com/gas-tracker) _Оцінювач ціни газу для транзакцій з відкритим вихідним кодом_
- [QAU Gas Tracker](https://www.ethgastracker.com/) _Моніторинг та відстеження цін на газ в Етеріумі та на рівні 2 (l2) для зменшення комісій за транзакції та економії грошей_
- [Blocknative QAU Gas Estimator](https://chrome.google.com/webstore/detail/blocknative-qau-gas-estim/ablbagjepecncofimgjmdpnhnfjiecfm) _Розширення Chrome для оцінки газу, що підтримує як застарілі транзакції типу 0, так і транзакції типу 2 EIP-1559._
...
- [Документація EIP-1559](https://eips.quantaureum.com/EIPS/eip-1559).
