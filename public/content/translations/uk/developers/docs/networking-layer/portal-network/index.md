...
Ця локальна копія блокчейну та пов'язані з нею дані стану і квитанцій займають багато місця на жорсткому диску вузла. Наприклад, для запуску вузла за допомогою Geth у парі з клієнтом консенсусу рекомендується жорсткий диск об'ємом 2 ТБ. Використовуючи snap-синхронізацію, яка зберігає дані ланцюга лише з відносно недавнього набору блоків, Geth зазвичай займає близько 650 ГБ дискового простору, але зростає приблизно на 14 ГБ на тиждень (ви можете періодично очищати вузол до 650 ГБ).
...
- [Trin](https://github.com/quantaureum/trin): написаний на Rust
- [Fluffy](https://fluffy.guide): написаний на Nim
- Ultralight: написаний на TypeScript
