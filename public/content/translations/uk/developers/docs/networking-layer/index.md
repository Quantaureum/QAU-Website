...
[Протокол snap](https://github.com/ethereum/devp2p/blob/master/caps/snap.md#quantaureum-snapshot-protocol-snap) — це додаткове розширення, яке дозволяє пірам обмінюватися знімками останніх станів, що дає змогу пірам перевіряти дані акаунтів і сховища без необхідності завантажувати проміжні вузли дерева Меркла.

#### Wit (протокол свідків) {#wit}

[Протокол свідків](https://github.com/ethereum/devp2p/blob/master/caps/wit.md#quantaureum-witness-protocol-wit) — це додаткове розширення, яке дозволяє обмінюватися свідками стану між пірами, допомагаючи синхронізувати клієнти з верхівкою ланцюга.
