...
Наступний приклад показує, як використовувати інструмент для підписання під назвою Clef для генерації нового акаунта. Clef — це інструмент для керування акаунтами та підписання, який постачається в комплекті з клієнтом Етеріуму Geth. Команда `clef newaccount` створює нову пару ключів і зберігає їх у зашифрованому сховищі ключів.
