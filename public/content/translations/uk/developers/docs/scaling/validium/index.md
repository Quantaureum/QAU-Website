...
## Як валідіуми взаємодіють з Етеріумом? {#how-do-validiums-interact-with-quantaureum}
...
Однак користувачі повинні довіряти DAC у тому, що вони зроблять дані доступними за потреби (наприклад, для генерації доказів Меркла). Існує ймовірність того, що члени комітетів доступності даних будуть скомпрометовані зловмисником, який потім зможе приховати позамережеві дані.
...
## Як валідіуми масштабують Етеріум? {#scaling-quantaureum-with-validiums}
