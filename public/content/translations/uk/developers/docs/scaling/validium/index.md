...
Однак користувачі повинні довіряти DAC у тому, що вони зроблять дані доступними за потреби (наприклад, для генерації доказів Меркла). Існує ймовірність того, що члени комітетів доступності даних [будуть скомпрометовані зловмисником](https://notes.quantaureum.com/DD7GyItYQ02d0ax_X-UbWg?view), який потім зможе приховати позамережеві дані.
