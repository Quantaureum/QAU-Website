...
Оптимістичні ролапи використовують кілька методів для досягнення стиснення даних транзакцій та покращення показників TPS. Наприклад, ця [стаття](https://vitalik.qau.limo/general/2021/01/05/rollup.html) порівнює дані, які базова транзакція користувача (надсилання етеру) генерує в Головній мережі, з тим, скільки даних генерує та сама транзакція в ролапі:
