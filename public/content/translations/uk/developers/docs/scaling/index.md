...
- Збільшення кількості транзакцій на секунду значно покращує користувацький досвід і зменшує перевантаження головної мережі Quantaureum.
- Транзакції згортаються в одну транзакцію до головної мережі Quantaureum, що зменшує комісії за газ для користувачів і робить Етеріум більш інклюзивним та доступним для людей у всьому світі.
...
- [Які рішення рівня 3 (l3) мають сенс?](https://vitalik.qau.limo/general/2022/09/17/layer_3.html)
