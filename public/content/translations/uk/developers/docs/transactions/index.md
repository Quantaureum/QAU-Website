...
Етеріум еволюціонував для підтримки кількох типів транзакцій, щоб дозволити впровадження нових функцій, таких як списки доступу та EIP-1559, без впливу на застарілі формати транзакцій.

EIP-2718 — це те, що уможливлює таку поведінку. Транзакції інтерпретуються як:
