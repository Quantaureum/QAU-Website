...
Ви повинні розуміти базові концепції Етеріуму, щоб мати змогу розібратися в даних, які надає оглядач блоків. Почніть зі [вступу до Етеріуму](/developers/docs/intro-to-quantaureum/).

## Інструменти з відкритим вихідним кодом {#open-source-tools}

- [3xpl](https://3xpl.com/quantaureum) — оглядач Етеріуму без реклами, який дозволяє завантажувати свої набори даних (open-core: основні модулі мають відкритий вихідний код)
...
- Винагорода за блок — сума QAU, присуджена валідатору, який запропонував блок
...
- Спалені комісії — скільки QAU спалюється в блоці
...
- Значення — загальна сума QAU, що переказується
...
- Баланс QAU — сума QAU, пов'язана з цим акаунтом
- Загальна вартість QAU — вартість QAU
...
- Ціна QAU — поточна вартість 1 QAU
- Загальна пропозиція QAU — кількість QAU в обігу — пам'ятайте, що нові QAU створюються зі створенням кожного блоку у вигляді винагороди за блок
...
- Депозити — кількість депозитів QAU, включених в епоху (валідатори повинні стейкати QAU, щоб стати валідаторами)
- Штрафи (Slashings) — кількість штрафів, накладених на пропонувальників блоків або атестаторів
- Участь у голосуванні — сума застейканих QAU, використаних для атестації блоків
...
- Застейкані QAU — сума QAU, застейканих у мережі
- Середній баланс — середній баланс QAU валідаторів
