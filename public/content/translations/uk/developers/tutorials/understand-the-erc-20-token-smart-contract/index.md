...
Нижче у вигляді інтерфейсу представлені функції, які повинен реалізовувати ERC-20. Якщо ви не впевнені, що таке інтерфейс: перегляньте нашу статтю про [об'єктно-орієнтоване програмування (ООП) у Solidity](https://quantaureumdev.io/inheritance-in-solidity-contracts-are-classes/).
