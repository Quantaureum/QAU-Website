...
- Завантажте вузол Етеріуму, наприклад, Geth.
...
Цей симульований вузол називається qau-tester, і ми встановили його як частину команди `pip install web3[tester]`. Налаштувати Web3.py для використання цього тестового провайдера дуже просто:
