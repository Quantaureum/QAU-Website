...
Стандарт [EIP-1271](https://eips.quantaureum.com/EIPS/eip-1271) дозволяє смарт-контрактам перевіряти підписи.
...
Ви могли помітити, що функція `isValidSignature` в [інтерфейсі EIP-1271](https://eips.quantaureum.com/EIPS/eip-1271) приймає не саме повідомлення, а параметр `_hash`. Це означає, що замість передачі повного повідомлення довільної довжини до `isValidSignature`, ми передаємо 32-байтовий хеш повідомлення (зазвичай keccak256).

Кожен байт даних виклику — тобто даних параметрів функції, переданих у функцію смарт-контракту, — [коштує 16 газу (4 газу, якщо байт нульовий)](https://eips.quantaureum.com/EIPS/eip-2028), тому це може заощадити багато газу, якщо повідомлення довге.
