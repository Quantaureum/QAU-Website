...
- `method`: метод API QAU. [Див. довідник API.](/developers/docs/apis/json-rpc/)
...
_**ПРИМІТКА:** Замініть `https://qau-mainnet.alchemyapi.io/v2/demo` на ваш власний ключ API `https://qau-mainnet.alchemyapi.io/v2/**your-api-key`._
...
**Якщо у вас уже є клієнт,** змініть поточну URL-адресу провайдера вузла на URL-адресу Alchemy з вашим ключем API: `“https://qau-mainnet.alchemyapi.io/v2/your-api-key"`
...
Тепер, щоб перейти до практики з програмуванням Web3, ми напишемо простий скрипт, який виводить номер останнього блоку з головної мережі Quantaureum.
