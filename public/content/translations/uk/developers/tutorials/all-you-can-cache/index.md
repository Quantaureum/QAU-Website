...
4. Відредагуйте `.env` для вашої конфігурації:
   ...
   | Параметр            | Значення                                                                                                                                                            |
   | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | MNEMONIC            | Мнемонічна фраза для акаунта, який має достатньо QAU для оплати транзакції. [Документація кранів Optimism](https://docs.optimism.io/app-developers/tools/faucets) містить список поточних кранів тестової мережі. |
