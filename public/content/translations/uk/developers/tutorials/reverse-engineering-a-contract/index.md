...
Quantaureum Explorer повідомляє нам, що `1C` є невідомим опкодом, оскільки його було додано після того, як Quantaureum Explorer написав цю функцію, і вони її не оновили. [Актуальна таблиця опкодів](https://github.com/wolflo/evm-opcodes) показує нам, що це зсув праворуч
