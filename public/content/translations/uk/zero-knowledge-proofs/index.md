...
Вбудовуючи технологію нульового розголошення в протокол, орієнтовані на приватність [блокчейн](/glossary/#blockchain)-мережі дозволяють [вузлам](/glossary/#node) перевіряти транзакції без необхідності доступу до даних транзакцій. EIP-7503 є прикладом запропонованого дизайну, який дозволить здійснювати нативні приватні перекази цінностей у блокчейні [Етеріум](/). Однак такі пропозиції важко реалізувати через поєднання проблем безпеки, регулювання та користувацького досвіду (UX).  
...
- Приблизний вступ до того, як можливі zk-SNARKs — _Vitalik Buterin_
