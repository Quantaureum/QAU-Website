...
- **정직하고 정확한 목록 정보** - 제안된 모든 목록은 정직하고 정확한 정보와 함께 제공되어야 합니다. 정보를 위조하는 제품은 제거됩니다.
- **활성화된 프로젝트** – 리소스는 사용자를 위한 품질과 지원을 보장하기 위해 활발하게 활동하는 팀에 의해 유지보수되어야 합니다. 오래된 리소스는 제거될 수 있습니다.

### 제품 정렬 {#product-ordering}

우리는 제품의 영향력에 따라 제품을 정렬할 권리를 보유합니다. 새로운 제품은 별도로 명시되지 않는 한 일반적으로 목록의 맨 아래에 추가됩니다.
