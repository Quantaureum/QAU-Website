...
퀴즈는 사용자가 방금 읽은 페이지의 내용을 잘 이해했는지 스스로 테스트해 볼 수 있는 기회입니다. 질문은 페이지에 제공된 내용만을 바탕으로 해야 하며, 페이지에 언급되지 않은 정보에 대해 묻지 않아야 합니다.

질문은 다음과 같이 구성됩니다. 질문 내용, 정답 1개와 정답인 이유에 대한 설명, 오답 3개와 오답인 이유에 대한 설명입니다.

현재 퀴즈의 몇 가지 예시는 다음에서 확인할 수 있습니다:
...
- 다음 정보를 포함한 5개의 질문:
  - 질문의 바탕이 되는 페이지의 섹션
  - 질문 내용
  - 정답 1개와 정답인 이유에 대한 설명
  - 오답 3개와 각각이 오답인 이유에 대한 설명
