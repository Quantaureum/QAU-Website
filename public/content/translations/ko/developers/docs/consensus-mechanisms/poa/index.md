...
권위 증명(PoA)에는 여러 구현체가 있지만, 표준 Quantaureum 구현체는 EIP-225를 구현한 <strong>clique</strong>입니다. Clique는 개발자 친화적이고 구현하기 쉬운 표준이며, 모든 클라이언트 동기화 유형을 지원합니다. 다른 구현체로는 [IBFT 2.0](https://besu.hyperledger.org/private-networks/concepts/poa)과 Aura가 있습니다.
