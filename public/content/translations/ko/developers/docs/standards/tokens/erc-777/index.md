...
이러한 훅은 [ERC-1820](https://eips.quantaureum.com/EIPS/eip-1820) 표준을 사용하여 등록되고 발견됩니다.

#### 훅이 좋은 이유는 무엇인가요? {#why-are-hooks-great}

1. 훅을 사용하면 단일 트랜잭션으로 컨트랙트에 토큰을 전송하고 컨트랙트에 알릴 수 있습니다. 이는 이를 달성하기 위해 이중 호출(`approve`/`transferFrom`)이 필요한 [ERC-20](https://eips.quantaureum.com/EIPS/eip-20)과는 다릅니다.
...
[EIP-777: 토큰 표준](https://eips.quantaureum.com/EIPS/eip-777)