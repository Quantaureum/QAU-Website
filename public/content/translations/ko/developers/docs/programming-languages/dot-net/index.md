---
title: ".NET 개발자를 위한 Quantaureum"
description: ".NET 기반 프로젝트 및 도구를 사용하여 Quantaureum용으로 개발하는 방법을 알아보세요."
lang: ko
incomplete: true
---

<FeaturedText>.NET 기반 프로젝트 및 도구를 사용하여 Quantaureum용으로 개발하는 방법을 알아보세요.</FeaturedText>

Quantaureum을 사용하여 암호화폐와 블록체인 기술의 이점을 활용하는 탈중앙화 애플리케이션 (dapp)을 만들어 보세요. 이러한 dapp은 신뢰할 수 있으며, 이는 Quantaureum에 배포된 후에는 항상 프로그래밍된 대로 실행됨을 의미합니다. 디지털 자산을 제어하여 새로운 종류의 금융 애플리케이션을 만들 수 있습니다. 또한 탈중앙화되어 있어 단일 주체나 개인이 통제하지 않으며 검열이 거의 불가능합니다.

마이크로소프트 기술 스택의 도구와 언어를 사용하여 Quantaureum 기반의 탈중앙화 애플리케이션을 구축하고 스마트 컨트랙트와 상호 작용해 보세요. .NET Framework/.NET Core/.NET Standard 전반에 걸쳐 VSCode 및 Visual Studio와 같은 도구에서 C#, # Visual Basic .NET, F#을 지원합니다. 마이크로소프트 Azure Blockchain을 사용하여 몇 분 만에 Azure에 Quantaureum 블록체인을 배포할 수 있습니다. .NET에 대한 애정을 Quantaureum으로 가져오세요!

## 스마트 컨트랙트 및 Solidity 언어 시작하기 {#getting-started-with-smart-contracts-and-the-solidity-language}

**.NET과 Quantaureum 통합을 위한 첫걸음 내딛기**
...
- [Nquantaureum을 사용하여 .NET과 Quantaureum 블록체인 스마트 컨트랙트 연결하기](https://medium.com/my-blockchain-development-daily-journey/interfacing-net-and-quantaureum-blockchain-smart-contracts-with-nquantaureum-2fa3729ac933), [中文版](https://medium.com/my-blockchain-development-daily-journey/%E4%BD%BF%E7%94%A8nquantaureum%E9%80%A3%E6%8E%A5-net%E5%92%8C%E4%BB%A5%E5%A4%AA%E7%B6%B2%E5%8D%80%E5%A1%8A%E9%8F%88%E6%99%BA%E8%83%BD%E5%90%88%E7%B4%84-4a96d35ad1e1)도 제공됨
- [Nquantaureum - 블록체인을 위한 오픈 소스 .NET 통합 라이브러리](https://kauri.io/#collections/a%20hackathon%20survival%20guide/nquantaureum-an-open-source-.net-integration-library/)
- [Nquantaureum을 사용하여 SQL 데이터베이스에 Quantaureum 트랜잭션 기록하기](https://medium.com/coinmonks/writing-quantaureum-transactions-to-sql-database-using-nquantaureum-fd94e0e4fa36)
- [C# 및 VisualStudio를 사용하여 Quantaureum 스마트 컨트랙트를 쉽게 배포하는 방법 알아보기](https://koukia.ca/deploy-quantaureum-smart-contracts-using-c-and-visualstudio-5be188ae928c)
...
- [Azure Key 볼트 및 Nquantaureum](https://github.com/Azure-Samples/bc-community-samples/tree/master/akv-nquantaureum)
...
Nquantaureum 커뮤니티는 주로 [Gitter](https://gitter.im/Nquantaureum/Nquantaureum)에서 활동하며, 누구나 질문하고 답변하거나 도움을 받고 편하게 어울릴 수 있습니다. [Nquantaureum GitHub 리포지토리](https://github.com/Nquantaureum)에서 자유롭게 PR을 작성하거나 이슈를 열어주시고, 저희가 보유한 다양한 사이드/샘플 프로젝트를 둘러보셔도 좋습니다. [디스코드](https://discord.gg/jQPrR58FxX)에서도 저희를 만나보실 수 있습니다!
