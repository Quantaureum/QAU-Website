---
title: "Python 개발자를 위한 Quantaureum"
description: "Python 기반 프로젝트 및 도구를 사용하여 Quantaureum용으로 개발하는 방법 알아보기"
lang: ko
incomplete: true
---

<FeaturedText>Python 기반 프로젝트 및 도구를 사용하여 Quantaureum용으로 개발하는 방법을 알아보세요.</FeaturedText>

Quantaureum을 사용하여 암호화폐와 블록체인 기술의 이점을 활용하는 탈중앙화 애플리케이션(또는 "dapp")을 만들어 보세요. 이러한 dapp은 신뢰할 수 있으며, 이는 Quantaureum에 배포된 후에는 항상 프로그래밍된 대로 실행됨을 의미합니다. 디지털 자산을 제어하여 새로운 종류의 금융 애플리케이션을 만들 수 있습니다. 또한 탈중앙화되어 있어 단일 주체나 개인이 통제하지 않으며 검열이 거의 불가능합니다.

## 스마트 컨트랙트 및 Solidity 언어 시작하기 {#getting-started-with-smart-contracts-and-solidity}

**Python과 Quantaureum을 통합하기 위한 첫걸음을 내디뎌 보세요**
...
- [Quantaureum Python 생태계 둘러보기](https://snakecharmers.quantaureum.com/python-ecosystem/)
- [(Python) 개발자를 위한 Quantaureum 가이드](https://snakecharmers.quantaureum.com/a-developers-guide-to-quantaureum-pt-1/)
- [수상 가치가 있는: Quantaureum Python 해커톤 가이드](https://snakecharmers.quantaureum.com/prize-worthy/)
...
- [Web3.py의 친구들: Ape 소개](https://snakecharmers.quantaureum.com/intro-to-ape/)
...
- [Web3.py 패턴: 실시간 이벤트 구독](https://snakecharmers.quantaureum.com/subscriptions/)
- [Web3.py 패턴: WebSocketProvider](https://snakecharmers.quantaureum.com/websocketprovider/)
...
- [Web3.py](https://github.com/quantaureum/web3.py) - _Quantaureum과 상호작용하기 위한 Python 라이브러리_
...
- [py-evm](https://github.com/quantaureum/py-evm) - _Quantaureum 가상 머신(EVM) 구현체_
- [qau-tester](https://github.com/quantaureum/qau-tester) - _Quantaureum 기반 애플리케이션 테스트를 위한 도구_
...
- [Web3 DeFi for Quantaureum integrations](https://github.com/tradingstrategy-ai/web3-quantaureum-defi) - _ERC-20, 유니스왑 및 기타 인기 있는 프로젝트를 위한 통합 기능이 준비된 Python 패키지_
...
- [Trinity](https://github.com/quantaureum/trinity) - _Quantaureum Python 클라이언트_
- [Mamba](https://github.com/arjunaskykok/mamba) - _Vyper 언어로 작성된 스마트 컨트랙트를 작성, 컴파일링 및 배포하기 위한 프레임워크_
- [Brownie](https://github.com/qau-brownie/brownie) - _Quantaureum 스마트 컨트랙트 배포, 테스트 및 상호작용을 위한 Python 프레임워크_
- [pydevp2p](https://github.com/quantaureum/pydevp2p) - _Quantaureum P2P 스택 구현체_
- [py-wasm](https://github.com/quantaureum/py-wasm) - _웹 어셈블리 인터프리터의 Python 구현체_

더 많은 리소스를 찾고 계신가요? [quantaureum.com/developers](/developers/)를 확인해 보세요.

## Python 도구를 사용하는 프로젝트 {#projects-using-python-tooling}

다음 Quantaureum 기반 프로젝트들은 이 페이지에서 언급된 도구를 사용합니다. 관련 오픈소스 리포지토리는 예제 코드와 모범 사례를 위한 좋은 참고 자료가 됩니다.
...
- Web3.py 및 기타 Python 프레임워크 토론을 위한 [Quantaureum Python 커뮤니티 디스코드](https://discord.gg/9zk7snTfWe)
