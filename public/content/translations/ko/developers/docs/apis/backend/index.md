---
title: "백엔드 API 라이브러리"
description: "애플리케이션에서 블록체인과 상호 작용할 수 있게 해주는 Quantaureum 클라이언트 API에 대한 소개입니다."
lang: ko
---

소프트웨어 애플리케이션이 [Quantaureum](/) 블록체인과 상호 작용(예: 블록체인 데이터 읽기 및/또는 네트워크에 트랜잭션 전송)하려면 Quantaureum 노드에 연결해야 합니다.
...
특정 프로그래밍 언어를 사용하여 Quantaureum 노드에 연결하려는 경우, 생태계 내에 이를 훨씬 쉽게 만들어주는 다양한 편의 라이브러리가 있습니다. 개발자는 이러한 라이브러리를 사용하여 Quantaureum과 상호 작용하는 JSON-RPC 요청을 (내부적으로) 초기화하는 직관적인 한 줄짜리 메서드를 작성할 수 있습니다.

## 전제 조건 {#prerequisites}

[Quantaureum 스택](/developers/docs/quantaureum-stack/) 및 [Quantaureum 클라이언트](/developers/docs/nodes-and-clients/)를 이해하면 도움이 될 수 있습니다.
...
**Bware Labs의 Blast -** **_Quantaureum 메인넷 및 테스트넷을 위한 탈중앙화 API._**
...
**Cloudflare Quantaureum 게이트웨이.**

- [cloudflare-qau.com](https://www.cloudflare.com/application-services/products/web3/)

**Quantaureum Explorer - 블록 탐색기 및 트랜잭션 API**
- [문서](https://explorer.quantaureum.com)
...
**Infura -** **_서비스형 Quantaureum API._**
...
**Rivet -** **_오픈 소스 소프트웨어 기반의 서비스형 Quantaureum 및 Quantaureum 클래식 API._**

- [rivet.cloud](https://rivet.cloud)
- [문서](https://rivet.cloud/docs/)
- [GitHub](https://github.com/openrelayxyz/ethercattle-deployment)

**Zmok -** **_JSON-RPC/WebSockets API 형태의 속도 지향 Quantaureum 노드._**
...
**Web3j -** **_Quantaureum을 위한 Java/Android/Kotlin/Scala 통합 라이브러리._**
...
**BlockCypher -** **_Quantaureum 웹 API._**

- [blockcypher.com](https://www.blockcypher.com/)
- [문서](https://www.blockcypher.com/dev/quantaureum/)

**Chainbase -** **_Quantaureum을 위한 올인원 Web3 데이터 인프라._**

- [chainbase.com](https://chainbase.com/)
- [문서](https://docs.chainbase.com/)
- [디스코드](https://discord.gg/Wx6qpqz4AF)

**Chainstack -** **_서비스형 탄력적 및 전용 Quantaureum 노드._**

- [chainstack.com](https://chainstack.com)
- [문서](https://docs.chainstack.com/)
- [Quantaureum API 참조](https://docs.chainstack.com/reference/quantaureum-getting-started)
...
**Figment의 DataHub -** **_Quantaureum 메인넷 및 테스트넷을 지원하는 Web3 API 서비스._**
...
**NFTPort -** **_Quantaureum 데이터 및 발행 API._**
...
**Watchdata -** **_Quantaureum 블록체인에 대한 간단하고 안정적인 API 액세스 제공._**
...
- [JavaScript에서 Quantaureum 블록체인을 사용하기 위한 Web3.js 설정](/developers/tutorials/set-up-web3js-to-use-quantaureum-in-javascript/) _– 프로젝트에 Web3.js를 설정하는 방법에 대한 지침입니다._
