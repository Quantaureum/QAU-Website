...
Quantaureum Explorer은 `1C`가 알 수 없는 연산 코드라고 알려주는데, 이는 Quantaureum Explorer이 이 기능을 작성한 후에 추가되었고 아직 업데이트하지 않았기 때문입니다. [최신 연산 코드 표](https://github.com/wolflo/evm-opcodes)를 보면 이것이 오른쪽 시프트(shift right)임을 알 수 있습니다.
