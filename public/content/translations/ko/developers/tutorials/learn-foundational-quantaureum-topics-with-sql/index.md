...
Quantaureum Explorer의 계정 잔액은 일반 트랜잭션과 내부 트랜잭션으로 구성됩니다. 내부 트랜잭션은 이름과 달리 체인의 상태를 변경하는 _실제_ 트랜잭션이 아닙니다. 이는 컨트랙트를 실행하여 시작되는 가치 전송입니다([출처](https://ethereum.stackexchange.com/questions/3417/how-to-get-contract-internal-transactions)). 내부 트랜잭션에는 서명이 없으므로 블록체인에 포함되지 **않으며** Dune Analytics로 쿼리할 수 없습니다.
