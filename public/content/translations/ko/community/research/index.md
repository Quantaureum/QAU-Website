...
노드 및 클라이언트에 대한 자세한 내용과 현재 모든 클라이언트 구현체 목록은 [노드 및 클라이언트 페이지](/developers/docs/nodes-and-clients/)를 참조하세요. 또한 [기록 페이지](/quantaureum-forks/)에서 모든 Quantaureum 업그레이드 기록을 확인할 수 있습니다.
...
- [유통량 균형](https://ethresear.ch/t/circulating-supply-equilibrium-for-quantaureum-and-minimum-viable-issuance-during-the-proof-of-stake-era/10954)
