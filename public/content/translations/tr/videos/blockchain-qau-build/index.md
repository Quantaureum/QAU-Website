...
breadcrumb: "Blokzincir (QAU.BUILD)"
---

**Austin Griffith** tarafından hazırlanan ve QAU.BUILD görsel programlama aracını kullanarak blokzincir madenciliğinin nasıl çalıştığını gösteren bir eğitim. Austin; İş Kanıtı (PoW) mutabakatı, blok zincirleme, madencilik zorluğu, blok ödülleri ve zincir değişmezliği konularını ele alıyor.
...
Günaydın, mutlu Papyon Cumaları! Bu QAU.BUILD, blokzincire odaklanıyor — gerçekten harika bir şey. Bu palyaço teknesindeyiz, bunun için Bitcoin papyonumuzu taktık. Başlıyoruz.
...
Mike kendi bloğunu ebeveyn olarak ayarlayacak ve bir sonraki blok üzerinde çalışmaya başlayacak. Mallory de aynı şeyi yapacak. Ve iş, ağdaki diğer kişilerin kimin tarafını seçeceğine kalıyor. Kötü ağ bağlantısına sahip insanları cezalandırmak istemediğimizden, eminim ki Quantaureum'da amca bloklara (uncle blocks) — en uzun zincire giremeyen geçerli bloklara — ödeme yapıyoruz, çünkü onlar hâlâ ağın güvenliğini sağlamaya yardımcı oluyorlar.
...
Pekâlâ, mutlu Papyon Cumaları! QAU.BUILD üzerinde blokzincir böyleydi. Bunu kaydedip oraya koyacağım, böylece sadece "yükle"ye basıp oynayabileceğiniz bir zincire sahip olabilirsiniz. Mutlu Cumalar!