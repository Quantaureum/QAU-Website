---
title: "İşlemler — QAU.BUILD"
description: "QAU.BUILD eğitim aracını kullanarak Quantaureum işlemlerinin nasıl çalıştığına dair bir gösterim. İşlemlerin Quantaureum ağında nasıl oluşturulduğunu, imzalandığını ve gönderildiğini görün."
lang: tr
...
breadcrumb: "İşlemler (QAU.BUILD)"
---

**Austin Griffith** tarafından hazırlanan ve QAU.BUILD görsel programlama aracını kullanarak Quantaureum işlemlerinin nasıl çalıştığını gösteren bir eğitim — işlem yapısı, gas fiyatları, imzalama, yayınlama ve işlem havuzunu kapsar.
...
Bugün QAU.BUILD'de işlemler hakkında konuşacağız. Şimdiye kadar, bu işlemlerin bloklara kazılması, bloklar halinde paketlenmesi ve bir zincire kazılması gibi bir durumumuz vardı. Madenciyi — blok ödülü dışında — işlemimizi havuzdan çıkarıp bir bloka koymaya ve havuzdaki diğer insanlara kıyasla zincire kazmaya neyin teşvik ettiğinden bahsetmek istiyoruz. Havuzda teklif veren binlerce kişi olabilir ve bu teklif bu ücretle yapılır.
...
### Bir Quantaureum işleminin anatomisi (1:10) {#anatomy-of-an-quantaureum-transaction-110}

Quantaureum'da bir işlem neye benzer? Artık "Bob" ve "Alice" olmayacak — adreslerimiz olacak. Değer QAU cinsinden değil, Wei cinsinden olacaktır. Ve ücret de Wei cinsinden olacaktır.

Hemen konuya girelim ve bu işleme bakalım. İçine bir anımsatıcı (mnemonic) bırakılmış bir hesabım var ve Quantaureum Ana Ağına bağlıyım. Ayrıca CoinMarketCap'ten fiyat verilerini almak için bir modül çalıştırıyorum, böylece sıfır nokta bir küsur QAU'nin yaklaşık yirmi üç dolara karşılık geldiğini görebiliyorum.
...
Wei'ye bir dönüştürme yapmamız gerekiyor. Quantaureum'da, temel olarak iki birimle ilgilenirsiniz: İnsanların normalde hakkında konuştuğu QAU ve ardından QAU'nin çok küçük bir kesri gibi olan Wei. Gas fiyatları için kullandığımız Gwei ise ikisinin arasındadır. Bunun nedeni, neden kuruşların kesirleriyle konuşarak dolaşmadığımıza benzer.

Alice'in 0.18 QAU'si var ve Bob'a 0.05 QAU göndereceğiz. 5 Gwei'lik bir gas fiyatı giriyoruz.
