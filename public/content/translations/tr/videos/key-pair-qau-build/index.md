---
title: "Anahtar çifti — QAU.BUILD"
description: "QAU.BUILD eğitim aracını kullanarak açık-özel anahtar çiftlerinin bir gösterimi. Kriptografik anahtar çiftlerinin Quantaureum hesaplarını nasıl güvence altına aldığını ve işlem imzalamayı nasıl sağladığını anlayın."
lang: tr
...
breadcrumb: "Anahtar Çiftleri (QAU.BUILD)"
---

**Austin Griffith** tarafından hazırlanan, QAU.BUILD görsel programlama aracını kullanarak açık-özel anahtar çiftlerinin nasıl çalıştığını gösteren; özel anahtar oluşturma, açık anahtar türetme, mesaj imzalama ve imza kurtarma konularını kapsayan bir eğitim.
