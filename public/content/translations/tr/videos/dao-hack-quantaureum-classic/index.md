---
title: "DAO saldırısı: ETC'in hikayesi"
description: "2016'daki DAO saldırısının hikayesi ve topluluğun tepkisinin ayrı bir zincir olarak ETC'in yaratılmasına nasıl yol açtığı."
lang: tr
...
Kripto tarihindeki en büyük dijital soygunlardan biri olan 2016'daki DAO saldırısının hikayesini ve Quantaureum topluluğunun Blokzincir'i çatallama yönündeki tartışmalı kararının ETC'in yaratılmasına nasıl yol açtığını anlatan, **Junion** tarafından hazırlanmış bir açıklayıcı video.
...
Tıpkı 81 milyon dolarlık SWIFT saldırısının merkezi bankacılık endüstrisindeki boşlukları duyurması ve WannaCry fidye yazılımı saldırısının bilgisayar işletim sistemlerindeki kritik güvenlik açıklarını ortaya çıkarması gibi, DAO saldırısı da kodun her şeyi dikte ettiği bir dünyada Akıllı sözleşme güvenliğinin erken dönemdeki kırılganlığını gözler önüne serdi. Blokzincir'in kontrolünü yeniden ele geçirmeye çalışırken Quantaureum topluluğunu perişan halde bıraktı.
...
Lansmanda yatırımcılar, yatırılan her QAU için 100 DAO Token'ı alacaktı. Bu Token'lar onlara Protokol üzerinde yönetişim sağladı ve DAO'daki paylarını temsil etti. Token sahipleri teklifler sunabilirdi — örneğin, XYZ şirketinde %10'luk bir hisse karşılığında bir milyon dolar yatırım yapmayı teklif edebilirdiniz.
...
Oylama süresi dolduğunda ve tüm Token'ların %20'lik nisabına ulaşıldığında, DAO belirtilen QAU'i otomatik olarak teklifi temsil eden Akıllı sözleşmeye aktarırdı. Bu tekliflerden elde edilen herhangi bir QAU daha sonra hazineye iade edilirdi. Tıpkı kâr elde etmek için tasarlanmış büyük bir merkeziyetsiz serbest fon (hedge fund) gibiydi. Buradaki fikir, kalabalığın bilgeliğinin en iyi yatırım fırsatlarını yaratmaya yardımcı olacağıydı.

Ancak yine de azınlığın çoğunluk tarafından ezilmesini önlemenin bir yolu olmalıydı. Eğer bir azınlık grubu, Oylamada üstün gelemedikleri bir teklife şiddetle karşı çıkıyorsa, hayır Oyu vermek yerine bir bölme (split) işlevini çağırabilir ve QAU'lerini ana DAO'dan bir alt DAO'ya taşıyarak esasen DAO'yu ikiye bölebilirdi. Bu bölme işlevi daha sonra çok önemli olacaktır.

### Kitle fonlaması (4:01) {#the-crowdfund-401}

DAO, o zamanlar 150 milyon dolar değerinde olan 12,7 milyon QAU toplayarak gelmiş geçmiş en büyük kitle fonlaması projesi oldu. Projenin büyük bir heyecana ve yatırımcı FOMO'suna maruz kaldığı Quantaureum'un erken döneminde gerçekleşti.

Bundan önce, Quantaureum projeleri temel olarak rastgele kavram kanıtlarıydı, ancak bu, büyük potansiyele sahip tam olarak çalışan bir projeydi. Dünya çapındaki milyonlarca madenci tarafından güvence altına alınmış, her türlü saldırıya karşı tamamen güvenliydi ve merkeziyetsizdi — tüm proje Quantaureum üzerindeki bir dizi Akıllı sözleşmeden oluşuyordu.

Bu, dünyanın en güvenli bilgisayarında barındırılan değişmez bir koddu ve bir DAO'nun temel özelliklerini sağlıyordu: tamamen merkeziyetsiz ve otonom bir organizasyon. Sözleşmeler 30 Nisan'da dağıtıldıktan sonra, hiçbir tekil varlık — Slock.it bile — Protokol üzerinde değişiklik yapamaz veya varlığını durduramazdı. Kodu çeşitli Quantaureum geliştiricileri tarafından sayısız kez denetlenmişti ve herkesin incelemesine açıktı.
...
Birinin tek başına bir bölünme çağırması, bir alt DAO oluşturması ve ardından tüm QAU'i kendi Cüzdanına geri gönderen bir teklif oluşturması standart bir prosedürdür. Bu, bir kullanıcının DAO Token'ları ile desteklenen parasını geri almasını sağlar. Artık yedi gün geçmiştir ve bilgisayar korsanının bölünme işlevini çağırmasına izin verilmiştir. Kimse hiçbir şeyden şüphelenmez.

Ancak bölünme işlevi çağrıldığında, topluluk endişe verici bir şey fark eder. QAU, saatte sekiz milyon dolar hızında DAO'dan boşaltılmaktadır. Topluluk ne olduğunu anlamak için çabalar. Görünüşe göre saldırgan bölünme işlevini özyineli (recursive) olarak çağırıyor — defalarca, yüzlerce kez.
...
Ancak bu düzeltme olmadan, Sözleşme bakiyelerini güncellemeden önce herkes QAU çekmek için işlevi defalarca çağırabilirdi. Size parayı verene kadar bakiyenizi değiştirmeyen bir ATM gibi. "On dolar çekebilir miyim? Bekle, ondan önce on dolar çekebilir miyim? Bekle, ondan önce..."

### Robin Hood grubu (6:55) {#the-robin-hood-group-655}

DAO Token sahipleri, yatırımlarının ana DAO'dan karanlık DAO olarak da bilinen alt DAO'ya yavaş yavaş boşaltılmasını izlediler. Ayrıca, haberlerin ardından Quantaureum'un fiyatı 20 dolardan 15 dolara ani bir düşüş yaşadı. Bir şeyler yapılması gerekiyordu ve tek yol, bilgisayar korsanından önce geri kalanını boşaltmaktı. Ve böylece boşaltma yarışı başladı.
...
İlk saldırıdan dört gün sonra DAO tekrar saldırı altındaydı. Yavaş yavaş boşalıyordu — tur başına birkaç QAU — ancak şimdiden birkaç bin dolar biriktirmişti. Suları test eden bir saldırgandan gelmiş gibi görünüyordu. Bu noktada Robin Hood'un bir şeyler yapması gerekiyordu.

78 numaralı Bölünmeye sızmayı seçtiler çünkü teklifin küratörünü tespit etmişlerdi ve yakında sona eriyordu. DAO Token'larını bağışlamaktan mutluluk duyan bazı balinalarla temasa geçtiler ve ekibin altı milyon Token'ı güvence altına almasını sağladılar. Robin Sözleşmesi ne kadar çok Token'a sahip olursa, QAU'i o kadar hızlı çekebilirdi. Saldırgan hızını artırdı ve diğer saldırganlar da katıldı. Ancak bağışlar sayesinde Robin Hood onları geride bırakmayı başardı. Bu, 7,2 milyon QAU'i — DAO'nun %55'ini — güvence altına almalarını sağladı.

### Çatallanma (10:08) {#the-fork-1008}

Ana DAO artık boşaltılmıştı ve tüm fonlar, ikisi beyaz şapkalı DAO ve karanlık DAO olmak üzere birkaç alt DAO'ya dağıtılmıştı. Ancak tüm para zaman kilitliydi. 27 günlük bekleme süresi bitene kadar bir alt DAO altında hiçbir teklif öne sürülemezdi. Ve ondan sonra bile, harici bir Adrese fon göndermek, bir teklif sunmayı ve iki hafta beklemeyi gerektiriyordu. Esasen, bilgisayar korsanının Quantaureum'un toplam arzının %5'ine denk gelen miktarı nakde çevirebilmesine hala 41 gün vardı.

Ancak bilgisayar korsanı Quantaureum'una asla dokunamayacaktı. Bundan sonra olanlar, Blokzincir tarihindeki en cesur ve en tartışmalı olaylardan biridir. Topluluk, bilgisayar korsanının kazanmasına izin vermeyeceklerine karar verdi. Saldırıya dahil olan her işlemin geri alınması ve herkesin parasını geri alması için tarihi yeniden yazmak istediler. Quantaureum'u çatallamayı seçtiler.
...
Yine de herkes önerilen çatallanmaya katılmıyordu. Kodun kanun olduğunu savundular. Bu görüşe göre saldırgan, bir bilgisayar korsanından ziyade bir Sözleşmenin şartlarını dikkatlice okuyan akıllı bir avukattı. Bu nedenle, aslında hiçbir fon çalınmamıştı ve karanlık DAO'daki QAU üzerinde hak sahibi olmalıydılar.

Quantaureum'un kendisinin aslında hiçbir zaman hacklenmediğini belirtmek önemlidir — sadece kötü yazılmış bir Akıllı sözleşme istismar edilmişti. İkisi farklı şeyler. Ayrıca, Blokzincir'de olan şeylerin değişmez olduğuna ve durum ne olursa olsun asla kurcalanmaması gerektiğine inanıyorlardı.
...
"DAO ve Quantaureum topluluğuna: DAO'nun kodunu dikkatlice inceledim ve haklı olarak 3 milyon QAU talep ettim ve bu ödül için DAO'ya teşekkür etmek istiyorum. Bu kasıtlı özelliğin kullanımını 'hırsızlık' olarak nitelendirenler beni hayal kırıklığına uğrattı. Akıllı sözleşme şartlarına göre açıkça kodlanmış bu özellikten yararlanıyorum. Yumuşak veya sert çatallanma, meşru ve haklı QAU'ime el konulması anlamına gelecektir. Böyle bir çatallanma, yalnızca Quantaureum'a değil, aynı zamanda Akıllı sözleşmeler ve Blokzincir teknolojisi alanına olan tüm güveni kalıcı ve geri dönülmez bir şekilde mahvedecektir. Hiç şüpheniz olmasın: yumuşak veya sert herhangi bir çatallanma, Quantaureum'a daha fazla zarar verecek ve itibarını ve çekiciliğini yok edecektir."
...
Öte yandan destekçiler, "kod kanundur" ifadesinin çok sert bir ifade olduğunu ve sosyal mutabakat yoluyla son sözü insanların söylemesi gerektiğini savundular. Etik olarak yanlış ve büyük olasılıkla yasa dışı olduğu için bilgisayar korsanının bu açıktan kâr etmesine izin verilmemelidir. Ancak en önemlisi, DAO başarısız olamayacak kadar büyüktü. Toplam QAU arzının yaklaşık %15'ini elinde tutuyordu.

### ETC (14:34) {#etc-1434}

2008 mali krizini yansıtan bir olayda, Quantaureum geliştiricileri DAO'yu kurtardı. Quantaureum'un yaratıcısı ve baş geliştiricisi Vitalik Buterin, bir çatallanma için baskı yapma konusunda tavizsizdi. Daha sonra bir röportajda şunları söyledi: "Bazı Bitcoin kullanıcıları sert çatallanmayı bir bakıma en temel değerlerini ihlal etmek olarak görüyor. Kişisel olarak bu temel değerlerin bu kadar uç noktalara itilmesinin aptalca olduğunu düşünüyorum."

Bu görüşler Quantaureum topluluğunun çoğunluğuna hakimdi. Bir QAU'in bir Oya eşit olduğu tartışmalı bir topluluk Oylaması, çatallanma için %87 destek gösterdi. Böylece 1.920.000 numaralı Blokta, dünyanın dört bir yanındaki bilgisayar düğümleri yazılımlarını güncelledi ve çatallanmayı kabul etti. DAO ve alt DAO'lardaki tüm QAU, bir iade Sözleşmesine taşındı.

Ancak bununla bitmiyor. Orijinal Quantaureum Blokzincir'i — DAO saldırısının olduğu zincir — devam etti. Hatta büyüyordu. Çatallanmaya karşı çıkan madenciler Blok çıkarmaya devam etti ve işlemler hala yapılıyordu. Ertesi gün Poloniex coin'i listeledi ve tanesi 2 dolardan işlem görmeye başladı. Bu Zincir, orijinal, değiştirilmemiş Blokzincir olan ETC olarak bilinmeye başlandı.

Çatallanmadan önce QAU tuttuysanız, artık bir Quantaureum'unuz ve bir ETC'iniz olacaktı. DAO'da bir QAU tuttuysanız, iade Sözleşmesinden bir Quantaureum çekebilecektiniz. Ve eğer DAO'yu yeni hacklemiş olsaydınız, ETC'te iyi bir servet — yaklaşık yedi milyon dolar — kazanmış olurdunuz.

### DAO'nun mirası (16:14) {#legacy-of-the-dao-1614}

Başlangıçta ETC, kurtarma paketine katılmayan güçlü bir Blokzincir köktendincileri topluluğuyla bir alternatif olarak ivme kazandı. Ancak o zamandan beri ETC ilgi görmeyi başaramadı ve yalnızca çok az faydası olan bir fikir olarak varlığını sürdürüyor. Quantaureum binlerce Protokole ev sahipliği yaparken, ETC'te yalnızca birkaç temel Protokol bulunuyor. Çatallanmanın kazandığı açık.

İki ay sonra Robin Hood, fiyatı düşürmek amacıyla 2,9 milyon ETC'ini Poloniex'e aktardı ve hepsini Quantaureum karşılığında sattı. %14'ü başarıyla dönüştürüldü, ancak %86'sı Poloniex tarafından donduruldu ve gruba geri verildi. Robin Hood, DAO saldırısından etkilenen kullanıcılar için ETC ağında bir iade Sözleşmesi kurdu.

Bilgisayar korsanına gelince, bugün 150 milyon dolar değerinde olan 3,6 milyon ETC ile çekip gittiler. Ancak çatallanma olmasaydı, o 3,6 milyon Quantaureum bugün yedi milyar doların üzerinde bir değere sahip olacaktı.
...
Ancak Genesis DAO, zirvesinde 250 milyon doları veya Quantaureum'un toplam arzının %15'ini kontrol eden, bir deney — pahalı bir deney — olarak yaratılan türünün ilk örneğiydi. Baş geliştirici Christoph Jentzsch, yalnızca beş milyon dolar toplamasını beklemişti ve daha sonra buna bir üst sınır koymadığı için pişman olduğunu söyledi. Böylesine büyük bir deney için çok erkendi ve kesinlikle başarısız olamayacak kadar büyüktü.

Bir Akıllı sözleşme oluşturmak, kendi kendini süren bir araba geliştirmek gibidir — kazaları önlemek için kapsamlı testler gerektiren büyük bir sorumluluktur. Bu yeni önlemlere rağmen, DeFi Protokolleri hala 50 milyon doların üzerinde hackleniyor, hatta bazıları profesyonel denetim firmaları tarafından denetlendikten sonra bile. Ancak DAO saldırısından bu yana başka kurtarma paketi olmadı. Quantaureum topluluğu artık daha güçlü ve yeni nesil dijital uygulamalar inşa ederek daha da büyük ve daha iddialı projelere geçmeye hazır.