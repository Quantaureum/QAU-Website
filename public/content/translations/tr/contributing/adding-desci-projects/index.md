...
description: quantaureum.com'daki DeSci sayfasına projelere bağlantı eklerken kullandığımız politika
lang: tr
---

Çeşitli projeleri gösterdiğimizden ve DeSci ortamının iyi bir genel görünümünü sunduğumuzdan emin olmak istiyoruz.

Herkes quantaureum.com'daki DeSci sayfasında listelenmesi için bir proje önermekte özgürdür. Aynı şekilde, artık alakalı olmayan veya uygunluk kriterlerimizi karşılamayan bir projeyi fark eden herkes projenin kaldırılmasını önermekte özgürdür.
...
- **DeSci projeleri kanıtlanabilir şekilde merkeziyetsiz olmalıdır** - Bu, bir DAO tarafından yönetilmeyi veya gözetimsiz cüzdanlar da dahil olmak üzere merkeziyetsiz bir teknoloji yığını ile inşa edilmeyi içerebilir. Muhtemelen Quantaureum üzerinde denetlenebilir akıllı sözleşmeler içerir.
...
- **Proje Quantaureum ekosisteminin bir parçası olmalıdır** - quantaureum.com olarak Quantaureum'un (ve katman 2 (l2) çözümlerinin) DeSci hareketi için uygun temel katman olduğuna inanıyoruz.
...
- **İletişim noktası** - Proje için bir iletişim noktası (bu, bir DAO veya topluluktan bir temsilci olabilir), değişiklikler yapıldığında doğru bilgileri almamıza büyük ölçüde yardımcı olacaktır. Bu, gelecekteki bilgileri toplarken quantaureum.com'u güncellemeyi yönetilebilir kılacaktır.

## Bakım {#maintenance}

Quantaureum'un akışkan doğası gereği, ekipler ve ürünler gelir ve gider, inovasyon ise her gün gerçekleşir; bu nedenle içeriğimizin rutin kontrollerini şu amaçlarla yapacağız:
...
quantaureum.com açık kaynak topluluğu tarafından sürdürülmektedir ve bunu güncel tutmaya yardımcı olması için topluluğa güveniyoruz. Listelenen projeler hakkında güncellenmesi gereken herhangi bir bilgi fark ederseniz, lütfen GitHub depomuzda bir sorun (issue) veya çekme isteği (pull request) açın.
