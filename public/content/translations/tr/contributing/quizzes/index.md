...
Testler, kullanıcıların az önce okudukları sayfadaki içeriği anlayıp anlamadıklarını görmek için kendilerini sınamaları adına bir fırsattır. Sorular yalnızca sayfada sağlanan içeriğe dayanmalı ve sayfada bahsedilmeyen bilgiler hakkında soru sorulmamalıdır.

Sorular aşağıdaki gibi yapılandırılmıştır. Soru metni, neden doğru olduğuna dair bir açıklama ile birlikte 1 doğru cevap, neden yanlış olduklarına dair bir açıklama ile birlikte 3 yanlış cevap.
...
- Aşağıdaki bilgileri içeren 5 soru:
  - Sorunun dayandığı sayfa bölümü
  - Soru metni
  - Neden doğru olduğuna dair bir açıklama ile birlikte 1 doğru cevap
  - Her biri neden yanlış olduğuna dair bir açıklama içeren 3 yanlış cevap
...
- Güncellenen her soru için aşağıdaki bilgileri sağlayın:
  - Sorunun dayandığı sayfa bölümü
  - Güncellemek istediğiniz sorunun soru metni
