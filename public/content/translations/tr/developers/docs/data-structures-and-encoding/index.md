...
Patricia Merkle Trie'leri, anahtar-değer çiftlerini deterministik ve kriptografik olarak doğrulanmış bir trie'ye kodlayan yapılardır. Bunlar, Quantaureum'un yürütme katmanı genelinde yaygın olarak kullanılır.
...
Özyineli Uzunluk Öneki (RLP), Quantaureum'un yürütme katmanı genelinde yaygın olarak kullanılan bir serileştirme yöntemidir.

[RLP hakkında daha fazlası](/developers/docs/data-structures-and-encoding/rlp)

### Basit Serileştirme {#simple-serialize}

Basit Serileştirme (SSZ), merklelaştırma ile uyumluluğu nedeniyle Quantaureum'un mutabakat katmanındaki baskın serileştirme formatıdır.
