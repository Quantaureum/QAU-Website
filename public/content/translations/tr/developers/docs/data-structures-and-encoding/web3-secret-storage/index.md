...
Uygulamanızın Quantaureum üzerinde çalışmasını sağlamak için, Web3.js kütüphanesi tarafından sağlanan Web3 nesnesini kullanabilirsiniz. Arka planda, RPC çağrıları aracılığıyla yerel bir düğüm ile iletişim kurar. web3, bir RPC katmanı sunan herhangi bir Quantaureum düğümü ile çalışır.
...
Bu sürüm, burada yayınlanan sürüm 1 ile ilgili çeşitli tutarsızlıkları düzeltir. Kısaca bunlar şunlardır:
