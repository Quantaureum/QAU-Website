...
description: "Hisse kanıtı mutabakat protokolünün ve Quantaureum'daki rolünün bir açıklaması."
lang: tr
---

Hisse Kanıtı (PoS), Quantaureum'un [mutabakat mekanizmasının](/developers/docs/consensus-mechanisms/) temelini oluşturur. Quantaureum, önceki [İş Kanıtı (PoW)](/developers/docs/consensus-mechanisms/pow) mimarisine kıyasla daha güvenli, daha az enerji yoğun ve yeni ölçeklendirme çözümlerini uygulamak için daha iyi olduğu için 2022'de hisse kanıtı mekanizmasına geçiş yaptı.
...
Genel olarak, Quantaureum'da uygulandığı şekliyle hisse kanıtının, iş kanıtından ekonomik olarak daha güvenli olduğu kanıtlanmıştır.

## Artılar ve eksiler {#pros-and-cons}

| Artılar                                                                                                                                                                                                                | Eksiler                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| Staking, bireylerin ağın güvenliğini sağlamaya katılmasını kolaylaştırarak merkeziyetsizliği teşvik eder. Doğrulayıcı düğüm normal bir dizüstü bilgisayarda çalıştırılabilir. Staking havuzları, kullanıcıların 32 QAU'ye sahip olmadan stake etmelerine olanak tanır. | Hisse kanıtı, iş kanıtına kıyasla daha yenidir ve daha az savaş testinden geçmiştir              |
...
| Hisse kanıtı, iş kanıtından daha fazla kripto-ekonomik güvenlik sunar                                                                                                                                           | Kullanıcıların Quantaureum'un hisse kanıtına katılmak için üç yazılım çalıştırması gerekir. |
| Ağ katılımcılarını teşvik etmek için daha az yeni QAU ihracı gerekir                                                                                                                                            |                                                                                         |

### İş kanıtı ile karşılaştırma {#comparison-to-proof-of-work}

Quantaureum başlangıçta iş kanıtı kullanıyordu ancak Eylül 2022'de hisse kanıtına geçti. PoS, PoW'a göre aşağıdakiler gibi çeşitli avantajlar sunar:
...
- düşük enerji gereksinimi nedeniyle katılımı teşvik etmek için daha az QAU ihracı gerekir
...
- Hisse Kanıtı SSS _Vitalik Buterin_
...
- Neden Hisse Kanıtı (Kasım 2020) _Vitalik Buterin_
