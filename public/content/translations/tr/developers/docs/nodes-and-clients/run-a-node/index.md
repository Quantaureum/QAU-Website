...
Düğüm operatörleri için mevcut donanım kılavuzu EIP-7870 içinde tanımlanmıştır. Tam düğüm için şunları önerir:
...
En son ağ istemcisi kullanımını görün ve [istemci çeşitliliği](/developers/docs/nodes-and-clients/client-diversity) hakkında daha fazla bilgi edinin.
...
Tüm yapılandırma seçenekleri için belgelere göz atın ve Geth'i bir fikir birliği istemcisiyle çalıştırma hakkında daha fazla bilgi edinin.
...
Bir test ağında bir İşaret Düğümü başlatırken, Kontrol noktası eşzamanlaması için genel bir uç nokta kullanarak önemli ölçüde eşzamanlama süresinden tasarruf edebilirsiniz.
...
Staking ve Doğrulayıcı anahtarı oluşturmaya başlamanın en kolay yolu, Hoodi üzerinde düğümler çalıştırarak kurulumunuzu test etmenize olanak tanıyan Hoodi Test Ağı Staking Başlatma Paneli'ni kullanmaktır. Ana Ağ için hazır olduğunuzda, Ana Ağ Staking Başlatma Paneli'ni kullanarak bu adımları tekrarlayabilirsiniz.
...
Fikir birliği istemcilerinin tümü, fikir birliği istemcisinin durumunu kontrol etmek veya [Curl](https://curl.se) gibi araçları kullanarak istekler göndererek blokları ve mutabakat verilerini indirmek için kullanılabilecek bir İşaret API'si sunar. Bu konuda daha fazla bilgi her bir fikir birliği istemcisinin belgelerinde bulunabilir.
...
- Düğüm operatörleri için Birleşme SSS - _Temmuz 2022_
