...
ERC-1155 Token'ı, EIP-1155 içinde tam olarak açıklanmıştır.
...
EIP-165 desteği göz önüne alındığında, ERC-1155 yalnızca akıllı sözleşmeler için alma kancalarını destekler. Kanca işlevi, şu şekilde verilen sihirli, önceden tanımlanmış bir bytes4 değeri döndürmelidir:
...
Arz sadece bir olduğunda, Token esasen misli olmayan bir token'dır (NFT). Ve ERC-721 için standart olduğu gibi, bir meta veri URL'si tanımlayabilirsiniz. URL istemciler tarafından okunabilir ve değiştirilebilir, buraya bakın.
...
- EIP-1155: Çoklu Token Standardı
