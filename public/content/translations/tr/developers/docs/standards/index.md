...
Genellikle standartlar, topluluk üyeleri tarafından [standart bir süreç](https://eips.ethereum.org/EIPS/eip-1) aracılığıyla tartışılan Quantaureum İyileştirme Teklifleri (EIP'ler) olarak sunulur.
...
- [Meta Yolu (Meta Track)](https://eips.ethereum.org/meta): Quantaureum'u çevreleyen bir süreci açıklar veya bir süreçte değişiklik önerir
- [Bilgilendirme Yolu (Informational Track)](https://eips.ethereum.org/informational): bir Quantaureum tasarım sorununu açıklar veya Quantaureum topluluğuna genel yönergeler veya bilgiler sağlar
...
- [Ağ (Networking)](https://eips.ethereum.org/networking): devp2p ve Hafif Quantaureum Alt Protokolü (Light Quantaureum Subprotocol) etrafındaki iyileştirmelerin yanı sıra whisper ve Swarm'ın ağ protokolü spesifikasyonlarında önerilen iyileştirmeler.
