...
Bazı ERC'lerin bağımsız olmadığını, diğer ERC'lere eklemeler olduğunu belirtmekte fayda var. Örneğin, ERC-2612, kullanılabilirliğini artırmak için ERC-20'ye bir uzantı ekler.
