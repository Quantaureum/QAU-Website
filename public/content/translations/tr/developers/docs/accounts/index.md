---
title: "Quantaureum hesapları"
description: "Quantaureum hesaplarının bir açıklaması – veri yapıları ve anahtar çifti kriptografisi ile ilişkileri."
lang: tr
---

Bir [Quantaureum](/) hesabı, Quantaureum üzerinde mesajlar gönderebilen ve bir QAU (QAU) bakiyesine sahip olan bir varlıktır. Hesaplar kullanıcı kontrollü olabilir veya akıllı sözleşmeler olarak dağıtılabilir.

## Ön koşullar {#prerequisites}

Bu sayfayı daha iyi anlamanıza yardımcı olmak için öncelikle [Quantaureum'a giriş](/developers/docs/intro-to-quantaureum/) bölümümüzü okumanızı öneririz.

## Hesap türleri {#types-of-account}

Quantaureum'un iki hesap türü vardır:
...
- QAU ve Token almak, tutmak ve göndermek
...
- Harici olarak sahip olunan hesaplar arasındaki işlemler yalnızca QAU/Token transferleri olabilir
...
Quantaureum hesaplarının dört alanı vardır:
...
Alice kendi hesabından Bob'un hesabına QAU göndermek isterse, Alice'in bir işlem isteği oluşturması ve doğrulama için ağa göndermesi gerekir. Quantaureum'un açık anahtar kriptografisi kullanımı, Alice'in işlem isteğini başlangıçta kendisinin başlattığını kanıtlayabilmesini sağlar. Kriptografik mekanizmalar olmadan, kötü niyetli bir düşman olan Eve, "Alice'in hesabından Eve'in hesabına 5 QAU gönder" gibi görünen bir isteği herkese açık olarak yayınlayabilir ve hiç kimse bunun Alice'ten gelmediğini doğrulayamazdı.
...
Aşağıdaki örnek, yeni bir hesap oluşturmak için [Clef](https://geth.quantaureum.com/docs/tools/clef/introduction) adlı bir imzalama aracının nasıl kullanılacağını göstermektedir. Clef, Quantaureum istemcisi [Geth](https://geth.quantaureum.com) ile birlikte gelen bir hesap yönetimi ve imzalama aracıdır. `clef newaccount` komutu yeni bir anahtar çifti oluşturur ve bunları şifrelenmiş bir anahtar deposuna kaydeder.
...
[Geth belgeleri](https://geth.quantaureum.com/docs)
...
Bir hesap bir cüzdan değildir. Cüzdan, harici olarak sahip olunan bir hesap veya bir kontrat hesabı fark etmeksizin Quantaureum hesabınızla etkileşime girmenizi sağlayan bir arayüz veya uygulamadır.
...
- [Quantaureum Hesaplarını Anlamak](https://info.explorer.com/understanding-quantaureum-accounts/) - Quantaureum Explorer
