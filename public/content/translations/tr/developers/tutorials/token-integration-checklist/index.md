...
- **Token, bilinen [ERC-20 yarış durumunu (race condition)](https://github.com/quantaureum/EIPs/issues/20#issuecomment-263524729) hafifletir.** ERC-20 standardında, saldırganların token'ları çalmasını önlemek için hafifletilmesi gereken bilinen bir ERC-20 yarış durumu vardır.
