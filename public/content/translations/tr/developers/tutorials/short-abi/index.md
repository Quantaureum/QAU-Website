...
- **İşlev seçici**: Sözleşmenin 256'dan az işlevi vardır, bu nedenle onları tek bir bayt ile ayırt edebiliriz.
  Bu baytlar tipik olarak sıfır değildir ve bu nedenle on altı Gaz'a mal olur.
- **Sıfırlar**: Bu baytlar her zaman sıfırdır çünkü yirmi baytlık bir adresin tutulması için otuz iki baytlık bir kelime gerekmez.
  Sıfır tutan baytlar dört Gaz'a mal olur (Sarı Bülten'e bakın, Ek G,
...
Ne yazık ki, ERC-20 spesifikasyonlarına bakıldığında, bu geriye yalnızca bir işlev bırakır: `transfer`.
