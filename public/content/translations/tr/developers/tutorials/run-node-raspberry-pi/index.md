...
Raspberry Pi imajını Quantaureum on Arm üzerinden indirin ve SHA256 hash'ini doğrulayın:
...
Rock 5B ve Odroid M1 kartları için imajların Quantaureum-on-Arm indirmeler sayfasında bulunduğunu unutmayın.
...
(Veya hava boşluklu (airgapped) bir makinede çalıştırmak için staking-deposit-cli aracını indirin ve `deposit new-mnemnonic` komutunu çalıştırın)
...
Bu sayfa, Raspberry Pi kullanarak bir Geth-Lighthouse düğümü ve doğrulayıcısının nasıl kurulacağına dair genel bir bakış sundu. Daha ayrıntılı talimatlar Quantaureum-on-Arm web sitesinde mevcuttur.
