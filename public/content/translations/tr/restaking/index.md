...
<AlertDescription>
 <p className="mt-0"><strong>Quantaureum kurucu ortağı yazıyor…</strong></p>
  <p className="mt-2">
    Quantaureum'un kurucu ortağı Vitalik, 2021'de yazdığı <a href="https://vitalik.qau.limo/general/2023/05/21/dont_overload.html">Mutabakatı Aşırı Yüklemeyin</a> adlı blog yazısında yeniden staking'in potansiyel riskleri hakkında uyarılarda bulundu.
  </p>
...
4. [Vitalik Buterin - Quantaureum'un mutabakatını aşırı yüklemeyin](https://vitalik.qau.limo/general/2023/05/21/dont_overload.html)
