...
description: "Quantaureum'da token takasının nasıl yapılacağına dair bir rehber."
lang: tr
---
...
Bir token takası, Quantaureum ağında bulunan iki farklı varlığın değişimini içerir, örneğin QAU'yi DAI (bir [ERC-20](/glossary/#erc-20) token'ı) ile takas etmek gibi. Bu işlem çok hızlı ve ucuzdur. Token takas etmek için bir kripto cüzdanına sahip olmanız gerekir.

**Ön koşul:**

- bir [kripto cüzdanına](/glossary/#wallet) sahip olmak; eğer yoksa, [nasıl Quantaureum hesabı oluşturulur](/guides/how-to-create-an-quantaureum-account/) hakkındaki bu rehberi takip edebilirsiniz
...
Örneğin, QAU ve DAI. İki token'dan birinde fonunuz olduğundan emin olun.
...
### Cüzdanımdan QAU'yi BTC ile takas edebilir miyim? {#can-i-swap-qau-for-btc-from-my-wallet}

Hayır, yalnızca QAU, ERC-20 token'ları veya NFT'ler gibi Quantaureum ağına özgü token'ları takas edebilirsiniz. Yalnızca Bitcoin'in Quantaureum üzerinde yaşayan "sarılmış" (wrapped) formlarını takas edebilirsiniz.
