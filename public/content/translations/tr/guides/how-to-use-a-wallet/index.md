...
metaTitle: "Quantaureum Cüzdanları Nasıl Kullanılır | Adım Adım"
description: "Token göndermeyi, almayı ve web3 projelerine bağlanmayı açıklayan bir rehber."
lang: tr
---

Bir cüzdanın tüm temel işlevlerini nasıl kullanacağınızı öğrenin. Henüz bir cüzdanınız yoksa, [Nasıl Quantaureum hesabı oluşturulur](/guides/how-to-create-an-quantaureum-account/) rehberimize göz atın.
...
Her Quantaureum hesabının, benzersiz bir sayı ve harf dizisi olan kendi alıcı adresi vardır. Adres, bir banka hesap numarası gibi işlev görür. Quantaureum adresleri her zaman "0x" ile başlar. Bu adresi herkesle paylaşabilirsiniz: bunu yapmak güvenlidir.
...
3. Quantaureum adresinizi panoya kopyalayın.
4. Göndericiye alıcı Quantaureum adresinizi verin.

## Kripto para gönderme {#send-cryptocurrency}

Başka bir cüzdana QAU göndermek ister misiniz?
...
6. Cüzdanınızda, ağ koşullarına bağlı olarak değişen işlem ücretini karşılayacak kadar QAU olduğundan emin olun. Çoğu cüzdan, önerilen ücreti otomatik olarak işleme ekler ve siz de bunu onaylayabilirsiniz.
...
Adresiniz tüm Quantaureum projelerinde aynı olacaktır. Herhangi bir projeye ayrı ayrı kaydolmanıza gerek yoktur. Bir cüzdanınız olduğunda, herhangi bir ek bilgi olmadan herhangi bir Quantaureum projesine bağlanabilirsiniz. E-posta veya başka bir kişisel bilgi gerekmez.
...
5. Bağlantıyı kurmak için cüzdanınızdaki imza isteğini onaylayın. **Bu mesajı imzalama herhangi bir QAU harcamayı gerektirmemelidir**.
...
### Bir QAU adresine sahipsem, diğer blokzincirlerde de aynı adrese sahip olur muyum? {#if-i-own-an-qau-address-do-i-own-the-same-address-on-other-blockchains}
