...
**Yaratıcıları, özgürlük araç setinde iki hayati aracın eksik olduğunu fark ettiler: öz-egemen hesaplama ve başka hiç kimsenin dokunulmaz öz-egemenliğini ihlal etmeden büyük ölçekte koordine olma hesaplama yeteneği.**

Bir kullanıcı ancak kendi hesaplaması - verileri, varlıkları, talimatları, kimlikleri, temsilcileri, temel dijital bütünlüğü ve bu unsurlar için elverişsiz olduğu kanıtlanan herhangi bir sistemden çıkış hakkı - üzerinde son söze sahip olursa, cesur yeni elektronik dünyada gerçekten istedikleri ve hak ettikleri şekilde yaşama şansına sahip olabilirdi.
...
**İkinci amaç, öz-egemenliğin garantili kullanılabilirliğini, onu doğrudan uygulamaya hazır kullanıcılara ulaştırmak için ölçeklendirmektir.**

**Bu bizim ikinci temel ilkemizdir: durdurulamaz öz-egemenlik, onu seçenler için, başkalarınınkini ihlal etmeden, istedikleri ölçekte ve biçimde mümkün hale gelmelidir.**

Öz-egemenliğin pozitif olduğuna, pozitif toplamlı olduğuna ve ölçeklendirilmiş öz-egemenliğin baskın pozitif toplamlı strateji olduğuna inanıyoruz.

Öz-egemenliğin CROPS'tan ödün vermeden rekabetçi bir şekilde ölçeklenebilir olduğuna ve ölçekli olarak egemenliği koruyan koordinasyonun mümkün olduğuna inanıyoruz.
...
<details>
<summary>KAYNAK SEPPUKU LİSANSI</summary>
<div className="text-sm [&_p]:mb-2 [&_p]:mt-0">

> Bu lisansın dahil edilmesiyle, bu yazılımın yazarı, sürdürücüsü, editörü veya (yeniden) dağıtıcısı
> ("Aktör") aşağıdaki taahhütleri yerine getirmek ZORUNDADIR:
>
> Aktör tarafından yapılan tüm değişiklikler dahil olmak üzere, bu yazılımın kaynak kodunun
> ve ilgili belgelerinin tam ve doğru bir kopyasını her zaman ücretsiz olarak sunmak ve
...
## IV. EYLEM İLKELERİ {#iv-principles-for-action}

**Görev Tanımımız, her biri dört ilkeden oluşan iki temel sütuna dayanmaktadır.**

**Yaptığımız her şey - hem protokol katmanında hem de başka yerlerdeki teknik çalışmalar, topluluk desteği ve karar alma süreçleri - bu ikiz sütunlardan ve onların ilkelerinden türetilmeli ve onlara yanıt vermelidir; CROPS (Sansür Direnci, Açık Kaynak, Gizlilik, Güvenlik) ise tartışılamaz olarak kabul edilmelidir.**

### Teknik Sütun {#iv-technical-pillar}

- **Sansür Direnci:** Hiçbir aktör, herhangi bir kritik mekanizmanın kalıcı, rekabetçi olmayan kontrolünü ele geçirmek de dahil olmak üzere, geçerli kullanımı seçici olarak hariç tutamaz veya işlevselliği bozamaz.

Tüm çalışmalar, maksimum düzeyde durdurulamaz olacak ve merkezi aracılar veya acil durum kapatma anahtarları (kill switch) içermeden çalışacak şekilde tasarlanmalıdır.

Durdurulamazlığın sağlanması, uygun bir rekabet olmaksızın uyumlu olanlara, kartellere veya en yüksek teklifi verenlere seçici olarak sansür direnci sağlayan rekabete aykırı ve sömürücü bir oyuna dönüşmesini önlemek için kendi içinde sansüre dirençli olmalıdır.

Sansür direnci aynı zamanda sosyal normlar veya yasal kısıtlamalar gibi teknik dışı baskılara karşı teknik direnci de içerir. Protokol, dayanıklılığı ve tarafsızlığı için siyasi bağlamın geçici kaygılarına değil, kriptografik garantilere dayanır. Çalışmalarımız, protokolü, aynı şeyi başarmak için temel fiziksel özellikleri kısa vadeli kırılgan mekanizmalarla değiştirme girişimlerinden korumalıdır.
...
Gizlilik, her şeyin tamamen gizlenmesi demek değildir. Özgürlük ve gerçek rıza ile ilgilidir: hangi bilgiyi kime, kendi şartlarında açıklayacağını seçmek. Günlük hayatımızda, başkalarıyla etkileşime girmek veya güvene dayalı ilişkileri kademeli olarak kurmak için genellikle bilgileri ifşa eder veya kendimizle ilgili talepleri kanıtlarız.

Bununla birlikte, son kullanıcıların ifşalarını her zaman seçici olarak müzakere etmeleri gerektiğine ve bunun yalnızca serbestçe erişilebilen, koşulsuz bir gizlilik temeli üzerinde desteklenmesi gerektiğine inanıyoruz.

- **Güvenlik:** Her şey tam olarak iddia ettiği şeyi yapmalıdır, ne daha fazlasını ne de daha azını.

Güvenlik her şeyden önemlidir. Kullanıcılara zarar gelmesini önlemek ve sistem bütünlüğünü korumak için hem protokol hem de uygulama katmanlarında titiz bir güvenlik tasarımını savunuyoruz. İstenen özellikleri belirlemek ve tasarımların bunları karşıladığını doğrulamak için birden fazla yöntem kullanarak test ve doğrulamaya derinlemesine yatırım yapıyoruz.

Güvenlik, kod satırlarının ve dış bağımlılıkların sorumlu bir şekilde en aza indirilmesi de dahil olmak üzere basitlik gerektirir; bir protokolün nasıl çalıştığını ve neden güvenli olduğunu yalnızca az sayıda insan anlayabiliyorsa, o protokol "güven gerektirmeyen" bir protokol değildir. Çalışmalar birçok kişi tarafından doğrulanabilir olmalıdır. Protokol için tamamen yeni alanlar, son derece yüksek bir gereklilik eşiğini aşmalı ve bunu anlaşılır bir şekilde yapmalıdır.

Güvenlik aynı zamanda yönetişimin en aza indirilmesi anlamına da gelir; hiçbir sosyal katman protokol garantilerini kolayca geçersiz kılmamalıdır.

Güvenlik ayrıca, yalnızca protokol için değil, kullanıcılar için de uzaklaşabilme (walkaway) testini geçmek anlamına gelir: öz-egemenlik, bir kullanıcının istenmeyen riskler yaratan sık ve karmaşık geçişlere zorlanmaması gerektiği anlamına gelir.

Gerçek güvenlik, hem sistemi hem de kullanıcıları teknik arızalardan, sosyal tuzaklardan ve baskıdan korur.
...
- **İlkesel Uyum:** İlk prensibimiz, işimizde ilkeli olmamızdır.

Özel mülkiyete geçirmeye veya rekabetçi olmayan kullanıcı sömürüsüne izin veren çalışmalara değil, ilkelerimizi somutlaştıran çalışmalara odaklanıyoruz.

İlkeleri savunan dayanıklılığın kalitesine, kullanıcı sayısından veya tasarımın değer optimizasyonundan daha fazla değer veriyoruz.

Merkezi bir siloda bir milyar kullanıcı bir başarı değildir; protokolde merkezi sömürü boru hatlarının kutsanması etrafında tasarım yapmak bir başarı değildir; bu bir misyon başarısızlığıdır.

- **Disiplin:** Doğru ve iyi yapmayı önemsiyoruz.

İşimizde gerçeği ve güzelliği arıyoruz. Teknik titizlik, mükemmellik ve yaratıcılık talep ediyoruz.

Hızlı veya yavaş gitmek yerine, hiç harekete geçmemeyi de içerebilecek uygun zamanlamayı seçiyoruz. Araştırmaları ve sonuçları hızlı bir şekilde paylaşıyoruz; sunduğumuz şeylerin görev açısından kritik düzeyde güvenilir olduğundan emin oluyoruz.

Piyasa baskısı veya kurumsal rahatlık yerine ilkesel değerlendirmelere dayanan zor, potansiyel olarak popüler olmayan kararlar alma cesaretini gösteriyoruz. Taviz verilmiş varsayılanları reddetmenin ve reforme etmenin işimizin bir parçası olduğunu kabul ediyoruz. Kararlarımızı sabır ve doğrulukla savunuyoruz.

Ayrıca, bir şeyleri - özellikle de büyük şeyleri - yanlış yaptığımızda, bunu alçakgönüllülükle, zarafetle ve görüşlerimizin neden değiştiğine ve yeni görüşlerimizin ne olduğuna dair dürüst ve net bir açıklamayla kabul ediyoruz.

Yüksek standartları nezaketle eşleştiriyoruz: dayanıklı sistemler, acımasızlık olmadan açıkça aynı fikirde olamayan ve baskı altındayken meraklı kalabilen insanlar tarafından inşa edilir.

- **Doğru Birliktelik:** Kiminle çalıştığımızın kendisi ilkesel bir seçimdir.

İlkelerimizi paylaşan, yayan ve zorlu koşullarda bile kapsamlı ve açık dokümantasyon yoluyla çalışmalarını anlaşılır kılan bireyler ve ekiplerle çalışmaya öncelik veriyoruz.

Vakfın desteğine bağımlı projeler için, bizden bağımsızlıklarını kazanmak için aktif olarak çalışanlarla daha yakın çalışmayı tercih ediyoruz.
...
Onlardan hiçbir estetik uygunluk beklemediğimizi, yalnızca ilkesel uyum beklediğimizi hatırlıyoruz: insanlar sistemleri çatallanabilir, sansüre dirençli, gizli ve güvenli tutma içgüdüsünü paylaştıklarında, onlara yolun yoldaşları ve sonsuz bahçenin ortak koruyucuları olarak davranıyoruz.

Gevşek koalisyonumuzun bir araya getirilmesine gerek yoktur. O zaten bir aradadır.

## V. ÇALIŞMANIN YÜRÜTÜLMESİ {#v-carrying-out-the-work}
...
- **Sadece-EF Kuralı:** Başka doğal bir yeri olmayan ve başka hiçbir ekosistem aktörünün güvenilir bir şekilde üstlenemeyeceği veya üstlenmeyeceği kritik görevlere odaklanıyoruz. Bu, şunları içerir ancak bunlarla sınırlı değildir: çekirdek protokol yükseltmeleri ve uzun ufuklu araştırmalar, tarafsız çoklu istemci spesifikasyonları ve testleri, kamu yararına güvenlik çalışmaları, kriz koordinasyonu, darboğazların önlenmesi ve sürdürülebilir bir sahibinin olmadığı çekirdek geliştirici araçları ve belgeleri. Bu görevlerin gerçekten kritik olup olmadığını kontrol ediyoruz.

- **Ekosistem Olgunluğu için Devir:** Bir işlev veya rol, uyumlu bir topluluk aktörü tarafından başarılı bir şekilde yönetilebildiği anda, yetenek ve sorumluluğun tek bir yerde yoğunlaşmak yerine ekosistemimize yayılması için bu geçişi kolaylaştırıyoruz.

- **Bağımsız İlham ve Güvenilirlik:** Dar ve hiyerarşik bir şekilde değil, çeşitli alanlarda çalışıyoruz; bizi birbirimize bağlayan tutkal yapımız değil, misyonumuzdur. Misyonla derinden uyumlu bireyleri işe alıyoruz. Yüksek dürüstlük ve esneklikle hareket eden bireylere değer veriyoruz, çünkü deneyimlerimize göre, hızla değişen koşullarda en etkili olanlar ve belirsizlik sırasında en güvenilir olanlar onlardır.
...
- **Biz bir Kral Yapan DEĞİLİZ:** Belirli özel markaları veya şirketleri değil, yetkimiz ve temel ilkelerimizle uyumlu mekanizmaları ve tasarımları destekliyoruz. İlkelerimizden ve hedeflerimizden ödün veren standartları ne destekliyor ne de dayatıyoruz.
...
- **Biz Patron DEĞİLİZ:** Sert çatallanmaları (hard forks) veya protokol değişikliklerini zorlayamayız. Sadece misyon için en iyisini savunmak ve önermek amacıyla fikir beyan ederiz.
...
Yetkimiz ve Sadece-EF Kuralı doğrultusunda önceliğimiz ve kararlar için varsayılan yolumuz CROPS yerlisi yaklaşımdır. **CROPS'a bağlılık bileşik bir güçtür:** kullanılabilir öz-egemenlik araçları ve kaçış kapıları üretir ve başkalarının daha sonra takip edebileceği kalıcı emsaller oluşturur. Bir kullanıcı üzerinde yeni kaldıraç noktaları oluşturmadıkları veya bağımlılıklar yaratmadıkları sürece, egemenliği seçmeyi kolaylaştıran kullanılabilirlik ve performans iyileştirmelerine değer veriyoruz.

**Benimsenme zamanla kazanılabilir, ancak bir kez kaybedilen ilkeli zemini geri kazanmak çok daha zordur.**

Vakıf içinde aşamalı yaklaşıma yalnızca sıkı sıkıya sınırlandırılmış durumlarda yer bırakıyoruz: merkezi kontrolü kalıcı olarak azalttığında, yerini aldığı şeyden daha derin bir kökleşmeye yol açmadığında ve ilkelerimizi tam olarak somutlaştıran güvenilir bir alternatifin kullanılabilirliğini hızlandırdığında taktiksel bir müdahale olarak.

Çalışmalarımız yeni darboğazlar getirmemeli veya mevcut olanları kökleştirmemelidir. Eklenen güven varsayımlarına olan bağımlılığı genişletmemeli veya normalleştirmemeli ve ilkelerimizle uyumu sağlamak için sürekli Vakıf varlığı gerektirmemelidir.
...
"Savunmanın" diferansiyel ve açık kaynaklı teşviki yeni bir fikir değildir. Mohistler, dengenin hücumdan savunmaya kaydırılmasının acıları geniş çapta azalttığı teorisi altında hareket ederek, tüm şehirlerin kendilerini daha iyi savunmalarına yardımcı olan kılavuzlar yazmış ve geniş çapta dağıtmışlardır.

> **卷十四 14. Kitap**
>
> 52. 备城门 Şehir Kapısının Güçlendirilmesi
> 53. 备高临 Yüksekten Gelen Saldırıya Karşı Savunma
> 54. 备梯 Merdivenli Saldırıya Karşı Savunma
> 55. 备水 Su Baskınına Karşı Hazırlık
> 56. 备突 Ani Çıkışa Karşı Hazırlık
> 57. 备穴 Tünel Kazmaya Karşı Hazırlık
> 58. 备蛾傅 Karınca Sürüsü Saldırısına Karşı Savunma
>
> **卷十五 15. Kitap**
>
> 68. 迎敌祠 Düşmanın Gelişine Karşı Kurban
> 69. 旗帜 Bayraklar ve Flamalar
> 70. 号令 Komutlar ve Emirler
> 71. 杂守 Savunmada Çeşitli Önlemler

Mohistler ile aramızdaki en büyük farklardan biri, kimin savunduğu ve kimin saldırdığına dair kendi yargılarına dayanarak çatışmalara doğrudan müdahale etmeleridir.

Bizim yaklaşımımız, kılavuzları yazmaya ve bunları erişilebilir kılmaya daha yakındır ve bireysel çatışmalara müdahale etmemektir.

Totaliterlikten arındırmanın (de-totalization) - hiçbir organizasyonun, sistemin veya ahlaki düzenin herhangi bir bireyin hayatı üzerinde tam bir hakimiyete sahip olmadığı bir dünyaya doğru inşa etmenin - en güvenilir şekilde iyi bir amaç olduğuna inanıyoruz.

Sansür direnci, güvenlik ve gizlilik, şehir surlarının modern öncesi kolektif savunma için taşıdığı anlama benzer şekilde totaliterlikten arındırma ile ilişkilidir. Açık kaynak, bu korumaların, bireyler olarak herhangi birimizin özel sempati duyabileceği bir grup bile olsa, herhangi bir grubun asimetrik avantajı haline gelmek yerine geniş çapta dağıtılmasını, yinelenebilir ve özelleştirilebilir olmasını sağlar.

Bugünün ekibi yarının ekibi olmayabilir.

## VI. İKİLEMLERİ ÇÖZMEK {#vi-resolving-quandaries}

Önümüzdeki bin yıl boyunca, biz ve bizden sonrakiler sayısız zorlukla karşılaşacak ve belirli ayrıntılarını öngöremeyeceğimiz zor seçimlerle yüzleşeceğiz.

Ancak insanlık tarihi bize, hiçbir iki nehir aynı yatakta akmasa da, nasıl bakacağınızı bildiğinizde oydukları vadilerin şekillerinin tanıdık olduğunu öğretir.
...
**1. İki teknik olarak inandırıcı yol rekabet ettiğinde, daha hızlı piyasaya sürülebilecek olanı değil, nüfuz noktalarını ortadan kaldıranı seçeriz.**

Tasarımlarına yerleşik güven mimarileri gibi merkezi darboğazlar inşa edenlerin, bunu zorunluluktan yaptıklarını ve işler "daha olgun" hale geldiğinde bunların daha sonra kaldırılacağını söylemeleri yaygın bir nakarattır.

Ancak hem yazılım geliştirmeden hem de siyasi tarihten gelen insan deneyimi, bize böyle bir yolun tehlikelerle dolu olduğunu ve bu tür ifadelere şüpheyle yaklaşmamız gerektiğini söyler.

**Bu nedenle daha akıllıca olan yol, teknik veya sosyal olarak başlatılması ve ölçeklendirilmesi daha zor olsa bile, başından itibaren tamamen CROPS uyumlu olan seçeneği tercih etmektir.**

Örneğin: bir teklif, "ekosistem ve protokol hazır olduğunda daha sonra merkeziyetsizleştirilecek" olan, paylaşılan kara listeler veya beyaz listeler gibi altyapıyı merkezileştirme olasılığıyla sonuçlanan güvenilir ortaklara sahip küratörlü bir özel aktarım ağı aracılığıyla işlem yayılımı için "daha iyi protokol kullanıcı deneyimi" veya "daha iyi güvenlik" sunar; ikinci bir teklif ise, egzotik işlemler için isteğe bağlı özel aktarıcılar ve doğrulanabilir hataların etrafından ücretsiz yönlendirme ile açık eşler arası (p2p) araçlar aracılığıyla yayılımı varsayılan olarak izinsiz tutar.

Diğer tüm koşullar eşit olduğunda CROPS, yayının denetlenebilir olduğu ve küçük bir aracı grubuna bağlı olmadığı; özel yayılımın isteğe bağlı ve vazgeçilebilir olduğu; ve kullanıcıların sansürün veya değer çıkarımının etrafından izinsiz bir şekilde dolaşabildiği tasarımı desteklediğimiz anlamına gelir.

**Buradan çıkarılacak ders, bir çözümün bugün sadece çalışıyor olmasının yeterli olmadığıdır; aynı zamanda yarın bir darboğaz haline gelmemesi de gerekir.**

**2. Bir teklifi tasarlarken veya değerlendirirken, uygulamanın eldeki katmanın ötesindeki daha yüksek dereceli etkilerini enine boyuna düşünür, genel etkinin öz-egemenliği ilerletmesini sağlarız ve ele geçirme noktalarının sadece dar odağın ötesine kaydırılmasından veya bir dışsallık haline gelmesinden kaçınırız.**

Sadece eldeki çözümün özelliklerine odaklanmak ve bu çözümün diğer dereceden sonuçlarının değerlendirilmesini başkalarına bırakmak anlaşılabilir bir durumdur. Bu durum illa ki yetersiz kapasite, motivasyon veya disiplinden kaynaklanmaz. Genellikle basit bir aşinalıktan kaynaklanır.

Yine de, herhangi bir teklifin genel sonuçları hakkında kendi acil referans çerçevemizin ötesinde düşünmemizi sağlamak bizim sorumluluğumuzdur. Nitekim, katmanlar arası düşünmek, bir seviyede çözüm yaratarak başka bir seviyedeki istenmeyen özelliklerin veya yapıların ortadan kaldırılmasına yol açabilir.

Örneğin: protokolün ölçek veya hız gibi yetenekleri üzerindeki çalışmalar sayısız yolla yapılabilir. Hatta bazıları, CROPS özelliklerini bir kontrol listesi olarak kullanma standardına göre "CROPS uyumlu" bile olabilir.

Ancak daha geniş amacımızı, yani öz-egemenliği teşvik etmeyi unutmamalıyız. Dar bir analizde CROPS özelliklerini karşılayan, ancak zorunlu aracılık, değer çıkarımı veya başka bir egemenlik karşıtı model olsun, başka bir etkileşim katmanında bir kullanıcı darboğazı getiren bir teklif, reddedilmesi gereken bir tekliftir. Ancak, diğer katmanlardaki darboğazları ortadan kaldırmak suretiyle çekirdek protokolün yeteneklerini artıran bir teklif memnuniyetle karşılanmalıdır.

CROPS özelliklerini tek başına ele almak ve başka bir yerde telafi edilebildikleri sürece her türlü boşluğu kabul edilebilir görmek sürekli tekrarlanan bir cazibedir. Bu cazibe ne zaman ortaya çıksa, onu dikkatle incelemeliyiz. Protokoller resmi olarak bozulmamış veya "saf" kalabilirken, gerçekte ölçek, hız, kullanıcı deneyimi erişilebilirliği, gizlilik, değer çıkarımına karşı direnç veya hesap işlevselliği gibi olumlu veya temel yetenekler merkezi, aracıya bağımlı, güvene dayalı, izinli veya şeffaf olmayan yapılara veya hizmetlere kayabilir.

Katmanlar arası düşünmenin gerekliliğini ve değerini gösterebilecek birkaç senaryo vardır.
...
Dördüncüsü, **protokol katmanında işlem korumaları**. İşlemin dahil edilmesi, olumsuz yürütme sonuçlarına karşı koruma ve adil yürütme, güvenlikle tutarlı olarak yığının en alt katmanında sağlanmalıdır. Protokol düzeyinde uygulama, kullanıcıların merkezi işlem hatları aracılığıyla aracılardan bu tür garantiler arama baskısını hafifletecek ve böylece sistemik değer çıkarımı fırsatlarını azaltacaktır.

Beşincisi, **kriptografik nesnelerin toplanması**. Aracılar kullanıcılar için toplama işlevlerini yerine getirir çünkü kriptografik nesnelerin, örneğin sıfır bilgi ispatlarının, zincir içi bireysel olarak gönderilmesi genellikle aşırı maliyetlidir. Toplama sağlamanın yüksek sabit maliyetleri, bu hizmet pazarının muhtemelen tekelci olacağı anlamına gelir ki bu da merkezi bir darboğazdır. Bu nedenle, eğer protokol bu tür nesnelerin toplu olarak birleştirilmesini ve verimli bir şekilde doğrulanmasını destekleseydi, bu merkezileşme riski ortadan kalkardı.
...
Güvenlik çağımızda önemli bir sorundur ve "zihne yönelik saldırılar", teknik özellikleri veya topluluk dinamiklerini hedef alan saldırılar kadar ciddiye alınmalıdır.

Ancak, kullanıcıyı güçlendiren ve kullanıcı kontrollü savunmaları hedefliyoruz. Özellikle kullanıcılar hiçbir zaman dahil olmadıysa veya çıkış yapamıyorsa, yüksek rahiplerin kendi kullanıcı koruma mantıkları altında kullanıcı iradesine kısıtlamalar dikte etmesini veya kurmasını desteklemiyoruz.

Örneğin: düşmanca bir dünyada güvenlik adına, bir Cüzdan, belirli sözleşmeleri sessizce engellemek, kullanıcıları tercih edilen mekanlara veya karşı taraflara yönlendirmek ve değiştirilemeyen önceden yüklenmiş beyaz listeleri kullanmaya sevk etmek gibi karanlık tasarım kalıplarını içeren, varsayılan olarak etkinleştirilmiş bir "güvenli mod" sunar; veya denetlenemeyen tescilli bir model kullanarak "riskli" eylemleri işaretleyen ve kullanıcı eylemlerini sessizce merkeze bildiren bir yapay zeka yardımcı pilotu sunar.
...
Bu nedenle, mümkün olan her yerde bu tür aracılara olan ihtiyacı ortadan kaldırmak için çalışıyoruz. Henüz kaldırılamadıkları durumlarda, onları ele geçirilmeye iten teknik ve ekonomik baskıları azaltan protokoller tasarlıyoruz.

**Özellikle, bir "sıfır seçeneği"nin varlığını sağlıyoruz: aracılı bir yolu olan her imkan için, mümkün olan herhangi bir aracısız yol inşa edilmeli ve inandırıcı ve erişilebilir kalmalıdır. Bu, hem halihazırda aracılar tarafından sömürülüyor olabilecek kullanıcılar için mevcut bir çıkış hem de bu tür suistimallerin genişlemesine karşı inandırıcı bir kısıtlama işlevi görür. Bu adımı atlamıyoruz.**

Örneğin: katılımın bir tür kimlik gerektirdiği bir uygulamayı düşünün. Bu, sybil direnci veya hizmet reddi saldırılarına karşı korumalar, yalnızca belirli bir topluluğun üyeleri tarafından yazılabilir olması amaçlanan çevrimiçi bir forum veya sayısız başka neden için olabilir.

Saf bir yaklaşım, "resmi" kimliğin - devlet, biyometrik veya kurumsal - mevcut en kolay hazır biçimini almak, onu bir sıfır bilgi ispatı ile sarmak ve sonucu CROPS dostu ilan etmek olacaktır.
...
Kimlik bilgileri verildikten sonra, ispat üretimi ve doğrulaması mümkün olduğunca yerel, doğrulanabilir ve gözetimsiz olmalıdır, böylece devam eden katılım ayrıcalıklı bir aracıya sürekli boyun eğmeye bağlı kalmaz ve keyfi olarak iptal edilemez.

Ayrıca, kimlik için amaca uygun birden fazla temel gerçeklik kaynağının mevcut olmasını ve sisteme dayanan gerçek dünya uygulamalarında kullanılabilmesini sağlamalıyız. Yazılım yığını, uygulamaların birden fazla bağımsız onay kaynağını entegre etmesini kolaylaştırmalı ve bu çoğulluğu varsayılan yol haline getirmelidir. Yalnızca resmi bir kurumdan alınan bir imza gibi tekil daha güçlü onaylara değil, sosyal ağ onayları gibi birden fazla daha zayıf sinyale izin vererek kombinasyon yaklaşımlarını desteklemelidir.

Böyle bir darboğazı en aza indirilmiş sistemi tasarlamak, doğası gereği saf yaklaşımdan daha zordur. Bu nedenle ve Sadece-EF (Only-EF) kuralına uygun olarak, görevimize hizmet ettiği durumlarda üstlenmeyi düşündüğümüz iş tam olarak budur.

**Kutup yıldızımız aracısızlaştırmadır. Aracılığın ortadan kaldırılabileceği durumlarda, onu ortadan kaldırmayı tercih ederiz. Kaçınılmaz olduğu durumlarda, aracı rollerini açık, çoğul, sınırlı ve doğrulanabilir tutarak ele geçirilme riskini en aza indirmek için çalışırız. Aracısız bir tasarım mümkün hale gelirse, aracıların nihayetinde yerleşik olmak yerine isteğe bağlı olması için bunun inandırıcı ve erişilebilir olmasını sağlarız.**

**5. Hangi ekiplerin destekleneceğine karar verirken, kısa vadeli çıktılara ve sosyal ipuçlarına bakmayıp, bunun yerine seçim kalıplarını ve ortaya konan tercihleri değerlendiririz.**

Çoğu zaman bize CROPS, öz-egemenlik ve özgürlük diliyle sarılmış fikirler sunulur; ancak daha yakından incelendiğinde göründüğünden daha azı vardır; iddia edilen ilkelerin ince cilası incelendiğinde dağılır. Bu her zaman samimiyetsiz değildir - nitekim bu tür pek çok fikir, iyi niyetli, vicdanlı bireyler, ekipler ve projeler tarafından, ya yanlış yönlendirilmiş olsa da gerçek bir inançla ya da iç gözlem veya sorgulama eksikliği nedeniyle önerilmektedir.

Bunun ortaya çıkmasının bir yolu, yalnızca tüm değişkenlerin planlandığı gibi gerçekleştiği "mutlu senaryo" hakkında düşünmek, ancak üçüncü taraf bağımlılıklarının (API'ler, içerik dağıtım ağları veya diğerleri) ortadan kalktığı veya bozulduğu - veya daha kötüsü, ekibin kendisinin ortadan kaybolduğu, hacklendiği veya içeriden birinin düşmanca davrandığı "mutsuz senaryo" hakkında düşünmemektir.

Bir başka yol da yankı odası etkisi veya başka bir deyişle, art arda gelen sosyal kanıttır. Şu anda küçük olan bir alanda, iyi niyetli insan grupları genellikle, özellikle de arkadaşlarına karşı destekleyici olmak isterler. Fikirler oluşur, paylaşılır ve tartışılır; tam da aracısızlaştırmaya yakınlığı olan bir alanda faaliyet gösterdiğimiz için, fikirlerin dolaşım hızı genellikle viral olmasa bile kaçış hızına ulaşır. Dahası, eğer güçlendirilmiş fikirler sosyal kanıt ve teşvikler - ister itibar ister ödül olsun - çekerse ve uygun şekilde sorgulanmadan veya eleştirel bir şekilde incelenmeden önce kamuoyuna sunulursa, o zaman sonradan sorgulama maliyetli hale gelebilir ve dirençle karşılaşabilir.

Örneğin: iki ekip, birden fazla token ve eşzamansız iletişim içeren bazı karmaşık senaryolarda kullanıcı deneyimini iyileştirmek için teklifler sunar. İlk bakışta her ikisi de "CROPS uyumlu" görünür: açık spesifikasyon, aşamalı merkeziyetsizlik yol haritası, kullanıcı öncelikli kullanıcı deneyimi.

İncelendiğinde, ilk ekip sosyal olarak cilalanmıştır, doğru CROPS dilini kullanır ve eş onayı ve kaynaklarla donanmıştır, ancak tasarım "gizli sos" aracı katmanını kapalı tutar, küçük bir beyaz listeye alınmış sağlayıcı setiyle başlar ve akışı tercih edilen yollara yönlendirmek için yumuşak varsayılanlar kullanır.

Diğer ekibin hiçbir sosyal varlığı yoktur, asgari düzeyde desteği vardır ve vizyonlarını iletmekte zorlanırlar, ancak beyaz liste olmadan aracılar için açık bir pazar (örneğin staking kullanarak) uygularlar ve onları kullanıcı odaklı rotalar ve zincir içi garantiler yoluyla ortadan kaldırılmaları için inandırıcı bir yola sahip geçici bir yapı olarak görürler. Erken araştırmaları ve tehdit modellerini yayınlarlar, okunaklı spesifikasyonlar ve referanslar sunarlar, eleştiriye davet ederler ve bağlantısız ekipleri birlikte inşa etmeye teşvik ederler, böylece varsayılan sonuç markalı bir hendek yerine paylaşılan bir altyapı olur.

**Kimi destekleyeceğinizi seçerken, algı netliği çok önemlidir. Ayırt etme yeteneği ve iyi bir muhakeme kullanmak zorunludur: özellikle sosyal kanıt durum tespitinden önce geldiğinde, cilaya, kimlik bilgilerine veya sempatik uyum sinyallerine demir atmamak gerekir.** Bunun yerine, bir projenin pratikte neyi optimize ettiğini - teknik ve sosyal olarak defalarca seçtiği ödünleşimleri - incelemeliyiz.

CROPS diline rağmen, daha yakından incelendiğinde çalışma kapalı bileşenler, beyaz listeler, yumuşak varsayılan yönlendirme, isteğe bağlı yükseltme yeteneği veya bağımlılığı yoğun entegrasyonlar gibi ayrıcalıklı konumlar getiriyorsa, şüpheci olmakta haklısınız.

Benzer şekilde, bir ekip sürekli olarak merkeziyetsizlik yerine kontrolü veya değeri seçiyorsa veya ortakları ve destekçileri öz-egemenlik karşıtı seçimler geleneğine sahipse, temkinli olmakta haklısınız.

**Teknik ve sosyal ilkelerimiz, varsayılan yolun zaman içinde nüfuzu ortadan kaldırıp kaldırmadığını veya bir siloda yoğunlaştırıp yoğunlaştırmadığını ve uyum sinyallerinin inceleme altında CROPS ile tutarlı eylemlerle eşleşip eşleşmediğini sormamıza yol açar.**

**İlk sürümlerin eksiksiz olmasını şart koşmuyoruz; sadece canlı kalmaları gerekiyor. Açık kaynaklı inşa, güçlü bir tasarım yolunun sonraki ekipler tarafından iyileştirilebileceği veya bitirilebileceği anlamına gelir. Erken yayınlayan, açık bir şekilde inşa eden ve eleştiriye davet eden ekipleri takdir ediyoruz, böylece bağlantısız geliştiriciler bitmemiş işleri sormak zorunda kalmadan devralabilirler.**

## VII. GELECEK {#vii-the-future}

Uzun zamandır insanlar, yalnızca iki kötü seçeneğimiz olduğuna inanmaya itildi.

Biri, asıl meselenin avantaj elde etmek ve bunu sürdürmek olduğunu kabul etmek; ve böylece, halihazırda gücü elinde bulunduranlar tarafından yukarıdan yönetilmeyi kabul etmektir: insanların nasıl yaşayacağını dikte eden, tebaalarının isteklerinden bağımsız olarak kimin özgürce hareket edeceğine ve kimin boyun eğmesi gerektiğine karar veren devletler, imparatorluklar, kurumsal oligarşiler, eskatolojik misyonlar ve büyük ideolojiler gibi makro-egemenler.

Diğeri ise bu oyuna ilkesel bir amaç gütmeden karşılık vermektir: her şeyi yakıp yıkmak, alaycılığa veya geri çekilmeye sığınmak; ya da daha iyi oldukları için değil, sadece fırsat sundukları için şu veya bu makro-egemenin safına geçmek.
...
## VIII. KAPANIŞ {#viii-closing}

Çalışmamız piyasaları, şirketleri veya devletleri ele geçirmekle ya da onların sömürmesine veya ele geçirmesine yardımcı olmakla ilgili değildir.

Bizler, bireyi özgürleştirmek ve örgütlenme özgürlüklerini sağlamlaştırmak için buradayız.

Mevcut hiyerarşiler ve sistemler içinde tanınmayan işbirliği, örgütlenme ve topluluk biçimlerine ses veren altyapıyı sağlamak için buradayız.
...
Amacımız, yetiştirdiğimiz bahçenin sadece hayatta kalmasını değil, aynı zamanda gelişip serpilmesini, yarattığı müştereklerin açık ve sonsuz derecede geniş kalmasını ve inşa edilen egemenlik araçlarının, onları kavramak isteyen herkese, bağlanıp kazanmak isteyen herkese sonsuza dek açık kalmasını sağlamaktır.

**İşin nankör olacağı; yolculuğun çetin geçeceği; yolun ıssız olacağı zamanlar olacaktır. Ancak yıldızlara giden her yol önce karanlıktan geçer.**
