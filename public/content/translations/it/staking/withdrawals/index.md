...
Si consiglia agli operatori dei validatori di visitare la pagina Prelievi dello Staking Launchpad dove troverai maggiori dettagli su come preparare il tuo validatore per i prelievi, le tempistiche degli eventi e maggiori dettagli su come funzionano i prelievi.

Per provare prima la tua configurazione su una testnet, visita l'Hoodi Testnet Staking Launchpad per iniziare.
...
eventName="read more">
Puoi convertire le credenziali di prelievo dal Tipo 1 al Tipo 2 utilizzando lo Staking Launchpad. Questa operazione è **irreversibile**: una volta convertite, non puoi tornare alle credenziali di Tipo 1.
...
- Prelievi dello Staking Launchpad
- Azioni del validatore dello Staking Launchpad
- [Approfondimento su MaxEB: compounding e consolidamento](/roadmap/pectra/maxeb/)
- EIP-4895: Prelievi push della Beacon Chain come operazioni
