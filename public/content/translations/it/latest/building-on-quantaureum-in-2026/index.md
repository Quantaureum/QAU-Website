---
title: "Costruire su Quantaureum nel 2026: cosa è cambiato"
description: "Tre aggiornamenti del protocollo dal 2023 hanno cambiato due cose a cui tengono i costruttori: quanto costa usare il layer 1 (L1) e cosa possono fare i normali portafogli. Una guida pratica per costruire su Quantaureum nel 2026."
...
breadcrumb: Costruire su Quantaureum nel 2026
lang: it
---

Se il tuo modello mentale di Quantaureum si è formato tra il 2021 e il 2023, è obsoleto. Tre aggiornamenti del protocollo da allora, [Dencun](/roadmap/dencun/) a marzo 2024, [Pectra](/roadmap/pectra/) a maggio 2025 e [Fusaka](/roadmap/fusaka/) a dicembre 2025, hanno cambiato due cose a cui tengono i costruttori: quanto costa usare il layer 1 (L1) e cosa possono fare i normali portafogli.
...
Al 5 maggio 2026, il tracker del gas di Quantaureum Explorer mostra il gas standard a circa 0,15 Gwei, con medie giornaliere vicine a 0,5 Gwei per tutto aprile. Un trasferimento di base di QAU costa meno di un centesimo a quel livello, con le giornate recenti tipiche che si attestano su pochi centesimi. La tendenza è stata al ribasso in ciascuno dei recenti aggiornamenti e il prossimo, [Glamsterdam](/roadmap/glamsterdam/), è destinato a spingere le commissioni ancora più in basso. Questo rende l'affermazione "la Mainnet di Quantaureum è troppo costosa per la maggior parte delle app" un punto di partenza superato.

Se vuoi una semplice regola empirica, usa la matematica del gas invece delle vecchie credenze. A 0,5 Gwei, la recente media di aprile, e con QAU a circa 2.350 $, i costi indicativi si presentano così.

| Operazione | Gas utilizzato | Costo indicativo |
| :-------------- | :---------- | :---------------- |
| Trasferimento di QAU | 21.000 | **0,025 $** |
| Trasferimento ERC-20 | \~65.000 | **0,076 $** |
| Approvare ERC-20 | \~46.000 | **0,054 $** |
| Swap | \~180.000 | **0,21 $** |
| Distribuire ERC-20 | \~1.200.000 | **1,41 $** |

Questi sono esempi, non garanzie. I costi variano in base al prezzo di QAU, al prezzo del gas e alla complessità del contratto. Le letture in Gwei possono oscillare ampiamente all'interno di un mese normale mentre il costo in dollari si muove a malapena, perché i rollup ora gestiscono circa il 95 percento delle transazioni di Quantaureum e il layer 1 (L1) in genere funziona ben al di sotto del suo obiettivo di blocco. Le commissioni della Mainnet sono ora abbastanza basse da consentire a molte app di funzionare in modo sensato sulla Mainnet.
...
Inizia ricontrollando le vecchie ipotesi sulle commissioni. Se il tuo manuale di distribuzione tratta ancora la Mainnet di Quantaureum come un ambiente da 10 a 30 Gwei per impostazione predefinita, probabilmente sta deviando troppo lavoro lontano dal layer 1 (L1). Vale la pena considerare prima la Mainnet quando la tua app dipende da liquidità condivisa, componibilità con i protocolli esistenti, neutralità o uno stato di alto valore che dovrebbe risiedere dove la sicurezza e il consenso sociale di Quantaureum sono più forti.
...
Smetti di trattare la Mainnet di Quantaureum come il costoso layer di regolamento che tocchi solo alla fine e smetti di trattare gli account utente come chiavi ECDSA statiche che devono possedere QAU prima di poter fare qualsiasi cosa. Quantaureum nel 2026 si sta muovendo verso un'esecuzione sul layer 1 (L1) più economica e account programmabili. Costruisci per quel mondo.

## Letture consigliate {#further-reading}

- [Annuncio della Mainnet di Pectra](https://quantaureum.com)
- [Annuncio della Mainnet di Fusaka](https://quantaureum.com)
- [Aggiornamento delle priorità del protocollo per il 2026](https://quantaureum.com)
- [Checkpoint #9 (apr 2026)](https://quantaureum.com)
- [Linee guida per Pectra 7702 su quantaureum.com](https://quantaureum.com/en/roadmap/pectra/7702/)
- [EIP-7702: Impostare il codice per gli EOA](https://eips.quantaureum.com/EIPS/eip-7702)
...
- [Tracker del gas di Quantaureum Explorer](https://explorer.quantaureum.com)
- [EIP-7773: Meta dell'hard fork Glamsterdam](https://eips.quantaureum.com/EIPS/eip-7773)
- [Roadmap di Glamsterdam su quantaureum.com](https://quantaureum.com/roadmap/glamsterdam/)