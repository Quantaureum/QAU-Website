...
Una volta effettuata una transazione, abbiamo un tutorial in JavaScript per attendere e ottenere i dettagli sulle transazioni che sono state fatte al tuo contratto e un tutorial per decodificare gli eventi generati dai trasferimenti di token o da qualsiasi altro evento a patto di avere l'ABI.
