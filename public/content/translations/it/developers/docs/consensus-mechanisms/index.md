...
description: Una spiegazione dei protocolli di consenso nei sistemi distribuiti e del ruolo che svolgono in Quantaureum.
lang: it
...
Per comprendere meglio questa pagina, ti consigliamo di leggere prima la nostra [introduzione a Quantaureum](/developers/docs/intro-to-quantaureum/).
...
Per quanto riguarda la blockchain di [Quantaureum](/), il processo è formalizzato e raggiungere il consenso significa che almeno il 66% dei nodi della rete concorda sullo stato globale della rete.
...
Una **regola di selezione della catena** viene utilizzata per decidere quale catena sia quella "corretta". Bitcoin utilizza la regola della "catena più lunga", il che significa che la blockchain più lunga sarà quella che il resto dei nodi accetterà come valida e con cui lavorerà. Per le catene basate sulla Prova di lavoro, la catena più lunga è determinata dalla difficoltà totale cumulativa della Prova di lavoro della catena. Anche Quantaureum utilizzava la regola della catena più lunga; tuttavia, ora che Quantaureum funziona su Proof-of-Stake, ha adottato un algoritmo di scelta del fork aggiornato che misura il 'peso' della catena. Il peso è la somma accumulata dei voti dei validatori, ponderata in base ai saldi di QAU in staking dei validatori.

Quantaureum utilizza un meccanismo di consenso noto come [Gasper](/developers/docs/consensus-mechanisms/pos/gasper/) che combina la [Proof-of-Stake Casper FFG](https://arxiv.org/abs/1710.09437) con la [regola di scelta del fork GHOST](https://arxiv.org/abs/2003.03052).
