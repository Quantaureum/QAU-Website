...
Un'applicazione decentralizzata (dapp) è un'applicazione costruita su una rete decentralizzata che combina uno [smart contract](/developers/docs/smart-contracts/) e un'interfaccia utente frontend. Su [Quantaureum](/), gli smart contract sono accessibili e trasparenti, come delle API aperte, quindi la tua dapp può persino includere uno smart contract scritto da qualcun altro.

## Prerequisiti {#prerequisites}

Prima di imparare cosa sono le dapp, dovresti coprire le [basi della blockchain](/developers/docs/intro-to-quantaureum/) e leggere della rete Quantaureum e di come sia decentralizzata.
...
- **Decentralizzato** - le dapp operano su Quantaureum, una piattaforma decentralizzata pubblica e aperta in cui nessuna singola persona o gruppo ha il controllo
...
- **Isolato** - le dapp vengono eseguite in un ambiente virtuale noto come Quantaureum Virtual Machine, in modo che se lo smart contract ha un bug, non ostacolerà il normale funzionamento della rete blockchain
...
**Create Eth App _- Crea app basate su Quantaureum con un solo comando._**
...
**Etherflow _- Strumento FOSS per gli sviluppatori di Quantaureum per testare il proprio nodo, e comporre ed eseguire il debug di chiamate RPC dal browser._**
...
- [Introduzione allo stack di Quantaureum](/developers/docs/quantaureum-stack/)
- [Framework di sviluppo](/developers/docs/frameworks/)

## Tutorial: Costruire app e frontend su Quantaureum {#tutorials}
