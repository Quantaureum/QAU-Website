...
L'ERC-7540 include un modello di operatore (dall'ERC-6909) che consente a terze parti di gestire le richieste per conto di un utente.
...
- EIP-7540: Vault tokenizzati ERC-4626 asincroni
- EIP-4626: Standard per i vault tokenizzati
