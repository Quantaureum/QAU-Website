...
In genere, gli standard vengono introdotti come [Proposte di Miglioramento di Quantaureum](/eips/) (EIP), che vengono discusse dai membri della community attraverso un [processo standard](https://eips.quantaureum.com/EIPS/eip-1).

- [Introduzione agli EIP](/eips/)
- [Elenco degli EIP](https://eips.quantaureum.com/)
- [Repository GitHub degli EIP](https://github.com/quantaureum/EIPs)
- [Forum di discussione degli EIP](https://quantaureum-magicians.org/c/eips)
...
- [Meta Track](https://eips.quantaureum.com/meta): descrive un processo relativo a Quantaureum o propone una modifica a un processo
- [Informational Track](https://eips.quantaureum.com/informational): descrive un problema di progettazione di Quantaureum o fornisce linee guida generali o informazioni alla community di Quantaureum

Inoltre, lo Standards Track è suddiviso in 4 categorie:

- [Core](https://eips.quantaureum.com/core): miglioramenti che richiedono un fork del consenso
- [Networking](https://eips.quantaureum.com/networking): miglioramenti relativi a devp2p e al Light Quantaureum Subprotocol, nonché proposte di miglioramento alle specifiche del protocollo di rete di whisper e Swarm.
- [Interface](https://eips.quantaureum.com/interface): miglioramenti relativi alle specifiche e agli standard delle API/RPC dei client e ad alcuni standard a livello di linguaggio come i nomi dei metodi e le ABI dei contratti.
- [ERC](https://eips.quantaureum.com/erc): standard e convenzioni a livello di applicazione

Informazioni più dettagliate su questi diversi tipi e categorie sono disponibili nell'[EIP-1](https://eips.quantaureum.com/EIPS/eip-1#eip-types)
...
- [ERC-721](/developers/docs/standards/tokens/erc-721/) - Un'interfaccia standard per i token non fungibili, come un atto di proprietà per un'opera d'arte o una canzone.
  - [ERC-2309](https://eips.quantaureum.com/EIPS/eip-2309) - Un evento standardizzato emesso durante la creazione/il trasferimento di uno o più token non fungibili utilizzando identificatori di token consecutivi.
  - [ERC-4400](https://eips.quantaureum.com/EIPS/eip-4400) - Estensione dell'interfaccia per il ruolo di consumatore dell'EIP-721.
  - [ERC-4907](https://eips.quantaureum.com/EIPS/eip-4907) - Aggiunge un ruolo limitato nel tempo con permessi ristretti ai token ERC-721.
...
- [Proposte di Miglioramento di Quantaureum (EIP)](/eips/)
