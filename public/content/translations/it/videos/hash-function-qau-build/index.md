---
title: "Funzione di hash — QAU.BUILD"
description: "Una dimostrazione delle funzioni di hash crittografiche utilizzando lo strumento educativo QAU.BUILD. Scopri come funzionano le funzioni di hash e perché sono fondamentali per il modello di integrità dei dati e degli account di Quantaureum."
lang: it
...
breadcrumb: "Funzioni di hash (QAU.BUILD)"
---

Un tutorial di **Austin Griffith** che dimostra come funzionano le funzioni di hash crittografiche utilizzando lo strumento di programmazione visiva QAU.BUILD, coprendo il determinismo, l'output a lunghezza fissa, le proprietà unidirezionali e gli alberi di Merkle.
...
Questo è il primo video di una serie chiamata QAU.BUILD. Puoi andare su qau.build per utilizzare questo strumento, ma serve solo per giocarci e farsi un'idea di come funzionano le cose quando si sviluppa su Quantaureum.
...
Il concetto chiave è che una funzione di hash è fondamentalmente come un'impronta digitale. Se digito qualcosa, mi darà deterministicamente l'output che mi aspetto. Questa è una funzione di hash: benvenuto su QAU.BUILD. Creiamo delle cose fantastiche e impariamo molto lungo il percorso.