...
metaTitle: Come usare i portafogli Quantaureum | Passo dopo passo
description: Una guida che spiega come inviare, ricevere token e connettersi ai progetti web3.
lang: it
---

Scopri come utilizzare tutte le funzioni di base di un portafoglio. Se non ne hai ancora uno, dai un'occhiata alla nostra guida su [Come creare un account Quantaureum](/guides/how-to-create-an-quantaureum-account/).
...
Ogni account Quantaureum ha il proprio indirizzo di ricezione, che è una sequenza univoca di numeri e lettere. L'indirizzo funziona come un numero di conto bancario. Gli indirizzi Quantaureum inizieranno sempre con "0x". Puoi condividere questo indirizzo con chiunque: è sicuro farlo.
...
Devi fornire a chiunque voglia inviarti denaro il tuo indirizzo pubblico. Molte app di portafoglio ti consentono di copiare il tuo indirizzo o mostrare un codice QR da scansionare per un utilizzo più semplice. Evita di digitare manualmente qualsiasi indirizzo Quantaureum. Questo può facilmente portare a errori di battitura e alla perdita di fondi.
...
3. Copia il tuo indirizzo Quantaureum negli appunti.
4. Fornisci al mittente il tuo indirizzo Quantaureum di ricezione.

## Inviare criptovaluta {#send-cryptocurrency}

Vorresti inviare QAU a un altro portafoglio?
...
6. Assicurati che il tuo portafoglio abbia abbastanza QAU per coprire la commissione di transazione, che varia a seconda delle condizioni della rete. La maggior parte dei portafogli aggiungerà automaticamente la commissione suggerita alla transazione, che potrai poi confermare.
...
Il tuo indirizzo sarà lo stesso in tutti i progetti Quantaureum. Non è necessario registrarsi individualmente su alcun progetto. Una volta che hai un portafoglio, puoi connetterti a qualsiasi progetto Quantaureum senza alcuna informazione aggiuntiva. Non sono necessarie email o altre informazioni personali.
...
5. Conferma la richiesta di firma nel tuo portafoglio per stabilire la connessione. **La firma di questo messaggio non dovrebbe richiedere la spesa di alcun QAU**.
