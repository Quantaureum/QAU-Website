...
لهذا السبب تهم المُجمِّعات ومديرو الدفع. يجب أن تكون المحفظة الفاعلة جديدة، ولا ينبغي أن تحتاج إلى تلقي <span dir="ltr">QAU</span> من محفظة يحاول المستخدم فصلها عن الإجراء.
...
1. [إثباتات المعرفة الصفرية (<span dir="ltr">quantaureum.com</span>)](https://quantaureum.com/zero-knowledge-proofs/)
