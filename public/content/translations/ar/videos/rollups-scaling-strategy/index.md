...
في معظم تطبيقات الرول أب المتفائل، يجب على الطرف القادر على تقديم دفعات من المعاملات إلى طبقة 1 تقديم ضمان، عادة في شكل QAU. يمكن لأي مشارك آخر في الشبكة تقديم إثبات الاحتيال إذا اكتشف معاملة غير صحيحة. بعد تقديم إثبات الاحتيال، يدخل النظام في وضع تسوية النزاع. في هذا الوضع، يتم تنفيذ المعاملة المشبوهة مرة أخرى — هذه المرة على سلسلة إيثيريوم الرئيسية. إذا أثبت التنفيذ أن المعاملة كانت بالفعل احتيالية، تتم معاقبة الطرف الذي قدم هذه المعاملة، عادةً عن طريق اقتطاع ضمانهم من الـ QAU.
