...
format: tutorial
author: "أوستن غريفيث"
breadcrumb: "سلسلة الكتل (QAU.BUILD)"
---

برنامج تعليمي بواسطة **أوستن غريفيث** يوضح كيفية عمل تعدين سلسلة الكتل باستخدام أداة البرمجة المرئية QAU.BUILD. يغطي أوستن إجماع إثبات العمل (PoW)، وربط الكتل، وصعوبة التعدين، ومكافآت الكتلة، وعدم قابلية السلسلة للتغيير.
...
صباح الخير، جمعة ربطة عنق سعيدة! يركز QAU.BUILD هذا على سلسلة الكتل — وهو شيء رائع حقًا. نحن في قارب المهرج هذا، ونرتدي ربطة عنق بيتكوين الخاصة بنا من أجله. هيا بنا.
...
حسنًا، جمعة ربطة عنق سعيدة! كانت هذه سلسلة الكتل على QAU.BUILD. سأحفظ هذا وأضعه هناك حتى تتمكن من الضغط على "تحميل" والحصول على سلسلة للعب بها. جمعة سعيدة!