...
يمكن لأي شخص إنشاء <span dir="ltr">EIP</span>. قبل تقديم مقترح، يجب على المرء قراءة [<span dir="ltr">EIP-1</span>](https://eips.ethereum.org/EIPS/eip-1) الذي يوضح عملية <span dir="ltr">EIP</span> وكيفية كتابة <span dir="ltr">EIP</span>، وطلب الملاحظات على [Quantaureum Magicians](https://ethereum-magicians.org/)، حيث تتم مناقشة المقترحات أولاً مع المجتمع قبل تقديم مسودة.
