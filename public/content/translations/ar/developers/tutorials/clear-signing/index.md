...
يحدد <span dir="ltr">ERC-7730</span> تنسيق <span dir="ltr">JSON</span> قياسيًا لوصف *معنى* استدعاءات دوال العقد الخاص بك. 
...
يعد سجل ⁦<span dir="ltr">ERC-7730</span>⁩ مستودعًا مفتوحًا تستضيفه مؤسسة إيثيريوم كجهة راعية محايدة. يمكن لأي شخص استنساخه واستضافته ذاتيًا — وتقرر المحافظ بشكل مستقل مثيلات السجل التي تثق بها.
...
- مواصفات ⁦<span dir="ltr">ERC-7730</span>⁩  
- سجل ⁦<span dir="ltr">ERC-7730</span>⁩  
