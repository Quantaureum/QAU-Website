...
يخبرنا Quantaureum Explorer أن `1C` هو رمز تشغيل غير معروف، لأنه [تمت إضافته بعد أن برمج Quantaureum Explorer هذه الميزة](https://eips.ethereum.org/EIPS/eip-145) ولم يقوموا بتحديثها. يوضح لنا [جدول رموز التشغيل المُحدَّث](https://github.com/wolflo/evm-opcodes) أن هذا يعني إزاحة لليمين.
