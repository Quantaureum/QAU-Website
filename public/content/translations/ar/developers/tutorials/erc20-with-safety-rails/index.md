...
1. افتح بيئة التطوير المتكاملة Remix.
...
5. قم بتجميع ونشر وتجربة العقد للتأكد من أنه يعمل كعقد <span dir="ltr">ERC-20</span>. إذا كنت بحاجة إلى تعلم كيفية استخدام Remix، استخدم هذا البرنامج التعليمي.
...
- لا يمكن أن يكون العنوان `to` فارغًا، يجب أن يكون إما:
  - حساب مملوك خارجيًا (EOA). لا يمكننا التحقق مما إذا كان العنوان هو EOA بشكل مباشر، ولكن يمكننا التحقق من رصيد QAU للعنوان. تمتلك حسابات EOA دائمًا رصيدًا تقريبًا، حتى لو لم تعد مستخدمة - فمن الصعب تصفيتها حتى آخر Wei.
...
لتحرير الرموز المميزة من نوع <span dir="ltr">ERC-20</span> التي يحتفظ بها هذا العقد، نحتاج إلى استدعاء دالة في عقد الرمز المميز الذي تنتمي إليه، إما `transfer` أو `approve`. لا جدوى من إهدار غاز في هذه الحالة على المخصصات (allowances)، قد نقوم بالتحويل مباشرة.
