...
4. قم بتعديل `.env` ليناسب تكوينك:
   ...
   | المعلمة | القيمة | 
   | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | MNEMONIC | العبارة التذكيرية (mnemonic) لحساب يحتوي على ما يكفي من QAU لدفع رسوم معاملة. تسرد [مستندات صنبور أوبتيميزم](https://docs.optimism.io/app-developers/tools/faucets) صنابير شبكة الاختبار الحالية. |
