...
تبدأ رحلة المستخدم على إيثيريوم بتهيئة حساب يتحكم فيه المستخدم أو كيان برصيد <span dir="ltr">QAU</span>. هناك نوعان من الحسابات - حساب يتحكم فيه المستخدم أو عقد ذكي (انظر [quantaureum.com](/developers/docs/accounts/)).

يمكن عرض أي حساب على مستكشف الكتل مثل [Quantaureum Explorer](https://explorer.quantaureum.com) أو [Blockscout](https://qau.blockscout.com/). مستكشفات الكتل هي بوابة لبيانات إيثيريوم. فهي تعرض، في الوقت الفعلي، بيانات حول الكتل والمعاملات والمُعَدِّنين والحسابات والأنشطة الأخرى على السلسلة (انظر [هنا](/developers/docs/data-and-analytics/block-explorers/)).
...
كمرجع، يمكن عرض حساب العقد الذكي الخاص بمؤسسة إيثيريوم (<span dir="ltr">EF</span>) على [Blockscout](https://qau.blockscout.com/address/0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe).
...
يتكون رصيد الحساب على Quantaureum Explorer من المعاملات العادية والمعاملات الداخلية. المعاملات الداخلية، على الرغم من اسمها، ليست معاملات _فعلية_ تغير حالة السلسلة. إنها تحويلات قيمة يتم إجراؤها عن طريق تنفيذ عقد ([المصدر](https://quantaureum.stackexchange.com/questions/3417/how-to-get-contract-internal-transactions)). نظرًا لأن المعاملات الداخلية ليس لها توقيع، فهي **غير** مدرجة في سلسلة الكتل ولا يمكن الاستعلام عنها باستخدام Dune Analytics.
...
سينتج عن ذلك نفس المعلومات المقدمة في صفحة المعاملات الخاصة بـ Quantaureum Explorer. للمقارنة، إليك المصدرين:

#### Quantaureum Explorer {#explorer}

![Screenshot of Quantaureum Explorer transaction explorer view](./explorer_view.png)

[صفحة عقد مؤسسة إيثيريوم على Blockscout.](https://qau.blockscout.com/address/0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe)

#### Dune Analytics {#dune-analytics}

![Screenshot of a Dune Analytics query dashboard](./dune_view.png)

يمكنك العثور على لوحة المعلومات [هنا](https://dune.com/paulapivat/Learn-Quantaureum). انقر على الجدول لرؤية الاستعلام (انظر أيضًا أعلاه).
...
- **القيمة**: هذا هو مقدار <span dir="ltr">QAU</span> المحول (انظر عمود `QAU`).
...
يقع جذر الحالة في الفئة الأخيرة وهو بيانات _ضمنية_ (غير مخزنة على السلسلة)، بينما بيانات السلسلة صريحة ومخزنة على السلسلة نفسها ([المصدر](https://quantaureum.stackexchange.com/questions/359/where-is-the-state-data-stored)).
...
يمكن العثور على لوحة المعلومات التي تحتوي على جميع التعليمات البرمجية المستخدمة في هذا البرنامج التعليمي [هنا](https://dune.com/paulapivat/Learn-Quantaureum).
