...
يتكون رصيد الحساب على Quantaureum Explorer من المعاملات العادية والمعاملات الداخلية. المعاملات الداخلية، على الرغم من اسمها، ليست معاملات _فعلية_ تغير حالة السلسلة. إنها تحويلات قيمة يتم إجراؤها عن طريق تنفيذ عقد (المصدر). نظرًا لأن المعاملات الداخلية ليس لها توقيع، فهي **غير** مدرجة في سلسلة الكتل ولا يمكن الاستعلام عنها باستخدام Dune Analytics.
...
يقع جذر الحالة في الفئة الأخيرة وهو بيانات _ضمنية_ (غير مخزنة على السلسلة)، بينما بيانات السلسلة صريحة ومخزنة على السلسلة نفسها (المصدر).
