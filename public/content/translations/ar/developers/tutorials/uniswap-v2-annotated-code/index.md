...
إذا لم تكن هناك رسوم، فقم بتعيين `kLast` إلى الصفر (إذا لم يكن كذلك بالفعل). عندما تمت كتابة هذا العقد، كانت هناك ميزة استرداد الغاز التي شجعت العقود على تقليل الحجم الإجمالي لحالة إيثيريوم عن طريق تصفير التخزين الذي لا يحتاجون إليه.
...
إذا تمكنا من الحد من العدد بحيث نستخدم المكدس، فإننا نستخدم غازًا أقل. لمزيد من التفاصيل، راجع الورقة الصفراء، مواصفات إيثيريوم الرسمية، ص 26، المعادلة 298.
...
هذه التجزئة هي المعرف لنوع المعاملة. النوع الوحيد الذي ندعمه هنا هو `Permit` مع هذه المعلمات.
...
احسب فاصل النطاق لـ <span dir="ltr">EIP-712</span>.
...
إذا كان كل شيء على ما يرام، فتعامل مع هذا على أنه موافقة <span dir="ltr">ERC-20</span>.
...
تحسب هذه الدالة عنوان تبادل الزوج للرمزين المميزين. يتم إنشاء هذا العقد باستخدام رمز التشغيل CREATE2، لذا يمكننا حساب العنوان باستخدام نفس الخوارزمية إذا كنا نعرف المعلمات التي يستخدمها. هذا أرخص بكثير من سؤال المصنع، و
...
تنفذ هذه الدالة وظيفة التحويل الخاصة بـ <span dir="ltr">ERC-20</span>، والتي تسمح لحساب بإنفاق السماحية المقدمة من حساب مختلف.
...
تنفذ هذه الدالة وظيفة transferFrom الخاصة بـ <span dir="ltr">ERC-20</span>، والتي تسمح لحساب بإنفاق السماحية المقدمة من حساب مختلف.
