...
المعلومات المطلوبة للتحقق من توقيعات <span dir="ltr">EIP-712</span>.
...
فاصل النطاق. لا يمكن حسابه في وقت الترجمة، لأنه يعتمد على معرف السلسلة وعنوان العقد. هذا يجعل من المستحيل خداع UserProxy برسالة مُعدة لآخر.
