...
[الورقة الصفراء](https://ethereum.github.io/yellowpaper/paper.pdf) هي المواصفات الرسمية لإيثيريوم. باستثناء ما تم تعديله بواسطة عملية مقترحات تحسين إيثيريوم (EIP)، فإنها تحتوي على الوصف الدقيق لكيفية عمل كل شيء. تمت كتابتها كورقة بحثية رياضية، والتي تتضمن مصطلحات قد لا يجدها المبرمجون مألوفة. في هذه المقالة، ستتعلم كيفية قراءتها، وبالتالي قراءة الأوراق الرياضية الأخرى ذات الصلة.
