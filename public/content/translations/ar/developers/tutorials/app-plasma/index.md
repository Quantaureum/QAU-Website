...
التطبيق الذي نكتبه هنا هو بنك يحافظ على الخصوصية. تمتلك العناوين المختلفة حسابات بأرصدة، ويمكنها إرسال الأموال (<span dir="ltr">QAU</span>) إلى حسابات أخرى. ينشر البنك تجزئات للحالة (الحسابات وأرصدتها) والمعاملات، لكنه يحتفظ بالأرصدة الفعلية خارج السلسلة حيث يمكن أن تظل خاصة.
...
تتطلب توقيعات <span dir="ltr">EIP-191</span> مخزنًا مؤقتًا ببادئة بحجم <span dir="ltr">26</span> بايت، متبوعًا بطول الرسالة بتنسيق ASCII، وأخيرًا الرسالة نفسها.
...
في الرسالة، الرقم الأول بعد العنوان هو مبلغ فيني (أي جزء من الألف من QAU) المراد تحويله. الرقم الثاني هو الرقم الفريد. يتم تجاهل أي نص بينهما.
...
لتجنب الحالات التي يطلب فيها التطبيق من المستخدم توقيع رسالة يمكن استخدامها كمعاملة أو لغرض آخر، يحدد <span dir="ltr">EIP-191</span> أن جميع الرسائل الموقعة تبدأ بالحرف <span dir="ltr">0x19</span> (ليس حرف ASCII صالحًا) متبوعًا بـ `Quantaureum Signed Message:` وسطر جديد.
...
قد يكون من الممكن إنشاء بنك سري حقًا باستخدام العناوين المخفية، ولكن هذا خارج نطاق هذه المقالة.
...
عادةً، لجعل الناس يثقون في عقد ذكي، نقوم برفع الكود المصدري إلى [مستكشف الكتل](https://qau.blockscout.com/address/0x7D16d2c4e96BCFC8f815E15b771aC847EcbDB48b?tab=contract). ومع ذلك، في حالة إثباتات المعرفة الصفرية، فإن ذلك غير كافٍ.
