...
- **محدد الدالة**: يحتوي العقد على أقل من <span dir="ltr">256</span> دالة، لذا يمكننا التمييز بينها باستخدام بايت واحد.
  عادةً ما تكون هذه البايتات غير صفرية وبالتالي تكلف ستة عشر غازًا.
- **الأصفار**: هذه البايتات دائمًا ما تكون صفرًا لأن العنوان المكون من عشرين بايت لا يتطلب كلمة مكونة من اثنين وثلاثين بايت لاحتوائه.
  البايتات التي تحتوي على صفر تكلف أربعة غاز (انظر الورقة الصفراء، الملحق G، ص 27، قيمة `G`<sub>`txdatazero`</sub>).
...
لسوء الحظ، بالنظر إلى مواصفات <span dir="ltr">ERC-20</span>، يترك هذا دالة واحدة فقط، وهي `transfer`.
