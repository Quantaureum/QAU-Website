...
- **يخفف الرمز المميز من حالة السباق المعروفة في <span dir="ltr">ERC-20</span>.** يحتوي معيار <span dir="ltr">ERC-20</span> على حالة سباق (race condition) معروفة يجب التخفيف منها لمنع المهاجمين من سرقة الرموز المميزة.
