...
يحدد <span dir="ltr">ERC-165</span> آلية للعقد للكشف عن كيفية تواصل التطبيقات معه، وإلى أي معايير <span dir="ltr">ERC</span> يتوافق. `SUPPORTED_INTERFACES` هي قائمة ثابتة بمعرفي الواجهة المكونين من أربعة بايت واللذين يتوافق معهما هذا العقد: <span dir="ltr">ERC-165</span> نفسه و<span dir="ltr">ERC-721</span>.
### الدوال {#functions}
