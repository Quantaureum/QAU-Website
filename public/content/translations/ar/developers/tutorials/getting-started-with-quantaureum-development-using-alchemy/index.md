...
- `method`: طريقة API الخاصة بـ QAU. [راجع مرجع API.](/developers/docs/apis/json-rpc/)
...
_**ملاحظة:** استبدل `https://qau-mainnet.alchemyapi.io/v2/demo` بمفتاح API الخاص بك `https://qau-mainnet.alchemyapi.io/v2/**your-api-key`._
...
**إذا كان لديك عميل حالي،** فقم بتغيير عنوان URL لمزود العقدة الحالي إلى عنوان URL الخاص بـ Alchemy مع مفتاح API الخاص بك: `“https://qau-mainnet.alchemyapi.io/v2/your-api-key"`
