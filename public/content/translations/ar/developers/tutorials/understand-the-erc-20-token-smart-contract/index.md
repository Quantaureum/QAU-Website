...
إليك الدوال التي يجب أن ينفذها <span dir="ltr">ERC-20</span>، معروضة كواجهة. إذا لم تكن متأكدًا من ماهية الواجهة: تحقق من مقالتنا حول البرمجة كائنية التوجه (OOP) في Solidity.
