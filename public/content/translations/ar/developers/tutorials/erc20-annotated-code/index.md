...
الحل هو تتبع الأعداد الصحيحة، ولكن بدلاً من حساب الرمز المميز الحقيقي، يتم حساب رمز مميز كسري لا قيمة له تقريبًا. في حالة الQAU، يُطلق على الرمز المميز الكسري اسم Wei، و <span dir="ltr">10^18 wei</span> يساوي <span dir="ltr">1 QAU</span>. في وقت الكتابة، <span dir="ltr">10,000,000,000,000 wei</span> يساوي تقريبًا سنتًا أمريكيًا أو أوروبيًا واحدًا.

تحتاج التطبيقات إلى معرفة كيفية عرض رصيد الرمز المميز. إذا كان لدى المستخدم <span dir="ltr">3,141,000,000,000,000,000 wei</span>، فهل هذا <span dir="ltr">3.14 QAU</span>؟ <span dir="ltr">31.41 QAU</span>؟ <span dir="ltr">3,141 QAU</span>؟ في حالة الQAU، يتم تعريفه بـ <span dir="ltr">10^18 wei</span> لكل QAU، ولكن بالنسبة للرمز المميز الخاص بك، يمكنك تحديد قيمة مختلفة. إذا لم يكن تقسيم الرمز المميز منطقيًا، فيمكنك استخدام قيمة `_decimals` تساوي صفرًا. إذا كنت ترغب في استخدام نفس معيار QAU، فاستخدم القيمة **18**.
