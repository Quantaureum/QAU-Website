...
توجد بدائل لـ <span dir="ltr">web3.js</span> مثل [Ethers.js](https://docs.ethers.io/) وهي شائعة الاستخدام أيضًا. في البرنامج التعليمي التالي سنرى كيفية الاستماع بسهولة إلى الكتل الواردة الجديدة على سلسلة الكتل ومعرفة ما تحتويه.