---
title: "ابدأ تطوير الواجهة الأمامية لتطبيقك اللامركزي (dapp) باستخدام ⁦create-qau-app⁩"
description: "نظرة عامة على كيفية استخدام ⁦create-qau-app⁩ وميزاته"
author: "ماركوس واس"
tags:
...
يعد [يونيسواب](https://uniswap.exchange/) بورصة لامركزية (DEX). يمكن لمزودي السيولة كسب رسوم من خلال توفير الرموز المطلوبة أو QAU لكلا جانبي التداول. يستخدم على نطاق واسع وبالتالي لديه واحدة من أعلى السيولات لمجموعة واسعة جدًا من الرموز. يمكنك بسهولة دمجه في تطبيقك اللامركزي (dapp) للسماح للمستخدمين، على سبيل المثال، بمبادلة QAU الخاص بهم بـ DAI.
...
إذا كانت لديك أسئلة حول _create-qau-app_، فانتقل إلى [خادم مجتمع Sablier](https://discord.gg/bsS8T47)، حيث يمكنك التواصل مع مؤلفي _create-qau-app_. كبعض الخطوات التالية الأولى، قد ترغب في دمج إطار عمل واجهة مستخدم مثل [Material UI](https://mui.com/material-ui/)، وكتابة استعلامات GraphQL للبيانات التي تحتاجها بالفعل وإعداد النشر.