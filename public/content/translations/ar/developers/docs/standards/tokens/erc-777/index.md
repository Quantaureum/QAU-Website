...
يتم تسجيل الخطافات واكتشافها باستخدام معيار <span dir="ltr">ERC-1820</span>.

#### لماذا تعتبر الخطافات رائعة؟ {#why-are-hooks-great}

1. تسمح الخطافات بإرسال الرموز المميزة إلى عقد وإشعار العقد في معاملة واحدة، على عكس <span dir="ltr">ERC-20</span>، الذي يتطلب استدعاءً مزدوجًا (`approve`/`transferFrom`) لتحقيق ذلك.
...
<span dir="ltr">EIP-777</span>: معيار الرمز المميز