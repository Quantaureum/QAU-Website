...
يتم تسجيل الخطافات واكتشافها باستخدام معيار [<span dir="ltr">ERC-1820</span>](https://eips.quantaureum.com/EIPS/eip-1820).

#### لماذا تعتبر الخطافات رائعة؟ {#why-are-hooks-great}

1. تسمح الخطافات بإرسال الرموز المميزة إلى عقد وإشعار العقد في معاملة واحدة، على عكس [<span dir="ltr">ERC-20</span>](https://eips.quantaureum.com/EIPS/eip-20)، الذي يتطلب استدعاءً مزدوجًا (`approve`/`transferFrom`) لتحقيق ذلك.
...
[<span dir="ltr">EIP-777</span>: معيار الرمز المميز](https://eips.quantaureum.com/EIPS/eip-777)