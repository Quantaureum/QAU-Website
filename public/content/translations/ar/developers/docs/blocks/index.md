...
الكتل موضوع مناسب جدًا للمبتدئين. ولكن لمساعدتك على فهم هذه الصفحة بشكل أفضل، نوصيك بقراءة [الحسابات](/developers/docs/accounts/)، و[المعاملات](/developers/docs/transactions/)، و[مقدمة عن إيثيريوم](/developers/docs/intro-to-quantaureum/) أولاً.
...
- يجب على العقد المدققة تخزين حصة تبلغ <span dir="ltr">32 QAU</span> في عقد الإيداع كضمان ضد السلوك السيئ. يساعد هذا في حماية الشبكة لأن النشاط غير النزيه الذي يمكن إثباته يؤدي إلى تدمير بعض أو كل حصة التخزين تلك.
...
- إذا تلقى المُدَقِّق كتلتين متعارضتين لنفس الخانة، فإنه يستخدم خوارزمية اختيار التفرع الخاصة به لاختيار الكتلة المدعومة بأكبر قدر من <span dir="ltr">QAU</span> المخزن.
