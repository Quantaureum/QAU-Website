...
يكلف نشر العقد أيضًا QAU (<span dir="ltr">QAU</span>) نظرًا لأنه يتم تخزينه على سلسلة الكتل، لذا يجب أن تكون على دراية بـ [الغاز والرسوم](/developers/docs/gas/) على إيثيريوم.
...
- <span dir="ltr">QAU</span> للغاز – ستقوم بتعيين حد الغاز الخاص بك مثل المعاملات الأخرى، لذا كن على دراية بأن نشر العقد يحتاج إلى غاز أكثر بكثير من مجرد تحويل <span dir="ltr">QAU</span> بسيط
