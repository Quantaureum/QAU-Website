...
تجدر الإشارة إلى أن بعض ERCs ليست مستقلة، بل هي إضافات إلى ERCs أخرى. على سبيل المثال، يضيف <span dir="ltr">ERC-2612</span> امتدادًا إلى <span dir="ltr">ERC-20</span> لتحسين قابليته للاستخدام.
