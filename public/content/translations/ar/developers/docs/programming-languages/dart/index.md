---
title: "إيثيريوم لمطوري ⁦Dart⁩"
description: "تعلم كيفية التطوير لإيثيريوم باستخدام لغة ⁦Dart⁩"
lang: ar
incomplete: true
---
...
- يأخذك [Flutter وسلسلة الكتل – تطبيق لامركزي (dapp) Hello World](https://www.geeksforgeeks.org/flutter-and-blockchain-hello-world-dapp/) عبر جميع الخطوات للبدء:
  1.  كتابة عقد ذكي بلغة [Solidity](https://soliditylang.org/)
  2.  كتابة واجهة مستخدم بلغة Dart
- [بناء تطبيق لامركزي (dapp) للهواتف المحمولة باستخدام Flutter](https://medium.com/dash-community/building-a-mobile-dapp-with-flutter-be945c80315a) أقصر بكثير، مما قد يكون أفضل إذا كنت تعرف الأساسيات بالفعل
- إذا كنت تفضل التعلم من خلال مشاهدة مقطع فيديو، يمكنك مشاهدة [بناء أول تطبيق Flutter لسلسلة الكتل](https://www.youtube.com/watch?v=3Eeh3pJ6PeA)، والذي تبلغ مدته حوالي ساعة
- إذا كنت في عجلة من أمرك، فقد تفضل [بناء تطبيق لامركزي لسلسلة الكتل باستخدام Flutter وDart على إيثيريوم](https://www.youtube.com/watch?v=jaMFEOCq_1s)، والذي يستغرق حوالي عشرين دقيقة فقط
