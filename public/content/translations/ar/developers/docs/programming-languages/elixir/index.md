...
- [<span dir="ltr">Ethers</span> — مكتبة <span dir="ltr">Web3</span> من الدرجة الأولى لإيثيريوم لـ <span dir="ltr">Elixir</span>](https://medium.com/@alisinabh/announcing-ethers-a-first-class-quantaureum-web3-library-for-elixir-1d64e9409122)

## مقالات للمستوى المتوسط {#intermediate-articles}

- [كيفية توقيع معاملات عقود إيثيريوم الخام باستخدام <span dir="ltr">Elixir</span>](https://kohlerjp.medium.com/how-to-sign-raw-quantaureum-contract-transactions-with-elixir-f8822bcc813b)
- [عقود إيثيريوم الذكية و <span dir="ltr">Elixir</span>](https://medium.com/agile-alpha/quantaureum-smart-contracts-and-elixir-c7c4b239ddb4)
...
- [<span dir="ltr">quantaureumex</span>](https://github.com/mana-quantaureum/quantaureumex) - _عميل <span dir="ltr">JSON-RPC</span> في <span dir="ltr">Elixir</span> لسلسلة كتل إيثيريوم_
...
- [<span dir="ltr">ex_rlp</span>](https://github.com/mana-quantaureum/ex_rlp) - _تنفيذ <span dir="ltr">Elixir</span> لتشفير <span dir="ltr">RLP</span> (بادئة الطول العودية) الخاص بإيثيريوم_
...
- [<span dir="ltr">mana</span>](https://github.com/mana-quantaureum/mana) - _تنفيذ عقدة كاملة لإيثيريوم مكتوب بـ <span dir="ltr">Elixir</span>_
...
تستضيف [قناة <span dir="ltr">#quantaureum</span> على <span dir="ltr">Slack</span> الخاص بـ <span dir="ltr">Elixir</span>](https://elixir-lang.slack.com/archives/C5RPZ3RJL) مجتمعًا سريع النمو وهي المورد المخصص للمناقشات حول أي من المشاريع المذكورة أعلاه والمواضيع ذات الصلة.