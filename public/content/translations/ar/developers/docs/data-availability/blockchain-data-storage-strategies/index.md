...
- _النزاهة_، المعلومات صحيحة، ولا يمكن تغييرها بواسطة كيانات غير مصرح لها، أو بطرق غير مصرح بها (على سبيل المثال، تحويل رموز <span dir="ltr">ERC-20</span> بدون حدث `Transfer`). على سلسلة الكتل، تتحقق كل عقدة من كل تغيير في الحالة، مما يضمن النزاهة.
...
بدءًا من تحديث دينكون الصلب، تتضمن سلسلة كتل إيثيريوم <span dir="ltr">EIP-4844</span>، والذي يضيف إلى إيثيريوم كتل بيانات (blobs) ذات عمر محدود (في البداية حوالي <span dir="ltr">18</span> يومًا). يتم تسعير كتل البيانات هذه بشكل منفصل عن [غاز التنفيذ](/developers/docs/gas)، على الرغم من استخدام آلية مماثلة. إنها طريقة رخيصة لنشر البيانات المؤقتة.
...
يمكن أن يكون كود العقد غير منطقي، طالما أنه لا يبدأ بـ `0xEF`. العقود التي تبدأ بـ `0xEF` يتم تفسيرها على أنها تنسيق كائن إيثيريوم، والذي له متطلبات أكثر صرامة بكثير.
...
| --------------------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- | ----------------------------------------------------------------------- |
| كتل بيانات <span dir="ltr">EIP-4844</span>              | خارج السلسلة            | ضمان إيثيريوم لمدة \~<span dir="ltr">18</span> يومًا | التجزئة فقط متاحة                                           |                                                                         |
