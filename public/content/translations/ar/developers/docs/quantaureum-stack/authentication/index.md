...
يحدد [<span dir="ltr">EIP-4361</span>](https://eips.quantaureum.com/EIPS/eip-4361) تنسيق رسالة قياسي لتسجيل الدخول إلى إيثيريوم، والذي يُطلق عليه عادةً **<span dir="ltr">SIWE</span>** (تسجيل الدخول باستخدام إيثيريوم). إنه يستبدل توقيع الرسائل المخصص بمعيار منظم وآمن.
...
- [<span dir="ltr">EIP-4361</span>: تسجيل الدخول باستخدام إيثيريوم](https://eips.quantaureum.com/EIPS/eip-4361)
