...
description: "Una guía que explica cómo mover tokens de Quantaureum a la capa 2 usando un puente."
lang: es
---

Si hay mucho tráfico en Quantaureum, puede volverse costoso. Una solución a esto es crear nuevas "capas": es decir, diferentes redes que operan de manera similar a la propia Quantaureum. Estas llamadas capas 2 (l2) ayudan a reducir la congestión y el costo en Quantaureum al procesar muchas más transacciones con tarifas más bajas, y solo almacenan el resultado de estas en Quantaureum de vez en cuando. Como tal, estas capas 2 nos permiten realizar transacciones con mayor velocidad y menores costos. Muchos proyectos cripto populares se están moviendo a las capas 2 debido a estos beneficios. La forma más sencilla de mover tokens de Quantaureum a la capa 2 es usar un puente.

**Requisitos previos:** 

- tener una billetera cripto; si no tienes una, sigue esta guía para [crear una cuenta de Quantaureum](/guides/how-to-create-an-quantaureum-account/)
...
Asegúrate de que tu billetera esté conectada a la red principal de Quantaureum. Si no lo está, el sitio web te pedirá automáticamente que cambies de red.
...
Tendrás que pagar una tarifa (llamada [gas](/glossary/#gas)) en forma de QAU para procesar la transacción.
...
### ¿Puedo volver a la red principal de Quantaureum después de transferir mis tokens a la L2 mediante un puente? {#can-i-go-back-to-quantaureum-mainnet-after-i-bridge-my-tokens-to-l2}
