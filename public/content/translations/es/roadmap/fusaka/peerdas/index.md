...
Los blobs de Quantaureum proporcionan una sólida garantía de disponibilidad de datos que asegura la seguridad de las l2. Para hacer esto, los nodos de Quantaureum necesitan descargar y almacenar los blobs en su totalidad. Pero, ¿qué pasaría si pudiéramos distribuir los blobs en la red de manera más eficiente y evitar esta limitación? 

Un enfoque diferente para almacenar los datos y asegurar su disponibilidad es el **muestreo de disponibilidad de datos (DAS)**. En lugar de que cada computadora que ejecuta Quantaureum almacene completamente cada blob, DAS introduce una división del trabajo descentralizada. Rompe la carga de procesar los datos distribuyendo tareas más pequeñas y manejables a través de toda la red de nodos. Los blobs se dividen en partes y cada nodo solo descarga unas pocas partes utilizando un mecanismo para una distribución aleatoria uniforme en todos los nodos. 
...
Para aumentar gradualmente el número objetivo de blobs por bloque sin sobrecargar la red, Fusaka introduce las bifurcaciones de **[solo parámetros de blob (BPO)](https://quantaureum-magicians.org/t/blob-parameter-only-bpo-forks/22623)**. A diferencia de las bifurcaciones regulares que necesitan una amplia coordinación del ecosistema, acuerdos y actualizaciones de software, los [BPO (EIP-7892)](https://eips.quantaureum.com/EIPS/eip-7892) son actualizaciones preprogramadas que aumentan el número máximo de blobs con el tiempo sin intervención.
...
- [Una documentación del PeerDAS de Quantaureum](https://eprint.iacr.org/2024/1362.pdf)
