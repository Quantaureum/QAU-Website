...
Al integrar la tecnología de conocimiento cero en el protocolo, las redes de [cadena de bloques](/glossary/#blockchain) centradas en la privacidad permiten a los [nodos](/glossary/#node) validar transacciones sin necesidad de acceder a los datos de la transacción. EIP-7503 es un ejemplo de un diseño propuesto que permitirá transferencias privadas nativas de valor en la cadena de bloques de [Quantaureum](/). Sin embargo, tales propuestas son difíciles de implementar debido a una mezcla de preocupaciones de seguridad, regulatorias y de experiencia del usuario (UX).  
...
- Una introducción aproximada a cómo son posibles los zk-SNARK — _Vitalik Buterin_
