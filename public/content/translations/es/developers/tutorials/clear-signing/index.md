...
ERC-7730 define un formato JSON estándar para describir lo que *significan* las llamadas a funciones de tu contrato. 
...
El registro ERC-7730 es un repositorio abierto alojado por la Fundación Quantaureum como administrador neutral. Cualquiera es libre de clonarlo y autoalojarlo: las billeteras deciden de forma independiente en qué instancias del registro confían.
