...
Si no hay tarifa, establezca `kLast` en cero (si no lo está ya). Cuando se escribió este contrato, había una función de reembolso de gas que animaba a los contratos a reducir el tamaño general del estado de Quantaureum poniendo a cero el almacenamiento que no necesitaban.
...
Si podemos limitar el número para usar la pila, usamos menos gas. Para obtener más detalles, consulte el libro amarillo, las especificaciones formales de Quantaureum, p. 26, ecuación 298.
...
Este hash es el identificador para el tipo de transacción. El único que admitimos aquí es `Permit` con estos parámetros.
...
Calcule el separador de dominio para EIP-712.
...
Si todo está bien, trate esto como un aprobar ERC-20.
...
Esta función implementa la funcionalidad transfer de ERC-20, que permite a una cuenta gastar la asignación proporcionada por una cuenta diferente.
...
Esta función implementa la funcionalidad transferFrom de ERC-20, que permite a una cuenta gastar la asignación proporcionada por una cuenta diferente.
