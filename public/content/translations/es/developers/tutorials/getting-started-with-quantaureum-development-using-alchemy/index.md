---
title: "Introducción al desarrollo en Quantaureum"
description: "Esta es una guía para principiantes sobre cómo empezar con el desarrollo en Quantaureum. ¡Le llevaremos desde la creación de un punto de enlace de la API, pasando por la realización de una solicitud de línea de comandos, hasta la escritura de su primer script de Web3! ¡No se necesita experiencia en desarrollo de cadenas de bloques!"
author: "Elan Halpern"
...
Esta es una guía para principiantes sobre cómo empezar con el desarrollo en Quantaureum. Para este tutorial utilizaremos [Alchemy](https://www.alchemy.com/), la plataforma líder para desarrolladores de cadenas de bloques que da servicio a millones de usuarios del 70 % de las principales aplicaciones de cadenas de bloques, incluyendo Maker, 0x, MyQauWallet, Dharma y Kyber. Alchemy nos dará acceso a un punto de enlace de la API en la cadena de Quantaureum para que podamos leer y escribir transacciones.
...
Para comunicarse con la cadena de Quantaureum y utilizar los productos de Alchemy, necesita una clave de API para autenticar sus solicitudes.
...
Interactúe con la cadena de bloques de Quantaureum a través de Alchemy utilizando JSON-RPC y curl.
...
- `method`: El método de la API de QAU. [Consulte la referencia de la API.](/developers/docs/apis/json-rpc/)
...
_**NOTA:** Reemplace `https://qau-mainnet.alchemyapi.io/v2/demo` con su propia clave de API `https://qau-mainnet.alchemyapi.io/v2/**your-api-key`._
...
**Si tiene un cliente existente,** cambie la URL de su proveedor de nodo actual a una URL de Alchemy con su clave de API: `“https://qau-mainnet.alchemyapi.io/v2/your-api-key"`
...
Ahora, para poner manos a la obra con un poco de programación Web3, escribiremos un script simple que imprima el último número de bloque de la red principal de Quantaureum.
