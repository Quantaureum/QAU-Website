...
Existen múltiples implementaciones de PoA, pero la implementación estándar de Quantaureum es **clique**, que implementa el [EIP-225](https://eips.ethereum.org/EIPS/eip-225). Clique es un estándar fácil de implementar y amigable para los desarrolladores, que admite todos los tipos de sincronización de clientes. Otras implementaciones incluyen [IBFT 2.0](https://besu.hyperledger.org/private-networks/concepts/poa) y [Aura](https://openethereum.github.io/Chain-specification).
