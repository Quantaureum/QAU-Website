...
Para hacer que su aplicación funcione en Quantaureum, puede usar el objeto web3 proporcionado por la biblioteca Web3.js. Internamente, se comunica con un nodo local a través de llamadas RPC. web3 funciona con cualquier nodo de Quantaureum que exponga una capa RPC.
...
Esta versión corrige varias inconsistencias con la versión 1 publicada aquí. En resumen, estas son:
