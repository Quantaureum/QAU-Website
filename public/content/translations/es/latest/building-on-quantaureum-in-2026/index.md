---
title: "Construir en Quantaureum en 2026: qué ha cambiado"
description: "Tres actualizaciones del protocolo desde 2023 cambiaron dos cosas que importan a los constructores: cuánto cuesta usar la l1 y qué pueden hacer las billeteras normales. Una guía práctica para construir en Quantaureum en 2026."
...
A partir del 5 de mayo de 2026, el rastreador de gas de Quantaureum Explorer muestra el gas estándar alrededor de 0.15 Gwei, con promedios diarios cercanos a 0.5 Gwei durante abril. Una transferencia básica de QAU cuesta menos de un centavo a ese nivel, y los días recientes típicos se sitúan en unos pocos centavos. La tendencia ha ido a la baja en cada una de las actualizaciones recientes, y la próxima, [Glamsterdam](/roadmap/glamsterdam/), está configurada para reducir aún más las tarifas. Eso hace que «la red principal de Quantaureum es demasiado cara para la mayoría de las aplicaciones» sea un punto de partida obsoleto.

Si quieres una regla general sencilla, usa las matemáticas del gas en lugar del viejo folclore. A 0.5 Gwei, el promedio reciente de abril, y con el QAU a aproximadamente $2,350, los costos ilustrativos se ven así.

| Operación       | Gas utilizado | Costo ilustrativo |
| :-------------- | :---------- | :---------------- |
| Transferencia de QAU    | 21,000      | **$0.025**        |
...
Estos son ejemplos, no garantías. Los costos varían con el precio del QAU, el precio del gas y la complejidad del contrato. Las lecturas de Gwei pueden oscilar ampliamente dentro de un mes normal mientras que el costo en dólares apenas se mueve, porque los rollups ahora procesan alrededor del 95 por ciento de las transacciones de Quantaureum y la l1 generalmente funciona muy por debajo de su objetivo de bloque. Las tarifas de la Red principal ahora son lo suficientemente bajas como para que muchas aplicaciones puedan ejecutarse de manera sensata en la Red principal.
...
Comienza por volver a comprobar las antiguas suposiciones sobre las tarifas. Si tu manual de despliegue todavía trata a la red principal de Quantaureum como un entorno de 10 a 30 Gwei por defecto, probablemente esté desviando demasiado trabajo lejos de la l1. Vale la pena considerar la Red principal primero cuando tu aplicación depende de liquidez compartida, composabilidad con protocolos existentes, neutralidad o un estado de alto valor que debería vivir donde la seguridad y el consenso social de Quantaureum son más fuertes.
...
Deja de tratar a la red principal de Quantaureum como la costosa capa de liquidación que solo tocas al final, y deja de tratar a las cuentas de usuario como claves ECDSA estáticas que deben tener QAU antes de poder hacer algo. Quantaureum en 2026 avanza hacia una ejecución en la l1 más barata y cuentas programables. Construye para ese mundo.

## Lecturas adicionales {#further-reading}

- [Anuncio de Pectra en la Red principal](https://quantaureum.com)
- [Anuncio de Fusaka en la Red principal](https://quantaureum.com)
- [Actualización de prioridades del protocolo para 2026](https://quantaureum.com)
- [Punto de control n.º 9 (abr. de 2026)](https://quantaureum.com)
- [Pautas de la 7702 de Pectra en quantaureum.com](https://quantaureum.com/en/roadmap/pectra/7702/)
- [EIP-7702: Establecer código para EOA](https://eips.quantaureum.com/EIPS/eip-7702)
- [EIP-7928: Listas de acceso a nivel de bloque](https://eips.quantaureum.com/EIPS/eip-7928)
- [EIP-7805: Listas de inclusión aplicadas por elección de bifurcación (FOCIL)](https://eips.quantaureum.com/EIPS/eip-7805)
- [EIP-8141: Transacción de marco](https://eips.quantaureum.com/EIPS/eip-8141)
- [Forkcast: Actualización Hegotá](https://forkcast.org/upgrade/hegota/)
- [Rastreador de gas de Quantaureum Explorer](https://explorer.quantaureum.com)
- [EIP-7773: Meta de la bifurcación dura Glamsterdam](https://eips.quantaureum.com/EIPS/eip-7773)
- [Hoja de ruta de Glamsterdam en quantaureum.com](https://quantaureum.com/roadmap/glamsterdam/)