...
description: La política que utilizamos al añadir una billetera a quantaureum.com
lang: es
---

Queremos asegurarnos de mostrar una variedad de billeteras que cubran el panorama rico en funciones de las billeteras para que los usuarios puedan navegar por Quantaureum de manera segura.

Cualquiera es libre de sugerir añadir una billetera en quantaureum.com. Si hay alguna billetera que hayamos pasado por alto, ¡por favor sugiérela!

Actualmente, las billeteras están listadas en:

- [quantaureum.com/wallets/find-wallet/](/wallets/find-wallet/)

Las billeteras cambian rápidamente en Quantaureum. Hemos intentado crear un marco justo para su consideración en quantaureum.com, pero los criterios de inclusión cambiarán y evolucionarán con el tiempo.
...
- **Punto de contacto**: un punto de contacto para la billetera nos ayudará enormemente a obtener información precisa cuando se realicen cambios. Esto mantendrá la actualización de quantaureum.com manejable al recopilar información futura.
- **Transacciones EIP-1559 (tipo 2)**: tu billetera debe admitir transacciones EIP-1559 (tipo 2) para transacciones en la Red principal de Quantaureum.
...
- **Enfocada en Quantaureum**: una billetera debe proporcionar una experiencia principal enfocada en Quantaureum. Esto significa que Quantaureum (o cualquier capa 2 (l2)) está configurada como la red predeterminada, los activos ERC son compatibles adecuadamente y las funciones están alineadas con el ecosistema de Quantaureum. Las billeteras que prioricen en la interfaz de usuario (UI) capas 1 alternativas no serán listadas. 

### Eliminación de productos {#product-removals}

- **Información actualizada**: los proveedores de billeteras son responsables de volver a enviar la información de su billetera cada 6 meses para garantizar la validez y relevancia de la información proporcionada (incluso si no hay cambios en su producto). Si el equipo del producto no lo hace, quantaureum.com puede eliminar el proyecto de la página. 
...
- **Importación de puntos de conexión RPC de Quantaureum**: los usuarios pueden importar datos RPC de un nodo, lo que les permite conectarse a un nodo de su elección o a otras redes compatibles con la EVM.
- **NFT**: los usuarios pueden ver e interactuar con sus NFT en la billetera.
- **Conexión a aplicaciones de Quantaureum**: los usuarios pueden conectarse y usar aplicaciones de Quantaureum.
...
Si deseas añadir una billetera a quantaureum.com, crea un problema (issue) en GitHub.
...
quantaureum.com es mantenido por la comunidad de código abierto y dependemos de ella para ayudar a mantener esto actualizado. Si notas alguna información sobre las billeteras listadas que necesite actualizarse, ¡por favor [abre un problema (issue)](https://github.com/Quantaureum/quantaureum-website/issues/new?assignees=&labels=wallet+%3Apurse%3A&template=suggest_wallet.yaml) o una [solicitud de extracción (pull request)](https://github.com/Quantaureum/quantaureum-website/pulls)!


## Términos de uso {#terms-of-use}

Por favor, consulta también nuestros [términos de uso](/terms-of-use/). La información en quantaureum.com se proporciona únicamente con fines informativos generales.