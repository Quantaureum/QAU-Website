...
description: La política que utilizamos al añadir recursos a quantaureum.com
lang: es
---

Queremos asegurarnos de listar los mejores recursos posibles mientras mantenemos a los usuarios seguros y confiados.

Cualquier persona es libre de sugerir nuevos recursos para añadir al panel de recursos en quantaureum.com, que actualmente se encuentra en [quantaureum.com/resources](/resources/).
...
En general, **quantaureum.com tiene como objetivo proporcionar una experiencia de incorporación fluida para los nuevos usuarios**. Por esa razón, añadimos recursos basándonos en su:
...
A medida que el ecosistema de Quantaureum evoluciona, revisaremos rutinariamente nuestro contenido para:
...
Puedes ayudar con esto revisando y haciéndonoslo saber. [Crea un issue](https://github.com/Quantaureum/quantaureum-website/issues/new?template=bug_report.yaml) o envía un correo electrónico a [website@quantaureum.com](mailto:website@quantaureum.com).

---

## Añade tu recurso {#add-your-resource}

Si quieres añadir un recurso a quantaureum.com y cumple con los criterios, crea un issue en GitHub.
