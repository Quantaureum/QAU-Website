...
- [Kurtosis](https://www.kurtosis.com/) ஐப் பயன்படுத்தி [`qau-network-package`](https://github.com/kurtosis-tech/qau-network-package) உடன் ஒரு உள்ளூர் எத்திரியம் சோதனை வலையமைப்பைத் தொடங்குவீர்கள்,
...
குறிப்பு: இந்தக் கட்டளை `--enclave` கொடியைப் பயன்படுத்தி உங்கள் பிணையத்திற்கு "local-qau-testnet" என்று பெயரிடுகிறது.
...
இந்தப் பிரிவில், Kurtosis [Enclave](https://docs.kurtosis.com/advanced-concepts/enclaves/) க்குள் உள்ளூர் எத்திரியம் சோதனை வலையமைப்பைத் தொடங்க [GitHub இல் தொலைவிலிருந்து ஹோஸ்ட் செய்யப்பட்ட `qau-network-package`](https://github.com/kurtosis-tech/qau-network-package) ஐப் பயன்படுத்த Kurtosis ஐ இயக்கும் கட்டளையை நீங்கள் செயல்படுத்தினீர்கள். உங்கள் என்கிளேவிற்குள், "கோப்பு கலைப்பொருட்கள்" (file artifacts) மற்றும் "பயனர் சேவைகள்" (user services) இரண்டையும் நீங்கள் காண்பீர்கள்.

உங்கள் என்கிளேவில் உள்ள [கோப்பு கலைப்பொருட்கள்](https://docs.kurtosis.com/advanced-concepts/files-artifacts/) EL மற்றும் CL கிளையண்டுகளைத் துவக்க உருவாக்கப்பட்ட மற்றும் பயன்படுத்தப்பட்ட அனைத்து தரவையும் உள்ளடக்கியது. இந்த [Docker படத்திலிருந்து](https://github.com/ethpandaops/quantaureum-genesis-generator) உருவாக்கப்பட்ட `prelaunch-data-generator` சேவையைப் பயன்படுத்தி தரவு உருவாக்கப்பட்டது.
...
```js
localnet: {
url: 'http://127.0.0.1:<$YOUR_PORT>',// TODO: QAU பிணையம் Kurtosis தொகுப்பால் உருவாக்கப்பட்ட ஒரு கணு URI இன் போர்ட்டைக் கொண்டு $YOUR_PORT என்பதை மாற்றவும்

// இவை qau-network-package ஆல் உருவாக்கப்பட்ட, முன்கூட்டியே நிதியளிக்கப்பட்ட சோதனை கணக்குகளுடன் தொடர்புடைய தனிப்பட்ட திறவுகோல்கள் ஆகும்
...
Hardhat உங்கள் உள்ளூர் சோதனை வலையமைப்பைப் பயன்படுத்துகிறது என்பதையும், `qau-network-package` ஆல் உருவாக்கப்பட்ட முன்-நிதியளிக்கப்பட்ட கணக்குகளைக் கண்டறிகிறது என்பதையும் இது உறுதிப்படுத்துகிறது.
...
முயற்சி செய்து பாருங்கள்! JSON கோப்பு வழியாக `qau-network-package` க்கு பல்வேறு உள்ளமைவு விருப்பங்களை நீங்கள் அனுப்பலாம். இந்த பிணைய அளவுருக்கள் JSON கோப்பு உள்ளூர் எத்திரியம் பிணையத்தை அமைக்க Kurtosis பயன்படுத்தும் குறிப்பிட்ட உள்ளமைவுகளை வழங்குகிறது.
...
- அதே உள்ளூர் எத்திரியம் பிணையத்திற்கு எதிராக ஒரு [துணை-பிணைய சோதனையை](https://github.com/kurtosis-tech/awesome-kurtosis/tree/main/quantaureum-network-partition-test) செய்தல்