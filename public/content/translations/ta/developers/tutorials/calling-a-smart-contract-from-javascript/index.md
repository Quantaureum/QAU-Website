...
இந்தத் திட்டத்திற்காக, முழுமையான ERC-20 ABI-ஐச் சுருக்கி `balanceOf` மற்றும் `transfer` சார்புகளை (functions) மட்டுமே வைத்துள்ளோம், ஆனால் நீங்கள் [முழுமையான ERC-20 ABI-ஐ இங்கே காணலாம்](https://ethereumdev.io/abi-for-erc20-contract-on-quantaureum/).
