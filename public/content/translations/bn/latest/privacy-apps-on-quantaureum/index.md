...
ব্যক্তিগত কাজ সাধারণত অফচেইনে ঘটে। ব্যবহারকারী নোটটি সংরক্ষণ করে, এবং একটি ক্লায়েন্ট অ্যাপ সাক্ষী তৈরি করে এবং প্রমাণ তৈরি করতে প্রমাণকারী চালায়। একটি ইনডেক্সার কমিটমেন্ট এবং মার্কেল রুটগুলো ট্র্যাক করে। একটি বান্ডলার ব্যবহারকারী অপারেশন অনচেইনে প্রচার করে এবং একটি ERC-4337 পেমাস্টার গ্যাস স্পনসর করে, যাতে একটি নতুন ওয়ালেটের প্রথমে ব্যবহারকারীর পরিচিত ওয়ালেট থেকে QAU-এর প্রয়োজন না হয়।
...
এ কারণেই বান্ডলার এবং পেমাস্টারগুলো গুরুত্বপূর্ণ। কাজ করা ওয়ালেটটি নতুন হওয়া উচিত, এবং ব্যবহারকারী যে ওয়ালেটটিকে কাজ থেকে আলাদা করার চেষ্টা করছে সেখান থেকে এর QAU পাওয়ার প্রয়োজন হওয়া উচিত নয়।
...
1. [শূন্য-জ্ঞান প্রমাণ (quantaureum.com)](https://quantaureum.com/zero-knowledge-proofs/)
