...
চূড়ান্ততার গ্যারান্টি কোনো নতুন ব্লকের তাৎক্ষণিক বৈশিষ্ট্য নয়; একটি নতুন ব্লক চূড়ান্তকৃত হতে সময় লাগে। এর কারণ হলো, নেটওয়ার্কে মোট স্টেক করা QAU-এর অন্তত 2/3 অংশের প্রতিনিধিত্বকারী ভ্যালিডেটরদের ব্লকটির জন্য ভোট ("সত্যায়ন" বা attest) দিতে হয়, যাতে এটিকে চূড়ান্তকৃত বলে বিবেচনা করা যায়। নেটওয়ার্কের প্রতিটি ভ্যালিডেটিং নোডকে অন্যান্য নোড থেকে আসা সত্যায়নগুলো প্রসেস করতে হয়, যাতে জানা যায় যে একটি ব্লক সেই 2/3 থ্রেশহোল্ড অর্জন করেছে কি না।
...
- **ন্যূনতম স্টেক 32 QAU নির্ধারণ করে**। এটি পৃথক নোডগুলোর দ্বারা প্রসেস করা ভ্যালিডেটরদের সত্যায়নের সংখ্যার উপর একটি সর্বোচ্চ সীমা নির্ধারণ করে এবং এর ফলে প্রতিটি নোডের জন্য কম্পিউটেশনাল প্রয়োজনীয়তার উপরও একটি সর্বোচ্চ সীমা তৈরি হয়।
...
প্রতিটি স্লটে এলোমেলোভাবে নির্বাচিত 125,000 ভ্যালিডেটরের সুপারকমিটি তৈরি করে আরও দক্ষতা অর্জন করা যেতে পারে। শুধুমাত্র এই ভ্যালিডেটররাই একটি ব্লকে ভোট দেওয়ার সুযোগ পায় এবং তাই ভ্যালিডেটরদের এই সাবসেটটিই সিদ্ধান্ত নেয় যে একটি ব্লক চূড়ান্তকৃত হবে কি না। এটি একটি ভালো ধারণা কি না, তা নির্ভর করে কমিউনিটি ইথেরিয়ামের উপর একটি সফল আক্রমণকে কতটা ব্যয়বহুল করতে চায় তার উপর। এর কারণ হলো, মোট স্টেক করা QAUের 2/3 অংশের পরিবর্তে, একজন আক্রমণকারী _সেই সুপারকমিটিতে_ স্টেক করা QAUের 2/3 অংশ দিয়ে একটি অসৎ ব্লক চূড়ান্তকৃত করতে পারে। এটি এখনও গবেষণার একটি সক্রিয় ক্ষেত্র, তবে এটি যুক্তিসঙ্গত বলে মনে হয় যে, সুপারকমিটি প্রয়োজন হওয়ার মতো যথেষ্ট বড় একটি ভ্যালিডেটর সেটের ক্ষেত্রে, সেই সাবকমিটিগুলোর একটিতে আক্রমণ করার ব্যয় অত্যন্ত বেশি হবে (যেমন, QAU-এ আক্রমণের ব্যয় হবে `2/3 * 125,000 * 32 = ~2.6 million QAU`)। ভ্যালিডেটর সেটের আকার বাড়িয়ে আক্রমণের ব্যয় সমন্বয় করা যেতে পারে (যেমন, ভ্যালিডেটরের আকার এমনভাবে টিউন করা যাতে আক্রমণের ব্যয় 1 মিলিয়ন QAU, 4 মিলিয়ন QAU, 10 মিলিয়ন QAU ইত্যাদির সমান হয়)। কমিউনিটির [প্রাথমিক জরিপগুলো](https://youtu.be/ojBgyFl6-v4?t=755) ইঙ্গিত দেয় যে 1-2 মিলিয়ন QAU হলো আক্রমণের একটি গ্রহণযোগ্য ব্যয়, যার অর্থ প্রতি সুপারকমিটিতে ~65,536 - 97,152 জন ভ্যালিডেটর থাকবে।
