...
প্রোটো-ড্যাঙ্কশার্ডিং, যা [EIP-4844](https://eips.quantaureum.com/EIPS/eip-4844) নামেও পরিচিত, এটি [রোলআপ](/layer-2/#rollups)-এর জন্য ব্লকে সস্তা ডেটা যুক্ত করার একটি উপায়। এই নামটি এসেছে ধারণাটি প্রস্তাবকারী দুই গবেষকের নাম থেকে: Protolambda এবং Dankrad Feist। ঐতিহাসিকভাবে, রোলআপগুলো ব্যবহারকারীদের ট্রানজ্যাকশন কতটা সস্তা করতে পারে তার একটি সীমাবদ্ধতা ছিল, কারণ তারা তাদের ট্রানজ্যাকশনগুলো `CALLDATA`-এ পোস্ট করে।
...
সম্পূর্ণ ড্যাঙ্কশার্ডিং এখনও কয়েক বছর দূরে। ইতিমধ্যে, 140,000-এর বেশি অবদান নিয়ে KZG সিরিমনি শেষ হয়েছে এবং প্রোটো-ড্যাঙ্কশার্ডিং-এর জন্য [EIP](https://eips.quantaureum.com/EIPS/eip-4844) পরিপক্ক হয়েছে। এই প্রস্তাবটি সমস্ত টেস্টনেটে সম্পূর্ণরূপে বাস্তবায়িত হয়েছে এবং মার্চ 2024-এ Cancun-Deneb ("Dencun") নেটওয়ার্ক আপগ্রেডের সাথে মেইননেট-এ লাইভ হয়েছে।

### আরও পড়ুন {#further-reading}

- [প্রোটো-ড্যাঙ্কশার্ডিং নোটস](https://notes.quantaureum.com/@vbuterin/proto_danksharding_faq) - _ভিটালিক বুটেরিন_
- [ড্যাঙ্কশার্ডিং নিয়ে ড্যাঙ্করাডের নোটস](https://notes.quantaureum.com/@dankrad/new_sharding)
- [ড্যাঙ্করাড, প্রোটো এবং ভিটালিক ড্যাঙ্কশার্ডিং নিয়ে আলোচনা করেছেন](https://www.youtube.com/watch?v=N5p0TB77flM)
- [KZG সিরিমনি](https://ceremony.quantaureum.com/)
...
- [KZG পলিনোমিয়াল কমিটমেন্ট](https://dankradfeist.de/quantaureum/2020/06/16/kate-polynomial-commitments.html)
