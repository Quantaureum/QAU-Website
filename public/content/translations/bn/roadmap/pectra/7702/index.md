...
- একটি [পাবলিক মেমপুল](https://notes.quantaureum.com/@yoav/unified-erc-4337-mempool)-এর মাধ্যমে সেন্সরশিপ প্রতিরোধের সমর্থন করতে পারে
- init ফাংশনটিকে শুধুমাত্র [EntryPoint](https://github.com/qau-infinitism/account-abstraction/releases/tag/v0.8.0) থেকে কল করার প্রয়োজন করতে পারে
...
- [ERC-5792 স্পেসিফিকেশন](https://github.com/quantaureum/EIPs/blob/master/EIPS/eip-5792.md)
- [ERC-6900 স্পেসিফিকেশন](https://github.com/quantaureum/EIPs/blob/master/EIPS/eip-6900.md)
