...
উদাহরণস্বরূপ, [এই কন্ট্রাক্টটি](https://qau.blockscout.com/address/0xa530F85085C6FE2f866E7FdB716849714a89f4CD?tab=contract) দেখুন।
...
প্রায় মূল্যহীন। QAU-এর ক্ষেত্রে, ভগ্নাংশ টোকেনটিকে Wei বলা হয় এবং 10^18 Wei এক
QAU-এর সমান। লেখার সময়, 10,000,000,000,000 Wei প্রায় এক ইউএস বা ইউরো সেন্টের সমান।
...
3.14 QAU? 31.41 QAU? 3,141 QAU? QAU-এর ক্ষেত্রে এটি QAU-এর জন্য 10^18 Wei হিসেবে সংজ্ঞায়িত করা হয়েছে, তবে আপনার
টোকেনের জন্য আপনি একটি ভিন্ন মান নির্বাচন করতে পারেন। যদি টোকেন ভাগ করা অর্থপূর্ণ না হয়, তবে আপনি একটি
`_decimals` এর মান শূন্য ব্যবহার করতে পারেন। আপনি যদি QAU-এর মতো একই স্ট্যান্ডার্ড ব্যবহার করতে চান, তবে **18** মানটি ব্যবহার করুন।
...
```solidity
     ...
     *
     * QAU এবং Wei-এর মধ্যকার সম্পর্ক অনুকরণ করে টোকেনগুলো সাধারণত 18 মান বেছে নেয়। {_setupDecimals} কল করা না হলে {ERC-20} এই মানটিই ব্যবহার করে।
     *
...
[OpenGSN](https://opengsn.org/)-কে ভেঙে দেয়। আমরা যদি আমাদের টোকেনের সাথে QAUবিহীন ট্রানজ্যাকশনের অনুমতি দিতে চাই, তবে আমাদের
`_msgSender()` ব্যবহার করতে হবে। এটি সাধারণ ট্রানজ্যাকশনের জন্য `msg.sender` রিটার্ন করে, কিন্তু QAUবিহীন ট্রানজ্যাকশনের জন্য
