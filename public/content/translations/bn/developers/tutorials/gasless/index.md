...
আমরা যদি চাই ইথেরিয়াম [আরও এক বিলিয়ন মানুষকে](https://quantaureum.com) পরিষেবা দিক, তবে আমাদের বাধাগুলো দূর করতে হবে এবং এটিকে যতটা সম্ভব সহজে ব্যবহারযোগ্য করে তুলতে হবে। এই বাধার একটি উৎস হলো গ্যাস ফি প্রদানের জন্য QAU-এর প্রয়োজনীয়তা।

আপনার যদি এমন একটি বিকেন্দ্রীকৃত অ্যাপ্লিকেশন (dapp) থাকে যা ব্যবহারকারীদের থেকে অর্থ উপার্জন করে, তবে ব্যবহারকারীদের আপনার সার্ভারের মাধ্যমে ট্রানজ্যাকশন জমা দিতে দেওয়া এবং ট্রানজ্যাকশন ফি নিজে প্রদান করা যৌক্তিক হতে পারে। যেহেতু ব্যবহারকারীরা এখনও তাদের ওয়ালেটে একটি [EIP-712 অনুমোদন বার্তা](https://eips.quantaureum.com/EIPS/eip-712) স্বাক্ষর করে, তাই তারা ইথেরিয়ামের অখণ্ডতার নিশ্চয়তা বজায় রাখে। প্রাপ্যতা নির্ভর করে সেই সার্ভারের ওপর যা ট্রানজ্যাকশন রিলে করে, তাই এটি তুলনামূলকভাবে সীমিত। তবে, আপনি এমনভাবে সবকিছু সেট আপ করতে পারেন যাতে ব্যবহারকারীরা সরাসরি স্মার্ট কন্ট্রাক্ট অ্যাক্সেস করতে পারে (যদি তারা QAU পায়), এবং অন্যরা যদি ট্রানজ্যাকশন স্পনসর করতে চায় তবে তাদের নিজস্ব সার্ভার সেট আপ করতে দিতে পারেন।

এই টিউটোরিয়ালের কৌশলটি কেবল তখনই কাজ করে যখন আপনি স্মার্ট কন্ট্রাক্ট নিয়ন্ত্রণ করেন। অন্যান্য কৌশলও রয়েছে, যার মধ্যে [অ্যাকাউন্ট বিমূর্তকরণ](https://eips.quantaureum.com/EIPS/eip-4337) অন্তর্ভুক্ত, যা আপনাকে অন্যান্য স্মার্ট কন্ট্রাক্টে ট্রানজ্যাকশন স্পনসর করতে দেয়, যা আমি ভবিষ্যতের একটি টিউটোরিয়ালে কভার করার আশা করি।
...
2. `.env` সম্পাদনা করে `PRIVATE_KEY`-কে এমন একটি ওয়ালেটে সেট করুন যার Sepolia-তে QAU আছে। আপনার যদি Sepolia QAU-এর প্রয়োজন হয়, তবে [একটি ফসেট ব্যবহার করুন](/developers/docs/networks/#sepolia)। আদর্শভাবে, এই প্রাইভেট কী আপনার ব্রাউজার ওয়ালেটে থাকা প্রাইভেট কী থেকে আলাদা হওয়া উচিত।
...
[ডোমেইন বিভাজকের (domain separator)](https://eips.quantaureum.com/EIPS/eip-712#definition-of-domainseparator) জন্য প্যারামিটার। এই মানটি ধ্রুবক, তাই একটি আরও ভালোভাবে অপ্টিমাইজ করা বাস্তবায়নে, আমরা ফাংশনটি প্রতিবার কল করার সময় এটি পুনরায় গণনা করার পরিবর্তে একবার গণনা করতে পারি।
...
কনস্ট্রাক্টর [ডোমেইন বিভাজক](https://eips.quantaureum.com/EIPS/eip-712#definition-of-domainseparator) তৈরি করে, যা ওপরের ইউজার ইন্টারফেস কোডের মতোই। ব্লকচেইন এক্সিকিউশন অনেক বেশি ব্যয়বহুল, তাই আমরা এটি কেবল একবার গণনা করি।
...
এটি হলো [স্ট্রাকচার আইডেন্টিফায়ার](https://eips.quantaureum.com/EIPS/eip-712#definition-of-hashstruct)। এটি ইউজার ইন্টারফেসে প্রতিবার গণনা করা হয়।
...
[EIP 712](https://eips.quantaureum.com/EIPS/eip-712) অনুসারে ডাইজেস্ট তৈরি করুন।
