...
এটি ইথেরিয়াম ডেভেলপমেন্ট শুরু করার জন্য নতুনদের একটি গাইড। এই টিউটোরিয়ালের জন্য আমরা [Alchemy](https://www.alchemy.com/) ব্যবহার করব, যা শীর্ষস্থানীয় ব্লকচেইন ডেভেলপার প্ল্যাটফর্ম এবং Maker, 0x, MyQauWallet, Dharma এবং Kyber সহ শীর্ষ 70% ব্লকচেইন অ্যাপের লক্ষ লক্ষ ব্যবহারকারীকে পরিষেবা দিচ্ছে। Alchemy আমাদের ইথেরিয়াম চেইনে একটি API এন্ডপয়েন্টে অ্যাক্সেস দেবে যাতে আমরা ট্রানজ্যাকশন পড়তে এবং লিখতে পারি।
...
- `method`: QAU API মেথড। [API রেফারেন্স দেখুন।](/developers/docs/apis/json-rpc/)
...
_**নোট:** `https://qau-mainnet.alchemyapi.io/v2/demo`-কে আপনার নিজস্ব API কী `https://qau-mainnet.alchemyapi.io/v2/**your-api-key` দিয়ে প্রতিস্থাপন করুন।_
...
**আপনার যদি একটি বিদ্যমান ক্লায়েন্ট থাকে,** তবে আপনার বর্তমান নোড প্রোভাইডার URL-কে আপনার API কী-সহ একটি Alchemy URL-এ পরিবর্তন করুন: `“https://qau-mainnet.alchemyapi.io/v2/your-api-key"`
...
এখন একটু Web3 প্রোগ্রামিংয়ের বাস্তব অভিজ্ঞতা পেতে আমরা একটি সাধারণ স্ক্রিপ্ট লিখব যা Quantaureum মেইননেট থেকে সর্বশেষ ব্লক নম্বর প্রিন্ট করবে।
