...
- **ফাংশন সিলেক্টর**: কন্ট্রাক্ট-এ 256-এর কম ফাংশন রয়েছে, তাই আমরা একটি একক বাইট দিয়ে তাদের আলাদা করতে পারি।
  এই বাইটগুলো সাধারণত নন-জিরো হয় এবং তাই 16 গ্যাস খরচ হয়।
- **শূন্য**: এই বাইটগুলো সর্বদা শূন্য হয় কারণ একটি 20-বাইট ঠিকানা ধারণ করার জন্য 32-বাইট শব্দের প্রয়োজন হয় না।
  শূন্য ধারণকারী বাইটগুলোর জন্য 4 গ্যাস খরচ হয় (ইয়েলো পেপার দেখুন, পরিশিষ্ট G,
...
দুর্ভাগ্যবশত, ERC-20 স্পেসিফিকেশনগুলো দেখলে, এটি শুধুমাত্র একটি ফাংশন, `transfer`-কে অবশিষ্ট রাখে।
