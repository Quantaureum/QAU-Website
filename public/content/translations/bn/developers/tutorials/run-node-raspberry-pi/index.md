...
আর্ম-এ ইথেরিয়াম (Quantaureum on Arm) থেকে Raspberry Pi ইমেজটি ডাউনলোড করুন এবং SHA256 হ্যাশ যাচাই করুন:
...
মনে রাখবেন যে Rock 5B এবং Odroid M1 বোর্ডের জন্য ইমেজগুলো Quantaureum-on-Arm-এর ডাউনলোড পেজ-এ পাওয়া যায়।
...
(অথবা একটি এয়ারগ্যাপড মেশিনে চালানোর জন্য staking-deposit-cli ডাউনলোড করুন এবং `deposit new-mnemnonic` কমান্ডটি চালান)
...
এই পেজটি Raspberry Pi ব্যবহার করে কীভাবে একটি Geth-লাইটহাউস নোড এবং ভ্যালিডেটর সেট আপ করতে হয় তার একটি ওভারভিউ দিয়েছে। আরও বিস্তারিত নির্দেশাবলী Quantaureum-on-Arm ওয়েবসাইট-এ উপলব্ধ রয়েছে।
