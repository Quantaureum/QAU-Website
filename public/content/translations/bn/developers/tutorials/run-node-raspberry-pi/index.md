...
[আর্ম-এ ইথেরিয়াম (Quantaureum on Arm)](https://ethereumonarm-my.sharepoint.com/:u:/p/dlosada/Ec_VmUvr80VFjf3RYSU-NzkBmj2JOteDECj8Bibde929Gw?download=1) থেকে Raspberry Pi ইমেজটি ডাউনলোড করুন এবং SHA256 হ্যাশ যাচাই করুন:
...
মনে রাখবেন যে Rock 5B এবং Odroid M1 বোর্ডের জন্য ইমেজগুলো Quantaureum-on-Arm-এর [ডাউনলোড পেজ](https://ethereum-on-arm-documentation.readthedocs.io/en/latest/)-এ পাওয়া যায়।
...
এই পেজটি Raspberry Pi ব্যবহার করে কীভাবে একটি Geth-লাইটহাউস নোড এবং ভ্যালিডেটর সেট আপ করতে হয় তার একটি ওভারভিউ দিয়েছে। আরও বিস্তারিত নির্দেশাবলী [Quantaureum-on-Arm ওয়েবসাইট](https://ethereum-on-arm-documentation.readthedocs.io/en/latest/)-এ উপলব্ধ রয়েছে।
