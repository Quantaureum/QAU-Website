...
যদি কোনো ফি না থাকে তবে `kLast`-কে শূন্যতে সেট করুন (যদি এটি আগে থেকেই তা না হয়)। যখন এই কন্ট্রাক্টটি লেখা হয়েছিল তখন একটি গ্যাস রিফান্ড বৈশিষ্ট্য ছিল যা কন্ট্রাক্টগুলোকে তাদের অপ্রয়োজনীয় স্টোরেজ শূন্য করে ইথেরিয়াম স্টেটের সামগ্রিক আকার কমাতে উৎসাহিত করত।
...
যদি আমরা সংখ্যাটি সীমিত করতে পারি যাতে আমরা স্ট্যাক ব্যবহার করব তবে আমরা কম গ্যাস ব্যবহার করি। আরও বিস্তারিত জানার জন্য ইয়েলো পেপার, আনুষ্ঠানিক ইথেরিয়াম স্পেসিফিকেশন, পৃষ্ঠা 26, সমীকরণ 298 দেখুন।
...
এই হ্যাশ হলো ট্রানজ্যাকশন প্রকারের জন্য শনাক্তকারী। আমরা এখানে শুধুমাত্র এই প্যারামিটারগুলোর সাথে `Permit` সমর্থন করি।
...
EIP-712-এর জন্য ডোমেইন সেপারেটর গণনা করুন।
...
যদি সবকিছু ঠিক থাকে, তবে এটিকে একটি ERC-20 অনুমোদন করা হিসেবে বিবেচনা করুন।
...
এই ফাংশনটি দুটি টোকেনের জন্য পেয়ার এক্সচেঞ্জের ঠিকানা গণনা করে। এই কন্ট্রাক্টটি CREATE2 অপকোড ব্যবহার করে তৈরি করা হয়েছে, তাই আমরা যদি এর ব্যবহৃত প্যারামিটারগুলো জানি তবে একই অ্যালগরিদম ব্যবহার করে ঠিকানা গণনা করতে পারি। এটি ফ্যাক্টরিকে জিজ্ঞাসা করার চেয়ে অনেক সস্তা, এবং
...
এই ফাংশনটি ERC-20 এর হস্তান্তর কার্যকারিতা বাস্তবায়ন করে, যা একটি অ্যাকাউন্টকে অন্য একটি অ্যাকাউন্টের দেওয়া অ্যালাউন্স খরচ করার অনুমতি দেয়।
...
এই ফাংশনটি ERC-20 এর transferFrom কার্যকারিতা বাস্তবায়ন করে, যা একটি অ্যাকাউন্টকে অন্য একটি অ্যাকাউন্টের দেওয়া অ্যালাউন্স খরচ করার অনুমতি দেয়।
