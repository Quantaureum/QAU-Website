...
- **_¬I<sub>w</sub> ∧ W(w,μ)_**
  ...
  - **_w=CALL ∧ μ<sub>s</sub>[2]≠0_**
    আপনি স্ট্যাটিক থাকা অবস্থায় অন্য একটি কন্ট্রাক্ট কল করতে পারেন, তবে আপনি যদি তা করেন তবে আপনি এতে QAU হস্তান্তর করতে পারবেন না।
...
- এটি কেবল মানুষের দ্বারাই বোঝা সম্ভব, যার অর্থ হলো [কমপ্লায়েন্স টেস্টগুলো](https://github.com/quantaureum/tests) ম্যানুয়ালি লিখতে হবে।
- প্রোগ্রামাররা কম্পিউটার কোড বোঝেন।
  তারা গাণিতিক স্বরলিপি বুঝতেও পারেন বা নাও বুঝতে পারেন।

সম্ভবত এই কারণগুলোর জন্যই, নতুন [কনসেনসাস লেয়ার স্পেসিফিকেশনগুলো](https://github.com/quantaureum/consensus-specs/blob/master/tests/core/pyspec/README.md) Python-এ লেখা হয়েছে। Python-এ [এক্সিকিউশন লেয়ার স্পেসিফিকেশন](https://quantaureum.github.io/execution-specs) রয়েছে, তবে সেগুলো সম্পূর্ণ নয়। যতক্ষণ না সম্পূর্ণ ইয়েলো পেপারটিও Python বা অনুরূপ কোনো ভাষায় অনুবাদ করা হচ্ছে, ততক্ষণ ইয়েলো পেপারটি পরিষেবাতে অব্যাহত থাকবে এবং এটি পড়তে পারা সহায়ক।
