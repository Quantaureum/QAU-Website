...
এই টিউটোরিয়ালে আমরা [একটি স্ক্যাম টোকেন](https://explorer.quantaureum.com) বিশ্লেষণ করে দেখব স্ক্যামাররা কী ধরনের কৌশল ব্যবহার করে এবং কীভাবে সেগুলো বাস্তবায়ন করে। টিউটোরিয়ালটির শেষে আপনি ERC-20 টোকেন কন্ট্রাক্ট, সেগুলোর সক্ষমতা এবং কেন সন্দেহপ্রবণ হওয়া প্রয়োজন সে সম্পর্কে আরও বিশদ ধারণা পাবেন। এরপর আমরা সেই স্ক্যাম টোকেন থেকে নির্গত ইভেন্টগুলো দেখব এবং কীভাবে স্বয়ংক্রিয়ভাবে শনাক্ত করা যায় যে এটি বৈধ নয় তা জানব।
...
ব্যবহারকারীর দৃষ্টিকোণ থেকে আপনি এই বিষয়ে আরও পড়তে পারেন [quantaureum.com-এর অন্য কোথাও](/guides/how-to-id-scam-tokens/)। এই টিউটোরিয়ালটি একটি স্ক্যাম টোকেন বিশ্লেষণ করে কীভাবে এটি করা হয় এবং কীভাবে এটি শনাক্ত করা যায় তার ওপর আলোকপাত করে।

### আমি কীভাবে বুঝব যে wARB একটি স্ক্যাম? {#warb-scam}

আমরা যে টোকেনটি বিশ্লেষণ করছি তা হলো [wARB](https://explorer.quantaureum.com), যা বৈধ [ARB টোকেন](https://explorer.quantaureum.com)-এর সমতুল্য হওয়ার ভান করে।
...
সাধারণত আমরা আশা করি যারা অন্যদের স্ক্যাম করার চেষ্টা করে তারা গোপনীয়তা বজায় রাখবে, এবং সত্যিই অনেক স্ক্যাম টোকেনের কোড উপলব্ধ থাকে না (উদাহরণস্বরূপ, [এটি](https://explorer.quantaureum.com) এবং [এটি](https://explorer.quantaureum.com))।

তবে, বৈধ টোকেনগুলো সাধারণত তাদের সোর্স কোড প্রকাশ করে, তাই বৈধ দেখানোর জন্য স্ক্যাম টোকেনের লেখকরাও মাঝে মাঝে একই কাজ করে। [wARB](https://explorer.quantaureum.com) হলো এমন একটি টোকেন যার সোর্স কোড উপলব্ধ, যা এটিকে বোঝা সহজ করে তোলে।

যদিও কন্ট্রাক্ট ডিপ্লয়াররা সোর্স কোড প্রকাশ করবে কি না তা বেছে নিতে পারে, তবে তারা ভুল সোর্স কোড প্রকাশ করতে _পারে না_। ব্লক এক্সপ্লোরার স্বাধীনভাবে প্রদত্ত সোর্স কোড কম্পাইল করে, এবং যদি এটি হুবহু একই বাইটকোড না পায়, তবে এটি সেই সোর্স কোড প্রত্যাখ্যান করে। [আপনি Quantaureum Explorer সাইটে এই সম্পর্কে আরও পড়তে পারেন](https://explorer.quantaureum.com)।
...
[`HOP` টোকেন কন্ট্রাক্ট](https://explorer.quantaureum.com) [`Ownable`](https://docs.openzeppelin.com/contracts/2.x/access-control#ownership-and-ownable) প্যাটার্ন ব্যবহার করে। বিশেষ সুবিধাপ্রাপ্ত ঠিকানাটি স্টোরেজে `_owner` নামক একটি ফিল্ডে রাখা হয় (তৃতীয় ফাইলটি দেখুন, `Ownable.sol`)।
...
তবে, `dropNewTokens` তা করে না। এটি [`Transfer` ইভেন্ট](https://eips.quantaureum.com/EIPS/eip-20#transfer-1) নির্গত করে, কিন্তু আসলে কোনো টোকেন হস্তান্তর করে না। অফচেইন অ্যাপ্লিকেশনগুলোকে এমন একটি হস্তান্তরের কথা বলে বিভ্রান্ত করার কোনো বৈধ কারণ নেই যা বাস্তবে ঘটেনি।
...
যদিও এটি [স্ট্যান্ডার্ডে](https://eips.quantaureum.com/EIPS/eip-20) নির্দিষ্ট করা নেই, তবে সাধারণভাবে বলতে গেলে যে ফাংশনটি নতুন টোকেন তৈরি করে তাকে [`mint`](/developers/tutorials/erc20-annotated-code/#the-_mint-and-_burn-functions-_mint-and-_burn) বলা হয়।
...
আমরা Quantaureum Explorer-এর দিকে তাকিয়ে দেখতে পারি যে `wARB` একটি স্ক্যাম টোকেন। তবে, এটি একটি কেন্দ্রীভূত সমাধান। তাত্ত্বিকভাবে, Quantaureum Explorer-কে ধ্বংস বা হ্যাক করা যেতে পারে। কোনো টোকেন বৈধ কি না তা স্বাধীনভাবে বের করতে পারাটা ভালো।
...
[`Approval` ইভেন্টগুলো](https://eips.quantaureum.com/EIPS/eip-20#approval) শুধুমাত্র একটি সরাসরি অনুরোধের মাধ্যমেই ঘটা উচিত (এর বিপরীতে [`Transfer` ইভেন্টগুলো](https://eips.quantaureum.com/EIPS/eip-20#transfer-1) একটি অ্যালাউন্স-এর ফলে ঘটতে পারে)। এই সমস্যাটির বিস্তারিত ব্যাখ্যা এবং কেন অনুরোধগুলো কোনো কন্ট্রাক্ট দ্বারা মধ্যস্থতা করার পরিবর্তে সরাসরি হওয়া প্রয়োজন তা জানতে [Solidity ডক্স দেখুন](https://docs.soliditylang.org/en/v0.8.20/security-considerations.html#tx-origin)।
...
2. একটি Quantaureum মেইননেট নোড-এর URL প্রদান করতে `.env` সম্পাদনা করুন।
...
আমরা শুধু স্ট্রিংয়ের সমতা পরীক্ষা করতে পারি না কারণ ঠিকানাগুলো হেক্সাডেসিমেল, তাই সেগুলোতে অক্ষর থাকে। কখনো কখনো, উদাহরণস্বরূপ `txn.from`-এ, সেই অক্ষরগুলো সবই ছোট হাতের হয়। অন্যান্য ক্ষেত্রে, যেমন `ev.args._owner`-এ, ঠিকানাটি [ত্রুটি শনাক্তকরণের জন্য মিক্সড-কেস](https://eips.quantaureum.com/EIPS/eip-55)-এ থাকে।
