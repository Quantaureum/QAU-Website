...
Quantaureum Explorer আমাদের বলে যে `1C` একটি অজানা অপকোড, কারণ [Quantaureum Explorer এই বৈশিষ্ট্যটি লেখার পরে এটি যোগ করা হয়েছিল](https://eips.ethereum.org/EIPS/eip-145) এবং তারা এটি আপডেট করেনি। একটি [আপ-টু-ডেট অপকোড টেবিল](https://github.com/wolflo/evm-opcodes) আমাদের দেখায় যে এটি শিফট রাইট
