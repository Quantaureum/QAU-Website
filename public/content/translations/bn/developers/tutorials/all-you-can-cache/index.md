...
4. আপনার কনফিগারেশনের জন্য `.env` সম্পাদনা করুন:
   ...
   | প্যারামিটার | মান |
   | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | MNEMONIC | একটি অ্যাকাউন্টের জন্য নেমোনিক (mnemonic) যার কাছে একটি ট্রানজ্যাকশনের জন্য অর্থ প্রদান করার মতো পর্যাপ্ত QAU রয়েছে। [অপটিমিজমের ফসেট ডক্স](https://docs.optimism.io/app-developers/tools/faucets) বর্তমান টেস্টনেট ফসেটগুলোর তালিকা দেয়। |
