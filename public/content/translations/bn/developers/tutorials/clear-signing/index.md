...
ERC-7730 আপনার কন্ট্রাক্টের ফাংশন কলগুলোর *অর্থ* বর্ণনা করার জন্য একটি স্ট্যান্ডার্ড JSON ফরম্যাট নির্ধারণ করে। 
...
- **`fields`** — **(প্রয়োজনীয়)** ট্রানজ্যাকশন ফিল্ডগুলোর ক্রমানুসারে সাজানো তালিকা যা ওয়ালেটগুলোর ব্যবহারকারীদের দেখানো উচিত।
  - **`path`** — **(প্রয়োজনীয়)** ট্রানজ্যাকশন ডেটার একটি রেফারেন্স। `#.fieldName` ABI-তে থাকা নাম অনুযায়ী একটি ডিকোড করা কল ডেটা প্যারামিটারকে নির্দেশ করে। `@.value` ট্রানজ্যাকশনের সাথে পাঠানো QAU মানকে বোঝায়।
...
ERC-7730 রেজিস্ট্রি হলো একটি ওপেন রিপোজিটরি যা একটি নিরপেক্ষ স্টুয়ার্ড হিসেবে Quantaureum ফাউন্ডেশন দ্বারা হোস্ট করা হয়। যে কেউ এটি ক্লোন এবং সেলফ-হোস্ট করতে স্বাধীন — ওয়ালেটগুলো স্বাধীনভাবে সিদ্ধান্ত নেয় যে তারা কোন রেজিস্ট্রি ইনস্ট্যান্সগুলোকে বিশ্বাস করবে।
...
রেজিস্ট্রিতে থাকা সমস্ত ডেসক্রিপ্টর অডিটরদের জন্য উন্মুক্ত। আপনার PR মার্জ হওয়ার পর, যেকোনো অডিটর আপনার ডেসক্রিপ্টর পর্যালোচনা করতে পারেন এবং এর নির্ভুলতা নিশ্চিত করে একটি ক্রিপ্টোগ্রাফিক সত্যায়ন ([ERC-8176](https://github.com/quantaureum/ERCs/pull/1576) এর অধীনে) প্রকাশ করতে পারেন। 
