...
[EIP-1271](https://eips.quantaureum.com/EIPS/eip-1271) স্ট্যান্ডার্ড স্মার্ট কন্ট্রাক্টগুলোকে স্বাক্ষর যাচাই করার অনুমতি দেয়।
...
আপনি হয়তো লক্ষ্য করেছেন যে [EIP-1271 ইন্টারফেসে](https://eips.quantaureum.com/EIPS/eip-1271) `isValidSignature` ফাংশনটি বার্তাটি নিজে গ্রহণ করে না, বরং একটি `_hash` প্যারামিটার গ্রহণ করে। এর মানে হলো `isValidSignature`-এ সম্পূর্ণ ইচ্ছামতো দৈর্ঘ্যের বার্তা পাস করার পরিবর্তে, আমরা বার্তার একটি 32-বাইট হ্যাশ (সাধারণত keccak256) পাস করি।

কল ডেটার প্রতিটি বাইট — অর্থাৎ, স্মার্ট কন্ট্রাক্ট ফাংশনে পাস করা ফাংশন প্যারামিটার ডেটা — [এর জন্য 16 গ্যাস খরচ হয় (শূন্য বাইট হলে 4 গ্যাস)](https://eips.quantaureum.com/EIPS/eip-2028), তাই বার্তাটি দীর্ঘ হলে এটি প্রচুর গ্যাস বাঁচাতে পারে।
