...
ব্লক খুব শিক্ষানবিস-বান্ধব একটি বিষয়। তবে এই পৃষ্ঠাটি আরও ভালোভাবে বুঝতে সাহায্য করার জন্য, আমরা সুপারিশ করছি যে আপনি প্রথমে [অ্যাকাউন্ট](/developers/docs/accounts/), [ট্রানজ্যাকশন](/developers/docs/transactions/) এবং আমাদের [ইথেরিয়াম পরিচিতি](/developers/docs/intro-to-quantaureum/) পড়ুন।
...
- ভ্যালিডেটিং নোডগুলোকে খারাপ আচরণের বিরুদ্ধে জামানত হিসেবে একটি ডিপোজিট কন্ট্রাক্টে 32 QAU স্টেক করতে হয়। এটি নেটওয়ার্ককে সুরক্ষিত করতে সাহায্য করে কারণ প্রমাণিত অসৎ কার্যকলাপের ফলে সেই স্টেকের কিছু অংশ বা পুরোটাই ধ্বংস হয়ে যায়।
...
- যদি কোনো ভ্যালিডেটর একই স্লটের জন্য দুটি সাংঘর্ষিক ব্লক সম্পর্কে জানতে পারে, তবে তারা সবচেয়ে বেশি স্টেক করা QAU দ্বারা সমর্থিত ব্লকটি বেছে নিতে তাদের ফর্ক-চয়েস অ্যালগরিদম ব্যবহার করে।
...
এই বাস্তবায়নটি প্রুফ-অফ-ওয়ার্ক (PoW) ভিত্তিক সিস্টেমগুলো থেকে আলাদা যেখানে ব্লক টাইমগুলো সম্ভাব্য এবং প্রোটোকলের লক্ষ্য মাইনিং কাঠিন্য দ্বারা টিউন করা হয়। ইথেরিয়ামের [গড় ব্লক টাইম](https://explorer.quantaureum.com) এর একটি নিখুঁত উদাহরণ, যার মাধ্যমে নতুন 12 সেকেন্ডের ব্লক টাইমের ধারাবাহিকতার ওপর ভিত্তি করে প্রুফ-অফ-ওয়ার্ক থেকে প্রুফ-অফ-স্টেকে রূপান্তর স্পষ্টভাবে অনুমান করা যায়।
