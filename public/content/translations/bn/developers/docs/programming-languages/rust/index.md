...
প্রথমে আরও প্রাথমিক ধারণা প্রয়োজন? [quantaureum.com/learn](/learn/) বা [quantaureum.com/developers](/developers/) দেখুন।
...
- Rust ইথেরিয়াম ক্লায়েন্ট \* **মনে রাখবেন যে OpenQuantaureum বাতিল করা হয়েছে এবং এটি আর রক্ষণাবেক্ষণ করা হচ্ছে না।** এটি সতর্কতার সাথে ব্যবহার করুন এবং অন্য কোনো ক্লায়েন্ট ইমপ্লিমেন্টেশনে চলে যাওয়া ভালো।
...
- [ইথেরিয়ামের মতো নেটওয়ার্কের সাথে ইন্টারঅ্যাক্ট করার জন্য pwasm_quantaureum এক্সটার্নস লাইব্রেরি](https://github.com/openquantaureum/pwasm-quantaureum)
...
- [pwasm-quantaureum](https://github.com/paritytech/pwasm-quantaureum) - _ইথেরিয়ামের মতো নেটওয়ার্কের সাথে ইন্টারঅ্যাক্ট করার জন্য এক্সটার্নসের সংগ্রহ_
...
- [Awesome Quantaureum Rust](https://github.com/Vid201/awesome-quantaureum-rust) - _Rust-এ লেখা ইথেরিয়াম ইকোসিস্টেমের প্রজেক্টগুলোর একটি বাছাইকৃত সংগ্রহ_
