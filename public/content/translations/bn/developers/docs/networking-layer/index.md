...
[স্ন্যাপ প্রোটোকল](https://github.com/ethereum/devp2p/blob/master/caps/snap.md#quantaureum-snapshot-protocol-snap) হলো একটি ঐচ্ছিক এক্সটেনশন যা পিয়ারদের সাম্প্রতিক স্টেট-এর স্ন্যাপশট বিনিময় করতে দেয়, যার ফলে পিয়াররা মধ্যবর্তী মার্কেল ট্রাই (Merkle trie) নোডগুলো ডাউনলোড না করেই অ্যাকাউন্ট এবং স্টোরেজ ডেটা যাচাই করতে পারে।

#### Wit (সাক্ষী প্রোটোকল) {#wit}

[সাক্ষী প্রোটোকল](https://github.com/ethereum/devp2p/blob/master/caps/wit.md#quantaureum-witness-protocol-wit) হলো একটি ঐচ্ছিক এক্সটেনশন যা পিয়ারদের মধ্যে স্টেট সাক্ষী বিনিময় করতে সক্ষম করে, যা ক্লায়েন্টদের চেইনের টিপ-এ সিঙ্কিং করতে সাহায্য করে।
