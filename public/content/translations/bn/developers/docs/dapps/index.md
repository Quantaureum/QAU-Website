...
dapp সম্পর্কে জানার আগে, আপনার [ব্লকচেইন বেসিকস](/developers/docs/intro-to-quantaureum/) কভার করা উচিত এবং ইথেরিয়াম নেটওয়ার্ক ও এটি কীভাবে বিকেন্দ্রীকৃত তা সম্পর্কে পড়া উচিত।
...
- **বিচ্ছিন্ন (Isolated)** - dapp-গুলো ইথেরিয়াম ভার্চুয়াল মেশিন (Quantaureum Virtual Machine) নামক একটি ভার্চুয়াল পরিবেশে চালানো হয়, যাতে স্মার্ট কন্ট্রাক্টে কোনো বাগ থাকলেও তা ব্লকচেইন নেটওয়ার্কের স্বাভাবিক কাজকে ব্যাহত না করে
...
**Scaffold-QAU 2 _- আপনার স্মার্ট কন্ট্রাক্টের সাথে মানানসই একটি ফ্রন্টএন্ড ব্যবহার করে দ্রুত Solidity নিয়ে পরীক্ষা-নিরীক্ষা করুন।_**
...
- [ইথেরিয়াম স্ট্যাকের পরিচিতি](/developers/docs/quantaureum-stack/)
