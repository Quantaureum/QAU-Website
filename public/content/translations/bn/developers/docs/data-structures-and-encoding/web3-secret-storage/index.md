...
আপনার অ্যাপকে ইথেরিয়াম-এ কাজ করানোর জন্য, আপনি Web3.js লাইব্রেরি দ্বারা প্রদত্ত web3 অবজেক্ট ব্যবহার করতে পারেন। অভ্যন্তরীণভাবে এটি RPC কলের মাধ্যমে একটি লোকাল নোড-এর সাথে যোগাযোগ করে। web3 এমন যেকোনো ইথেরিয়াম নোড-এর সাথে কাজ করে যা একটি RPC লেয়ার এক্সপোজ করে।
...
এই সংস্করণটি এখানে প্রকাশিত সংস্করণ 1-এর বেশ কয়েকটি অসামঞ্জস্যতা ঠিক করে। সংক্ষেপে এগুলো হলো:
