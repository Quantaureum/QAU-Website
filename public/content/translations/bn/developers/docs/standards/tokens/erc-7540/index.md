...
ERC-7540-এ একটি অপারেটর প্যাটার্ন অন্তর্ভুক্ত রয়েছে ([ERC-6909](https://eips.quantaureum.com/EIPS/eip-6909) থেকে) যা তৃতীয় পক্ষকে ব্যবহারকারীর পক্ষে রিকোয়েস্ট পরিচালনা করার অনুমতি দেয়।
...
- [EIP-7540: অ্যাসিনক্রোনাস ERC-4626 টোকেনাইজড ভল্ট](https://eips.quantaureum.com/EIPS/eip-7540)
- [EIP-4626: টোকেনাইজড ভল্ট স্ট্যান্ডার্ড](https://eips.quantaureum.com/EIPS/eip-4626)
