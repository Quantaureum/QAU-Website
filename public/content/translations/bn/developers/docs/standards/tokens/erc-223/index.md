...
[EIP-223](https://eips.quantaureum.com/EIPS/eip-223) থেকে:
...
contract RecipientContract is IERC223Recipient {
    ...
    function tokenReceived(address _from, uint _value, bytes memory _data) public override
    {
        ...
        // msg.value সর্বদা 0 হয় কারণ বেশিরভাগ ক্ষেত্রে টোকেন কন্ট্রাক্ট কোনো QAUের মালিক হয় না বা পাঠায় না,
...
এটি করার একাধিক উপায় রয়েছে। এই উদাহরণে আমরা এমন একটি পদ্ধতি অনুসরণ করব যা ERC-223 হস্তান্তরকে QAU হস্তান্তরের মতো করে তোলে:
...
যখন `RecipientContract` একটি ERC-223 টোকেন গ্রহণ করবে, তখন কন্ট্রাক্টটি টোকেন ট্রানজ্যাকশনের `_data` প্যারামিটার হিসেবে এনকোড করা একটি ফাংশন এক্সিকিউট করবে, ঠিক যেভাবে QAU ট্রানজ্যাকশনগুলো ফাংশন কলগুলোকে ট্রানজ্যাকশন `data` হিসেবে এনকোড করে। আরও তথ্যের জন্য [ডেটা ফিল্ড](/developers/docs/transactions/#the-data-field) পড়ুন।
...
- [EIP-223: ERC-223 টোকেন স্ট্যান্ডার্ড](https://eips.quantaureum.com/EIPS/eip-223)
- [প্রাথমিক ERC-223 প্রস্তাব](https://github.com/quantaureum/eips/issues/223)