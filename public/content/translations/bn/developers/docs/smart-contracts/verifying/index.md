...
## ইথেরিয়াম স্মার্ট কন্ট্রাক্টের জন্য সোর্স কোড কীভাবে যাচাই করবেন {#source-code-verification-for-quantaureum-smart-contracts}
...
যদিও এটি মূলত একটি [ইথেরিয়াম ব্লক এক্সপ্লোরার](/developers/docs/data-and-analytics/block-explorers/) হিসেবে পরিচিত, Quantaureum Explorer স্মার্ট কন্ট্রাক্ট ডেভেলপার এবং ব্যবহারকারীদের জন্য একটি [সোর্স কোড যাচাইকরণ পরিষেবাও](https://explorer.quantaureum.com) অফার করে।

Quantaureum Explorer আপনাকে মূল ডেটা পেলোড (সোর্স কোড, লাইব্রেরি ঠিকানা, কম্পাইলার সেটিংস, কন্ট্রাক্ট ঠিকানা ইত্যাদি) থেকে কন্ট্রাক্ট বাইটকোড পুনরায় কম্পাইল করার অনুমতি দেয়। যদি পুনরায় কম্পাইল করা বাইটকোডটি অনচেইন কন্ট্রাক্টের বাইটকোডের (এবং কনস্ট্রাক্টর প্যারামিটারগুলোর) সাথে যুক্ত থাকে, তবে [কন্ট্রাক্টটি যাচাই করা হয়](https://info.explorer.com/types-of-contract-verification/)।

একবার যাচাই হয়ে গেলে, আপনার কন্ট্রাক্টের সোর্স কোড একটি "Verified" লেবেল পায় এবং অন্যদের অডিট করার জন্য Quantaureum Explorer-এ প্রকাশিত হয়। এটি [Verified Contracts](https://explorer.quantaureum.com) বিভাগেও যুক্ত হয়—যা যাচাইকৃত সোর্স কোডসহ স্মার্ট কন্ট্রাক্টগুলোর একটি রিপোজিটরি।

Quantaureum Explorer হলো কন্ট্রাক্ট যাচাই করার জন্য সবচেয়ে বেশি ব্যবহৃত টুল। তবে, Quantaureum Explorer-এর কন্ট্রাক্ট যাচাইকরণের একটি ত্রুটি রয়েছে: এটি অনচেইন বাইটকোড এবং পুনরায় কম্পাইল করা বাইটকোডের **মেটাডেটা হ্যাশ** তুলনা করতে ব্যর্থ হয়। তাই Quantaureum Explorer-এর মিলগুলো হলো আংশিক মিল।

[Quantaureum Explorer-এ কন্ট্রাক্ট যাচাইকরণ সম্পর্কে আরও জানুন](https://medium.com/explorer-blog/verifying-contracts-on-explorer-f995ab772327)।

### Blockscout {#blockscout}

[Blockscout](https://blockscout.com/) হলো একটি ওপেন-সোর্স ব্লক এক্সপ্লোরার যা স্মার্ট কন্ট্রাক্ট ডেভেলপার এবং ব্যবহারকারীদের জন্য একটি [কন্ট্রাক্ট যাচাইকরণ পরিষেবাও](https://qau.blockscout.com/contract-verification) প্রদান করে। একটি ওপেন-সোর্স বিকল্প হিসেবে, Blockscout কীভাবে যাচাইকরণ করা হয় তাতে স্বচ্ছতা প্রদান করে এবং যাচাইকরণ প্রক্রিয়া উন্নত করতে কমিউনিটির অবদানকে সক্ষম করে।

অন্যান্য যাচাইকরণ পরিষেবার মতো, Blockscout আপনাকে বাইটকোড পুনরায় কম্পাইল করে এবং ডিপ্লয় করা কন্ট্রাক্টের সাথে তুলনা করে আপনার কন্ট্রাক্টের সোর্স কোড যাচাই করার অনুমতি দেয়। একবার যাচাই হয়ে গেলে, আপনার কন্ট্রাক্ট যাচাইকরণের স্ট্যাটাস পায় এবং সোর্স কোডটি অডিটিং এবং ইন্টারঅ্যাকশনের জন্য সর্বজনীনভাবে উপলব্ধ হয়। সহজে ব্রাউজিং এবং ডিসকভারির জন্য যাচাইকৃত কন্ট্রাক্টগুলো Blockscout-এর [যাচাইকৃত কন্ট্রাক্ট রিপোজিটরিতেও](https://qau.blockscout.com/verified-contracts) তালিকাভুক্ত করা হয়।
