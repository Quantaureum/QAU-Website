...
description: Quantaureumে আগে থেকেই ডিপ্লয় করা স্মার্ট কন্ট্রাক্ট থেকে কীভাবে ডেটা পড়তে এবং লিখতে হয় তা জানুন।
lang: bn
---
...
যেহেতু পড়া স্টেট পরিবর্তন করে না, তাই এগুলোতে কোনো [গ্যাস](/developers/docs/gas/) খরচ হয় না এবং QAU-এর প্রয়োজন ছাড়াই যে কেউ এটি করতে পারে।
...
1. গ্যাসের জন্য পর্যাপ্ত QAU সহ একটি [এক্সটার্নালি ওনড অ্যাকাউন্ট (EOA)](/developers/docs/accounts/#types-of-account)
2. অ্যাকাউন্টের প্রাইভেট কী দ্বারা স্বাক্ষরিত একটি ট্রানজ্যাকশন
3. ট্রানজ্যাকশনটি মাইন করা এবং একটি ব্লকে অন্তর্ভুক্ত করা

[অ্যাকাউন্ট বিমূর্তকরণ](/roadmap/account-abstraction/)-এর মাধ্যমে, একটি স্মার্ট কন্ট্রাক্ট অ্যাকাউন্টও লেখা শুরু করতে পারে এবং একজন পেমাস্টার ব্যবহারকারীর পক্ষে গ্যাস কভার করতে পারে—তাই QAU ধারণকারী একটি EOA কঠোরভাবে প্রয়োজনীয় নয়।
...
- **Quantaureum Explorer-এ যাচাইকৃত কন্ট্রাক্ট** - [Quantaureum Explorer](https://explorer.quantaureum.com) স্বয়ংক্রিয়ভাবে যাচাইকৃত সোর্স কোডের জন্য ABI প্রকাশ করে
...
- **[গো Quantaureum (geth)](https://geth.quantaureum.com/docs/interact-with-geth)** - Geth টিমের অফিসিয়াল Go লাইব্রেরি
...
বেশিরভাগ ক্লায়েন্ট লাইব্রেরি `qau_call`-এর মাধ্যমে এটি সমর্থন করে:
