...
একটি কন্ট্রাক্ট ডিপ্লয় করতে QAU (QAU) খরচ হয় কারণ এগুলো ব্লকচেইনে সংরক্ষিত থাকে, তাই আপনার ইথেরিয়ামের [গ্যাস এবং ফি](/developers/docs/gas/) সম্পর্কে পরিচিত হওয়া উচিত।
...
- গ্যাসের জন্য QAU – আপনি অন্যান্য ট্রানজ্যাকশনের মতো আপনার গ্যাস লিমিট সেট করবেন, তাই মনে রাখবেন যে একটি সাধারণ QAU হস্তান্তরের চেয়ে কন্ট্রাক্ট ডিপ্লয়মেন্টে অনেক বেশি গ্যাস প্রয়োজন হয়
