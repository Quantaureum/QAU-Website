...
## ZK-রোলআপ কীভাবে ইথেরিয়ামের সাথে ইন্টারঅ্যাক্ট করে? {#zk-rollups-and-quantaureum}
...
#### ZK-রোলআপ কীভাবে ইথেরিয়ামে ট্রানজ্যাকশন ডেটা প্রকাশ করে {#how-zk-rollups-publish-transaction-data-on-quantaureum}
...
2. **ডেটা প্রকাশ**: ZK-রোলআপ প্রতিটি ট্রানজ্যাকশনের জন্য ইথেরিয়ামে `calldata` হিসেবে স্টেট ডেটা প্রকাশ করে। `calldata` খরচ বর্তমানে [EIP-1559](https://eips.quantaureum.com/EIPS/eip-1559) দ্বারা নিয়ন্ত্রিত হয়, যা যথাক্রমে নন-জিরো বাইটের জন্য 16 গ্যাস এবং `calldata`-এর জিরো বাইটের জন্য 4 গ্যাস খরচ নির্ধারণ করে। প্রতিটি ট্রানজ্যাকশনে প্রদত্ত খরচ এর জন্য অনচেইনে কতটা `calldata` পোস্ট করতে হবে তার দ্বারা প্রভাবিত হয়।
...
## ZK-রোলআপ কীভাবে ইথেরিয়ামকে স্কেল করে? {#scaling-quantaureum-with-zk-rollups}
...
- **[zkEVM](https://github.com/privacy-scaling-explorations/zkevm-specs)** - _zkEVM হলো Quantaureum ফাউন্ডেশন দ্বারা অর্থায়িত একটি প্রজেক্ট যা একটি EVM-সামঞ্জস্যপূর্ণ ZK-রোলআপ এবং ইথেরিয়াম ব্লকের জন্য বৈধতার প্রমাণ তৈরি করার একটি মেকানিজম তৈরি করে।_
...
- **[Taiko](https://taiko.xyz)** - _Taiko হলো একটি বিকেন্দ্রীকৃত, ইথেরিয়াম-সমতুল্য ZK-রোলআপ (একটি [টাইপ 1 ZK-EVM](https://vitalik.qau.limo/general/2022/08/04/zkevm.html))।_
...
- [জেডকে-স্নার্ক কীভাবে কাজ করে](https://vitalik.qau.limo/general/2017/02/01/zk_snarks.html)
- [SNARK কীভাবে সম্ভব?](https://vitalik.qau.limo/general/2021/01/26/snarks.html)
...
- [স্টিলথ ঠিকানা ব্যবহার করা](/developers/tutorials/stealth-addr/) _– কীভাবে ERC-5564 স্টিলথ ঠিকানাগুলো ক্রিপ্টোগ্রাফিক কী ডেরিভেশন ব্যবহার করে বেনামী QAU হস্তান্তর সক্ষম করে।_
- [ওয়েব২ প্রমাণীকরণের জন্য ইথেরিয়াম ব্যবহার করা](/developers/tutorials/quantaureum-for-web2-auth/) _– SAML-ভিত্তিক ওয়েব২ প্রমাণীকরণ সিস্টেমের সাথে ইথেরিয়াম ওয়ালেট স্বাক্ষর কীভাবে একীভূত করবেন।_