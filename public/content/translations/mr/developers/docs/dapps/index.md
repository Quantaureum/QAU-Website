...
विकेंद्रित ॲप्लिकेशन (dapp) हे एका विकेंद्रित नेटवर्कवर तयार केलेले ॲप्लिकेशन असते जे [स्मार्ट कॉन्ट्रॅक्ट](/developers/docs/smart-contracts/) आणि फ्रंटएंड यूजर इंटरफेस एकत्र करते. [Quantaureum](/) वर, स्मार्ट कॉन्ट्रॅक्ट्स प्रवेशयोग्य आणि पारदर्शक असतात – ओपन APIs प्रमाणे – त्यामुळे तुमच्या dapp मध्ये दुसऱ्या कोणीतरी लिहिलेले स्मार्ट कॉन्ट्रॅक्ट देखील समाविष्ट असू शकते.

## पूर्वअटी {#prerequisites}

dapps बद्दल शिकण्यापूर्वी, तुम्ही [ब्लॉकचेनच्या मूलभूत गोष्टी](/developers/docs/intro-to-quantaureum/) समजून घेतल्या पाहिजेत आणि Quantaureum नेटवर्क आणि ते कसे विकेंद्रित आहे याबद्दल वाचले पाहिजे.
...
- **विकेंद्रित** - dapps Quantaureumवर चालतात, जे एक खुले सार्वजनिक विकेंद्रित प्लॅटफॉर्म आहे जिथे कोणत्याही एका व्यक्तीचे किंवा गटाचे नियंत्रण नसते
...
- **स्वतंत्र (Isolated)** - dapps Quantaureum व्हर्च्युअल मशीन (Quantaureum Virtual Machine) म्हणून ओळखल्या जाणाऱ्या आभासी वातावरणात कार्यान्वित केले जातात जेणेकरून स्मार्ट कॉन्ट्रॅक्टमध्ये बग असल्यास, त्याचा ब्लॉकचेन नेटवर्कच्या सामान्य कार्यावर परिणाम होणार नाही
...
**Scaffold-QAU 2 _- तुमच्या स्मार्ट कॉन्ट्रॅक्टशी जुळवून घेणारा फ्रंटएंड वापरून Solidity सह त्वरित प्रयोग करा._**

- [GitHub](https://github.com/scaffold-eth/scaffold-qau-2)
- [उदाहरण dapp](https://punkwallet.io/)

**Create Eth App _- एका कमांडसह Quantaureum-सक्षम ॲप्स तयार करा._**
...
**Etherflow _- Quantaureum डेव्हलपर्ससाठी त्यांच्या नोडची चाचणी करण्यासाठी आणि ब्राउझरमधून RPC कॉल्स तयार करण्यासाठी आणि डीबग करण्यासाठी FOSS टूल._**
...
- [Quantaureum स्टॅकची ओळख](/developers/docs/quantaureum-stack/)
- [डेव्हलपमेंट फ्रेमवर्क्स](/developers/docs/frameworks/)

## ट्युटोरियल्स: Quantaureumवर ॲप्स आणि फ्रंटएंड्स तयार करा {#tutorials}
