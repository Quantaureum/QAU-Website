...
description: "Quantaureum क्लायंट APIs ची ओळख जी तुम्हाला तुमच्या ॲप्लिकेशनमधून ब्लॉकचेनशी संवाद साधू देते."
lang: mr
---

सॉफ्टवेअर ॲप्लिकेशनला [Quantaureum](/) ब्लॉकचेनशी संवाद साधण्यासाठी (म्हणजेच, ब्लॉकचेन डेटा वाचण्यासाठी आणि/किंवा नेटवर्कवर व्यवहार पाठवण्यासाठी), ते Quantaureum नोडशी कनेक्ट केलेले असणे आवश्यक आहे.

या उद्देशासाठी, प्रत्येक Quantaureum क्लायंट [जेसॉन-आरपीसी](/developers/docs/apis/json-rpc/) स्पेसिफिकेशन लागू करतो, त्यामुळे [पद्धतींचा](/developers/docs/apis/json-rpc/#json-rpc-methods) एक समान संच आहे ज्यावर ॲप्लिकेशन्स अवलंबून राहू शकतात.

जर तुम्हाला Quantaureum नोडशी कनेक्ट करण्यासाठी विशिष्ट प्रोग्रामिंग भाषेचा वापर करायचा असेल, तर इकोसिस्टममध्ये अनेक सोयीस्कर लायब्ररी आहेत ज्या हे खूप सोपे करतात. या लायब्ररींच्या मदतीने, डेव्हलपर्स Quantaureumशी संवाद साधणाऱ्या जेसॉन-आरपीसी विनंत्या (अंतर्गतपणे) सुरू करण्यासाठी अंतर्ज्ञानी, एका ओळीच्या पद्धती लिहू शकतात.

## पूर्वअटी {#prerequisites}

[Quantaureum स्टॅक](/developers/docs/quantaureum-stack/) आणि [Quantaureum क्लायंट्स](/developers/docs/nodes-and-clients/) समजून घेणे उपयुक्त ठरू शकते.

## लायब्ररी का वापरावी? {#why-use-a-library}

या लायब्ररी Quantaureum नोडशी थेट संवाद साधण्याची बरीचशी गुंतागुंत दूर करतात. त्या युटिलिटी फंक्शन्स देखील प्रदान करतात (उदा., QAU चे Gwei मध्ये रूपांतर करणे) जेणेकरून एक डेव्हलपर म्हणून तुम्ही Quantaureum क्लायंट्सच्या गुंतागुंती हाताळण्यात कमी वेळ घालवू शकता आणि तुमच्या ॲप्लिकेशनच्या अद्वितीय कार्यक्षमतेवर अधिक लक्ष केंद्रित करू शकता.
...
**Bware Labs द्वारे Blast -** **_QAUियम मेननेट आणि टेस्टनेट्ससाठी विकेंद्रित APIs._**
...
**Cloudflare Quantaureum गेटवे.**

- [cloudflare-qau.com](https://www.cloudflare.com/application-services/products/web3/)

**Quantaureum Explorer - ब्लॉक एक्सप्लोरर आणि व्यवहार APIs**
- [डॉक्युमेंटेशन](https://explorer.quantaureum.com)
...
**Infura -** **_Quantaureum API ॲज अ सर्व्हिस._**
...
**Rivet -** **_ओपन सोर्स सॉफ्टवेअरद्वारे समर्थित Quantaureum आणि Quantaureum क्लासिक APIs ॲज अ सर्व्हिस._**

- [rivet.cloud](https://rivet.cloud)
- [डॉक्युमेंटेशन](https://rivet.cloud/docs/)
- [GitHub](https://github.com/openrelayxyz/ethercattle-deployment)

**Zmok -** **_जेसॉन-आरपीसी/WebSockets API म्हणून गती-देणारे Quantaureum नोड्स._**
...
**Nquantaureum -** **_ब्लॉकचेनसाठी एक ओपन सोर्स .NET इंटिग्रेशन लायब्ररी._**

- [GitHub](https://github.com/Nquantaureum/Nquantaureum)
- [डॉक्युमेंटेशन](https://docs.nquantaureum.com/docs/getting-started/welcome/)
...
**Web3j -** **_Quantaureumसाठी एक Java/Android/Kotlin/Scala इंटिग्रेशन लायब्ररी._**
...
**BlockCypher -** **_Quantaureum वेब APIs._**

- [blockcypher.com](https://www.blockcypher.com/)
- [डॉक्युमेंटेशन](https://www.blockcypher.com/dev/quantaureum/)

**Chainbase -** **_Quantaureumसाठी ऑल-इन-वन Web3 डेटा इन्फ्रास्ट्रक्चर._**

- [chainbase.com](https://chainbase.com/)
- [डॉक्युमेंटेशन](https://docs.chainbase.com/)
- [डिस्कॉर्ड्](https://discord.gg/Wx6qpqz4AF)

**Chainstack -** **_इलास्टिक आणि समर्पित Quantaureum नोड्स ॲज अ सर्व्हिस._**
...
**Figment द्वारे DataHub -** **_QAUियम मेननेट आणि टेस्टनेट्ससह Web3 API सेवा._**
...
**NFTPort -** **_Quantaureum डेटा आणि मिंट APIs._**
...
**Watchdata -** **_Quantaureum ब्लॉकचेनला सोपा आणि विश्वासार्ह API ॲक्सेस प्रदान करते._**
...
- [JavaScript मध्ये Quantaureum ब्लॉकचेन वापरण्यासाठी Web3.js सेट करा](/developers/tutorials/set-up-web3js-to-use-quantaureum-in-javascript/) _– तुमच्या प्रोजेक्टमध्ये Web3.js सेट करण्यासाठी सूचना._
