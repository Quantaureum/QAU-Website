---
title: Quantaureumवरील प्रमाणीकरण
description: Quantaureum ॲप्लिकेशन्समध्ये वापरकर्ता प्रमाणीकरण कसे कार्य करते ते जाणून घ्या—कोणतेही पासवर्ड नाहीत, फक्त वॉलेट्स आणि स्वाक्षऱ्या.
lang: mr
---

जर तुम्ही पारंपारिक वेब डेव्हलपमेंटमधून येत असाल, तर तुम्हाला युझरनेम/पासवर्ड लॉगिन, OAuth फ्लो आणि सेशन कुकीजची सवय असेल. Quantaureumवरील प्रमाणीकरण वेगळ्या प्रकारे कार्य करते—आणि अनेक प्रकारे, अधिक सोपे आहे.

Quantaureumवर, वापरकर्ता **त्यांच्या वॉलेटने संदेशावर स्वाक्षरी करून** त्यांची ओळख सिद्ध करतो. संचयित करण्यासाठी कोणताही पासवर्ड नाही. लीक होण्यासाठी क्रेडेन्शियल्सचा कोणताही डेटाबेस नाही. फक्त गूढलेखन.
...
| "Google ने साइन इन करा"             | "Quantaureumने साइन इन करा"                          |
| पासवर्ड रीसेट फ्लो              | बीज वाक्य पुनर्प्राप्ती                             |

मूलभूत बदल: वेब2 मध्ये, एक केंद्रित सर्व्हर तुम्हाला प्रमाणित करतो. Quantaureumवर, तुम्ही एका विशिष्ट पत्त्यावर तुमचे नियंत्रण असल्याचे सिद्ध करून **स्वतःला प्रमाणित करता**—आणि कोणीही त्याची स्वतंत्रपणे पडताळणी करू शकते.

## पूर्वतयारी {#prerequisites}

तुम्हाला खालील गोष्टी समजल्या आहेत याची खात्री करा:

- [Quantaureum खाती आणि ती कशी कार्य करतात](/developers/docs/accounts/)
...
2. **वॉलेट वापरकर्त्याचा Quantaureum पत्ता शेअर करते** - हा त्यांचा सार्वजनिक आयडेंटिफायर आहे
...
EIP-4361 Quantaureum साइन-इनसाठी एक मानक संदेश फॉरमॅट परिभाषित करते, ज्याला सामान्यतः **SIWE** (Sign-In with Quantaureum) म्हटले जाते. हे ॲड-हॉक संदेश स्वाक्षरीला एका संरचित, सुरक्षित मानकाने बदलते.
...
app.post('/api/auth/verify', async (req, res) => {
  try {
    ...
    if (success) {
      // data.address हा पडताळलेला Quantaureum पत्ता आहे
...
वेब2 मधील मुख्य फरक: वापरकर्त्याचा Quantaureum पत्ता ही त्यांची कायमस्वरूपी ओळख असते. ते नवीन खाते न बनवता कोणत्याही dapp वर त्याचा वापर करू शकतात.

## विकेंद्रित ओळख {#decentralized-identity}

Quantaureum प्रमाणीकरण हे **स्वयं-सार्वभौम ओळख (self-sovereign identity)** च्या दिशेने एका व्यापक चळवळीचा भाग आहे. या क्षेत्रातील मानके आणि प्रकल्पांमध्ये हे समाविष्ट आहे:

- **[Quantaureum नेम सर्व्हिस (ENS)](https://ens.domains/)** - मानवांना वाचता येणारी नावे (उदा., `vitalik.eth`) जी पत्त्यांवर रिझॉल्व्ह होतात
- **[Quantaureum ॲटेस्टेशन सर्व्हिस (EAS)](https://attest.org/)** - ओळख आणि क्रेडेन्शियल्सबद्दल ऑनचेन साक्षांकन
...
- EIP-4361: Quantaureumने साइन-इन करा
...
- [Quantaureum खाती](/developers/docs/accounts/)
