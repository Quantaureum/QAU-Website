...
ट्युटोरियल दरम्यान आपण एका साध्या स्मार्ट कॉन्ट्रॅक्टच्या उदाहरणावर काम करू - QauSplitter. हे कोणालाही काही wei पाठवण्याची आणि ते दोन पूर्वनिर्धारित रिसीव्हर्समध्ये समान रीतीने विभाजित करण्याव्यतिरिक्त फार काही करत नाही.
...
QauSplitter कोडचा स्निपेट `src/QauSplitter.sol` मध्ये ठेवा.
...
`yarn build` चालवा. परिणामी, JSON फॉरमॅटमध्ये QauSplitter च्या कंपाईल केलेल्या कॉन्ट्रॅक्टसह `build` डिरेक्टरी दिसेल.
...
आता `test` डिरेक्टरी तयार करा आणि `test\QauSplitter.test.ts` ही नवीन फाईल तयार करा.
...
`MockProvider` ब्लॉकचेनची एक मॉक आवृत्ती प्रदान करतो. ते मॉक वॉलेट्स देखील प्रदान करते जे QauSplitter कॉन्ट्रॅक्टच्या चाचणीसाठी आपल्याला उपयोगी पडतील. प्रोव्हायडरवर `getWallets()` पद्धत कॉल करून आपण दहा पर्यंत वॉलेट्स मिळवू शकतो. उदाहरणामध्ये, आपण तीन वॉलेट्स मिळवतो - सेंडरसाठी आणि दोन रिसीव्हर्ससाठी.

पुढे, आपण 'splitter' नावाचा एक व्हेरिएबल घोषित करतो - हा आपला मॉक QauSplitter कॉन्ट्रॅक्ट आहे. `deployContract` पद्धतीद्वारे प्रत्येक एकाच चाचणीच्या अंमलबजावणीपूर्वी ते तयार केले जाते. ही पद्धत पहिला पॅरामीटर म्हणून पास केलेल्या वॉलेटमधून (आपल्या बाबतीत सेंडरचे वॉलेट) कॉन्ट्रॅक्टच्या डिप्लॉयमेंटचे सिम्युलेशन करते. दुसरा पॅरामीटर चाचणी केलेल्या कॉन्ट्रॅक्टचा ABI आणि बायटेकोड आहे - आपण तिथे `build` डिरेक्टरीमधून कंपाईल केलेल्या QauSplitter कॉन्ट्रॅक्टची json फाईल पास करतो. तिसरा पॅरामीटर कॉन्ट्रॅक्टच्या कन्स्ट्रक्टर युक्तिवादांसह एक अ‍ॅरे आहे, जे आपल्या बाबतीत, रिसीव्हर्सचे दोन अ‍ॅड्रेस आहेत.
...
चाचणी, जर पास झाली, तर आपल्याला खात्री देईल की व्यवहार खरोखरच परत फिरवला गेला होता. तथापि, `require` स्टेटमेंटमध्ये आपण पास केलेल्या संदेशांमध्ये आणि `revertedWith` मध्ये आपण अपेक्षित असलेल्या संदेशात एक अचूक जुळणी देखील असणे आवश्यक आहे. जर आपण QauSplitter कॉन्ट्रॅक्टच्या कोडवर परत गेलो, तर wei रकमेसाठीच्या `require` स्टेटमेंटमध्ये, आपण संदेश देतो: 'विषम wei रक्कम परवानगी नाही'. हे आपल्या चाचणीमध्ये अपेक्षित असलेल्या संदेशाशी जुळते. जर ते समान नसते, तर चाचणी अयशस्वी झाली असती.
