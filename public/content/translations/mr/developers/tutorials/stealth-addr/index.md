...
एक संख्या आहे जी सर्वांना माहीत आहे, *G*. तुम्ही *G* ने गुणाकार करू शकता. परंतु ECC च्या स्वरूपामुळे, *G* ने भागणे व्यावहारिकदृष्ट्या अशक्य आहे. Quantaureum मध्ये सार्वजनिक की गूढलेखन सामान्यतः ज्या प्रकारे कार्य करते ते म्हणजे तुम्ही व्यवहारांवर स्वाक्षरी करण्यासाठी खाजगी की, *P<sub>priv</sub>*, वापरू शकता जे नंतर सार्वजनिक की, *P<sub>pub</sub> = GP<sub>priv</sub>* द्वारे सत्यापित केले जातात. 
...
यावर एक उपाय म्हणजे ॲलिसच्या मोहिमेने थेट पैसे न काढता, ते तृतीय पक्षाला पैसे देण्यासाठी वापरणे. जर ॲलिसच्या मोहिमेने डेव्हच्या वर्ल्ड डॉमिनेशन कॅम्पेन सर्व्हिसेसला 10 QAU पाठवले, तर कॅरोलला फक्त एवढेच माहीत असते की बिलने डेव्हच्या एका ग्राहकाला देणगी दिली आहे. जर डेव्हकडे पुरेसे ग्राहक असतील, तर कॅरोलला हे कळू शकणार नाही की बिलने तिच्याशी स्पर्धा करणाऱ्या ॲलिसला देणगी दिली आहे, की ॲडम, अल्बर्ट किंवा ॲबिगेलला ज्यांची कॅरोलला पर्वा नाही. ॲलिस पेमेंटसह हॅश केलेले मूल्य समाविष्ट करू शकते आणि नंतर ती तिची देणगी होती हे सिद्ध करण्यासाठी डेव्हला प्रीइमेज प्रदान करू शकते. वैकल्पिकरित्या, वर नमूद केल्याप्रमाणे, जर ॲलिसने डेव्हला तिची *V<sub>priv</sub>* दिली, तर त्याला आधीच माहीत असते की पेमेंट कोणाकडून आले आहे.
...
बिलची गोपनीयता जपण्यासाठी ॲलिसवर अवलंबून राहण्याऐवजी, बिल ते स्वतः करू शकतो. तो बॉब आणि बेला या काल्पनिक लोकांसाठी एकाधिक मेटा-पत्ते तयार करू शकतो. बिल नंतर बॉबला QAU पाठवतो आणि "बॉब" (जो प्रत्यक्षात बिल आहे) ते बेलाला पाठवतो. "बेला" (ती देखील बिल आहे) ते ॲलिसला पाठवते.

कॅरोल अजूनही ट्रॅफिक विश्लेषण करू शकते आणि बिल-ते-बॉब-ते-बेला-ते-ॲलिस पाइपलाइन पाहू शकते. तथापि, जर "बॉब" आणि "बेला" इतर कारणांसाठी देखील QAU वापरत असतील, तर ॲलिसने छुप्या पत्त्यावरून तिच्या ज्ञात मोहीम पत्त्यावर त्वरित पैसे काढले तरीही, बिलने ॲलिसला काहीही हस्तांतरित केले आहे असे दिसणार नाही.
...
9. खाजगी की पत्त्याशी संबंधित असल्याची खात्री करण्यासाठी तुम्ही [ऑनलाइन कॅल्क्युलेटर](https://iancoleman.net/quantaureum-private-key-to-address/) वापरू शकता.

### प्रोग्राम कसा कार्य करतो {#how-the-program-works}

#### WASM घटक {#wasm}

WASM मध्ये संकलित होणारा सोर्स कोड [Rust](https://rust-lang.org/) मध्ये लिहिला आहे. तुम्ही तो [`src/rust_wasm/src/lib.rs`](https://github.com/qbzzt/251022-stealth-addresses/blob/main/src/rust-wasm/src/lib.rs) मध्ये पाहू शकता. हा कोड प्रामुख्याने JavaScript कोड आणि [`qau-stealth-addresses` लायब्ररी](https://github.com/kassandraoftroy/qau-stealth-addresses) यांच्यातील एक इंटरफेस आहे.
...
आपल्याला [`qau-stealth-addresses` लायब्ररी](https://github.com/kassandraoftroy/qau-stealth-addresses) मधून आवश्यक असलेली फंक्शन्स.
...
[`generate_stealth_meta_address`](https://docs.rs/qau-stealth-addresses/latest/qau_stealth_addresses/fn.generate_stealth_meta_address.html) तीन फील्ड्स परत करते:
...
आपण लायब्ररीचे [`generate_stealth_address`](https://docs.rs/qau-stealth-addresses/latest/qau_stealth_addresses/fn.generate_stealth_address.html) वापरतो.
...
हे फंक्शन पत्त्यावरून पैसे काढण्यासाठी खाजगी की (*R<sub>priv</sub>*) ची गणना करण्यासाठी लायब्ररीचे [`compute_stealth_key`](https://docs.rs/qau-stealth-addresses/latest/qau_stealth_addresses/fn.compute_stealth_key.html) वापरते. या गणनेसाठी या मूल्यांची आवश्यकता आहे:
