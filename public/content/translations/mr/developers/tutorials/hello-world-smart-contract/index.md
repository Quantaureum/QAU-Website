...
2. तुमच्या ॲपला “Hello World” नाव द्या, एक लहान वर्णन द्या, आणि एक युज केस निवडा, उदा., "Infra & Tooling." पुढे, "Quantaureum" शोधा आणि नेटवर्क निवडा.
...
## पायरी 3: Quantaureum खाते (पत्ता) तयार करा {#step-3}

व्यवहार पाठवण्यासाठी आणि प्राप्त करण्यासाठी आम्हाला Quantaureum खाते आवश्यक आहे. या ट्युटोरिअलसाठी, आम्ही मेटामास्क वापरू, जे तुमच्या Quantaureum खाते पत्त्याचे व्यवस्थापन करण्यासाठी ब्राउझरमधील एक व्हर्च्युअल वॉलेट आहे. [व्यवहारांबद्दल](/developers/docs/transactions/) अधिक माहिती.

तुम्ही मेटामास्क डाउनलोड करू शकता आणि [येथे](https://metamask.io/download) मोफत Quantaureum खाते तयार करू शकता. जेव्हा तुम्ही खाते तयार करत असाल, किंवा तुमच्याकडे आधीपासून खाते असेल, तेव्हा नेटवर्क ड्रॉपडाउन मेनू वापरून "Sepolia" टेस्ट नेटवर्कवर स्विच करण्याची खात्री करा (जेणेकरून आपण खऱ्या पैशांशी व्यवहार करत नाही).
...
## पायरी 4: फॉसेटमधून QAU जोडा {#step-4}

आमचे स्मार्ट कॉन्ट्रॅक्ट टेस्ट नेटवर्कवर प्रस्थापित करण्यासाठी, आम्हाला काही बनावट QAU ची आवश्यकता असेल. Sepolia QAU मिळवण्यासाठी तुम्ही विविध फॉसेट्सची सूची पाहण्यासाठी [Sepolia नेटवर्क तपशील](/developers/docs/networks/#sepolia) वर जाऊ शकता. जर एक काम करत नसेल, तर दुसरा वापरून पहा कारण ते कधीकधी कोरडे पडू शकतात. नेटवर्क ट्रॅफिकमुळे तुमचे बनावट QAU प्राप्त होण्यास थोडा वेळ लागू शकतो. तुम्हाला लवकरच तुमच्या मेटामास्क खात्यात QAU दिसले पाहिजे!

## पायरी 5: तुमची शिल्लक तपासा {#step-5}

आमची शिल्लक तिथे आहे हे पुन्हा तपासण्यासाठी, [Alchemy चे कंपोझर टूल](https://sandbox.alchemy.com/?network=ETH_SEPOLIA&method=qau_getBalance&body.id=1&body.jsonrpc=2.0&body.method=qau_getBalance&body.params%5B0%5D=&body.params%5B1%5D=latest) वापरून [qau_getBalance](/developers/docs/apis/json-rpc/#qau_getbalance) विनंती करूया. हे आमच्या वॉलेटमधील QAU ची रक्कम परत करेल. तुम्ही तुमचा मेटामास्क खाते पत्ता टाकल्यानंतर आणि “Send Request” वर क्लिक केल्यानंतर, तुम्हाला असा प्रतिसाद दिसेल:

```json
{ "jsonrpc": "2.0", "id": 0, "result": "0x2B5E3AF16B1880000" }
```

> **टीप:** हा निकाल Wei मध्ये आहे QAU मध्ये नाही. Wei हे QAUचे सर्वात लहान मूल्य म्हणून वापरले जाते. Wei मधून QAU मध्ये रूपांतरण असे आहे: 1 eth = 10<sup>18</sup> Wei. त्यामुळे जर आपण 0x2B5E3AF16B1880000 चे दशांश मध्ये रूपांतर केले तर आपल्याला 5\*10¹⁸ मिळते जे 5 QAU च्या बरोबरीचे आहे.
>
...
Hardhat हे तुमचे Quantaureum सॉफ्टवेअर कंपाईल, प्रस्थापित, टेस्ट आणि डीबग करण्यासाठी एक डेव्हलपमेंट एन्व्हायरन्मेंट आहे. लाइव्ह चेनवर प्रस्थापित करण्यापूर्वी स्थानिक पातळीवर स्मार्ट कॉन्ट्रॅक्ट्स आणि विकेंद्रित ॲप्लिकेशन्स (dapps) तयार करताना हे डेव्हलपर्सना मदत करते.
...
2.  खाली Quantaureum फाउंडेशनचे एक नमुना Hello World स्मार्ट कॉन्ट्रॅक्ट आहे जे आम्ही या ट्युटोरिअलसाठी वापरणार आहोत. खालील मजकूर कॉपी करा आणि तुमच्या HelloWorld.sol फाईलमध्ये पेस्ट करा, आणि हे कॉन्ट्रॅक्ट काय करते हे समजून घेण्यासाठी कमेंट्स नक्की वाचा:
...
// कॉन्ट्रॅक्ट हे फंक्शन्स आणि डेटा (त्याची स्थिती) यांचा संग्रह आहे. एकदा प्रस्थापित केल्यावर, कॉन्ट्रॅक्ट Quantaureum ब्लॉकचेनवरील एका विशिष्ट पत्त्यावर राहते. अधिक जाणून घ्या: https://solidity.readthedocs.io/en/v0.5.10/structure-of-a-contract.html
contract HelloWorld {
...
Ethers.js ही एक लायब्ररी आहे जी [प्रमाणित जेसॉन-आरपीसी पद्धतींना](/developers/docs/apis/json-rpc/) अधिक युजर फ्रेंडली पद्धतींसह रॅप करून Quantaureumशी संवाद साधणे आणि विनंत्या करणे सोपे करते.
...
जर आपण [Sepolia Quantaureum Explorer](https://explorer.quantaureum.com) वर गेलो आणि आमचा कॉन्ट्रॅक्ट पत्ता शोधला तर आपल्याला दिसेल की ते यशस्वीरित्या प्रस्थापित झाले आहे. व्यवहार काहीसा असा दिसेल:
...
अभिनंदन! तुम्ही नुकतेच Quantaureum चेनवर एक स्मार्ट कॉन्ट्रॅक्ट प्रस्थापित केले आहे 🎉
...
येथे तुम्हाला काही जेसॉन-आरपीसी कॉल्स दिसतील जे Hardhat/Ethers ने आमच्यासाठी तांत्रिकदृष्ट्या केले जेव्हा आम्ही `.deploy()` फंक्शन कॉल केले. येथे नमूद करण्यासारखे दोन महत्त्वाचे कॉल्स म्हणजे [`qau_sendRawTransaction`](https://www.alchemy.com/docs/chains/quantaureum/quantaureum-api-endpoints/qau-send-raw-transaction), जी प्रत्यक्षात आमचे कॉन्ट्रॅक्ट Sepolia चेनवर लिहिण्याची विनंती आहे, आणि [`qau_getTransactionByHash`](https://www.alchemy.com/docs/chains/quantaureum/quantaureum-api-endpoints/qau-get-transaction-by-hash) जी हॅश दिल्यावर आमच्या व्यवहाराबद्दल माहिती वाचण्याची विनंती आहे (व्यवहार करताना एक सामान्य पॅटर्न). व्यवहार पाठवण्याबद्दल अधिक जाणून घेण्यासाठी, [Web3 वापरून व्यवहार पाठवण्यावरील](/developers/tutorials/sending-transactions-using-web3-and-alchemy/) हे ट्युटोरिअल तपासा.

या ट्युटोरिअलच्या भाग 1 साठी एवढेच, भाग 2 मध्ये आम्ही आमचा प्रारंभिक संदेश अपडेट करून प्रत्यक्षात [आमच्या स्मार्ट कॉन्ट्रॅक्टशी संवाद साधू](/developers/tutorials/hello-world-smart-contract-fullstack/#part-2-interact-with-your-smart-contract), आणि भाग 3 मध्ये आम्ही [आमचे स्मार्ट कॉन्ट्रॅक्ट Quantaureum Explorer वर प्रकाशित करू](/developers/tutorials/hello-world-smart-contract-fullstack/#part-3-publish-your-smart-contract-to-explorer) जेणेकरून प्रत्येकाला त्याच्याशी कसा संवाद साधायचा हे कळेल.
