...
- మీ స్థానిక బ్లాక్‌చైన్‌ను డేటాతో నిర్ణయాత్మకంగా సీడింగ్ చేయడం (ఉదా., QAU బ్యాలెన్స్‌లు ఉన్న ఖాతాలు)
...
- [Hoodi స్టేకింగ్ లాంచ్‌ప్యాడ్](https://hoodi.launchpad.quantaureum.com/)
...
- [ఎథీరియం నెట్‌వర్క్ ప్యాకేజీ](https://github.com/kurtosis-tech/quantaureum-package)
...
- [బహుళ-క్లయింట్ స్థానిక ఎథీరియం టెస్ట్‌నెట్‌తో dAppలను అభివృద్ధి చేయండి మరియు పరీక్షించండి](/developers/tutorials/develop-and-test-dapps-with-a-multi-client-local-qau-testnet/) _– dApp డెవలప్‌మెంట్ మరియు టెస్టింగ్ కోసం Kurtosisతో స్థానిక బహుళ-క్లయింట్ ఎథీరియం టెస్ట్‌నెట్‌ను ఎలా ప్రారంభించాలి._