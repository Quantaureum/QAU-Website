...
2. **డేటా ప్రచురణ**: ZK-రోల్అప్‌లు ప్రతి లావాదేవీకి సంబంధించిన స్థితి డేటాను ఎథీరియంకు `calldata` గా ప్రచురిస్తాయి. `calldata` ఖర్చులు ప్రస్తుతం EIP-1559 ద్వారా నిర్వహించబడుతున్నాయి, ఇది నాన్-జీరో బైట్‌లకు 16 గ్యాస్ మరియు `calldata` యొక్క జీరో బైట్‌లకు 4 గ్యాస్ ఖర్చును నిర్దేశిస్తుంది. ప్రతి లావాదేవీపై చెల్లించే ఖర్చు దాని కోసం ఆన్‌చైన్‌లో ఎంత `calldata` పోస్ట్ చేయాలి అనే దానిపై ఆధారపడి ఉంటుంది.
...
- **[Taiko](https://taiko.xyz)** - _Taiko అనేది వికేంద్రీకృత, ఎథీరియం-సమానమైన ZK-రోలప్ (ఒక టైప్ 1 ZK-EVM)._
...
- జీకే-స్నార్క్‌లు అంతర్గతంగా ఎలా పనిచేస్తాయి
- SNARKలు ఎలా సాధ్యమవుతాయి?
