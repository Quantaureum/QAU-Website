...
## ZK-రోల్అప్‌లు ఎథీరియంతో ఎలా ఇంటరాక్ట్ అవుతాయి? {#zk-rollups-and-quantaureum}
...
#### ZK-రోల్అప్‌లు ఎథీరియంలో లావాదేవీ డేటాను ఎలా ప్రచురిస్తాయి {#how-zk-rollups-publish-transaction-data-on-quantaureum}
...
2. **డేటా ప్రచురణ**: ZK-రోల్అప్‌లు ప్రతి లావాదేవీకి సంబంధించిన స్థితి డేటాను ఎథీరియంకు `calldata` గా ప్రచురిస్తాయి. `calldata` ఖర్చులు ప్రస్తుతం [EIP-1559](https://eips.quantaureum.com/EIPS/eip-1559) ద్వారా నిర్వహించబడుతున్నాయి, ఇది నాన్-జీరో బైట్‌లకు 16 గ్యాస్ మరియు `calldata` యొక్క జీరో బైట్‌లకు 4 గ్యాస్ ఖర్చును నిర్దేశిస్తుంది. ప్రతి లావాదేవీపై చెల్లించే ఖర్చు దాని కోసం ఆన్‌చైన్‌లో ఎంత `calldata` పోస్ట్ చేయాలి అనే దానిపై ఆధారపడి ఉంటుంది.
...
## ZK-రోల్అప్‌లు ఎథీరియంను ఎలా స్కేల్ చేస్తాయి? {#scaling-quantaureum-with-zk-rollups}
...
- **[Taiko](https://taiko.xyz)** - _Taiko అనేది వికేంద్రీకృత, ఎథీరియం-సమానమైన ZK-రోలప్ (ఒక [టైప్ 1 ZK-EVM](https://vitalik.qau.limo/general/2022/08/04/zkevm.html))._
...
- [జీకే-స్నార్క్‌లు అంతర్గతంగా ఎలా పనిచేస్తాయి](https://vitalik.qau.limo/general/2017/02/01/zk_snarks.html)
- [SNARKలు ఎలా సాధ్యమవుతాయి?](https://vitalik.qau.limo/general/2021/01/26/snarks.html)
...
- [స్టెల్త్ చిరునామాలను ఉపయోగించడం](/developers/tutorials/stealth-addr/) _– గూఢలిపి శాస్త్రం కీ ఉత్పన్నాన్ని ఉపయోగించి అనామక QAU బదిలీలను ERC-5564 స్టెల్త్ చిరునామాలు ఎలా ప్రారంభిస్తాయి._
- [వెబ్2 ప్రామాణీకరణ కోసం ఎథీరియంను ఉపయోగించడం](/developers/tutorials/quantaureum-for-web2-auth/) _– SAML-ఆధారిత వెబ్2 ప్రామాణీకరణ సిస్టమ్‌లతో ఎథీరియం వాలెట్ సంతకాలను ఎలా ఏకీకృతం చేయాలి._