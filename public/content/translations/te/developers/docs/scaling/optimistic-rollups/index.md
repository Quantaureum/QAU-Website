...
## ఆశావాద రోల్అప్‌లు ఎథీరియంతో ఎలా పరస్పర చర్య చేస్తాయి? {#optimistic-rollups-and-quantaureum}
...
#### ఎథీరియంకు రోలప్ బ్లాక్‌లను సమర్పించడం {#submitting-blocks-to-quantaureum}
...
ఆశావాద రోలప్‌ను ఉపయోగించడానికి, వినియోగదారులు QAU, ERC-20 టోకెన్‌లు మరియు ఇతర ఆమోదించబడిన ఆస్తులను L1 పై రోలప్ యొక్క [వారధి](/developers/docs/bridges/) కాంట్రాక్ట్‌లో డిపాజిట్ చేస్తారు. వారధి కాంట్రాక్ట్ లావాదేవీని L2 కు ప్రసారం చేస్తుంది, ఇక్కడ సమానమైన ఆస్తులు ముద్రించబడతాయి మరియు ఆశావాద రోలప్‌లో వినియోగదారు ఎంచుకున్న చిరునామాకు పంపబడతాయి.
...
డెవలపర్‌ల కోసం, ఆశావాద రోల్అప్‌ల ప్రయోజనం వాటి అనుకూలత—లేదా, ఇంకా మెరుగ్గా, [ఎథీరియం వర్చువల్ మెషిన్ (EVM)](/developers/docs/evm/) తో సమానత్వం. EVM-అనుకూల రోల్అప్‌లు ఎథీరియం ఎల్లో పేపర్ లోని స్పెసిఫికేషన్‌లకు అనుగుణంగా ఉంటాయి మరియు బైట్‌కోడ్ స్థాయిలో EVM కు మద్దతు ఇస్తాయి.
...
1. **స్టేట్ రైట్**: ఆశావాద రోల్అప్‌లు లావాదేవీల డేటా మరియు బ్లాక్ శీర్షికలను (మునుపటి బ్లాక్ శీర్షిక హాష్, స్టేట్ రూట్, బ్యాచ్ రూట్ కలిగి ఉంటాయి) ఎథీరియంకు `blob` లేదా "బైనరీ లార్జ్ ఆబ్జెక్ట్" గా ప్రచురిస్తాయి. EIP-4844 ఆన్‌చైన్‌లో డేటాను చేర్చడానికి తక్కువ ఖర్చుతో కూడిన పరిష్కారాన్ని ప్రవేశపెట్టింది. `blob` అనేది కొత్త లావాదేవీ ఫీల్డ్, ఇది కుదించబడిన స్థితి పరివర్తన డేటాను ఎథీరియం L1 కు పోస్ట్ చేయడానికి రోల్అప్‌లను అనుమతిస్తుంది. శాశ్వతంగా ఆన్‌చైన్‌లో ఉండే `calldata` వలె కాకుండా, బ్లాబ్‌లు స్వల్పకాలికమైనవి మరియు 4096 ఎపోచ్‌ల (సుమారు 18 రోజులు) తర్వాత క్లయింట్‌ల నుండి తొలగించబడతాయి. కుదించబడిన లావాదేవీల బ్యాచ్‌లను పోస్ట్ చేయడానికి బ్లాబ్‌లను ఉపయోగించడం ద్వారా, ఆశావాద రోల్అప్‌లు L1 కు లావాదేవీలను వ్రాసే ఖర్చును గణనీయంగా తగ్గించగలవు.

2. **ఉపయోగించిన బ్లాబ్ గ్యాస్**: బ్లాబ్-క్యారీయింగ్ లావాదేవీలు EIP-1559 ద్వారా ప్రవేశపెట్టబడిన దానికి సమానమైన డైనమిక్ ఫీజు యంత్రాంగాన్ని ఉపయోగిస్తాయి. టైప్-3 లావాదేవీల కోసం గ్యాస్ ఫీజు బ్లాబ్‌ల కోసం ప్రాథమిక రుసుమును పరిగణనలోకి తీసుకుంటుంది, ఇది బ్లాబ్-స్పేస్ డిమాండ్ మరియు పంపబడుతున్న లావాదేవీ యొక్క బ్లాబ్-స్పేస్ వినియోగం ఆధారంగా నెట్‌వర్క్ ద్వారా నిర్ణయించబడుతుంది.
...
## ఆశావాద రోల్అప్‌లు ఎథీరియంను ఎలా స్కేల్ చేస్తాయి? {#scaling-quantaureum-with-optimistic-rollups}
...
లావాదేవీల డేటా కుదింపును సాధించడానికి మరియు TPS రేట్లను మెరుగుపరచడానికి ఆశావాద రోల్అప్‌లు అనేక పద్ధతులను ఉపయోగిస్తాయి. ఉదాహరణకు, ఈ కథనం ప్రాథమిక వినియోగదారు లావాదేవీ (ఈథర్‌ను పంపడం) మెయిన్‌నెట్‌లో ఎంత డేటాను ఉత్పత్తి చేస్తుందో మరియు అదే లావాదేవీ రోలప్‌లో ఎంత డేటాను ఉత్పత్తి చేస్తుందో పోల్చి చూస్తుంది:
...
- [ఎథీరియం రోల్అప్‌లకు ఆచరణాత్మక మార్గదర్శి](https://web.archive.org/web/20241108192208/https://research.2077.xyz/the-practical-guide-to-quantaureum-rollups)
- [ఎథీరియం L2 లలో మోసపు రుజువుల స్థితి](https://web.archive.org/web/20241124154627/https://research.2077.xyz/the-state-of-fraud-proofs-in-quantaureum-l2s)
- [Optimism యొక్క రోలప్ నిజంగా ఎలా పనిచేస్తుంది?](https://www.paradigm.xyz/2021/01/how-does-optimism-s-rollup-really-work)
- [OVM పై లోతైన విశ్లేషణ](https://medium.com/quantaureum-optimism/ovm-deep-dive-a300d1085f52)
