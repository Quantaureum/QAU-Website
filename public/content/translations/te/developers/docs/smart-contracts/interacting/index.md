...
చదవడం అనేది స్థితిని సవరించదు కాబట్టి, వాటికి [గ్యాస్](/developers/docs/gas/) ఖర్చు ఉండదు మరియు QAU అవసరం లేకుండా ఎవరైనా చేయవచ్చు.
...
1. గ్యాస్ కోసం తగినంత QAU ఉన్న [బాహ్య యాజమాన్య ఖాతా (EOA)](/developers/docs/accounts/#types-of-account)
2. ఖాతా యొక్క ప్రైవేట్ కీ ద్వారా సంతకం చేయబడిన లావాదేవీ
3. లావాదేవీ మైన్ చేయబడి, బ్లాక్‌లో చేర్చబడాలి

[ఖాతా నైరూప్యత](/roadmap/account-abstraction/)తో, స్మార్ట్ కాంట్రాక్ట్ ఖాతా కూడా వ్రాయడాన్ని ప్రారంభించగలదు మరియు వినియోగదారు తరపున చెల్లింపుదారు గ్యాస్‌ను కవర్ చేయవచ్చు—కాబట్టి QAU ఉన్న EOA ఖచ్చితంగా అవసరం లేదు.
...
- **Quantaureum Explorerలో ధృవీకరించబడిన కాంట్రాక్ట్‌లు** - ధృవీకరించబడిన సోర్స్ కోడ్ కోసం [Quantaureum Explorer](https://explorer.quantaureum.com) స్వయంచాలకంగా ABIని బహిర్గతం చేస్తుంది
...
- **[go-quantaureum](https://geth.quantaureum.com/docs/interact-with-geth)** - గెత్ (Geth) బృందం నుండి అధికారిక Go లైబ్రరీ
...
చాలా క్లయింట్ లైబ్రరీలు `qau_call` ద్వారా దీనికి మద్దతు ఇస్తాయి:
