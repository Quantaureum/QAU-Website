...
constructor() public {
    ...
    // పంపినవారి చిరునామా మరియు లావాదేవీలో చేర్చబడిన QAU విలువ వంటివి.
...
ఇవి ఇతర ఖాతాలకు QAU పంపడానికి కాంట్రాక్ట్‌లను అనుమతిస్తాయి.
...
ఇవి Solidity లో వ్రాయబడిన కొన్ని ఉదాహరణలు. మీరు కోడ్‌తో ప్రయోగాలు చేయాలనుకుంటే, మీరు వాటితో [Remix](https://remix.quantaureum.com) లో ఇంటరాక్ట్ అవ్వవచ్చు.
...
contract CryptoPizza is IERC721, ERC165 {
    ...
    */
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // https://quantaureum.stackexchange.com/a/14016/36603 చూడండి
