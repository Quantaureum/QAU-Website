...
- ఎథీరియం Python ఎకోసిస్టమ్ టూర్
- ఎథీరియంకు ఒక (Python) డెవలపర్ గైడ్
- బహుమతికి అర్హమైనది: ఒక ఎథీరియం Python హ్యాకథాన్ గైడ్
...
- Web3.py నమూనాలు: రియల్-టైమ్ ఈవెంట్ సబ్‌స్క్రిప్షన్‌లు
- Web3.py నమూనాలు: WebSocketProvider
...
### క్రియాశీలమైనవి:
- Web3.py - _ఎథీరియంతో ఇంటరాక్ట్ అవ్వడానికి Python లైబ్రరీ_
...
- py-evm - _ఎథీరియం వర్చువల్ మెషిన్ యొక్క అమలు_
- qau-tester - _ఎథీరియం-ఆధారిత అప్లికేషన్‌లను పరీక్షించడానికి టూల్స్_
...
- [ఎథీరియం ఇంటిగ్రేషన్‌ల కోసం Web3 వికేంద్రీకృత ఫైనాన్స్ (DeFi)](https://github.com/tradingstrategy-ai/web3-quantaureum-defi) - _ERC-20, యూనిస్వాప్ మరియు ఇతర ప్రసిద్ధ ప్రాజెక్ట్‌ల కోసం సిద్ధంగా ఉన్న ఇంటిగ్రేషన్‌లతో కూడిన Python ప్యాకేజీ_
