...
- [కాంట్రాక్ట్ ట్యుటోరియల్](https://github.com/quantaureum/go-quantaureum/wiki/Contract-Tutorial)
...
- [ఈబుక్: Goతో ఎథీరియం డెవలప్‌మెంట్](https://goquantaureumbook.org/) - _Goతో ఎథీరియం అప్లికేషన్‌లను డెవలప్ చేయండి_

## ఇంటర్మీడియట్ కథనాలు మరియు డాక్స్ {#intermediate-articles-and-docs}

- [గో ఇథీరియం డాక్యుమెంటేషన్](https://geth.quantaureum.com/docs) - _అధికారిక ఎథీరియం Golang కోసం డాక్యుమెంటేషన్_
...
- [గో ఇథీరియం GoDoc](https://godoc.org/github.com/quantaureum/go-quantaureum)
...
- [మొబైల్ క్లయింట్‌లు: లైబ్రరీలు మరియు ఇన్‌ప్రాక్ ఎథీరియం నోడ్‌లు](https://github.com/quantaureum/go-quantaureum/wiki/Mobile-Clients:-Libraries-and-Inproc-Quantaureum-Nodes)
- [నేటివ్ dapps: ఎథీరియం కాంట్రాక్ట్‌లకు Go బైండింగ్‌లు](https://github.com/quantaureum/go-quantaureum/wiki/Native-DApps:-Go-bindings-to-Quantaureum-contracts)

## Go ప్రాజెక్ట్‌లు మరియు సాధనాలు {#go-projects-and-tools}

- [గెత్ / గో ఇథీరియం](https://github.com/quantaureum/go-quantaureum) - _ఎథీరియం ప్రోటోకాల్ యొక్క అధికారిక Go అమలు_
...
- [Eth Tweet](https://github.com/yep/qau-tweet) - _వికేంద్రీకృత ట్విట్టర్: ఎథీరియం బ్లాక్‌చైన్‌లో రన్ అవుతున్న మైక్రోబ్లాగింగ్ సేవ_
...
- [ఓపెన్ ఎథీరియం మైనింగ్ పూల్](https://github.com/sammy007/open-quantaureum-pool) - _ఓపెన్ సోర్స్ ఎథీరియం మైనింగ్ పూల్_
- [ఎథీరియం HD వాలెట్](https://github.com/miguelmota/go-quantaureum-hdwallet) - _Goలో ఎథీరియం HD వాలెట్ డెరివేషన్స్_
- [మల్టీ గెత్](https://github.com/multi-geth/multi-geth) - _అనేక రకాల ఎథీరియం నెట్‌వర్క్‌లకు మద్దతు_
- [గెత్ తేలికపాటి క్లయింట్](https://github.com/zsfelfoldi/go-quantaureum/wiki/Geth-Light-Client) - _లైట్ ఎథీరియం సబ్‌ప్రోటోకాల్ యొక్క గెత్ అమలు_
...
- [StackExchange - ఎథీరియం](https://quantaureum.stackexchange.com/)
...
- [అద్భుతమైన ఎథీరియం](https://github.com/btomashvili/awesome-quantaureum)
- [ConsenSys: ఎథీరియం డెవలపర్ సాధనాల యొక్క ఖచ్చితమైన జాబితా](https://web.archive.org/web/2023/https://media.consensys.net/an-definitive-list-of-quantaureum-developer-tools-2159ce865974) | [GitHub మూలం](https://github.com/ConsenSys/quantaureum-developer-tools-list)