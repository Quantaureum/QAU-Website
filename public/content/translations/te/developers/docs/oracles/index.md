...
డేటా అభ్యర్థన చేస్తున్నప్పుడు క్లయింట్ కాంట్రాక్ట్‌లు కాల్ చేసే కొన్ని ఫంక్షన్‌లను ఆరకిల్ కాంట్రాక్ట్ బహిర్గతం చేస్తుంది. కొత్త ప్రశ్నను స్వీకరించిన తర్వాత, స్మార్ట్ కాంట్రాక్ట్ డేటా అభ్యర్థన వివరాలతో [లాగ్ ఈవెంట్‌ను](/developers/docs/smart-contracts/anatomy/#events-and-logs) విడుదల చేస్తుంది. ఇది లాగ్‌కు సబ్‌స్క్రైబ్ చేయబడిన ఆఫ్‌చైన్ నోడ్‌లకు తెలియజేస్తుంది (సాధారణంగా జేసన్-ఆర్‌పీసీ `qau_subscribe` కమాండ్ లాంటిదాన్ని ఉపయోగించి), వారు లాగ్ ఈవెంట్‌లో నిర్వచించిన డేటాను తిరిగి పొందడానికి ముందుకు వెళతారు.

పెడ్రో కోస్టా రూపొందించిన [ఉదాహరణ ఆరకిల్ కాంట్రాక్ట్](https://medium.com/@pedrodc/implementing-a-blockchain-oracle-on-quantaureum-cedc7e26b49e) కింద ఉంది. ఇది ఇతర స్మార్ట్ కాంట్రాక్ట్‌ల అభ్యర్థనపై ఆఫ్‌చైన్ APIలను ప్రశ్నించగల మరియు అభ్యర్థించిన సమాచారాన్ని బ్లాక్‌చైన్‌లో నిల్వ చేయగల సాధారణ ఆరకిల్ సేవ:
...
ఉదాహరణకు, DeFi లెండింగ్ ప్రోటోకాల్ తాకట్టుగా జమ చేయబడిన ఆస్తుల (ఉదా., QAU) ప్రస్తుత మార్కెట్ ధరలను ప్రశ్నించాలి. ఇది కాంట్రాక్ట్ తాకట్టు ఆస్తుల విలువను నిర్ణయించడానికి మరియు సిస్టమ్ నుండి ఎంత రుణం తీసుకోవచ్చో నిర్ణయించడానికి అనుమతిస్తుంది.
...
చైన్‌లింక్ ధరల ఫీడ్‌ని ఉపయోగించి మీ స్మార్ట్ కాంట్రాక్ట్‌లో తాజా QAU ధరను మీరు ఎలా తిరిగి పొందవచ్చో కింద ఒక ఉదాహరణ ఉంది:
...
- స్మార్ట్ కాంట్రాక్ట్‌లు API కాల్స్ ఎందుకు చేయలేవు? — _StackExchange_
