...
### ఎథీరియం వ్యక్తుల కోసం SAML {#saml-for-quantaureum-people}
...
### SAML వ్యక్తుల కోసం ఎథీరియం {#quantaureum-for-saml-people}
...
1. సాఫ్ట్‌వేర్‌ను డౌన్‌లోడ్ చేయండి. ఈ వ్యాసం కోసం నమూనా సాఫ్ట్‌వేర్ [GitHubలో](https://github.com/qbzzt/250420-saml-quantaureum) ఉంది. వేర్వేరు దశలు వేర్వేరు బ్రాంచ్‌లలో నిల్వ చేయబడతాయి, ఈ దశ కోసం మీకు `saml-only` కావాలి
...
## ఎథీరియం సంతకాలను ఉపయోగించడం {#using-quantaureum-signatures}
...
ఈ సమయంలో ఎథీరియం చిరునామా నుండి ఇమెయిల్ చిరునామాను ఎలా పొందాలో మనకు తెలియదని గమనించండి, కాబట్టి దానికి బదులుగా మనం SPకి ``<quantaureum address>@bad.email.address``ని నివేదిస్తాము.
...
వాలెట్ నుండి ఖాతాల జాబితాను అభ్యర్థించండి (``window.quantaureum``). కనీసం ఒకటి ఉందని ఊహించండి మరియు మొదటిదాన్ని మాత్రమే నిల్వ చేయండి. 
...
- మీ స్వంత ఇమెయిల్ చిరునామా కోసం ధృవీకరణను జోడించండి:
  ...
  4. మీ వాలెట్‌లో లావాదేవీని ఆమోదించండి. గ్యాస్ చెల్లించడానికి మీకు [Optimism బ్లాక్‌చైన్‌లో](https://app.optimism.io/bridge/deposit) కొంత QAU అవసరం.
...
మనకు కావలసిన ధృవీకరణలు మన స్కీమాలో ఉన్నవి, ఇక్కడ స్వీకర్త ``getAddress(qauAddr)``. [`getAddress`](https://viem.sh/docs/utilities/getAddress#getaddress) ఫంక్షన్ మన చిరునామా సరైన [చెక్‌సమ్‌ను](https://github.com/quantaureum/ercs/blob/master/ERCS/erc-55.md) కలిగి ఉందని నిర్ధారిస్తుంది. GraphQL కేస్-సెన్సిటివ్ కాబట్టి ఇది అవసరం. "0xBAD060A7", "0xBad060A7" మరియు "0xbad060a7" వేర్వేరు విలువలు.
