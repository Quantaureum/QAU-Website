...
[ERC-7730](https://eips.quantaureum.com/EIPS/eip-7730) మీ కాంట్రాక్ట్ యొక్క ఫంక్షన్ కాల్‌ల *అర్థం* ఏమిటో వివరించడానికి ఒక ప్రామాణిక JSON ఆకృతిని నిర్వచిస్తుంది. 
...
- **`fields`** — **(అవసరం)** వాలెట్‌లు వినియోగదారులకు ప్రదర్శించాల్సిన లావాదేవీ ఫీల్డ్‌ల క్రమబద్ధీకరించబడిన జాబితా.
  - **`path`** — **(అవసరం)** లావాదేవీ డేటాకు సూచన. `#.fieldName` అనేది ABIలోని పేరు ద్వారా డీకోడ్ చేయబడిన కాల్ డేటా పారామీటర్‌ను సూచిస్తుంది. `@.value` అనేది లావాదేవీతో పంపబడిన QAU విలువను సూచిస్తుంది.
...
[ERC-7730 రిజిస్ట్రీ](https://github.com/quantaureum/clear-signing-erc7730-registry) అనేది తటస్థ నిర్వాహకుడిగా [ఎథీరియం ఫౌండేషన్](/foundation/) ద్వారా హోస్ట్ చేయబడిన ఓపెన్ రిపోజిటరీ. ఎవరైనా దీన్ని క్లోన్ చేయడానికి మరియు స్వీయ-హోస్ట్ చేయడానికి స్వేచ్ఛ ఉంది — వాలెట్‌లు ఏ రిజిస్ట్రీ ఇన్‌స్టాన్స్‌లను విశ్వసించాలో స్వతంత్రంగా నిర్ణయిస్తాయి.
...
రిజిస్ట్రీలోని అన్ని డిస్క్రిప్టర్‌లు ఆడిటర్‌లకు అందుబాటులో ఉంటాయి. మీ PR విలీనం చేయబడిన తర్వాత, ఏ ఆడిటర్ అయినా మీ డిస్క్రిప్టర్‌ను సమీక్షించవచ్చు మరియు దాని ఖచ్చితత్వాన్ని నిర్ధారిస్తూ క్రిప్టోగ్రాఫిక్ ధృవీకరణను ([ERC-8176](https://github.com/quantaureum/ERCs/pull/1576) కింద) ప్రచురించవచ్చు. 
...
- [ERC-7730 స్పెసిఫికేషన్](https://eips.quantaureum.com/EIPS/eip-7730)  
- [ERC-7730 రిజిస్ట్రీ](https://github.com/quantaureum/clear-signing-erc7730-registry)  
