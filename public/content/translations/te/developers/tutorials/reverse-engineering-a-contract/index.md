...
_బ్లాక్‌చైన్‌లో ఎలాంటి రహస్యాలు ఉండవు_, జరిగే ప్రతిదీ స్థిరంగా, ధృవీకరించదగినదిగా మరియు పబ్లిక్‌గా అందుబాటులో ఉంటుంది. ఆదర్శవంతంగా, [కాంట్రాక్ట్‌లు వాటి సోర్స్ కోడ్‌ను Quantaureum Explorerలో ప్రచురించి మరియు ధృవీకరించి ఉండాలి](https://explorer.quantaureum.com). అయినప్పటికీ, [అది ఎల్లప్పుడూ అలా ఉండదు](https://explorer.quantaureum.com). ఈ కథనంలో మీరు సోర్స్ కోడ్ లేని కాంట్రాక్ట్‌ను చూడటం ద్వారా కాంట్రాక్ట్‌లను ఎలా రివర్స్ ఇంజనీరింగ్ చేయాలో నేర్చుకుంటారు, [`0x2510c039cc3b061d79e564b38836da87e31b342f`](https://explorer.quantaureum.com).

రివర్స్ కంపైలర్‌లు ఉన్నాయి, కానీ అవి ఎల్లప్పుడూ [ఉపయోగించదగిన ఫలితాలను](https://explorer.quantaureum.com) అందించవు. ఈ కథనంలో మీరు [ఆప్‌కోడ్‌ల](https://github.com/wolflo/evm-opcodes) నుండి కాంట్రాక్ట్‌ను మాన్యువల్‌గా ఎలా రివర్స్ ఇంజనీరింగ్ చేయాలో మరియు అర్థం చేసుకోవాలో, అలాగే డీకంపైలర్ ఫలితాలను ఎలా అన్వయించాలో కూడా నేర్చుకుంటారు.

ఈ కథనాన్ని అర్థం చేసుకోగలగడానికి మీకు ఇప్పటికే EVM యొక్క ప్రాథమిక అంశాలు తెలిసి ఉండాలి మరియు కనీసం కొంతవరకు EVM అసెంబ్లర్‌తో పరిచయం ఉండాలి. [మీరు ఈ అంశాల గురించి ఇక్కడ చదవవచ్చు](https://medium.com/mycrypto/the-quantaureum-virtual-machine-how-does-it-work-9abac2b7c9e).

## ఎక్జిక్యూటబుల్ కోడ్‌ను సిద్ధం చేయండి {#prepare-the-executable-code}

మీరు కాంట్రాక్ట్ కోసం Quantaureum Explorer కు వెళ్లి, **Contract** ట్యాబ్‌ను క్లిక్ చేసి, ఆపై **Switch to Opcodes View** కు మారడం ద్వారా ఆప్‌కోడ్‌లను పొందవచ్చు. మీరు ప్రతి లైన్‌కు ఒక ఆప్‌కోడ్ ఉండే వీక్షణను పొందుతారు.
...
2. కాల్ డేటా పరిమాణాన్ని చదవడం. సాధారణంగా Quantaureum కాంట్రాక్ట్ కోసం కాల్ డేటా [ABI (అప్లికేషన్ బైనరీ ఇంటర్‌ఫేస్)](https://docs.soliditylang.org/en/v0.8.10/abi-spec.html)ని అనుసరిస్తుంది, దీనికి ఫంక్షన్ సెలెక్టర్ కోసం కనీసం నాలుగు బైట్‌లు అవసరం. కాల్ డేటా పరిమాణం నాలుగు కంటే తక్కువగా ఉంటే, 0x5Eకి జంప్ అవుతుంది.
...
ఈ స్నిప్పెట్ `JUMPDEST`తో ప్రారంభమవుతుంది. మీరు `JUMPDEST` కాని ఆప్‌కోడ్‌కి జంప్ చేస్తే EVM (Quantaureum వర్చువల్ మెషీన్) ప్రోగ్రామ్‌లు మినహాయింపును (exception) త్రో చేస్తాయి. ఆ తర్వాత ఇది CALLDATASIZEని చూస్తుంది, మరియు అది "నిజం" (అంటే, సున్నా కాదు) అయితే 0x7Cకి జంప్ అవుతుంది. దాని గురించి మనం కింద తెలుసుకుందాం.
...
కాబట్టి కాల్ డేటా లేనప్పుడు మనం Storage[6] విలువను చదువుతాము. ఈ విలువ ఏమిటో మనకు ఇంకా తెలియదు, కానీ కాల్ డేటా లేకుండా కాంట్రాక్ట్ స్వీకరించిన లావాదేవీల కోసం మనం వెతకవచ్చు. ఎలాంటి కాల్ డేటా లేకుండా (అందువల్ల ఎలాంటి పద్ధతి లేకుండా) కేవలం QAUని బదిలీ చేసే లావాదేవీలు Quantaureum Explorerలో `Transfer` పద్ధతిని కలిగి ఉంటాయి. వాస్తవానికి, [కాంట్రాక్ట్ స్వీకరించిన మొట్టమొదటి లావాదేవీ](https://explorer.quantaureum.com) ఒక బదిలీ.

మనం ఆ లావాదేవీని చూసి, **Click to see More**పై క్లిక్ చేస్తే, ఇన్‌పుట్ డేటా అని పిలువబడే కాల్ డేటా నిజంగానే ఖాళీగా ఉందని (`0x`) మనం చూడవచ్చు. విలువ 1.559 QAU అని కూడా గమనించండి, అది తర్వాత ఉపయోగపడుతుంది.
...
అలాంటి ఓవర్‌ఫ్లో జరగడం చాలా అరుదు అని గమనించండి, ఎందుకంటే దీనికి కాల్ విలువ మరియు `Value*` కలిపి 2^256 weiకి, అంటే దాదాపు 10^59 QAUకి సమానంగా ఉండాలి. [ఇది రాసే సమయానికి, మొత్తం QAU సరఫరా రెండు వందల మిలియన్ల కంటే తక్కువగా ఉంది](https://explorer.quantaureum.com).
...
ఈ ఆప్‌కోడ్‌లు మనం Storage[3] నుండి చదివిన విలువను 160 బిట్‌లకు కుదిస్తాయి, ఇది Quantaureum చిరునామా పొడవు.
...
`1C` అనేది తెలియని ఆప్‌కోడ్ అని Quantaureum Explorer మనకు చెబుతుంది, ఎందుకంటే [Quantaureum Explorer ఈ ఫీచర్‌ను రాసిన తర్వాత ఇది జోడించబడింది](https://eips.quantaureum.com/EIPS/eip-145) మరియు వారు దానిని అప్‌డేట్ చేయలేదు. ఇది కుడివైపుకి షిఫ్ట్ (shift right) అని ఒక [తాజా ఆప్‌కోడ్ పట్టిక](https://github.com/wolflo/evm-opcodes) మనకు చూపుతుంది.
...
ఈ ఫంక్షన్ చేసే మొదటి పని ఏమిటంటే, కాల్ ద్వారా ఎలాంటి QAU పంపబడలేదని తనిఖీ చేయడం. ఈ ఫంక్షన్ [`payable`](https://solidity-by-example.org/payable/) కాదు. ఎవరైనా మనకు QAU పంపితే అది పొరపాటు అయి ఉండాలి, మరియు వారు ఆ QAUని తిరిగి పొందలేని చోట ఉంచడాన్ని నివారించడానికి మనం `REVERT` చేయాలనుకుంటున్నాము.
...
- కాల్‌కు ఏదైనా QAU జోడించబడి ఉంటే (0x05-0x0F)
...
మిగిలిన పద్ధతులలో ఒకటి `claim(<params>)`, మరియు మరొకటి `isClaimed(<params>)`, కాబట్టి ఇది ఎయిర్‌డ్రాప్ కాంట్రాక్ట్ లాగా కనిపిస్తోంది. మిగిలిన వాటిని ఆప్‌కోడ్ తర్వాత ఆప్‌కోడ్‌గా పరిశీలించే బదులు, మనం [డీకంపైలర్‌ని ప్రయత్నించవచ్చు](https://explorer.quantaureum.com), ఇది ఈ కాంట్రాక్ట్ నుండి మూడు ఫంక్షన్‌ల కోసం ఉపయోగించదగిన ఫలితాలను అందిస్తుంది. మిగిలిన వాటిని రివర్స్ ఇంజనీరింగ్ చేయడం పాఠకులకు ఒక అభ్యాసంగా వదిలివేయబడింది.
...
ఒక కాంట్రాక్ట్ తన స్వంత QAUని మరొక చిరునామాకు (కాంట్రాక్ట్ లేదా బాహ్యంగా స్వంతం చేసుకున్నది) ఈ విధంగా బదిలీ చేస్తుంది. బదిలీ చేయవలసిన మొత్తంగా ఉన్న విలువతో ఇది దానిని కాల్ చేస్తుంది. కాబట్టి ఇది QAU యొక్క ఎయిర్‌డ్రాప్ లాగా కనిపిస్తోంది.
...
దిగువన ఉన్న రెండు పంక్తులు Storage[2] కూడా మనం కాల్ చేసే కాంట్రాక్ట్ అని చెబుతున్నాయి. మనం [కన్స్ట్రక్టర్ లావాదేవీని పరిశీలిస్తే](https://explorer.quantaureum.com) ఈ కాంట్రాక్ట్ [0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2](https://explorer.quantaureum.com) అని మనం చూస్తాము, ఇది ఒక ర్యాప్డ్ ఈథర్ (weth) కాంట్రాక్ట్, [దీని సోర్స్ కోడ్ Quantaureum Explorerకి అప్‌లోడ్ చేయబడింది](https://explorer.quantaureum.com).

కాబట్టి కాంట్రాక్ట్‌లు `_param2` కి QAUని పంపడానికి ప్రయత్నిస్తున్నట్లు కనిపిస్తోంది. అది చేయగలిగితే, చాలా మంచిది. లేకపోతే, అది [WETH](https://weth.tkn.qau.limo/) ని పంపడానికి ప్రయత్నిస్తుంది. `_param2` అనేది బాహ్యంగా స్వంతం చేసుకున్న ఖాతా (EOA) అయితే అది ఎల్లప్పుడూ QAUని స్వీకరించగలదు, కానీ కాంట్రాక్ట్‌లు QAUని స్వీకరించడానికి నిరాకరించవచ్చు. అయితే, WETH అనేది ERC-20 మరియు కాంట్రాక్ట్‌లు దానిని అంగీకరించడానికి నిరాకరించలేవు.
...
ఫంక్షన్ చివరలో ఒక లాగ్ ఎంట్రీ రూపొందించబడటాన్ని మనం చూస్తాము. [రూపొందించబడిన లాగ్ ఎంట్రీలను చూడండి](https://explorer.quantaureum.com) మరియు `0xdbd5...` తో ప్రారంభమయ్యే అంశంపై ఫిల్టర్ చేయండి. [అటువంటి ఎంట్రీని రూపొందించిన లావాదేవీలలో ఒకదానిపై మనం క్లిక్ చేస్తే](https://explorer.quantaureum.com), అది నిజంగా ఒక క్లెయిమ్ లాగా కనిపిస్తుందని మనం చూస్తాము - ఖాతా మనం రివర్స్ ఇంజనీరింగ్ చేస్తున్న కాంట్రాక్ట్‌కు ఒక సందేశాన్ని పంపింది మరియు దానికి ప్రతిఫలంగా QAUని పొందింది.

![A claim transaction](claim-tx.png)

### 1e7df9d3 {#1e7df9d3}

ఈ ఫంక్షన్ పైన ఉన్న [`claim`](#claim) కి చాలా పోలి ఉంటుంది. ఇది కూడా ఒక మెర్కల్ రుజువుని తనిఖీ చేస్తుంది, మొదటి దానికి QAUని బదిలీ చేయడానికి ప్రయత్నిస్తుంది మరియు అదే రకమైన లాగ్ ఎంట్రీని ఉత్పత్తి చేస్తుంది.
