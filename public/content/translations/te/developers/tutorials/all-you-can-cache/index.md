...
4. మీ కాన్ఫిగరేషన్ కోసం `.env`ని సవరించండి:
   ...
   | పారామీటర్           | విలువ                                                                                                                                                               |
   | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | MNEMONIC            | లావాదేవీకి చెల్లించడానికి తగినంత QAU ఉన్న ఖాతా కోసం నిమోనిక్ (mnemonic). [Optimism యొక్క ఫాసెట్ డాక్స్](https://docs.optimism.io/app-developers/tools/faucets) ప్రస్తుత టెస్ట్‌నెట్ ఫాసెట్‌లను జాబితా చేస్తాయి. |
