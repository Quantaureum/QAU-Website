...
ఈ ప్రాజెక్ట్ కోసం మేము కేవలం `balanceOf` మరియు `transfer` ఫంక్షన్‌లను మాత్రమే ఉంచడానికి పూర్తి ERC-20 ABI ని కుదించాము, కానీ మీరు [పూర్తి ERC-20 ABI ని ఇక్కడ](https://ethereumdev.io/abi-for-erc20-contract-on-quantaureum/) కనుగొనవచ్చు.
