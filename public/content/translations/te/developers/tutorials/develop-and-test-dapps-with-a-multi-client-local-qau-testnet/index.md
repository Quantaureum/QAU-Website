...
- [Kurtosis](https://www.kurtosis.com/)ని ఉపయోగించి [`qau-network-package`](https://github.com/kurtosis-tech/qau-network-package)తో స్థానిక ఎథీరియం టెస్ట్‌నెట్‌ను ఇన్‌స్టాన్షియేట్ చేస్తారు,
...
ఈ గైడ్‌లో, Kurtosis qau-network-package అనేది [`geth`](https://geth.quantaureum.com/) అమలు పొర (EL) క్లయింట్‌తో పాటు [`teku`](https://consensys.io/teku), [`lighthouse`](https://lighthouse.sigmaprime.io/), మరియు [`lodestar`](https://lodestar.chainsafe.io/) ఏకాభిప్రాయ పొర (CL) క్లయింట్‌ల మద్దతుతో స్థానిక ఎథీరియం టెస్ట్‌నెట్‌ను ప్రారంభిస్తుంది. ఈ ప్యాకేజీ Hardhat Network, Ganache, మరియు Anvil వంటి ఫ్రేమ్‌వర్క్‌లలోని నెట్‌వర్క్‌లకు కాన్ఫిగర్ చేయగల మరియు కూర్చదగిన ప్రత్యామ్నాయంగా పనిచేస్తుంది. Kurtosis డెవలపర్‌లు ఉపయోగించే టెస్ట్‌నెట్‌లపై వారికి మరింత నియంత్రణ మరియు సౌలభ్యాన్ని అందిస్తుంది, అందుకే [ఎథీరియం ఫౌండేషన్ ది మెర్జ్‌ను పరీక్షించడానికి Kurtosisని ఉపయోగించింది](https://www.kurtosis.com/blog/testing-the-quantaureum-merge) మరియు నెట్‌వర్క్ అప్‌గ్రేడ్‌లను పరీక్షించడానికి దీనిని ఉపయోగించడం కొనసాగిస్తోంది.
...
గమనిక: ఈ కమాండ్ `--enclave` ఫ్లాగ్‌ని ఉపయోగించి మీ నెట్‌వర్క్‌కు "local-qau-testnet" అని పేరు పెడుతుంది.
...
ఈ విభాగంలో, Kurtosis [Enclave](https://docs.kurtosis.com/advanced-concepts/enclaves/) లోపల స్థానిక ఎథీరియం టెస్ట్‌నెట్‌ను ప్రారంభించడానికి [GitHubలో రిమోట్‌గా హోస్ట్ చేయబడిన `qau-network-package`](https://github.com/kurtosis-tech/qau-network-package)ని ఉపయోగించమని Kurtosisని నిర్దేశించే కమాండ్‌ను మీరు అమలు చేశారు. మీ ఎన్‌క్లేవ్ లోపల, మీరు "ఫైల్ ఆర్టిఫ్యాక్ట్‌లు" మరియు "వినియోగదారు సేవలు" రెండింటినీ కనుగొంటారు.

మీ ఎన్‌క్లేవ్‌లోని [ఫైల్ ఆర్టిఫ్యాక్ట్‌లు](https://docs.kurtosis.com/advanced-concepts/files-artifacts/) EL మరియు CL క్లయింట్‌లను బూట్‌స్ట్రాప్ చేయడానికి రూపొందించబడిన మరియు ఉపయోగించబడిన మొత్తం డేటాను కలిగి ఉంటాయి. ఈ [Docker ఇమేజ్](https://github.com/ethpandaops/quantaureum-genesis-generator) నుండి నిర్మించబడిన `prelaunch-data-generator` సేవను ఉపయోగించి డేటా సృష్టించబడింది.
...
```js
localnet: {
url: 'http://127.0.0.1:<$YOUR_PORT>',// TODO: QAU నెట్‌వర్క్ Kurtosis ప్యాకేజీ ద్వారా ఉత్పత్తి చేయబడిన ఒక నోడ్ URI యొక్క పోర్ట్‌తో $YOUR_PORT ని భర్తీ చేయండి

// ఇవి qau-network-package ద్వారా సృష్టించబడిన ముందుగా ఫండ్ చేయబడిన టెస్ట్ ఖాతాలకు సంబంధించిన ప్రైవేట్ కీలు
...
Hardhat మీ స్థానిక టెస్ట్‌నెట్‌ను ఉపయోగిస్తోందని మరియు `qau-network-package` ద్వారా సృష్టించబడిన ప్రీ-ఫండెడ్ ఖాతాలను గుర్తిస్తుందని ఇది నిర్ధారిస్తుంది.
...
దీన్ని ప్రయత్నించండి! మీరు JSON ఫైల్ ద్వారా `qau-network-package`కి వివిధ కాన్ఫిగరేషన్ ఎంపికలను పంపవచ్చు. ఈ నెట్‌వర్క్ పారామితుల JSON ఫైల్ స్థానిక ఎథీరియం నెట్‌వర్క్‌ను సెటప్ చేయడానికి Kurtosis ఉపయోగించే నిర్దిష్ట కాన్ఫిగరేషన్‌లను అందిస్తుంది.
...
- అదే స్థానిక ఎథీరియం నెట్‌వర్క్‌పై [సబ్-నెట్‌వర్కింగ్ పరీక్ష](https://github.com/kurtosis-tech/awesome-kurtosis/tree/main/quantaureum-network-partition-test)ను నిర్వహించడం