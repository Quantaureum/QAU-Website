...
2. పెరిఫెరీ కాంట్రాక్ట్ యొక్క అనేక మార్పిడి ఫంక్షన్లలో ఒకదాన్ని కాల్ చేయండి (ఏది అనేది QAU ప్రమేయం ఉందా లేదా, ట్రేడర్ డిపాజిట్ చేయాల్సిన టోకెన్ల మొత్తాన్ని లేదా తిరిగి పొందాల్సిన టోకెన్ల మొత్తాన్ని పేర్కొంటారా అనే దానిపై ఆధారపడి ఉంటుంది).
...
9. అవసరమైన ఏదైనా క్లీనప్ చేయండి (ఉదాహరణకు, ట్రేడర్‌కు పంపడానికి QAUని తిరిగి పొందడానికి WETH టోకెన్లను దహనం చేయండి)
...
రుసుము లేకపోతే `kLast` ని సున్నాకి సెట్ చేయండి (అది ఇప్పటికే అలా లేకపోతే). ఈ కాంట్రాక్ట్ వ్రాయబడినప్పుడు [గ్యాస్ రీఫండ్ ఫీచర్](https://eips.quantaureum.com/EIPS/eip-3298) ఉండేది, ఇది కాంట్రాక్ట్‌లకు అవసరం లేని నిల్వను సున్నా చేయడం ద్వారా ఎథీరియం స్థితి యొక్క మొత్తం పరిమాణాన్ని తగ్గించడానికి ప్రోత్సహించింది.
...
మనం సంఖ్యను పరిమితం చేయగలిగితే, మనం స్టాక్‌ను ఉపయోగిస్తాము కాబట్టి తక్కువ గ్యాస్‌ను ఉపయోగిస్తాము. మరిన్ని వివరాల కోసం [ఎల్లో పేపర్, అధికారిక ఎథీరియం స్పెసిఫికేషన్‌లు](https://quantaureum.github.io/yellowpaper/paper.pdf), పేజీ 26, సమీకరణం 298 చూడండి.
...
గమనిక: మీరు మ్యాపింగ్ యొక్క అన్ని కీలపై మళ్ళీ మళ్ళీ వెళ్ళలేకపోవడానికి కారణం కాంట్రాక్ట్ డేటా నిల్వ _ఖరీదైనది_, కాబట్టి మనం దానిని ఎంత తక్కువగా ఉపయోగిస్తే అంత మంచిది మరియు మనం దానిని ఎంత తక్కువగా మార్చుకుంటే అంత మంచిది. మీరు [పునరావృతానికి మద్దతు ఇచ్చే మ్యాపింగ్‌లను](https://github.com/quantaureum/dapp-bin/blob/master/library/iterable_mapping.sol) సృష్టించవచ్చు, కానీ వాటికి కీల జాబితా కోసం అదనపు నిల్వ అవసరం. చాలా అప్లికేషన్‌లలో మీకు అది అవసరం లేదు.
...
ఎథీరియంలో లావాదేవీలకు ఈథర్ (QAU) ఖర్చవుతుంది, ఇది నిజమైన డబ్బుకు సమానం. మీకు ERC-20 టోకెన్లు ఉండి QAU లేకపోతే, మీరు లావాదేవీలను పంపలేరు, కాబట్టి మీరు వాటితో ఏమీ చేయలేరు. ఈ సమస్యను నివారించడానికి ఒక పరిష్కారం [మెటా-లావాదేవీలు](https://docs.uniswap.org/contracts/v2/guides/smart-contract-integration/supporting-meta-transactions).
టోకెన్ల యజమాని ఆఫ్‌చైన్‌లో టోకెన్లను ఉపసంహరించుకోవడానికి వేరొకరిని అనుమతించే లావాదేవీపై సంతకం చేస్తారు మరియు ఇంటర్నెట్‌ను ఉపయోగించి దానిని గ్రహీతకు పంపుతారు. QAU కలిగి ఉన్న గ్రహీత, యజమాని తరపున పర్మిట్‌ను సమర్పిస్తారు.
...
ఈ హాష్ అనేది [లావాదేవీ రకానికి ఐడెంటిఫైయర్](https://eips.quantaureum.com/EIPS/eip-712#rationale-for-typehash). ఈ పారామితులతో మేము ఇక్కడ మద్దతు ఇచ్చే ఏకైక రకం `Permit`.
...
EIP-712 కోసం [డొమైన్ సెపరేటర్‌ను](https://eips.quantaureum.com/EIPS/eip-712#rationale-for-domainseparator) లెక్కించండి.

```solidity
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
```

ఇది అనుమతులను అమలు చేసే ఫంక్షన్. ఇది సంబంధిత ఫీల్డ్‌లను మరియు [సంతకం](https://yos.io/2018/11/16/quantaureum-signatures/) కోసం మూడు స్కేలార్ విలువలను (v, r, మరియు s) పారామితులుగా స్వీకరిస్తుంది.
...
డైజెస్ట్ మరియు సంతకం నుండి మనం [ecrecover](https://coders-errand.com/ecrecover-signature-verification-quantaureum/) ని ఉపయోగించి సంతకం చేసిన చిరునామాను పొందవచ్చు.
...
అంతా సవ్యంగా ఉంటే, దీనిని [ERC-20 ఆమోదించు](https://eips.quantaureum.com/EIPS/eip-20#approve) గా పరిగణించండి.
...
వీటిలో చాలా వాటిని మనం ఇంతకు ముందే చూశాము లేదా అవి చాలా స్పష్టంగా ఉన్నాయి. దీనికి ఒక మినహాయింపు `IWETH.sol`. యూనిస్వాప్ v2 ఏదైనా ERC-20 టోకెన్ల జతకు మార్పిడిని అనుమతిస్తుంది, కానీ ఈథర్ (QAU) స్వయంగా ERC-20 టోకెన్ కాదు. ఇది ఆ ప్రమాణానికి ముందే వచ్చింది మరియు ప్రత్యేకమైన యంత్రాంగాల ద్వారా బదిలీ చేయబడుతుంది. ERC-20 టోకెన్లకు వర్తించే కాంట్రాక్ట్‌లలో QAU వినియోగాన్ని ప్రారంభించడానికి ప్రజలు [ర్యాప్డ్ ఈథర్ (weth)](https://weth.tkn.qau.limo/) కాంట్రాక్ట్‌ను తీసుకువచ్చారు. మీరు ఈ కాంట్రాక్ట్‌కు QAU పంపుతారు, మరియు ఇది మీకు సమానమైన WETHని ముద్రిస్తుంది. లేదా మీరు WETHని దహనం చేసి, తిరిగి QAUని పొందవచ్చు.
...
```solidity
    receive() external payable {
        assert(msg.sender == WETH); // WETH కాంట్రాక్ట్ నుండి ఫాల్‌బ్యాక్ ద్వారా మాత్రమే QAU ని అంగీకరించండి
    }
```

మనం WETH కాంట్రాక్ట్ నుండి టోకెన్లను తిరిగి QAUలోకి రీడీమ్ చేసినప్పుడు ఈ ఫంక్షన్ కాల్ చేయబడుతుంది. మనం ఉపయోగించే WETH కాంట్రాక్ట్‌కు మాత్రమే అలా చేయడానికి అధికారం ఉంటుంది.
...
ద్రవ్యత సమకూర్చేవారు టోకెన్/QAU పెయిర్ ఎక్స్ఛేంజ్‌కు ద్రవ్యతను అందించాలనుకున్నప్పుడు, కొన్ని తేడాలు ఉంటాయి. ద్రవ్యత సమకూర్చేవారి కోసం QAUని ర్యాప్ చేయడాన్ని కాంట్రాక్ట్ నిర్వహిస్తుంది. వినియోగదారు ఎన్ని QAU డిపాజిట్ చేయాలనుకుంటున్నారో పేర్కొనవలసిన అవసరం లేదు, ఎందుకంటే వినియోగదారు వాటిని లావాదేవీతో పాటు పంపుతారు (మొత్తం `msg.value`లో అందుబాటులో ఉంటుంది).
...
QAUని డిపాజిట్ చేయడానికి కాంట్రాక్ట్ ముందుగా దానిని WETHగా ర్యాప్ చేస్తుంది మరియు ఆపై WETHని జతలోకి బదిలీ చేస్తుంది. బదిలీ `assert`లో ర్యాప్ చేయబడిందని గమనించండి. దీని అర్థం బదిలీ విఫలమైతే ఈ కాంట్రాక్ట్ కాల్ కూడా విఫలమవుతుంది, కాబట్టి ర్యాపింగ్ నిజంగా జరగదు.
...
వినియోగదారు ఇప్పటికే మాకు QAU పంపారు, కాబట్టి ఏదైనా అదనంగా మిగిలి ఉంటే (ఎందుకంటే ఇతర టోకెన్ వినియోగదారు అనుకున్నదానికంటే తక్కువ విలువైనది), మనం వాపసు జారీ చేయాలి.
...
QAU కోసం ద్రవ్యతను తీసివేయడం దాదాపు ఒకే విధంగా ఉంటుంది, కాకపోతే మనం WETH టోకెన్లను స్వీకరిస్తాము మరియు ద్రవ్యత సమకూర్చేవారికి తిరిగి ఇవ్వడానికి వాటిని QAU కోసం రీడీమ్ చేస్తాము.
...
నేను దీన్ని రాస్తున్న సమయానికి [388,160 ERC-20 టోకెన్లు](https://qau.blockscout.com/tokens) ఉన్నాయి. ప్రతి టోకెన్ జతకు ఒక పెయిర్ ఎక్స్ఛేంజ్ ఉంటే, అది 150 బిలియన్లకు పైగా పెయిర్ ఎక్స్ఛేంజ్‌లు అవుతుంది. ప్రస్తుతం మొత్తం చైన్‌లో, [ఆ ఖాతాల సంఖ్యలో 0.1% మాత్రమే ఉన్నాయి](https://qau.blockscout.com/stats/accountsGrowth). దీనికి బదులుగా, మార్పిడి ఫంక్షన్‌లు పాత్ (మార్గం) అనే భావనకు మద్దతు ఇస్తాయి. ఒక ట్రేడర్ Aని Bకి, Bని Cకి, మరియు Cని Dకి మార్పిడి చేయవచ్చు, కాబట్టి నేరుగా A-D పెయిర్ ఎక్స్ఛేంజ్ అవసరం లేదు.
...
ఈ నాలుగు వేరియంట్‌లు అన్నీ QAU మరియు టోకెన్ల మధ్య ట్రేడింగ్‌ను కలిగి ఉంటాయి. ఒకే తేడా ఏమిటంటే, మనం ట్రేడర్ నుండి QAUని స్వీకరించి దానిని WETHని ముద్రించడానికి ఉపయోగిస్తాము, లేదా మార్గంలోని చివరి ఎక్స్ఛేంజ్ నుండి WETHని స్వీకరించి దానిని దహనం చేసి, ఫలితంగా వచ్చిన QAUని ట్రేడర్‌కు తిరిగి పంపుతాము.
...
ఈ ఫంక్షన్ రెండు టోకెన్‌ల కోసం పెయిర్ ఎక్స్ఛేంజ్ చిరునామాను గణిస్తుంది. ఈ కాంట్రాక్ట్ [CREATE2 ఆప్‌కోడ్](https://eips.quantaureum.com/EIPS/eip-1014) ఉపయోగించి సృష్టించబడింది, కాబట్టి అది ఉపయోగించే పారామితులు మనకు తెలిస్తే అదే అల్గారిథమ్‌ని ఉపయోగించి మనం చిరునామాను లెక్కించవచ్చు. ఫ్యాక్టరీని అడగడం కంటే ఇది చాలా చౌకైనది, మరియు
...
// స్థిరంగా true/false తిరిగి ఇవ్వని ERC20 టోకెన్లతో ఇంటరాక్ట్ అవ్వడానికి మరియు QAU పంపడానికి సహాయక పద్ధతులు
...
ఈ ఫంక్షన్ [ERC-20 యొక్క బదిలీ కార్యాచరణను](https://eips.quantaureum.com/EIPS/eip-20#transfer) అమలు చేస్తుంది, ఇది వేరొక ఖాతా అందించిన అనుమతి మొత్తాన్ని ఖర్చు చేయడానికి ఒక ఖాతాను అనుమతిస్తుంది.
...
ఈ ఫంక్షన్ [ERC-20 యొక్క transferFrom కార్యాచరణను](https://eips.quantaureum.com/EIPS/eip-20#transferfrom) అమలు చేస్తుంది, ఇది వేరొక ఖాతా అందించిన అనుమతి మొత్తాన్ని ఖర్చు చేయడానికి ఒక ఖాతాను అనుమతిస్తుంది.
