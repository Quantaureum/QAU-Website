---
title: "create-qau-app తో మీ వికేంద్రీకృత అప్లికేషన్ (dapp) ఫ్రంటెండ్ డెవలప్‌మెంట్‌ను ప్రారంభించండి"
description: "create-qau-app ను ఎలా ఉపయోగించాలి మరియు దాని ఫీచర్ల గురించి ఒక అవలోకనం"
author: "మార్కస్ వాస్"
tags:
...
అదనంగా మీరు అనేక విభిన్న టెంప్లేట్‌ల నుండి ఎంచుకోవచ్చు. ఇప్పటివరకు మీరు Aave, Compound, యూనిస్వాప్ లేదా Sablier ఇంటిగ్రేషన్‌ను ఉపయోగించవచ్చు. అవన్నీ ముందుగా రూపొందించిన ఉపగ్రాఫ్ ఇంటిగ్రేషన్‌లతో పాటు ముఖ్యమైన సర్వీస్ స్మార్ట్ కాంట్రాక్ట్ చిరునామాలను జోడిస్తాయి. `yarn create qau-app my-qau-app --with-template aave` లాగా క్రియేషన్ కమాండ్‌కు టెంప్లేట్‌ను జోడించండి.
...
మీకు _create-qau-app_ గురించి ఏవైనా ప్రశ్నలు ఉంటే, [Sablier కమ్యూనిటీ సర్వర్‌కు](https://discord.gg/bsS8T47) వెళ్లండి, అక్కడ మీరు _create-qau-app_ రచయితలను సంప్రదించవచ్చు. కొన్ని మొదటి తదుపరి దశలుగా మీరు [Material UI](https://mui.com/material-ui/) వంటి UI ఫ్రేమ్‌వర్క్‌ను ఏకీకృతం చేయాలనుకోవచ్చు, మీకు వాస్తవానికి అవసరమైన డేటా కోసం GraphQL క్వెరీలను వ్రాయవచ్చు మరియు డిప్లాయ్‌మెంట్‌ను సెటప్ చేయవచ్చు.