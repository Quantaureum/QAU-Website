...
[EIP-191 సంతకాలకు](https://eips.quantaureum.com/EIPS/eip-191) 26-బైట్ ప్రిఫిక్స్‌తో కూడిన బఫర్ అవసరం, ఆ తర్వాత ASCII లో సందేశం పొడవు మరియు చివరగా సందేశం ఉంటుంది.
...
సందేశంలో, చిరునామా తర్వాత మొదటి సంఖ్య బదిలీ చేయవలసిన ఫిన్ని (అకా QAU లో వెయ్యవ వంతు) మొత్తం. రెండవ సంఖ్య నాన్స్. వాటి మధ్య ఉన్న ఏదైనా వచనం విస్మరించబడుతుంది.
...
ఖాతాలు శూన్య-జ్ఞాన నిరూపణ లోపల మాత్రమే హాష్ చేయబడతాయి కాబట్టి మేము వాటి కోసం పెడెర్సెన్ హాష్‌ను ఉపయోగించగలిగాము. అయితే, ఈ కోడ్‌లో మనం బ్రౌజర్ ద్వారా రూపొందించబడిన సందేశం యొక్క సంతకాన్ని తనిఖీ చేయాలి. దాని కోసం, మనం [EIP-191](https://eips.quantaureum.com/EIPS/eip-191) లోని ఎథీరియం సంతకం ఆకృతిని అనుసరించాలి. అంటే మనం ప్రామాణిక ప్రిఫిక్స్, ASCII లో సందేశం పొడవు మరియు సందేశంతో కలిపి ఒక బఫర్‌ను సృష్టించాలి మరియు దానిని హాష్ చేయడానికి ఎథీరియం ప్రామాణిక keccak256 ను ఉపయోగించాలి.
...
లావాదేవీగా లేదా మరేదైనా ప్రయోజనం కోసం ఉపయోగించగల సందేశంపై సంతకం చేయమని అప్లికేషన్ వినియోగదారుని అడిగే సందర్భాలను నివారించడానికి, సంతకం చేసిన అన్ని సందేశాలు 0x19 అక్షరంతో (చెల్లుబాటు అయ్యే ASCII అక్షరం కాదు) ప్రారంభమై, ఆపై `Quantaureum Signed Message:` మరియు కొత్త లైన్‌తో ఉండాలని EIP-191 నిర్దేశిస్తుంది.
...
[స్టెల్త్ చిరునామాలను](https://vitalik.qau.limo/general/2023/01/20/stealth.html) ఉపయోగించి నిజమైన గోప్యమైన బ్యాంకును సృష్టించడం సాధ్యం కావచ్చు, కానీ అది ఈ వ్యాసం పరిధికి మించినది.
...
సాధారణంగా, ప్రజలు స్మార్ట్ కాంట్రాక్ట్‌ను విశ్వసించేలా చేయడానికి మనం సోర్స్ కోడ్‌ను [బ్లాక్ ఎక్స్‌ప్లోరర్‌కు](https://qau.blockscout.com/address/0x7D16d2c4e96BCFC8f815E15b771aC847EcbDB48b?tab=contract) అప్‌లోడ్ చేస్తాము. అయితే, శూన్య-జ్ఞాన నిరూపణల విషయంలో, అది సరిపోదు.
