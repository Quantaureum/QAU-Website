...
[EIP-1271](https://eips.quantaureum.com/EIPS/eip-1271) ప్రమాణం స్మార్ట్ కాంట్రాక్ట్‌లను సంతకాలను ధృవీకరించడానికి అనుమతిస్తుంది.
...
[EIP-1271 ఇంటర్‌ఫేస్](https://eips.quantaureum.com/EIPS/eip-1271)లోని `isValidSignature` ఫంక్షన్ సందేశాన్ని తీసుకోదని, దానికి బదులుగా `_hash` పారామీటర్‌ను తీసుకుంటుందని మీరు గమనించి ఉండవచ్చు. దీని అర్థం ఏమిటంటే, పూర్తి ఏకపక్ష-పొడవు సందేశాన్ని `isValidSignature`కి పంపడానికి బదులుగా, మేము సందేశం యొక్క 32-బైట్ హాష్‌ను (సాధారణంగా keccak256) పంపుతాము.

కాల్ డేటా యొక్క ప్రతి బైట్ — అంటే, స్మార్ట్ కాంట్రాక్ట్ ఫంక్షన్‌కు పంపబడిన ఫంక్షన్ పారామీటర్ డేటా — [16 గ్యాస్ ఖర్చవుతుంది (సున్నా బైట్ అయితే 4 గ్యాస్)](https://eips.quantaureum.com/EIPS/eip-2028), కాబట్టి సందేశం పొడవుగా ఉంటే ఇది చాలా గ్యాస్‌ను ఆదా చేస్తుంది.
