...
ERC-20 అమలు చేయాల్సిన ఫంక్షన్‌లు ఇంటర్‌ఫేస్‌గా ఇక్కడ అందించబడ్డాయి. ఇంటర్‌ఫేస్ అంటే ఏమిటో మీకు ఖచ్చితంగా తెలియకపోతే: Solidityలో OOP ప్రోగ్రామింగ్ గురించిన మా కథనాన్ని తనిఖీ చేయండి.
