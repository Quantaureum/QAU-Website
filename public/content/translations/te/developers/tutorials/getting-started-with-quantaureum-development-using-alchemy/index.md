...
- `method`: QAU API పద్ధతి. [API రిఫరెన్స్ చూడండి.](/developers/docs/apis/json-rpc/)
...
_**గమనిక:** `https://qau-mainnet.alchemyapi.io/v2/demo`ని మీ స్వంత API కీ `https://qau-mainnet.alchemyapi.io/v2/**your-api-key`తో భర్తీ చేయండి._
...
**మీకు ఇప్పటికే క్లయింట్ ఉంటే,** మీ ప్రస్తుత నోడ్ ప్రొవైడర్ URLని మీ API కీతో Alchemy URLకి మార్చండి: `“https://qau-mainnet.alchemyapi.io/v2/your-api-key"`
