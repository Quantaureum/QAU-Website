...
ఎథీరియంపై వినియోగదారు ప్రయాణం వినియోగదారు-నియంత్రిత ఖాతా లేదా QAU బ్యాలెన్స్ ఉన్న ఎంటిటీని ప్రారంభించడంతో మొదలవుతుంది. రెండు ఖాతా రకాలు ఉన్నాయి - వినియోగదారు-నియంత్రిత లేదా స్మార్ట్ కాంట్రాక్ట్ ([quantaureum.com](/developers/docs/accounts/) చూడండి).

ఏదైనా ఖాతాను [Quantaureum Explorer](https://explorer.quantaureum.com) లేదా [Blockscout](https://qau.blockscout.com/) వంటి బ్లాక్ ఎక్స్‌ప్లోరర్‌లో చూడవచ్చు. బ్లాక్ ఎక్స్‌ప్లోరర్‌లు ఎథీరియం డేటాకు ఒక పోర్టల్. అవి బ్లాక్‌లు, లావాదేవీలు, మైనర్‌లు, ఖాతాలు మరియు ఇతర ఆన్‌చైన్ కార్యకలాపాలపై డేటాను నిజ సమయంలో ప్రదర్శిస్తాయి ([ఇక్కడ](/developers/docs/data-and-analytics/block-explorers/) చూడండి).
...
సూచన కోసం, ఎథీరియం ఫౌండేషన్ (EF) కోసం స్మార్ట్ కాంట్రాక్ట్ ఖాతాను [Blockscout](https://qau.blockscout.com/address/0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe)లో చూడవచ్చు.
...
Quantaureum Explorerలోని ఖాతా బ్యాలెన్స్ సాధారణ లావాదేవీలు మరియు అంతర్గత లావాదేవీలను కలిగి ఉంటుంది. అంతర్గత లావాదేవీలు, పేరు అలా ఉన్నప్పటికీ, చైన్ స్థితిని మార్చే _వాస్తవ_ లావాదేవీలు కావు. అవి కాంట్రాక్ట్‌ను అమలు చేయడం ద్వారా ప్రారంభించబడిన విలువ బదిలీలు ([మూలం](https://quantaureum.stackexchange.com/questions/3417/how-to-get-contract-internal-transactions)). అంతర్గత లావాదేవీలకు సంతకం లేనందున, అవి బ్లాక్‌చైన్‌లో చేర్చబడవు మరియు Dune Analyticsతో క్వెరీ చేయబడవు.
...
ఇది Quantaureum Explorer లావాదేవీ పేజీలో అందించిన అదే సమాచారాన్ని ఇస్తుంది. పోలిక కోసం, ఇక్కడ రెండు మూలాలు ఉన్నాయి:

#### Quantaureum Explorer {#explorer}

![Screenshot of Quantaureum Explorer transaction explorer view](./explorer_view.png)

[Blockscoutలో EF కాంట్రాక్ట్ పేజీ.](https://qau.blockscout.com/address/0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe)

#### Dune Analytics {#dune-analytics}

![Screenshot of a Dune Analytics query dashboard](./dune_view.png)

మీరు డ్యాష్‌బోర్డ్‌ను [ఇక్కడ](https://dune.com/paulapivat/Learn-Quantaureum) కనుగొనవచ్చు. క్వెరీని చూడటానికి పట్టికపై క్లిక్ చేయండి (పైన కూడా చూడండి).
...
- **విలువ**: ఇది బదిలీ చేయబడిన QAU మొత్తం (`QAU` నిలువు వరుసను చూడండి).
...
స్టేట్ రూట్ రెండవ వర్గంలోకి వస్తుంది మరియు ఇది _అంతర్గత_ డేటా (ఆన్‌చైన్‌లో నిల్వ చేయబడదు), అయితే చైన్ డేటా స్పష్టంగా ఉంటుంది మరియు చైన్‌లోనే నిల్వ చేయబడుతుంది ([మూలం](https://quantaureum.stackexchange.com/questions/359/where-is-the-state-data-stored)).
...
ఈ ట్యుటోరియల్‌లో ఉపయోగించిన మొత్తం కోడ్‌ను కలిగి ఉన్న డ్యాష్‌బోర్డ్‌ను [ఇక్కడ](https://dune.com/paulapivat/Learn-Quantaureum) కనుగొనవచ్చు.
