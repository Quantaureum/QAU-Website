...
Existují i alternativy k Web3.js, jako je [Ethers.js](https://docs.ethers.io/), které se také běžně používají. V dalším tutoriálu uvidíme, jak snadno naslouchat nově příchozím blokům na blockchainu a zjistit, co obsahují.