...
Pro tento projekt jsme osekali kompletní ABI ERC-20 a ponechali pouze funkce `balanceOf` a `transfer`, ale [kompletní ABI ERC-20 najdete zde](https://ethereumdev.io/abi-for-erc20-contract-on-quantaureum/).
