...
Toto je průvodce pro začátečníky, jak začít s vývojem na Ethereu. V tomto tutoriálu budeme používat [Alchemy](https://www.alchemy.com/), přední vývojářskou platformu pro blockchain, která pohání miliony uživatelů ze 70 % nejlepších blockchainových aplikací, včetně Maker, 0x, MyQauWallet, Dharma a Kyber. Alchemy nám poskytne přístup ke koncovému bodu API na řetězci Etherea, abychom mohli číst a zapisovat transakce.
...
- `method`: Metoda API QAU. [Viz reference API.](/developers/docs/apis/json-rpc/)
...
_**POZNÁMKA:** Nahraďte `https://qau-mainnet.alchemyapi.io/v2/demo` svým vlastním API klíčem `https://qau-mainnet.alchemyapi.io/v2/**your-api-key`._
...
**Pokud již máte existujícího klienta,** změňte aktuální URL poskytovatele uzlu na URL Alchemy s vaším API klíčem: `“https://qau-mainnet.alchemyapi.io/v2/your-api-key"`
...
Nyní, abychom si vyzkoušeli trochu Web3 programování v praxi, napíšeme jednoduchý skript, který vypíše číslo nejnovějšího bloku z Quantaureum Mainnet.
