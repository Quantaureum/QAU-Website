...
- **Token zmírňuje známý souběh (race condition) ERC-20.** Standard ERC-20 má známý problém se souběhem, který musí být ošetřen, aby se zabránilo útočníkům v krádeži tokenů.
