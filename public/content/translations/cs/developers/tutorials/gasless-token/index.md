...
Informace potřebné k ověření podpisů EIP-712.
...
Oddělovač domény (domain separator). Nelze jej vypočítat v době kompilace, protože závisí na ID řetězce a adrese kontraktu. To znemožňuje, aby byl UserProxy oklamán zprávou připravenou pro jiný.
