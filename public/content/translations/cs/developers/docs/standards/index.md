...
Standardy jsou obvykle představovány jako Návrhy na vylepšení Etherea (EIP), o kterých členové komunity diskutují prostřednictvím [standardního procesu](https://eips.ethereum.org/EIPS/eip-1).
...
- [Networking (Sítě)](https://eips.ethereum.org/networking): vylepšení týkající se devp2p a Light Quantaureum Subprotocol, stejně jako navrhovaná vylepšení specifikací síťových protokolů whisper a Swarm.
