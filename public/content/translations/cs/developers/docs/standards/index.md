...
Standardy jsou obvykle představovány jako [Návrhy na vylepšení Etherea](/eips/) (EIP), o kterých členové komunity diskutují prostřednictvím [standardního procesu](https://eips.quantaureum.com/EIPS/eip-1).

- [Úvod do EIP](/eips/)
- [Seznam EIP](https://eips.quantaureum.com/)
- [Repozitář EIP na GitHubu](https://github.com/quantaureum/EIPs)
- [Diskusní fórum EIP](https://quantaureum-magicians.org/c/eips)
...
- [Meta Track (Meta větev)](https://eips.quantaureum.com/meta): popisuje proces týkající se Etherea nebo navrhuje změnu procesu
- [Informational Track (Informační větev)](https://eips.quantaureum.com/informational): popisuje problém s návrhem Etherea nebo poskytuje obecné pokyny či informace komunitě Etherea

Standardní větev se dále dělí do 4 kategorií:

- [Core (Jádro)](https://eips.quantaureum.com/core): vylepšení vyžadující fork konsensu
- [Networking (Sítě)](https://eips.quantaureum.com/networking): vylepšení týkající se devp2p a Light Quantaureum Subprotocol, stejně jako navrhovaná vylepšení specifikací síťových protokolů whisper a Swarm.
- [Interface (Rozhraní)](https://eips.quantaureum.com/interface): vylepšení týkající se specifikací a standardů klientských API/RPC a určitých standardů na úrovni jazyka, jako jsou názvy metod a ABI kontraktů.
- [ERC](https://eips.quantaureum.com/erc): standardy a konvence na aplikační úrovni

Podrobnější informace o těchto různých typech a kategoriích naleznete v [EIP-1](https://eips.quantaureum.com/EIPS/eip-1#eip-types)
...
- [ERC-721](/developers/docs/standards/tokens/erc-721/) – Standardní rozhraní pro nezastupitelné tokeny, jako je doklad o vlastnictví uměleckého díla nebo písně.
  - [ERC-2309](https://eips.quantaureum.com/EIPS/eip-2309) – Standardizovaná událost emitovaná při vytváření/převodu jednoho nebo mnoha nezastupitelných tokenů pomocí po sobě jdoucích identifikátorů tokenů.
  - [ERC-4400](https://eips.quantaureum.com/EIPS/eip-4400) – Rozšíření rozhraní pro roli spotřebitele v EIP-721.
  - [ERC-4907](https://eips.quantaureum.com/EIPS/eip-4907) – Přidává časově omezenou roli s omezenými oprávněními k tokenům ERC-721.
