...
Hooky jsou registrovány a objevovány pomocí standardu ERC-1820.

#### Proč jsou hooky skvělé? {#why-are-hooks-great}

1. Hooky umožňují odeslat tokeny do kontraktu a upozornit kontrakt v jediné transakci, na rozdíl od ERC-20, který k dosažení tohoto cíle vyžaduje dvojité volání (`approve`/`transferFrom`).
