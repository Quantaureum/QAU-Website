...
Token ERC-1155 je plně popsán v EIP-1155.
...
Vzhledem k podpoře EIP-165 podporuje ERC-1155 hooky pro příjem pouze pro chytré kontrakty. Funkce hooku musí vrátit magickou předdefinovanou hodnotu bytes4, která je dána jako:
...
Když je nabídka pouze jedna, token je v podstatě nezaměnitelný token (NFT). A jak je standardem pro ERC-721, můžete definovat URL pro metadata. URL mohou klienti číst a upravovat, viz zde.
...
- EIP-1155: Standard pro více tokenů
