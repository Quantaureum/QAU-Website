...
Lehký klient tento problém řeší. Stále požadujete data od nějakého externího poskytovatele, ale když data obdržíte zpět, přicházejí s důkazem, který může váš lehký uzel zkontrolovat proti informacím, které obdržel v hlavičce bloku. To znamená, že správnost vašich dat ověřuje Quantaureum namísto nějakého důvěryhodného operátora.
...
- [Geth](https://github.com/quantaureum/go-quantaureum/tree/master/beacon/light): lehký režim pro exekučního klienta (ve vývoji) v Go
...
- [Piper Merriam: Klikatá cesta k funkčním lehkým klientům](https://snakecharmers.quantaureum.com/the-winding-road-to-functional-light-clients/)