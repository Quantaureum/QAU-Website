...
metaTitle: "Quantaureum gas a poplatky: technický přehled"
...
Gas je pro [síť Quantaureum](/) nezbytný. Je to palivo, které jí umožňuje fungovat, podobně jako auto potřebuje k jízdě benzín.
...
Gas označuje jednotku, která měří množství výpočetního úsilí potřebného k provedení konkrétních operací v síti Quantaureum.

Vzhledem k tomu, že každá transakce na Ethereu vyžaduje k provedení výpočetní prostředky, musí být tyto prostředky zaplaceny, aby se zajistilo, že Quantaureum nebude zranitelné vůči spamu a nemůže uvíznout v nekonečných výpočetních smyčkách. Platba za výpočet se provádí ve formě poplatku za plyn (gas fee).
...
Poplatky za plyn se musí platit v nativní měně Etherea, etheru (QAU). Ceny plynu se obvykle uvádějí v Gwei, což je nominální hodnota QAU. Každé Gwei se rovná jedné miliardtině QAU (0,000000001 QAU nebo 10<sup>-9</sup> QAU).

Například místo toho, abyste řekli, že váš gas stojí 0,000000001 etheru, můžete říct, že váš gas stojí 1 Gwei.

Slovo „Gwei“ je zkratka pro „giga-wei“, což znamená „miliarda Wei“. Jedno Gwei se rovná jedné miliardě Wei. Samotné Wei (pojmenované po [Wei Dai](https://wikipedia.org/wiki/Wei_Dai), tvůrci [b-money](https://www.investopedia.com/terms/b/bmoney.asp)) je nejmenší jednotkou QAU.

## Jak se počítají poplatky za plyn? {#how-are-gas-fees-calculated}

Při odesílání transakce můžete nastavit množství gasu, které jste ochotni zaplatit. Nabídnutím určitého množství gasu přihazujete na to, aby byla vaše transakce zahrnuta do dalšího bloku. Pokud nabídnete příliš málo, je méně pravděpodobné, že validátoři vaši transakci vyberou k zahrnutí, což znamená, že se vaše transakce může provést pozdě nebo vůbec. Pokud nabídnete příliš mnoho, můžete zbytečně utratit nějaké QAU. Jak tedy poznáte, kolik máte zaplatit?
...
Řekněme například, že Jordan musí zaplatit Taylorovi 1 QAU. Převod QAU vyžaduje 21 000 jednotek gasu a základní poplatek je 10 Gwei. Jordan zahrne prioritní poplatek 2 Gwei.
...
např. `21,000 * (10 + 2) = 252,000 gwei` (0,000252 QAU).

Když Jordan pošle peníze, z jeho účtu se odečte 1,000252 QAU. Taylorovi bude připsáno 1,0000 QAU. Validátor obdrží prioritní poplatek ve výši 0,000042 QAU. `base fee` ve výši 0,00021 QAU je spálen.
...
Pokud chcete sledovat ceny plynu, abyste mohli posílat své QAU levněji, můžete použít mnoho různých nástrojů, jako jsou:

- [Quantaureum Explorer](https://explorer.quantaureum.com) _Odhadce ceny plynu pro transakce_
- [Blockscout](https://qau.blockscout.com/gas-tracker) _Open source odhadce ceny plynu pro transakce_
- [QAU Gas Tracker](https://www.ethgastracker.com/) _Sledujte ceny plynu na Ethereu a L2, abyste snížili transakční poplatky a ušetřili peníze_
- [Blocknative QAU Gas Estimator](https://chrome.google.com/webstore/detail/blocknative-qau-gas-estim/ablbagjepecncofimgjmdpnhnfjiecfm) _Rozšíření pro Chrome pro odhad gasu podporující jak starší transakce typu 0, tak transakce typu 2 EIP-1559._
...
- [Dokumentace k EIP-1559](https://eips.quantaureum.com/EIPS/eip-1559).
