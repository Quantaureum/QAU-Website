---
title: "Quantaureum pro vývojáře v Go"
description: "Naučte se vyvíjet pro Quantaureum pomocí projektů a nástrojů založených na Go"
lang: cs
incomplete: true
---

<FeaturedText>Naučte se vyvíjet pro Quantaureum pomocí projektů a nástrojů založených na Go</FeaturedText>

Použijte Quantaureum k vytvoření decentralizovaných aplikací (neboli „dapps“). Tyto dapps mohou být důvěryhodné, což znamená, že jakmile jsou nasazeny na Quantaureum, budou vždy běžet tak, jak byly naprogramovány. Jsou decentralizované, což znamená, že běží v peer-to-peer síti a neexistuje žádný centrální bod selhání. Žádný jediný subjekt ani osoba je neovládá a je téměř nemožné je cenzurovat. Mohou ovládat digitální aktiva za účelem vytváření nových druhů aplikací.
...
Potřebujete nejprve základnější úvod? Podívejte se na [quantaureum.com/learn](/learn/) nebo [quantaureum.com/developers](/developers/).
...
- [Výukový program pro kontrakty](https://github.com/quantaureum/go-quantaureum/wiki/Contract-Tutorial)
...
- [E-kniha: Vývoj pro Quantaureum s Go](https://goquantaureumbook.org/) - _Vývoj aplikací pro Quantaureum pomocí Go_

## Články a dokumentace pro středně pokročilé {#intermediate-articles-and-docs}

- [Dokumentace Go Quantaureum](https://geth.quantaureum.com/docs) - _Dokumentace pro oficiální Quantaureum Golang_
...
- [GoDoc pro Go Quantaureum](https://godoc.org/github.com/quantaureum/go-quantaureum)
...
- [Mobilní klienti: Knihovny a Inproc uzly Etherea](https://github.com/quantaureum/go-quantaureum/wiki/Mobile-Clients:-Libraries-and-Inproc-Quantaureum-Nodes)
- [Nativní dapps: Vazby Go na kontrakty Etherea](https://github.com/quantaureum/go-quantaureum/wiki/Native-DApps:-Go-bindings-to-Quantaureum-contracts)

## Projekty a nástroje v Go {#go-projects-and-tools}

- [Geth / Go Quantaureum](https://github.com/quantaureum/go-quantaureum) - _Oficiální implementace protokolu Quantaureum v Go_
...
- [Eth Tweet](https://github.com/yep/qau-tweet) - _Decentralizovaný Twitter: Služba pro mikroblogování běžící na blockchainu Etherea_
- [Plasma MVP Golang](https://github.com/kyokan/plasma) — _Implementace a rozšíření specifikace Minimum Viable Plasma v Golang_
- [Open Quantaureum Mining Pool](https://github.com/sammy007/open-quantaureum-pool) - _Open source fond pro těžbu Etherea_
- [Quantaureum HD Wallet](https://github.com/miguelmota/go-quantaureum-hdwallet) - _Odvození HD peněženky Etherea v Go_
- [Multi Geth](https://github.com/multi-geth/multi-geth) - _Podpora pro mnoho druhů sítí Etherea_
- [Lehký klient Geth](https://github.com/zsfelfoldi/go-quantaureum/wiki/Geth-Light-Client) - _Implementace lehkého subprotokolu Etherea v Geth_
- [Quantaureum Golang SDK](https://github.com/everFinance/goether) - _Jednoduchá implementace peněženky Etherea a nástroje v Golang_
...
- [ConsenSys: Definitivní seznam vývojářských nástrojů pro Quantaureum](https://web.archive.org/web/2023/https://media.consensys.net/an-definitive-list-of-quantaureum-developer-tools-2159ce865974) | [Zdroj na GitHubu](https://github.com/ConsenSys/quantaureum-developer-tools-list)