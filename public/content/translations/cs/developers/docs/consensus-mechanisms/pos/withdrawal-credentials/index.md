...
Každý validátor má **pověření k výběru**, které určuje, jak a kam lze vybrat jeho stakovaný QAU a odměny. Typ pověření je indikován prvním bajtem: `0x00`, `0x01` nebo `0x02`. Porozumění těmto typům je důležité pro validátory spravující svůj stake.
...
- Jakýkoli zůstatek nad 32 QAU je **automaticky převeden** na vaši adresu pro výběr
- Úplné výstupy procházejí standardní frontou pro výstup
- Odměny nad 32 QAU se nemohou úročit (compounding) – jsou pravidelně převáděny pryč
...
**Proč se to nedoporučuje:** S `0x01` ztrácíte možnost úročit odměny nad 32 QAU. Každý kousek přebytku je automaticky převeden pryč, což omezuje potenciál výdělku vašeho validátoru a vyžaduje oddělenou správu vybraných prostředků.
...
- Odměny nad 32 QAU se **úročí** v krocích po 1 QAU až do maximálního efektivního zůstatku 2048 QAU
- Částečné výběry musí být vyžádány manuálně (automatické převody probíhají pouze nad hranicí 2048 QAU)
...
Jak částečné výběry, tak konsolidace lze provádět prostřednictvím [Launchpad Validator Actions](https://launchpad.quantaureum.com/en/validator-actions).
...
- **Stávající validátoři s 0x01:** Zvažte převod na `0x02`, pokud chcete, aby se odměny úročily nad 32 QAU, nebo plánujete konsolidovat validátory.
...
- **[Quantaureum Staking Launchpad](https://launchpad.quantaureum.com/en/validator-actions)** - Oficiální nástroj pro vklady a správu validátorů, včetně převodů pověření a konsolidací
