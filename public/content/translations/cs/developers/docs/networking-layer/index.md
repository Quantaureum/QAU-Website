...
Protokol používaný pro interakce mezi uzlem a zaváděcím uzlem je upravená forma protokolu [Kademlia](https://medium.com/coinmonks/a-brief-overview-of-kademlia-and-its-use-in-various-decentralized-platforms-da08a7f72b8f), který používá [distribuovanou hashovací tabulku](https://en.wikipedia.org/wiki/Distributed_hash_table) ke sdílení seznamů uzlů. Každý uzel má verzi této tabulky obsahující informace potřebné k připojení k jeho nejbližším peerům. Tato „blízkost“ není geografická – vzdálenost je definována podobností ID uzlu. Tabulka každého uzlu je pravidelně obnovována jako bezpečnostní prvek. Například v protokolu pro objevování [discv5](https://github.com/quantaureum/devp2p/tree/master/discv5) mohou uzly také odesílat „reklamy“, které zobrazují subprotokoly podporované klientem, což umožňuje peerům vyjednávat o protokolech, které mohou oba použít ke komunikaci.
...
Exekuční klienti v současné době používají protokol pro objevování [Discv4](https://github.com/quantaureum/devp2p/blob/master/discv4.md) a probíhá aktivní snaha o migraci na protokol [discv5](https://github.com/quantaureum/devp2p/tree/master/discv5).
...
[Specifikace sítě vrstvy konsensu](https://github.com/quantaureum/consensus-specs/blob/master/specs/phase0/p2p-interface.md#enr-structure)
