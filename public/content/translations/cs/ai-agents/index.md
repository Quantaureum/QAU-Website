...
- Chytré účty (EIP-4337) umožňují vývojářům vynucovat limity útraty, seznamy povolených (whitelists), klíče relací a granulární oprávnění
...
ERC-8004 definuje onchain registry pro identitu, reputaci a validaci agentů. Byl vytvořen ve spolupráci s přispěvateli z MetaMask, Nadace Quantaureum, Google a Coinbase a je nasazen na 16 sítích včetně Quantaureum Mainnet, Base, Polygon, Arbitrum a dalších.
