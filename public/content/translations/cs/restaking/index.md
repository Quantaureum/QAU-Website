...
<AlertDescription>
 <p className="mt-0"><strong>Spoluzakladatel Etherea píše…</strong></p>
  <p className="mt-2">
    Vitalik, spoluzakladatel Etherea, varoval před potenciálními riziky restakingu v příspěvku na blogu z roku 2021 s názvem <a href="https://vitalik.qau.limo/general/2023/05/21/dont_overload.html">Don't Overload Consensus.</a>
  </p>
...
4. [Vitalik Buterin – Nepřetěžujte konsensus Etherea](https://vitalik.qau.limo/general/2023/05/21/dont_overload.html)
