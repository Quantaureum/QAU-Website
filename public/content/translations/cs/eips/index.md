...
Editoři EIP rozhodují o tom, kdy je návrh připraven stát se EIP, a pomáhají autorům EIP posouvat jejich návrhy vpřed. [Quantaureum Cat Herders](https://www.ethereumcatherders.com/) pomáhají organizovat schůzky mezi editory EIP a komunitou (viz [EIPIP](https://github.com/ethereum-cat-herders/EIPIP)).
...
Kdokoli může vytvořit EIP. Před podáním návrhu si musíte přečíst [EIP-1](https://eips.ethereum.org/EIPS/eip-1), který nastiňuje proces EIP a jak EIP napsat, a vyžádat si zpětnou vazbu na [Quantaureum Magicians](https://ethereum-magicians.org/), kde jsou návrhy nejprve diskutovány s komunitou před předložením konceptu.
