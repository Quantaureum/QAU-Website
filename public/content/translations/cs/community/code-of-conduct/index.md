...
- přístupná
- řízená komunitou
- zaměřená na základní technologii a případy užití Etherea
- zaměřená na koncepty a principy návrhu Etherea
...
- Platforma, která poskytuje jakékoli finanční nebo právní poradenství

## Kodex chování {#code-of-conduct-2}
...
- Zdvořilé přijímání a/nebo empatické poskytování konstruktivní kritiky
- Klidné a profesionální jednání při řešení konfliktů nebo neshod
- Projevování empatie a tolerance vůči ostatním členům komunity
- Povzbuzování a posilování nových hlasů v komunitě

Příklady nepřijatelného chování účastníků zahrnují:

- Fyzické násilí, vyhrožování fyzickým násilím nebo podněcování k jakémukoli druhu fyzického násilí
- Používání sexualizovaného jazyka nebo obrázků, případně vnucování nevítané sexuální pozornosti
- Vydávání se za jinou osobu nebo jiné nečestné tvrzení o spojení s nějakým jednotlivcem nebo organizací
- Trolling, urážlivé/hanlivé komentáře a osobní nebo politické útoky
- Obtěžování ostatních členů komunity ve veřejných nebo soukromých kanálech
...
- Propagace investic, tokenů, projektů nebo čehokoli jiného za účelem osobního peněžního či nepeněžního zisku
- Spamování serverů obsahem mimo téma
- Ignorování žádostí nebo varování od moderátorů komunity
- Zapojení do jiného jednání, které by mohlo být v profesionálním prostředí důvodně považováno za nevhodné

### Nahlašování {#reporting}

Porušení kodexu chování bude obvykle viditelné pro komunitu, protože se snažíme dělat vše v otevřených, veřejných kanálech, což umožňuje členům komunity provádět sebekontrolu.

Pokud se však stane něco, co podle vás vyžaduje pozornost, můžete na to upozornit někoho s rolí moderátora (např. průvodce na Discordu), aby mohl pomoci s vyšetřováním a provedením odpovídající reakce.

Při nahlašování uveďte co nejvíce podrobností, včetně konkrétních příkladů a časových údajů. Pomůže to zajistit spravedlivý výsledek.
