...
- **Open source kód/data** - Otevřenost kódu a dat je základním principem decentralizované vědy (DeSci), takže projekty DeSci nesmí mít uzavřený zdrojový kód. Kódová základna by měla být přístupná a ideálně otevřená pro PR (pull requesty).
- **Projekty DeSci by měly být prokazatelně decentralizované** - To může zahrnovat řízení pomocí DAO nebo budování pomocí decentralizovaného technologického zásobníku včetně nekustodiálních peněženek. Pravděpodobně to zahrnuje auditovatelné chytré kontrakty na Ethereu.
- **Pravdivé a přesné informace o zařazení** - Očekává se, že všechny navrhované záznamy projektů budou obsahovat pravdivé a přesné informace. Produkty, které falšují informace o zařazení, například prohlašují, že je produkt „open source“, i když není, budou odstrěny.
