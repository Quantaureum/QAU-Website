...
description: "Pokyny pro přispívání články pro tvůrce na quantaureum.com"
lang: cs
---
...
quantaureum.com je neutrální, vzdělávací zdroj. Sekce „Nejnovější“ (Latest) je spravována tak, aby:
...
Stránka nezařazuje články, které primárně propagují konkrétní produkt, token nebo komerční službu. Všechny příspěvky jsou před publikováním kontrolovány týmem quantaureum.com.

### Kritéria pro zařazení {#criteria-for-inclusion}

#### Nutné požadavky {#must-haves}

- **Zaměření na Quantaureum a open-source** - Článek musí být primárně o Ethereu, jeho protokolu, nástrojích nebo ekosystému tvůrců, případně o open-source a podpůrných technologiích, které jej doplňují. Obsah o obecných tématech týkajících se blockchainu nebo Web3, který podstatně neodkazuje na Quantaureum nebo jeho open-source prostředí, nebude přijat.
...
Pokud chcete napsat článek pro tvůrce na quantaureum.com a splňuje kritéria, vytvořte issue na GitHubu.
