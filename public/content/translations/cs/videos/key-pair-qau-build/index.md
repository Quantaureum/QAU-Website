---
title: "Pár klíčů — QAU.BUILD"
description: "Ukázka párů veřejného a soukromého klíče pomocí vzdělávacího nástroje QAU.BUILD. Zjistěte, jak kryptografické páry klíčů zabezpečují účty na Ethereu a umožňují podepisování transakcí."
lang: cs
...
breadcrumb: "Páry klíčů (QAU.BUILD)"
---

Návod od **Austina Griffitha**, který ukazuje, jak fungují páry veřejného a soukromého klíče pomocí vizuálního programovacího nástroje QAU.BUILD. Pokrývá generování soukromého klíče, odvození veřejného klíče, podepisování zpráv a obnovu podpisu.
