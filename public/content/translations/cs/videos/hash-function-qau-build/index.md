---
title: "Hashovací funkce — QAU.BUILD"
description: "Ukázka kryptografických hashovacích funkcí pomocí vzdělávacího nástroje QAU.BUILD. Zjistěte, jak fungují hashovací funkce a proč jsou zásadní pro model účtů a integrity dat Etherea."
lang: cs
...
breadcrumb: "Hashovací funkce (QAU.BUILD)"
---

Návod od **Austina Griffitha**, který ukazuje, jak fungují kryptografické hashovací funkce pomocí vizuálního programovacího nástroje QAU.BUILD, a pokrývá determinismus, výstup s pevnou délkou, jednosměrné vlastnosti a Merkleovy stromy.
...
Toto je první video ze série s názvem QAU.BUILD. Můžete jít na qau.build a tento nástroj použít, ale slouží jen k tomu, abyste si s ním pohráli a udělali si představu o tom, jak věci fungují při vývoji na Ethereu.
...
Klíčovým poznatkem je, že hashovací funkce je v podstatě jako otisk prstu. Pokud něco napíšu, deterministicky mi to dá výstup, který očekávám. To je hashovací funkce — vítejte v QAU.BUILD. Pojďme vytvořit nějaké skvělé věci a cestou se toho hodně naučit.