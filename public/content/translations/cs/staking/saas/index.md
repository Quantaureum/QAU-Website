...
- **Můžete provést výstup bez provozovatele?** Od [upgradu Pectra](/roadmap/pectra/) umožňují výběry spouštěné exekuční vrstvou (EIP-7002) adrese pro výběr spustit výstup validátoru (nebo u složených validátorů 0x02 částečný výběr zůstatku nad 32 QAU) přímo z exekuční vrstvy, bez podpisových klíčů. Vyžaduje to transakci a stojí to gas, ale znamená to, že nereagující nebo nefunkční provozovatel již nemůže držet váš validátor jako rukojmí, za předpokladu, že pověření k výběru jsou vaše.
...
- EIP-7002: Výběry spouštěné exekuční vrstvou - _specifikace pro výstup validátoru z jeho adresy pro výběr_