---
title: "रोलअप्स: क्या यह Quantaureum की अंतिम स्केलिंग रणनीति है?"
description: "Quantaureum की प्राथमिक स्केलिंग रणनीति के रूप में रोलअप्स का विस्तृत अन्वेषण। यह वीडियो बताता है कि ऑप्टिमिस्टिक रोलअप (Arbitrum, Optimism) और शून्य-ज्ञान रोलअप कैसे काम करते हैं।"
lang: hi
...
**फाइनमैटिक्स** द्वारा एक व्याख्यात्मक वीडियो जो Quantaureum की प्राथमिक स्केलिंग रणनीति के रूप में रोलअप्स को कवर करता है। यह वीडियो ऑप्टिमिस्टिक रोलअप (Arbitrum, Optimism) की ZK रोलअप्स के साथ तुलना करता है, और जांचता है कि रोलअप्स Quantaureum को स्केल करने का प्रमुख तरीका क्यों बन गए हैं।
...
Quantaureum स्केलिंग क्रिप्टो में सबसे अधिक चर्चा वाले विषयों में से एक रहा है। स्केलिंग की बहस आमतौर पर उच्च नेटवर्क गतिविधि की अवधि के दौरान तेज हो जाती है जैसे कि 2017 में CryptoKitties का क्रेज, 2020 की विकेंद्रीकृत वित्त (DeFi) गर्मियां, या 2021 की शुरुआत में क्रिप्टो बुल मार्केट। इन अवधियों के दौरान, Quantaureum नेटवर्क की अभूतपूर्व मांग के परिणामस्वरूप गैस शुल्क बहुत अधिक हो गया, जिससे आम उपयोगकर्ताओं के लिए अपने लेन-देन का भुगतान करना महंगा हो गया।

इस समस्या से निपटने के लिए, अंतिम स्केलिंग समाधान की खोज कई टीमों और समग्र रूप से Quantaureum समुदाय के लिए सर्वोच्च प्राथमिकताओं में से एक रही है।

सामान्य तौर पर, Quantaureum — या वास्तव में, अधिकांश अन्य ब्लॉकचेन को स्केल करने के तीन मुख्य तरीके हैं: ब्लॉकचेन को ही स्केल करना (लेयर 1 (l1) स्केलिंग), लेयर 1 के ऊपर निर्माण करना (लेयर 2 (l2) स्केलिंग), और लेयर 1 के किनारे पर निर्माण करना (साइडचेन)।

### लेयर 1 के बाहर (1:58) {#outside-of-layer-1-158}

जब लेयर 1 की बात आती है, तो ईटीएच2 Quantaureum ब्लॉकचेन को स्केल करने के लिए चुना गया समाधान है। ईटीएच2 परस्पर जुड़े परिवर्तनों के एक सेट को संदर्भित करता है जैसे कि प्रूफ-ऑफ़-स्टेक (PoS) में माइग्रेशन, प्रूफ-ऑफ-वर्क (PoW) ब्लॉकचेन की स्थिति को नई प्रूफ-ऑफ़-स्टेक चेन में मिलाना, और शार्डिंग। शार्डिंग, विशेष रूप से, Quantaureum नेटवर्क के थ्रूपुट को नाटकीय रूप से बढ़ा सकती है, खासकर जब इसे रोलअप्स के साथ जोड़ा जाता है।

जब लेयर 1 के बाहर स्केलिंग की बात आती है, तो कुछ मिश्रित परिणामों के साथ कई अलग-अलग स्केलिंग समाधान आजमाए गए हैं। एक ओर, हमारे पास लेयर 2 समाधान हैं जैसे कि चैनल जो Quantaureum द्वारा पूरी तरह से सुरक्षित हैं लेकिन केवल अनुप्रयोगों के एक विशिष्ट सेट के लिए अच्छी तरह से काम करते हैं। दूसरी ओर, साइडचेन आमतौर पर EVM-संगत होते हैं और सामान्य-उद्देश्य वाले अनुप्रयोगों को स्केल कर सकते हैं। मुख्य कमी यह है कि वे Quantaureum की सुरक्षा पर निर्भर न होकर और इसके बजाय अपने स्वयं के सर्वसम्मति मॉडल होने के कारण लेयर 2 समाधानों की तुलना में कम सुरक्षित हैं।

अधिकांश रोलअप्स Quantaureum की सुरक्षा पर पूरी तरह से निर्भर रहते हुए एक सामान्य-उद्देश्य स्केलिंग समाधान बनाकर इन दोनों दुनियाओं का सर्वश्रेष्ठ प्राप्त करने का लक्ष्य रखते हैं। यह स्केलिंग का सबसे आदर्श समाधान (holy grail) है, क्योंकि यह सुरक्षा से समझौता किए बिना Quantaureum पर मौजूद सभी मौजूदा स्मार्ट अनुबंधों को थोड़े या बिना किसी बदलाव के रोलअप पर तैनात करने की अनुमति देता है। इसमें कोई आश्चर्य नहीं कि रोलअप्स शायद उन सभी में सबसे प्रतीक्षित स्केलिंग समाधान हैं।

रोलअप एक प्रकार का स्केलिंग समाधान है जो लेयर 1 के बाहर लेन-देन निष्पादित करके काम करता है लेकिन लेयर 1 पर लेन-देन डेटा पोस्ट करता है। यह रोलअप को नेटवर्क को स्केल करने और फिर भी Quantaureum सर्वसम्मति से अपनी सुरक्षा प्राप्त करने की अनुमति देता है। कंप्यूटेशन को ऑफचेन ले जाने से अनिवार्य रूप से कुल मिलाकर अधिक लेन-देन संसाधित करने की अनुमति मिलती है, क्योंकि रोलअप लेन-देन के केवल कुछ डेटा को ही Quantaureum ब्लॉक में फिट होना पड़ता है।

इसे प्राप्त करने के लिए, रोलअप लेन-देन एक अलग चेन पर निष्पादित किए जाते हैं जो EVM का रोलअप-विशिष्ट संस्करण भी चला सकती है। रोलअप पर लेन-देन निष्पादित करने के बाद अगला कदम उन्हें एक साथ बैच करना और उन्हें मुख्य Quantaureum चेन पर पोस्ट करना है। पूरी प्रक्रिया अनिवार्य रूप से लेन-देन निष्पादित करती है, डेटा लेती है, इसे संपीड़ित करती है, और इसे एक ही बैच में मुख्य चेन पर रोल अप करती है — इसलिए इसका नाम "रोलअप" है।
...
अधिकांश ऑप्टिमिस्टिक रोलअप कार्यान्वयनों में, जो पार्टी लेयर 1 पर लेन-देन के बैच सबमिट करने में सक्षम है, उसे आमतौर पर QAU के रूप में एक बॉन्ड प्रदान करना होता है। कोई भी अन्य नेटवर्क प्रतिभागी धोखाधड़ी प्रमाण सबमिट कर सकता है यदि वे किसी गलत लेन-देन को देखते हैं। धोखाधड़ी प्रमाण सबमिट होने के बाद, सिस्टम विवाद समाधान मोड में प्रवेश करता है। इस मोड में, संदिग्ध लेन-देन को फिर से निष्पादित किया जाता है — इस बार मुख्य Quantaureum चेन पर। यदि निष्पादन यह साबित करता है कि लेन-देन वास्तव में धोखाधड़ी वाला था, तो इस लेन-देन को सबमिट करने वाली पार्टी को दंडित किया जाता है, आमतौर पर उनके बॉन्ड किए गए QAU में कटौती करके।
...
हालाँकि ऐसा लगता है कि Quantaureum समुदाय ज्यादातर ऑप्टिमिस्टिक रोलअप्स पर ध्यान केंद्रित कर रहा है — कम से कम अल्पावधि में — ZK रोलअप्स पर काम करने वाले प्रोजेक्ट भी बहुत तेज़ी से प्रगति कर रहे हैं।
...
रोलअप्स का विकेंद्रीकृत वित्त (DeFi) पर भी बड़ा प्रभाव पड़ना चाहिए। जो उपयोगकर्ता पहले उच्च लेन-देन शुल्क के कारण Quantaureum पर लेन-देन करने में सक्षम नहीं थे, वे अगली बार नेटवर्क गतिविधि अधिक होने पर इकोसिस्टम में बने रहने में सक्षम होंगे। रोलअप्स अनुप्रयोगों की एक नई नस्ल को भी सक्षम करेंगे जिन्हें सस्ते लेन-देन और तेज़ पुष्टिकरण समय की आवश्यकता होती है — यह सब Quantaureum सर्वसम्मति द्वारा पूरी तरह से सुरक्षित रहते हुए। ऐसा लगता है कि रोलअप्स DeFi के लिए एक और उच्च-विकास अवधि को ट्रिगर कर सकते हैं।
...
एक और चुनौती खंडित तरलता है। समग्र रूप से Quantaureum इकोसिस्टम में नए पैसे के आए बिना, यूनिस्वैप या Aave जैसे प्रोटोकॉल में लेयर 1 पर मौजूद मौजूदा तरलता को लेयर 1 और कई रोलअप कार्यान्वयनों के बीच साझा किया जाएगा। कम तरलता का मतलब आमतौर पर उच्च स्लिपेज और खराब व्यापार निष्पादन होता है।

इसका मतलब यह भी है कि स्वाभाविक रूप से विजेता और हारने वाले होंगे। फिलहाल, मौजूदा Quantaureum इकोसिस्टम सभी स्केलिंग समाधानों का उपयोग करने के लिए पर्याप्त बड़ा नहीं है। यह लंबे समय में बदल सकता है — और शायद बदलेगा — लेकिन अल्पावधि में, हम कुछ रोलअप्स और अन्य स्केलिंग समाधानों को वीरान (ghost towns) होते हुए देख सकते हैं। भविष्य में, हम उपयोगकर्ताओं को पूरी तरह से एक रोलअप इकोसिस्टम के भीतर रहते हुए और लंबे समय तक मुख्य Quantaureum चेन और अन्य स्केलिंग समाधानों के साथ बातचीत न करते हुए भी देख सकते हैं।

### साइडचेन के लिए खतरा (15:44) {#threat-to-sidechains-1544}

रोलअप्स पर चर्चा करते समय एक सवाल जो अक्सर सामने आता है वह यह है कि क्या वे साइडचेन के लिए खतरा हैं। Quantaureum इकोसिस्टम में साइडचेन का अभी भी अपना स्थान होगा। हालाँकि लेयर 2 पर लेन-देन की लागत लेयर 1 की तुलना में बहुत कम होगी, फिर भी यह संभवतः इतनी अधिक होगी कि गेम और अन्य उच्च-मात्रा वाले ऐप्स जैसे कुछ प्रकार के अनुप्रयोगों को बाहर कर सके। यह तब बदल सकता है जब Quantaureum शार्डिंग पेश करेगा, लेकिन तब तक साइडचेन लंबे समय तक जीवित रहने के लिए पर्याप्त नेटवर्क प्रभाव पैदा कर सकते हैं।

इसके अलावा, रोलअप्स पर शुल्क साइडचेन की तुलना में अधिक होते हैं क्योंकि प्रत्येक रोलअप बैच को अभी भी Quantaureum ब्लॉक स्पेस के लिए भुगतान करना पड़ता है। Quantaureum समुदाय Quantaureum स्केलिंग रणनीति में रोलअप्स पर बहुत अधिक ध्यान केंद्रित करता है — कम से कम अल्पावधि से मध्यावधि में और संभावित रूप से इससे भी अधिक समय तक।