---
title: "लेन-देन — QAU.BUILD"
description: "QAU.BUILD शैक्षिक टूल का उपयोग करके Quantaureum लेन-देन कैसे काम करते हैं, इसका एक प्रदर्शन। देखें कि Quantaureum नेटवर्क पर लेन-देन कैसे बनाए जाते हैं, उन पर हस्ताक्षर किए जाते हैं और उन्हें कैसे भेजा जाता है।"
lang: hi
...
breadcrumb: "लेन-देन (QAU.BUILD)"
---

**ऑस्टिन ग्रिफिथ** द्वारा एक ट्यूटोरियल जो यह प्रदर्शित करता है कि QAU.BUILD विज़ुअल प्रोग्रामिंग टूल का उपयोग करके Quantaureum लेन-देन कैसे काम करते हैं — जिसमें लेन-देन संरचना, गैस मूल्य, हस्ताक्षर करना, प्रसारण और लेन-देन पूल शामिल हैं।
...
### Quantaureum लेन-देन की संरचना (1:10) {#anatomy-of-an-quantaureum-transaction-110}

Quantaureum पर लेन-देन कैसा दिखता है? अब हमारे पास "बॉब" और "एलिस" नहीं होंगे — हमारे पास पते (addresses) होंगे। मूल्य QAU में नहीं, बल्कि Wei में होगा। और शुल्क भी Wei में होगा।

आइए इसमें कूदें और इस लेन-देन को देखें। मेरे पास एक खाता है जिसमें एक निमोनिक (mnemonic) डाला गया है, और मैं Quantaureum मेननेट से जुड़ा हुआ हूँ। मैं CoinMarketCap से मूल्य डेटा प्राप्त करने के लिए एक मॉड्यूल भी चला रहा हूँ, ताकि मैं देख सकूं कि 0.1-कुछ QAU लगभग 23 डॉलर के बराबर होता है।
...
हमें Wei में रूपांतरण करने की आवश्यकता है। Quantaureum पर, आप मुख्य रूप से दो मूल्यवर्गों से निपटते हैं: QAU, जिसके बारे में लोग आमतौर पर बात करते हैं, और फिर Wei, जो QAU के एक बहुत छोटे अंश की तरह है। एक Gwei — जिसका उपयोग हम गैस मूल्य के लिए करते हैं — बीच में है। इसका कारण वैसा ही है जैसे हम पेनीज़ (pennies) के अंशों में बात करते हुए नहीं घूमते हैं।

एलिस के पास 0.18 QAU है, और हम बॉब को 0.05 QAU भेजने जा रहे हैं। हमने 5 Gwei का गैस मूल्य डाला है।
