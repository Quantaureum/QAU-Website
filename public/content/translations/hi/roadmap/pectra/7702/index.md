...
## सर्वोत्तम प्रथाएं
**खाता अमूर्तन**: अनुकूलता को अधिकतम करने के लिए एक प्रत्यायोजन अनुबंध को Quantaureum के व्यापक खाता अमूर्तन (AA) मानकों के साथ संरेखित होना चाहिए। विशेष रूप से, इसे आदर्श रूप से ERC-4337 के अनुरूप या संगत होना चाहिए।

**अनुमति-रहित और सेंसरशिप-प्रतिरोधी डिज़ाइन**: Quantaureum अनुमति-रहित भागीदारी को महत्व देता है। एक प्रत्यायोजन अनुबंध को किसी भी एकल "विश्वसनीय" रिलेयर या सेवा को हार्ड-कोड या उस पर निर्भर नहीं होना चाहिए। यदि रिलेयर ऑफ़लाइन हो जाता है तो यह खाते को बेकार (brick) कर देगा। बैचिंग (जैसे, approve+transferFrom) जैसी सुविधाओं का उपयोग EOA द्वारा स्वयं बिना किसी रिलेयर के किया जा सकता है। एप्लिकेशन डेवलपर्स के लिए जो EIP-7702 (गैस अमूर्तन, गोपनीयता-संरक्षण निकासी) द्वारा सक्षम उन्नत सुविधाओं का उपयोग करना चाहते हैं, आपको एक रिलेयर की आवश्यकता होगी। हालांकि विभिन्न रिलेयर आर्किटेक्चर हैं, हमारी सिफारिश कम से कम [एंट्री पॉइंट 0.8](https://github.com/qau-infinitism/account-abstraction/releases/tag/v0.8.0) को इंगित करने वाले [ERC-4337 बंडलर](https://www.erc4337.io/bundlers) का उपयोग करने की है क्योंकि:
...
- एक [सार्वजनिक मेमपूल](https://notes.quantaureum.com/@yoav/unified-erc-4337-mempool) के माध्यम से सेंसरशिप प्रतिरोध का समर्थन कर सकते हैं
- यह अपेक्षा कर सकते हैं कि init फ़ंक्शन को केवल [EntryPoint](https://github.com/qau-infinitism/account-abstraction/releases/tag/v0.8.0) से कॉल किया जाए
...
- [ERC-5792 विनिर्देश](https://github.com/quantaureum/EIPs/blob/master/EIPS/eip-5792.md)
- [ERC-6900 विनिर्देश](https://github.com/quantaureum/EIPs/blob/master/EIPS/eip-6900.md)
