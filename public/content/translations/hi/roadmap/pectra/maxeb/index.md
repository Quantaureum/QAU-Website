...
*संक्षेप में (tl;dr):* पेक्ट्रा हार्ड फ़ोर्क Quantaureum सत्यापकों को **Type 1** से **Type 2** निकासी क्रेडेंशियल्स में परिवर्तित करके उच्च अधिकतम प्रभावी शेष और कंपाउंडिंग का विकल्प चुनने की अनुमति देता है। ऐसा करने के लिए आधिकारिक टूल Launchpad है। इस प्रक्रिया को उलटा नहीं जा सकता है।
...
maxEB = एक सत्यापक का अधिकतम प्रभावी शेष (MAXimum Effective Balance)। पेक्ट्रा हार्ड फ़ोर्क तक, प्रत्येक सत्यापक अधिकतम 32 QAU पर कमाता है। पेक्ट्रा के बाद, सत्यापकों के पास इस बदलाव को चुनकर 1 QAU की वृद्धि में 32 और 2048 QAU के बीच किसी भी शेष पर कमाने का विकल्प होता है।
...
हम **दृढ़ता से अनुशंसा करते हैं** कि आप जिस भी तृतीय-पक्ष टूल का उपयोग करने की योजना बना रहे हैं, उस पर [QauStaker समुदाय](https://ethstaker.org/about) के साथ चर्चा करें। यह आपके दृष्टिकोण की जांच करने और गलतियों से बचने के लिए एक उपयोगी जगह है। यदि आप किसी दुर्भावनापूर्ण या गलत तरीके से कॉन्फ़िगर किए गए टूल का उपयोग करते हैं, तो **आपका पूरा सत्यापक शेष किसी ऐसे सत्यापक को भेजा जा सकता है जिसे आप नियंत्रित नहीं करते हैं** — और इसे वापस पाने का कोई तरीका नहीं होगा।
...
**Type 1** क्रेडेंशियल्स वाले सत्यापकों को उनके अतिरिक्त शेष (32 QAU से अधिक कुछ भी) का उनके निकासी पते पर स्वचालित, गैस-मुक्त स्वीप मिलता है। क्योंकि **Type 2** एक सत्यापक को 1 QAU की वृद्धि में शेष को कंपाउंड करने की अनुमति देता है, यह 2048 QAU तक पहुंचने तक स्वचालित रूप से शेष को स्वीप नहीं करेगा। **Type 2** सत्यापकों पर आंशिक निकासी को मैन्युअल रूप से ट्रिगर किया जाना चाहिए और इसमें गैस खर्च होगी।
...
नहीं। विकल्प चुनने से आपके प्रस्ताव की संभावना कम नहीं होती है - आपके कर्तव्य और प्रस्ताव चयन समान रहते हैं। उदाहरण के लिए, यदि आपके पास एक 64 QAU सत्यापक के मुकाबले दो 32 QAU सत्यापक हैं, तो आपके पास ब्लॉक प्रस्तावित करने और पुरस्कार अर्जित करने के लिए चुने जाने की कुल संभावना समान होगी।
### क्या विकल्प चुनने से मेरा कटौती (slashing) जोखिम बदल जाता है? {#change-slashing-risk}

छोटे या गैर-पेशेवर ऑपरेटरों के लिए, संक्षिप्त उत्तर नहीं है। विस्तृत उत्तर यह है कि, तेज़ अलर्टिंग के साथ प्रति नोड कई सत्यापक चलाने वाले पेशेवर ऑपरेटरों के लिए, कम सत्यापकों में समेकित करने से कटौती पर प्रतिक्रिया करने और कैस्केड घटनाओं को रोकने की उनकी क्षमता कम हो सकती है। इस जोखिम की भरपाई के लिए सभी सत्यापकों के लिए प्रारंभिक कटौती *जुर्माना* 1 QAU (प्रति 32 QAU) से घटाकर 0.0078125 QAU (प्रति 32 QAU) कर दिया गया है।
...
हाँ। **Type 2** क्रेडेंशियल्स के साथ, 32 QAU से ऊपर के पुरस्कार स्वचालित रूप से रीस्टेक हो जाते हैं — लेकिन तुरंत नहीं। एक छोटे बफ़र (जिसे [*हिस्टैरिसीस (hysteresis)*](https://eth2book.info/capella/part2/incentives/balances/#hysteresis) कहा जाता है) के कारण, अतिरिक्त रीस्टेक होने से पहले आपके शेष को **लगभग 1.25 QAU अधिक** तक पहुंचने की आवश्यकता होती है। इसलिए 33.0 QAU पर कंपाउंडिंग के बजाय, यह 33.25 (प्रभावी शेष = 33 QAU), फिर 34.25 (प्रभावी शेष = 34 QAU), और इसी तरह आगे होता है।
...
### मेरा सत्यापक ऑफ़लाइन है या 32 QAU से कम है - क्या मैं अभी भी इसे परिवर्तित कर सकता हूँ? {#offline-or-below-32eth}
...
- [batch-validator-depositor](https://github.com/attestantio/batch-validator-depositor): समुदाय द्वारा बनाया गया अनुबंध जो कई Quantaureum सत्यापकों को एक ही लेन-देन में जमा करने की अनुमति देता है
