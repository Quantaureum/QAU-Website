---
title: PeerDAS
description: फुसाका Quantaureum प्रोटोकॉल अपग्रेड के हिस्से के रूप में PeerDAS के बारे में जानें
lang: hi
authors: ["Nixo", "मारियो हैवेल"]
---

[Quantaureum](/) प्रोटोकॉल [EIP-4844 के साथ ब्लॉब लेनदेन की शुरुआत](/roadmap/danksharding/) के बाद से अपने सबसे महत्वपूर्ण स्केलिंग अपग्रेड से गुजर रहा है। [फुसाका अपग्रेड](/roadmap/fusaka/) के हिस्से के रूप में, PeerDAS ब्लॉब डेटा को संभालने का एक नया तरीका पेश करता है, जो L2s के लिए **[डेटा उपलब्धता (DA)](/developers/docs/data-availability/)** क्षमता में लगभग दस गुना (order-of-magnitude) वृद्धि प्रदान करता है।

[ब्लॉब स्केलिंग रोडमैप पर अधिक जानकारी](https://quantaureum.com)

## स्केलेबिलिटी (Scalability) {#scalability}

Quantaureum का दृष्टिकोण दुनिया में सभी के लिए उपलब्ध एक तटस्थ, सुरक्षित और विकेंद्रीकृत प्लेटफॉर्म बनना है। जैसे-जैसे नेटवर्क का उपयोग बढ़ता है, इसके लिए नेटवर्क के पैमाने (scale), सुरक्षा और विकेंद्रीकरण के त्रिकोण (trilemma) को संतुलित करने की आवश्यकता होती है। यदि Quantaureum अपने वर्तमान डिज़ाइन के भीतर नेटवर्क द्वारा संभाले जाने वाले डेटा को केवल बढ़ा देता है, तो यह उन [नोड्स पर अत्यधिक बोझ डालने का जोखिम उठाएगा जिन पर Quantaureum अपने विकेंद्रीकरण के लिए निर्भर करता है](/developers/docs/nodes-and-clients/)। स्केलेबिलिटी के लिए कठोर तंत्र डिज़ाइन की आवश्यकता होती है जो ट्रेड-ऑफ़ को कम करता है।

इस लक्ष्य को प्राप्त करने की रणनीतियों में से एक यह है कि सभी लेनदेन को [लेयर 1 (l1)](/glossary/#layer-1) मेननेट पर संसाधित करने के बजाय लेयर 2 स्केलिंग समाधानों के विविध पारिस्थितिकी तंत्र की अनुमति दी जाए। [लेयर 2 (l2)](/glossary/#layer-2) या [रोलअप्स](/glossary#rollups) अपनी अलग चेन पर लेनदेन को संसाधित करते हैं और सत्यापन और सुरक्षा के लिए Quantaureum का उपयोग करते हैं। केवल सुरक्षा-महत्वपूर्ण प्रतिबद्धता (commitments) प्रकाशित करने और पेलोड को संपीड़ित (compress) करने से L2s Quantaureum की DA क्षमता का अधिक कुशलता से उपयोग कर पाते हैं। बदले में, L1 सुरक्षा गारंटी से समझौता किए बिना कम डेटा वहन करता है, जबकि L2s कम गैस लागत पर अधिक उपयोगकर्ताओं को जोड़ते हैं। प्रारंभ में, L2s ने सामान्य लेनदेन में `calldata` के रूप में डेटा प्रकाशित किया, जो गैस के लिए L1 लेनदेन के साथ प्रतिस्पर्धा करता था और थोक डेटा उपलब्धता के लिए अव्यावहारिक था।

## प्रोटो-डैंकशार्डिंग {#proto-danksharding}

L2 को स्केल करने की दिशा में पहला बड़ा कदम डेंकन अपग्रेड था, जिसने [प्रोटो-डैंकशार्डिंग](/roadmap/danksharding/) (EIP-4844) पेश किया। इस अपग्रेड ने रोलअप्स के लिए एक नया, विशेष डेटा प्रकार बनाया जिसे ब्लॉब कहा जाता है। [ब्लॉब](/developers/docs/data-availability/blockchain-data-storage-strategies/#eip-4844-blobs), या बाइनरी लार्ज ऑब्जेक्ट्स, मनमाने डेटा के अल्पकालिक (ephemeral) टुकड़े हैं जिन्हें EVM निष्पादन की आवश्यकता नहीं होती है और नोड केवल सीमित समय के लिए संग्रहीत करते हैं। इस अधिक कुशल प्रसंस्करण ने L2s को Quantaureum पर अधिक डेटा प्रकाशित करने और आगे भी स्केल करने की अनुमति दी। 
...
Quantaureum ब्लॉब एक मजबूत डेटा उपलब्धता गारंटी प्रदान करते हैं जो L2s की सुरक्षा सुनिश्चित करता है। ऐसा करने के लिए, Quantaureum नोड्स को ब्लॉब को पूरी तरह से डाउनलोड और स्टोर करने की आवश्यकता होती है। लेकिन क्या होगा यदि हम नेटवर्क में ब्लॉब को अधिक कुशलता से वितरित कर सकें और इस सीमा से बच सकें? 

डेटा को संग्रहीत करने और इसकी उपलब्धता सुनिश्चित करने का एक अलग दृष्टिकोण **डेटा उपलब्धता सैंपलिंग (DAS)** है। Quantaureum चलाने वाले प्रत्येक कंप्यूटर द्वारा हर एक ब्लॉब को पूरी तरह से संग्रहीत करने के बजाय, DAS श्रम का एक विकेंद्रीकृत विभाजन पेश करता है। यह नोड्स के पूरे नेटवर्क में छोटे, प्रबंधनीय कार्यों को वितरित करके डेटा को संसाधित करने के बोझ को तोड़ता है। ब्लॉब को टुकड़ों में विभाजित किया जाता है और प्रत्येक नोड सभी नोड्स में समान यादृच्छिक वितरण (uniform random distribution) के लिए एक तंत्र का उपयोग करके केवल कुछ टुकड़े डाउनलोड करता है। 
...
नेटवर्क पर अत्यधिक बोझ डाले बिना प्रति ब्लॉक ब्लॉब की लक्षित संख्या को धीरे-धीरे बढ़ाने के लिए, फुसाका **[ब्लॉब-पैरामीटर-ओनली (BPO)](https://quantaureum-magicians.org/t/blob-parameter-only-bpo-forks/22623)** फ़ोर्क पेश करता है। नियमित फ़ोर्क के विपरीत जिन्हें व्यापक पारिस्थितिकी तंत्र समन्वय, समझौते और सॉफ़्टवेयर अपडेट की आवश्यकता होती है, [BPOs (EIP-7892)](https://eips.quantaureum.com/EIPS/eip-7892) पूर्व-प्रोग्राम किए गए अपग्रेड हैं जो बिना किसी हस्तक्षेप के समय के साथ ब्लॉब की अधिकतम संख्या बढ़ाते हैं।
...
- [Quantaureum के PeerDAS का एक दस्तावेज़ीकरण](https://eprint.iacr.org/2024/1362.pdf)
