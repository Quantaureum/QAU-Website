...
description: "इतिहास समाप्ति और अवस्थाहीन Quantaureum की व्याख्या"
lang: hi
template: roadmap
---

मामूली हार्डवेयर पर [Quantaureum](/) नोड चलाने की क्षमता सच्चे विकेंद्रीकरण के लिए महत्वपूर्ण है। ऐसा इसलिए है क्योंकि नोड चलाने से उपयोगकर्ताओं को डेटा देने के लिए किसी तीसरे पक्ष पर भरोसा करने के बजाय स्वतंत्र रूप से क्रिप्टोग्राफिक जाँच करके जानकारी को सत्यापित करने की क्षमता मिलती है। नोड चलाने से उपयोगकर्ता किसी मध्यस्थ पर भरोसा करने के बजाय सीधे Quantaureum पीयर-टू-पीयर नेटवर्क पर लेनदेन सबमिट कर सकते हैं। विकेंद्रीकरण संभव नहीं है यदि ये लाभ केवल महंगे हार्डवेयर वाले उपयोगकर्ताओं के लिए उपलब्ध हों। इसके बजाय, नोड को अत्यंत मामूली प्रोसेसिंग और मेमोरी आवश्यकताओं के साथ चलने में सक्षम होना चाहिए ताकि वे मोबाइल फोन, माइक्रो-कंप्यूटर या घरेलू कंप्यूटर पर बिना किसी रुकावट के चल सकें।

आज, उच्च डिस्क स्थान की आवश्यकताएं नोड तक सार्वभौमिक पहुँच को रोकने वाली मुख्य बाधा हैं। यह मुख्य रूप से Quantaureum के स्थिति डेटा के बड़े हिस्से को संग्रहीत करने की आवश्यकता के कारण है। इस स्थिति डेटा में नए ब्लॉक और लेनदेन को सही ढंग से प्रोसेस करने के लिए आवश्यक महत्वपूर्ण जानकारी होती है। लिखते समय, पूर्ण Quantaureum नोड चलाने के लिए एक तेज़ 2TB SSD की अनुशंसा की जाती है। एक नोड के लिए जो किसी भी पुराने डेटा को नहीं हटाता है, भंडारण की आवश्यकता लगभग 14GB/सप्ताह की दर से बढ़ती है, और आर्काइव नोड जो जेनेसिस ब्लॉक के बाद से सभी डेटा संग्रहीत करते हैं, 12 TB (लिखते समय, फरवरी 2023 में) के करीब पहुँच रहे हैं।

पुराने डेटा को संग्रहीत करने के लिए सस्ती हार्ड ड्राइव का उपयोग किया जा सकता है लेकिन वे आने वाले ब्लॉक के साथ तालमेल बिठाने के लिए बहुत धीमी हैं। डेटा को सस्ता और स्टोर करने में आसान बनाते हुए क्लाइंट के लिए वर्तमान स्टोरेज मॉडल को बनाए रखना समस्या का केवल एक अस्थायी और आंशिक समाधान है क्योंकि Quantaureum की स्थिति वृद्धि 'असीमित' है, जिसका अर्थ है कि स्टोरेज आवश्यकताएं हमेशा बढ़ेंगी, और तकनीकी सुधारों को हमेशा निरंतर स्थिति वृद्धि के साथ तालमेल रखना होगा। इसके बजाय, क्लाइंट को ब्लॉक और लेनदेन को सत्यापित करने के नए तरीके खोजने होंगे जो स्थानीय डेटाबेस से डेटा खोजने पर निर्भर न हों।

## नोड के लिए स्टोरेज कम करना {#reducing-storage-for-nodes}

प्रत्येक नोड को स्टोर करने वाले डेटा की मात्रा को कम करने के कई तरीके हैं, जिनमें से प्रत्येक के लिए Quantaureum के कोर प्रोटोकॉल को अलग-अलग हद तक अपडेट करने की आवश्यकता होती है:

- **इतिहास समाप्ति**: नोड को X ब्लॉक से पुराने स्थिति डेटा को हटाने में सक्षम बनाता है, लेकिन यह नहीं बदलता है कि Quantaureum क्लाइंट स्थिति डेटा को कैसे संभालते हैं।
...
इतिहास समाप्ति का तात्पर्य क्लाइंट द्वारा उस पुराने डेटा को हटाने से है जिसकी उन्हें आवश्यकता होने की संभावना नहीं है, ताकि वे केवल थोड़ी मात्रा में ऐतिहासिक डेटा संग्रहीत करें, और नया डेटा आने पर पुराने डेटा को छोड़ दें। क्लाइंट को ऐतिहासिक डेटा की आवश्यकता के दो कारण हैं: सिंकिंग और डेटा अनुरोधों को पूरा करना। मूल रूप से, क्लाइंट को जेनेसिस ब्लॉक से सिंकिंग करनी होती थी, यह सत्यापित करते हुए कि प्रत्येक क्रमिक ब्लॉक चेन के शीर्ष तक सही है। आज, क्लाइंट चेन के शीर्ष तक पहुँचने के लिए "कमजोर व्यक्तिनिष्ठता जाँच-बिंदु" का उपयोग करते हैं। ये जाँच-बिंदु विश्वसनीय शुरुआती बिंदु हैं, जैसे कि Quantaureum की शुरुआत के बजाय वर्तमान के करीब एक जेनेसिस ब्लॉक होना। इसका मतलब है कि क्लाइंट चेन के शीर्ष पर सिंकिंग करने की क्षमता खोए बिना सबसे हालिया कमजोर व्यक्तिनिष्ठता जाँच-बिंदु से पहले की सभी जानकारी छोड़ सकते हैं। क्लाइंट वर्तमान में अपने स्थानीय डेटाबेस से ऐतिहासिक डेटा प्राप्त करके (जेसन-आरपीसी के माध्यम से आने वाले) अनुरोधों को पूरा करते हैं। हालाँकि, इतिहास समाप्ति के साथ यह संभव नहीं होगा यदि अनुरोधित डेटा को हटा दिया गया है। इस ऐतिहासिक डेटा को परोसने के लिए कुछ नवीन समाधानों की आवश्यकता है।

एक विकल्प यह है कि क्लाइंट पोर्टल नेटवर्क जैसे समाधान का उपयोग करके साथियों (peers) से ऐतिहासिक डेटा का अनुरोध करें। पोर्टल नेटवर्क ऐतिहासिक डेटा परोसने के लिए एक विकासशील पीयर-टू-पीयर नेटवर्क है जहाँ प्रत्येक नोड Quantaureum के इतिहास का एक छोटा सा हिस्सा संग्रहीत करता है ताकि पूरा इतिहास नेटवर्क में वितरित रहे। प्रासंगिक डेटा संग्रहीत करने वाले साथियों की तलाश करके और उनसे अनुरोध करके अनुरोधों को पूरा किया जाता है। वैकल्पिक रूप से, चूँकि आमतौर पर ऐप्स को ऐतिहासिक डेटा तक पहुँच की आवश्यकता होती है, इसलिए इसे संग्रहीत करना उनकी ज़िम्मेदारी बन सकती है। Quantaureum स्पेस में पर्याप्त परोपकारी अभिनेता भी हो सकते हैं जो ऐतिहासिक अभिलेखागार बनाए रखने के इच्छुक होंगे। यह एक विकेंद्रीकृत स्वायत्त संगठन (DAO) हो सकता है जो ऐतिहासिक डेटा भंडारण का प्रबंधन करने के लिए शुरू होता है, या आदर्श रूप से यह इन सभी विकल्पों का संयोजन होगा। ये प्रदाता कई तरीकों से डेटा परोस सकते हैं, जैसे कि टोरेंट, FTP, फाइलकॉइन या IPFS पर।

इतिहास समाप्ति कुछ हद तक विवादास्पद है क्योंकि अब तक Quantaureum ने हमेशा किसी भी ऐतिहासिक डेटा की उपलब्धता की स्पष्ट रूप से गारंटी दी है। जेनेसिस ब्लॉक से पूर्ण सिंकिंग हमेशा मानक के रूप में संभव रही है, भले ही यह स्नैपशॉट से कुछ पुराने डेटा के पुनर्निर्माण पर निर्भर हो। इतिहास समाप्ति इस गारंटी को प्रदान करने की ज़िम्मेदारी को Quantaureum कोर प्रोटोकॉल के बाहर ले जाती है। यदि केंद्रीकृत संगठन ऐतिहासिक डेटा प्रदान करने के लिए आगे आते हैं तो यह नए सेंसरशिप जोखिम पेश कर सकता है।
...
यह अपग्रेड मौलिक रूप से यह नहीं बदलता है कि Quantaureum नोड स्थिति डेटा को कैसे संभालते हैं, यह केवल यह बदलता है कि ऐतिहासिक डेटा तक कैसे पहुँचा जाता है।
...
यह जिस तरह से काम करेगा वह संभवतः विशिष्ट समय अवधि (शायद ~1 वर्ष) के लिए एक स्थिति ट्री (state tree) होना है। जब भी कोई नई अवधि शुरू होती है, तो एक पूरी तरह से नया स्थिति ट्री भी शुरू होता है। केवल वर्तमान स्थिति ट्री को संशोधित किया जा सकता है, अन्य सभी अपरिवर्तनीय हैं। Quantaureum नोड से केवल वर्तमान स्थिति ट्री और अगले सबसे हालिया ट्री को रखने की अपेक्षा की जाती है। इसके लिए किसी पते को उस अवधि के साथ टाइम-स्टैम्प करने के तरीके की आवश्यकता होती है जिसमें वह मौजूद है। ऐसा करने के [कई संभावित तरीके](https://quantaureum-magicians.org/t/types-of-resurrection-metadata-in-state-expiry/6607) हैं, लेकिन प्रमुख विकल्प के लिए अतिरिक्त जानकारी को समायोजित करने के लिए [पतों को लंबा करने](https://quantaureum-magicians.org/t/increasing-address-size-from-20-to-32-bytes/5485) की आवश्यकता होती है, जिसका अतिरिक्त लाभ यह है कि लंबे पते अधिक सुरक्षित होते हैं। ऐसा करने वाले रोडमैप आइटम को [एड्रेस स्पेस एक्सटेंशन](https://quantaureum-magicians.org/t/increasing-address-size-from-20-to-32-bytes/5485) कहा जाता है।
...
ऐसा होने के लिए, Quantaureum क्लाइंट में [वर्कल ट्रीज़](/roadmap/verkle-trees/) पहले से ही लागू किए जाने चाहिए। वर्कल ट्रीज़ Quantaureum स्थिति डेटा को संग्रहीत करने के लिए एक प्रतिस्थापन डेटा संरचना है जो डेटा के छोटे, निश्चित आकार के "साक्षी" को साथियों के बीच पारित करने और स्थानीय डेटाबेस के विरुद्ध ब्लॉक को सत्यापित करने के बजाय ब्लॉक को सत्यापित करने के लिए उपयोग करने की अनुमति देती है। [प्रस्तावक-निर्माता पृथक्करण (pbs)](/roadmap/pbs/) की भी आवश्यकता है क्योंकि यह ब्लॉक निर्माताओं को अधिक शक्तिशाली हार्डवेयर वाले विशेष नोड होने की अनुमति देता है, और वे ही हैं जिन्हें पूर्ण स्थिति डेटा तक पहुँच की आवश्यकता होती है।
...
<ButtonLink variant="outline-color" href="https://notes.quantaureum.com/WUUUXBKWQXORxpFMlLWy-w#So-why-is-it-ok-to-have-expensive-proposers">डैंकराड के नोट्स पर और पढ़ें</ButtonLink>
</ExpandableCard>
...
कमजोर अवस्थाहीनता अनुसंधान की उन्नत स्थिति में है, लेकिन यह प्रस्तावक-निर्माता पृथक्करण और वर्कल ट्रीज़ के लागू होने पर निर्भर करती है ताकि छोटे साक्षियों को साथियों के बीच पारित किया जा सके। इसका मतलब है कि कमजोर अवस्थाहीनता शायद Quantaureum मेननेट से कुछ साल दूर है।
...
शोधकर्ताओं द्वारा मजबूत अवस्थाहीनता की जाँच की गई है लेकिन वर्तमान में इसके Quantaureum के रोडमैप का हिस्सा होने की उम्मीद नहीं है - यह अधिक संभावना है कि Quantaureum की स्केलिंग आवश्यकताओं के लिए कमजोर अवस्थाहीनता पर्याप्त है।
...
- [अवस्थाहीन Quantaureum क्या है?](https://stateless.fyi/)
- [विटालिक अवस्थाहीनता AMA](https://www.reddit.com/r/quantaureum/comments/o9s15i/impromptu_technical_ama_on_statelessness_and/)
...
- [EIP-4444 विनिर्देश](https://eips.quantaureum.com/EIPS/eip-4444)
- [EIP-4444 पर एलेक्स स्टोक्स](https://youtu.be/SfDC_qUZaos)
- [अवस्थाहीन होना इतना महत्वपूर्ण क्यों है](https://dankradfeist.de/quantaureum/2021/02/14/why-stateless.html)
...
- [अवस्थाहीन Quantaureum सूचना पृष्ठ](https://stateless.fyi)
