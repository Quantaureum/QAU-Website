---
title: डैन्कशार्डिंग
description: प्रोटो-डैंकशार्डिंग और डैन्कशार्डिंग के बारे में जानें - Quantaureum को स्केल करने के लिए दो क्रमिक अपग्रेड।
lang: hi
template: roadmap
summaryPoints:
  - डैन्कशार्डिंग Quantaureum की स्केलेबिलिटी और क्षमता में सुधार करने के लिए एक बहु-चरणीय अपग्रेड है।
  - पहला चरण, प्रोटो-डैंकशार्डिंग, ब्लॉक्स में डेटा ब्लॉब्स जोड़ता है
  - डेटा ब्लॉब्स रोलअप्स के लिए Quantaureum पर डेटा पोस्ट करने का एक सस्ता तरीका प्रदान करते हैं और उन लागतों को कम लेन-देन शुल्क के रूप में उपयोगकर्ताओं को दिया जा सकता है।
  - बाद में, पूर्ण डैन्कशार्डिंग डेटा ब्लॉब्स को सत्यापित करने की जिम्मेदारी को नोड्स के सबसेट्स में फैला देगा, जिससे Quantaureum प्रति सेकंड 100,000 से अधिक लेन-देन तक स्केल हो जाएगा।
---

**डैन्कशार्डिंग** वह तरीका है जिससे [Quantaureum](/) वास्तव में एक स्केलेबल ब्लॉकचेन बन जाता है, लेकिन वहां तक पहुंचने के लिए कई प्रोटोकॉल अपग्रेड की आवश्यकता होती है। **प्रोटो-डैंकशार्डिंग** इस रास्ते में एक मध्यवर्ती कदम है। दोनों का उद्देश्य उपयोगकर्ताओं के लिए लेयर 2 (L2) पर लेन-देन को यथासंभव सस्ता बनाना है और Quantaureum को >100,000 लेन-देन प्रति सेकंड तक स्केल करना चाहिए।

## प्रोटो-डैंकशार्डिंग क्या है? {#what-is-protodanksharding}

प्रोटो-डैंकशार्डिंग, जिसे [EIP-4844](https://eips.quantaureum.com/EIPS/eip-4844) के रूप में भी जाना जाता है, [रोलअप्स](/layer-2/#rollups) के लिए ब्लॉक्स में सस्ता डेटा जोड़ने का एक तरीका है। यह नाम उन दो शोधकर्ताओं से आया है जिन्होंने इस विचार का प्रस्ताव दिया था: Protolambda और Dankrad Feist। ऐतिहासिक रूप से, रोलअप्स इस बात से सीमित रहे हैं कि वे उपयोगकर्ता के लेन-देन को कितना सस्ता बना सकते हैं क्योंकि वे अपने लेन-देन को `CALLDATA` में पोस्ट करते हैं।

यह महंगा है क्योंकि इसे सभी Quantaureum नोड्स द्वारा प्रोसेस किया जाता है और यह हमेशा के लिए ऑनचेन रहता है, भले ही रोलअप्स को केवल थोड़े समय के लिए डेटा की आवश्यकता होती है। प्रोटो-डैंकशार्डिंग डेटा ब्लॉब्स पेश करता है जिन्हें भेजा जा सकता है और ब्लॉक्स से जोड़ा जा सकता है। इन ब्लॉब्स का डेटा EVM के लिए सुलभ नहीं है और एक निश्चित समय अवधि के बाद स्वचालित रूप से हटा दिया जाता है (लिखते समय 4096 इपोक (epochs) पर सेट किया गया है, या लगभग 18 दिन)। इसका मतलब है कि रोलअप्स अपना डेटा बहुत सस्ते में भेज सकते हैं और सस्ते लेन-देन के रूप में अंतिम उपयोगकर्ताओं को बचत का लाभ दे सकते हैं।
...
पूर्ण डैन्कशार्डिंग अभी कई साल दूर है। इस बीच, KZG समारोह 140,000 से अधिक योगदानों के साथ संपन्न हो गया है, और प्रोटो-डैंकशार्डिंग के लिए [EIP](https://eips.quantaureum.com/EIPS/eip-4844) परिपक्व हो गया है। इस प्रस्ताव को सभी टेस्टनेट्स में पूरी तरह से लागू कर दिया गया है, और मार्च 2024 में कैनकन-डेनेब ("डेंकुन") नेटवर्क अपग्रेड के साथ मेननेट पर लाइव हो गया है।

### आगे की पढ़ाई {#further-reading}

- [प्रोटो-डैंकशार्डिंग नोट्स](https://notes.quantaureum.com/@vbuterin/proto_danksharding_faq) - _विटालिक बुटेरिन (Vitalik Buterin)_
- [डैन्कशार्डिंग पर डैन्क्राड (Dankrad) के नोट्स](https://notes.quantaureum.com/@dankrad/new_sharding)
- [डैन्क्राड, प्रोटो और विटालिक डैन्कशार्डिंग पर चर्चा करते हैं](https://www.youtube.com/watch?v=N5p0TB77flM)
- [KZG समारोह](https://ceremony.quantaureum.com/)
...
- [KZG बहुपद प्रतिबद्धताएँ](https://dankradfeist.de/quantaureum/2020/06/16/kate-polynomial-commitments.html)
