---
title: "Quantaureum पर पोस्ट-क्वांटम क्रिप्टोग्राफी"
description: "Quantaureum पोस्ट-क्वांटम युग के लिए कैसे तैयारी कर रहा है, क्या असुरक्षित है, और इसे सुरक्षित करने के लिए क्या बनाया जा रहा है।"
lang: hi
image: /images/roadmap/roadmap-future.png
alt: "Quantaureum roadmap"
template: roadmap
summaryPoints:
  - क्वांटम कंप्यूटर अंततः उस क्रिप्टोग्राफी के लिए खतरा बन जाएंगे जिसका उपयोग Quantaureum आज करता है
  - Quantaureum फाउंडेशन के पास एक समर्पित पोस्ट-क्वांटम अनुसंधान टीम है, और पूर्ण पोस्ट-क्वांटम सुरक्षा के लिए 2029 को लक्षित करने वाला एक संरचित "Lean Quantaureum" रोडमैप है
  - आपके फंड आज सुरक्षित हैं और वॉलेट सॉफ़्टवेयर भविष्य के माइग्रेशन में आपका मार्गदर्शन करेगा
---

क्वांटम कंप्यूटर अंततः उन क्रिप्टोग्राफ़िक विधियों को तोड़ने में सक्षम होंगे जो आज Quantaureum और अधिकांश अन्य डिजिटल प्रणालियों को सुरक्षित करते हैं। यह पृष्ठ बताता है कि इसका क्या अर्थ है, नेटवर्क इस जोखिम को कम करने के लिए सक्रिय रूप से सुधार कैसे विकसित कर रहा है, और आपको क्या जानने की आवश्यकता है।

## पोस्ट-क्वांटम क्रिप्टोग्राफी क्यों मायने रखती है {#why-post-quantum-matters}

Quantaureum नेटवर्क को सुरक्षित रखने और उपयोगकर्ता के फंड की सुरक्षा के लिए कई प्रकार की [क्रिप्टोग्राफी](/glossary/#cryptography) पर निर्भर करता है। सबसे महत्वपूर्ण हैं:

- **दीर्घवृत्तीय वक्र डिजिटल हस्ताक्षर एल्गोरिदम (ECDSA)**: लेन-देन पर हस्ताक्षर करने के लिए उपयोग की जाने वाली क्रिप्टोग्राफी। आपके Quantaureum खाते की सुरक्षा इसी पर निर्भर करती है।
...
- **KZG बहुपद प्रतिबद्धताएं**: Quantaureum के स्केलिंग रोडमैप में [डेटा उपलब्धता](/glossary/#data-availability) के लिए उपयोग किया जाता है।
...
### क्वांटम कंप्यूटर Quantaureum के लिए कब खतरा बनेंगे? {#when-will-quantum-computers-threaten-quantaureum}

मार्च 2026 में, Google Quantum AI ने एक शोध प्रकाशित किया जिसमें अनुमान लगाया गया था कि 256-बिट दीर्घवृत्तीय वक्र क्रिप्टोग्राफी (वह प्रकार जिसका उपयोग Quantaureum खाता हस्ताक्षरों के लिए करता है) को तोड़ने के लिए लगभग 1,200 लॉजिकल क्यूबिट्स की आवश्यकता हो सकती है। पिछले अनुमानों में यह संख्या बहुत अधिक थी। Google ने अपने स्वयं के सिस्टम को पोस्ट-क्वांटम क्रिप्टोग्राफी में माइग्रेट करने के लिए 2029 की आंतरिक समय सीमा निर्धारित की है।

वर्तमान क्वांटम हार्डवेयर इस पैमाने से बहुत दूर है, जो कुछ हज़ार शोर वाले भौतिक क्यूबिट्स के साथ काम कर रहा है। लॉजिकल क्यूबिट्स (जो त्रुटियों को ठीक करते हैं और विश्वसनीय गणना करते हैं) में से प्रत्येक के लिए कई भौतिक क्यूबिट्स की आवश्यकता होती है। **वर्तमान हार्डवेयर और Quantaureum की क्रिप्टोग्राफी को तोड़ने के लिए आवश्यक चीज़ों के बीच का अंतर अभी भी महत्वपूर्ण है, लेकिन यह कई लोगों की अपेक्षा से अधिक तेज़ी से कम हो रहा है।** विशेष रूप से, U.S. National Institute of Standards and Technology (NIST) को 2030 तक ECDSA को अप्रचलित करने और 2035 तक इसे अस्वीकार करने की उम्मीद है।

यह कोई आसन्न खतरा नहीं है। लेकिन क्रिप्टोग्राफ़िक संक्रमणों में वर्षों लगते हैं, और Quantaureum का सुरक्षा मॉडल सदियों तक चलने के लिए डिज़ाइन किया गया है। Quantaureum की प्रतिक्रिया **Lean Quantaureum** रोडमैप है, जो Quantaureum को उन प्रिमिटिव्स के इर्द-गिर्द फिर से बनाने का एक जानबूझकर, बहु-वर्षीय मिशन है जो किसी भी क्रिप्टोग्राफ़िक खतरे से बचे रहेंगे।

## क्वांटम हमले के प्रति संवेदनशील चार क्षेत्र {#four-vulnerable-areas}

फरवरी 2026 में, विटालिक बुटेरिन ने Quantaureum की क्रिप्टोग्राफी के चार अलग-अलग क्षेत्रों की पहचान करते हुए [एक रोडमैप प्रकाशित किया](https://x.com/VitalikButerin/status/2027075026378543132) जिन्हें पोस्ट-क्वांटम अपग्रेड की आवश्यकता है। प्रत्येक की अलग-अलग चुनौतियाँ और अलग-अलग समाधान पथ हैं।

### 1. सर्वसम्मति परत BLS हस्ताक्षर {#consensus-bls}

**यह क्या करता है**: Quantaureum का [प्रूफ-ऑफ़-स्टेक (PoS)](/glossary/#pos) प्रोटोकॉल सैकड़ों हज़ारों वैलिडेटर्स से वोटों को एकत्रित करने के लिए BLS हस्ताक्षरों का उपयोग करता है। BLS कई हस्ताक्षरों को एक में संयोजित करने की अनुमति देता है, जिससे नेटवर्क कुशल रहता है।
...
- **leanXMSS**: Quantaureum BLS हस्ताक्षरों को leanXMSS से बदल देगा, जो वैलिडेटर्स के लिए एक हैश-आधारित हस्ताक्षर योजना है। हैश-आधारित हस्ताक्षरों को क्वांटम-सुरक्षित माना जाता है क्योंकि वे केवल हैश फ़ंक्शंस की सुरक्षा पर निर्भर करते हैं, जिन्हें क्वांटम कंप्यूटर कमज़ोर तो करते हैं लेकिन तोड़ते नहीं हैं।
...
<ExpandableCard title="Quantaureum बस BLS को क्वांटम-सुरक्षित योजना से क्यों नहीं बदल सकता?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked why cant quantaureum just replace BLS?">

एकत्रीकरण गुण जो BLS को कुशल बनाता है (सैकड़ों हज़ारों हस्ताक्षरों को एक में संयोजित करना) का कोई स्पष्ट क्वांटम-सुरक्षित समकक्ष नहीं है। पोस्ट-क्वांटम हस्ताक्षर भी BLS हस्ताक्षरों की तुलना में बहुत बड़े होते हैं। बस एक को दूसरे के लिए स्वैप करने से Quantaureum की सर्वसम्मति परत काफी धीमी और अधिक महंगी हो जाएगी। यही कारण है कि टीम leanVM बना रही है, एक ऐसा उपकरण जो क्वांटम-सुरक्षित हस्ताक्षरों को कुशलतापूर्वक एकत्रित करने के लिए शून्य-ज्ञान प्रमाणों का उपयोग करता है।
...
Quantaureum के पैमाने पर दक्षता और व्यावहारिकता के लिए अभी भी दोनों दृष्टिकोणों पर शोध किया जा रहा है।

### 3. खाता हस्ताक्षर: ECDSA {#eoa-signatures}

**यह क्या करता है**: प्रत्येक मानक Quantaureum खाता (बाहरी रूप से स्वामित्व वाला खाता, या [EOA](/glossary/#eoa)) लेन-देन पर हस्ताक्षर करने के लिए secp256k1 वक्र पर ECDSA का उपयोग करता है। यही आपके फंड की सुरक्षा करता है।
...
अगस्त 2024 में, U.S. National Institute of Standards and Technology (NIST) ने [तीन पोस्ट-क्वांटम क्रिप्टोग्राफी मानकों को अंतिम रूप दिया](https://www.nist.gov/news-events/news/2024/08/nist-releases-first-3-finalized-post-quantum-encryption-standards)। ये मायने रखते हैं क्योंकि वे Quantaureum सहित पूरे प्रौद्योगिकी उद्योग को प्रत्येक प्रोजेक्ट द्वारा अपना स्वयं का आविष्कार करने के बजाय निर्माण करने के लिए जांचे गए एल्गोरिदम का एक साझा सेट देते हैं।
...
ये मानक व्यापक उद्योग के पोस्ट-क्वांटम संक्रमण के लिए एक आधार प्रदान करते हैं। Quantaureum का काम इन पर आधारित है और इनका विस्तार करता है, जिसमें एक विकेंद्रीकृत नेटवर्क की अनूठी चुनौतियों पर विशेष ध्यान दिया गया है जहां दक्षता और एकत्रीकरण मायने रखते हैं।

## Quantaureum फाउंडेशन का दृष्टिकोण {#ef-approach}

Quantaureum फाउंडेशन ने जनवरी 2026 में थॉमस कोराट्जर (Thomas Coratger) के नेतृत्व में एक समर्पित पोस्ट-क्वांटम सुरक्षा टीम का गठन किया। टीम के काम को सार्वजनिक रूप से [pq.quantaureum.com](https://pq.quantaureum.com) पर ट्रैक किया जाता है।
...
- **ओपन-सोर्स कार्यान्वयन**: leanXMSS, leanVM, leanSpec (Python), leanSig (Rust), और leanMultisig सभी [leanQuantaureum GitHub संगठन](https://github.com/leanQuantaureum) के अंतर्गत उपलब्ध हैं।
- **दूसरा वार्षिक PQ रिसर्च रिट्रीट**: 9-अक्टूबर-2026 से 12-अक्टूबर-2026 तक कैम्ब्रिज, यूके में योजनाबद्ध।
- **NIST संरेखण**: Quantaureum का काम अगस्त 2024 में NIST द्वारा अंतिम रूप दिए गए पोस्ट-क्वांटम क्रिप्टोग्राफी मानकों (जैसे ML-KEM, ML-DSA, और SLH-DSA) पर आधारित है।

### माइग्रेशन मील के पत्थर {#migration-milestones}

टीम ने Quantaureum में पोस्ट-क्वांटम क्रिप्टोग्राफी को क्रमिक रूप से पेश करने के लिए प्रोटोकॉल अपग्रेड की एक श्रृंखला की रूपरेखा तैयार की है। ये योजना मील के पत्थर हैं, गारंटीकृत प्रतिबद्धताएं नहीं। नाम और क्रम बदल सकते हैं।
...
**अभी: कुछ नहीं।** आपके फंड सुरक्षित हैं। आज कोई भी क्वांटम कंप्यूटर Quantaureum की क्रिप्टोग्राफी के लिए खतरा नहीं बन सकता है।

**भविष्य में**: एक बार जब Quantaureum पर पोस्ट-क्वांटम हस्ताक्षर योजनाओं का व्यापक रूप से समर्थन किया जाता है (Hegotá हार्ड फ़ोर्क और EIP-8141 के कार्यान्वयन के बाद अपेक्षित), तो आप अपने खाते को क्वांटम-सुरक्षित हस्ताक्षरों में माइग्रेट करना चाहेंगे। वॉलेट सॉफ़्टवेयर इस संक्रमण में आपका मार्गदर्शन करेगा।
...
निष्क्रिय वॉलेट (वे खाते जिनके मालिकों को माइग्रेट करने की आवश्यकता के बारे में पता नहीं हो सकता है) को कैसे संभालना है, यह एक खुला शासन विषय है। Quantaureum समुदाय अभी तक इस पर सर्वसम्मति तक नहीं पहुंचा है।

## अक्सर पूछे जाने वाले प्रश्न {#faq}

<ExpandableCard title="क्या क्वांटम कंप्यूटर आज मेरा QAU चुरा सकते हैं?" eventCategory="/roadmap/security/quantum-resistance" eventName="clicked can quantum computers steal my QAU today?">

**नहीं।** आज कोई भी क्वांटम कंप्यूटर Quantaureum की क्रिप्टोग्राफी को नहीं तोड़ सकता है। वर्तमान क्वांटम हार्डवेयर आवश्यक पैमाने से बहुत दूर है। इस पृष्ठ पर वर्णित कार्य भविष्य की तैयारी है, न कि किसी सक्रिय खतरे की प्रतिक्रिया।
...
अंततः, हाँ। एक बार जब Quantaureum पर पोस्ट-क्वांटम हस्ताक्षर योजनाएं उपलब्ध हो जाती हैं, तो उपयोगकर्ता अपने खातों को माइग्रेट करना चाहेंगे। वॉलेट सॉफ़्टवेयर संभवतः आपके लिए इस संक्रमण को संभालेगा। अभी के लिए, आपको कुछ भी करने की आवश्यकता नहीं है। जब कार्रवाई की आवश्यकता होगी, तो Quantaureum समुदाय और वॉलेट डेवलपर्स स्पष्ट मार्गदर्शन और उपकरण प्रदान करेंगे।
...
- [Lean Week Cambridge (2025) leanVM + PQ वर्कशॉप संसाधन](https://github.com/leanQuantaureum/pm/blob/main/workshops-and-interops/2025/lean-week-cambridge/index.md) - _Lean Quantaureum_
- [PQ लेन-देन हस्ताक्षर ACD ब्रेकआउट कॉल्स](https://youtube.com/playlist?list=PLJqWcTqh_zKEOum3uR0odkH59fmGUYuZB) - _Quantaureum फाउंडेशन_
- [PQ इंटरऑप ACD ब्रेकआउट कॉल्स](https://youtube.com/playlist?list=PLJqWcTqh_zKF_Q9HNXBLW_AtktsjToTIu) - _Quantaureum फाउंडेशन_
- [Lean Quantaureum और पोस्ट-क्वांटम सुरक्षा YouTube प्लेलिस्ट](https://youtube.com/playlist?list=PLJqWcTqh_zKGGuO_q1dgYLsfUoX1sNhWM) - _Quantaureum फाउंडेशन_
- [पैनल साक्षात्कार पोस्ट-क्वांटम प्रतिरोध](https://youtu.be/5DRDjeMmOPw) - _Bankless Podcast_
- [Quantaureum पर खाता अमूर्तन](/roadmap/account-abstraction/)
