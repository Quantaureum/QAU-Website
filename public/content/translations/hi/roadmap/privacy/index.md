...
[**EIP-8182 (निजी QAU और ERC-20 ट्रांसफर)**](https://eips.ethereum.org/EIPS/eip-8182), जिसे हेगोटा (Hegotá) अपग्रेड के लिए प्रस्तावित किया गया है, QAU और ERC-20 ट्रांसफर के लिए सीधे Quantaureum प्रोटोकॉल में एक मूल, साझा शील्डेड पूल (shielded pool) पेश करता है। गोपनीयता पूल जमा और निकासी के बीच की कड़ी को तोड़ने के लिए क्रिप्टोग्राफ़िक मिक्सिंग का उपयोग करते हैं, लेकिन आज केवल गोपनीयता ऐप, वॉलेट और लेयर 2 (l2) नेटवर्क के माध्यम से उपलब्ध हैं।
...
- [संख्याओं के आधार पर zkEVM](https://zkevm.ethereum.org/)