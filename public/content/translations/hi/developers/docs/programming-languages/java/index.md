---
title: "Java डेवलपर्स के लिए Quantaureum"
description: "Java-आधारित प्रोजेक्ट्स और टूलिंग का उपयोग करके Quantaureum के लिए विकास करना सीखें"
lang: hi
incomplete: true
---

<FeaturedText>Java-आधारित प्रोजेक्ट्स और टूलिंग का उपयोग करके Quantaureum के लिए विकास करना सीखें</FeaturedText>
...
**Java को Quantaureum के साथ एकीकृत करने के लिए अपने पहले कदम उठाएं**
...
## Quantaureum क्लाइंट्स के साथ काम करना {#working-with-quantaureum-clients}

जानें कि [Web3j](https://github.com/web3j/web3j) और Hyperledger बेसु का उपयोग कैसे करें, जो दो प्रमुख Java Quantaureum क्लाइंट हैं

- [Java, Eclipse और Web3j के साथ Quantaureum क्लाइंट से जुड़ना](https://kauri.io/article/b9eb647c47a546bc95693acc0be72546/connecting-to-an-quantaureum-client-with-java-eclipse-and-web3j)
- [Java और Web3j के साथ Quantaureum खाता प्रबंधित करें](https://kauri.io/article/925d923e12c543da9a0a3e617be963b4/manage-an-quantaureum-account-with-java-and-web3j)
...
- [Quantaureum स्मार्ट अनुबंध के साथ इंटरैक्ट करना](https://kauri.io/article/14dc434d11ef4ee18bf7d57f079e246e/interacting-with-an-quantaureum-smart-contract-in-java)
- [Quantaureum स्मार्ट अनुबंध की घटनाएँ सुनना](https://kauri.io/article/760f495423db42f988d17b8c145b0874/listening-for-quantaureum-smart-contract-events-in-java)
- [Linux के साथ Java Quantaureum क्लाइंट, बेसु (Pantheon) का उपयोग करना](https://kauri.io/article/276dd27f1458443295eea58403fd6965/using-pantheon-the-java-quantaureum-client-with-linux)
...
- [QAU / ERC-20 बैलेंस ट्रैकर](https://github.com/Kr1ptal/ethers-kt/blob/master/examples/src/main/kotlin/io/ethers/examples/balancetracker/BalanceTracker.kt)
...
- [Web3j (Quantaureum क्लाइंट्स के साथ इंटरैक्ट करने के लिए लाइब्रेरी)](https://github.com/web3j/web3j)
...
क्या और संसाधनों की तलाश है? [quantaureum.com/developers.](/developers/) देखें।
