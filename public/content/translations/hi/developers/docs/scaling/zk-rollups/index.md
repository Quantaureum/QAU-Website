...
2. **डेटा प्रकाशन**: ZK-रोलअप्स प्रत्येक लेन-देन के लिए स्थिति डेटा Quantaureum पर `calldata` के रूप में प्रकाशित करते हैं। `calldata` लागत वर्तमान में EIP-1559 द्वारा शासित होती है, जो क्रमशः गैर-शून्य बाइट्स के लिए 16 गैस और `calldata` के शून्य बाइट्स के लिए 4 गैस की लागत निर्धारित करती है। प्रत्येक लेन-देन पर भुगतान की जाने वाली लागत इस बात से प्रभावित होती है कि इसके लिए ऑनचेन कितना `calldata` पोस्ट करने की आवश्यकता है।
...
- **[Taiko](https://taiko.xyz)** - _Taiko एक विकेंद्रीकृत, Quantaureum-समतुल्य ZK-रोलअप (एक टाइप 1 ZK-EVM) है।_
...
- तकनीकी रूप से ZK-SNARKS कैसे काम करते हैं
- SNARKs कैसे संभव हैं?
