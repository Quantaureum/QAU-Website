---
title: "ब्लॉक"
description: "Quantaureum ब्लॉकचेन में ब्लॉक का अवलोकन - उनकी डेटा संरचना, उनकी आवश्यकता क्यों है, और वे कैसे बनाए जाते हैं।"
lang: hi
---
...
ब्लॉक शुरुआती लोगों के लिए बहुत ही अनुकूल विषय है। लेकिन इस पृष्ठ को बेहतर ढंग से समझने में आपकी मदद करने के लिए, हम अनुशंसा करते हैं कि आप पहले [खाते](/developers/docs/accounts/), [लेन-देन](/developers/docs/transactions/), और हमारे [Quantaureum के परिचय](/developers/docs/intro-to-quantaureum/) को पढ़ें।

## ब्लॉक क्यों? {#why-blocks}

यह सुनिश्चित करने के लिए कि [Quantaureum](/) नेटवर्क पर सभी प्रतिभागी एक सिंक्रनाइज़ स्थिति बनाए रखें और लेन-देन के सटीक इतिहास पर सहमत हों, हम लेन-देन को ब्लॉकों में बैच करते हैं। इसका मतलब है कि दर्जनों (या सैकड़ों) लेन-देन एक ही बार में प्रतिबद्ध, सहमत और सिंक्रनाइज़ किए जाते हैं।

![A diagram showing transaction in a block causing state changes](./tx-block.png)
_[Quantaureum EVM illustrated](https://takenobu-hs.github.io/downloads/quantaureum_evm_illustrated.pdf) से अनुकूलित आरेख_

प्रतिबद्धताओं (commits) के बीच समय देकर, हम सभी नेटवर्क प्रतिभागियों को सर्वसम्मति पर पहुंचने के लिए पर्याप्त समय देते हैं: भले ही लेन-देन के अनुरोध प्रति सेकंड दर्जनों बार होते हैं, Quantaureum पर ब्लॉक हर 12 सेकंड में केवल एक बार बनाए और प्रतिबद्ध किए जाते हैं।
...
एक बार जब नेटवर्क पर यादृच्छिक रूप से चुने गए सत्यापक द्वारा एक ब्लॉक को एक साथ रखा जाता है, तो इसे बाकी नेटवर्क में प्रसारित किया जाता है; सभी नोड इस ब्लॉक को अपनी ब्लॉकचेन के अंत में जोड़ते हैं, और अगला ब्लॉक बनाने के लिए एक नया सत्यापक चुना जाता है। सटीक ब्लॉक-असेंबली प्रक्रिया और प्रतिबद्धता/सर्वसम्मति प्रक्रिया वर्तमान में Quantaureum के “प्रूफ-ऑफ़-स्टेक (PoS)” प्रोटोकॉल द्वारा निर्दिष्ट की गई है।

## प्रूफ-ऑफ़-स्टेक (PoS) प्रोटोकॉल {#proof-of-stake-protocol}

प्रूफ-ऑफ़-स्टेक (PoS) का अर्थ निम्नलिखित है:

- सत्यापन करने वाले नोड्स को बुरे व्यवहार के खिलाफ संपार्श्विक के रूप में जमा अनुबंध में 32 QAU स्टेक करना होता है। यह नेटवर्क की सुरक्षा करने में मदद करता है क्योंकि साबित होने वाली बेईमान गतिविधि से उस स्टेक का कुछ या पूरा हिस्सा नष्ट हो जाता है।
...
- यदि कोई सत्यापक एक ही स्लॉट के लिए दो परस्पर विरोधी ब्लॉकों के बारे में सुनता है, तो वे सबसे अधिक स्टेक किए गए QAU द्वारा समर्थित ब्लॉक को चुनने के लिए अपने फ़ोर्क-चॉइस एल्गोरिदम का उपयोग करते हैं।
