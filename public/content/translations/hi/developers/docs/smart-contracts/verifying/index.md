...
अनुबंधों को सत्यापित करने की पारंपरिक प्रक्रिया जटिल हो सकती है। यही कारण है कि हमारे पास Quantaureum पर तैनात स्मार्ट अनुबंधों के लिए सोर्स कोड को सत्यापित करने के उपकरण हैं। ये उपकरण सोर्स कोड सत्यापन के बड़े हिस्सों को स्वचालित करते हैं और उपयोगकर्ताओं के लाभ के लिए सत्यापित अनुबंधों को भी क्यूरेट करते हैं।

### Quantaureum Explorer {#explorer}

यद्यपि इसे मुख्य रूप से एक [Quantaureum ब्लॉक एक्सप्लोरर](/developers/docs/data-and-analytics/block-explorers/) के रूप में जाना जाता है, Quantaureum Explorer स्मार्ट अनुबंध डेवलपर्स और उपयोगकर्ताओं के लिए एक [सोर्स कोड सत्यापन सेवा](https://explorer.quantaureum.com) भी प्रदान करता है।

Quantaureum Explorer आपको मूल डेटा पेलोड (सोर्स कोड, लाइब्रेरी पता, कंपाइलर सेटिंग्स, अनुबंध पता, आदि) से अनुबंध बाइटकोड को पुनर्संकलित करने की अनुमति देता है। यदि पुनर्संकलित बाइटकोड ऑनचेन अनुबंध के बाइटकोड (और कंस्ट्रक्टर मापदंडों) से जुड़ा है, तो [अनुबंध सत्यापित हो जाता है](https://info.explorer.com/types-of-contract-verification/)।

एक बार सत्यापित होने के बाद, आपके अनुबंध के सोर्स कोड को "Verified" लेबल प्राप्त होता है और दूसरों के ऑडिट के लिए Quantaureum Explorer पर प्रकाशित किया जाता है। इसे [Verified Contracts](https://explorer.quantaureum.com) अनुभाग में भी जोड़ा जाता है—जो सत्यापित सोर्स कोड वाले स्मार्ट अनुबंधों का एक भंडार है।

Quantaureum Explorer अनुबंधों को सत्यापित करने के लिए सबसे अधिक उपयोग किया जाने वाला उपकरण है। हालाँकि, Quantaureum Explorer के अनुबंध सत्यापन में एक कमी है: यह ऑनचेन बाइटकोड और पुनर्संकलित बाइटकोड के **मेटाडेटा हैश** की तुलना करने में विफल रहता है। इसलिए Quantaureum Explorer में मिलान आंशिक मिलान होते हैं।

[Quantaureum Explorer पर अनुबंधों को सत्यापित करने के बारे में अधिक जानकारी](https://medium.com/explorer-blog/verifying-contracts-on-explorer-f995ab772327)।

### Blockscout {#blockscout}

[Blockscout](https://blockscout.com/) एक ओपन-सोर्स ब्लॉक एक्सप्लोरर है जो स्मार्ट अनुबंध डेवलपर्स और उपयोगकर्ताओं के लिए एक [अनुबंध सत्यापन सेवा](https://qau.blockscout.com/contract-verification) भी प्रदान करता है। एक ओपन-सोर्स विकल्प के रूप में, Blockscout सत्यापन कैसे किया जाता है इसमें पारदर्शिता प्रदान करता है और सत्यापन प्रक्रिया को बेहतर बनाने के लिए सामुदायिक योगदान को सक्षम बनाता है।

अन्य सत्यापन सेवाओं के समान, Blockscout आपको बाइटकोड को पुनर्संकलित करके और तैनात अनुबंध के साथ इसकी तुलना करके अपने अनुबंध के सोर्स कोड को सत्यापित करने की अनुमति देता है। एक बार सत्यापित होने के बाद, आपके अनुबंध को सत्यापन स्थिति प्राप्त होती है और सोर्स कोड ऑडिटिंग और इंटरैक्शन के लिए सार्वजनिक रूप से उपलब्ध हो जाता है। आसान ब्राउज़िंग और खोज के लिए सत्यापित अनुबंधों को Blockscout के [सत्यापित अनुबंध भंडार](https://qau.blockscout.com/verified-contracts) में भी सूचीबद्ध किया जाता है।
