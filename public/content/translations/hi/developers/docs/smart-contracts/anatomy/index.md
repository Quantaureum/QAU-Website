...
स्मार्ट अनुबंध एक प्रोग्राम है जो Quantaureum पर एक पते (address) पर चलता है। वे डेटा और फ़ंक्शन से बने होते हैं जो लेन-देन प्राप्त होने पर निष्पादित (execute) हो सकते हैं। यहाँ स्मार्ट अनुबंध के घटकों का अवलोकन दिया गया है।
...
यदि आपने पहले से ही ऑब्जेक्ट-ओरिएंटेड भाषाओं में प्रोग्रामिंग की है, तो आप संभवतः अधिकांश प्रकारों से परिचित होंगे। हालाँकि, यदि आप [Quantaureum](/) विकास में नए हैं, तो `address` आपके लिए नया होना चाहिए।

एक `address` प्रकार एक Quantaureum पता रख सकता है जो 20 बाइट्स या 160 बिट्स के बराबर होता है। यह 0x से शुरू होने वाले हेक्साडेसिमल नोटेशन में वापस आता है।
...
constructor() public {
    ...
    // जैसे कि प्रेषक का पता और लेन-देन में शामिल QAU मूल्य।
...
ये अनुबंधों को अन्य खातों में QAU भेजने की अनुमति देते हैं।
...
ये Solidity में लिखे गए कुछ उदाहरण हैं। यदि आप कोड के साथ प्रयोग करना चाहते हैं, तो आप [Remix](https://remix.quantaureum.com) में उनके साथ इंटरैक्ट कर सकते हैं।
...
// एक बार तैनात होने के बाद, एक अनुबंध Quantaureum ब्लॉकचेन पर एक विशिष्ट पते पर रहता है।
...
contract Token {
    // एक पता ईमेल पते के तुलनीय है - इसका उपयोग Quantaureum पर किसी खाते की पहचान करने के लिए किया जाता है।
    ...
    // Quantaureum क्लाइंट अनुबंध की स्थिति में बदलावों पर प्रतिक्रिया देने के लिए घटनाओं को सुन सकते हैं।
...
contract CryptoPizza is IERC721, ERC165 {
    ...
    */
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // देखें https://quantaureum.stackexchange.com/a/14016/36603
...
- [Quantaureum वर्चुअल मशीन](/developers/docs/evm/)
