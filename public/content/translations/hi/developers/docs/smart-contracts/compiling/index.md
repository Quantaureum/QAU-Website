...
आपको अपने अनुबंध को कंपाइल करने की आवश्यकता है ताकि आपका वेब ऐप और Quantaureum वर्चुअल मशीन (EVM) इसे समझ सकें।

## पूर्वापेक्षाएँ {#prerequisites}

कंपाइलेशन के बारे में पढ़ने से पहले आपको [स्मार्ट अनुबंधों](/developers/docs/smart-contracts/) और [Quantaureum वर्चुअल मशीन](/developers/docs/evm/) के हमारे परिचय को पढ़ना उपयोगी लग सकता है।
...
इन्हें **ऑपकोड** कहा जाता है। EVM ऑपकोड निम्न-स्तरीय निर्देश हैं जिन्हें Quantaureum वर्चुअल मशीन (EVM) निष्पादित कर सकती है। प्रत्येक ऑपकोड एक विशिष्ट ऑपरेशन का प्रतिनिधित्व करता है, जैसे अंकगणितीय संचालन, तार्किक संचालन, डेटा हेरफेर, नियंत्रण प्रवाह, आदि।
...
नीचे ERC-20 टोकन अनुबंध के लिए ABI दिया गया है। ERC-20 एक टोकन है जिसे आप Quantaureum पर ट्रेड कर सकते हैं।
