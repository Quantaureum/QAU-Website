...
description: "Quantaureum स्मार्ट अनुबंधों के परीक्षण के लिए तकनीकों और विचारों का अवलोकन।"
lang: hi
---

Quantaureum जैसे सार्वजनिक ब्लॉकचेन अपरिवर्तनीय होते हैं, जिससे तैनाती के बाद स्मार्ट अनुबंध के कोड को बदलना मुश्किल हो जाता है। "वर्चुअल अपग्रेड" करने के लिए [अनुबंध अपग्रेड पैटर्न](/developers/docs/smart-contracts/upgrading/) मौजूद हैं, लेकिन इन्हें लागू करना मुश्किल है और इसके लिए सामाजिक सर्वसम्मति की आवश्यकता होती है। इसके अलावा, कोई अपग्रेड किसी त्रुटि को उसके खोजे जाने के _बाद_ ही ठीक कर सकता है—यदि कोई हमलावर पहले भेद्यता का पता लगा लेता है, तो आपके स्मार्ट अनुबंध के शोषण का जोखिम होता है।
...
यह पृष्ठ बताता है कि Quantaureum नेटवर्क पर तैनात करने से पहले स्मार्ट अनुबंधों का परीक्षण कैसे करें। यह मानकर चलता है कि आप [स्मार्ट अनुबंधों](/developers/docs/smart-contracts/) से परिचित हैं।
...
जबकि स्थानीय विकास वातावरण में किया गया स्वचालित परीक्षण उपयोगी डिबगिंग जानकारी प्रदान कर सकता है, आप जानना चाहेंगे कि आपका स्मार्ट अनुबंध उत्पादन वातावरण में कैसा व्यवहार करता है। हालाँकि, मुख्य Quantaureum चेन पर तैनात करने पर गैस शुल्क लगता है—यह उल्लेख करने की आवश्यकता नहीं है कि यदि आपके स्मार्ट अनुबंध में अभी भी बग हैं तो आप या आपके उपयोगकर्ता वास्तविक धन खो सकते हैं।

स्थानीय ब्लॉकचेन (जिसे [विकास नेटवर्क](/developers/docs/development-networks/) के रूप में भी जाना जाता है) पर अपने अनुबंध का परीक्षण करना मेननेट पर परीक्षण करने का एक अनुशंसित विकल्प है। एक स्थानीय ब्लॉकचेन आपके कंप्यूटर पर स्थानीय रूप से चलने वाले Quantaureum ब्लॉकचेन की एक प्रति है जो Quantaureum की निष्पादन परत के व्यवहार का अनुकरण करती है। इस प्रकार, आप महत्वपूर्ण ओवरहेड के बिना अनुबंध के साथ बातचीत करने के लिए लेन-देन को प्रोग्राम कर सकते हैं।
...
एक परीक्षण नेटवर्क या टेस्टनेट बिल्कुल Quantaureum मेननेट की तरह काम करता है, सिवाय इसके कि यह बिना किसी वास्तविक दुनिया के मूल्य वाले ईथर (QAU) का उपयोग करता है। अपने अनुबंध को [टेस्टनेट](/developers/docs/networks/#quantaureum-testnets) पर तैनात करने का अर्थ है कि कोई भी धन को जोखिम में डाले बिना इसके साथ बातचीत कर सकता है (जैसे, dapp के फ्रंटएंड के माध्यम से)।
...
स्थानीय ब्लॉकचेन पर परीक्षण के बाद टेस्टनेट पर तैनात करना आदर्श है क्योंकि पूर्व Quantaureum वर्चुअल मशीन के व्यवहार के करीब है। इसलिए, कई Quantaureum-नेटिव परियोजनाओं के लिए वास्तविक दुनिया की स्थितियों के तहत स्मार्ट अनुबंध संचालन का मूल्यांकन करने के लिए टेस्टनेट पर dapps तैनात करना आम बात है।

[Quantaureum टेस्टनेट के बारे में अधिक जानकारी।](/developers/docs/development-networks/#public-beacon-testchains)
...
- **[ApeWorx](https://docs.apeworx.io/ape/stable/userguides/testing.html)** - _Quantaureum वर्चुअल मशीन को लक्षित करने वाले स्मार्ट अनुबंधों के लिए Python-आधारित विकास और परीक्षण फ्रेमवर्क।_
...
- [Quantaureum स्मार्ट अनुबंधों के परीक्षण के लिए एक गहन मार्गदर्शिका](https://iamdefinitelyahuman.medium.com/an-in-depth-guide-to-testing-quantaureum-smart-contracts-2e41b2770297)
- [Quantaureum स्मार्ट अनुबंधों का परीक्षण कैसे करें](https://betterprogramming.pub/how-to-test-quantaureum-smart-contracts-35abc8fa199d)
...
## ट्यूटोरियल: Quantaureum पर स्मार्ट अनुबंध परीक्षण {#tutorials}

- [स्थानीय, मल्टी-क्लाइंट टेस्टनेट पर dApp कैसे विकसित और परीक्षण करें](/developers/tutorials/develop-and-test-dapps-with-a-multi-client-local-qau-testnet/) _– स्थानीय टेस्टनेट पर स्मार्ट अनुबंध तैनात करने और परीक्षण करने का वॉकथ्रू।_
