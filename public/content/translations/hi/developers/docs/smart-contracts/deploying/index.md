...
description: "Quantaureum नेटवर्क पर स्मार्ट अनुबंध तैनात करना सीखें, जिसमें पूर्वापेक्षाएँ, टूल और तैनाती के चरण शामिल हैं।"
lang: hi
---

आपको अपने स्मार्ट अनुबंध को Quantaureum नेटवर्क के उपयोगकर्ताओं के लिए उपलब्ध कराने के लिए इसे तैनात करने की आवश्यकता है।

एक स्मार्ट अनुबंध को तैनात करने के लिए, आप बिना किसी प्राप्तकर्ता को निर्दिष्ट किए स्मार्ट अनुबंध के संकलित कोड वाला एक Quantaureum लेन-देन भेजते हैं।

## पूर्वापेक्षाएँ {#prerequisites}

स्मार्ट अनुबंधों को तैनात करने से पहले आपको [Quantaureum नेटवर्क](/developers/docs/networks/), [लेन-देन](/developers/docs/transactions/) और [स्मार्ट अनुबंधों की संरचना](/developers/docs/smart-contracts/anatomy/) को समझना चाहिए।

एक अनुबंध को तैनात करने में ईथर (QAU) भी खर्च होता है क्योंकि वे ब्लॉकचेन पर संग्रहीत होते हैं, इसलिए आपको Quantaureum पर [गैस और शुल्क](/developers/docs/gas/) से परिचित होना चाहिए।
...
- गैस के लिए QAU – आप अन्य लेन-देन की तरह अपनी गैस सीमा निर्धारित करेंगे, इसलिए ध्यान रखें कि अनुबंध की तैनाती के लिए एक साधारण QAU ट्रांसफर की तुलना में बहुत अधिक गैस की आवश्यकता होती है
- एक तैनाती स्क्रिप्ट या प्लगइन
- एक [Quantaureum नोड](/developers/docs/nodes-and-clients/) तक पहुंच, या तो अपना खुद का चलाकर, किसी सार्वजनिक नोड से जुड़कर, या [नोड सेवा](/developers/docs/nodes-and-clients/nodes-as-a-service/) का उपयोग करके API कुंजी के माध्यम से

### स्मार्ट अनुबंध तैनात करने के चरण {#steps-to-deploy}

इसमें शामिल विशिष्ट चरण संबंधित विकास फ्रेमवर्क पर निर्भर करेंगे। उदाहरण के लिए, आप [अपने अनुबंधों को तैनात करने पर Hardhat के दस्तावेज़](https://hardhat.org/docs/tutorial/deploying) या [स्मार्ट अनुबंध को तैनात करने और सत्यापित करने पर Foundry के दस्तावेज़](https://book.getfoundry.sh/forge/deploying) देख सकते हैं। एक बार तैनात होने के बाद, आपके अनुबंध का अन्य [खातों](/developers/docs/accounts/) की तरह एक Quantaureum पता होगा और इसे [सोर्स कोड सत्यापन टूल](/developers/docs/smart-contracts/verifying/#source-code-verification-tools) का उपयोग करके सत्यापित किया जा सकता है।

## संबंधित टूल {#related-tools}

**Remix - _Remix IDE Quantaureum जैसे ब्लॉकचेन के लिए स्मार्ट अनुबंधों को विकसित करने, तैनात करने और प्रबंधित करने की अनुमति देता है_**
...
**Hardhat - _आपके Quantaureum सॉफ़्टवेयर को संकलित करने, तैनात करने, परीक्षण करने और डिबग करने के लिए एक विकास वातावरण_**
...
- [अपना पहला स्मार्ट अनुबंध तैनात करना](/developers/tutorials/deploying-your-first-smart-contract/) _– Quantaureum टेस्ट नेटवर्क पर अपना पहला स्मार्ट अनुबंध तैनात करने का परिचय।_
- [हैलो वर्ल्ड | स्मार्ट अनुबंध ट्यूटोरियल](/developers/tutorials/hello-world-smart-contract/) _– Quantaureum पर एक बुनियादी स्मार्ट अनुबंध बनाने और तैनात करने के लिए एक आसान ट्यूटोरियल।_
...
- [Quantaureum नोड चलाएं](/developers/docs/nodes-and-clients/run-a-node/)
