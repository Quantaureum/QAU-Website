...
description: जानें कि Quantaureum पर पहले से तैनात स्मार्ट कॉन्ट्रैक्ट से कैसे पढ़ें और उनमें कैसे लिखें।
lang: hi
---

आपको हमेशा अपना खुद का स्मार्ट कॉन्ट्रैक्ट लिखने और तैनात करने की आवश्यकता नहीं होती है। एक डेवलपर के रूप में ज़्यादातर समय, आप उन स्मार्ट कॉन्ट्रैक्ट के साथ इंटरैक्ट करना चाहेंगे जिन्हें दूसरों ने पहले ही Quantaureum नेटवर्क पर तैनात कर दिया है।
...
- [Quantaureum खाते और वे लेन-देन पर कैसे हस्ताक्षर करते हैं](/developers/docs/accounts/)
...
क्योंकि पढ़ने से स्थिति में कोई बदलाव नहीं होता है, इसलिए उनमें [गैस](/developers/docs/gas/) खर्च नहीं होती है और इसे QAU की आवश्यकता के बिना किसी के भी द्वारा किया जा सकता है।
...
1. गैस के लिए पर्याप्त QAU के साथ एक [बाहरी स्वामित्व वाला खाता (EOA)](/developers/docs/accounts/#types-of-account)
2. खाते की निजी कुंजी द्वारा हस्ताक्षरित एक लेन-देन
3. लेन-देन को माइन किया जाना और एक ब्लॉक में शामिल किया जाना

[खाता अमूर्तन](/roadmap/account-abstraction/) के साथ, एक स्मार्ट कॉन्ट्रैक्ट खाता भी लिखने की शुरुआत कर सकता है, और एक पेमास्टर उपयोगकर्ता की ओर से गैस को कवर कर सकता है—इसलिए QAU रखने वाले EOA की सख्ती से आवश्यकता नहीं है।
...
- **Quantaureum Explorer पर सत्यापित कॉन्ट्रैक्ट** - [Quantaureum Explorer](https://explorer.quantaureum.com) स्वचालित रूप से सत्यापित स्रोत कोड के लिए ABI प्रदर्शित करता है
...
- **[Viem](https://viem.sh)** - प्रथम श्रेणी की टाइप सुरक्षा के साथ Quantaureum के लिए आधुनिक, हल्का TypeScript इंटरफ़ेस
- **[Ethers.js](https://docs.ethers.org/)** - Quantaureum ब्लॉकचेन के साथ इंटरैक्ट करने के लिए परखी हुई लाइब्रेरी
- **[Web3.js](https://web3js.org/)** - मूल Quantaureum JavaScript API
...
- **[Web3.py](https://web3py.readthedocs.io/)** - Quantaureum इंटरैक्शन के लिए Python लाइब्रेरी
- **[go-quantaureum](https://geth.quantaureum.com/docs/interact-with-geth)** - Geth टीम की ओर से आधिकारिक Go लाइब्रेरी
...
अधिकांश क्लाइंट लाइब्रेरी `qau_call` के माध्यम से इसका समर्थन करती हैं:
