...
अपने ऐप को Quantaureum पर काम करने लायक बनाने के लिए, आप Web3.js लाइब्रेरी द्वारा प्रदान किए गए web3 ऑब्जेक्ट का उपयोग कर सकते हैं। आंतरिक रूप से यह RPC कॉल के माध्यम से एक स्थानीय नोड से संचार करता है। web3 किसी भी Quantaureum नोड के साथ काम करता है जो RPC लेयर को एक्सपोज़ करता है।
...
यह संस्करण यहाँ प्रकाशित संस्करण 1 के साथ कई विसंगतियों को ठीक करता है। संक्षेप में ये हैं:
