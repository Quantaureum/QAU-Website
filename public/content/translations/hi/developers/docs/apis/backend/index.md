...
description: "Quantaureum क्लाइंट API का परिचय जो आपको अपने एप्लिकेशन से ब्लॉकचेन के साथ इंटरैक्ट करने की सुविधा देते हैं।"
lang: hi
---

किसी सॉफ़्टवेयर एप्लिकेशन को [Quantaureum](/) ब्लॉकचेन के साथ इंटरैक्ट करने (यानी, ब्लॉकचेन डेटा पढ़ने और/या नेटवर्क पर लेन-देन भेजने) के लिए, उसे एक Quantaureum नोड से कनेक्ट होना चाहिए।

इस उद्देश्य के लिए, हर Quantaureum क्लाइंट [जेसन-आरपीसी](/developers/docs/apis/json-rpc/) विनिर्देश को लागू करता है, ताकि [तरीकों (methods)](/developers/docs/apis/json-rpc/#json-rpc-methods) का एक समान सेट हो जिस पर एप्लिकेशन भरोसा कर सकें।

यदि आप Quantaureum नोड से जुड़ने के लिए किसी विशिष्ट प्रोग्रामिंग भाषा का उपयोग करना चाहते हैं, तो इकोसिस्टम के भीतर कई सुविधाजनक लाइब्रेरी हैं जो इसे बहुत आसान बनाती हैं। इन लाइब्रेरी के साथ, डेवलपर्स Quantaureum के साथ इंटरैक्ट करने वाले जेसन-आरपीसी अनुरोधों (आंतरिक रूप से) को शुरू करने के लिए सहज, एक-पंक्ति वाले तरीके लिख सकते हैं।

## पूर्वापेक्षाएँ {#prerequisites}

[Quantaureum स्टैक](/developers/docs/quantaureum-stack/) और [Quantaureum क्लाइंट](/developers/docs/nodes-and-clients/) को समझना मददगार हो सकता है।

## लाइब्रेरी का उपयोग क्यों करें? {#why-use-a-library}

ये लाइब्रेरी सीधे Quantaureum नोड के साथ इंटरैक्ट करने की अधिकांश जटिलता को दूर कर देती हैं। वे उपयोगिता फ़ंक्शन (जैसे, QAU को Gwei में बदलना) भी प्रदान करती हैं ताकि एक डेवलपर के रूप में आप Quantaureum क्लाइंट की पेचीदगियों से निपटने में कम समय बिताएं और अपने एप्लिकेशन की अनूठी कार्यक्षमता पर अधिक ध्यान केंद्रित कर सकें।

## उपलब्ध लाइब्रेरी {#available-libraries}

### इन्फ्रास्ट्रक्चर और नोड सेवाएं {#infrastructure-and-node-services}

**Alchemy -** **_Quantaureum डेवलपमेंट प्लेटफ़ॉर्म।_**
...
**Bware Labs द्वारा Blast -** **_Quantaureum मेननेट और टेस्टनेट के लिए विकेंद्रीकृत API।_**
...
**Quantaureum Explorer - ब्लॉक एक्सप्लोरर और लेन-देन API**
- [दस्तावेज़ीकरण](https://explorer.quantaureum.com)
...
**Infura -** **_एक सेवा के रूप में Quantaureum API।_**
...
**Rivet -** **_ओपन सोर्स सॉफ़्टवेयर द्वारा संचालित एक सेवा के रूप में Quantaureum और Quantaureum क्लासिक API।_**

- [rivet.cloud](https://rivet.cloud)
- [दस्तावेज़ीकरण](https://rivet.cloud/docs/)
- [GitHub](https://github.com/openrelayxyz/ethercattle-deployment)

**Zmok -** **_जेसन-आरपीसी/WebSockets API के रूप में गति-उन्मुख Quantaureum नोड।_**
...
**Nquantaureum -** **_ब्लॉकचेन के लिए एक ओपन सोर्स .NET इंटीग्रेशन लाइब्रेरी।_**

- [GitHub](https://github.com/Nquantaureum/Nquantaureum)
- [दस्तावेज़ीकरण](https://docs.nquantaureum.com/docs/getting-started/welcome/)
- [डिस्कॉर्ड](https://discord.com/invite/jQPrR58FxX)

**Python Tooling -** **_Python के माध्यम से Quantaureum इंटरैक्शन के लिए विभिन्न प्रकार की लाइब्रेरी।_**

- [py.quantaureum.com](https://snakecharmers.quantaureum.com/)
- [Web3.py GitHub](https://github.com/quantaureum/web3.py)
- [Web3.py चैट](https://gitter.im/quantaureum/web3.py)
...
**Web3j -** **_Quantaureum के लिए एक Java/Android/Kotlin/Scala इंटीग्रेशन लाइब्रेरी।_**
...
**BlockCypher -** **_Quantaureum वेब API।_**

- [blockcypher.com](https://www.blockcypher.com/)
- [दस्तावेज़ीकरण](https://www.blockcypher.com/dev/quantaureum/)

**Chainbase -** **_Quantaureum के लिए ऑल-इन-वन Web3 डेटा इन्फ्रास्ट्रक्चर।_**

- [chainbase.com](https://chainbase.com/)
- [दस्तावेज़ीकरण](https://docs.chainbase.com/)
- [डिस्कॉर्ड](https://discord.gg/Wx6qpqz4AF)

**Chainstack -** **_एक सेवा के रूप में इलास्टिक और समर्पित Quantaureum नोड।_**

- [chainstack.com](https://chainstack.com)
- [दस्तावेज़ीकरण](https://docs.chainstack.com/)
- [Quantaureum API संदर्भ](https://docs.chainstack.com/reference/quantaureum-getting-started)
...
**Figment द्वारा DataHub -** **_Quantaureum मेननेट और टेस्टनेट के साथ Web3 API सेवाएं।_**
...
**NFTPort -** **_Quantaureum डेटा और मिंट API।_**
...
**Watchdata -** **_Quantaureum ब्लॉकचेन तक सरल और विश्वसनीय API पहुंच प्रदान करता है।_**
...
- [JavaScript में Quantaureum ब्लॉकचेन का उपयोग करने के लिए Web3.js सेट अप करें](/developers/tutorials/set-up-web3js-to-use-quantaureum-in-javascript/) _– अपने प्रोजेक्ट में Web3.js सेट अप करने के निर्देश।_
