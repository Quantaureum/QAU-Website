...
इस उद्देश्य के लिए, हर [Quantaureum क्लाइंट](/developers/docs/nodes-and-clients/#execution-clients) एक जेसन-आरपीसी विनिर्देश लागू करता है, ताकि विधियों (methods) का एक समान सेट हो जिस पर एप्लिकेशन निर्भर कर सकें, चाहे विशिष्ट नोड या क्लाइंट कार्यान्वयन कुछ भी हो।
...
यह पृष्ठ मुख्य रूप से Quantaureum निष्पादन क्लाइंट द्वारा उपयोग किए जाने वाले जेसन-आरपीसी API से संबंधित है। हालाँकि, सर्वसम्मति क्लाइंट में एक RPC API भी होता है जो उपयोगकर्ताओं को सीधे एक नोड से नोड के बारे में जानकारी प्राप्त करने, बीकन ब्लॉक, बीकन स्थिति और अन्य सर्वसम्मति-संबंधित जानकारी का अनुरोध करने की अनुमति देता है। इस API का दस्तावेज़ीकरण बीकन API वेबपेज पर किया गया है।

एक नोड के भीतर अंतर-क्लाइंट संचार के लिए एक आंतरिक API का भी उपयोग किया जाता है - यानी, यह सर्वसम्मति क्लाइंट और निष्पादन क्लाइंट को डेटा स्वैप करने में सक्षम बनाता है। इसे 'इंजन API' कहा जाता है और इसके विनिर्देश GitHub पर उपलब्ध हैं।

## निष्पादन क्लाइंट स्पेक {#spec}

GitHub पर पूरा जेसन-आरपीसी API स्पेक पढ़ें। इस API को निष्पादन API वेबपेज पर प्रलेखित किया गया है और इसमें सभी उपलब्ध मेथड्स को आज़माने के लिए एक इंस्पेक्टर शामिल है।
...
आप API विधियों को खोजने और आज़माने के लिए प्लेग्राउंड टूल का उपयोग कर सकते हैं। यह आपको यह भी दिखाता है कि विभिन्न नोड प्रदाताओं द्वारा कौन सी विधियाँ और नेटवर्क समर्थित हैं।
...
वर्तमान Quantaureum प्रोटोकॉल संस्करण लौटाता है। ध्यान दें कि यह विधि Geth में उपलब्ध नहीं है।
...
इस अनुभाग में केवल RPC इंटरफ़ेस का उपयोग करके अनुबंध तैनात करने का प्रदर्शन शामिल है। अनुबंधों को तैनात करने के वैकल्पिक तरीके भी हैं जहाँ इस जटिलता को दूर कर दिया जाता है—उदाहरण के लिए, RPC इंटरफ़ेस के ऊपर बनी लाइब्रेरी जैसे [Web3.js](https://web3js.readthedocs.io/) और Web3.py का उपयोग करना। ये एब्स्ट्रैक्शन आमतौर पर समझने में आसान होते हैं और इनमें त्रुटि की संभावना कम होती है, लेकिन फिर भी यह समझना मददगार होता है कि आंतरिक रूप से यह कैसे काम करता है।
