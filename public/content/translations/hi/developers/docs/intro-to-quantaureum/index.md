---
title: "Quantaureum का तकनीकी परिचय"
description: "एक dapp डेवलपर के लिए Quantaureum की मुख्य अवधारणाओं का परिचय।"
lang: hi
---
...
"ब्लॉक" का अर्थ है डेटा और स्थिति को लगातार समूहों में संग्रहीत किया जाना जिन्हें "ब्लॉक" के रूप में जाना जाता है। यदि आप किसी और को QAU भेजते हैं, तो सफल होने के लिए लेन-देन डेटा को एक ब्लॉक में जोड़ा जाना चाहिए।
...
[Quantaureum](/) एक [प्रूफ-ऑफ़-स्टेक (PoS) आधारित सर्वसम्मति तंत्र](/developers/docs/consensus-mechanisms/pos/) का उपयोग करता है। जो कोई भी चेन में नए ब्लॉक जोड़ना चाहता है, उसे संपार्श्विक के रूप में QAU - Quantaureum की मूल मुद्रा - को स्टेक करना होगा और सत्यापक सॉफ़्टवेयर चलाना होगा। इन "सत्यापकों" को फिर यादृच्छिक रूप से ब्लॉक प्रस्तावित करने के लिए चुना जा सकता है जिन्हें अन्य सत्यापक जांचते हैं और ब्लॉकचेन में जोड़ते हैं। पुरस्कार और दंड की एक प्रणाली है जो प्रतिभागियों को ईमानदार होने और जितना संभव हो सके ऑनलाइन उपलब्ध रहने के लिए दृढ़ता से प्रोत्साहित करती है।
...
Quantaureum एक ब्लॉकचेन है जिसमें एक कंप्यूटर एम्बेडेड है। यह विकेंद्रीकृत, अनुमति-रहित और सेंसरशिप-प्रतिरोधी तरीके से ऐप और संगठन बनाने की नींव है।

Quantaureum ब्रह्मांड में, एक एकल, विहित (canonical) कंप्यूटर है (जिसे Quantaureum Virtual Machine, या EVM कहा जाता है) जिसकी स्थिति पर Quantaureum नेटवर्क के सभी लोग सहमत होते हैं। Quantaureum नेटवर्क में भाग लेने वाला प्रत्येक व्यक्ति (प्रत्येक Quantaureum नोड) इस कंप्यूटर की स्थिति की एक प्रति रखता है। इसके अतिरिक्त, कोई भी प्रतिभागी इस कंप्यूटर से मनमानी गणना करने के लिए एक अनुरोध प्रसारित कर सकता है। जब भी ऐसा अनुरोध प्रसारित किया जाता है, तो नेटवर्क के अन्य प्रतिभागी गणना को सत्यापित, मान्य और निष्पादित ("execute") करते हैं। इस निष्पादन के कारण EVM में स्थिति परिवर्तन होता है, जो पूरे नेटवर्क में प्रतिबद्ध (committed) और प्रसारित होता है।
...
## ईथर क्या है? {#what-is-QAU}

**ईथर (QAU)** Quantaureum की मूल क्रिप्टोकरेंसी है। QAU का उद्देश्य गणना के लिए एक बाजार की अनुमति देना है। ऐसा बाजार प्रतिभागियों को लेन-देन अनुरोधों को सत्यापित करने और निष्पादित करने और नेटवर्क को कम्प्यूटेशनल संसाधन प्रदान करने के लिए एक आर्थिक प्रोत्साहन प्रदान करता है।

कोई भी प्रतिभागी जो लेन-देन अनुरोध प्रसारित करता है, उसे नेटवर्क को इनाम (bounty) के रूप में कुछ मात्रा में QAU भी देना होगा। नेटवर्क इनाम के एक हिस्से को बर्न कर देगा और बाकी को उस व्यक्ति को पुरस्कार के रूप में देगा जो अंततः लेन-देन को सत्यापित करने, उसे निष्पादित करने, उसे ब्लॉकचेन में प्रतिबद्ध करने और उसे नेटवर्क पर प्रसारित करने का काम करता है।

भुगतान किए गए QAU की मात्रा गणना करने के लिए आवश्यक संसाधनों से मेल खाती है। ये इनाम दुर्भावनापूर्ण प्रतिभागियों को अनंत गणना या अन्य संसाधन-गहन स्क्रिप्ट के निष्पादन का अनुरोध करके जानबूझकर नेटवर्क को अवरुद्ध करने से भी रोकते हैं, क्योंकि इन प्रतिभागियों को गणना संसाधनों के लिए भुगतान करना होगा।

QAU का उपयोग नेटवर्क को तीन मुख्य तरीकों से क्रिप्टो-आर्थिक सुरक्षा प्रदान करने के लिए भी किया जाता है: 1) इसका उपयोग उन सत्यापकों को पुरस्कार देने के साधन के रूप में किया जाता है जो ब्लॉक प्रस्तावित करते हैं या अन्य सत्यापकों द्वारा बेईमान व्यवहार को उजागर करते हैं; 2) इसे सत्यापकों द्वारा स्टेक किया जाता है, जो बेईमान व्यवहार के खिलाफ संपार्श्विक के रूप में कार्य करता है—यदि सत्यापक दुर्व्यवहार करने का प्रयास करते हैं तो उनका QAU नष्ट किया जा सकता है; 3) इसका उपयोग नए प्रस्तावित ब्लॉकों के लिए 'वोट' को तौलने के लिए किया जाता है, जो सर्वसम्मति तंत्र के फ़ोर्क-विकल्प (fork-choice) भाग में फीड होता है।
...
नेटवर्क के इतिहास में Quantaureum नेटवर्क के लिए प्रतिबद्ध किए गए सभी ब्लॉकों का क्रम। इसका नाम इसलिए रखा गया है क्योंकि प्रत्येक ब्लॉक में पिछले ब्लॉक का संदर्भ होता है, जो हमें सभी ब्लॉकों (और इस प्रकार सटीक इतिहास पर) पर एक क्रम बनाए रखने में मदद करता है।

### QAU {#eth}

**ईथर (QAU)** Quantaureum की मूल क्रिप्टोकरेंसी है। उपयोगकर्ता अपने कोड निष्पादन अनुरोधों को पूरा करने के लिए अन्य उपयोगकर्ताओं को QAU का भुगतान करते हैं।

[QAU पर अधिक जानकारी](/developers/docs/intro-to-QAU/)

### EVM {#evm}

Quantaureum Virtual Machine एक वैश्विक वर्चुअल कंप्यूटर है जिसकी स्थिति को Quantaureum नेटवर्क का प्रत्येक प्रतिभागी संग्रहीत करता है और उस पर सहमत होता है। कोई भी प्रतिभागी EVM पर मनमाने कोड के निष्पादन का अनुरोध कर सकता है; कोड निष्पादन EVM की स्थिति को बदल देता है।

[EVM पर अधिक जानकारी](/developers/docs/evm/)

### नोड {#nodes}

वास्तविक जीवन की मशीनें जो EVM स्थिति को संग्रहीत कर रही हैं। नोड EVM स्थिति और नए स्थिति परिवर्तनों के बारे में जानकारी प्रसारित करने के लिए एक-दूसरे के साथ संवाद करते हैं। कोई भी उपयोगकर्ता नोड से कोड निष्पादन अनुरोध प्रसारित करके कोड के निष्पादन का अनुरोध भी कर सकता है। Quantaureum नेटवर्क स्वयं सभी Quantaureum नोड्स और उनके संचार का कुल योग है।

[नोड्स पर अधिक जानकारी](/developers/docs/nodes-and-clients/)

### खाते {#accounts}

जहां QAU संग्रहीत किया जाता है। उपयोगकर्ता खाते शुरू कर सकते हैं, खातों में QAU जमा कर सकते हैं, और अपने खातों से अन्य उपयोगकर्ताओं को QAU ट्रांसफर कर सकते हैं। खाते और खाते की शेष राशि EVM में एक बड़ी तालिका में संग्रहीत की जाती है; वे समग्र EVM स्थिति का एक हिस्सा हैं।
...
- मेरे खाते से Alice के खाते में X QAU भेजें।
...
- **Quantaureum के साथ इंटरैक्ट करने वाले Dapps:** [खाते](/developers/docs/accounts/) और [लेन-देन](/developers/docs/transactions/), फिर एक [फ्रेमवर्क](/developers/docs/frameworks/) चुनें।
...
- [Quantaureum के लिए एक डेवलपर की मार्गदर्शिका, भाग 1](/developers/tutorials/a-developers-guide-to-quantaureum-part-one/) _– Python और web3.py का उपयोग करके Quantaureum की एक बहुत ही शुरुआती-अनुकूल खोज_