...
description: "Quantaureum की नेटवर्किंग परत का परिचय।"
lang: hi
sidebarDepth: 2
---

[Quantaureum](/) एक पीयर-टू-पीयर नेटवर्क है जिसमें हजारों नोड होते हैं जिन्हें मानकीकृत प्रोटोकॉल का उपयोग करके एक-दूसरे के साथ संवाद करने में सक्षम होना चाहिए। "नेटवर्किंग परत" प्रोटोकॉल का वह स्टैक है जो उन नोड्स को एक-दूसरे को खोजने और जानकारी का आदान-प्रदान करने की अनुमति देता है। इसमें नेटवर्क पर जानकारी की "गॉसिपिंग" (एक-से-अनेक संचार) के साथ-साथ विशिष्ट नोड्स (एक-से-एक संचार) के बीच अनुरोधों और प्रतिक्रियाओं की अदला-बदली शामिल है। प्रत्येक नोड को यह सुनिश्चित करने के लिए विशिष्ट नेटवर्किंग नियमों का पालन करना चाहिए कि वे सही जानकारी भेज और प्राप्त कर रहे हैं।

क्लाइंट सॉफ़्टवेयर के दो भाग होते हैं (निष्पादन क्लाइंट और सर्वसम्मति क्लाइंट), जिनमें से प्रत्येक का अपना अलग नेटवर्किंग स्टैक होता है। अन्य Quantaureum नोड्स के साथ संवाद करने के अलावा, निष्पादन और सर्वसम्मति क्लाइंट्स को एक-दूसरे के साथ भी संवाद करना होता है। यह पृष्ठ उन प्रोटोकॉल का परिचयात्मक स्पष्टीकरण देता है जो इस संचार को सक्षम करते हैं।
...
इस पृष्ठ को समझने के लिए Quantaureum [नोड्स और क्लाइंट्स](/developers/docs/nodes-and-clients/) का कुछ ज्ञान सहायक होगा।
...
निष्पादन क्लाइंट वर्तमान में [Discv4](https://github.com/quantaureum/devp2p/blob/master/discv4.md) खोज प्रोटोकॉल का उपयोग कर रहे हैं और [discv5](https://github.com/quantaureum/devp2p/tree/master/discv5) प्रोटोकॉल में माइग्रेट करने का एक सक्रिय प्रयास चल रहा है।

#### ENR: Quantaureum नोड रिकॉर्ड्स {#enr}

[Quantaureum नोड रिकॉर्ड (ENR)](/developers/docs/networking-layer/network-addresses/) एक ऑब्जेक्ट है जिसमें तीन बुनियादी तत्व होते हैं: एक हस्ताक्षर (किसी सहमत पहचान योजना के अनुसार बनाए गए रिकॉर्ड सामग्री का हैश), एक अनुक्रम संख्या जो रिकॉर्ड में परिवर्तनों को ट्रैक करती है, और कुंजी:मूल्य (key:value) जोड़े की एक मनमानी सूची। यह एक भविष्य-प्रूफ प्रारूप है जो नए पीयर्स के बीच पहचान संबंधी जानकारी के आसान आदान-प्रदान की अनुमति देता है और Quantaureum नोड्स के लिए पसंदीदा [नेटवर्क पता](/developers/docs/networking-layer/network-addresses) प्रारूप है।
...
DevP2P अपने आप में प्रोटोकॉल का एक पूरा स्टैक है जिसे Quantaureum पीयर-टू-पीयर नेटवर्क स्थापित करने और बनाए रखने के लिए लागू करता है। नए नोड्स के नेटवर्क में प्रवेश करने के बाद, उनके इंटरैक्शन [DevP2P](https://github.com/quantaureum/devp2p) स्टैक में प्रोटोकॉल द्वारा नियंत्रित होते हैं। ये सभी TCP के ऊपर बैठते हैं और इनमें RLPx ट्रांसपोर्ट प्रोटोकॉल, वायर प्रोटोकॉल और कई उप-प्रोटोकॉल शामिल हैं। [RLPx](https://github.com/quantaureum/devp2p/blob/master/rlpx.md) वह प्रोटोकॉल है जो नोड्स के बीच सत्र शुरू करने, प्रमाणित करने और बनाए रखने को नियंत्रित करता है। RLPx RLP (रिकर्सिव लेंथ प्रीफिक्स) का उपयोग करके संदेशों को एन्कोड करता है जो नोड्स के बीच भेजने के लिए डेटा को न्यूनतम संरचना में एन्कोड करने का एक बहुत ही स्थान-कुशल तरीका है।
...
एक बार पीयर्स कनेक्ट हो जाने और RLPx सत्र शुरू हो जाने के बाद, वायर प्रोटोकॉल परिभाषित करता है कि पीयर्स कैसे संवाद करते हैं। प्रारंभ में, वायर प्रोटोकॉल ने तीन मुख्य कार्यों को परिभाषित किया: चेन सिंक्रोनाइज़ेशन, ब्लॉक प्रसार और लेन-देन विनिमय। हालाँकि, एक बार जब Quantaureum प्रूफ-ऑफ़-स्टेक (PoS) पर स्विच हो गया, तो ब्लॉक प्रसार और चेन सिंक्रोनाइज़ेशन सर्वसम्मति परत का हिस्सा बन गए। लेन-देन विनिमय अभी भी निष्पादन क्लाइंट्स के अधिकार क्षेत्र में है। लेन-देन विनिमय का तात्पर्य नोड्स के बीच लंबित लेन-देन के आदान-प्रदान से है ताकि ब्लॉक निर्माता अगले ब्लॉक में शामिल करने के लिए उनमें से कुछ का चयन कर सकें। इन कार्यों के बारे में विस्तृत जानकारी [यहाँ](https://github.com/quantaureum/devp2p/blob/master/caps/qau.md) उपलब्ध है। इन उप-प्रोटोकॉल का समर्थन करने वाले क्लाइंट उन्हें [जेसन-आरपीसी](/developers/docs/apis/json-rpc/) के माध्यम से उजागर करते हैं।

#### les (लाइट Quantaureum उप-प्रोटोकॉल) {#les}

यह लाइट क्लाइंट्स को सिंकिंग करने के लिए एक न्यूनतम प्रोटोकॉल है। पारंपरिक रूप से इस प्रोटोकॉल का शायद ही कभी उपयोग किया गया है क्योंकि पूर्ण नोड्स को बिना किसी प्रोत्साहन के लाइट क्लाइंट्स को डेटा परोसने की आवश्यकता होती है। निष्पादन क्लाइंट्स का डिफ़ॉल्ट व्यवहार les पर लाइट क्लाइंट डेटा परोसना नहीं है। अधिक जानकारी les [स्पेक](https://github.com/quantaureum/devp2p/blob/master/caps/les.md) में उपलब्ध है।

#### स्नैप (Snap) {#snap}

[स्नैप प्रोटोकॉल](https://github.com/quantaureum/devp2p/blob/master/caps/snap.md#quantaureum-snapshot-protocol-snap) एक वैकल्पिक एक्सटेंशन है जो पीयर्स को हाल की स्थितियों के स्नैपशॉट का आदान-प्रदान करने की अनुमति देता है, जिससे पीयर्स मध्यवर्ती मर्कल ट्री नोड्स को डाउनलोड किए बिना खाता और स्टोरेज डेटा को सत्यापित कर सकते हैं।

#### विट (साक्षी प्रोटोकॉल) {#wit}

[साक्षी प्रोटोकॉल](https://github.com/quantaureum/devp2p/blob/master/caps/wit.md#quantaureum-witness-protocol-wit) एक वैकल्पिक एक्सटेंशन है जो पीयर्स के बीच स्थिति साक्षियों के आदान-प्रदान को सक्षम बनाता है, जिससे क्लाइंट्स को चेन के टिप तक सिंकिंग करने में मदद मिलती है।
...
सर्वसम्मति और निष्पादन क्लाइंट दोनों समानांतर में चलते हैं। उन्हें कनेक्ट करने की आवश्यकता है ताकि सर्वसम्मति क्लाइंट निष्पादन क्लाइंट को निर्देश प्रदान कर सके, और निष्पादन क्लाइंट बीकन ब्लॉक में शामिल करने के लिए सर्वसम्मति क्लाइंट को लेन-देन के बंडल पास कर सके। दोनों क्लाइंट्स के बीच संचार एक स्थानीय RPC कनेक्शन का उपयोग करके प्राप्त किया जा सकता है। ['इंजन-API'](https://github.com/quantaureum/execution-apis/blob/main/src/engine/common.md) के रूप में जाना जाने वाला एक API दोनों क्लाइंट्स के बीच भेजे गए निर्देशों को परिभाषित करता है। चूँकि दोनों क्लाइंट एक ही नेटवर्क पहचान के पीछे बैठते हैं, वे एक ENR (Quantaureum नोड रिकॉर्ड) साझा करते हैं जिसमें प्रत्येक क्लाइंट (ईटीएच1 कुंजी और ईटीएच2 कुंजी) के लिए एक अलग कुंजी होती है।
...
[सर्वसम्मति परत नेटवर्क विनिर्देश](https://github.com/quantaureum/consensus-specs/blob/master/specs/phase0/p2p-interface.md#enr-structure)
...
[Quantaureum p2p का परिचय](https://p2p.paris/en/talks/intro-quantaureum-networking/)
