...
[Quantaureum](/) एक नेटवर्क है जो Quantaureum क्लाइंट सॉफ़्टवेयर चलाने वाले कंप्यूटरों से बना है। इनमें से प्रत्येक कंप्यूटर को 'नोड' कहा जाता है। क्लाइंट सॉफ़्टवेयर एक नोड को Quantaureum नेटवर्क पर डेटा भेजने और प्राप्त करने की अनुमति देता है, और Quantaureum प्रोटोकॉल नियमों के विरुद्ध डेटा को सत्यापित करता है। नोड्स अपने डिस्क स्टोरेज में बहुत सारा ऐतिहासिक डेटा रखते हैं और जब वे नेटवर्क पर अन्य नोड्स से जानकारी के नए पैकेट प्राप्त करते हैं, जिन्हें ब्लॉक के रूप में जाना जाता है, तो वे इसे जोड़ते हैं। यह हमेशा जांचने के लिए आवश्यक है कि किसी नोड के पास शेष नेटवर्क के अनुरूप जानकारी है। इसका मतलब है कि नोड चलाने के लिए बहुत अधिक डिस्क स्थान की आवश्यकता हो सकती है। कुछ नोड ऑपरेशन्स के लिए बहुत अधिक RAM की भी आवश्यकता हो सकती है।
...
पोर्टल नेटवर्क Quantaureum के लिए एक नया नेटवर्किंग डिज़ाइन है जिसका उद्देश्य नेटवर्क भर में छोटे टुकड़ों में आवश्यक डेटा साझा करके, पूर्ण नोड्स पर भरोसा किए बिना या उन पर अतिरिक्त दबाव डाले बिना "लाइट" नोड्स के लिए डेटा उपलब्धता समस्या को हल करना है।
...
पोर्टल नेटवर्क का उद्देश्य मौजूदा Quantaureum क्लाइंट्स की डिज़ाइन बाधाओं के बाहर, विशेष रूप से हल्केपन (lightness) के लिए निर्माण करते हुए, पूरे डिज़ाइन पर पुनर्विचार करना है।
...
विचार यह है कि कुल ऐतिहासिक Quantaureum डेटा के छोटे हिस्सों और कुछ विशिष्ट नोड जिम्मेदारियों को प्रत्येक नोड में जोड़ा जाए। फिर, अनुरोध किए गए विशिष्ट डेटा को संग्रहीत करने वाले नोड्स की खोज करके और उनसे इसे प्राप्त करके अनुरोधों को पूरा किया जाता है।
...
- [Trin](https://github.com/quantaureum/trin): Rust में लिखा गया
- [Fluffy](https://fluffy.guide): Nim में लिखा गया
- Ultralight: TypeScript में लिखा गया
- [Shisui](https://github.com/zen-eth/shisui): Go में लिखा गया

कई स्वतंत्र क्लाइंट कार्यान्वयन होने से Quantaureum नेटवर्क के लचीलेपन और विकेंद्रीकरण में वृद्धि होती है।
