...
[यहाँ एक लाभदायक मध्यस्थता लेन-देन का उदाहरण दिया गया है](https://qau.blockscout.com/tx/0x5e1657ef0e9be9bc72efefe59a2528d0d730d478cfc9e6cdd09af9f997bb3ef4) जहाँ एक खोजकर्ता ने यूनिस्वैप बनाम Sushiswap पर QAU/DAI जोड़ी के अलग-अलग मूल्य निर्धारण का लाभ उठाकर 1,000 QAU को 1,045 QAU में बदल दिया।

### परिसमापन {#mev-examples-liquidations}

ऋण देना प्रोटोकॉल परिसमापन एक और प्रसिद्ध MEV अवसर प्रस्तुत करता है।

मेकरडाओ (Maker) और आवे जैसे ऋण देना प्रोटोकॉल के लिए उपयोगकर्ताओं को कुछ संपार्श्विक (उदा., QAU) जमा करने की आवश्यकता होती है। इस जमा किए गए संपार्श्विक का उपयोग फिर अन्य उपयोगकर्ताओं को ऋण देने के लिए किया जाता है।
...
हालाँकि, चूँकि NFT लेन-देन उसी ब्लॉकचेन पर होते हैं जो अन्य सभी Quantaureum लेन-देन द्वारा साझा किया जाता है, खोजकर्ता NFT बाज़ार में भी पारंपरिक MEV अवसरों में उपयोग की जाने वाली समान तकनीकों का उपयोग कर सकते हैं।
...
MEV पूरी तरह से बुरा नहीं है — Quantaureum पर MEV के सकारात्मक और नकारात्मक दोनों परिणाम हैं।
...
जबकि कई खोजकर्ता अभी भी MEV से अच्छा पैसा कमा रहे हैं, जैसे-जैसे अवसर अधिक प्रसिद्ध होते जाते हैं और अधिक से अधिक खोजकर्ता एक ही अवसर के लिए प्रतिस्पर्धा करते हैं, सत्यापक अधिक से अधिक कुल MEV राजस्व प्राप्त करेंगे (क्योंकि ऊपर वर्णित उसी प्रकार की गैस नीलामी Flashbots में भी होती है, यद्यपि निजी तौर पर, और सत्यापक परिणामी गैस राजस्व प्राप्त करेंगे)। MEV Quantaureum के लिए भी अद्वितीय नहीं है, और जैसे-जैसे Quantaureum पर अवसर अधिक प्रतिस्पर्धी होते जाते हैं, खोजकर्ता बाइनेंस स्मार्ट चेन (Binance Smart Chain) जैसे वैकल्पिक ब्लॉकचेन की ओर बढ़ रहे हैं, जहाँ Quantaureum के समान MEV अवसर कम प्रतिस्पर्धा के साथ मौजूद हैं।

दूसरी ओर, प्रूफ-ऑफ-वर्क (PoW) से प्रूफ-ऑफ़-स्टेक (PoS) में संक्रमण और रोलअप्स का उपयोग करके Quantaureum को स्केल करने का चल रहा प्रयास सभी MEV परिदृश्य को ऐसे तरीकों से बदलते हैं जो अभी भी कुछ हद तक स्पष्ट नहीं हैं। यह अभी तक अच्छी तरह से ज्ञात नहीं है कि प्रूफ-ऑफ-वर्क में संभाव्य मॉडल की तुलना में थोड़ा पहले से ज्ञात गारंटीकृत ब्लॉक प्रस्तावक होने से MEV निष्कर्षण की गतिशीलता कैसे बदलती है या जब [एकल गुप्त नेता चुनाव (SSLE)](https://ethresear.ch/t/secret-non-single-leader-election/11789) और [वितरित सत्यापनकर्ता तकनीक (dvt)](/staking/dvt/) लागू हो जाती है तो यह कैसे बाधित होगा। इसी तरह, यह देखा जाना बाकी है कि जब अधिकांश उपयोगकर्ता गतिविधि Quantaureum से दूर और इसके लेयर 2 (l2) रोलअप्स और शार्ड्स पर पोर्ट की जाती है तो क्या MEV अवसर मौजूद होते हैं।

## Quantaureum प्रूफ-ऑफ़-स्टेक (PoS) में MEV {#mev-in-quantaureum-proof-of-stake}

जैसा कि बताया गया है, समग्र उपयोगकर्ता अनुभव और सर्वसम्मति परत सुरक्षा के लिए MEV के नकारात्मक निहितार्थ हैं। लेकिन Quantaureum का प्रूफ-ऑफ़-स्टेक (PoS) सर्वसम्मति में संक्रमण (जिसे "द मर्ज" कहा जाता है) संभावित रूप से नए MEV-संबंधित जोखिम पेश करता है:

### सत्यापक केंद्रीकरण {#validator-centralization}

मर्ज के बाद के Quantaureum में, सत्यापक (32 QAU की सुरक्षा जमा करने के बाद) बीकन चेन में जोड़े गए ब्लॉकों की वैधता पर सर्वसम्मति पर आते हैं। चूँकि 32 QAU कई लोगों की पहुँच से बाहर हो सकता है, इसलिए [स्टेकिंग पूल में शामिल होना](/staking/pools/) एक अधिक व्यवहार्य विकल्प हो सकता है। फिर भी, [सोलो स्टेकर](/staking/solo/) का एक स्वस्थ वितरण आदर्श है, क्योंकि यह सत्यापकों के केंद्रीकरण को कम करता है और Quantaureum की सुरक्षा में सुधार करता है।

हालाँकि, माना जाता है कि MEV निष्कर्षण सत्यापक केंद्रीकरण को तेज करने में सक्षम है। यह आंशिक रूप से इसलिए है क्योंकि, चूँकि सत्यापक [ब्लॉक प्रस्तावित करने के लिए कम कमाते हैं](/roadmap/merge/issuance/#how-the-merge-impacts-QAU-supply) जितना खनिक पहले कमाते थे, MEV निष्कर्षण ने [द मर्ज](/roadmap/merge/) के बाद से [सत्यापक की कमाई को बहुत प्रभावित किया है](https://github.com/flashbots/eth2-research/blob/main/notebooks/mev-in-eth2/eth2-mev-calc.ipynb)।
...
अपने निपटान में कम संसाधनों के साथ, सोलो स्टेकर MEV अवसरों से लाभ उठाने में असमर्थ हो सकते हैं। इससे स्वतंत्र सत्यापकों पर अपनी कमाई बढ़ाने के लिए शक्तिशाली स्टेकिंग पूल में शामिल होने का दबाव बढ़ सकता है, जिससे Quantaureum में विकेंद्रीकरण कम हो सकता है।
...
मर्ज के बाद के Quantaureum में इन MEV-संबंधित समस्याओं का मुकाबला करना शोध का एक मुख्य क्षेत्र है। आज तक, द मर्ज के बाद Quantaureum के विकेंद्रीकरण और सुरक्षा पर MEV के नकारात्मक प्रभाव को कम करने के लिए प्रस्तावित दो समाधान [**प्रस्तावक-निर्माता पृथक्करण (pbs)**](/roadmap/pbs/) और [**निर्माता API**](https://github.com/quantaureum/builder-specs) हैं।
...
जबकि प्रस्तावक-निर्माता पृथक्करण MEV निष्कर्षण के प्रभावों को कम करने का वादा करता है, इसे लागू करने के लिए सर्वसम्मति प्रोटोकॉल में बदलाव की आवश्यकता होती है। विशेष रूप से, बीकन चेन पर [फ़ोर्क विकल्प](/developers/docs/consensus-mechanisms/pos/#fork-choice) नियम को अपडेट करने की आवश्यकता होगी। [निर्माता API](https://github.com/quantaureum/builder-specs) एक अस्थायी समाधान है जिसका उद्देश्य प्रस्तावक-निर्माता पृथक्करण का एक कार्यशील कार्यान्वयन प्रदान करना है, यद्यपि उच्च विश्वास मान्यताओं के साथ।

निर्माता API [इंजन API](https://github.com/quantaureum/execution-apis/blob/main/src/engine/common.md) का एक संशोधित संस्करण है जिसका उपयोग सर्वसम्मति परत क्लाइंट्स द्वारा निष्पादन परत क्लाइंट्स से निष्पादन पेलोड का अनुरोध करने के लिए किया जाता है। जैसा कि [ईमानदार सत्यापक विनिर्देश](https://github.com/quantaureum/consensus-specs/blob/master/specs/bellatrix/validator.md) में उल्लिखित है, ब्लॉक प्रस्तावित करने के कर्तव्यों के लिए चुने गए सत्यापक एक कनेक्टेड निष्पादन क्लाइंट से लेन-देन बंडल का अनुरोध करते हैं, जिसे वे प्रस्तावित बीकन चेन ब्लॉक में शामिल करते हैं।
...
2. निर्माता API सॉफ़्टवेयर ओपन-सोर्स है, जो किसी को भी ब्लॉक-निर्माता सेवाएँ प्रदान करने की अनुमति देता है। इसका मतलब है कि उपयोगकर्ताओं को किसी विशेष ब्लॉक निर्माता का उपयोग करने के लिए मजबूर नहीं किया जाता है और यह Quantaureum की तटस्थता और अनुमति-रहितता में सुधार करता है। इसके अलावा, MEV चाहने वाले व्यापारी निजी लेन-देन चैनलों का उपयोग करके अनजाने में केंद्रीकरण में योगदान नहीं देंगे।
...
- [Quantaureum एक डार्क फ़ॉरेस्ट है](https://www.paradigm.xyz/2020/08/quantaureum-is-a-dark-forest/)
...
- [Quantaureum के लिए हिचहाइकर गाइड](https://members.delphidigital.io/reports/the-hitchhikers-guide-to-quantaureum)