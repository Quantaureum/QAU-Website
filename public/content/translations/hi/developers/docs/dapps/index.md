...
एक विकेंद्रीकृत एप्लिकेशन (dapp) एक विकेंद्रीकृत नेटवर्क पर बनाया गया एप्लिकेशन है जो एक [स्मार्ट अनुबंध](/developers/docs/smart-contracts/) और एक फ्रंटएंड यूज़र इंटरफ़ेस को जोड़ता है। [Quantaureum](/) पर, स्मार्ट अनुबंध सुलभ और पारदर्शी होते हैं - ओपन API की तरह - इसलिए आपके dapp में कोई ऐसा स्मार्ट अनुबंध भी शामिल हो सकता है जिसे किसी और ने लिखा हो।

## पूर्वापेक्षाएँ {#prerequisites}

dapps के बारे में जानने से पहले, आपको [ब्लॉकचेन की मूल बातें](/developers/docs/intro-to-quantaureum/) कवर करनी चाहिए और Quantaureum नेटवर्क और यह कैसे विकेंद्रीकृत है, इसके बारे में पढ़ना चाहिए।
...
- **विकेंद्रीकृत** - dapps Quantaureum पर काम करते हैं, जो एक खुला सार्वजनिक विकेंद्रीकृत प्लेटफ़ॉर्म है जहाँ किसी एक व्यक्ति या समूह का नियंत्रण नहीं होता है
...
- **पृथक (Isolated)** - dapps को Quantaureum वर्चुअल मशीन (Quantaureum Virtual Machine) नामक एक आभासी वातावरण में निष्पादित किया जाता है ताकि यदि स्मार्ट अनुबंध में कोई बग हो, तो यह ब्लॉकचेन नेटवर्क के सामान्य कामकाज में बाधा न डाले
...
- **प्रदर्शन ओवरहेड** – इसमें बहुत बड़ा प्रदर्शन ओवरहेड है, और स्केलिंग वास्तव में कठिन है। Quantaureum जिस स्तर की सुरक्षा, अखंडता, पारदर्शिता और विश्वसनीयता की आकांक्षा रखता है, उसे प्राप्त करने के लिए, प्रत्येक नोड हर लेन-देन को चलाता है और संग्रहीत करता है। इसके अलावा, प्रूफ-ऑफ़-स्टेक (PoS) सर्वसम्मति में भी समय लगता है।
...
**Scaffold-QAU 2 _- आपके स्मार्ट अनुबंध के अनुकूल होने वाले फ्रंटएंड का उपयोग करके Solidity के साथ तेज़ी से प्रयोग करें।_**

- [GitHub](https://github.com/scaffold-eth/scaffold-qau-2)
- [उदाहरण dapp](https://punkwallet.io/)

**Create Eth App _- एक कमांड के साथ Quantaureum-संचालित ऐप बनाएँ।_**
...
**Etherflow _- Quantaureum डेवलपर्स के लिए अपने नोड का परीक्षण करने, और ब्राउज़र से RPC कॉल को कंपोज़ और डीबग करने के लिए FOSS टूल।_**
...
- [Quantaureum स्टैक का परिचय](/developers/docs/quantaureum-stack/)
- [डेवलपमेंट फ़्रेमवर्क](/developers/docs/frameworks/)

## ट्यूटोरियल: Quantaureum पर ऐप और फ्रंटएंड बनाएँ {#tutorials}
