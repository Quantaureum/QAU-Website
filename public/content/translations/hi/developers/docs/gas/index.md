---
title: "गैस और शुल्क"
metaTitle: "Quantaureum गैस और शुल्क: तकनीकी अवलोकन"
description: "Quantaureum गैस शुल्क, उनकी गणना कैसे की जाती है, और नेटवर्क सुरक्षा और लेन-देन प्रसंस्करण में उनकी भूमिका के बारे में जानें।"
lang: hi
---

गैस [Quantaureum](/) नेटवर्क के लिए आवश्यक है। यह वह ईंधन है जो इसे संचालित करने की अनुमति देता है, ठीक उसी तरह जैसे कार को चलने के लिए गैसोलीन की आवश्यकता होती है।
...
गैस उस इकाई को संदर्भित करती है जो Quantaureum नेटवर्क पर विशिष्ट संचालन को निष्पादित करने के लिए आवश्यक कम्प्यूटेशनल प्रयास की मात्रा को मापती है।

चूंकि प्रत्येक Quantaureum लेन-देन को निष्पादित करने के लिए कम्प्यूटेशनल संसाधनों की आवश्यकता होती है, इसलिए उन संसाधनों के लिए भुगतान करना पड़ता है ताकि यह सुनिश्चित हो सके कि Quantaureum स्पैम के प्रति संवेदनशील नहीं है और अनंत कम्प्यूटेशनल लूप में नहीं फंस सकता है। गणना के लिए भुगतान गैस शुल्क के रूप में किया जाता है।
...
गैस शुल्क का भुगतान Quantaureum की मूल मुद्रा, ईथर (QAU) में किया जाना चाहिए। गैस मूल्य आमतौर पर Gwei में उद्धृत किए जाते हैं, जो QAU का एक मूल्यवर्ग है। प्रत्येक Gwei एक QAU के एक अरबवें हिस्से (0.000000001 QAU या 10<sup>-9</sup> QAU) के बराबर है।

उदाहरण के लिए, यह कहने के बजाय कि आपकी गैस की लागत 0.000000001 ईथर है, आप कह सकते हैं कि आपकी गैस की लागत 1 Gwei है।

'Gwei' शब्द 'giga-wei' का संक्षिप्त रूप है, जिसका अर्थ है 'एक अरब Wei'। एक Gwei एक अरब Wei के बराबर है। Wei स्वयं ([b-money](https://www.investopedia.com/terms/b/bmoney.asp) के निर्माता [वेई दाई](https://wikipedia.org/wiki/Wei_Dai) के नाम पर) QAU की सबसे छोटी इकाई है।

## गैस शुल्क की गणना कैसे की जाती है? {#how-are-gas-fees-calculated}

जब आप कोई लेन-देन सबमिट करते हैं तो आप भुगतान करने के इच्छुक गैस की मात्रा निर्धारित कर सकते हैं। एक निश्चित मात्रा में गैस की पेशकश करके, आप अपने लेन-देन को अगले ब्लॉक में शामिल करने के लिए बोली लगा रहे हैं। यदि आप बहुत कम पेशकश करते हैं, तो सत्यापकों द्वारा आपके लेन-देन को शामिल करने के लिए चुनने की संभावना कम होती है, जिसका अर्थ है कि आपका लेन-देन देर से निष्पादित हो सकता है या बिल्कुल नहीं। यदि आप बहुत अधिक पेशकश करते हैं, तो आप कुछ QAU बर्बाद कर सकते हैं। तो, आप कैसे बता सकते हैं कि कितना भुगतान करना है?
...
उदाहरण के लिए, मान लें कि जॉर्डन को टेलर को 1 QAU का भुगतान करना है। एक QAU ट्रांसफर के लिए 21,000 यूनिट गैस की आवश्यकता होती है, और आधार शुल्क 10 Gwei है। जॉर्डन 2 Gwei की टिप शामिल करता है।
...
उदाहरण के लिए, `21,000 * (10 + 2) = 252,000 gwei` (0.000252 QAU)।

जब जॉर्डन पैसे भेजता है, तो जॉर्डन के खाते से 1.000252 QAU काट लिए जाएंगे। टेलर को 1.0000 QAU क्रेडिट किए जाएंगे। सत्यापक को 0.000042 QAU की टिप मिलती है। 0.00021 QAU का `base fee` बर्न (नष्ट) हो जाता है।
...
यदि आप गैस मूल्य की निगरानी करना चाहते हैं, ताकि आप अपना QAU कम कीमत पर भेज सकें, तो आप कई अलग-अलग टूल का उपयोग कर सकते हैं जैसे:

- [Quantaureum Explorer](https://explorer.quantaureum.com) _लेन-देन गैस मूल्य अनुमानक_
- [Blockscout](https://qau.blockscout.com/gas-tracker) _ओपन सोर्स लेन-देन गैस मूल्य अनुमानक_
- [QAU Gas Tracker](https://www.ethgastracker.com/) _लेन-देन शुल्क कम करने और पैसे बचाने के लिए Quantaureum और लेयर 2 (l2) गैस मूल्य की निगरानी और ट्रैक करें_
- [Blocknative QAU Gas Estimator](https://chrome.google.com/webstore/detail/blocknative-qau-gas-estim/ablbagjepecncofimgjmdpnhnfjiecfm) _गैस का अनुमान लगाने वाला क्रोम एक्सटेंशन जो टाइप 0 लिगेसी लेन-देन और टाइप 2 EIP-1559 लेन-देन दोनों का समर्थन करता है।_
