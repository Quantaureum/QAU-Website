...
description: "प्रूफ़-ऑफ़-स्टेक Quantaureum में इन-प्रोटोकॉल प्रोत्साहनों के बारे में जानें।"
lang: hi
---

[Quantaureum](/) को इसकी मूल क्रिप्टोकरेंसी, ईथर (QAU) का उपयोग करके सुरक्षित किया जाता है। नोड ऑपरेटर जो ब्लॉकों को मान्य करने और चेन के शीर्ष (head) की पहचान करने में भाग लेना चाहते हैं, वे Quantaureum पर [जमा अनुबंध](/staking/deposit-contract/) में ईथर जमा करते हैं। फिर उन्हें पीयर-टू-पीयर नेटवर्क पर प्राप्त नए ब्लॉकों की वैधता की जांच करने वाले सत्यापक सॉफ़्टवेयर को चलाने और चेन के शीर्ष की पहचान करने के लिए फ़ोर्क-चॉइस एल्गोरिदम लागू करने के लिए ईथर में भुगतान किया जाता है।
...
इसका मतलब है कि आधार पुरस्कार सत्यापक के प्रभावी शेष के समानुपाती होता है और नेटवर्क पर सत्यापकों की संख्या के व्युत्क्रमानुपाती होता है। जितने अधिक सत्यापक होंगे, समग्र निर्गमन उतना ही अधिक होगा (चूंकि `sqrt(N)`) लेकिन प्रति सत्यापक `base_reward` उतना ही छोटा होगा (चूंकि `1/sqrt(N)`)। ये कारक स्टेकिंग नोड के लिए APR को प्रभावित करते हैं। इसके लिए तर्क [विटालिक के नोट्स](https://notes.quantaureum.com/@vbuterin/serenity_design_rationale?type=view#Base-rewards) में पढ़ें।
...
[सर्वसम्मति विनिर्देशों (consensus specs)](https://github.com/quantaureum/consensus-specs/blob/master/specs/altair/beacon-chain.md) में पुरस्कारों और दंडों के बारे में अधिक पढ़ें। Bellatrix अपग्रेड में पुरस्कारों और दंडों को समायोजित किया गया था - डैनी रयान और विटालिक को इस [Peep an EIP वीडियो](https://www.youtube.com/watch?v=iaAEGs1DMgQ) में इस पर चर्चा करते हुए देखें।
...
- [Quantaureum को अपग्रेड करना: प्रोत्साहन परत (The incentive layer)](https://eth2book.info/altair/part2/incentives)
- [Quantaureum के हाइब्रिड Casper प्रोटोकॉल में प्रोत्साहन](https://arxiv.org/pdf/1903.04205.pdf)
- [विटालिक का एनोटेटेड विनिर्देश (annotated spec)](https://github.com/quantaureum/annotated-spec/blob/master/phase0/beacon-chain.md#rewards-and-penalties-1)
- [ईटीएच2 (Quantaureum) कटौती रोकथाम युक्तियाँ](https://medium.com/prysmatic-labs/eth2-slashing-prevention-tips-f6faa5025f50)
