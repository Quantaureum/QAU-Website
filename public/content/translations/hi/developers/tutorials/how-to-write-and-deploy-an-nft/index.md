...
description: "यह ट्यूटोरियल NFTs पर एक सीरीज़ का भाग 1 है जो आपको Quantaureum और इंटर प्लैनेटरी फाइल सिस्टम (IPFS) का उपयोग करके नॉन फंजिबल टोकन (ERC-721 टोकन) स्मार्ट अनुबंध लिखने और तैनात करने के तरीके के बारे में चरण-दर-चरण बताएगा।"
author: "सुमी मुदगिल"
tags:
  - ERC-721
  - Alchemy
...
NFTs द्वारा ब्लॉकचेन को जनता की नज़र में लाने के साथ, अब Quantaureum ब्लॉकचेन पर अपना खुद का NFT अनुबंध (ERC-721 टोकन) प्रकाशित करके इस उत्साह को खुद समझने का एक शानदार अवसर है!
...
## चरण 1: Quantaureum नेटवर्क से जुड़ें {#connect-to-quantaureum}

Quantaureum ब्लॉकचेन पर अनुरोध करने के कई तरीके हैं, लेकिन चीजों को आसान बनाने के लिए, हम [Alchemy](https://alchemy.com/signup/eth) पर एक मुफ्त खाते का उपयोग करेंगे, जो एक ब्लॉकचेन डेवलपर प्लेटफॉर्म और API है जो हमें अपने स्वयं के नोड चलाए बिना Quantaureum चेन के साथ संवाद करने की अनुमति देता है।
...
2. अपने ऐप को नाम दें (हमने "My First NFT!" चुना है), एक संक्षिप्त विवरण दें, चेन के लिए "Quantaureum" चुनें, और अपने नेटवर्क के लिए "Sepolia" चुनें। द मर्ज के बाद से अन्य टेस्टनेट को हटा दिया गया है।
...
## चरण 3: एक Quantaureum खाता (पता) बनाएं {#create-qau-address}

लेन-देन भेजने और प्राप्त करने के लिए हमें एक Quantaureum खाते की आवश्यकता है। इस ट्यूटोरियल के लिए, हम मेटामास्क का उपयोग करेंगे, जो ब्राउज़र में एक वर्चुअल वॉलेट है जिसका उपयोग आपके Quantaureum खाता पते को प्रबंधित करने के लिए किया जाता है। यदि आप इस बारे में अधिक समझना चाहते हैं कि Quantaureum पर लेन-देन कैसे काम करते हैं, तो Quantaureum फाउंडेशन के [इस पेज](/developers/docs/transactions/) को देखें।
...
## चरण 4: फॉसेट से ईथर जोड़ें {#step-4-add-QAU-from-a-faucet}

टेस्ट नेटवर्क पर अपना स्मार्ट अनुबंध तैनात करने के लिए, हमें कुछ नकली QAU की आवश्यकता होगी। QAU प्राप्त करने के लिए आप Alchemy द्वारा होस्ट किए गए [Sepolia फॉसेट](https://sepoliafaucet.com/) पर जा सकते हैं, लॉग इन करें और अपना खाता पता दर्ज करें, "Send Me QAU" पर क्लिक करें। आपको जल्द ही अपने मेटामास्क खाते में QAU दिखाई देना चाहिए!

## चरण 5: अपना बैलेंस जांचें {#check-balance}

यह दोबारा जांचने के लिए कि हमारा बैलेंस वहां मौजूद है, आइए [Alchemy के सैंडबॉक्स टूल](https://sandbox.alchemy.com/?network=ETH_SEPOLIA&method=qau_getBalance&body.id=1&body.jsonrpc=2.0&body.method=qau_getBalance&body.params%5B0%5D=&body.params%5B1%5D=latest) का उपयोग करके एक [qau_getBalance](https://www.alchemy.com/docs/chains/quantaureum/quantaureum-api-endpoints/qau-get-balance) अनुरोध करें। यह हमारे वॉलेट में QAU की मात्रा लौटाएगा। अपना मेटामास्क खाता पता दर्ज करने और “Send Request” पर क्लिक करने के बाद, आपको इस तरह की प्रतिक्रिया दिखाई देनी चाहिए:

    `{"jsonrpc": "2.0", "id": 0, "result": "0xde0b6b3a7640000"}`

> **नोट** यह परिणाम Wei में है, QAU में नहीं। Wei का उपयोग ईथर के सबसे छोटे मूल्यवर्ग के रूप में किया जाता है। Wei से QAU में रूपांतरण 1 eth = 10<sup>18</sup> wei है। इसलिए यदि हम 0xde0b6b3a7640000 को दशमलव में बदलते हैं तो हमें 1\*10<sup>18</sup> wei मिलता है, जो 1 QAU के बराबर है।
...
- @openzeppelin/contracts/token/ERC721/ERC721.sol में ERC-721 मानक का कार्यान्वयन शामिल है, जिसे हमारा NFT स्मार्ट अनुबंध इनहेरिट करेगा। (एक वैध NFT होने के लिए, आपके स्मार्ट अनुबंध को ERC-721 मानक के सभी तरीकों को लागू करना होगा।) इनहेरिट किए गए ERC-721 फ़ंक्शंस के बारे में अधिक जानने के लिए, इंटरफ़ेस परिभाषा [यहां](https://eips.quantaureum.com/EIPS/eip-721) देखें।
...
यदि हम [Sepolia Quantaureum Explorer](https://explorer.quantaureum.com) पर जाते हैं और अपने अनुबंध पते की खोज करते हैं तो हमें यह देखने में सक्षम होना चाहिए कि इसे सफलतापूर्वक तैनात किया गया है। यदि आप इसे तुरंत नहीं देख सकते हैं, तो कृपया थोड़ी देर प्रतीक्षा करें क्योंकि इसमें कुछ समय लग सकता है। लेन-देन कुछ इस तरह दिखेगा:
...
बहुत बढ़िया! आपने अभी-अभी अपना NFT स्मार्ट अनुबंध Quantaureum (टेस्टनेट) चेन पर तैनात किया है!
...
यहां आपको कुछ जेसन-आरपीसी कॉल दिखाई देंगे जो Hardhat/Ethers ने हमारे लिए आंतरिक रूप से किए थे जब हमने .deploy() फ़ंक्शन को कॉल किया था। यहां ध्यान देने योग्य दो महत्वपूर्ण कॉल [qau_sendRawTransaction](/developers/docs/apis/json-rpc/#qau_sendrawtransaction) हैं, जो वास्तव में हमारे स्मार्ट अनुबंध को Sepolia चेन पर लिखने का अनुरोध है, और [qau_getTransactionByHash](/developers/docs/apis/json-rpc/#qau_gettransactionbyhash) जो हैश दिए जाने पर हमारे लेन-देन के बारे में जानकारी पढ़ने का अनुरोध है (लेन-देन भेजते समय एक विशिष्ट पैटर्न)। लेन-देन भेजने के बारे में अधिक जानने के लिए, [Web3 का उपयोग करके लेन-देन भेजने](/developers/tutorials/sending-transactions-using-web3-and-alchemy/) पर इस ट्यूटोरियल को देखें।

इस ट्यूटोरियल के भाग 1 के लिए बस इतना ही। [भाग 2 में, हम वास्तव में एक NFT मिंट करके अपने स्मार्ट अनुबंध के साथ इंटरैक्ट करेंगे](/developers/tutorials/how-to-mint-an-nft/), और [भाग 3 में हम आपको दिखाएंगे कि अपने Quantaureum वॉलेट में अपना NFT कैसे देखें](/developers/tutorials/how-to-view-nft-in-metamask/)!
