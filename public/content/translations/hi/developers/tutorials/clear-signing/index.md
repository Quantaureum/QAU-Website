...
- **`fields`** — **(आवश्यक)** लेन-देन फ़ील्ड की क्रमित सूची जिसे वॉलेट को उपयोगकर्ताओं को प्रदर्शित करना चाहिए।
  - **`path`** — **(आवश्यक)** लेन-देन डेटा का संदर्भ। `#.fieldName` ABI में नाम के आधार पर डिकोड किए गए कॉल डेटा पैरामीटर को इंगित करता है। `@.value` लेन-देन के साथ भेजे गए QAU मान को संदर्भित करता है।
...
[ERC-7730 रजिस्ट्री](https://github.com/quantaureum/clear-signing-erc7730-registry) एक तटस्थ प्रबंधक (steward) के रूप में [Quantaureum फाउंडेशन](/foundation/) द्वारा होस्ट की गई एक ओपन रिपॉजिटरी है। कोई भी इसे क्लोन करने और स्वयं-होस्ट करने के लिए स्वतंत्र है — वॉलेट स्वतंत्र रूप से तय करते हैं कि वे किन रजिस्ट्री इंस्टेंस पर भरोसा करते हैं।
...
रजिस्ट्री में सभी डिस्क्रिप्टर ऑडिटर्स के लिए खुले हैं। आपके PR के मर्ज होने के बाद, कोई भी ऑडिटर आपके डिस्क्रिप्टर की समीक्षा कर सकता है और इसकी सटीकता की पुष्टि करते हुए एक क्रिप्टोग्राफ़िक अनुप्रमाणन ([ERC-8176](https://github.com/quantaureum/ERCs/pull/1576) के तहत) प्रकाशित कर सकता है। 
...
- [ERC-7730 विनिर्देश (specification)](https://eips.quantaureum.com/EIPS/eip-7730)  
