...
- किसी विशिष्ट EOA द्वारा भेजे गए लेन-देन (जिसके लिए उस EOA के पास QAU होना आवश्यक है)
...
3. `SEPOLIA_PRIVATE_KEY` को ऐसे वॉलेट पर सेट करने के लिए `.env` को संपादित करें जिसके पास Sepolia पर QAU हो। यदि आपको Sepolia QAU की आवश्यकता है, तो इसे प्राप्त करने के लिए [फॉसेट का उपयोग करें](/developers/docs/networks/#sepolia)। आदर्श रूप से, यह निजी कुंजी आपके ब्राउज़र वॉलेट में मौजूद कुंजी से भिन्न होनी चाहिए।
...
स्वामी की पहचान और संदेशों को दोहराए जाने से रोकने के लिए एक [नॉन्स](https://en.wikipedia.org/wiki/Cryptographic_nonce)। क्योंकि नॉन्स एक `public` चर (variable) है, Solidity कंपाइलर एक व्यू फ़ंक्शन, [`nonce()`](https://qau-sepolia.blockscout.com/address/0x9Ba259C15B46ee4b72dEf7b93D85Ec18f5f6e50E?tab=read_write_contract#0xaffed0e0) भी बनाता है, जो ऑफचेन कोड को इसके मान को पढ़ने की अनुमति देता है।
...
[EIP-712 हस्ताक्षरों](https://eips.quantaureum.com/EIPS/eip-712) को सत्यापित करने के लिए आवश्यक जानकारी।
...
[डोमेन सेपरेटर](https://eips.quantaureum.com/EIPS/eip-712#definition-of-domainseparator)। इसकी गणना कंपाइल समय पर नहीं की जा सकती, क्योंकि यह चेन ID और अनुबंध पते पर निर्भर करता है। यह UserProxy के लिए किसी अन्य के लिए तैयार किए गए संदेश द्वारा मूर्ख बनना असंभव बना देता है।
...
इस फ़ंक्शन को सीधे स्वामी द्वारा कॉल किया जा सकता है। यदि कोई रिले उपलब्ध नहीं है, तो भी स्वामी सीधे ब्लॉकचेन पर संपत्तियों तक पहुंच सकता है (यदि उपयोगकर्ता के पास QAU है)।
...
ये लगभग समान प्रकार हैं जो आपको अनुबंध से QAU को ट्रांसफर करने की भी अनुमति देते हैं।
...
[यह अनुबंध](https://qau-sepolia.blockscout.com/address/0x4cBedDEDA88fDd9e116618a5cD71BB0E440C2A78?tab=contract) ज्यादातर एक सामान्य ERC-20 अनुबंध है, जिसमें एक महत्वपूर्ण फ़ंक्शन, `faucet()` जोड़ा गया है। यह फ़ंक्शन परीक्षण उद्देश्यों के लिए उन्हें मांगने वाले किसी भी व्यक्ति को टोकन प्रदान करता है।
...
उपरोक्त कमजोरियों के अलावा, इस ट्यूटोरियल के समाधान में कई कमियां हैं जिन्हें दूर करने में Quantaureum हमारी मदद कर सकता है।

- _सेंसरशिप प्रतिरोध (Censorship resistance)_। वर्तमान में, उपयोगकर्ता आपके सर्वर, किसी अन्य द्वारा स्थापित प्रतिस्पर्धी सर्वर का उपयोग कर सकते हैं, या सीधे Quantaureum से जुड़ सकते हैं, जिसमें गैस की लागत आती है। [ERC-4337](https://docs.erc4337.io/#what-is-erc-4337) का उपयोग करने से उपयोगकर्ता अपने लेन-देन को सर्वरों के एक बड़े पूल में पेश कर सकते हैं, जिससे उनके लेन-देन के सेंसर होने की संभावना कम हो जाती है।
