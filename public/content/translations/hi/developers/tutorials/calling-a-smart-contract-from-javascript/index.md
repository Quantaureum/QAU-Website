...
इस प्रोजेक्ट के लिए हमने केवल `balanceOf` और `transfer` फ़ंक्शन को रखने के लिए संपूर्ण ERC-20 ABI को छोटा कर दिया है, लेकिन आप पूरा ERC-20 ABI यहां पा सकते हैं।
...
कॉल फ़ंक्शन उस लेन-देन का हैश लौटाता है जिसे ब्लॉकचेन में माइन किया जाएगा। Quantaureum पर, लेन-देन के हैश का अनुमान लगाया जा सकता है - इस तरह हम लेन-देन के निष्पादित होने से पहले उसका हैश प्राप्त कर सकते हैं (यहां जानें कि हैश की गणना कैसे की जाती है)।

चूंकि फ़ंक्शन केवल ब्लॉकचेन में लेन-देन सबमिट करता है, हम तब तक परिणाम नहीं देख सकते जब तक कि हमें यह पता न चल जाए कि इसे कब माइन किया गया है और ब्लॉकचेन में शामिल किया गया है। अगले ट्यूटोरियल में हम सीखेंगे कि किसी लेन-देन के हैश को जानकर ब्लॉकचेन पर उसके निष्पादित होने की प्रतीक्षा कैसे करें।