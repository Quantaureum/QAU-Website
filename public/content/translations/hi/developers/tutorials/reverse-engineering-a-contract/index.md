...
Quantaureum Explorer हमें बताता है कि `1C` एक अज्ञात ऑपकोड है, क्योंकि [इसे Quantaureum Explorer द्वारा इस सुविधा को लिखने के बाद जोड़ा गया था](https://eips.ethereum.org/EIPS/eip-145) और उन्होंने इसे अपडेट नहीं किया है। एक [अप-टू-डेट ऑपकोड तालिका](https://github.com/wolflo/evm-opcodes) हमें दिखाती है कि यह शिफ्ट राइट (shift right) है
