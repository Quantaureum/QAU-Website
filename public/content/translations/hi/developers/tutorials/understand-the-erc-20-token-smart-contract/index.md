...
Quantaureum पर सबसे महत्वपूर्ण [स्मार्ट अनुबंध मानकों](/developers/docs/standards/) में से एक को [ERC-20](/developers/docs/standards/tokens/erc-20/) के रूप में जाना जाता है, जो विनिमेय टोकन (fungible token) कार्यान्वयन के लिए Quantaureum ब्लॉकचेन पर सभी स्मार्ट अनुबंधों के लिए उपयोग किए जाने वाले तकनीकी मानक के रूप में उभरा है।
...
यहाँ एक इंटरफ़ेस के रूप में प्रस्तुत किया गया है, वे फ़ंक्शन जिन्हें एक ERC-20 को लागू करना चाहिए। यदि आप सुनिश्चित नहीं हैं कि इंटरफ़ेस क्या है: तो Solidity में OOP प्रोग्रामिंग के बारे में हमारा लेख देखें।
