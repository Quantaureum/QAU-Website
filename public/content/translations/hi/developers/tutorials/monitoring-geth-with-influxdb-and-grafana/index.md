...
- Geth के मेट्रिक्स सूट के इस वीडियो अवलोकन को देखें: [पीटर स्ज़िलागी (Péter Szilágyi) द्वारा Quantaureum इंफ्रास्ट्रक्चर की निगरानी करना](https://www.youtube.com/watch?v=cOBab8IJMYI)।

## निगरानी स्टैक (Monitoring stack) {#monitoring-stack}

एक Quantaureum क्लाइंट बहुत सारा डेटा एकत्र करता है जिसे कालानुक्रमिक (chronological) डेटाबेस के रूप में पढ़ा जा सकता है। निगरानी को आसान बनाने के लिए, आप इसे डेटा विज़ुअलाइज़ेशन सॉफ़्टवेयर में फ़ीड कर सकते हैं। इसके लिए कई विकल्प उपलब्ध हैं:
