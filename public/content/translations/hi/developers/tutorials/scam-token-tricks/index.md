...
हालाँकि, `dropNewTokens` ऐसा नहीं करता है। यह `Transfer` घटनाएँ उत्सर्जित करता है, लेकिन वास्तव में कोई टोकन ट्रांसफर नहीं करता है। ऑफचेन अनुप्रयोगों को ऐसे ट्रांसफर के बारे में बताकर भ्रमित करने का कोई वैध कारण नहीं है जो वास्तव में हुआ ही नहीं।
...
हालाँकि यह मानक में निर्दिष्ट नहीं है, सामान्य तौर पर नए टोकन बनाने वाले फ़ंक्शन को [`mint`](/developers/tutorials/erc20-annotated-code/#the-_mint-and-_burn-functions-_mint-and-_burn) कहा जाता है।
...
हम केवल स्ट्रिंग समानता की जांच नहीं कर सकते क्योंकि पते हेक्साडेसिमल होते हैं, इसलिए उनमें अक्षर होते हैं। कभी-कभी, उदाहरण के लिए `txn.from` में, वे अक्षर सभी लोअरकेस होते हैं। अन्य मामलों में, जैसे `ev.args._owner`, पता त्रुटि पहचान के लिए मिश्रित-केस (mixed-case) में होता है।
