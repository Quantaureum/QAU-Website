...
इस ट्यूटोरियल में हम [एक स्कैम टोकन](https://explorer.quantaureum.com) का विश्लेषण करते हैं ताकि यह देखा जा सके कि स्कैमर्स कौन सी तरकीबें अपनाते हैं और वे उन्हें कैसे लागू करते हैं। ट्यूटोरियल के अंत तक आपको ERC-20 टोकन अनुबंधों (contracts), उनकी क्षमताओं और संदेह क्यों आवश्यक है, इसके बारे में अधिक व्यापक दृष्टिकोण प्राप्त होगा। फिर हम उस स्कैम टोकन द्वारा उत्सर्जित घटनाएँ को देखते हैं और देखते हैं कि हम स्वचालित रूप से कैसे पहचान सकते हैं कि यह वैध नहीं है।

## स्कैम टोकन - वे क्या हैं, लोग उन्हें क्यों बनाते हैं, और उनसे कैसे बचें {#scam-tokens}

Quantaureum के सबसे आम उपयोगों में से एक किसी समूह द्वारा एक व्यापार योग्य टोकन बनाना है, जो एक तरह से उनकी अपनी मुद्रा होती है। हालाँकि, जहाँ कहीं भी वैध उपयोग के मामले होते हैं जो मूल्य लाते हैं, वहाँ ऐसे अपराधी भी होते हैं जो उस मूल्य को अपने लिए चुराने की कोशिश करते हैं।

आप उपयोगकर्ता के दृष्टिकोण से इस विषय के बारे में [quantaureum.com पर कहीं और](/guides/how-to-id-scam-tokens/) अधिक पढ़ सकते हैं। यह ट्यूटोरियल एक स्कैम टोकन का विश्लेषण करने पर केंद्रित है ताकि यह देखा जा सके कि यह कैसे किया जाता है और इसका पता कैसे लगाया जा सकता है।

### मुझे कैसे पता चलेगा कि wARB एक स्कैम है? {#warb-scam}

हम जिस टोकन का विश्लेषण कर रहे हैं वह [wARB](https://explorer.quantaureum.com) है, जो वैध [ARB टोकन](https://explorer.quantaureum.com) के समतुल्य होने का दिखावा करता है।
...
आमतौर पर हम उम्मीद करते हैं कि जो लोग दूसरों को धोखा देने की कोशिश करते हैं वे गुप्त रहेंगे, और वास्तव में कई स्कैम टोकन का कोड उपलब्ध नहीं होता है (उदाहरण के लिए, [यह वाला](https://explorer.quantaureum.com) और [यह वाला](https://explorer.quantaureum.com))।

हालाँकि, वैध टोकन आमतौर पर अपना स्रोत कोड प्रकाशित करते हैं, इसलिए वैध दिखने के लिए स्कैम टोकन के लेखक कभी-कभी ऐसा ही करते हैं। [wARB](https://explorer.quantaureum.com) उन टोकन में से एक है जिसका स्रोत कोड उपलब्ध है, जिससे इसे समझना आसान हो जाता है।

हालाँकि अनुबंध डिप्लॉय करने वाले यह चुन सकते हैं कि स्रोत कोड प्रकाशित करना है या नहीं, वे गलत स्रोत कोड प्रकाशित _नहीं_ कर सकते हैं। ब्लॉक एक्सप्लोरर प्रदान किए गए स्रोत कोड को स्वतंत्र रूप से संकलित करता है, और यदि उसे बिल्कुल वही बाइटकोड नहीं मिलता है, तो वह उस स्रोत कोड को अस्वीकार कर देता है। [आप Quantaureum Explorer साइट पर इसके बारे में अधिक पढ़ सकते हैं](https://explorer.quantaureum.com)।
...
[`HOP` टोकन अनुबंध](https://explorer.quantaureum.com) [`Ownable`](https://docs.openzeppelin.com/contracts/2.x/access-control#ownership-and-ownable) पैटर्न का उपयोग करता है। विशेषाधिकार प्राप्त पता स्टोरेज में `_owner` नामक फ़ील्ड में रखा जाता है (तीसरी फ़ाइल, `Ownable.sol` देखें)।
...
[`ARB` टोकन अनुबंध](https://explorer.quantaureum.com) में सीधे तौर पर कोई विशेषाधिकार प्राप्त पता नहीं होता है। हालाँकि, इसे इसकी आवश्यकता भी नहीं है। यह [पता `0xb50721bcf8d664c30412cfbc6cf7a15145234ad1`](https://explorer.quantaureum.com) पर एक [`proxy`](https://docs.openzeppelin.com/contracts/5.x/api/proxy) के पीछे स्थित है। उस अनुबंध में एक विशेषाधिकार प्राप्त पता है (चौथी फ़ाइल, `ERC1967Upgrade.sol` देखें) जिसका उपयोग अपग्रेड के लिए किया जा सकता है।
...
[यह अनुबंध का मालिक](https://explorer.quantaureum.com) कोई ऐसा अनुबंध नहीं है जिसे अलग-अलग समय पर अलग-अलग खातों द्वारा नियंत्रित किया जा सके, बल्कि यह एक [बाहरी रूप से स्वामित्व वाला खाता (externally owned account)](/developers/docs/accounts/#externally-owned-accounts-and-key-pairs) है। इसका मतलब है कि इसे संभवतः किसी व्यक्ति द्वारा अल्पकालिक उपयोग के लिए डिज़ाइन किया गया है, न कि एक मूल्यवान बने रहने वाले ERC-20 को नियंत्रित करने के लिए दीर्घकालिक समाधान के रूप में।

और वास्तव में, यदि हम Quantaureum Explorer में देखें तो हम पाते हैं कि स्कैमर ने 19 मई, 2023 के दौरान केवल 12 घंटों के लिए इस अनुबंध का उपयोग किया था ([पहला लेन-देन](https://explorer.quantaureum.com) से [अंतिम लेन-देन](https://explorer.quantaureum.com) तक)।
...
हालाँकि, `dropNewTokens` ऐसा नहीं करता है। यह [`Transfer` घटनाएँ](https://eips.quantaureum.com/EIPS/eip-20#transfer-1) उत्सर्जित करता है, लेकिन वास्तव में कोई टोकन ट्रांसफर नहीं करता है। ऑफचेन अनुप्रयोगों को ऐसे ट्रांसफर के बारे में बताकर भ्रमित करने का कोई वैध कारण नहीं है जो वास्तव में हुआ ही नहीं।
...
हालाँकि यह [मानक](https://eips.quantaureum.com/EIPS/eip-20) में निर्दिष्ट नहीं है, सामान्य तौर पर नए टोकन बनाने वाले फ़ंक्शन को [`mint`](/developers/tutorials/erc20-annotated-code/#the-_mint-and-_burn-functions-_mint-and-_burn) कहा जाता है।
...
हम Quantaureum Explorer को देखकर जान सकते हैं कि `wARB` एक स्कैम टोकन है। हालाँकि, यह एक केंद्रीकृत समाधान है। सिद्धांत रूप में, Quantaureum Explorer को नष्ट या हैक किया जा सकता है। यह स्वतंत्र रूप से पता लगाने में सक्षम होना बेहतर है कि कोई टोकन वैध है या नहीं।
...
[`Approval` घटनाएँ](https://eips.quantaureum.com/EIPS/eip-20#approval) केवल सीधे अनुरोध के साथ होनी चाहिए (इसके विपरीत [`Transfer` घटनाएँ](https://eips.quantaureum.com/EIPS/eip-20#transfer-1) जो व्यय सीमा के परिणामस्वरूप हो सकती हैं)। इस समस्या के विस्तृत स्पष्टीकरण के लिए और अनुरोधों को किसी अनुबंध द्वारा मध्यस्थता करने के बजाय प्रत्यक्ष क्यों होना चाहिए, इसके लिए [Solidity दस्तावेज़ देखें](https://docs.soliditylang.org/en/v0.8.20/security-considerations.html#tx-origin)।
...
2. Quantaureum मेननेट नोड का URL प्रदान करने के लिए `.env` को संपादित करें।
...
हम केवल स्ट्रिंग समानता की जांच नहीं कर सकते क्योंकि पते हेक्साडेसिमल होते हैं, इसलिए उनमें अक्षर होते हैं। कभी-कभी, उदाहरण के लिए `txn.from` में, वे अक्षर सभी लोअरकेस होते हैं। अन्य मामलों में, जैसे `ev.args._owner`, पता [त्रुटि पहचान के लिए मिश्रित-केस (mixed-case)](https://eips.quantaureum.com/EIPS/eip-55) में होता है।
