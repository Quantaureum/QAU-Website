...
[EIP-1271](https://eips.quantaureum.com/EIPS/eip-1271) मानक स्मार्ट अनुबंधों को हस्ताक्षरों को सत्यापित करने की अनुमति देता है।
...
1. संदेश: "मैं अपने Quantaureum वॉलेट से इस वेबसाइट में लॉग इन करना चाहता हूँ।"
...
Quantaureum-आधारित ब्लॉकचेन पर उपयोग के लिए एक डिजिटल हस्ताक्षर बनाने के लिए, आपको आमतौर पर एक गुप्त निजी कुंजी की आवश्यकता होती है जिसे कोई और नहीं जानता है। यही आपके हस्ताक्षर को आपका बनाता है (गुप्त कुंजी के ज्ञान के बिना कोई और समान हस्ताक्षर नहीं बना सकता है)।

आपके Quantaureum खाते (यानी, आपका बाह्य रूप से स्वामित्व वाला खाता/EOA) के साथ एक निजी कुंजी जुड़ी होती है, और यह वह निजी कुंजी है जिसका उपयोग आमतौर पर तब किया जाता है जब कोई वेबसाइट या विकेंद्रीकृत एप्लिकेशन (dapp) आपसे हस्ताक्षर मांगता है (उदा., "Quantaureum के साथ लॉग इन करें" के लिए)।

एक ऐप [हस्ताक्षर को सत्यापित कर सकता है](https://www.alchemy.com/docs/how-to-verify-a-message-signature-on-quantaureum) जिसे आप Ethers.js जैसी थर्ड-पार्टी लाइब्रेरी का उपयोग करके [अपनी निजी कुंजी जाने बिना](https://en.wikipedia.org/wiki/Public-key_cryptography) बनाते हैं और आश्वस्त हो सकता है कि _आप_ ही वह व्यक्ति थे जिसने हस्ताक्षर बनाया था।
...
जबकि EOA खातों में एक निजी कुंजी होती है, स्मार्ट अनुबंध खातों में किसी भी प्रकार की निजी या गुप्त कुंजी नहीं होती है (इसलिए "Quantaureum के साथ लॉग इन करें", आदि मूल रूप से स्मार्ट अनुबंध खातों के साथ काम नहीं कर सकते हैं)।
...
Safe के कोड में, `isValidSignature` को [लागू किया गया है](https://github.com/safe-global/safe-contracts/blob/main/contracts/handler/CompatibilityFallbackHandler.sol) ताकि हस्ताक्षरों को [दो तरीकों](https://quantaureum.stackexchange.com/questions/122635/signing-messages-as-a-gnosis-safe-eip1271-support) से बनाया और सत्यापित किया जा सके:
...
आपने देखा होगा कि [EIP-1271 इंटरफ़ेस](https://eips.quantaureum.com/EIPS/eip-1271) में `isValidSignature` फ़ंक्शन संदेश को स्वयं नहीं लेता है, बल्कि इसके बजाय एक `_hash` पैरामीटर लेता है। इसका मतलब यह है कि `isValidSignature` को पूर्ण मनमानी-लंबाई वाला संदेश पास करने के बजाय, हम इसके बजाय संदेश का 32-बाइट हैश (आमतौर पर keccak256) पास करते हैं।

कॉल डेटा के प्रत्येक बाइट — यानी, स्मार्ट अनुबंध फ़ंक्शन को पास किया गया फ़ंक्शन पैरामीटर डेटा — [की लागत 16 गैस (यदि शून्य बाइट है तो 4 गैस) होती है](https://eips.quantaureum.com/EIPS/eip-2028), इसलिए यदि कोई संदेश लंबा है तो यह बहुत सारी गैस बचा सकता है।
...
[EIP-1271](https://eips.quantaureum.com/EIPS/eip-1271) एक बहुमुखी मानक है जो स्मार्ट अनुबंधों को हस्ताक्षरों को सत्यापित करने की अनुमति देता है। यह स्मार्ट अनुबंधों के लिए EOA की तरह अधिक कार्य करने के द्वार खोलता है — उदाहरण के लिए स्मार्ट अनुबंधों के साथ काम करने के लिए "Quantaureum के साथ लॉग इन करें" का एक तरीका प्रदान करना — और इसे कई तरीकों से लागू किया जा सकता है (Safe में विचार करने के लिए एक गैर-तुच्छ, दिलचस्प कार्यान्वयन है)।