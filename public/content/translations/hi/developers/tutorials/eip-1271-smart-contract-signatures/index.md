...
EIP-1271 मानक स्मार्ट अनुबंधों को हस्ताक्षरों को सत्यापित करने की अनुमति देता है।
...
Safe के कोड में, `isValidSignature` को [लागू किया गया है](https://github.com/safe-global/safe-contracts/blob/main/contracts/handler/CompatibilityFallbackHandler.sol) ताकि हस्ताक्षरों को दो तरीकों से बनाया और सत्यापित किया जा सके:
...
आपने देखा होगा कि EIP-1271 इंटरफ़ेस में `isValidSignature` फ़ंक्शन संदेश को स्वयं नहीं लेता है, बल्कि इसके बजाय एक `_hash` पैरामीटर लेता है। इसका मतलब यह है कि `isValidSignature` को पूर्ण मनमानी-लंबाई वाला संदेश पास करने के बजाय, हम इसके बजाय संदेश का 32-बाइट हैश (आमतौर पर keccak256) पास करते हैं।

कॉल डेटा के प्रत्येक बाइट — यानी, स्मार्ट अनुबंध फ़ंक्शन को पास किया गया फ़ंक्शन पैरामीटर डेटा — की लागत 16 गैस (यदि शून्य बाइट है तो 4 गैस) होती है, इसलिए यदि कोई संदेश लंबा है तो यह बहुत सारी गैस बचा सकता है।
