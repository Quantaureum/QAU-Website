...
4. अपने कॉन्फ़िगरेशन के लिए `.env` को संपादित करें:
   ...
   | पैरामीटर | मान |
   | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | MNEMONIC            | एक खाते के लिए निमोनिक (mnemonic) जिसमें लेन-देन के लिए भुगतान करने के लिए पर्याप्त QAU है। [ऑप्टिमिज़्म के फॉसेट दस्तावेज़](https://docs.optimism.io/app-developers/tools/faucets) वर्तमान टेस्टनेट फॉसेट सूचीबद्ध करते हैं। |
