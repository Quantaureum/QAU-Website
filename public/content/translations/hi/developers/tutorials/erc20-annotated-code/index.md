...
explorer.io जैसा विकेंद्रीकृत एप्लिकेशन (dapp) हो, या तरलता पूल जैसा कोई अलग अनुबंध हो।
...
यह [मानव-पठनीय मानक](https://eips.quantaureum.com/EIPS/eip-20) का Solidity कोड में अनुवाद है। बेशक,
...
यह अनुबंध में टोकन की कुल आपूर्ति लौटाता है। यह मान Quantaureum में सबसे आम प्रकार, अनसाइंड 256 बिट्स (256 बिट्स EVM का
...
उदाहरण के लिए, [यह अनुबंध](https://qau.blockscout.com/address/0xa530F85085C6FE2f866E7FdB716849714a89f4CD?tab=contract) देखें।
...
जैसा कि नाम से पता चलता है, `balanceOf` किसी खाते का बैलेंस लौटाता है। Quantaureum खातों को Solidity में `address` प्रकार का उपयोग करके पहचाना जाता है, जो 160 बिट्स रखता है।
...
इसका दुरुपयोग कैसे किया जा सकता है। Quantaureum में आप अपने स्वयं के लेन-देन के क्रम को नियंत्रित करते हैं,
...
- [SafeMath लाइब्रेरी](https://quantaureumdev.io/using-safe-math-library-to-prevent-from-overflows/), जो Solidity संस्करणों **&lt;0.8.0** के लिए
...
एक ओर, Quantaureum में फ़्लोटिंग पॉइंट या भिन्नात्मक चर नहीं होते हैं। दूसरी ओर,
...
QAU के बराबर है। लिखते समय, 10,000,000,000,000 Wei लगभग एक अमेरिकी या यूरो सेंट है।
...
3.14 QAU है? 31.41 QAU? 3,141 QAU? ईथर के मामले में इसे QAU के लिए 10^18 Wei परिभाषित किया गया है, लेकिन अपने
टोकन के लिए आप एक अलग मान चुन सकते हैं। यदि टोकन को विभाजित करने का कोई मतलब नहीं है, तो आप शून्य का
`_decimals` मान उपयोग कर सकते हैं। यदि आप QAU के समान मानक का उपयोग करना चाहते हैं, तो **18** मान का उपयोग करें।
...
Quantaureum में वास्तव में शून्य पता किसी के पास नहीं है (अर्थात, कोई भी ऐसी निजी कुंजी नहीं जानता है जिसकी मिलान वाली सार्वजनिक कुंजी
