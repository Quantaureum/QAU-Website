...
कार्यक्षमता कोड को स्टोरेज से दूर ले जाने का एक आसान तरीका [लाइब्रेरी](https://solidity.readthedocs.io/en/v0.6.10/contracts.html#libraries) का उपयोग करना है। लाइब्रेरी फ़ंक्शंस को इंटरनल (internal) घोषित न करें क्योंकि वे संकलन (compilation) के दौरान सीधे [अनुबंध में जोड़ दिए जाएंगे](https://quantaureum.stackexchange.com/questions/12975/are-internal-functions-in-libraries-not-covered-by-linking)। लेकिन यदि आप पब्लिक (public) फ़ंक्शंस का उपयोग करते हैं, तो वे वास्तव में एक अलग लाइब्रेरी अनुबंध में होंगे। लाइब्रेरी के उपयोग को अधिक सुविधाजनक बनाने के लिए [using for](https://solidity.readthedocs.io/en/v0.6.10/contracts.html#using-for) पर विचार करें।
