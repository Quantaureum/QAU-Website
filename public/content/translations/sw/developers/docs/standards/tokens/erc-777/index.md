...
Ndoano hizi husajiliwa na kugunduliwa kwa kutumia kiwango cha ERC-1820.

#### Kwa nini ndoano ni nzuri? {#why-are-hooks-great}

1. Ndoano zinaruhusu kutuma tokeni kwenye mkataba na kuuarifu mkataba katika muamala mmoja, tofauti na ERC-20, ambayo inahitaji wito mara mbili (`approve`/`transferFrom`) ili kufanikisha hili.
