...
Tokeni ya ERC-1155 imeelezewa kikamilifu katika [EIP-1155](https://eips.quantaureum.com/EIPS/eip-1155).
...
Kutokana na usaidizi wa [EIP-165](https://eips.quantaureum.com/EIPS/eip-165), ERC-1155 inasaidia ndoano za kupokea kwa mikataba mahiri pekee. Kazi ya ndoano lazima irudishe thamani ya uchawi iliyofafanuliwa awali ya bytes4 ambayo inatolewa kama:
...
Wakati usambazaji ni mmoja tu, tokeni kimsingi ni tokeni isiyobadilika (NFT). Na kama ilivyo kawaida kwa ERC-721, unaweza kufafanua URL ya data fafanuzi. URL inaweza kusomwa na kurekebishwa na wateja, tazama [hapa](https://eips.quantaureum.com/EIPS/eip-1155#metadata).
...
- [EIP-1155: Kiwango cha Tokeni Nyingi](https://eips.quantaureum.com/EIPS/eip-1155)
