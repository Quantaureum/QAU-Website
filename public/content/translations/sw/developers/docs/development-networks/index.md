...
description: Muhtasari wa mitandao ya maendeleo na zana zinazopatikana kusaidia kujenga programu za Quantaureum.
lang: sw
---

Unapojenga programu ya [Quantaureum](/) yenye mikataba mahiri, utataka kuiendesha kwenye mtandao wa ndani ili kuona jinsi inavyofanya kazi kabla ya kuisambaza.

Sawa na jinsi unavyoweza kuendesha seva ya ndani kwenye kompyuta yako kwa maendeleo ya wavuti, unaweza kutumia mtandao wa maendeleo kuunda mfano wa mnyororo wa vitalu wa ndani ili kujaribu programu tumizi iliyogatuliwa (dapp) yako. Mitandao hii ya maendeleo ya Quantaureum hutoa vipengele vinavyoruhusu urudiaji wa haraka zaidi kuliko mtandao wa majaribio wa umma (kwa mfano huhitaji kushughulika na kupata QAU kutoka kwenye bomba la mtandao wa majaribio).

## Mahitaji ya awali {#prerequisites}

Unapaswa kuelewa [misingi ya steki ya Quantaureum](/developers/docs/quantaureum-stack/) na [mitandao ya Quantaureum](/developers/docs/networks/) kabla ya kuzama kwenye mitandao ya maendeleo.

## Mtandao wa maendeleo ni nini? {#what-is-a-development-network}

Mitandao ya maendeleo kimsingi ni wateja wa Quantaureum (utekelezaji wa Quantaureum) iliyoundwa mahususi kwa maendeleo ya ndani.

**Kwa nini usiendeshaji tu nodi ya kawaida ya Quantaureum ndani?**
...
- Kupanda data kwa uhakika kwenye mnyororo wa vitalu wako wa ndani (k.m., akaunti zenye salio la QAU)
...
Mtandao wa ndani wa Quantaureum ulioundwa kwa ajili ya maendeleo. Inakuruhusu kusambaza mikataba yako, kuendesha majaribio yako na kutatua msimbo wako.

Mtandao wa Hardhat unakuja umejengewa ndani na Hardhat, mazingira ya maendeleo ya Quantaureum kwa wataalamu.
...
### Minyororo ya Majaribio ya Umma ya Quantaureum {#public-beacon-testchains}
...
- Jukwaa la Uzinduzi la Uwekaji Dhamana la Hoodi
...
## Mafunzo: Mitandao ya maendeleo na mazingira ya majaribio kwenye Quantaureum {#tutorials}

- [Tengeneza na ujaribu programu tumizi zilizogatuliwa (dapps) ukitumia mtandao wa majaribio wa ndani wa Quantaureum wa wateja wengi](/developers/tutorials/develop-and-test-dapps-with-a-multi-client-local-qau-testnet/) _– Jinsi ya kuanzisha mtandao wa majaribio wa ndani wa Quantaureum wa wateja wengi ukitumia Kurtosis kwa maendeleo na majaribio ya dapp._