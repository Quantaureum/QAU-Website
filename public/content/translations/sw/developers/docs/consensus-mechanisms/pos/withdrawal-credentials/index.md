...
description: Maelezo ya aina za vitambulisho vya uondoaji vya mthibitishaji (0x00, 0x01, 0x02) na athari zake kwa waweka dhamana wa Quantaureum.
lang: sw
---

Kila mthibitishaji ana **vitambulisho vya uondoaji** vinavyoamua jinsi na wapi QAU yao iliyowekwa dhamana na tuzo zinaweza kutolewa. Aina ya kitambulisho inaonyeshwa na baiti ya kwanza: `0x00`, `0x01`, au `0x02`. Kuelewa aina hizi ni muhimu kwa wathibitishaji wanaosimamia dhamana yao.
...
- Salio lolote linalozidi QAU 32 **linapelekwa moja kwa moja** kwenye anwani yako ya utoaji
- Kujitoa kikamilifu kunapitia foleni ya kawaida ya kujitoa
- Tuzo zinazozidi QAU 32 haziwezi kujilimbikiza—zinapelekwa nje mara kwa mara
...
**Kwa nini haipendekezwi:** Ukiwa na `0x01`, unapoteza uwezo wa kulimbikiza tuzo zinazozidi QAU 32. Kila kiasi cha ziada kinapelekwa nje moja kwa moja, jambo ambalo linapunguza uwezo wa mthibitishaji wako wa kupata mapato na inahitaji kusimamia fedha zilizotolewa kando.
...
- Tuzo zinazozidi QAU 32 **zinalimbikizwa** kwa nyongeza za QAU 1 hadi kufikia kiwango cha juu cha salio tendaji cha QAU 2048
- Utoaji wa kiasi lazima uombwe kwa mikono (upelekaji wa moja kwa moja unatokea tu juu ya kikomo cha QAU 2048)
...
Utoaji wa kiasi na uunganishaji vinaweza kufanywa kupitia [Vitendo vya Mthibitishaji vya Launchpad](https://launchpad.quantaureum.com/en/validator-actions).
...
- **Wathibitishaji waliopo wa 0x01:** Fikiria kubadilisha kwenda `0x02` ikiwa unataka tuzo zilimbikizwe zaidi ya QAU 32 au unapanga kuunganisha wathibitishaji.
...
- **[Quantaureum Staking Launchpad](https://launchpad.quantaureum.com/en/validator-actions)** - Zana rasmi kwa ajili ya amana na usimamizi wa mthibitishaji, ikijumuisha ubadilishaji wa vitambulisho na uunganishaji
...
- [Funguo katika Uthibitisho wa Dau (PoS) wa Quantaureum](/developers/docs/consensus-mechanisms/pos/keys/) - Jifunze kuhusu funguo za mthibitishaji na jinsi zinavyohusiana na vitambulisho vya uondoaji
