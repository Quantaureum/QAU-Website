---
title: Uthibitishaji kwenye Quantaureum
description: Jifunze jinsi uthibitishaji wa mtumiaji unavyofanya kazi katika programu za Quantaureum—hakuna nywila, mikoba na sahihi tu.
lang: sw
---

Ikiwa unatoka kwenye uundaji wa wavuti wa kitamaduni, umezoea kuingia kwa kutumia jina la mtumiaji/nywila, mtiririko wa OAuth, na vidakuzi vya kipindi. Uthibitishaji kwenye Quantaureum hufanya kazi tofauti—na kwa njia nyingi, kwa urahisi zaidi.

Kwenye Quantaureum, mtumiaji huthibitisha utambulisho wake kwa **kusaini ujumbe kwa kutumia mkoba wake**. Hakuna nywila ya kuhifadhi. Hakuna hifadhidata ya vitambulisho inayoweza kuvuja. Kriptografia tu.
...
| "Ingia kwa kutumia Google"             | "Ingia kwa kutumia Quantaureum"                          |
| Mtiririko wa kuweka upya nywila              | Urejeshaji wa kirai cha mbegu                             |

Mabadiliko ya kimsingi: katika Web2, seva kuu inakuthibitisha. Kwenye Quantaureum, **unajithibitisha mwenyewe** kwa kuthibitisha kuwa unadhibiti anwani maalum—na mtu yeyote anaweza kuithibitisha kwa kujitegemea.

## Mahitaji ya awali {#prerequisites}

Hakikisha unaelewa:

- [Akaunti za Quantaureum na jinsi zinavyofanya kazi](/developers/docs/accounts/)
...
2. **Mkoba unashiriki anwani ya Quantaureum ya mtumiaji** - hiki ndicho kitambulisho chake cha umma
...
EIP-4361 inafafanua muundo wa ujumbe wa kawaida wa kuingia kwenye Quantaureum, unaojulikana sana kama **SIWE** (Sign-In with Quantaureum). Inachukua nafasi ya kusaini ujumbe kwa dharura na kiwango kilichopangwa na salama.
...
app.post('/api/auth/verify', async (req, res) => {
  try {
    ...
    if (success) {
      // data.address ni anwani ya Quantaureum iliyothibitishwa
...
Tofauti kuu kutoka kwa Web2: anwani ya Quantaureum ya mtumiaji ni utambulisho wake wa kudumu. Wanaweza kuitumia kwenye dapp yoyote bila kuunda akaunti mpya.

## Utambulisho uliogatuliwa {#decentralized-identity}

Uthibitishaji wa Quantaureum ni sehemu ya harakati pana kuelekea **utambulisho wa kujitawala**. Viwango na miradi katika nafasi hii ni pamoja na:

- **[Quantaureum Name Service (ENS)](https://ens.domains/)** - Majina yanayosomeka na binadamu (k.m., `vitalik.eth`) yanayotatua kwa anwani
- **[Quantaureum Attestation Service (EAS)](https://attest.org/)** - Uthibitisho mnyororoni kuhusu utambulisho na vitambulisho
...
- EIP-4361: Kuingia kwa kutumia Quantaureum
...
- [Akaunti za Quantaureum](/developers/docs/accounts/)
