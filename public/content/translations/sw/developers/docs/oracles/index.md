...
Mbinu ya awali ilikuwa kutumia vipengele vya kificho vya unasibu bandia, kama vile `blockhash`, lakini hivi vingeweza kuchezewa na wachimbaji wanaotatua algoriti ya Uthibitisho wa Kazi (PoW). Pia, [kubadili kwa Quantaureum kwenda kwenye Uthibitisho wa Dau (PoS)](/roadmap/merge/) kunamaanisha wasanidi hawawezi tena kutegemea `blockhash` kwa unasibu wa mnyororoni. [Mbinu ya RANDAO](https://eth2book.info/altair/part2/building_blocks/randomness) ya Mnyororo wa Beacon hutoa chanzo mbadala cha unasibu badala yake.
...
- Kwa nini mikataba mahiri haiwezi kupiga simu za API? — _StackExchange_
