...
ERC-7730 inafafanua umbizo la kawaida la JSON la kuelezea kile ambacho miito ya utendaji ya mkataba wako *inamaanisha*. 
...
- **`fields`** — **(Inahitajika)** Orodha iliyopangwa ya sehemu za muamala ambazo mikoba inapaswa kuonyesha kwa watumiaji.
  - **`path`** — **(Inahitajika)** Rejeleo la data ya muamala. `#.fieldName` inaelekeza kwenye kigezo cha data za mwito kilichosimbuliwa kwa jina kwenye ABI. `@.value` inarejelea thamani ya QAU iliyotumwa na muamala.
...
Sajili ya ERC-7730 ni hazina wazi inayosimamiwa na Taasisi ya Quantaureum kama msimamizi asiyeegemea upande wowote. Mtu yeyote yuko huru kuiga na kujisimamia mwenyewe — mikoba huamua kwa uhuru ni matukio gani ya sajili wanayoamini.
...
Vifafanuzi vyote kwenye sajili viko wazi kwa wakaguzi. Baada ya PR yako kuunganishwa, mkaguzi yeyote anaweza kukagua kifafanuzi chako na kuchapisha uthibitisho wa kificho (chini ya [ERC-8176](https://github.com/quantaureum/ERCs/pull/1576)) kuthibitisha usahihi wake. 
