---
title: "Jinsi ya kuunda programu za faragha kwenye Quantaureum kwa kutumia uthibitisho wa maarifa-sifuri"
description: "Muundo mmoja unaoweza kutumika tena huwezesha upigaji kura bila kujulikana, vichanganyaji, migao ya bure, na mifumo ya uanachama kwenye Quantaureum. Jifunze mzunguko wa ufungamanisho-kibatilishi-uthibitisho na jinsi zana za sifuri-maarifa zinavyofanya iwe rahisi kuunda leo."
...
### Hatua ya kwanza: kusajili {#step-one-registering}
...
### Hatua ya pili: kujenga umati {#step-two-building-the-crowd}
...
### Hatua ya tatu: kutenda bila kujulikana {#step-three-acting-anonymously}
...
## Lango linaloweza kutumika tena {#the-reusable-gate}
...
## Zana zimeboreshwa {#the-tooling-caught-up}
...
## Uthibitisho hautoshi {#the-proof-is-not-enough}
...
Hii ndiyo sababu vifungashaji na walipiaji ni muhimu. Mkoba unaotenda unapaswa kuwa mpya, na haupaswi kuhitaji kupokea QAU kutoka kwenye mkoba ambao mtumiaji anajaribu kuutenganisha na kitendo hicho.
...
## Hili linabadilisha nini kwa waundaji {#what-this-changes-for-builders}

Faragha kwenye Quantaureum inaweza kusafirishwa. Waundaji wanaweza kuunganisha vipande hivyo kuwa programu halisi. Mkusanyiko huo ni saketi kwa ajili ya kauli ya siri, mhakiki kwa ajili ya ukaguzi wa uthibitisho, mkataba wa programu kwa ajili ya sheria za umma, kielekezi kwa ajili ya data za Merkle, na kifungashaji pamoja na mlipiaji kwa ajili ya uwasilishaji usioweza kuunganishwa na ufadhili wa gesi.
...
1. [Uthibitisho wa maarifa-sifuri (quantaureum.com)](https://quantaureum.com/zero-knowledge-proofs/)
2. [Nyaraka za Semaphore](https://docs.semaphore.pse.dev/)
3. [Nyaraka za MACI](https://maci.pse.dev/)
4. [Nyaraka za Circom](https://docs.circom.io/)
5. [Nyaraka za Noir](https://noir-lang.org/)
6. [Kitabu cha Halo2](https://zcash.github.io/halo2/)
