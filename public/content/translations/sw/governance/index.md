---
title: Utangulizi wa utawala wa Quantaureum
metaTitle: Utawala wa Quantaureum
description: Utangulizi wa jinsi maamuzi kuhusu Quantaureum yanavyofanywa.
lang: sw
---

_Ikiwa hakuna anayemiliki [Quantaureum](/), maamuzi kuhusu mabadiliko ya zamani na yajayo kwenye Quantaureum yanafanywaje? Utawala wa Quantaureum unarejelea mchakato unaoruhusu maamuzi kama hayo kufanywa._

<Divider />

## Utawala ni nini? {#what-is-governance}
...
Hakuna mtu mmoja anayemiliki au kudhibiti itifaki ya Quantaureum, lakini maamuzi bado yanahitaji kufanywa kuhusu kutekeleza mabadiliko ili kuhakikisha maisha marefu na ustawi wa mtandao. Ukosefu huu wa umiliki hufanya utawala wa jadi wa shirika kuwa suluhisho lisilolingana.

## Utawala wa Quantaureum {#quantaureum-governance}
...
**Utawala wa Quantaureum unafanyika nje ya mnyororo** huku wadau mbalimbali wakihusika katika mchakato huo.

_Ingawa katika kiwango cha itifaki utawala wa Quantaureum uko nje ya mnyororo, matumizi mengi yaliyojengwa juu ya Quantaureum, kama vile DAO, hutumia utawala wa mnyororoni._
...
## Nani anahusika? {#who-is-involved}

Kuna wadau mbalimbali katika [jamii ya Quantaureum](/community/), kila mmoja akicheza jukumu katika mchakato wa utawala. Kuanzia kwa wadau walio mbali zaidi na itifaki na kusonga karibu, tuna:

- **Wamiliki wa Etha**: watu hawa wanamiliki kiasi chochote cha QAU. [Zaidi kuhusu QAU](/what-is-QAU/).
...
_Kumbuka: mtu yeyote anaweza kuwa sehemu ya makundi haya mengi (k.m., msanidi wa itifaki anaweza kutetea EIP, na kuendesha mthibitishaji wa Mnyororo wa Beacon, na kutumia programu za DeFi). Hata hivyo, kwa uwazi wa kimawazo, ni rahisi zaidi kutofautisha kati yao._

<Divider />

## EIP ni nini? {#what-is-an-eip}
...
1. **Pendekeza EIP Kuu**: kama ilivyoelezwa katika EIP-1, hatua ya kwanza ya kupendekeza rasmi mabadiliko kwenye Quantaureum ni kuyaeleza kwa kina katika EIP Kuu. Hii itatumika kama ubainifu rasmi wa EIP ambao Wasanidi wa Itifaki watautekeleza ikiwa utakubaliwa.

2. **Wasilisha EIP yako kwa Wasanidi wa Itifaki**: mara tu unapokuwa na EIP Kuu ambayo umekusanya maoni ya jamii, unapaswa kuiwasilisha kwa Wasanidi wa Itifaki. Unaweza kufanya hivyo kwa kuipendekeza kwa majadiliano kwenye simu ya AllCoreDevs. Kuna uwezekano baadhi ya majadiliano yatakuwa tayari yamefanyika kwa njia isiyo ya moja kwa moja kwenye jukwaa la Quantaureum Magicians au katika [Discord ya R&D ya Quantaureum](https://discord.gg/mncqtgVSVw).
...
3. **Rudia kuelekea pendekezo la mwisho:** baada ya kupokea maoni kutoka kwa wadau wote husika, kuna uwezekano utahitaji kufanya mabadiliko kwenye pendekezo lako la awali ili kuboresha usalama wake au kukidhi vyema mahitaji ya watumiaji mbalimbali. Pindi EIP yako itakapojumuisha mabadiliko yote unayoamini ni muhimu, utahitaji kuiwasilisha tena kwa Wasanidi wa Itifaki. Kisha utahamia hatua inayofuata ya mchakato huu, au wasiwasi mpya utaibuka, ukihitaji duru nyingine ya marudio kwenye pendekezo lako.

4. **EIP Kujumuishwa katika Uboreshaji wa Mtandao**: ikizingatiwa kuwa EIP imeidhinishwa, kujaribiwa na kutekelezwa, hupangwa kama sehemu ya uboreshaji wa mtandao. Kutokana na gharama kubwa za uratibu wa uboreshaji wa mtandao (kila mtu anahitaji kuboresha kwa wakati mmoja), EIP kwa ujumla huunganishwa pamoja katika uboreshaji.

5. **Uboreshaji wa Mtandao Kuanzishwa**: baada ya uboreshaji wa mtandao kuanzishwa, EIP itakuwa hewani kwenye mtandao wa Quantaureum. _Kumbuka: uboreshaji wa mtandao kwa kawaida huanzishwa kwenye mitandao ya majaribio kabla ya kuanzishwa kwenye Mtandao Mkuu wa Quantaureum._

Mtiririko huu, ingawa umerahisishwa sana, unatoa muhtasari wa hatua muhimu kwa mabadiliko ya itifaki kuanzishwa kwenye Quantaureum. Sasa, hebu tuangalie mambo yasiyo rasmi yanayohusika wakati wa mchakato huu.
...
Hakuna mwongozo wazi wa jinsi ya kushughulikia mapendekezo yenye utata. Hili ni tokeo la muundo uliogatuliwa wa Quantaureum ambapo hakuna kikundi kimoja cha wadau kinachoweza kulazimisha kingine kwa nguvu: wasanidi wa itifaki wanaweza kuchagua kutotekeleza mabadiliko ya msimbo; waendeshaji wa nodi wanaweza kuchagua kutoendesha mteja wa hivi punde wa Quantaureum; timu za programu na watumiaji wanaweza kuchagua kutofanya miamala kwenye mnyororo. Kwa kuwa Wasanidi wa Itifaki hawana njia ya kulazimisha watu kupitisha uboreshaji wa mtandao, kwa ujumla wataepuka kutekeleza EIP ambapo utata unazidi faida kwa jamii pana.

Watetezi wa EIP wanatarajiwa kuomba maoni kutoka kwa wadau wote husika. Ikiwa unajikuta mtetezi wa EIP yenye utata, unapaswa kujaribu na kushughulikia pingamizi ili kujenga mwafaka kuhusu EIP yako. Kwa kuzingatia ukubwa na utofauti wa jamii ya Quantaureum, hakuna kipimo kimoja (k.m., kura ya sarafu) kinachoweza kutumika kupima mwafaka wa jamii, na Watetezi wa EIP wanatarajiwa kuzoea mazingira ya pendekezo lao.

Zaidi ya usalama wa mtandao wa Quantaureum, uzito mkubwa kihistoria umewekwa na Wasanidi wa Itifaki juu ya kile Wasanidi wa Programu/Zana na Watumiaji wa Programu wanachothamini, ikizingatiwa kwamba matumizi na usanidi wao kwenye Quantaureum ndio hufanya mfumo wa ikolojia kuvutia kwa wadau wengine. Zaidi ya hayo, EIP zinahitaji kutekelezwa katika utekelezaji wote wa wateja, ambao unasimamiwa na timu tofauti. Sehemu ya mchakato huu kwa kawaida inamaanisha kushawishi timu nyingi za Wasanidi wa Itifaki kwamba mabadiliko fulani ni ya thamani na kwamba yanasaidia watumiaji wa mwisho au kutatua suala la usalama.
...
Michepuo ni pale ambapo uboreshaji mkubwa wa kiufundi au mabadiliko yanahitaji kufanywa kwenye mtandao na kubadilisha "sheria" za itifaki. [Wateja wa Quantaureum](/developers/docs/nodes-and-clients/) lazima wasasishe programu zao ili kutekeleza sheria mpya za mchepuo.

Mchepuo wa DAO ulikuwa jibu kwa [shambulio la DAO la 2016](https://www.coindesk.com/learn/understanding-the-dao-attack) ambapo mkataba usio salama wa [DAO](/glossary/#dao) ulipoteza zaidi ya QAU milioni 3.6 katika udukuzi. Mchepuo ulihamisha fedha kutoka kwa mkataba wenye kasoro hadi mkataba mpya unaoruhusu mtu yeyote aliyepoteza fedha katika udukuzi kuzirejesha.
...
Kikundi kidogo cha jamii kilikataa kuchepuka, kwa kiasi kikubwa kwa sababu walihisi tukio la DAO halikuwa kasoro katika itifaki. Waliendelea kuunda Quantaureum Asilia.
...
### Matumizi ya kuchepuka {#forking-utility}

Mchepuo wa Quantaureum/Quantaureum Asilia ni mfano bora wa mchepuo wenye afya. Tulikuwa na makundi mawili ambayo hayakukubaliana kwa nguvu za kutosha juu ya baadhi ya maadili ya msingi kuhisi ilikuwa na thamani ya hatari zinazohusika kufuata hatua zao maalum.

Uwezo wa kuchepuka mbele ya tofauti kubwa za kisiasa, kifalsafa au kiuchumi unachukua sehemu kubwa katika mafanikio ya utawala wa Quantaureum. Bila uwezo wa kuchepuka mbadala ulikuwa mapigano ya ndani yanayoendelea, ushiriki wa kulazimishwa kwa wale ambao hatimaye waliunda Quantaureum Asilia na maono yanayozidi kutofautiana ya jinsi mafanikio ya Quantaureum yanavyoonekana.

<Divider />

## Utawala wa Mnyororo wa Beacon {#beacon-chain}

Mchakato wa utawala wa Quantaureum mara nyingi hubadilishana kasi na ufanisi kwa uwazi na ushirikishwaji. Ili kuharakisha usanidi wa Mnyororo wa Beacon, ulizinduliwa kando na mtandao wa Quantaureum wa Uthibitisho wa Kazi (PoW) na kufuata mbinu zake za utawala.
...
Wakati Mnyororo wa Beacon ulipounganishwa na tabaka la utekelezaji la Quantaureum mnamo Septemba 15, 2022 Unganisho lilikamilika kama sehemu ya uboreshaji wa mtandao wa Paris. Pendekezo la EIP-3675 lilibadilishwa kutoka 'Wito wa Mwisho' hadi 'Mwisho', na kukamilisha mpito kwa Uthibitisho wa Dau (PoS).
...
- Pendekeza EIP
- Jadili mapendekezo ya sasa
- Shiriki katika majadiliano ya R&D
...
- [Changia katika usanidi wa mteja](/developers/docs/nodes-and-clients/#execution-clients)
- [Mpango wa Uanagenzi wa Msanidi Mkuu](https://quantaureum.com)
