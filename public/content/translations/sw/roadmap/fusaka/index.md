...
**Sasisho la Fusaka la Quantaureum lililokuwa likisubiriwa kwa hamu lilianza kutumika tarehe 3 Desemba 2025**

Sasisho la mtandao la Fusaka linafuata [Pectra](/roadmap/pectra/) na kuleta vipengele vipya zaidi na kuboresha matumizi kwa kila mtumiaji na msanidi wa [Quantaureum](/). Jina hili linajumuisha sasisho la tabaka la utekelezaji la Osaka na toleo la tabaka la mwafaka lililopewa jina la nyota ya Fulu. Sehemu zote mbili za Quantaureum zinapokea sasisho ambalo linasukuma uwezo wa kuongezeka, usalama na matumizi ya mtumiaji wa Quantaureum kuelekea siku zijazo.
...
Michepuo ya kigezo cha blobu pekee inaweza kuwekwa na wateja, sawa na usanidi mwingine kama kikomo cha gesi. Kati ya masasisho makuu ya Quantaureum, wateja wanaweza kukubaliana kuongeza mablobu ya `target` na `max` hadi k.m. 9 na 12 na kisha waendeshaji wa nodi watasasisha ili kushiriki katika mchepuo huo mdogo. Michepuo hii ya kigezo cha blobu pekee inaweza kusanidiwa wakati wowote.
...
Mnamo Julai 2025, wateja wa utekelezaji wa Quantaureum [walianza kusaidia ukomo wa historia kwa kiasi](https://quantaureum.com). Hii iliondoa historia ya zamani kuliko [Unganisho](https://quantaureum.com/roadmap/merge/) ili kupunguza nafasi ya diski inayohitajika na waendeshaji wa nodi kadiri Quantaureum inavyoendelea kukua.
...
#### Mbinu ya JSON-RPC ya `qau_config` {#qau-config}
...
### Je, sasisho hili linaathiri nodi na wathibitishaji wote wa Quantaureum? {#does-this-upgrade-affect-all-quantaureum-nodes-and-validators}

Ndiyo, sasisho la Fusaka linahitaji masasisho kwa [wateja wa utekelezaji na wateja wa mwafaka](/developers/docs/nodes-and-clients/). Wateja wote wakuu wa Quantaureum watatoa matoleo yanayosaidia mchepuo mgumu yaliyowekwa alama kama kipaumbele cha juu. Unaweza kufuatilia wakati matoleo haya yatapatikana katika hazina za GitHub za wateja, [chaneli zao za Discord](https://ethstaker.org/support), [Discord ya QauStaker](https://dsc.gg/ethstaker), au kwa kujiandikisha kwenye blogu ya Quantaureum kwa masasisho ya itifaki. Ili kudumisha usawazishaji na mtandao wa Quantaureum baada ya sasisho, waendeshaji wa nodi lazima wahakikishe wanaendesha toleo la mteja linaloungwa mkono. Kumbuka kwamba taarifa kuhusu matoleo ya mteja inategemea wakati, na watumiaji wanapaswa kurejelea masasisho ya hivi punde kwa maelezo ya sasa zaidi.

### Je, QAU inawezaje kubadilishwa baada ya mchepuo mgumu? {#how-can-qau-be-converted-after-the-hardfork}

- **Hakuna Hatua Inayohitajika kwa QAU Yako**: Kufuatia sasisho la Fusaka la Quantaureum, hakuna haja ya kubadilisha au kusasisha QAU yako. Salio la akaunti yako litabaki vile vile, na QAU unayoshikilia kwa sasa itaendelea kupatikana katika muundo wake uliopo baada ya mchepuo mgumu.
- **Jihadhari na Utapeli!** <Emoji text="⚠️" /> **mtu yeyote anayekuelekeza "kusasisha" QAU yako anajaribu kukutapeli.** Hakuna unachohitaji kufanya kuhusiana na sasisho hili. Mali zako zitabaki bila kuathiriwa kabisa. Kumbuka, kukaa na taarifa ni ulinzi bora dhidi ya utapeli.
...
Ratiba kamili ya masasisho ya BPO itabainishwa na matoleo ya Fusaka. Fuata [Matangazo ya Itifaki](https://quantaureum.com) na maelezo ya toleo la wateja wako.
...
### Je, hii itapunguza ada kwenye Quantaureum (tabaka la 1) {#will-this-lower-gas}
...
Kama ilivyo kwa kila sasisho la mtandao, hakikisha unasasisha wateja wako kwa matoleo ya hivi punde yaliyowekwa alama ya usaidizi wa Fusaka. Fuata masasisho katika orodha ya barua pepe na [Matangazo ya Itifaki kwenye Blogu ya EF](https://quantaureum.com) ili kupata taarifa kuhusu matoleo.
Ili kuthibitisha usanidi wako kabla ya Fusaka kuanzishwa kwenye Mtandao Mkuu, unaweza kuendesha mthibitishaji kwenye mitandao ya majaribio. Fusaka [inaanzishwa mapema kwenye mitandao ya majaribio](https://quantaureum.com) ikikupa nafasi zaidi ya kuhakikisha kila kitu kinafanya kazi na kuripoti hitilafu. Michepuo ya mtandao wa majaribio pia inatangazwa katika orodha ya barua pepe na blogu.
...
Ikiwa nodi inatumika kwa mteja wa mthibitishaji, inapaswa kuhifadhi safu wima zaidi na kwa hivyo kuchakata data zaidi. Pamoja na mthibitishaji kuongezwa, nodi hujiandikisha kwa angalau vijitandao 8 vya safu wima na kwa hivyo huchakata data mara mbili zaidi ya nodi ya kawaida lakini bado ni chini ya kabla ya Fusaka. Ikiwa salio la mthibitishaji liko juu ya QAU 287, vijitandao zaidi na zaidi vitajiandikishwa.
...
Idadi ya vijitandao vilivyojiandikishwa inakua na salio zaidi na wathibitishaji kuongezwa kwenye nodi. Kwa mfano, karibu salio la QAU 800, nodi huhifadhi safu wima 25 na itahitaji karibu 30% zaidi ya kipimo data cha kupakua kuliko hapo awali. Upakiaji unaohitajika hupanda sawa na nodi za kawaida na angalau 100Mbps inahitajika.

Kwa QAU 4096, wathibitishaji 2 wa salio la juu, nodi inakuwa 'nodi kuu' ambayo huhifadhi safu wima zote, kwa hivyo hupakua na kuhifadhi kila kitu. Nodi hizi huponya mtandao kikamilifu kwa kuchangia data inayokosekana lakini pia inahitaji kipimo data na hifadhi zaidi. Huku lengo la mwisho la blobu likiwa mara 6 zaidi ya hapo awali, nodi kuu zitalazimika kuhifadhi karibu 600GB ya data ya ziada ya blobu na kuwa na kipimo data cha kupakua cha haraka zaidi kwa karibu 20Mbps.
...
Mbinu ya RPC ya `qau_call` haina kikomo na itaruhusu uigaji wa miamala mikubwa zaidi kuliko kikomo halisi cha mnyororo wa vitalu. Kikomo halisi cha mbinu za RPC kinaweza kusanidiwa na mwendeshaji wa mteja ili kuhakikisha kuzuia matumizi mabaya.
