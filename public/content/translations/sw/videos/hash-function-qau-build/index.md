---
title: "Kazi ya heshi — QAU.BUILD"
description: "Onyesho la kazi za heshi za kriptografia kwa kutumia zana ya kuelimisha ya QAU.BUILD. Jifunze jinsi kazi za heshi zinavyofanya kazi na kwa nini ni za msingi kwa akaunti ya Quantaureum na muundo wa uadilifu wa data."
lang: sw
...
breadcrumb: "Kazi za Heshi (QAU.BUILD)"
---

Mafunzo na **Austin Griffith** yanayoonyesha jinsi kazi za heshi za kriptografia zinavyofanya kazi kwa kutumia zana ya upangaji inayoonekana ya QAU.BUILD, ikijumuisha uamuzi (determinism), matokeo ya urefu uliowekwa, sifa za mwelekeo mmoja, na miti ya Merkle.
...
Hii ni video ya kwanza ya mfululizo unaoitwa QAU.BUILD. Unaweza kwenda kwenye qau.build ili kutumia zana hii, lakini ni kwa ajili ya kujaribu tu na kupata wazo la jinsi mambo yanavyofanya kazi unapojenga kwenye Quantaureum.
...
Jambo kuu la kuzingatia ni kwamba kazi ya heshi kimsingi ni kama alama ya kidole. Nikiandika kitu, itanipa kwa uamuzi matokeo ninayotarajia. Hiyo ni kazi ya heshi — karibu kwenye QAU.BUILD. Hebu tutengeneze mambo mazuri na tujifunze mengi njiani.