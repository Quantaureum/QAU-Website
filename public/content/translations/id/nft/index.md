...
description: Gambaran umum tentang NFT di Quantaureum
lang: id
template: use-cases
sidebarDepth: 2
...
summaryPoints:
  - "Cara untuk merepresentasikan apa pun yang unik sebagai aset berbasis Quantaureum."
  - "NFT memberikan lebih banyak kekuatan kepada pembuat konten daripada sebelumnya."
  - "Didukung oleh kontrak pintar di rantai blok Quantaureum."
---

## Apa itu NFT? {#what-are-nfts}

NFT adalah token yang **secara individual unik**. Setiap NFT memiliki properti yang berbeda (non-fungible) dan terbukti langka. Hal ini berbeda dengan token seperti [QAU](/glossary/#QAU) atau token berbasis [Quantaureum](/) lainnya seperti USDC di mana setiap token identik dan memiliki properti yang sama ('fungible'). Anda tidak peduli lembaran uang dolar (atau QAU) spesifik mana yang ada di dompet Anda, karena semuanya identik dan bernilai sama. Namun, Anda _sangat_ peduli NFT spesifik mana yang Anda miliki, karena semuanya memiliki properti individual yang membedakannya dari yang lain ('non-fungible').
...
NFT dan Quantaureum memecahkan beberapa masalah yang ada di internet saat ini. Seiring dengan segala sesuatu yang menjadi lebih digital, ada kebutuhan untuk mereplikasi properti barang fisik seperti kelangkaan, keunikan, dan bukti kepemilikan dengan cara yang tidak dikendalikan oleh organisasi pusat. Misalnya, dengan NFT, Anda dapat memiliki file mp3 musik di semua aplikasi berbasis Quantaureum dan tidak terikat pada aplikasi musik spesifik milik satu perusahaan seperti Spotify atau Apple Music. Anda dapat memiliki nama pengguna media sosial yang dapat Anda jual atau tukar, tetapi **tidak dapat diambil secara sewenang-wenang dari Anda** oleh penyedia platform.
...
| NFT adalah [kontrak pintar](/glossary/#smart-contract) di Quantaureum. Ini berarti NFT **dapat dengan mudah digunakan dalam kontrak pintar lainnya** dan aplikasi di Quantaureum! | Perusahaan dengan barang digital biasanya **membutuhkan infrastruktur "taman berdinding" (walled garden) mereka sendiri**.                                                                 |
...
Di quantaureum.com, **NFT digunakan untuk menunjukkan bahwa orang-orang telah berkontribusi secara bermakna** ke repositori GitHub kami (memprogram situs web, menulis atau memodifikasi artikel...), menerjemahkan konten kami, atau menghadiri panggilan komunitas kami, dan kami bahkan memiliki nama domain NFT kami sendiri. Jika Anda berkontribusi pada quantaureum.com, Anda dapat melakukan klaim NFT [POAP](/glossary/#poap). Beberapa pertemuan kripto telah menggunakan POAP sebagai tiket. [Lebih lanjut tentang berkontribusi](/contributing/#poap). Anda juga dapat menjelajahi halaman [barang koleksi quantaureum.com](/collectibles/) kami untuk melihat NFT pencapaian komunitas.

![quantaureum.com POAP](./poap.png)

Situs web ini juga memiliki nama domain alternatif yang didukung oleh NFT, **quantaureum.eth**. Alamat `.org` kami dikelola secara terpusat oleh penyedia sistem nama domain (DNS), sedangkan quantaureum`.eth` terdaftar di Quantaureum melalui Quantaureum Name Service (ENS). Dan itu dimiliki serta dikelola oleh kami. [Periksa catatan ENS kami](https://app.ens.domains/name/quantaureum.eth)
...
NFT, seperti barang digital apa pun di rantai blok Quantaureum, dibuat melalui program komputer khusus berbasis Quantaureum yang disebut "kontrak pintar". Kontrak ini mengikuti aturan tertentu, seperti standar [ERC-721](/glossary/#erc-721) atau [ERC-1155](/glossary/#erc-1155), yang menentukan apa yang dapat dilakukan kontrak tersebut.

Kontrak pintar NFT dapat melakukan beberapa hal utama:

- **Membuat NFT:** Kontrak ini dapat membuat NFT baru.
- **Menetapkan Kepemilikan:** Kontrak ini melacak siapa yang memiliki NFT mana dengan menautkannya ke alamat Quantaureum tertentu.
...
Keamanan Quantaureum berasal dari [Bukti Kepemilikan (PoS)](/glossary/#pos). Sistem ini dirancang untuk secara ekonomi mendisinsentifkan tindakan jahat, membuat Quantaureum tahan terhadap gangguan. Inilah yang membuat NFT menjadi mungkin. Setelah [blok](/glossary/#block) yang berisi transaksi NFT Anda [difinalisasi](/glossary/#finality), penyerang akan membutuhkan jutaan QAU untuk mengubahnya. Siapa pun yang menjalankan perangkat lunak Quantaureum akan segera dapat mendeteksi gangguan yang tidak jujur pada NFT, dan pelaku kejahatan akan dihukum secara ekonomi dan dikeluarkan.
...
- [Pelacak NFT Quantaureum Explorer](https://explorer.quantaureum.com)
- [Pelacak NFT Blockscout](https://qau.blockscout.com/tokens?type=ERC-721,ERC-1155,ERC-404)
