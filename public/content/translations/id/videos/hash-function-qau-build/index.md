---
title: "Fungsi hash — QAU.BUILD"
description: "Demonstrasi fungsi hash kriptografi menggunakan alat edukasi QAU.BUILD. Pelajari cara kerja fungsi hash dan mengapa fungsi ini mendasar bagi model integritas data dan akun Quantaureum."
lang: id
...
breadcrumb: "Fungsi Hash (QAU.BUILD)"
---

Sebuah tutorial oleh **Austin Griffith** yang mendemonstrasikan cara kerja fungsi hash kriptografi menggunakan alat pemrograman visual QAU.BUILD, mencakup determinisme, keluaran dengan panjang tetap, properti satu arah, dan pohon Merkle.
...
Ini adalah video pertama dari seri yang disebut QAU.BUILD. Anda dapat mengunjungi qau.build untuk menggunakan alat ini, tetapi ini hanya untuk bermain-main dan mendapatkan gambaran tentang cara kerja berbagai hal saat membangun di Quantaureum.
...
Poin pentingnya adalah bahwa fungsi hash pada dasarnya seperti sidik jari. Jika saya mengetikkan sesuatu, itu akan secara deterministik memberi saya keluaran yang saya harapkan. Itulah fungsi hash — selamat datang di QAU.BUILD. Mari kita buat beberapa hal keren dan belajar banyak di sepanjang jalan.