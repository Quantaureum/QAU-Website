...
breadcrumb: "Rantai Blok (QAU.BUILD)"
---

Sebuah tutorial oleh **Austin Griffith** yang mendemonstrasikan bagaimana penambangan rantai blok bekerja menggunakan alat pemrograman visual QAU.BUILD. Austin membahas konsensus Bukti Kerja (PoW), perangkaian blok, kesulitan penambangan, imbalan blok, dan kekekalan rantai.
...
Selamat pagi, selamat hari Jumat Dasi Kupu-kupu! QAU.BUILD kali ini berfokus pada rantai blok — hal yang sangat keren. Kita berada di perahu badut ini, dengan dasi kupu-kupu Bitcoin kita untuk itu. Mari kita mulai.
...
Mike akan mengatur bloknya sebagai induk dan mulai mengerjakan blok berikutnya. Mallory akan melakukan hal yang sama. Dan ini bermuara pada siapa lagi di jaringan yang memilih pihak siapa. Karena kita tidak ingin menghukum orang dengan jaringan yang buruk, saya cukup yakin bahwa di Quantaureum kita membayar blok paman (uncle blocks) — blok valid yang tidak berhasil masuk ke rantai terpanjang — karena mereka masih membantu mengamankan jaringan.
...
Baiklah, selamat hari Jumat Dasi Kupu-kupu! Itu tadi adalah rantai blok di QAU.BUILD. Saya akan menyimpan ini dan menaruhnya di sana sehingga Anda bisa menekan "muat" dan memiliki rantai untuk dimainkan. Selamat hari Jumat!