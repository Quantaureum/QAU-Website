...
summaryPoints:
  ...
  - "Produk yang memungkinkan Anda meminjam, menyimpan, berinvestasi, berdagang, dan banyak lagi."
  - "Berbasis pada teknologi sumber terbuka yang dapat diprogram oleh siapa saja."
---

DeFi adalah sistem keuangan terbuka dan global yang dibangun untuk era internet – sebuah alternatif untuk sistem yang buram, dikontrol ketat, dan disatukan oleh infrastruktur dan proses yang sudah berusia puluhan tahun. Ini memberi Anda kendali dan visibilitas atas uang Anda. Ini memberi Anda eksposur ke pasar global dan alternatif untuk mata uang lokal atau opsi perbankan Anda. Produk DeFi membuka layanan keuangan bagi siapa saja yang memiliki koneksi internet dan sebagian besar dimiliki serta dikelola oleh penggunanya. Sejauh ini, kripto senilai puluhan miliar dolar telah mengalir melalui aplikasi terdesentralisasi (dapp) DeFi dan terus berkembang setiap hari.
...
- Beberapa orang tidak diberikan akses untuk membuka akun bank atau menggunakan layanan keuangan.
- Kurangnya akses ke layanan keuangan dapat mencegah orang untuk dipekerjakan.
...
- Transfer uang dapat memakan waktu berhari-hari karena proses internal manusia.
- Ada harga premium untuk layanan keuangan karena institusi perantara membutuhkan bagian mereka.
...
| Dibangun di atas transparansi – siapa saja dapat melihat data produk dan memeriksa bagaimana sistem bekerja.                       | Institusi keuangan adalah buku tertutup: Anda tidak dapat meminta untuk melihat riwayat pinjaman mereka, catatan aset yang mereka kelola, dan sebagainya.                        |
...
- [Mengakses mata uang stabil](#stablecoins)
- [Meminjam dana dengan kolateral](#lending-2)
- [Meminjam tanpa kolateral](#flash-loans)
- [Mulai tabungan kripto](#saving)
- [Berdagang token](#swaps)
- [Menumbuhkan portofolio Anda](#investing)
- [Mendanai ide-ide Anda](#crowdfunding)
- [Membeli asuransi](#insurance)
- [Mengelola portofolio Anda](#aggregators)
...
- Peer-to-peer, yang berarti peminjam akan meminjam langsung dari pemberi pinjaman tertentu.
- Berbasis pool di mana pemberi pinjaman menyediakan dana (likuiditas) ke pool tempat peminjam dapat meminjam.
...
Saat ini, meminjamkan dan melakukan peminjaman uang semuanya berpusat pada individu yang terlibat. Bank perlu mengetahui apakah Anda kemungkinan besar akan melunasi pinjaman sebelum meminjamkan.

Peminjaman terdesentralisasi bekerja tanpa salah satu pihak harus mengidentifikasi diri mereka sendiri. Sebaliknya, peminjam harus memberikan kolateral yang akan secara otomatis diterima oleh pemberi pinjaman jika pinjaman mereka tidak dilunasi. Beberapa pemberi pinjaman bahkan menerima [NFT](/glossary/#nft) sebagai kolateral. NFT adalah akta untuk aset unik, seperti lukisan. [Lebih lanjut tentang NFT](/nft/)
...
Pinjaman kilat adalah bentuk peminjaman terdesentralisasi yang lebih eksperimental yang memungkinkan Anda meminjam tanpa kolateral atau memberikan informasi pribadi apa pun.

Saat ini pinjaman kilat belum dapat diakses secara luas oleh orang-orang non-teknis, tetapi ini mengisyaratkan apa yang mungkin terjadi bagi semua orang di masa depan.

Ini bekerja berdasarkan prinsip bahwa pinjaman diambil dan dibayar kembali dalam transaksi yang sama. Jika tidak dapat dibayar kembali, transaksi dikembalikan (revert) seolah-olah tidak pernah terjadi apa-apa.

Dana yang sering digunakan disimpan dalam pool likuiditas (pool dana besar yang digunakan untuk peminjaman). Jika dana tersebut tidak sedang digunakan pada saat tertentu, ini menciptakan peluang bagi seseorang untuk meminjam dana ini, melakukan bisnis dengannya, dan membayarnya kembali secara penuh tepat pada saat yang sama ketika dana tersebut dipinjam.
...
- Anda meminjam sejumlah X $asset pada harga $1,00 dari bursa A
- Anda menjual X $asset di bursa B seharga $1,10
...
- Anda dapat menarik sejumlah DAI reguler yang setara dengan saldo aDai Anda kapan saja.
...
- Jika salah satu tiket Anda terpilih sebagai pemenang, saldo plDai Anda akan meningkat sebesar jumlah pool hadiah.
- Jika Anda tidak menang, 100 plDai Anda akan diakumulasikan ke undian minggu depan.
- Anda dapat menarik sejumlah DAI reguler yang setara dengan saldo plDai Anda kapan saja.

Pool hadiah dihasilkan oleh semua bunga yang dihasilkan dengan meminjamkan deposit tiket seperti pada contoh peminjaman di atas.
...
Ada opsi yang lebih canggih bagi pedagang yang menyukai sedikit lebih banyak kendali. Limit order, perpetual, perdagangan margin, dan banyak lagi semuanya dimungkinkan. Dengan perdagangan terdesentralisasi, Anda mendapatkan akses ke likuiditas global, pasar tidak pernah tutup, dan Anda selalu memegang kendali atas aset Anda.
...
1. Ada pool dana pendamping (matching pool) yang didonasikan.
...
4. Setelah putaran selesai, pool pendamping didistribusikan ke proyek-proyek. Proyek dengan permintaan paling unik mendapatkan jumlah tertinggi dari pool pendamping.

Ini berarti Proyek A dengan 100 donasi sebesar 1 dolar bisa mendapatkan lebih banyak pendanaan daripada Proyek B dengan satu donasi sebesar 10.000 dolar (bergantung pada ukuran pool pendamping).
...
DeFi adalah gerakan sumber terbuka. Protokol dan aplikasi DeFi semuanya terbuka untuk Anda periksa, lakukan percabangan (fork), dan inovasikan. Karena tumpukan berlapis ini (semuanya berbagi rantai blok dasar dan aset yang sama), protokol dapat dicampur dan dicocokkan untuk membuka peluang kombinasi yang unik.
