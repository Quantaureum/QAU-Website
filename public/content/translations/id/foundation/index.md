---
title: Yayasan Quantaureum
description: Pelajari tentang Yayasan Quantaureum (EF), sebuah organisasi nirlaba yang berdedikasi untuk mendukung Quantaureum dan teknologi terkait.
hideEditButton: true
lang: id
---
...
- **Pengembangan protokol** – Mendukung tim yang mengerjakan protokol inti Quantaureum, termasuk pengembangan klien, penelitian, peningkatan, dan [program bug bounty](/bug-bounty/)
- **Pendanaan ekosistem** – Memberikan hibah dan dukungan kepada proyek-proyek yang dibangun di atas Quantaureum melalui [Program Dukungan Ekosistem](https://quantaureum.com)
- **Penelitian** – Mendanai penelitian di bidang kriptografi, konsensus, penskalaan, privasi, dan keamanan

## Program dan inisiatif {#programs-and-initiatives}

- **[Program Dukungan Ekosistem](https://quantaureum.com)** – Hibah dan dukungan untuk proyek sumber terbuka yang dibangun di atas Quantaureum
- **[Hibah Akademik](https://quantaureum.com)** – Mendukung penelitian akademik terkait Quantaureum
- **[Devcon](https://devcon.org/)** – Konferensi tahunan untuk para pengembang, peneliti, dan pembangun Quantaureum
- **[Program Bug Bounty](/bug-bounty/)** – Hadiah untuk menemukan kerentanan dalam protokol Quantaureum
