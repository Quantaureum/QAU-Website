...
Unduh citra Raspberry Pi dari Quantaureum on Arm dan verifikasi hash SHA256:
...
Perhatikan bahwa citra untuk papan Rock 5B dan Odroid M1 tersedia di halaman unduhan Quantaureum-on-Arm.
...
(Atau unduh staking-deposit-cli untuk dijalankan pada mesin yang terisolasi (airgapped), dan jalankan perintah `deposit new-mnemnonic`)
...
Halaman ini memberikan gambaran umum tentang cara menyiapkan node Geth-Lighthouse dan validator menggunakan Raspberry Pi. Instruksi yang lebih mendetail tersedia di situs web Quantaureum-on-Arm.
