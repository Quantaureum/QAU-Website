...
- **Pemilih fungsi**: Kontrak memiliki kurang dari 256 fungsi, jadi kita dapat membedakannya dengan satu bita.
  Bita-bita ini biasanya bukan nol dan oleh karena itu memakan biaya enam belas gas.
- **Nol**: Bita-bita ini selalu nol karena alamat dua puluh bita tidak memerlukan kata tiga puluh dua bita untuk menyimpannya.
  Bita yang menyimpan nol memakan biaya empat gas (lihat kertas kuning, Lampiran G,
...
Sayangnya, melihat spesifikasi ERC-20, ini hanya menyisakan satu fungsi, `transfer`.
