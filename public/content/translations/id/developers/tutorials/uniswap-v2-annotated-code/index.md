...
Jika tidak ada biaya, atur `kLast` menjadi nol (jika belum). Ketika kontrak ini ditulis, ada fitur pengembalian dana gas yang mendorong kontrak untuk mengurangi ukuran keseluruhan state Quantaureum dengan mengosongkan penyimpanan yang tidak mereka butuhkan.
...
Jika kita dapat membatasi jumlahnya sehingga kita akan menggunakan tumpukan, kita menggunakan lebih sedikit gas. Untuk detail lebih lanjut lihat kertas kuning, spesifikasi formal Quantaureum, hal. 26, persamaan 298.
...
Hash ini adalah pengidentifikasi untuk jenis transaksi. Satu-satunya yang kita dukung di sini adalah `Permit` dengan parameter ini.
...
Hitung pemisah domain untuk EIP-712.
...
Jika semuanya baik-baik saja, perlakukan ini sebagai persetujuan ERC-20.
...
Fungsi ini menghitung alamat pertukaran pasangan untuk kedua token tersebut. Kontrak ini dibuat menggunakan opcode CREATE2, sehingga kita dapat menghitung alamat menggunakan algoritma yang sama jika kita mengetahui parameter yang digunakannya. Ini jauh lebih murah daripada bertanya kepada factory, dan
...
Fungsi ini mengimplementasikan fungsionalitas transfer ERC-20, yang memungkinkan sebuah akun untuk menghabiskan jatah yang diberikan oleh akun yang berbeda.
...
Fungsi ini mengimplementasikan fungsionalitas transferFrom ERC-20, yang memungkinkan sebuah akun untuk menghabiskan jatah yang diberikan oleh akun yang berbeda.
