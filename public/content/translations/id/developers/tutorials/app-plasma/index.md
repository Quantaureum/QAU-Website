...
Tanda tangan EIP-191 memerlukan buffer dengan awalan 26-byte, diikuti oleh panjang pesan dalam ASCII, dan terakhir pesan itu sendiri.
...
Kita dapat menggunakan Hash Pedersen untuk akun karena mereka hanya di-hash di dalam bukti tanpa pengetahuan. Namun, dalam kode ini kita perlu memeriksa tanda tangan pesan, yang dihasilkan oleh peramban. Untuk itu, kita perlu mengikuti format penandatanganan Quantaureum di EIP-191. Ini berarti kita perlu membuat buffer gabungan dengan awalan standar, panjang pesan dalam ASCII, dan pesan itu sendiri, serta menggunakan keccak256 standar Quantaureum untuk menge-hash-nya.
...
Mungkin saja untuk membuat bank yang benar-benar rahasia menggunakan alamat siluman, tetapi hal itu di luar cakupan artikel ini.
