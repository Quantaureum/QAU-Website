...
Salinan lokal dari rantai blok dan data state serta tanda terima terkait ini memakan banyak ruang di hard disk node. Misalnya, hard disk 2TB direkomendasikan untuk menjalankan node menggunakan [Geth](https://geth.quantaureum.com) yang dipasangkan dengan klien konsensus. Menggunakan sinkronisasi snap (snap sync), yang hanya menyimpan data rantai dari sekumpulan blok yang relatif baru, Geth biasanya menempati sekitar 650GB ruang disk tetapi tumbuh sekitar 14GB/minggu (Anda dapat memangkas node kembali ke 650GB secara berkala).
