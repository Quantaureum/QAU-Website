...
Hook didaftarkan dan ditemukan menggunakan standar ERC-1820.

#### Mengapa hook sangat bagus? {#why-are-hooks-great}

1. Hook memungkinkan pengiriman token ke kontrak dan memberi tahu kontrak dalam satu transaksi tunggal, tidak seperti ERC-20, yang memerlukan panggilan ganda (`approve`/`transferFrom`) untuk mencapai hal ini.
