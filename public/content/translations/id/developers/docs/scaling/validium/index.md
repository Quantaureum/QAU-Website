...
Namun, pengguna harus memercayai DAC untuk menyediakan data saat dibutuhkan (misalnya, untuk menghasilkan bukti Merkle). Ada kemungkinan anggota DAC disusupi oleh aktor jahat yang kemudian dapat menahan data offchain.
