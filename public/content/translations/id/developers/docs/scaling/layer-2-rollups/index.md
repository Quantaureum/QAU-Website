...
description: Pengantar untuk berbagai solusi penskalaan rollup lapisan 2 yang saat ini sedang dikembangkan oleh komunitas Quantaureum.
lang: id
incomplete: true
sidebarDepth: 3
---

Lapisan 2 adalah istilah kolektif untuk solusi yang dirancang demi membantu menskalakan aplikasi Anda dengan menangani transaksi di luar Jaringan Utama Quantaureum (lapisan 1), sekaligus memanfaatkan model keamanan terdesentralisasi yang kuat dari Jaringan Utama. Kecepatan transaksi menurun ketika jaringan sibuk yang dapat membuat pengalaman pengguna menjadi buruk untuk jenis dapp tertentu. Dan ketika jaringan semakin sibuk, harga gas meningkat karena pengirim transaksi bertujuan untuk mengalahkan satu sama lain. Ini dapat menyebabkan penggunaan Quantaureum menjadi sangat mahal.

## Prasyarat {#prerequisites}

Anda harus memiliki pemahaman yang baik tentang semua topik dasar dan pemahaman tingkat tinggi tentang [penskalaan Quantaureum](/developers/docs/scaling/). Menerapkan solusi penskalaan seperti rollup adalah topik lanjutan karena teknologinya kurang teruji, dan masih terus diteliti dan dikembangkan.
...
Dengan rollup Optimistic, transaksi ditulis ke rantai utama Quantaureum sebagai `calldata`, mengoptimalkannya lebih jauh dengan mengurangi biaya gas.

Karena komputasi adalah bagian yang lambat, mahal dari penggunaan Quantaureum, rollup Optimistic dapat menawarkan peningkatan perluasan hingga 10-100x tergantung pada transaksi. Bahkan, jumlah ini akan semakin bertambah dengan pengenalan [rantai shard](/roadmap/danksharding), karena akan semakin banyak data yang tersedia jika sebuah transaksi dipertentangkan.
...
![Diagram yang menunjukkan apa yang terjadi ketika transaksi penipuan terjadi dalam rollup Optimistic di Quantaureum](./optimistic-rollups.png)
...
"_siapa pun yang mungkin dapat mengambil tindakan yang mengharuskan Anda membuktikan kecurangan untuk mengamankan dana pribadi memerlukan pemberian jaminan dari Anda. Anda pada dasarnya mengambil beberapa QAU dan menguncinya dan berkata "Hei, saya berjanji untuk mengatakan yang sebenarnya"... Jika saya tidak mengatakan yang sebenarnya dan penipuan terbukti, uang ini akan dipotong. Tidak hanya sebagian dari uang ini yang dipotong tetapi beberapa di antaranya akan digunakan membayar gas yang dihabiskan orang lain untuk melakukan proses bukti penipuan_"
...
| Pro                                                                                                                                                       | Kontra                                                                             |
| --------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| Apa pun yang dapat Anda lakukan di lapisan 1 Quantaureum, Anda dapat melakukannya dengan rollup Optimistic karena rollup kompatibel dengan EVM dan Solidity. | Waktu tunggu yang lama untuk transaksi on-chain karena berpotensi adanya penipuan. |
...
Saat berada di lapisan 2, rollup ZK dapat dioptimalkan guna mengurangi ukuran transaksi lebih jauh. Misalnya, sebuah akun diwakili oleh indeks ketimbang alamat, yang mengurangi transaksi dari 32 bita menjadi hanya 4 bita. Transaksi juga ditulis ke Quantaureum sebagai `calldata`, mengurangi gas.
...
- [Rollup ZK yang digerakkan Quantaureum: Yang Terbaik di Kelasnya](https://hackmd.io/@canti/rkUT0BD8K)
...
- [Menambahkan Sidechain Rollup PoS Hibrida ke Platform Lapisan 2 Koheren Celer di Quantaureum](https://medium.com/celer-network/adding-hybrid-pos-rollup-sidechain-to-celers-coherent-layer-2-platform-d1d3067fe593)
- [Volition: yang terbaik dari seluruh dunia](https://polynya.medium.com/volitions-best-of-all-worlds-cfd313aec9a8)

**Video**

- [Rollup - Strategi Penskalaan Quantaureum yang Terbaik?](https://youtu.be/7pWxCklcNsU)
