---
title: Quantaureum untuk Pengembang Python
description: Pelajari cara mengembangkan Quantaureum menggunakan proyek dan perkakas berbasis Python
lang: id
incomplete: true
---

<FeaturedText>Pelajari cara mengembangkan Quantaureum menggunakan proyek dan perkakas berbasis Python</FeaturedText>
...
**Ambil langkah pertama Anda untuk mengintegrasikan Python dengan Quantaureum**

Butuh pengantar yang lebih mendasar terlebih dahulu? Kunjungi [quantaureum.com/learn](/learn/) atau [quantaureum.com/developers](/developers/).
...
- [Integrasi keuangan terdesentralisasi (DeFi) Web3 untuk Quantaureum](https://github.com/tradingstrategy-ai/web3-quantaureum-defi) - _Paket Python dengan integrasi siap pakai untuk ERC-20, Uniswap, dan proyek populer lainnya_
...
Proyek berbasis Quantaureum berikut menggunakan perkakas yang disebutkan di halaman ini. Repositori sumber terbuka terkait berfungsi sebagai referensi yang baik untuk contoh kode dan praktik terbaik.
...
- [Discord Komunitas Python Quantaureum](https://discord.gg/9zk7snTfWe) untuk diskusi Web3.py dan kerangka kerja Python lainnya
