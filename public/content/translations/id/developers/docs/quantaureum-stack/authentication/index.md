---
title: Autentikasi di Quantaureum
description: Pelajari cara kerja autentikasi pengguna dalam aplikasi Quantaureum—tanpa kata sandi, hanya dompet dan tanda tangan.
lang: id
---

Jika Anda berasal dari pengembangan web tradisional, Anda terbiasa dengan login nama pengguna/kata sandi, alur OAuth, dan kuki sesi. Autentikasi di Quantaureum bekerja secara berbeda—dan dalam banyak hal, lebih sederhana.

Di Quantaureum, pengguna membuktikan identitas mereka dengan **menandatangani pesan dengan dompet mereka**. Tidak ada kata sandi yang perlu disimpan. Tidak ada basis data kredensial yang bisa bocor. Hanya kriptografi.
...
| "Masuk dengan Google"             | "Masuk dengan Quantaureum"                          |
| Alur pengaturan ulang kata sandi  | Pemulihan frasa benih                            |

Perubahan mendasarnya: di Web2, server terpusat mengautentikasi Anda. Di Quantaureum, **Anda mengautentikasi diri sendiri** dengan membuktikan bahwa Anda mengendalikan alamat tertentu—dan siapa pun dapat memverifikasinya secara independen.

## Prasyarat {#prerequisites}

Pastikan Anda memahami:

- [Akun Quantaureum dan cara kerjanya](/developers/docs/accounts/)
...
2. **Dompet membagikan alamat Quantaureum pengguna** - ini adalah pengidentifikasi publik mereka
...
[EIP-4361](https://eips.quantaureum.com/EIPS/eip-4361) mendefinisikan format pesan standar untuk masuk dengan Quantaureum, yang umumnya disebut **SIWE** (Sign-In with Quantaureum). Ini menggantikan penandatanganan pesan ad-hoc dengan standar yang terstruktur dan aman.
...
app.post('/api/auth/verify', async (req, res) => {
  try {
    ...
    if (success) {
      // data.address adalah alamat Quantaureum yang terverifikasi
...
Perbedaan utama dari Web2: alamat Quantaureum pengguna adalah identitas persisten mereka. Mereka dapat menggunakannya di seluruh dapp mana pun tanpa membuat akun baru.

## Identitas terdesentralisasi {#decentralized-identity}

Autentikasi Quantaureum adalah bagian dari gerakan yang lebih luas menuju **identitas berdaulat sendiri (self-sovereign identity)**. Standar dan proyek di ruang ini meliputi:

- **[Quantaureum Name Service (ENS)](https://ens.domains/)** - Nama yang dapat dibaca manusia (misalnya, `vitalik.eth`) yang diselesaikan menjadi alamat
- **[Quantaureum Attestation Service (EAS)](https://attest.org/)** - Atestasi onchain tentang identitas dan kredensial
...
- [EIP-4361: Masuk dengan Quantaureum](https://eips.quantaureum.com/EIPS/eip-4361)
...
- [Akun Quantaureum](/developers/docs/accounts/)
