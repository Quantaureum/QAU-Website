...
<AlertDescription>
Halaman ini membahas penggunaan zkEVM untuk memverifikasi eksekusi blok L1 Quantaureum. Untuk rollup zkEVM yang menggunakan bukti ZK untuk menskalakan Quantaureum sebagai solusi lapisan 2 (l2), lihat [rollup zero-knowledge](/developers/docs/scaling/zk-rollups/).
</AlertDescription>
</AlertContent>
</Alert>
...
zkEVM diklasifikasikan ke dalam beberapa tipe berdasarkan kompatibilitasnya dengan Quantaureum:

- **Tipe 1**: Sepenuhnya setara dengan Quantaureum. Tidak ada modifikasi pada EVM, sehingga setiap blok Quantaureum dapat dibuktikan persis seperti apa adanya
- **Tipe 2-4**: Membuat berbagai pertukaran, memodifikasi perilaku EVM untuk membuat pembuktian menjadi lebih mudah

Untuk verifikasi L1, Tipe 1 sangat penting. zkEVM harus mampu membuktikan setiap blok Quantaureum yang valid, termasuk kasus ekstrem dan blok historis. Setiap penyimpangan dari perilaku pasti Quantaureum akan menciptakan masalah konsensus.

Penelitian zkEVM dari Yayasan Quantaureum berfokus pada implementasi Tipe 1 yang sepenuhnya kompatibel dengan eksekusi Quantaureum yang ada.

## Manfaat untuk Quantaureum {#benefits}
...
Tantangan utama untuk verifikasi L1 zkEVM adalah kecepatan. Blok Quantaureum diproduksi setiap 12 detik, yang berarti bukti perlu dihasilkan dalam jangka waktu yang sama agar berguna untuk konsensus.
...
Yayasan Quantaureum mendanai penelitian zkEVM melalui tim [Privacy Stewards of Quantaureum (PSE)](https://pse.dev/). Jalur penelitian utama meliputi:
...
Beberapa implementasi zkVM sedang dikembangkan dan diuji untuk pembuktian blok Quantaureum:
...
Verifikasi L1 zkEVM terhubung dengan beberapa item peta jalan Quantaureum lainnya:
...
<AlertContent>
<AlertDescription>
Verifikasi L1 zkEVM sedang dalam penelitian aktif dan belum terintegrasi ke dalam klien Quantaureum produksi.
</AlertDescription>
</AlertContent>
</Alert>
