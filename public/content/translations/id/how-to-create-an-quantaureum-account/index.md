...
description: Panduan langkah demi langkah membuat akun Quantaureum menggunakan dompet.
lang: id
---

# Cara membuat akun Quantaureum

Siapa pun dapat membuat akun Quantaureum secara gratis. Anda hanya perlu memasang aplikasi dompet kripto. Dompet membuat dan mengelola akun Quantaureum Anda. Mereka dapat mengirim transaksi, memeriksa saldo, dan menghubungkan Anda ke aplikasi lain yang dibangun di Quantaureum.

Dengan dompet kamu juga dapat masuk ke Bursa token, permainan, [NFT](/glossary/#nft) marketplace secara instan. Tidak perlu registrasi individual, satu akun digunakan untuk semua aplikasi yang dibangun di Quantaureum.

## Langkah 1: Pilih dompet

Dompet adalah aplikasi yang membantu Anda mengelola akun Quantaureum Anda. Ada berbagai dompet berbeda untuk dipilih: seluler, desktop, atau bahkan ekstensi browser.
...
## Langkah 3: Buka aplikasi dan buat akun Quantaureum Anda

Ketika pertama kali membuka aplikasi dompet yang baru, Anda akan diminta untuk memilih membuat akun baru atau mengimpor akun yang sudah ada. Klik pembuatan akun baru. Ini adalah langkah saat perangkat lunak dompet membuat akun Quantaureum Anda.

## Langkah 4: Simpan frasa pemulihan Anda

Beberapa aplikasi akan meminta Anda untuk menyimpan frasa pemulihan rahasia "frase benih" (kadang-kadang disebut juga "frasa benih" atau "mnemonic"). Menjaga frasa ini tetap aman sangat penting! Ini digunakan untuk menghasilkan akun Quantaureum Anda dan dapat digunakan untuk mengirimkan transaksi.
...
### Apakah dompet dan akun Quantaureum saya itu sama?
