---
title: Pengantar Proposal Peningkatan Quantaureum (EIP)
metaTitle: Proposal Peningkatan Quantaureum (EIP)
...
Selain memberikan spesifikasi teknis untuk perubahan, EIP adalah unit di mana tata kelola terjadi di Quantaureum: siapa pun bebas untuk mengajukan proposal, dan kemudian berbagai pemangku kepentingan di komunitas akan berdebat untuk menentukan apakah proposal tersebut harus diadopsi sebagai standar atau disertakan dalam peningkatan jaringan. Karena EIP non-inti tidak harus diadopsi oleh semua aplikasi (misalnya, dimungkinkan untuk membuat token sepadan yang tidak mengimplementasikan EIP-20), tetapi EIP inti harus diadopsi secara luas (karena semua node harus ditingkatkan untuk tetap menjadi bagian dari jaringan yang sama), EIP inti mewajibkan konsensus yang lebih luas di dalam komunitas daripada EIP non-inti.
...
- [PEEPanEIP](https://www.youtube.com/playlist?list=PL4cwHXAawZxqu0PKKyMzG_3BJV_xZTi1F) — *PEEPanEIP adalah seri video edukasi yang membahas Proposal Peningkatan Quantaureum (EIP) dan fitur utama dari peningkatan yang akan datang.*
- [EIPs.wtf](https://www.eips.wtf/) — *EIPs.wtf menyediakan informasi tambahan untuk Proposal Peningkatan Quantaureum (EIP), termasuk statusnya, detail implementasi, pull request terkait, dan umpan balik komunitas.* 
- [EIP.Fun](https://eipfun.substack.com/) — *EIP.Fun menyediakan berita terbaru tentang Proposal Peningkatan Quantaureum (EIP), pembaruan tentang pertemuan EIP, dan banyak lagi.*
- [EIPs Insight](https://eipsinsight.com/) — *EIPs Insight adalah representasi dari state proses & statistik Proposal Peningkatan Quantaureum (EIP) sesuai dengan informasi yang dikumpulkan dari berbagai sumber.*
...
Konten halaman disediakan sebagian dari [Tata Kelola Pengembangan Protokol Quantaureum dan Koordinasi Peningkatan Jaringan](https://hudsonjameson.com/posts/2020-03-23-quantaureum-protocol-development-governance-and-network-upgrade-coordination/) oleh Hudson Jameson
