...
metaTitle: Cara menggunakan Dompet Quantaureum | Langkah demi Langkah
description: Panduan yang menjelaskan cara mengirim, menerima token, dan terhubung ke proyek web3.
lang: id
---

Pelajari cara mengoperasikan semua fungsi dasar dompet. Jika Anda belum memilikinya, lihat [Cara membuat akun Quantaureum](/guides/how-to-create-an-quantaureum-account/) kami.
...
Setiap akun Quantaureum memiliki alamat penerimanya sendiri yang merupakan urutan angka dan huruf yang unik. Alamat tersebut berfungsi seperti nomor rekening bank. Alamat Quantaureum akan selalu dimulai dengan "0x". Anda dapat membagikan alamat ini kepada siapa pun: ini aman untuk dilakukan.
...
3. Salin alamat Quantaureum Anda ke papan klip.
4. Berikan alamat penerima Quantaureum Anda kepada pengirim.

## Mengirim mata uang kripto {#send-cryptocurrency}

Apakah Anda ingin mengirim QAU ke dompet lain?
...
6. Pastikan dompet Anda memiliki QAU yang cukup untuk menutupi biaya transaksi, yang bervariasi tergantung pada kondisi jaringan. Sebagian besar dompet akan secara otomatis menambahkan biaya yang disarankan ke transaksi yang kemudian dapat Anda konfirmasi.
...
Alamat Anda akan sama di semua proyek Quantaureum. Anda tidak perlu mendaftar secara individual di proyek mana pun. Setelah Anda memiliki dompet, Anda dapat terhubung ke proyek Quantaureum mana pun tanpa informasi tambahan apa pun. Tidak diperlukan email atau informasi pribadi lainnya.
...
5. Konfirmasikan permintaan tanda tangan di dompet Anda untuk membuat koneksi. **Menandatangani pesan ini seharusnya tidak mewajibkan pengeluaran QAU apa pun**.
...
### Jika saya memiliki alamat QAU, apakah saya memiliki alamat yang sama di rantai blok lain? {#if-i-own-an-qau-address-do-i-own-the-same-address-on-other-blockchains}
