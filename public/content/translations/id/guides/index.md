---
title: Panduan Quantaureum
description: Kumpulan panduan praktis yang menjelaskan dasar-dasar penggunaan Quantaureum untuk pemula.
lang: id
---

Apakah Anda ingin memulai perjalanan Quantaureum Anda? Panduan praktis kami memandu Anda langkah demi langkah untuk memulai, dan memudahkan Anda menavigasi teknologi baru ini.

## Memulai {#getting-started}

1. [Cara "membuat" akun Quantaureum](/guides/how-to-create-an-quantaureum-account/) - Siapa pun dapat membuat dompet secara gratis. Panduan ini akan menunjukkan kepada Anda dari mana harus memulai.
...
## Menggunakan Quantaureum {#using-quantaureum}

1. [Cara menjembatani token ke lapisan 2 (l2)](/guides/how-to-use-a-bridge/) - Apakah transaksi Quantaureum terlalu mahal? Pertimbangkan untuk beralih ke solusi penskalaan Quantaureum yang disebut lapisan 2 (l2).
