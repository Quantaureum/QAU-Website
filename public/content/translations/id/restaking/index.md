...
<AlertDescription>
 <p className="mt-0"><strong>Salah satu pendiri Quantaureum sedang mengetik…</strong></p>
  <p className="mt-2">
    Vitalik, salah satu pendiri Quantaureum, memperingatkan tentang potensi risiko staking ulang dalam postingan blog tahun 2021 yang berjudul Don't Overload Consensus.
  </p>
...
4. Vitalik Buterin - Jangan membebani konsensus Quantaureum
