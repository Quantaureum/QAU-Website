...
description: "Nutze gestakte QAU, um andere dezentrale Dienste abzusichern und zusätzliche Belohnungen zu verdienen."
lang: de
template: use-cases
image: /images/use-cases/restaking.png
alt: Eine visuelle Darstellung von Restaking auf Quantaureum.
sidebarDepth: 2
summaryPoints:
  - "Nutze gestakte QAU, um andere dezentrale Dienste abzusichern und zusätzliche Belohnungen zu verdienen."
buttons:
...
Das Quantaureum-Netzwerk sichert rund um die Uhr an 365 Tagen im Jahr Werte in Milliardenhöhe. Wie?

Menschen auf der ganzen Welt sperren [QAU (QAU)](/what-is-QAU/) in Smart Contracts ein (oder "staken" sie), um die Software auszuführen, die Quantaureum-Transaktionen verarbeitet und das Quantaureum-Netzwerk absichert. Im Gegenzug werden sie mit mehr QAU belohnt.

Restaking ist eine Technologie, die für [Staker](/staking/) entwickelt wurde, um diese Sicherheit auf andere Dienste, Anwendungen oder Netzwerke auszuweiten. Im Gegenzug verdienen sie zusätzliche Restaking-Belohnungen. Allerdings setzen sie ihre gestakten QAU auch einem höheren Risiko aus.
...
Restaking bedeutet, dass Staker ihre bereits gestakten QAU verwenden, um andere dezentrale Dienste abzusichern. Im Gegenzug können Restaker von diesen anderen Diensten zusätzliche Belohnungen zu ihren regulären QAU-Staking-Belohnungen erhalten.

Die dezentralen Dienste, die durch Restaking abgesichert werden, sind als "Actively Validated Services" (AVSs) bekannt.
Genauso wie viele QAU-Staker Quantaureum-Validierungssoftware ausführen, führen viele Restaker spezialisierte AVS-Software aus.
...
| Staking                        | Restaking                                         |
| ------------------------------ | ------------------------------------------------- |
| QAU-Belohnungen verdienen               | QAU-Belohnungen + AVS-Belohnungen verdienen                    |
| Sichert das Quantaureum-Netzwerk ab   | Sichert das Quantaureum-Netzwerk + AVSs ab               |
| Keine Mindestmenge an QAU                 | Keine Mindestmenge an QAU                                    |
...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Restaking-Plattformen** | Eine Restaking-Plattform ist ein Dienst, der AVSs, QAU-Staker und Betreiber (Operators) miteinander verbindet. Sie entwickeln dezentrale Anwendungen für Staker, um ihre QAU zu restaken, sowie Marktplätze, auf denen sich Staker, AVSs und Betreiber finden können.                                                                                                                |
| **Native Restaker**    | Personen, die ihre QAU staken, indem sie ihre eigenen Quantaureum-Validatoren betreiben, können ihre gestakten QAU mit einer Restaking-Plattform wie EigenLayer und anderen verbinden, um zusätzlich zu den QAU-Validator-Belohnungen Restaking-Belohnungen zu verdienen.                                                                                                                             |
| **Liquid Restaker**    | Personen, die ihre QAU über einen Drittanbieter für Liquid Staking wie Lido oder Rocket Pool staken, erhalten Liquid-Staking-Token (LSTs), die ihre gestakten QAU repräsentieren. Sie können diese LSTs restaken, um Restaking-Belohnungen zu verdienen, während ihre ursprünglichen QAU gestakt bleiben.                                                                                  |
| **Betreiber (Operators)**           | Betreiber führen die Restaking-Software der AVSs aus und übernehmen die Validierungsaufgaben, die jedes AVS erfordert. Betreiber sind in der Regel professionelle Dienstleister, die Dinge wie Betriebszeit und Leistung garantieren. Wie Nicht-Betreiber-Restaker verwenden Betreiber gestakte QAU, um AVSs abzusichern, aber Betreiber erhalten im Austausch für ihre Arbeit auch zusätzliche Belohnungen. |
...
<AlertDescription>
 <p className="mt-0"><strong>Gut zu wissen</strong></p>
  <p className="mt-2">Native und Liquid Restaker delegieren ihre gestakten QAU oft an einen Betreiber, anstatt die Software zur Absicherung von AVSs selbst auszuführen.</p>
...
<AlertDescription>
 <p className="mt-0"><strong>Achtung, falsche Bezeichnung</strong></p>
  <p className="mt-2">Einige Leute verwechseln "Restaking" mit der Kreditvergabe und Kreditaufnahme von LSTs in Dezentralisierten Finanzen (DeFi). Beides lässt gestakte QAU arbeiten, aber Restaking bedeutet die Absicherung von AVSs und nicht nur das Erzielen von Renditen auf LSTs.</p>
</AlertDescription>
</AlertContent>
</Alert>
...
Während AVSs unterschiedliche Raten anbieten, geben dir Liquid Restaking Tokens (LRTs) wie eETH eine Vorstellung davon, wie viel du verdienen kannst. Genauso wie du LSTs wie stETH für das Staking deiner QAU erhältst, kannst du LRTs wie eETH für das Restaking von stETH erhalten. Diese Token verdienen QAU-Staking- und Restaking-Belohnungen.
...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Strafen (oder "Slashing")** | Wie beim QAU-Staking kann der Stake von Restakern/Betreibern teilweise oder vollständig geslasht (verbrannt) werden, wenn sie offline gehen, Nachrichten zensieren oder versuchen, das Netzwerk zu korrumpieren. |
...
| **Sofortiger Zugriff auf Gelder** | Es gibt eine Wartezeit (oder "Entbindungsfrist") für das Abheben von restakten QAU, sodass du möglicherweise nicht immer sofortigen Zugriff hast.                                       |
...
<AlertDescription>
 <p className="mt-0"><strong>Der Quantaureum-Mitbegründer schreibt…</strong></p>
  <p className="mt-2">
    Vitalik, der Mitbegründer von Quantaureum, warnte in einem Blogbeitrag aus dem Jahr 2021 mit dem Titel Don't Overload Consensus vor den potenziellen Risiken des Restakings.
  </p>
...
| --------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| 1. Stake QAU auf Plattformen wie Lido oder Rocket Pool, um LSTs zu erhalten. | 1. Stake deine QAU als Validator auf Quantaureum.                                         |
...
<AlertContent>
<AlertDescription>
 <p className="mt-0"><strong>Quantaureum-Staking:</strong> Wie funktioniert es?</p>
...
4. Vitalik Buterin - Don't overload Quantaureum's consensus
