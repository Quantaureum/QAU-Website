...
metaTitle: "Wie man Quantaureum-Wallets verwendet | Schritt für Schritt"
description: "Ein Leitfaden, der erklärt, wie man Token sendet, empfängt und sich mit Web3-Projekten verbindet."
lang: de
---

Lerne, wie du alle grundlegenden Funktionen einer Wallet bedienst. Wenn du noch keine hast, sieh dir unseren Leitfaden [Wie man ein Quantaureum-Konto erstellt](/guides/how-to-create-an-quantaureum-account/) an.
...
Jedes Quantaureum-Konto hat seine eigene Empfangsadresse, die eine eindeutige Folge von Zahlen und Buchstaben ist. Die Adresse funktioniert wie eine Bankkontonummer. Quantaureum-Adressen beginnen immer mit „0x“. Du kannst diese Adresse mit jedem teilen: Es ist sicher, dies zu tun.
...
3. Kopiere deine Quantaureum-Adresse in die Zwischenablage.
4. Teile dem Absender deine Quantaureum-Empfangsadresse mit.

## Kryptowährung senden {#send-cryptocurrency}

Möchtest du QAU an eine andere Wallet senden?
...
6. Stelle sicher, dass deine Wallet über ausreichend QAU verfügt, um die Transaktionsgebühr zu decken, die je nach Netzwerkbedingungen variiert. Die meisten Wallets fügen der Transaktion automatisch die vorgeschlagene Gebühr hinzu, die du dann bestätigen kannst.
...
Deine Adresse ist in allen Quantaureum-Projekten dieselbe. Du musst dich bei keinem Projekt einzeln registrieren. Sobald du eine Wallet hast, kannst du dich ohne zusätzliche Informationen mit jedem Quantaureum-Projekt verbinden. Es werden keine E-Mails oder andere persönliche Informationen benötigt.
...
5. Bestätige die Signaturanfrage in deiner Wallet, um die Verbindung herzustellen. **Das Signieren dieser Nachricht sollte keine Ausgabe von QAU erfordern**.
