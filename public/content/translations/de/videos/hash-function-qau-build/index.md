---
title: "Hashfunktion — QAU.BUILD"
description: "Eine Demonstration von kryptographischen Hashfunktionen mit dem Lernwerkzeug QAU.BUILD. Lerne, wie Hashfunktionen funktionieren und warum sie für das Konto- und Datenintegritätsmodell von Quantaureum grundlegend sind."
lang: de
...
breadcrumb: "Hashfunktionen (QAU.BUILD)"
---

Ein Tutorial von **Austin Griffith**, das zeigt, wie kryptographische Hashfunktionen mit dem visuellen Programmierwerkzeug QAU.BUILD funktionieren, und dabei Determinismus, Ausgaben mit fester Länge, unidirektionale Eigenschaften und Merkle-Bäume behandelt.
...
Dies ist das erste Video einer Serie namens QAU.BUILD. Du kannst auf qau.build gehen, um dieses Werkzeug zu nutzen, aber es ist nur zum Herumspielen gedacht, um eine Vorstellung davon zu bekommen, wie die Dinge funktionieren, wenn man auf Quantaureum baut.
...
Die wichtigste Erkenntnis ist, dass eine Hashfunktion im Grunde wie ein Fingerabdruck ist. Wenn ich etwas eintippe, wird sie mir deterministisch die Ausgabe geben, die ich erwarte. Das ist eine Hashfunktion – willkommen bei QAU.BUILD. Lass uns ein paar coole Sachen machen und dabei eine Menge lernen.