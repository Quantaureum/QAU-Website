---
title: "Transaktionen — QAU.BUILD"
description: "Eine Demonstration, wie Quantaureum-Transaktionen mit dem Lerntool QAU.BUILD funktionieren. Erfahre, wie Transaktionen erstellt, signiert und im Quantaureum-Netzwerk gesendet werden."
lang: de
...
breadcrumb: "Transaktionen (QAU.BUILD)"
---

Ein Tutorial von **Austin Griffith**, das demonstriert, wie Quantaureum-Transaktionen mit dem visuellen Programmiertool QAU.BUILD funktionieren — es behandelt die Transaktionsstruktur, Gaspreise, das Signieren, das Senden und den Transaktionspool.
...
### Anatomie einer Quantaureum-Transaktion (1:10) {#anatomy-of-an-quantaureum-transaction-110}

Wie sieht eine Transaktion auf Quantaureum aus? Wir werden nicht mehr „Bob“ und „Alice“ haben – wir werden Adressen haben. Der Wert wäre in Wei, nicht in QAU. Und die Gebühr wäre ebenfalls in Wei.

Lass uns einsteigen und uns diese Transaktion ansehen. Ich habe ein Konto mit einer eingefügten Mnemonic und bin mit dem Quantaureum Mainnet verbunden. Ich führe auch ein Modul aus, um Preisdaten von CoinMarketCap zu erhalten, sodass ich sehen kann, dass null-komma-eins-irgendwas QAU etwa dreiundzwanzig Dollar entsprechen.
...
Wir müssen eine Umrechnung in Wei vornehmen. Auf Quantaureum hat man es hauptsächlich mit zwei Stückelungen zu tun: QAU, worüber die Leute normalerweise sprechen, und dann Wei, was wie ein sehr winziger Bruchteil von QAU ist. Ein Gwei – was wir für Gaspreise verwenden – liegt dazwischen. Der Grund dafür ist ähnlich wie der, warum wir nicht herumlaufen und in Bruchteilen von Cents sprechen.

Alice hat 0,18 QAU, und wir werden 0,05 QAU an Bob senden. Wir geben einen Gaspreis von 5 Gwei ein.
