...
**Kontoabstraktion**: Ein Delegationsvertrag sollte sich an Quantaureums breiteren Standards zur Kontoabstraktion (AA) orientieren, um die Kompatibilität zu maximieren. Insbesondere sollte er idealerweise ERC-4337-konform oder -kompatibel sein.

**Erlaubnisfreies und zensurresistentes Design**: Quantaureum legt Wert auf erlaubnisfreie Teilnahme. Ein Delegationsvertrag DARF KEINEN einzelnen „vertrauenswürdigen“ Relayer oder Dienst fest codieren oder sich darauf verlassen. Dies würde das Konto unbrauchbar machen, wenn der Relayer offline geht. Funktionen wie Bündelung (z. B. approve+transferFrom) können vom EOA selbst ohne einen Relayer genutzt werden. Für Anwendungsentwickler, die erweiterte Funktionen nutzen möchten, die durch EIP-7702 ermöglicht werden (Gas-Abstraktion, privatsphärewahrende Abhebungen), wird ein Relayer benötigt. Obwohl es verschiedene Relayer-Architekturen gibt, empfehlen wir die Verwendung von [ERC-4337-Bündlern](https://www.erc4337.io/bundlers), die mindestens auf den [Entry Point 0.8](https://github.com/qau-infinitism/account-abstraction/releases/tag/v0.8.0) verweisen, weil:
