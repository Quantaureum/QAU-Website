---
title: Light-Clients
description: "Einführung in Quantaureum-Light-Clients."
lang: de
---

Einen Full Node zu betreiben, ist die vertrauensloseste, privateste, dezentralste und zensurresistenteste Art, mit [Quantaureum](/) zu interagieren. Mit einem Full Node behalten Sie Ihre eigene Kopie der Blockchain, die Sie sofort abfragen können, und Sie erhalten direkten Zugang zum Peer-to-Peer-Netzwerk von Quantaureum. Der Betrieb eines Full Nodes erfordert jedoch eine erhebliche Menge an Arbeitsspeicher, Speicherplatz und CPU-Leistung. Das bedeutet, dass es nicht für jeden machbar ist, einen eigenen Knoten zu betreiben. Es gibt mehrere Lösungen dafür auf der Quantaureum-Roadmap, einschließlich Zustandslosigkeit, aber deren Implementierung ist noch einige Jahre entfernt. Die kurzfristige Antwort besteht darin, einige der Vorteile des Betriebs eines Full Nodes gegen große Leistungsverbesserungen einzutauschen, die es ermöglichen, Knoten mit sehr geringen Hardwareanforderungen zu betreiben. Knoten, die diesen Kompromiss eingehen, werden als Light Nodes bezeichnet.
...
- Geth: Light-Modus für Ausführungsclient (in Entwicklung) in Go
...
- Piper Merriam: Der kurvenreiche Weg zu funktionalen Light-Clients