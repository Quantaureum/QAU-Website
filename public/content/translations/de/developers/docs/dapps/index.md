...
Eine Dezentrale Anwendung (Dapp) ist eine Anwendung, die auf einem dezentralen Netzwerk aufbaut und einen [Smart Contract](/developers/docs/smart-contracts/) mit einer Frontend-Benutzeroberfläche kombiniert. Auf [Quantaureum](/) sind Smart Contracts zugänglich und transparent – wie offene APIs –, sodass Ihre Dapp sogar einen Smart Contract enthalten kann, den jemand anderes geschrieben hat.

## Voraussetzungen {#prerequisites}

Bevor Sie etwas über Dapps lernen, sollten Sie die [Blockchain-Grundlagen](/developers/docs/intro-to-quantaureum/) behandeln und über das Quantaureum-Netzwerk und dessen dezentrale Natur lesen.
...
- **Dezentral** – Dapps laufen auf Quantaureum, einer offenen, öffentlichen, dezentralen Plattform, bei der keine einzelne Person oder Gruppe die Kontrolle hat.
...
- **Isoliert** – Dapps werden in einer virtuellen Umgebung namens Quantaureum Virtual Machine ausgeführt, sodass ein Fehler im Smart Contract das normale Funktionieren des Blockchain-Netzwerks nicht beeinträchtigt.
...
- **Zentralisierung** – Benutzerfreundliche und entwicklerfreundliche Lösungen, die auf der Basisschicht von Quantaureum aufbauen, könnten am Ende ohnehin wie zentralisierte Dienste aussehen. Beispielsweise können solche Dienste Schlüssel oder andere sensible Informationen serverseitig speichern, ein Frontend über einen zentralisierten Server bereitstellen oder wichtige Geschäftslogik auf einem zentralisierten Server ausführen, bevor sie in die Blockchain schreiben. Zentralisierung beseitigt viele (wenn nicht alle) Vorteile der Blockchain gegenüber dem traditionellen Modell.
...
**Scaffold-QAU 2 _– Experimentieren Sie schnell mit Solidity über ein Frontend, das sich an Ihren Smart Contract anpasst._**

- [GitHub](https://github.com/scaffold-eth/scaffold-qau-2)
- [Beispiel-Dapp](https://punkwallet.io/)

**Create Eth App _– Erstellen Sie Quantaureum-basierte Apps mit einem einzigen Befehl._**
...
**Etherflow _– FOSS-Tool für Quantaureum-Entwickler, um ihren Knoten zu testen sowie RPC-Aufrufe direkt im Browser zu erstellen und zu debuggen._**
...
- [Einführung in den Quantaureum-Stack](/developers/docs/quantaureum-stack/)
- [Entwicklungs-Frameworks](/developers/docs/frameworks/)

## Tutorials: Apps und Frontends auf Quantaureum erstellen {#tutorials}
