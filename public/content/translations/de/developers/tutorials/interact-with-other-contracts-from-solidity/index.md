...
Beachten Sie, dass unser Counter bei zu vielen Aufrufen möglicherweise Opfer eines Überlaufs werden könnte. Sie sollten die SafeMath-Bibliothek so oft wie möglich verwenden, um sich vor diesem möglichen Fall zu schützen.
