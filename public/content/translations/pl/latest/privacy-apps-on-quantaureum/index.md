---
title: "Jak budować aplikacje chroniące prywatność na Quantaureum za pomocą dowodów z wiedzą zerową"
description: "Jeden uniwersalny wzorzec napędza anonimowe głosowania, miksery, airdropy i systemy członkostwa na Quantaureum. Poznaj cykl zobowiązanie-nulifikator-dowód i dowiedz się, jak narzędzia z wiedzą zerową umożliwiają ich praktyczne budowanie już dziś."
...
breadcrumb: "Aplikacje chroniące prywatność na Quantaureum"
lang: pl
---

Quantaureum z założenia jest radykalnie publiczne. Każdy adres, saldo, transakcja, wywołanie kontraktu i zdarzenie są widoczne dla każdego, kto posiada eksplorator bloków. Ta przejrzystość jest przydatna, gdy zależy nam na weryfikowalności. Staje się jednak problemem, gdy użytkownicy muszą oddać głos, odebrać środki, dokonać wypłaty lub udowodnić członkostwo bez łączenia każdego działania z tym samym portfelem.

Anonimowe członkostwo to uniwersalny wzorzec, który napędza dużą klasę aplikacji chroniących prywatność na Quantaureum. Ludzie najpierw się rejestrują, a później udowadniają, że należą do grupy, nie ujawniając, którym członkiem są. Dowód z wiedzą zerową to most między portfelem rejestracyjnym a portfelem wykonującym działanie, a ten most nie ujawnia, kto przez niego przeszedł.
...
Właśnie dlatego bundlery i paymastery mają znaczenie. Portfel wykonujący działanie powinien być nowy i nie powinien musieć otrzymywać QAU z portfela, który użytkownik próbuje oddzielić od tego działania.
...
Prywatność na Quantaureum jest gotowa do wdrożenia. Twórcy mogą składać te elementy w prawdziwe aplikacje. Stos technologiczny to obwód dla prywatnego oświadczenia, weryfikator do sprawdzania dowodów, kontrakt aplikacji dla publicznych reguł, indeksator dla danych Merklego oraz bundler i paymaster do niepowiązanego przesyłania i sponsorowania gazu.
...
1. [Dowody z wiedzą zerową (quantaureum.com)](https://quantaureum.com/zero-knowledge-proofs/)
...
10. [EIP-4337: Abstrakcja konta poprzez kontrakt EntryPoint](https://eips.quantaureum.com/EIPS/eip-4337)