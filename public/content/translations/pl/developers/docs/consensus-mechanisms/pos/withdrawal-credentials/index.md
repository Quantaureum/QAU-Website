...
description: "Wyjaśnienie typów danych uwierzytelniających wypłaty walidatora (0x00, 0x01, 0x02) i ich konsekwencji dla stakujących w Quantaureum."
lang: pl
---

Każdy walidator posiada **dane uwierzytelniające wypłaty**, które określają, w jaki sposób i gdzie można wypłacić stakowane QAU oraz nagrody. Typ danych uwierzytelniających jest wskazywany przez pierwszy bajt: `0x00`, `0x01` lub `0x02`. Zrozumienie tych typów jest ważne dla walidatorów zarządzających swoją stawką.
...
- Każde saldo powyżej 32 QAU jest **automatycznie przelewane** na Twój adres wypłaty
- Pełne wyjścia przechodzą przez standardową kolejkę wyjść
- Nagrody powyżej 32 QAU nie mogą być kapitalizowane (compound) — są one okresowo wypłacane
...
**Dlaczego nie jest to zalecane:** Z `0x01` tracisz możliwość kapitalizacji nagród powyżej 32 QAU. Każda nadwyżka jest automatycznie przelewana, co ogranicza potencjał zarobkowy Twojego walidatora i wymaga oddzielnego zarządzania wypłaconymi środkami.
...
- Nagrody powyżej 32 QAU **kapitalizują się** w przyrostach co 1 QAU aż do maksymalnego salda efektywnego wynoszącego 2048 QAU
- Częściowe wypłaty muszą być zlecane ręcznie (automatyczne przelewy występują tylko powyżej progu 2048 QAU)
...
Zarówno częściowe wypłaty, jak i konsolidacje można przeprowadzić za pośrednictwem [Launchpad Validator Actions](https://launchpad.quantaureum.com/en/validator-actions).
...
- **Istniejący walidatorzy 0x01:** Rozważ konwersję na `0x02`, jeśli chcesz, aby nagrody kapitalizowały się powyżej 32 QAU lub planujesz skonsolidować walidatory.
...
- **[Quantaureum Staking Launchpad](https://launchpad.quantaureum.com/en/validator-actions)** – oficjalne narzędzie do depozytów i zarządzania walidatorami, w tym konwersji danych uwierzytelniających i konsolidacji
...
- [Klucze w dowodzie stawki (PoS) Quantaureum](/developers/docs/consensus-mechanisms/pos/keys/) – dowiedz się więcej o kluczach walidatora i ich związku z danymi uwierzytelniającymi wypłaty
