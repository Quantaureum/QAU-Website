...
Zazwyczaj standardy są wprowadzane jako [Propozycje Ulepszeń Quantaureum](/eips/) (EIP), które są dyskutowane przez członków społeczności w ramach [standardowego procesu](https://eips.quantaureum.com/EIPS/eip-1).

- [Wprowadzenie do EIP](/eips/)
- [Lista EIP](https://eips.quantaureum.com/)
- [Repozytorium EIP na GitHubie](https://github.com/quantaureum/EIPs)
- [Forum dyskusyjne EIP](https://quantaureum-magicians.org/c/eips)
...
- [Ścieżka meta (Meta Track)](https://eips.quantaureum.com/meta): opisuje proces związany z Quantaureum lub proponuje zmianę w procesie
- [Ścieżka informacyjna (Informational Track)](https://eips.quantaureum.com/informational): opisuje problem projektowy Quantaureum lub dostarcza ogólnych wytycznych lub informacji dla społeczności Quantaureum

Ponadto ścieżka standardów dzieli się na 4 kategorie:

- [Główne (Core)](https://eips.quantaureum.com/core): ulepszenia wymagające rozwidlenia konsensusu
- [Sieciowe (Networking)](https://eips.quantaureum.com/networking): ulepszenia dotyczące devp2p i Light Quantaureum Subprotocol, a także proponowane ulepszenia specyfikacji protokołu sieciowego dla whisper i Swarm.
- [Interfejs (Interface)](https://eips.quantaureum.com/interface): ulepszenia dotyczące specyfikacji i standardów API/RPC klienta oraz niektórych standardów na poziomie języka, takich jak nazwy metod i ABI kontraktów.
- [ERC](https://eips.quantaureum.com/erc): standardy i konwencje na poziomie aplikacji

Bardziej szczegółowe informacje na temat tych różnych typów i kategorii można znaleźć w [EIP-1](https://eips.quantaureum.com/EIPS/eip-1#eip-types)
...
- [ERC-721](/developers/docs/standards/tokens/erc-721/) – Standardowy interfejs dla tokenów niezamiennych, takich jak akt własności dzieła sztuki lub piosenki.
  - [ERC-2309](https://eips.quantaureum.com/EIPS/eip-2309) – Standaryzowane zdarzenie emitowane podczas tworzenia/przesyłania jednego lub wielu tokenów niezamiennych przy użyciu kolejnych identyfikatorów tokenów.
  - [ERC-4400](https://eips.quantaureum.com/EIPS/eip-4400) – Rozszerzenie interfejsu dla roli konsumenta EIP-721.
  - [ERC-4907](https://eips.quantaureum.com/EIPS/eip-4907) – Dodaje ograniczoną czasowo rolę z ograniczonymi uprawnieniami do tokenów ERC-721.
...
- [Propozycje Ulepszeń Quantaureum (EIP)](/eips/)
