...
Hooki są rejestrowane i wykrywane przy użyciu standardu ERC-1820.

#### Dlaczego hooki są świetne? {#why-are-hooks-great}

1. Hooki pozwalają na wysyłanie tokenów do kontraktu i powiadamianie go w pojedynczej transakcji, w przeciwieństwie do ERC-20, który wymaga podwójnego wywołania (`approve`/`transferFrom`), aby to osiągnąć.
