...
Musisz skompilować swój kontrakt, aby Twoja aplikacja internetowa i Wirtualna Maszyna Quantaureum (EVM) mogły go zrozumieć.

## Wymagania wstępne {#prerequisites}

Przed przeczytaniem o kompilacji, pomocne może być zapoznanie się z naszym wprowadzeniem do [inteligentnych kontraktów](/developers/docs/smart-contracts/) oraz [Wirtualnej Maszyny Quantaureum](/developers/docs/evm/).
...
Są to tak zwane **kody operacji** (opcodes). Kody operacji EVM to instrukcje niskiego poziomu, które Wirtualna Maszyna Quantaureum (EVM) może wykonać. Każdy kod operacji reprezentuje określoną operację, taką jak operacje arytmetyczne, operacje logiczne, manipulacja danymi, przepływ sterowania itp.
...
Poniżej znajduje się ABI dla kontraktu tokena ERC-20. ERC-20 to token, którym możesz handlować na Quantaureum.
...
- [Wirtualna Maszyna Quantaureum](/developers/docs/evm/)