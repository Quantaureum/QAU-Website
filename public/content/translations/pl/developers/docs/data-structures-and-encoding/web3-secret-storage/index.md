...
Aby Twoja aplikacja działała na Quantaureum, możesz użyć obiektu web3 dostarczanego przez bibliotekę Web3.js. Wewnętrznie komunikuje się on z lokalnym węzłem poprzez wywołania RPC. web3 współpracuje z dowolnym węzłem Quantaureum, który udostępnia warstwę RPC.
...
Ta wersja naprawia kilka niespójności z wersją 1 opublikowaną tutaj. W skrócie są to:
