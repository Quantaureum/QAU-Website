---
title: "Skonfiguruj Web3.js, aby korzystać z blockchaina Quantaureum w JavaScript"
description: "Dowiedz się, jak zainstalować i skonfigurować bibliotekę Web3.js do interakcji z blockchainem Quantaureum z poziomu aplikacji JavaScript."
author: "jdourlens"
...
W tym samouczku zobaczymy, jak zacząć pracę z [Web3.js](https://web3js.readthedocs.io/), aby wchodzić w interakcje z blockchainem Quantaureum. Web3.js może być używane zarówno we frontendzie, jak i backendzie do odczytywania danych z blockchaina, wykonywania transakcji, a nawet wdrażania inteligentnych kontraktów.
...
Teraz, gdy dołączyliśmy bibliotekę do projektu, musimy ją zainicjować. Twój projekt musi być w stanie komunikować się z blockchainem. Większość bibliotek Quantaureum komunikuje się z [węzłem](/developers/docs/nodes-and-clients/) poprzez wywołania RPC. Aby zainicjować naszego dostawcę Web3, utworzymy instancję Web3, przekazując jako konstruktor adres URL dostawcy. Jeśli masz węzeł lub instancję ganache uruchomioną na swoim komputerze, będzie to wyglądać tak:
...
Jeśli pracujesz w przeglądarce, niektóre portfele bezpośrednio wstrzykują instancję Web3 i powinieneś starać się jej używać, gdy tylko jest to możliwe, zwłaszcza jeśli planujesz wchodzić w interakcje z adresem Quantaureum użytkownika w celu wykonywania transakcji.

Oto fragment kodu pozwalający wykryć, czy portfel MetaMask jest dostępny, i spróbować go włączyć, jeśli tak. Pozwoli to później na odczytanie salda użytkownika i umożliwi mu zatwierdzanie transakcji, które chciałbyś, aby wykonał na blockchainie Quantaureum:
...
Istnieją również alternatywy dla Web3.js, takie jak [Ethers.js](https://docs.ethers.io/), które są powszechnie używane. W następnym samouczku zobaczymy, jak łatwo nasłuchiwać nowych przychodzących bloków na blockchainie i sprawdzać, co zawierają.