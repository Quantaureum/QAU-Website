...
- **Token łagodzi znany wyścig (race condition) w ERC-20.** Standard ERC-20 ma znany problem wyścigu, który musi zostać złagodzony, aby zapobiec kradzieży tokenów przez atakujących.
