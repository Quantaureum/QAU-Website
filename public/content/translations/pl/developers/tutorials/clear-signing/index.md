...
ERC-7730 definiuje standardowy format JSON do opisywania, co *oznaczają* wywołania funkcji Twojego kontraktu. 
...
Rejestr ERC-7730 to otwarte repozytorium hostowane przez Fundację Quantaureum jako neutralnego zarządcę. Każdy może je sklonować i hostować samodzielnie — portfele niezależnie decydują, którym instancjom rejestru ufają.
