...
- **Dostępność globalna** – Twój portfel nie ma ograniczeń geograficznych ani wymogów KYC, które wykluczałyby niektóre osoby z dostępu do Twojej usługi.
- **Dostępność w wielu językach** – Twój portfel jest przetłumaczony na wiele języków, co pozwala użytkownikom na całym świecie na korzystanie z niego.
- **Open source** – cała baza kodu Twojego projektu (nie tylko moduły) powinna być dostępna i powinieneś akceptować PR-y (Pull Requests) od szerszej społeczności.
...
- **Sieci warstwy 2** – Twój portfel domyślnie obsługuje dostęp użytkowników do sieci warstwy 2 (L2).
- **Dostosowywanie opłat za gaz** – Twój portfel pozwala użytkownikom dostosować opłaty za gaz dla transakcji (opłata podstawowa, opłata priorytetowa, opłata maksymalna).
...
- **Kupowanie krypto** – Twój portfel obsługuje bezpośrednie kupowanie i onboarding do krypto przez użytkowników.
- **Sprzedaż za waluty fiducjarne (fiat)** – Twój portfel obsługuje sprzedaż i wypłatę w walutach fiducjarnych bezpośrednio na kartę lub konto bankowe.
- **Multisig** – Twój portfel obsługuje wiele podpisów do podpisania transakcji.
- **Odzyskiwanie społecznościowe** – Twój portfel obsługuje strażników (guardians), a użytkownik może odzyskać swój portfel w przypadku utraty frazy odzyskiwania za ich pomocą.
- **Dedykowany zespół wsparcia** – Twój portfel ma dedykowany zespół wsparcia, do którego użytkownicy mogą się zwrócić w przypadku problemów.
- **Zasoby edukacyjne/dokumentacja** – Twój produkt powinien mieć dobrze zaprojektowany proces onboardingu, aby pomagać i edukować użytkowników. Lub dowody na istnienie treści instruktażowych, takich jak artykuły czy filmy.
