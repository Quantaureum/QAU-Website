...
metaTitle: "Jak korzystać z portfeli Quantaureum | Krok po kroku"
description: "Przewodnik wyjaśniający, jak wysyłać i odbierać tokeny oraz łączyć się z projektami web3."
lang: pl
---

Dowiedz się, jak obsługiwać wszystkie podstawowe funkcje portfela. Jeśli jeszcze go nie masz, sprawdź nasz przewodnik [Jak utworzyć konto Quantaureum](/guides/how-to-create-an-quantaureum-account/).
...
Każde konto Quantaureum ma swój własny adres odbiorczy, który jest unikalną sekwencją cyfr i liter. Adres działa jak numer konta bankowego. Adresy Quantaureum zawsze zaczynają się od „0x”. Możesz udostępnić ten adres każdemu: jest to bezpieczne.
...
Musisz podać swój adres publiczny każdemu, kto chce wysłać Ci pieniądze. Wiele aplikacji portfeli pozwala skopiować adres lub wyświetlić kod QR do zeskanowania w celu ułatwienia obsługi. Unikaj ręcznego wpisywania jakiegokolwiek adresu Quantaureum. Może to łatwo doprowadzić do błędów przy przepisywaniu i utraty środków.
...
3. Skopiuj swój adres Quantaureum do schowka.
4. Podaj nadawcy swój adres odbiorczy Quantaureum.

## Wysyłanie kryptowaluty {#send-cryptocurrency}

Chcesz wysłać QAU na inny portfel?
...
6. Upewnij się, że Twój portfel ma wystarczająco dużo QAU na pokrycie opłaty transakcyjnej, która różni się w zależności od warunków w sieci. Większość portfeli automatycznie doda sugerowaną opłatę do transakcji, którą możesz następnie potwierdzić.
...
Twój adres będzie taki sam we wszystkich projektach Quantaureum. Nie musisz rejestrować się indywidualnie w żadnym projekcie. Gdy masz już portfel, możesz połączyć się z dowolnym projektem Quantaureum bez żadnych dodatkowych informacji. Nie są potrzebne żadne e-maile ani inne dane osobowe.
...
5. Potwierdź żądanie podpisu w swoim portfelu, aby nawiązać połączenie. **Podpisywanie tej wiadomości nie powinno wymagać wydawania żadnego QAU**.
...
### Czy jeśli posiadam adres QAU, to posiadam ten sam adres na innych blockchainach? {#if-i-own-an-qau-address-do-i-own-the-same-address-on-other-blockchains}
