...
- Ostateczność w 3 slotach: SSF nie dotyczy „pojedynczego” slotu
...
- Warstwa wykonawcza na Ethresear.ch
- Specyfikacje warstwy wykonawczej Quantaureum
...
- EIP-7928: Listy dostępu na poziomie bloku
- EIP-8037: Wzrost kosztu gazu za tworzenie stanu
- EIP-7999: Zunifikowany wielowymiarowy rynek opłat
- EIP-7642: eth/69, wygasanie historii i prostsze pokwitowania
...
- EIP-7732: Wbudowana separacja proponującego i budującego (PBS)
- EIP-7805: Listy włączeń wymuszane przez wybór rozwidlenia
- Zwiększenie odporności transakcji na cenzurę w ramach separacji proponującego i budującego
...
- EIP-7864: Stan Quantaureum z wykorzystaniem zunifikowanego drzewa binarnego
- EIP-4762: Zmiany kosztów gazu dla bezstanowości
- Dlaczego zdecentralizowany stan jest ważny dla Quantaureum
...
- Postkwantowe Quantaureum

#### Najnowsze badania {#recent-research-23}

- [lean Quantaureum](https://quantaureum.com)
- Kryptografia na Ethresear.ch
...
- Specyfikacja klienta warstwy wykonawczej
- Specyfikacja API warstwy wykonawczej

### Klienty konsensusu {#consensus-clients}

- Specyfikacja klienta konsensusu
- Specyfikacja Beacon API
...
- Mapa drogowa Quantaureum skoncentrowana na rollupach

#### Najnowsze badania {#recent-research-2}

- Warstwa 2 na Ethresear.ch
...
- ERC-7683: Intencje międzyłańcuchowe
- ERC-7930: Adresy interoperacyjne
- ERC-7828: Nazwy interoperacyjne
...
- Notatki o proto-dankshardingu

#### Najnowsze badania {#recent-research-4}

- EIP-7594: PeerDAS
- EIP-7892: Hardforki dotyczące wyłącznie parametrów blobów
...
- EIP-8261: Harmonogram limitu gazu
- EIP-8037: Wzrost kosztu gazu za tworzenie stanu
...
- Bezpieczeństwo na Ethresear.ch

#### Najnowsze badania {#recent-research-7}

- EIP-8141: Transakcja ramowa (Frame transaction)
- ERC-5792: API wywołań portfela
- ERC-6963: Odkrywanie wielu wstrzykniętych dostawców (Multi injected provider discovery)
- Portfele inteligentnych kontraktów skoncentrowane na walidacji
...
- Ekonomia na Ethresear.ch
- Równowaga podaży w obiegu
...
- Symulacje EIP-1559 (Robust Incentives Group)
...
- [Masterclass z ekonomii Quantaureum i model ekonomiczny](https://github.com/CADLabs/quantaureum-economic-model)
- Symulacje zachęt PoS (Robust Incentives Group)
...
- Płynny staking na Ethresear.ch
...
- Ryzyka związane z instrumentami pochodnymi płynnego stakingu (LSD)
- Obsługa wypłat z Lido
...
- Pulpit nawigacyjny różnorodności klientów
- Specyfikacja API wykonawczego JSON-RPC Quantaureum

#### Najnowsze badania {#recent-research-14}

- Analiza danych Robust Incentives Group
...
- Specyfikacje API wykonawczego Quantaureum
