...
**Justin Drake:** Chciałbym wtrącić i uargumentować, dlaczego ta analogia między akcjami a dowodem stawki jest być może zła. W kontekście akcji masz prawo oddać głos na cokolwiek — możesz całkowicie zmienić zasady działania firmy. W konsensusie dowodu stawki uczestnicy konsensusu nie mogą po prostu arbitralnie zmieniać zasad. Nie mogą powiedzieć "po prostu damy sobie po tysiąc QAU" — to byłaby nieprawidłowa transakcja. Ostatecznie uczestnicy konsensusu są zależni od społeczności, a to ogromna różnica w stosunku do akcji.
...
W dowodzie stawki istnieje bardzo proste rozwiązanie: usunięcie atakującego ze zbioru walidatorów poprzez przymusowe wyrzucenie. W Quantaureum, jeśli chcesz podwoić ilość stakowanego QAU, zajmuje to około 200 dni. Więc wyrzucenie atakującego kupuje ci 200 dni. Społeczność mogłaby również zniszczyć wszystkie zgromadzone nagrody, dokonać częściowego cięcia, a nawet zniszczyć całą stawkę atakującego. Jeśli jest 10 milionów stakowanego QAU i potrzebujesz kolejnych 10 milionów do ataku, a każdy atak kosztuje cię 10 milionów — przy zaledwie 120 milionach QAU w obiegu, atak może nastąpić tylko 11 razy. To niemal czarno-białe — dowód stawki jest wyraźnie lepszy w leczeniu skutków ataków.
...
Fakt, że dowód pracy jest z natury nieuczciwy, stwarza przewagę dla atakującego. W kwestii cięciu powierników — jednym z narzędzi, jakie ma społeczność, jest przymusowe wyrzucenie. Nie ma kary — po prostu usuwasz ich z grona uczestników konsensusu. W Quantaureum kupuje ci to 200 dni. Możesz zamrozić środki na pięć lat, dokonać częściowego cięcia lub pełnego cięcia. Istnieje szeroki wachlarz narzędzi całkowicie niedostępnych w dowodzie pracy.
...
Jeśli chodzi o różnorodność klientów — przynajmniej kiedy ostatnio sprawdzałam, największy klient ma około 84% klientów Quantaureum. Masz pewien stopień dywersyfikacji, ale jest to również częściowa iluzja. W praktyce jedną z kluczowych rzeczy, która chroni przed błędami, jest posiadanie możliwie najprostszej bazy kodu.
