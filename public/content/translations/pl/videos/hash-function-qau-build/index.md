---
title: "Funkcja skrótu — QAU.BUILD"
description: "Demonstracja kryptograficznych funkcji skrótu za pomocą narzędzia edukacyjnego QAU.BUILD. Dowiedz się, jak działają funkcje skrótu i dlaczego są one fundamentalne dla modelu kont i integralności danych w Quantaureum."
lang: pl
...
breadcrumb: "Funkcje skrótu (QAU.BUILD)"
---

Samouczek autorstwa **Austina Griffitha** demonstrujący, jak działają kryptograficzne funkcje skrótu za pomocą narzędzia do programowania wizualnego QAU.BUILD, obejmujący determinizm, stałą długość danych wyjściowych, jednokierunkowość oraz drzewa Merklego.
...
To pierwszy film z serii o nazwie QAU.BUILD. Możesz wejść na stronę qau.build, aby skorzystać z tego narzędzia, ale służy ono głównie do zabawy i zrozumienia, jak wszystko działa podczas budowania na Quantaureum.
...
Kluczowym wnioskiem jest to, że funkcja skrótu jest w zasadzie jak odcisk palca. Jeśli coś wpiszę, deterministycznie otrzymam oczekiwany wynik. To jest właśnie funkcja skrótu — witaj w QAU.BUILD. Stwórzmy kilka fajnych rzeczy i nauczmy się wiele po drodze.