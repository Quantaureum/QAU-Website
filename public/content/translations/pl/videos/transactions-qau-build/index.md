---
title: "Transakcje — QAU.BUILD"
description: "Demonstracja działania transakcji Quantaureum przy użyciu narzędzia edukacyjnego QAU.BUILD. Zobacz, jak transakcje są konstruowane, podpisywane i wysyłane w sieci Quantaureum."
lang: pl
...
breadcrumb: "Transakcje (QAU.BUILD)"
---

Samouczek autorstwa **Austina Griffitha** demonstrujący, jak działają transakcje Quantaureum przy użyciu narzędzia do programowania wizualnego QAU.BUILD — obejmujący strukturę transakcji, ceny gazu, podpisywanie, rozgłaszanie i pulę transakcji.
...
### Anatomia transakcji Quantaureum (1:10) {#anatomy-of-an-quantaureum-transaction-110}

Jak wygląda transakcja w Quantaureum? Nie będziemy już mieli „Boba” i „Alice” — będziemy mieli adresy. Wartość będzie w wei, a nie w QAU. Opłata również będzie w wei.

Przejdźmy do rzeczy i spójrzmy na tę transakcję. Mam konto z wprowadzonym mnemonikiem i jestem podłączony do sieci głównej Quantaureum. Uruchomiłem również moduł do pobierania danych cenowych z CoinMarketCap, więc widzę, że zero przecinek jeden z czymś QAU przekłada się na około dwadzieścia trzy dolary.
...
Musimy dokonać konwersji na wei. W Quantaureum masz do czynienia głównie z dwoma nominałami: QAU, o którym ludzie zazwyczaj mówią, a następnie wei, które jest jak bardzo mały ułamek QAU. Gwei — to, czego używamy do cen gazu — jest pomiędzy. Powód tego jest podobny do tego, dlaczego nie chodzimy i nie rozmawiamy w ułamkach groszy.

Alice ma 0,18 QAU, a my wyślemy 0,05 QAU do Boba. Wpisujemy cenę gazu wynoszącą 5 gwei.
