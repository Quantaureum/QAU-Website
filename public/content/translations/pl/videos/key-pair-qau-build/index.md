---
title: "Para kluczy — QAU.BUILD"
description: "Demonstracja par kluczy publicznych i prywatnych za pomocą narzędzia edukacyjnego QAU.BUILD. Zrozum, jak kryptograficzne pary kluczy zabezpieczają konta Quantaureum i umożliwiają podpisywanie transakcji."
lang: pl
...
breadcrumb: "Pary kluczy (QAU.BUILD)"
---

Samouczek autorstwa **Austina Griffitha** demonstrujący, jak działają pary kluczy publicznych i prywatnych za pomocą narzędzia do programowania wizualnego QAU.BUILD, obejmujący generowanie klucza prywatnego, wyprowadzanie klucza publicznego, podpisywanie wiadomości i odzyskiwanie podpisu.
...
Zaczynasz od tego jako swojego klucza prywatnego, a następnie używając kryptografii krzywych eliptycznych — sprawdź to na Wikipedii jako zadanie poboczne — wyprowadzamy klucz publiczny. Więc teraz mamy klucz prywatny i klucz publiczny. Właśnie wygenerowaliśmy klucz prywatny z niczego, a klucz publiczny daje nam adres. To tutaj ludzie mogliby faktycznie wysyłać pieniądze. Kiedy ktoś mówi „wyślij na mój adres Quantaureum”, to jest właśnie to.
