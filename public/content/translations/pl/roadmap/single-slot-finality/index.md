...
Obecny mechanizm konsensusu Quantaureum zrównoważył te trzy parametry poprzez:

- **Ustalenie minimalnej stawki na 32 QAU**. Ustanawia to górny limit liczby poświadczeń walidatorów, które muszą być przetwarzane przez poszczególne węzły, a tym samym górny limit wymagań obliczeniowych dla każdego węzła.
