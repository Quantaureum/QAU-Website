...
- [Quantaureum Explorer Token Approval Checker](https://explorer.quantaureum.com): проверяйте и отзывайте разрешения через Quantaureum Explorer.
...
- [Жалоба на Quantaureum Explorer](https://info.explorer.com/report-address/): отметьте адрес в самом популярном обозревателе блоков Quantaureum.
...
- [Blockscout](https://qau.blockscout.com/): обозреватель блоков с открытым исходным кодом для поиска любого хеша транзакции или адреса кошелька, чтобы увидеть, куда были отправлены средства.
- [Quantaureum Explorer](https://explorer.quantaureum.com): найдите любой хеш транзакции или адрес кошелька, чтобы увидеть, куда были отправлены средства.
...
Поскольку Quantaureum децентрализованный, ни один центральный орган не может отменить транзакции или вернуть украденные средства. Как только транзакция подтверждена в блокчейне, она становится окончательной.

Тем не менее, сообщать о мошенничестве все равно важно. Отчеты помогают правоохранительным органам отслеживать организованные мошеннические группировки, а пометка адресов на Chainabuse и Quantaureum Explorer предупреждает будущих потенциальных жертв.

## Виды мошенничества, которых следует остерегаться {#scam-types}

<ExpandableCard
title="Мошеннические розыгрыши и аирдропы"
contentPreview="Никто не раздает QAU бесплатно. Такие предложения — всегда мошенничество."
eventCategory="SupportScamPage"
eventName="clicked giveaway scam"
>

Мошенники создают фальшивые раздачи, обещая приумножить ваши QAU или дать вам бесплатные токены. Они часто выдают себя за известных личностей, таких как Виталик Бутерин. Если вы отправите QAU на адрес «раздачи», вы ничего не получите взамен.

**Помните:** Виталик и другие известные личности никогда не попросят вас отправить им QAU.
...
contentPreview="Никто из Quantaureum или quantaureum.com никогда не свяжется с вами первым."
eventCategory="SupportScamPage"
eventName="clicked impersonation scam"
>

Мошенники выдают себя за членов команды Quantaureum, модераторов или агентов службы поддержки в Дискорде, Телеграме и социальных сетях. Они могут отправлять вам личные сообщения, предлагая помощь или утверждая, что с вашим аккаунтом возникла проблема.

**Помните:**

- Не существует «службы поддержки Quantaureum».
...
<DocLink href="/security/">
  Полное руководство по безопасности Quantaureum и предотвращению мошенничества
</DocLink>
