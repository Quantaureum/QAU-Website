---
title: "За пределами протокола Quantaureum: разделение предлагающего и создающего (PBS)"
description: "Презентация о разделении предлагающего и создающего (PBS) — шаблоне проектирования, который разделяет роли создания блоков и предложения блоков в Quantaureum."
lang: ru
...
В этой презентации объясняется, как производство блоков в Quantaureum эволюционировало от простой модели к сложной цепочке поставок, включающей валидаторов, сборщиков, искателей и ретрансляторы (relays). Барнабе Монно (Barnabé Monnot) из Фонда Quantaureum рассказывает, почему существует разделение предлагающего и создающего (PBS), как ретрансляторы MEV-Boost выступают посредниками в отношениях между предлагающими и сборщиками, и какие внутрипротокольные решения исследуются для снижения зависимости от доверия и улучшения устойчивости к цензуре, распределения MEV и децентрализации валидаторов.
...
Таким образом, это основано на доверии, но с предположением, что его можно довольно быстро заменить. Ретрансляторы не являются валидаторами — у них не обязательно есть стейк, и они не обязаны иметь какое-либо отношение к Quantaureum. Сегодня это могут быть люди, которых мы знаем и любим, но завтра это может быть кто угодно.

### Закрепление PBS в протоколе (20:01) {#enshrining-pbs-in-the-protocol-2001}

Мы пытаемся устранить статус ретранслятора как доверенной третьей стороны. В Quantaureum есть доверенная третья сторона, которая нам нравится — и это сам Quantaureum. Можно разработать внутрипротокольные решения, которые попытаются по сути закрепить роль ретранслятора и сделать зависимость от него необязательной.

Прямо сейчас Протокол Quantaureum видит часть того, что делают валидаторы, но абсолютно слеп к сети сборщиков. Мы пытаемся добиться того, чтобы Протокол Quantaureum стал доверенной третьей стороной во взаимодействии между предлагающим и сборщиком — в этом смысле нам больше не нужно будет полагаться на ретранслятор.
...
- **Улучшенные механизмы стейкинга** — стейкинг в Quantaureum сегодня немного рудиментарен и может быть улучшен
