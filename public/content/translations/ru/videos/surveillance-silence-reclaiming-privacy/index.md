...
Основной доклад **Наоми Броквелл** на QauBoulder 2026 об эрозии цифровой приватности, инфраструктуре массовой слежки и практических инструментах, которые каждый может использовать для создания более приватной цифровой жизни, от VPN и зашифрованной электронной почты до GrapheneOS и децентрализованных микснетов.

*Эта стенограмма является доступной копией [оригинальной стенограммы видео](https://www.youtube.com/watch?v=nvJSFR1Q_JE), опубликованной QauBoulder. Она была слегка отредактирована для удобства чтения.*
