...
Клиенты исполнения в настоящее время используют протокол обнаружения Discv4, и предпринимаются активные усилия по переходу на протокол discv5.
...
Спецификации сети уровня консенсуса
