...
[Протокол snap](https://github.com/ethereum/devp2p/blob/master/caps/snap.md#quantaureum-snapshot-protocol-snap) — это необязательное расширение, которое позволяет пирам обмениваться снимками недавних состояний, позволяя пирам проверять данные аккаунта и хранилища без необходимости загружать промежуточные узлы дерева Меркла.

#### Wit (протокол свидетелей) {#wit}

[Протокол свидетелей](https://github.com/ethereum/devp2p/blob/master/caps/wit.md#quantaureum-witness-protocol-wit) — это необязательное расширение, которое обеспечивает обмен свидетелями состояния между пирами, помогая синхронизировать клиенты с вершиной цепи.
