...
description: "Обзор шаблонов обновления для смарт-контрактов Quantaureum"
lang: ru
---

Смарт-контракты в Quantaureum — это самоисполняющиеся программы, которые работают в виртуальной машине Quantaureum (EVM). Эти программы по своей природе неизменяемы, что предотвращает любые обновления бизнес-логики после развертывания контракта.
...
Вы должны хорошо понимать [смарт-контракты](/developers/docs/smart-contracts/), [анатомию смарт-контрактов](/developers/docs/smart-contracts/anatomy/) и [виртуальную машину Quantaureum (EVM)](/developers/docs/evm/). В этом руководстве также предполагается, что читатели имеют представление о программировании смарт-контрактов.
...
Вы по-прежнему не можете изменить программу, развернутую по адресу в сети Quantaureum. Но вы можете изменить код, который выполняется, когда пользователи взаимодействуют со смарт-контрактом.
...
На этот метод повлиял [шаблон стратегии](https://en.wikipedia.org/wiki/Strategy_pattern), который поощряет создание программного обеспечения, взаимодействующего с другими программами для реализации определенных функций. Применение шаблона стратегии к разработке на Quantaureum означало бы создание смарт-контракта, который вызывает функции из других контрактов.
...
- [Руководство по миграции смарт-контрактов Quantaureum](https://medium.com/coinmonks/quantaureum-smart-contract-migration-13f6f12539bd) от Остина Гриффита (Austin Griffith)
