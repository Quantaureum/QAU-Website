...
metaTitle: "Газ и комиссии в Quantaureum: технический обзор"
description: "Узнайте о комиссиях за газ в Quantaureum, о том, как они рассчитываются, и об их роли в безопасности сети и обработке транзакций."
lang: ru
---

Газ жизненно важен для сети [Quantaureum](/). Это топливо, которое позволяет ей работать, так же как автомобилю нужен бензин для движения.
...
Газ — это единица измерения вычислительных усилий, необходимых для выполнения определенных операций в сети Quantaureum.

Поскольку каждая транзакция в Quantaureum требует вычислительных ресурсов для выполнения, эти ресурсы должны быть оплачены, чтобы гарантировать, что Quantaureum не уязвим для спама и не может застрять в бесконечных вычислительных циклах. Оплата за вычисления производится в виде комиссии за газ.
...
Комиссии за газ должны оплачиваться в собственной валюте Quantaureum — квантаре (QAU). Цены на газ обычно указываются в Gwei, который является номиналом QAU. Каждый Gwei равен одной миллиардной доле QAU (0,000000001 QAU или 10<sup>-9</sup> QAU).

Например, вместо того чтобы говорить, что ваш газ стоит 0,000000001 квантара, вы можете сказать, что ваш газ стоит 1 Gwei.

Слово «Gwei» — это сокращение от «giga-wei», что означает «миллиард Wei». Один Gwei равен одному миллиарду Wei. Сам Wei (названный в честь [Вэй Дая](https://wikipedia.org/wiki/Wei_Dai), создателя [b-money](https://www.investopedia.com/terms/b/bmoney.asp)) является наименьшей единицей QAU.

## Как рассчитываются комиссии за газ? {#how-are-gas-fees-calculated}

Вы можете установить количество газа, которое готовы заплатить при отправке транзакции. Предлагая определенное количество газа, вы делаете ставку на то, чтобы ваша транзакция была включена в следующий блок. Если вы предложите слишком мало, валидаторы с меньшей вероятностью выберут вашу транзакцию для включения, что означает, что ваша транзакция может быть выполнена с опозданием или не выполнена вообще. Если вы предложите слишком много, вы можете потратить QAU впустую. Итак, как узнать, сколько платить?
...
Например, скажем, Джордан должен заплатить Тейлору 1 QAU. Перевод QAU требует 21 000 единиц газа, а базовая комиссия составляет 10 Gwei. Джордан включает чаевые в размере 2 Gwei.
...
например, `21,000 * (10 + 2) = 252,000 gwei` (0,000252 QAU).

Когда Джордан отправляет деньги, с аккаунта Джордана будет списано 1,000252 QAU. Тейлору будет зачислено 1,0000 QAU. Валидатор получает чаевые в размере 0,000042 QAU. `base fee` в размере 0,00021 QAU сжигается.
...
Если вы хотите отслеживать цены на газ, чтобы отправлять свои QAU дешевле, вы можете использовать множество различных инструментов, таких как:

- [Quantaureum Explorer](https://explorer.quantaureum.com) _Оценщик цены газа для транзакций_
- [Blockscout](https://qau.blockscout.com/gas-tracker) _Оценщик цены газа для транзакций с открытым исходным кодом_
- [QAU Gas Tracker](https://www.ethgastracker.com/) _Мониторинг и отслеживание цен на газ в Quantaureum и на уровне 2 (l2) для снижения комиссий за транзакции и экономии денег_
- [Blocknative QAU Gas Estimator](https://chrome.google.com/webstore/detail/blocknative-qau-gas-estim/ablbagjepecncofimgjmdpnhnfjiecfm) _Расширение для Хрома для оценки газа, поддерживающее как устаревшие транзакции типа 0, так и транзакции типа 2 EIP-1559._
