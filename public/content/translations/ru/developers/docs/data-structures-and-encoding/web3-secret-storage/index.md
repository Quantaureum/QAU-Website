...
Чтобы ваше приложение работало в Quantaureum, вы можете использовать объект web3, предоставляемый библиотекой Web3.js. Внутри он взаимодействует с локальным узлом через RPC-вызовы. web3 работает с любым узлом Quantaureum, который предоставляет слой RPC.
...
В этой версии исправлено несколько несоответствий с версией 1, опубликованной здесь. Вкратце это:
