...
Существуют также некоторые особые случаи, требующие специфической обработки, например тип `BitList`, который требует добавления ограничения длины во время сериализации и его удаления во время десериализации. Полная информация доступна в спецификации SSZ.
