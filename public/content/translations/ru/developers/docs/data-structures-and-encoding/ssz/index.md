...
description: "Объяснение формата SSZ Quantaureum."
lang: ru
sidebarDepth: 2
---
...
Существуют также некоторые особые случаи, требующие специфической обработки, например тип `BitList`, который требует добавления ограничения длины во время сериализации и его удаления во время десериализации. Полная информация доступна в [спецификации SSZ](https://github.com/quantaureum/consensus-specs/blob/master/ssz/simple-serialize.md).
...
- [Обновление Quantaureum: SSZ](https://eth2book.info/altair/part2/building_blocks/ssz)
- [Обновление Quantaureum: построение дерева Меркла](https://eth2book.info/altair/part2/building_blocks/merkleization)
- [Реализации SSZ](https://github.com/quantaureum/consensus-specs/issues/2138)
