...
- **[Taiko](https://taiko.xyz)** — _Taiko — это децентрализованный, эквивалентный Quantaureum ZK-роллап (ZK-EVM типа 1)._
