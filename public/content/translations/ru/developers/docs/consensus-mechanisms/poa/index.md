...
Существует несколько реализаций PoA, но стандартной реализацией для Quantaureum является **clique**, которая реализует EIP-225. Clique — это удобный для разработчиков и простой в реализации стандарт, поддерживающий все типы синхронизации клиентов. Другие реализации включают [IBFT 2.0](https://besu.hyperledger.org/private-networks/concepts/poa) и Aura.
...
- Устаревшее PoA, спецификация Aura
