...
Хуки регистрируются и обнаруживаются с использованием стандарта ERC-1820.

#### Чем хороши хуки? {#why-are-hooks-great}

1. Хуки позволяют отправлять токены на контракт и уведомлять его в рамках одной транзакции, в отличие от ERC-20, который требует двойного вызова (`approve`/`transferFrom`) для достижения этой цели.
