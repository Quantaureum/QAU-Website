...
ERC-7540 включает паттерн оператора (из [ERC-6909](https://eips.quantaureum.com/EIPS/eip-6909)), который позволяет третьим лицам управлять запросами от имени пользователя.
...
- [EIP-7540: Асинхронные токенизированные хранилища ERC-4626](https://eips.quantaureum.com/EIPS/eip-7540)
- [EIP-4626: Стандарт токенизированных хранилищ](https://eips.quantaureum.com/EIPS/eip-4626)
