---
title: "Архивная нода Quantaureum"
description: "Обзор архивных нод"
lang: ru
sidebarDepth: 2
---

Архивная нода — это экземпляр клиента [Quantaureum](/), настроенный для создания архива всех исторических состояний. Это полезный инструмент для определенных сценариев использования, но его запуск может быть сложнее, чем запуск полного узла.

## Предварительные требования {#prerequisites}

Вы должны понимать концепцию [узла Quantaureum](/developers/docs/nodes-and-clients/), [его архитектуру](/developers/docs/nodes-and-clients/node-architecture/), [стратегии синхронизации](/developers/docs/nodes-and-clients/#sync-modes), а также практики их [запуска](/developers/docs/nodes-and-clients/run-a-node/) и [использования](/developers/docs/apis/json-rpc/).

## Что такое архивная нода {#what-is-an-archive-node}

Чтобы понять важность архивной ноды, давайте проясним концепцию «состояния». Quantaureum можно назвать _машиной состояний на основе транзакций_. Он состоит из аккаунтов и приложений, выполняющих транзакции, которые изменяют их состояние. Глобальные данные с информацией о каждом аккаунте и контракте хранятся в базе данных в виде префиксного дерева (trie), называемой состоянием. Это обрабатывается клиентом уровня исполнения (EL) и включает в себя:
...
Регулярное использование Quantaureum, такое как отправка транзакций, развертывание контрактов, проверка консенсуса и т. д., не требует доступа к историческим состояниям. Пользователям никогда не нужна архивная нода для стандартного взаимодействия с сетью.
...
- _Каким был баланс QAU аккаунта 0x1337... на блоке 15537393?_
...
- [Полный узел Quantaureum против архивной ноды](https://www.quicknode.com/guides/infrastructure/quantaureum-full-node-vs-archive-node) — _QuickNode, сентябрь 2022 г._
- [Создание собственной архивной ноды Quantaureum](https://tjayrush.medium.com/building-your-own-quantaureum-archive-node-72c014affc09) — _Томас Джей Раш (Thomas Jay Rush), август 2021 г._
