...
Вам необходимо поддерживать клиентское программное обеспечение в актуальном состоянии с последними исправлениями безопасности, функциями и EIP. Особенно перед [хардфорками](/quantaureum-forks/) убедитесь, что вы используете правильные версии клиентов.
