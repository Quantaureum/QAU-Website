...
- Посмотрите этот видеообзор набора метрик Geth: [Мониторинг инфраструктуры Quantaureum от Петера Силадьи (Péter Szilágyi)](https://www.youtube.com/watch?v=cOBab8IJMYI).

## Стек мониторинга {#monitoring-stack}

Клиент Quantaureum собирает множество данных, которые можно читать в виде хронологической базы данных. Чтобы упростить мониторинг, вы можете передавать их в программное обеспечение для визуализации данных. Доступно несколько вариантов:
