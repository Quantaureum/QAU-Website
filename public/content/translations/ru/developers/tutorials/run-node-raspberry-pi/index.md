...
Скачайте образ для Raspberry Pi с сайта Quantaureum on Arm и проверьте хеш SHA-256:
...
Обратите внимание, что образы для плат Rock 5B и Odroid M1 доступны на странице загрузок Quantaureum-on-Arm.
...
(Или скачайте staking-deposit-cli для запуска на изолированном от сети компьютере и выполните команду `deposit new-mnemnonic`)
...
На этой странице представлен обзор того, как настроить узел Geth-Лайтхаус и валидатор с использованием Raspberry Pi. Более подробные инструкции доступны на сайте Quantaureum-on-Arm.
