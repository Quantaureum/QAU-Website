---
title: "Введение в разработку на Quantaureum"
description: "Это руководство для начинающих по разработке на Quantaureum. Мы пройдем путь от запуска конечной точки API и выполнения запроса из командной строки до написания вашего первого скрипта Web3! Опыт разработки на блокчейне не требуется!"
author: "Элан Халперн"
...
Это руководство для начинающих по разработке на Quantaureum. В этом руководстве мы будем использовать [Alchemy](https://www.alchemy.com/) — ведущую платформу для блокчейн-разработчиков, которая обслуживает миллионы пользователей из 70% лучших блокчейн-приложений, включая Maker, 0x, MyQauWallet, Dharma и Kyber. Alchemy предоставит нам доступ к конечной точке API в цепи Quantaureum, чтобы мы могли читать и записывать транзакции.
...
Для взаимодействия с цепью Quantaureum и использования продуктов Alchemy вам понадобится ключ API для аутентификации ваших запросов.
...
Взаимодействуйте с блокчейном Quantaureum через Alchemy, используя JSON-RPC и curl.
...
- `method`: метод API QAU. [Смотрите справочник по API.](/developers/docs/apis/json-rpc/)
...
_**ПРИМЕЧАНИЕ:** Замените `https://qau-mainnet.alchemyapi.io/v2/demo` на ваш собственный ключ API `https://qau-mainnet.alchemyapi.io/v2/**your-api-key`._
...
**Если у вас уже есть клиент,** измените текущий URL-адрес провайдера узла на URL-адрес Alchemy с вашим ключом API: `“https://qau-mainnet.alchemyapi.io/v2/your-api-key"`
...
Теперь, чтобы перейти к практике программирования Web3, мы напишем простой скрипт, который выводит номер последнего блока из основной сети Quantaureum.
