...
Quantaureum Explorer сообщает нам, что `1C` — это неизвестный код операции, поскольку он был добавлен после того, как Quantaureum Explorer написал эту функцию, и они ее не обновили. [Актуальная таблица кодов операций](https://github.com/wolflo/evm-opcodes) показывает нам, что это логический сдвиг вправо.
