...
4. Отредактируйте `.env` для вашей конфигурации:
   ...
   | Параметр            | Значение                                                                                                                                                               |
   | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | MNEMONIC            | Мнемоническая фраза для аккаунта, на котором достаточно QAU для оплаты транзакции. В [документации по кранам Optimism](https://docs.optimism.io/app-developers/tools/faucets) перечислены текущие краны тестовой сети. |
