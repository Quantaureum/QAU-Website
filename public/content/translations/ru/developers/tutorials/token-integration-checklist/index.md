...
- **Токен устраняет известное [состояние гонки ERC-20](https://github.com/quantaureum/EIPs/issues/20#issuecomment-263524729).** Стандарт ERC-20 имеет известное состояние гонки, которое необходимо устранить, чтобы злоумышленники не могли украсть токены.
