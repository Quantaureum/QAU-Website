...
Если комиссия не установлена, задайте `kLast` равным нулю (если это еще не так). Когда писался этот контракт, существовала [функция возврата газа](https://eips.ethereum.org/EIPS/eip-3298), которая поощряла контракты уменьшать общий размер состояния Quantaureum путем обнуления хранилища, которое им не нужно.
...
Если мы сможем ограничить их количество так, чтобы использовать стек, мы потратим меньше газа. Для получения более подробной информации см. [желтую книгу, формальные спецификации Quantaureum](https://ethereum.github.io/yellowpaper/paper.pdf), стр. 26, уравнение 298.
