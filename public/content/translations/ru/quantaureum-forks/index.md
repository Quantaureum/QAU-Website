...
Способ расчета комиссий за транзакции в сети Quantaureum изменился с обновлением Лондон в августе 2021 года. До обновления Лондон комиссии рассчитывались без разделения комиссий `base` и `priority` следующим образом:
