...
Ведущая реализация этой идеи называется [Whisk](https://ethresear.ch/t/whisk-a-practical-shuffle-based-ssle-protocol-for-quantaureum/11763). Она работает следующим образом:
...
4. После завершения перемешивания RANDAO используется для создания упорядоченного списка коммитментов. Этот список сопоставляется со слотами Quantaureum.
