...
[PeerDAS (EIP-7594)](https://eips.ethereum.org/EIPS/eip-7594) — это конкретное предложение, которое реализует механизм DAS в Quantaureum, знаменуя собой, вероятно, самое большое обновление со времен Слияния. PeerDAS предназначен для расширения данных блобов, разделяя их на столбцы и распределяя подмножество между узлами.
