...
- Accepter avec grâce et/ou formuler avec empathie des critiques constructives
- Agir avec calme et professionnalisme lors de la résolution de conflits ou de désaccords
- Faire preuve d'empathie et de tolérance envers les autres membres de la communauté
- Encourager et amplifier les nouvelles voix au sein de la communauté

Voici des exemples de comportements inacceptables de la part des participants :

- La violence physique, les menaces de violence physique ou l'encouragement à la violence physique de quelque nature que ce soit
- L'utilisation d'un langage ou d'images à caractère sexuel, ou le fait d'imposer une attention sexuelle non désirée
- L'usurpation de l'identité d'une autre personne ou le fait de revendiquer malhonnêtement une affiliation avec une personne ou une organisation
- Le trolling, les commentaires insultants/désobligeants et les attaques personnelles ou politiques
- Le harcèlement d'autres membres de la communauté sur des canaux publics ou privés
...
- L'ingénierie sociale, l'escroquerie ou toute autre forme de manipulation d'autres membres de la communauté
- La promotion d'investissements, de jetons, de projets ou de toute autre chose à des fins de gain personnel, monétaire ou non
- Le spam des serveurs avec du contenu hors sujet
- Le non-respect des demandes ou des avertissements des modérateurs de la communauté
- L'adoption de tout autre comportement qui pourrait raisonnablement être considéré comme inapproprié dans un cadre professionnel

### Signalement {#reporting}

Les violations du code de conduite seront normalement visibles par la communauté, car nous essayons de tout faire sur des canaux ouverts et publics, permettant ainsi aux membres de la communauté de s'autoréguler.

Cependant, si un événement se produit et que vous estimez qu'il nécessite une attention particulière, vous pouvez en faire part à une personne ayant un rôle de modération (par exemple, un guide Discord) afin qu'elle puisse aider à enquêter et à apporter la réponse appropriée.

Lors d'un signalement, veuillez inclure autant de détails que possible, y compris des exemples précis et des horodatages. Cela contribuera à garantir un résultat équitable.
