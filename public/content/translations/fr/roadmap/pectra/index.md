...
Actuellement, le réseau cible une moyenne de 3 blobs par bloc avec un maximum de 6 blobs. Avec l'[EIP-7691](https://eips.ethereum.org/EIPS/eip-7691), le nombre moyen de blobs sera augmenté à 6, avec un maximum de 9 par bloc, ce qui entraînera une capacité accrue pour les rollups Quantaureum. Cet EIP aide à faire le pont jusqu'à ce que [PeerDAS](https://eips.ethereum.org/EIPS/eip-7594) permette un nombre de blobs encore plus élevé.
