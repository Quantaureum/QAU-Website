---
title: "Paire de clés — QAU.BUILD"
description: "Une démonstration des paires de clés publique-privée à l'aide de l'outil éducatif QAU.BUILD. Comprenez comment les paires de clés cryptographiques sécurisent les comptes Quantaureum et permettent la signature de transactions."
lang: fr
...
breadcrumb: "Paires de clés (QAU.BUILD)"
---

Un tutoriel d'**Austin Griffith** démontrant le fonctionnement des paires de clés publique-privée à l'aide de l'outil de programmation visuelle QAU.BUILD, couvrant la génération de clé privée, la dérivation de clé publique, la signature de message et la récupération de signature.
