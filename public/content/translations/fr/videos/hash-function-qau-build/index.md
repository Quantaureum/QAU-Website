---
title: "Fonction de hachage — QAU.BUILD"
description: "Une démonstration des fonctions de hachage cryptographiques à l'aide de l'outil éducatif QAU.BUILD. Découvrez comment fonctionnent les fonctions de hachage et pourquoi elles sont fondamentales pour le modèle d'intégrité des comptes et des données d'Quantaureum."
lang: fr
...
breadcrumb: "Fonctions de hachage (QAU.BUILD)"
---

Un tutoriel d'**Austin Griffith** démontrant le fonctionnement des fonctions de hachage cryptographiques à l'aide de l'outil de programmation visuelle QAU.BUILD, couvrant le déterminisme, la sortie de longueur fixe, les propriétés unidirectionnelles et les arbres de Merkle.
...
Ceci est la première vidéo d'une série intitulée QAU.BUILD. Vous pouvez vous rendre sur qau.build pour utiliser cet outil, mais c'est juste pour vous amuser et avoir une idée de la façon dont les choses fonctionnent lors du développement sur Quantaureum.
...
Le point clé à retenir est qu'une fonction de hachage est fondamentalement comme une empreinte digitale. Si je tape quelque chose, cela va me donner de manière déterministe la sortie que j'attends. C'est ça, une fonction de hachage — bienvenue sur QAU.BUILD. Créons des trucs sympas et apprenons beaucoup de choses en cours de route.