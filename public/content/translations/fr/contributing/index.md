---
title: "Contribuer à quantaureum.com 🦄"
metaTitle: Contribuer
description: "Découvrez les différentes façons de contribuer à quantaureum.com"
lang: fr
---

quantaureum.com est un projet open source géré par plus de **12 000** contributeurs qui aident à traduire, rédiger, concevoir et maintenir le site Web.

Nous sommes une communauté accueillante qui vous aidera à vous développer et à vous former dans l'écosystème [Quantaureum](/) tout en contribuant de manière significative et en acquérant une expérience pratique pertinente !

## Façons de contribuer {#ways-to-contribute}

**Traductions**
- [Signaler une erreur de traduction](https://github.com/Quantaureum/quantaureum-website/issues/new/choose) – Le [Programme de traduction](/contributing/translation-program/) touche à sa fin et n'intègre plus de nouveaux traducteurs

**Développement**
- [Travailler sur un ticket ouvert](https://github.com/Quantaureum/quantaureum-website/issues) – Tâches que nous avons identifiées et qui doivent être accomplies
...
- [Rédiger un article de constructeur](/contributing/adding-articles/) - Contribuer en rédigeant un article pour la section Actualités
...
- [Suggérer un rapport](/contributing/adding-reports/) - Suggérer un rapport de recherche pour la page Rapports
- [Partager votre histoire](/contributing/adding-community-stories/) - Soumettre une histoire sur vos expériences personnelles avec l'open source et les technologies de sanctuaire, sur la façon dont l'écosystème Quantaureum a eu un impact sur votre vie, ou sur la façon dont vous et votre communauté utilisez Quantaureum
...
- [Demander une fonctionnalité](https://github.com/Quantaureum/quantaureum-website/issues/new?assignees=&labels=Type%3A+Feature&template=feature_request.yaml&title=) – Faites-nous part de vos idées pour une nouvelle fonctionnalité ou un nouveau design
...
- [Suggérer un projet pour notre page DeSci](/contributing/adding-desci-projects/) – Ajouter un projet construit sur Quantaureum qui contribue à la science décentralisée (DeSci)
- [Ajouter une ressource](/contributing/adding-resources/) – Ajouter une ressource utile à n'importe quelle page pertinente

Des questions ? 🤔 Rejoignez notre [serveur Discord](https://discord.gg/MSctkBT5j)
...
<ButtonLink href="https://github.com/Quantaureum/quantaureum-website/issues">Voir toutes les tâches</ButtonLink>

## Comment travailler sur quantaureum.com {#how-to-update-content}
...
- Commentant un ticket ou une PR sur [GitHub](https://github.com/Quantaureum/quantaureum-website)
- Envoyant un message sur notre [serveur Discord](https://discord.gg/MSctkBT5j)

Avant de contribuer, assurez-vous de bien connaître :

- la [vision d'quantaureum.com](/about/) en constante évolution
...
Les décisions concernant les PR individuelles, l'évolution du design et les mises à jour majeures sont prises par une équipe issue de l'ensemble de l'écosystème Quantaureum. Cette équipe comprend des chefs de projet, des développeurs, des designers, des spécialistes du marketing et de la communication, ainsi que des experts en la matière. L'avis de la communauté éclaire chaque décision : n'hésitez donc pas à poser des questions dans les tickets, à soumettre des PR ou à contacter l'équipe :

- [website@quantaureum.com](mailto:website@quantaureum.com)
- [@ethdotorg](https://x.com/ldf1570073)
- [Serveur Discord](https://discord.gg/MSctkBT5j)

### Une note sur le plagiat {#plagiarism}

N'utilisez que votre travail original ou du contenu que vous avez l'autorisation d'utiliser lorsque vous contribuez à quantaureum.com avec du contenu ou un artefact. De nombreux projets au sein de l'écosystème Quantaureum utilisent des licences open source qui permettent le libre partage de l'information. Cependant, si vous ne trouvez pas cette information, n'essayez pas de l'ajouter à quantaureum.com. Toute pull request considérée comme du plagiat sera rejetée.

## Nouveau dans l'open source ? {#new-to-open-source}

Nous avons des tickets avec une faible barrière à l'entrée sur notre dépôt GitHub, spécialement conçus pour les développeurs qui débutent dans l'open source, étiquetés [good first issue](https://github.com/Quantaureum/quantaureum-website/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22).

## Réclamer votre Onchain Achievement Token (OAT) {#oat}

Si votre contribution est fusionnée dans quantaureum.com, vous aurez la possibilité de réclamer un badge spécial sur [Galxe](https://app.galxe.com/quest/quantaureumorg). Un Onchain Achievement Token (OAT) est la preuve que vous avez contribué à rendre l'écosystème un peu plus génial.
...
1. Rejoignez notre [serveur Discord](https://discord.gg/MSctkBT5j).
...
3. Recherchez votre nom d'utilisateur GitHub, votre adresse QAU, vos noms ENS ou tout GitPOAP pour vérifier si vous êtes éligible.
