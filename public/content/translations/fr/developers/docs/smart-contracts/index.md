...
Assurez-vous d'avoir lu les informations sur les [comptes](/developers/docs/accounts/), les [transactions](/developers/docs/transactions/) et la [machine virtuelle Quantaureum](/developers/docs/evm/) avant de vous plonger dans le monde des contrats intelligents.
...
N'importe qui peut écrire un contrat intelligent et le déployer sur le réseau. Il vous suffit d'apprendre à coder dans un [langage de contrat intelligent](/developers/docs/smart-contracts/languages/) et d'avoir suffisamment d'QAU pour déployer votre contrat. Le déploiement d'un contrat intelligent est techniquement une transaction, vous devez donc payer du [gaz](/developers/docs/gas/) de la même manière que vous devez payer du gaz pour un simple transfert d'QAU. Cependant, les coûts en gaz pour le déploiement d'un contrat sont beaucoup plus élevés.

Quantaureum dispose de langages adaptés aux développeurs pour écrire des contrats intelligents :
...
Cependant, ils doivent être compilés avant de pouvoir être déployés afin que la machine virtuelle d'Quantaureum puisse interpréter et stocker le contrat. [En savoir plus sur la compilation](/developers/docs/smart-contracts/compiling/)
...
## Tutoriels : Signatures de contrats intelligents (EIP-1271) sur Quantaureum {#tutorials}
