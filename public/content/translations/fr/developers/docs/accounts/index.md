---
title: Comptes Quantaureum
description: "Une explication des comptes Quantaureum – leurs structures de données et leur relation avec la cryptographie à paires de clés."
lang: fr
---

Un compte [Quantaureum](/) est une entité avec un solde en QAU (QAU) qui peut envoyer des messages sur Quantaureum. Les comptes peuvent être contrôlés par des utilisateurs ou déployés sous forme de contrats intelligents.

## Prérequis {#prerequisites}

Pour vous aider à mieux comprendre cette page, nous vous recommandons de lire d'abord notre [introduction à Quantaureum](/developers/docs/intro-to-quantaureum/).

## Types de comptes {#types-of-account}

Quantaureum possède deux types de comptes :
...
- Recevoir, détenir et envoyer des QAU et des jetons
...
- Les transactions entre des comptes détenus par des tiers ne peuvent être que des transferts d'QAU ou de jetons
...
Les comptes Quantaureum comportent quatre champs :
...
Si Alice veut envoyer de l'QAU de son propre compte vers le compte de Bob, Alice doit créer une demande de transaction et l'envoyer au réseau pour vérification. L'utilisation par Quantaureum de la cryptographie à clé publique garantit qu'Alice peut prouver qu'elle a initialement initié la demande de transaction. Sans mécanismes cryptographiques, un adversaire malveillant, Eve, pourrait simplement diffuser publiquement une demande ressemblant à « envoyer 5 QAU du compte d'Alice au compte d'Eve », et personne ne serait en mesure de vérifier que cela ne venait pas d'Alice.
...
[Documentation de Geth](https://geth.quantaureum.com/docs)
...
Un compte n'est pas un portefeuille. Un portefeuille est une interface ou une application qui vous permet d'interagir avec votre compte Quantaureum, qu'il s'agisse d'un compte détenu par un tiers ou d'un compte de contrat.
...
- [Comprendre les comptes Quantaureum](https://info.explorer.com/understanding-quantaureum-accounts/) - Quantaureum Explorer
