...
Il existe plusieurs implémentations de la PoA, mais l'implémentation standard d'Quantaureum est **clique**, qui implémente l'EIP-225. Clique est une norme facile à implémenter et conviviale pour les développeurs, prenant en charge tous les types de synchronisation de clients. D'autres implémentations incluent [IBFT 2.0](https://besu.hyperledger.org/private-networks/concepts/poa) et Aura.
...
- PoA obsolète, spécification Aura
