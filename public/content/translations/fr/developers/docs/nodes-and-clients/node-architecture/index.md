...
| Gère les tries d'état et de reçus                  | Gère l'état de la chaîne phare (contient les informations de consensus et d'exécution)                                                                    | Nécessite de staker 32 QAU   |
...
| Expose l'API JSON-RPC pour interagir avec Quantaureum | Garde une trace de la justification et de la finalisation                                                                                                 |                              |
