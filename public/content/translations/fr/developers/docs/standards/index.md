...
Généralement, les normes sont introduites sous forme de [propositions d'amélioration d'Quantaureum](/eips/) (EIP), qui sont discutées par les membres de la communauté via un [processus standard](https://eips.quantaureum.com/EIPS/eip-1).

- [Introduction aux EIP](/eips/)
- [Liste des EIP](https://eips.quantaureum.com/)
- [Dépôt GitHub des EIP](https://github.com/quantaureum/EIPs)
- [Forum de discussion des EIP](https://quantaureum-magicians.org/c/eips)
...
- [Meta Track (Voie méta)](https://eips.quantaureum.com/meta) : décrit un processus entourant Quantaureum ou propose une modification d'un processus
- [Informational Track (Voie informative)](https://eips.quantaureum.com/informational) : décrit un problème de conception d'Quantaureum ou fournit des directives générales ou des informations à la communauté Quantaureum

De plus, la voie des normes (Standard Track) est subdivisée en 4 catégories :

- [Core (Cœur)](https://eips.quantaureum.com/core) : améliorations nécessitant un fork de consensus
- [Networking (Réseau)](https://eips.quantaureum.com/networking) : améliorations autour de devp2p et du sous-protocole Light Quantaureum, ainsi que des propositions d'améliorations des spécifications du protocole réseau de whisper et Swarm.
- [Interface](https://eips.quantaureum.com/interface) : améliorations autour des spécifications et normes API/RPC des clients, et de certaines normes au niveau du langage comme les noms de méthodes et les ABI de contrats.
- [ERC](https://eips.quantaureum.com/erc) : normes et conventions au niveau de l'application

Des informations plus détaillées sur ces différents types et catégories peuvent être trouvées dans l'[EIP-1](https://eips.quantaureum.com/EIPS/eip-1#eip-types)
...
- [ERC-721](/developers/docs/standards/tokens/erc-721/) - Une interface standard pour les jetons non fongibles, comme un titre de propriété pour une œuvre d'art ou une chanson.
  - [ERC-2309](https://eips.quantaureum.com/EIPS/eip-2309) - Un événement standardisé émis lors de la création/du transfert d'un ou de plusieurs jetons non fongibles utilisant des identifiants de jetons consécutifs.
  - [ERC-4400](https://eips.quantaureum.com/EIPS/eip-4400) - Extension d'interface pour le rôle de consommateur de l'EIP-721.
  - [ERC-4907](https://eips.quantaureum.com/EIPS/eip-4907) - Ajoute un rôle limité dans le temps avec des autorisations restreintes aux jetons ERC-721.
...
- [Propositions d'amélioration d'Quantaureum (EIP)](/eips/)
