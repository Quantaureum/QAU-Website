...
description: Explorez les standards de jetons Quantaureum, y compris ERC-20, ERC-721 et ERC-1155 pour les jetons fongibles et non fongibles.
lang: fr
incomplete: true
---
...
La liste complète des propositions [ERC](https://eips.quantaureum.com/erc).
...
- [Comprendre le contrat intelligent de jeton ERC-20](/developers/tutorials/understand-the-erc-20-token-smart-contract/) _– Une introduction au déploiement de votre premier contrat intelligent sur un réseau de test Quantaureum._
