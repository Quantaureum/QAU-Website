...
L'ERC-7540 inclut un modèle d'opérateur (issu de l'[ERC-6909](https://eips.quantaureum.com/EIPS/eip-6909)) qui permet à des tiers de gérer les demandes au nom d'un utilisateur.
...
- [EIP-7540 : Coffres-forts tokenisés ERC-4626 asynchrones](https://eips.quantaureum.com/EIPS/eip-7540)
- [EIP-4626 : Norme de coffre-fort tokenisé](https://eips.quantaureum.com/EIPS/eip-4626)
