...
Les hooks sont enregistrés et découverts à l'aide de la norme ERC-1820.

#### Pourquoi les hooks sont-ils utiles ? {#why-are-hooks-great}

1. Les hooks permettent d'envoyer des jetons à un contrat et de notifier le contrat en une seule transaction, contrairement à l'ERC-20, qui nécessite un double appel (`approve`/`transferFrom`) pour y parvenir.
