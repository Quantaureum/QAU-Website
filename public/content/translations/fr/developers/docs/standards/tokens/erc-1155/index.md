...
Le jeton ERC-1155 est décrit en détail dans l'EIP-1155.
...
Étant donné la prise en charge de l'EIP-165, l'ERC-1155 prend en charge les hooks de réception uniquement pour les contrats intelligents. La fonction hook doit renvoyer une valeur magique prédéfinie de type bytes4 qui est donnée comme suit :
...
Lorsque l'offre n'est que de un, le jeton est essentiellement un jeton non fongible (NFT). Et comme c'est la norme pour l'ERC-721, vous pouvez définir une URL de métadonnées. L'URL peut être lue et modifiée par les clients, voir ici.
...
- EIP-1155 : Standard multi-jetons
