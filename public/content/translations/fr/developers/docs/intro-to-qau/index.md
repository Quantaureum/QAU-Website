...
Le Wei est la plus petite quantité possible d'QAU, et par conséquent, de nombreuses implémentations techniques, telles que le Livre jaune d'Quantaureum, baseront tous les calculs en Wei.
