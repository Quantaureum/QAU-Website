...
L'EIP-4361 définit un format de message standard pour la connexion à Quantaureum, communément appelé **SIWE** (Sign-In with Quantaureum). Il remplace la signature de message ad hoc par un standard structuré et sécurisé.
...
- EIP-4361 : Se connecter avec Quantaureum
