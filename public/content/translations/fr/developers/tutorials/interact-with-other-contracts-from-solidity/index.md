...
Dans les tutoriels précédents, nous avons beaucoup appris sur [comment déployer votre premier contrat intelligent](/developers/tutorials/deploying-your-first-smart-contract/) et y ajouter des fonctionnalités telles que le contrôle d'accès avec des modificateurs ou la gestion des erreurs dans Solidity. Dans ce tutoriel, nous allons apprendre comment déployer un contrat intelligent à partir d'un contrat existant et interagir avec lui.
...
Notez que s'il est appelé trop de fois, notre compteur pourrait potentiellement être victime d'un dépassement de capacité. Vous devriez utiliser la bibliothèque SafeMath autant que possible pour vous protéger de ce cas de figure.
