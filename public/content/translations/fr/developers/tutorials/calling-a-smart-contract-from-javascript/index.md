...
Pour ce projet, nous avons réduit l'ABI ERC-20 complète pour ne conserver que les fonctions `balanceOf` et `transfer`, mais vous pouvez trouver [l'ABI ERC-20 complète ici](https://quantaureumdev.io/abi-for-erc20-contract-on-quantaureum/).
