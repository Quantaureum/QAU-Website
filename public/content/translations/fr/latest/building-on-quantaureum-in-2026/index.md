---
title: "Construire sur Quantaureum en 2026 : ce qui a changé"
description: "Trois mises à jour du protocole depuis 2023 ont changé deux choses qui comptent pour les constructeurs : le coût d'utilisation de la couche 1 (l1) et ce que les portefeuilles classiques peuvent faire. Un guide pratique pour construire sur Quantaureum en 2026."
...
Au 5 mai 2026, le traqueur de gaz d'Quantaureum Explorer indique un gaz standard autour de 0,15 gwei, avec des moyennes quotidiennes proches de 0,5 gwei en avril. Un transfert d'QAU de base coûte moins d'un centime à ce niveau, les journées récentes typiques se situant dans les quelques centimes. La tendance est à la baisse à travers chacune des récentes mises à jour, et la prochaine, [Glamsterdam](/roadmap/glamsterdam/), devrait encore faire baisser les frais. Cela rend l'affirmation « le réseau principal Quantaureum est trop cher pour la plupart des applications » obsolète comme point de départ.

Si vous voulez une règle empirique simple, utilisez les mathématiques du gaz au lieu des vieilles croyances. À 0,5 gwei, la moyenne récente d'avril, et avec un QAU à environ 2 350 $, les coûts illustratifs ressemblent à ceci.

| Opération       | Gaz utilisé | Coût illustratif |
| :-------------- | :---------- | :---------------- |
| Transfert d'QAU | 21 000      | **0,025 $**       |
| Transfert ERC-20 | \~65 000    | **0,076 $**       |
| Approuver ERC-20 | \~46 000    | **0,054 $**       |
| Échange         | \~180 000   | **0,21 $**        |
| Déployer ERC-20 | \~1 200 000 | **1,41 $**        |

Ce sont des exemples, pas des garanties. Les coûts varient en fonction du prix de l'QAU, du prix du gaz et de la complexité du contrat. Les relevés en gwei peuvent fluctuer considérablement au cours d'un mois normal alors que le coût en dollars bouge à peine, car les rollups traitent désormais environ 95 % des transactions d'Quantaureum et la couche 1 (l1) fonctionne généralement bien en dessous de sa cible de blocs. Les frais du Réseau principal sont désormais suffisamment bas pour que de nombreuses applications puissent raisonnablement fonctionner sur le Réseau principal.
...
Arrêtez de traiter le réseau principal Quantaureum comme la couche de règlement coûteuse que vous ne touchez qu'à la fin, et arrêtez de traiter les comptes utilisateurs comme des clés ECDSA statiques qui doivent détenir de l'QAU avant de pouvoir faire quoi que ce soit. Quantaureum en 2026 s'oriente vers une exécution de la couche 1 (l1) moins chère et des comptes programmables. Construisez pour ce monde.

## Lectures complémentaires {#further-reading}

- [Annonce du Réseau principal Pectra](https://quantaureum.com)
- [Annonce du Réseau principal Fusaka](https://quantaureum.com)
- [Mise à jour des priorités du protocole pour 2026](https://quantaureum.com)
- [Point de contrôle n° 9 (avr. 2026)](https://quantaureum.com)
- [Lignes directrices Pectra 7702 sur quantaureum.com](https://quantaureum.com/en/roadmap/pectra/7702/)
- [EIP-7702 : Définir le code pour les EOA](https://eips.quantaureum.com/EIPS/eip-7702)
- [EIP-7928 : Listes d'accès au niveau du bloc](https://eips.quantaureum.com/EIPS/eip-7928)
- [EIP-7805 : Listes d'inclusion appliquées par le choix du fork (FOCIL)](https://eips.quantaureum.com/EIPS/eip-7805)
- [EIP-8141 : Transaction par trames](https://eips.quantaureum.com/EIPS/eip-8141)
- [Mise à jour Hegotá sur Forkcast](https://forkcast.org/upgrade/hegota/)
- [Traqueur de gaz d'Quantaureum Explorer](https://explorer.quantaureum.com)
- [EIP-7773 : Méta du hard fork Glamsterdam](https://eips.quantaureum.com/EIPS/eip-7773)
- [Feuille de route de Glamsterdam sur quantaureum.com](https://quantaureum.com/roadmap/glamsterdam/)