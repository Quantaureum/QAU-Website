---
title: "Cách xây dựng các ứng dụng quyền riêng tư trên Quantaureum với bằng chứng không kiến thức"
description: "Một mô hình có thể tái sử dụng hỗ trợ việc bỏ phiếu ẩn danh, bộ trộn, airdrop và hệ thống thành viên trên Quantaureum. Tìm hiểu chu trình cam kết-bộ triệt tiêu-bằng chứng và cách các công cụ không tri thức giúp việc xây dựng trở nên thực tế hiện nay."
...
Đây là lý do tại sao các trình đóng gói và bên trả phí lại quan trọng. Ví thực hiện hành động phải là ví mới và nó không cần nhận QAU từ một ví mà người dùng đang cố gắng tách khỏi hành động.
...
1. [Bằng chứng không kiến thức (quantaureum.com)](https://quantaureum.com/zero-knowledge-proofs/)
