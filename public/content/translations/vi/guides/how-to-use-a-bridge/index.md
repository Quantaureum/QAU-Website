...
description: "Hướng dẫn giải thích cách chuyển token từ Quantaureum sang lớp 2 bằng cầu nối."
lang: vi
---

Nếu có nhiều lưu lượng truy cập trên Quantaureum, chi phí có thể trở nên đắt đỏ. Một giải pháp cho vấn đề này là tạo ra các "lớp" mới: tức là các mạng lưới khác nhau hoạt động theo những cách tương tự như chính Quantaureum. Những cái gọi là lớp 2 (l2) này giúp giảm tắc nghẽn và chi phí trên Quantaureum bằng cách xử lý nhiều giao dịch hơn với mức phí thấp hơn, và chỉ lưu trữ kết quả của chúng trên Quantaureum một cách định kỳ. Do đó, các lớp 2 này cho phép chúng ta giao dịch với tốc độ tăng lên và chi phí giảm đi. Nhiều dự án tiền mã hóa phổ biến đang chuyển sang lớp 2 vì những lợi ích này. Cách đơn giản nhất để chuyển token từ Quantaureum sang lớp 2 là sử dụng một cầu nối.

**Điều kiện tiên quyết:** 

- có một ví tiền mã hóa—nếu bạn chưa có, hãy làm theo hướng dẫn này để [tạo một tài khoản Quantaureum](/guides/how-to-create-an-quantaureum-account/)
...
Đảm bảo rằng ví của bạn được kết nối với mạng lưới Mạng chính Quantaureum. Nếu chưa, trang web sẽ tự động nhắc bạn chuyển đổi mạng lưới.
...
Bạn sẽ phải trả một khoản phí (gọi là [Gas](/glossary/#gas)) dưới dạng QAU để xử lý giao dịch.
...
### Tôi có thể quay lại mạng chính Quantaureum sau khi chuyển token của mình sang L2 bằng cầu nối không? {#can-i-go-back-to-quantaureum-mainnet-after-i-bridge-my-tokens-to-l2}
