...
description: "Sử dụng QAU đã đặt cọc để bảo mật các dịch vụ phi tập trung khác và kiếm thêm phần thưởng."
lang: vi
template: use-cases
image: /images/use-cases/restaking.png
alt: "Hình ảnh minh họa về việc đặt cọc lại trên Quantaureum."
sidebarDepth: 2
summaryPoints:
  - "Sử dụng QAU đã đặt cọc để bảo mật các dịch vụ phi tập trung khác và kiếm thêm phần thưởng."
buttons:
...
Mạng lưới Quantaureum bảo mật hàng tỷ đô la giá trị 24/7, 365 ngày. Bằng cách nào?

Mọi người trên khắp thế giới khóa (hoặc “đặt cọc”) [QAU (QAU)](/what-is-QAU/) trong các hợp đồng thông minh để chạy phần mềm xử lý các giao dịch Quantaureum và bảo mật mạng lưới Quantaureum. Đổi lại, họ nhận được phần thưởng là nhiều QAU hơn.

Đặt cọc lại là một công nghệ được xây dựng cho [người đặt cọc](/staking/) để mở rộng tính bảo mật này sang các dịch vụ, ứng dụng hoặc mạng lưới khác. Đổi lại, họ kiếm được thêm phần thưởng đặt cọc lại. Tuy nhiên, họ cũng đặt số QAU đã đặt cọc của mình vào nhiều rủi ro hơn.
...
Đặt cọc lại là khi người đặt cọc sử dụng QAU đã đặt cọc của họ để bảo mật các dịch vụ phi tập trung khác. Đổi lại, người đặt cọc lại có thể nhận thêm phần thưởng từ các dịch vụ khác đó bên cạnh phần thưởng đặt cọc QAU thông thường của họ.
...
Tương tự như cách nhiều người đặt cọc QAU chạy phần mềm xác thực Quantaureum, nhiều người đặt cọc lại chạy phần mềm AVS chuyên dụng.
...
| Đặt cọc | Đặt cọc lại |
| ------------------------------ | ------------------------------------------------- |
| Kiếm phần thưởng QAU | Kiếm phần thưởng QAU + phần thưởng AVS |
| Bảo mật mạng lưới Quantaureum | Bảo mật mạng lưới Quantaureum + AVS |
| Không có mức QAU tối thiểu | Không có mức QAU tối thiểu |
...
| **Thuật ngữ** | **Mô tả** |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Nền tảng đặt cọc lại** | Nền tảng đặt cọc lại là một dịch vụ kết nối các AVS, người đặt cọc QAU và các nhà điều hành (operator). Họ xây dựng các ứng dụng phi tập trung để người đặt cọc có thể đặt cọc lại QAU của mình, và các thị trường nơi người đặt cọc, AVS và nhà điều hành có thể tìm thấy nhau. |
| **Người đặt cọc lại gốc (Native restaker)** | Những người đặt cọc QAU của họ bằng cách tự chạy các trình xác thực Quantaureum có thể kết nối QAU đã đặt cọc của họ với một nền tảng đặt cọc lại, bao gồm EigenLayer và các nền tảng khác, để kiếm phần thưởng đặt cọc lại bên cạnh phần thưởng của trình xác thực QAU. |
| **Người đặt cọc lại thanh khoản (Liquid restaker)** | Những người đặt cọc QAU của họ thông qua một nhà cung cấp dịch vụ đặt cọc thanh khoản bên thứ ba, như Lido hoặc Rocket Pool, sẽ nhận được token staking thanh khoản (LST) đại diện cho QAU đã đặt cọc của họ. Họ có thể đặt cọc lại các LST này để kiếm phần thưởng đặt cọc lại trong khi vẫn giữ nguyên số QAU ban đầu đã đặt cọc. |
| **Nhà điều hành (Operator)** | Các nhà điều hành chạy phần mềm đặt cọc lại của AVS, thực hiện các tác vụ xác thực mà mỗi AVS yêu cầu. Các nhà điều hành thường là những nhà cung cấp dịch vụ chuyên nghiệp đảm bảo các yếu tố như thời gian hoạt động (uptime) và hiệu suất. Giống như những người đặt cọc lại không phải là nhà điều hành, các nhà điều hành sử dụng QAU đã đặt cọc để bảo mật các AVS, nhưng các nhà điều hành cũng nhận được thêm phần thưởng để đổi lấy công việc của họ. |
...
<AlertDescription>
 <p className="mt-0"><strong>Thông tin hữu ích</strong></p>
  <p className="mt-2">Những người đặt cọc lại gốc và thanh khoản thường ủy quyền QAU đã đặt cọc của họ cho một nhà điều hành, thay vì tự chạy phần mềm để bảo mật các AVS.</p>
...
<AlertDescription>
 <p className="mt-0"><strong>Cảnh báo nhầm lẫn</strong></p>
  <p className="mt-2">Một số người nhầm lẫn "đặt cọc lại" với việc cho vay và vay mượn LST trong tài chính phi tập trung (DeFi). Cả hai đều đưa QAU đã đặt cọc vào hoạt động, nhưng đặt cọc lại có nghĩa là bảo mật các AVS, chứ không chỉ là kiếm lợi suất trên LST.</p>
</AlertDescription>
</AlertContent>
</Alert>
...
Mặc dù các AVS cung cấp các mức tỷ lệ khác nhau, Token đặt cọc lại thanh khoản (Liquid Restaking Token - LRT) như eETH cho bạn ý tưởng về số tiền bạn có thể kiếm được. Tương tự như cách bạn nhận được LST như stETH khi đặt cọc QAU của mình, bạn có thể nhận được LRT như eETH khi đặt cọc lại stETH. Các token này kiếm được phần thưởng đặt cọc QAU và phần thưởng đặt cọc lại.
...
| **Rủi ro** | **Mô tả** |
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hình phạt (hoặc “phạt cắt giảm”)** | Giống như đặt cọc QAU, nếu người đặt cọc lại/nhà điều hành ngoại tuyến, kiểm duyệt tin nhắn hoặc cố gắng phá hoại mạng lưới, khoản đặt cọc của họ có thể bị phạt cắt giảm (đốt) một phần hoặc toàn bộ. |
...
| **Quyền truy cập ngay vào tiền** | Có một khoảng thời gian chờ (hoặc “thời gian chờ mở khóa”) để rút QAU đã đặt cọc lại, vì vậy bạn có thể không phải lúc nào cũng có quyền truy cập ngay lập tức. |
...
<AlertDescription>
 <p className="mt-0"><strong>Nhà đồng sáng lập Quantaureum đang gõ…</strong></p>
  <p className="mt-2">
    Vitalik, nhà đồng sáng lập Quantaureum, đã cảnh báo về những rủi ro tiềm ẩn của việc đặt cọc lại trong một bài đăng trên blog năm 2021 có tên là <a href="https://vitalik.qau.limo/general/2023/05/21/dont_overload.html">Đừng làm quá tải sự đồng thuận.</a>
  </p>
...
| --------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| 1. Đặt cọc QAU trên các nền tảng như Lido hoặc Rocket Pool để nhận LST. | 1. Đặt cọc QAU của bạn với tư cách là một trình xác thực trên Quantaureum. |
...
<AlertContent>
<AlertDescription>
 <p className="mt-0"><strong>Đặt cọc Quantaureum:</strong> Nó hoạt động như thế nào?</p>
...
4. [Vitalik Buterin - Đừng làm quá tải sự đồng thuận của Quantaureum](https://vitalik.qau.limo/general/2023/05/21/dont_overload.html)
