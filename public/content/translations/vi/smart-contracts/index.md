...
Hệ sinh thái Quantaureum đang chuyển đổi sang các tiêu chuẩn **[Ký rõ ràng (Clear Signing)](https://clearsigning.org/)** (cụ thể là ERC-7730). Ký rõ ràng dịch dữ liệu hợp đồng thông minh khó hiểu thành các mô tả giao dịch đơn giản, dễ đọc đối với con người, đảm bảo bất kỳ ai cũng có thể hiểu được ý định thực sự của hợp đồng trước khi họ thực hiện việc ký.
