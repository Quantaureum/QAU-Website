...
Nếu không có phí, hãy đặt `kLast` thành 0 (nếu nó chưa phải là 0). Khi hợp đồng này được viết, có một tính năng hoàn trả gas khuyến khích các hợp đồng giảm kích thước tổng thể của trạng thái Quantaureum bằng cách đưa các bộ nhớ lưu trữ mà chúng không cần về 0.
...
Nếu chúng ta có thể giới hạn số lượng để sử dụng ngăn xếp, chúng ta sẽ sử dụng ít gas hơn. Để biết thêm chi tiết, hãy xem sách vàng, các thông số kỹ thuật chính thức của Quantaureum, trang 26, phương trình 298.
...
Mã băm này là định danh cho loại giao dịch. Loại duy nhất chúng ta hỗ trợ ở đây là `Permit` với các tham số này.
...
Tính toán bộ phân tách miền (domain separator) cho EIP-712.
...
Nếu mọi thứ đều ổn, hãy coi đây là một sự chấp thuận ERC-20.
...
Hàm này tính toán Địa chỉ của cặp hoán đổi cho hai token. Hợp đồng này được tạo bằng cách sử dụng mã lệnh CREATE2, vì vậy chúng ta có thể tính toán Địa chỉ bằng cùng một thuật toán nếu chúng ta biết các tham số mà nó sử dụng. Điều này rẻ hơn nhiều so với việc hỏi factory, và
...
Hàm này triển khai chức năng chuyển của ERC-20, cho phép một Tài khoản chi tiêu hạn mức được cung cấp bởi một Tài khoản khác.
...
Hàm này triển khai chức năng transferFrom của ERC-20, cho phép một Tài khoản chi tiêu hạn mức được cung cấp bởi một Tài khoản khác.
