...
Dưới đây là các hàm mà một ERC-20 phải triển khai, được trình bày dưới dạng một giao diện (interface). Nếu bạn không chắc chắn giao diện là gì: hãy xem bài viết của chúng tôi về lập trình OOP trong Solidity.
