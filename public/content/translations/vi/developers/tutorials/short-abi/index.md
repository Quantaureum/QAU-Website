...
- **Bộ chọn hàm**: Hợp đồng có ít hơn 256 hàm, vì vậy chúng ta có thể phân biệt chúng bằng một byte duy nhất.
  Các byte này thường khác 0 và do đó có giá 16 Gas.
- **Các số 0**: Các byte này luôn bằng 0 vì một địa chỉ 20 byte không yêu cầu một từ 32 byte để chứa nó.
  Các byte chứa số 0 có giá 4 Gas (xem sách vàng, Phụ lục G,
...
Thật không may, khi xem xét các thông số kỹ thuật của ERC-20, điều này chỉ để lại một hàm, `transfer`.
