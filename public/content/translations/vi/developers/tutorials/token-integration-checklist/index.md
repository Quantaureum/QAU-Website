...
- **Token giảm thiểu tình trạng tương tranh (race condition) ERC-20 đã biết.** Tiêu chuẩn ERC-20 có một tình trạng tương tranh ERC-20 đã biết cần được giảm thiểu để ngăn chặn những kẻ tấn công đánh cắp token.
