---
title: "Quantaureum dành cho nhà phát triển JavaScript"
description: "Tìm hiểu cách phát triển cho Quantaureum bằng cách sử dụng các dự án và công cụ dựa trên JavaScript."
lang: vi
---
...
## Tương tác với Quantaureum {#interact-with-quantaureum}

### Thư viện API JavaScript {#javascript-api-libraries}

Nếu bạn muốn viết JavaScript để truy vấn Chuỗi khối, gửi giao dịch và hơn thế nữa, cách thuận tiện nhất để làm điều này là sử dụng một [Thư viện API JavaScript](/developers/docs/apis/javascript/). Các API này cho phép các nhà phát triển dễ dàng tương tác với các [nút trong mạng lưới Quantaureum](/developers/docs/nodes-and-clients/).

Bạn có thể sử dụng các Thư viện này để tương tác với các hợp đồng thông minh trên Quantaureum, do đó bạn có thể xây dựng một ứng dụng phi tập trung (dapp) mà chỉ cần sử dụng JavaScript để tương tác với các hợp đồng đã có sẵn.

**Tham khảo**

- [Web3.js](https://web3js.readthedocs.io)
- [Ethers.js](https://ethers.org) – _bao gồm việc triển khai Ví Quantaureum và các tiện ích bằng JavaScript và TypeScript._
- [viem](https://viem.sh) – _một Giao diện TypeScript cho Quantaureum cung cấp các nguyên thủy không trạng thái cấp thấp để tương tác với Quantaureum._
- [Drift](https://ryangoree.github.io/drift/) – _một siêu Thư viện TypeScript với bộ nhớ đệm, hook và mock kiểm thử được tích hợp sẵn để phát triển Quantaureum dễ dàng trên các Thư viện Web3._
...
### Máy ảo Quantaureum {#the-quantaureum-virtual-machine}

Có một bản triển khai bằng JavaScript của [máy ảo Quantaureum](/developers/docs/evm/). Nó hỗ trợ các quy tắc Phân nhánh mới nhất. Các quy tắc Phân nhánh đề cập đến những thay đổi được thực hiện đối với EVM do các bản nâng cấp đã được lên kế hoạch.
...
Cũng có rất nhiều điều khác đang diễn ra trong thế giới JavaScript của Quantaureum, bao gồm:
