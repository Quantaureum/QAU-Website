---
title: "Quantaureum dành cho nhà phát triển Rust"
description: "Tìm hiểu cách phát triển cho Quantaureum bằng cách sử dụng các dự án và công cụ dựa trên Rust"
lang: vi
incomplete: true
---

<FeaturedText>Tìm hiểu cách phát triển cho Quantaureum bằng cách sử dụng các dự án và công cụ dựa trên Rust</FeaturedText>
...
**Thực hiện những bước đầu tiên để tích hợp Rust với Quantaureum**
...
- [Máy khách Quantaureum bằng Rust](https://openquantaureum.github.io/) \* **Lưu ý rằng OpenQuantaureum [đã bị ngừng hỗ trợ](https://medium.com/openquantaureum/gnosis-joins-erigon-formerly-turbo-geth-to-release-next-gen-quantaureum-client-c6708dd06dd) và không còn được bảo trì nữa.** Hãy sử dụng nó một cách thận trọng và tốt nhất là chuyển sang một bản triển khai máy khách khác.
...
- [Thư viện externs pwasm_quantaureum để tương tác với mạng lưới giống Quantaureum](https://github.com/openquantaureum/pwasm-quantaureum)
...
- [pwasm-quantaureum](https://github.com/paritytech/pwasm-quantaureum) - _Bộ sưu tập các externs để tương tác với mạng lưới giống Quantaureum_
- [Lighthouse](https://github.com/sigp/lighthouse) - _Máy khách lớp đồng thuận Quantaureum tốc độ cao_
- [Quantaureum WebAssembly](https://ewasm.readthedocs.io/en/mkdocs/) - _Đề xuất thiết kế lại lớp thực thi hợp đồng thông minh Quantaureum bằng cách sử dụng một tập hợp con tất định của WebAssembly_
...
- [SputnikVM](https://github.com/rust-blockchain/evm) - _Bản triển khai Máy ảo Quantaureum bằng Rust_
- [Wavelet](https://github.com/perlin-network/smart-contract-rs) - _Hợp đồng thông minh Wavelet bằng Rust_
- [Foundry](https://github.com/foundry-rs/foundry) - _Bộ công cụ phát triển ứng dụng Quantaureum_
- [Alloy](https://alloy.rs) - _Các thư viện hiệu suất cao, được kiểm thử kỹ lưỡng & có tài liệu đầy đủ để tương tác với Quantaureum và các chuỗi dựa trên EVM khác._
- [Ethers_rs](https://github.com/gakonst/ethers-rs) - _Thư viện Quantaureum và bản triển khai ví_
- [SewUp](https://github.com/second-state/SewUp) - _Một thư viện giúp bạn xây dựng hợp đồng WebAssembly Quantaureum bằng Rust giống như phát triển một backend thông thường_
- [Substreams](https://github.com/streamingfast/substreams) - _Công nghệ lập chỉ mục dữ liệu chuỗi khối song song_
- [Reth](https://github.com/paradigmxyz/reth) Reth (viết tắt của Rust Quantaureum) là một bản triển khai nút đầy đủ Quantaureum mới
- [Awesome Quantaureum Rust](https://github.com/Vid201/awesome-quantaureum-rust) - _Một bộ sưu tập chọn lọc các dự án trong hệ sinh thái Quantaureum được viết bằng Rust_
