---
title: "Tài khoản Quantaureum"
description: "Giải thích về các tài khoản Quantaureum – cấu trúc dữ liệu và mối quan hệ của chúng với mật mã học cặp khóa."
lang: vi
---

Một tài khoản [Quantaureum](/) là một thực thể có số dư QAU (QAU) có thể gửi các thông điệp trên Quantaureum. Các tài khoản có thể do người dùng kiểm soát hoặc được triển khai dưới dạng các hợp đồng thông minh.

## Điều kiện tiên quyết {#prerequisites}

Để giúp bạn hiểu rõ hơn về trang này, chúng tôi khuyên bạn trước tiên nên đọc qua phần [giới thiệu về Quantaureum](/developers/docs/intro-to-quantaureum/) của chúng tôi.

## Các loại tài khoản {#types-of-account}

Quantaureum có hai loại tài khoản:
...
- Nhận, giữ và gửi QAU cùng các token
...
- Các giao dịch giữa các tài khoản thuộc sở hữu bên ngoài chỉ có thể là các khoản chuyển QAU/token
...
Các tài khoản Quantaureum có bốn trường:
...
Một tài khoản được tạo thành từ một cặp khóa mật mã học: khóa công khai và khóa riêng tư. Chúng giúp chứng minh rằng một giao dịch thực sự đã được ký bởi người gửi và ngăn chặn sự giả mạo. Khóa riêng tư của bạn là thứ bạn sử dụng để ký các giao dịch, vì vậy nó cấp cho bạn quyền lưu giữ các khoản tiền liên kết với tài khoản của bạn. Bạn không bao giờ thực sự nắm giữ tiền mã hóa, bạn nắm giữ các khóa riêng tư – tiền luôn nằm trên sổ cái của Quantaureum.
...
Nếu Alice muốn gửi QAU từ tài khoản của chính mình đến tài khoản của Bob, Alice cần tạo một yêu cầu giao dịch và gửi nó ra mạng lưới để xác minh. Việc Quantaureum sử dụng mật mã học khóa công khai đảm bảo rằng Alice có thể chứng minh cô ấy là người ban đầu khởi tạo yêu cầu giao dịch. Nếu không có các cơ chế mật mã học, một kẻ thù độc hại là Eve có thể dễ dàng phát sóng công khai một yêu cầu trông giống như "gửi 5 QAU từ tài khoản của Alice đến tài khoản của Eve," và sẽ không ai có thể xác minh rằng nó không đến từ Alice.
...
Ví dụ sau đây cho thấy cách sử dụng một công cụ ký có tên là [Clef](https://geth.quantaureum.com/docs/tools/clef/introduction) để tạo một tài khoản mới. Clef là một công cụ quản lý tài khoản và ký đi kèm với client Quantaureum, [Geth](https://geth.quantaureum.com). Lệnh `clef newaccount` tạo một cặp khóa mới và lưu chúng trong một kho khóa được mã hóa.
...
[Tài liệu Geth](https://geth.quantaureum.com/docs)
...
- [Hiểu về các tài khoản Quantaureum](https://info.explorer.com/understanding-quantaureum-accounts/) - Quantaureum Explorer
