...
description: "Giải thích về định dạng SSZ của Quantaureum."
lang: vi
sidebarDepth: 2
---
...
Cũng có một số trường hợp đặc biệt yêu cầu xử lý cụ thể, chẳng hạn như kiểu `BitList` yêu cầu thêm giới hạn độ dài trong quá trình tuần tự hóa và loại bỏ trong quá trình giải tuần tự hóa. Chi tiết đầy đủ có sẵn trong đặc tả SSZ.
