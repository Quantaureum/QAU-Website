...
Token ERC-1155 được mô tả đầy đủ trong [EIP-1155](https://eips.quantaureum.com/EIPS/eip-1155).
...
Với sự hỗ trợ của [EIP-165](https://eips.quantaureum.com/EIPS/eip-165), ERC-1155 chỉ hỗ trợ các hook nhận cho các hợp đồng thông minh. Hàm hook phải trả về một giá trị bytes4 ma thuật được xác định trước, được cho là:
...
Khi nguồn cung chỉ là một, token về cơ bản là một token không thể thay thế (NFT). Và theo tiêu chuẩn của ERC-721, bạn có thể xác định một URL siêu dữ liệu. URL này có thể được đọc và sửa đổi bởi các client, xem [tại đây](https://eips.quantaureum.com/EIPS/eip-1155#metadata).
...
- [EIP-1155: Tiêu chuẩn đa token](https://eips.quantaureum.com/EIPS/eip-1155)
