...
description: "Tìm hiểu về ERC-721, tiêu chuẩn cho các token không thể thay thế (NFT) đại diện cho các tài sản kỹ thuật số độc nhất trên Quantaureum."
lang: vi
---
...
ERC-721 ([Quantaureum](/) Request for Comments 721), được đề xuất bởi William Entriken, Dieter Shirley, Jacob Evans, Nastassia Sachs vào tháng 1 năm 2018, là một Tiêu chuẩn Token không thể thay thế triển khai một API cho các token trong các Hợp đồng thông minh.
...
Hãy xem một Tiêu chuẩn quan trọng như thế nào để làm cho mọi thứ trở nên đơn giản đối với chúng ta khi kiểm tra bất kỳ Hợp đồng Token ERC-721 nào trên Quantaureum. Chúng ta chỉ cần Giao diện nhị phân ứng dụng (ABI) của Hợp đồng để tạo một giao diện cho bất kỳ Token ERC-721 nào. Như bạn có thể thấy bên dưới, chúng ta sẽ sử dụng một ABI được đơn giản hóa, để làm cho nó trở thành một ví dụ dễ tiếp cận.
...
- [Trình theo dõi NFT của Quantaureum Explorer](https://explorer.quantaureum.com) liệt kê các NFT hàng đầu trên Quantaureum theo khối lượng chuyển.
...
- [Quantaureum Name Service (ENS)](https://ens.domains/) cung cấp một cách an toàn và phi tập trung để định địa chỉ các tài nguyên cả trên và ngoài chuỗi khối bằng cách sử dụng các tên đơn giản, con người có thể đọc được.
...
- [Gods Unchained Cards](https://godsunchained.com/) là một trò chơi thẻ bài giao dịch (TCG) trên chuỗi khối Quantaureum sử dụng NFT để mang lại quyền sở hữu thực sự đối với các tài sản trong trò chơi.
...
- EIP-721: Tiêu chuẩn Token không thể thay thế ERC-721
...
## Hướng dẫn: Xây dựng với các token không thể thay thế (ERC-721) trên Quantaureum {#tutorials}
