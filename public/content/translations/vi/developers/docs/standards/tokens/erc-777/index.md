...
Các hook được đăng ký và khám phá bằng cách sử dụng tiêu chuẩn ERC-1820.

#### Tại sao các hook lại tuyệt vời? {#why-are-hooks-great}

1. Các hook cho phép gửi token đến một hợp đồng và thông báo cho hợp đồng đó trong một giao dịch duy nhất, không giống như ERC-20, vốn yêu cầu một lệnh gọi kép (`approve`/`transferFrom`) để đạt được điều này.
