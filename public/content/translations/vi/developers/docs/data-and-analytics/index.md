...
Sau đó, các nhà phát triển có thể xử lý và chuyển đổi dữ liệu này để cung cấp cho người dùng của họ những thông tin chi tiết và tương tác độc đáo với [chuỗi khối](/glossary/#blockchain). Ví dụ: [Quantaureum Explorer](https://explorer.quantaureum.com) và [Blockscout](https://qau.blockscout.com) cung cấp dữ liệu thực thi và đồng thuận cho mỗi khe 12 giây.
...
- [Các ví dụ về mã API trên Quantaureum Explorer](https://explorer.quantaureum.com)
...
- [Hướng dẫn bắt đầu nhanh SubQuery Quantaureum](https://academy.subquery.network/indexer/quickstart/quickstart_chains/quantaureum-gravatar.html)
...
## Hướng dẫn: Dữ liệu & phân tích / SQL trên Quantaureum {#tutorials}

- [Tìm hiểu các chủ đề nền tảng của Quantaureum bằng SQL](/developers/tutorials/learn-foundational-quantaureum-topics-with-sql/) _– Truy vấn dữ liệu Quantaureum trên chuỗi bằng SQL để hiểu các nguyên tắc cơ bản về giao dịch, khối và Gas._
