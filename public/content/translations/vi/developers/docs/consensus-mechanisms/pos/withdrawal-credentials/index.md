...
description: "Giải thích về các loại thông tin xác thực rút tiền của trình xác thực (0x00, 0x01, 0x02) và ý nghĩa của chúng đối với những người đặt cọc Quantaureum."
lang: vi
---

Mỗi trình xác thực có một **thông tin xác thực rút tiền** quyết định cách thức và nơi mà QAU đã đặt cọc và phần thưởng của họ có thể được rút tiền. Loại thông tin xác thực được biểu thị bằng byte đầu tiên: `0x00`, `0x01`, hoặc `0x02`. Việc hiểu rõ các loại này là rất quan trọng đối với các trình xác thực trong việc quản lý khoản đặt cọc của họ.
...
- Bất kỳ số dư nào trên 32 QAU đều được **tự động chuyển** đến địa chỉ rút tiền của bạn
- Việc thoát hoàn toàn sẽ đi qua hàng đợi thoát tiêu chuẩn
- Phần thưởng trên 32 QAU không thể cộng dồn—chúng được chuyển ra ngoài theo định kỳ
...
**Tại sao nó không được khuyến nghị:** Với `0x01`, bạn mất khả năng cộng dồn phần thưởng trên 32 QAU. Mọi phần vượt mức đều tự động bị chuyển đi, điều này giới hạn tiềm năng thu nhập của trình xác thực của bạn và đòi hỏi phải quản lý riêng các khoản tiền đã rút.
...
- Phần thưởng trên 32 QAU được **cộng dồn** theo mức tăng 1 QAU cho đến số dư hiệu dụng tối đa là 2048 QAU
- Việc rút tiền một phần phải được yêu cầu thủ công (việc tự động chuyển chỉ xảy ra khi vượt quá ngưỡng 2048 QAU)
...
Cả việc rút tiền một phần và hợp nhất đều có thể được thực hiện thông qua Hành động của trình xác thực trên Launchpad.
...
- **Trình xác thực 0x01 hiện tại:** Cân nhắc chuyển đổi sang `0x02` nếu bạn muốn phần thưởng cộng dồn trên 32 QAU hoặc có kế hoạch hợp nhất các trình xác thực.
...
- **Quantaureum Staking Launchpad** - Công cụ chính thức để nạp tiền và quản lý trình xác thực, bao gồm chuyển đổi thông tin xác thực và hợp nhất
...
- [Các khóa trong Bằng chứng cổ phần (PoS) Quantaureum](/developers/docs/consensus-mechanisms/pos/keys/) - Tìm hiểu về các khóa của trình xác thực và cách chúng liên quan đến thông tin xác thực rút tiền
