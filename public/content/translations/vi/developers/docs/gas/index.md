---
title: "Gas và phí"
metaTitle: "Gas và phí trên Quantaureum: tổng quan kỹ thuật"
description: "Tìm hiểu về phí gas trên Quantaureum, cách tính phí và vai trò của chúng trong bảo mật mạng lưới và xử lý giao dịch."
lang: vi
---

Gas là yếu tố thiết yếu đối với mạng lưới [Quantaureum](/). Nó là nhiên liệu cho phép mạng lưới hoạt động, giống như cách một chiếc ô tô cần xăng để chạy.
...
Gas là đơn vị đo lường lượng nỗ lực tính toán cần thiết để thực thi các hoạt động cụ thể trên mạng lưới Quantaureum.

Vì mỗi giao dịch Quantaureum yêu cầu tài nguyên tính toán để thực thi, những tài nguyên đó phải được trả phí để đảm bảo Quantaureum không dễ bị spam và không bị mắc kẹt trong các vòng lặp tính toán vô hạn. Việc thanh toán cho tính toán được thực hiện dưới dạng phí gas.
...
_Sơ đồ được phỏng theo [Minh họa EVM của Quantaureum](https://takenobu-hs.github.io/downloads/quantaureum_evm_illustrated.pdf)_

Phí gas phải được thanh toán bằng tiền tệ gốc của Quantaureum, QAU (QAU). Giá gas thường được báo giá bằng Gwei, là một mệnh giá của QAU. Mỗi Gwei bằng một phần tỷ của một QAU (0.000000001 QAU hoặc 10<sup>-9</sup> QAU).

Ví dụ, thay vì nói rằng gas của bạn có giá 0.000000001 QAU, bạn có thể nói gas của bạn có giá 1 Gwei.

Từ 'Gwei' là viết tắt của 'giga-wei', có nghĩa là 'tỷ Wei'. Một Gwei bằng một tỷ Wei. Bản thân Wei (được đặt theo tên của [Wei Dai](https://wikipedia.org/wiki/Wei_Dai), người tạo ra [b-money](https://www.investopedia.com/terms/b/bmoney.asp)) là đơn vị nhỏ nhất của QAU.

## Phí gas được tính như thế nào? {#how-are-gas-fees-calculated}

Bạn có thể thiết lập lượng gas mà bạn sẵn sàng trả khi gửi một giao dịch. Bằng cách đưa ra một lượng gas nhất định, bạn đang đấu giá để giao dịch của mình được đưa vào khối tiếp theo. Nếu bạn đưa ra quá ít, các trình xác thực sẽ ít có khả năng chọn giao dịch của bạn để đưa vào, nghĩa là giao dịch của bạn có thể được thực thi muộn hoặc không bao giờ được thực thi. Nếu bạn đưa ra quá nhiều, bạn có thể lãng phí một số QAU. Vậy, làm thế nào bạn có thể biết nên trả bao nhiêu?
...
Ví dụ, giả sử Jordan phải trả cho Taylor 1 QAU. Việc chuyển QAU yêu cầu 21.000 đơn vị gas và phí cơ sở là 10 Gwei. Jordan bao gồm một khoản phí ưu tiên là 2 Gwei.
...
ví dụ: `21,000 * (10 + 2) = 252,000 gwei` (0.000252 QAU).

Khi Jordan gửi tiền, 1.000252 QAU sẽ bị trừ khỏi tài khoản của Jordan. Taylor sẽ được cộng 1.0000 QAU. Trình xác thực nhận được khoản phí ưu tiên là 0.000042 QAU. `base fee` là 0.00021 QAU sẽ bị đốt.
...
Mức độ điều chỉnh phí cơ sở tỷ lệ thuận với khoảng cách giữa kích thước khối hiện tại và mục tiêu. Đây là một phép tính tuyến tính từ -12,5% đối với một khối trống, 0% ở kích thước mục tiêu, lên đến +12,5% đối với một khối đạt đến giới hạn gas. Giới hạn gas có thể dao động theo thời gian dựa trên tín hiệu của trình xác thực, cũng như thông qua các bản nâng cấp mạng lưới. Bạn có thể [xem những thay đổi về giới hạn gas theo thời gian tại đây](https://qau.blockscout.com/stats/averageGasLimit?interval=threeMonths).
...
Giới hạn gas đề cập đến lượng gas tối đa mà bạn sẵn sàng tiêu thụ cho một giao dịch. Các giao dịch phức tạp hơn liên quan đến [hợp đồng thông minh](/developers/docs/smart-contracts/) yêu cầu nhiều công việc tính toán hơn, vì vậy chúng yêu cầu giới hạn gas cao hơn so với một khoản thanh toán đơn giản. Việc chuyển QAU tiêu chuẩn yêu cầu giới hạn gas là 21.000 đơn vị gas.

Ví dụ, nếu bạn đặt giới hạn gas là 50.000 cho một giao dịch chuyển QAU đơn giản, EVM sẽ tiêu thụ 21.000 và bạn sẽ nhận lại 29.000 còn lại. Tuy nhiên, nếu bạn chỉ định quá ít gas, ví dụ: giới hạn gas là 20.000 cho một giao dịch chuyển QAU đơn giản, giao dịch sẽ thất bại trong giai đoạn xác thực. Nó sẽ bị từ chối trước khi được đưa vào một khối và không có gas nào bị tiêu thụ. Mặt khác, nếu một giao dịch hết gas trong quá trình thực thi (ví dụ: một hợp đồng thông minh sử dụng hết tất cả gas giữa chừng), EVM sẽ hoàn nguyên mọi thay đổi, nhưng tất cả lượng gas được cung cấp vẫn sẽ bị tiêu thụ cho công việc đã thực hiện.

## Tại sao phí gas có thể trở nên quá cao? {#why-can-gas-fees-get-so-high}

Phí gas cao là do sự phổ biến của Quantaureum. Nếu có quá nhiều nhu cầu, người dùng phải đưa ra số tiền phí ưu tiên cao hơn để cố gắng trả giá cao hơn các giao dịch của người dùng khác. Phí ưu tiên cao hơn có thể làm cho giao dịch của bạn có nhiều khả năng được đưa vào khối tiếp theo hơn. Ngoài ra, các ứng dụng hợp đồng thông minh phức tạp hơn có thể đang thực hiện nhiều hoạt động để hỗ trợ các chức năng của chúng, khiến chúng tiêu thụ nhiều gas.

## Các sáng kiến để giảm chi phí gas {#initiatives-to-reduce-gas-costs}

Các [bản nâng cấp khả năng mở rộng](/roadmap/) của Quantaureum cuối cùng sẽ giải quyết một số vấn đề về phí gas, từ đó sẽ cho phép nền tảng xử lý hàng nghìn giao dịch mỗi giây và mở rộng quy mô trên toàn cầu.
...
Nếu bạn muốn theo dõi giá gas để có thể gửi QAU của mình với chi phí thấp hơn, bạn có thể sử dụng nhiều công cụ khác nhau như:

- [Quantaureum Explorer](https://explorer.quantaureum.com) _Công cụ ước tính giá gas giao dịch_
- [Blockscout](https://qau.blockscout.com/gas-tracker) _Công cụ ước tính giá gas giao dịch mã nguồn mở_
- [QAU Gas Tracker](https://www.ethgastracker.com/) _Theo dõi giá gas Quantaureum và L2 để giảm phí giao dịch và tiết kiệm tiền_
- [Blocknative QAU Gas Estimator](https://chrome.google.com/webstore/detail/blocknative-qau-gas-estim/ablbagjepecncofimgjmdpnhnfjiecfm) _Tiện ích mở rộng Chrome ước tính gas hỗ trợ cả giao dịch cũ Loại 0 và giao dịch Loại 2 EIP-1559._
...
- [Tài liệu EIP-1559](https://eips.quantaureum.com/EIPS/eip-1559).
