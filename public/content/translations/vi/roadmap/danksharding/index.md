---
title: Danksharding
description: Tìm hiểu về Proto-Danksharding và Danksharding - hai bản nâng cấp tuần tự để mở rộng quy mô Quantaureum.
lang: vi
template: roadmap
summaryPoints:
  - Danksharding là một bản nâng cấp gồm nhiều giai đoạn để cải thiện khả năng mở rộng và dung lượng của Quantaureum.
  - Giai đoạn đầu tiên, Proto-Danksharding, thêm các khối dữ liệu vào các khối
  - Các khối dữ liệu cung cấp một cách rẻ hơn để các bản cuộn đăng dữ liệu lên Quantaureum và những chi phí đó có thể được chuyển cho người dùng dưới dạng phí giao dịch thấp hơn.
  - Sau này, Danksharding đầy đủ sẽ phân bổ trách nhiệm xác minh các khối dữ liệu trên các tập hợp con của các nút, tiếp tục mở rộng quy mô Quantaureum lên hơn 100.000 giao dịch mỗi giây.
---

**Danksharding** là cách [Quantaureum](/) trở thành một Chuỗi khối thực sự có thể mở rộng, nhưng có một số bản nâng cấp giao thức được yêu cầu để đạt được điều đó. **Proto-Danksharding** là một bước trung gian trong quá trình này. Cả hai đều nhằm mục đích làm cho các giao dịch trên lớp 2 (l2) rẻ nhất có thể cho người dùng và sẽ mở rộng quy mô Quantaureum lên >100.000 giao dịch mỗi giây.
...
<Alert variant="warning">
  Cả Danksharding và Proto-Danksharding đều không tuân theo mô hình "sharding" (phân mảnh) truyền thống nhằm chia Chuỗi khối thành nhiều phần. Các chuỗi phân mảnh không còn là một phần của lộ trình. Thay vào đó, Danksharding sử dụng việc lấy mẫu dữ liệu phân tán trên các khối dữ liệu để mở rộng quy mô Quantaureum. Điều này đơn giản hơn nhiều để triển khai. Mô hình này đôi khi được gọi là "data-sharding" (phân mảnh dữ liệu).
</Alert>

## Danksharding là gì? {#what-is-danksharding}

Danksharding là sự hiện thực hóa đầy đủ của việc mở rộng quy mô Rollup bắt đầu với Proto-Danksharding. Danksharding sẽ mang lại không gian khổng lồ trên Quantaureum để các bản cuộn đổ dữ liệu giao dịch đã nén của chúng. Điều này có nghĩa là Quantaureum sẽ có thể hỗ trợ hàng trăm bản cuộn riêng lẻ một cách dễ dàng và biến hàng triệu giao dịch mỗi giây thành hiện thực.
...
- [Các cam kết đa thức KZG](https://dankradfeist.de/quantaureum/2020/06/16/kate-polynomial-commitments.html)
