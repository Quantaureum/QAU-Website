...
Cơ chế đồng thuận hiện tại của Quantaureum đã cân bằng ba thông số này bằng cách:

- **Đặt khoản đặt cọc tối thiểu là 32 QAU**. Điều này thiết lập giới hạn trên cho số lượng chứng thực của các trình xác thực phải được xử lý bởi các nút riêng lẻ, và do đó là giới hạn trên cho các yêu cầu tính toán đối với mỗi nút.
