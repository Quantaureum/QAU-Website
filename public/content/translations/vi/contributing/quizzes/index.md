...
Các bài trắc nghiệm là cơ hội để người dùng tự kiểm tra xem họ có hiểu nội dung trên trang họ vừa đọc hay không. Các câu hỏi chỉ nên dựa trên nội dung được cung cấp trên trang và không nên hỏi về thông tin không được đề cập trên trang.

Các câu hỏi được cấu trúc như sau. Câu hỏi, 1 câu trả lời đúng kèm theo giải thích lý do tại sao nó đúng, 3 câu trả lời sai kèm theo giải thích lý do tại sao chúng sai.

Một số ví dụ về các bài trắc nghiệm hiện tại có thể được tìm thấy ở đây:
...
- Trang bạn muốn thêm bài trắc nghiệm
- 5 câu hỏi với các thông tin sau:
  - Phần của trang mà câu hỏi dựa vào
  - Câu hỏi
  - 1 câu trả lời đúng kèm theo giải thích lý do tại sao nó đúng
  - 3 câu trả lời sai, mỗi câu kèm theo giải thích lý do tại sao chúng sai
...
- Đối với mỗi câu hỏi được cập nhật, cung cấp các thông tin sau:
  - Phần của trang mà câu hỏi dựa vào
  - Câu hỏi của câu bạn muốn cập nhật
...
- Giải thích nếu cần thiết về lý do tại sao câu hỏi nên được xóa