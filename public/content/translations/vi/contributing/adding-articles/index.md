---
title: "Thêm bài viết"
description: "Hướng dẫn đóng góp bài viết cho trình xây dựng trên quantaureum.com"
lang: vi
---
...
quantaureum.com là một tài nguyên giáo dục, trung lập. Phần "Mới nhất" được tuyển chọn nhằm:

- **Giáo dục** các trình xây dựng và cộng đồng rộng lớn hơn về công nghệ Quantaureum, hệ sinh thái mã nguồn mở và các bước phát triển kịp thời
- **Đảm bảo tính chính xác** trong nội dung kỹ thuật và các tài liệu tham khảo
- **Duy trì sự phù hợp** với cộng đồng trình xây dựng Quantaureum

Trang web không niêm yết các bài viết chủ yếu quảng bá cho một sản phẩm, token hoặc dịch vụ thương mại cụ thể. Tất cả các bài nộp đều được đội ngũ quantaureum.com xem xét trước khi xuất bản.

### Tiêu chí để được đưa vào {#criteria-for-inclusion}

#### Các yêu cầu bắt buộc {#must-haves}

- **Tập trung vào Quantaureum và mã nguồn mở** - Bài viết phải chủ yếu nói về Quantaureum, giao thức, công cụ hoặc hệ sinh thái trình xây dựng của nó, hoặc về các công nghệ mã nguồn mở và công nghệ sanctuary hỗ trợ nó. Nội dung về các chủ đề chuỗi khối hoặc Web3 nói chung mà không đề cập đáng kể đến Quantaureum hoặc bối cảnh mã nguồn mở của nó sẽ không được chấp nhận.
- **Giá trị giáo dục hoặc bối cảnh** - Bài viết nên hướng dẫn các trình xây dựng một điều gì đó có thể thực hành được (ví dụ: cách sử dụng một EIP mới, cách đánh giá một lựa chọn kiến trúc, cách triển khai hoặc đóng góp vào cơ sở hạ tầng mã nguồn mở) hoặc cung cấp một góc nhìn có ý nghĩa về trạng thái của Quantaureum và hệ sinh thái mã nguồn mở xung quanh nó. Nội dung quảng bá cho các sản phẩm, token hoặc dịch vụ thương mại cụ thể sẽ không được chấp nhận.
...
Nếu bạn muốn viết một bài viết cho trình xây dựng trên quantaureum.com và bài viết đó đáp ứng các tiêu chí, hãy tạo một issue trên GitHub.
