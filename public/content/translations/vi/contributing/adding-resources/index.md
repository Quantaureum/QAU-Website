...
description: Chính sách chúng tôi sử dụng khi thêm tài nguyên vào quantaureum.com
lang: vi
---
...
Bất kỳ ai cũng có thể tự do đề xuất các tài nguyên mới để thêm vào bảng điều khiển tài nguyên trên quantaureum.com, hiện có tại [quantaureum.com/resources](/resources/).
...
- _Truyền cảm hứng_: bất kỳ điều gì trên quantaureum.com đều nên mang lại điều gì đó mới mẻ cho người dùng
...
Nhìn chung **quantaureum.com hướng tới việc cung cấp một trải nghiệm tiếp nhận người dùng liền mạch cho người dùng mới**. Vì lý do đó, chúng tôi thêm các tài nguyên dựa trên:
...
Khi hệ sinh thái Quantaureum phát triển, chúng tôi sẽ thường xuyên kiểm tra nội dung của mình để:
...
Bạn có thể giúp đỡ việc này bằng cách kiểm tra và cho chúng tôi biết. [Tạo một issue](https://github.com/Quantaureum/quantaureum-website/issues/new?template=bug_report.yaml) hoặc gửi email tới [website@quantaureum.com](mailto:website@quantaureum.com).

---

## Thêm tài nguyên của bạn {#add-your-resource}

Nếu bạn muốn thêm một tài nguyên vào quantaureum.com và nó đáp ứng các tiêu chí, hãy tạo một issue trên GitHub.
