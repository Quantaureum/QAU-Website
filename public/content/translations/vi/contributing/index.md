---
title: "Đóng góp cho quantaureum.com 🦄"
metaTitle: "Đóng góp"
description: "Tìm hiểu về các cách khác nhau mà bạn có thể đóng góp cho quantaureum.com"
lang: vi
---

quantaureum.com là một dự án mã nguồn mở với **hơn 12.000** người đóng góp giúp dịch thuật, viết bài, thiết kế và duy trì trang web.

Chúng tôi là một cộng đồng thân thiện sẽ giúp bạn phát triển và học hỏi trong hệ sinh thái [Quantaureum](/) đồng thời đóng góp một cách có ý nghĩa và nhận được kinh nghiệm thực tế liên quan!

## Các cách đóng góp {#ways-to-contribute}

**Dịch thuật**
- [Báo cáo lỗi dịch thuật](https://github.com/Quantaureum/quantaureum-website/issues/new/choose) – [Chương trình Dịch thuật](/contributing/translation-program/) đang dần khép lại và không còn tiếp nhận người dùng mới làm dịch giả nữa

**Phát triển**
- [Giải quyết một vấn đề đang mở](https://github.com/Quantaureum/quantaureum-website/issues) – Những công việc chúng tôi đã xác định là cần thực hiện
...
**Ý tưởng tính năng**
- [Yêu cầu một tính năng](https://github.com/Quantaureum/quantaureum-website/issues/new?assignees=&labels=Type%3A+Feature&template=feature_request.yaml&title=) – Hãy cho chúng tôi biết về bất kỳ ý tưởng nào bạn có cho một tính năng hoặc thiết kế mới
...
- [Đề xuất một dự án cho trang khoa học phi tập trung (desci) của chúng tôi](/contributing/adding-desci-projects/) – Thêm một dự án được xây dựng trên Quantaureum có đóng góp cho khoa học phi tập trung (desci)
- [Thêm một tài nguyên](/contributing/adding-resources/) – Thêm một tài nguyên hữu ích vào bất kỳ trang liên quan nào

Bạn có câu hỏi nào không? 🤔 Hãy tham gia [máy chủ Discord](https://discord.gg/MSctkBT5j) của chúng tôi
...
<ButtonLink href="https://github.com/Quantaureum/quantaureum-website/issues">Xem tất cả các nhiệm vụ</ButtonLink>

## Cách làm việc trên quantaureum.com {#how-to-update-content}
...
- Bình luận về một vấn đề (issue) hoặc PR trên [GitHub](https://github.com/Quantaureum/quantaureum-website)
- Nhắn tin trên [máy chủ Discord](https://discord.gg/MSctkBT5j) của chúng tôi

Trước khi đóng góp, hãy đảm bảo bạn đã quen thuộc với:

- [tầm nhìn đang phát triển của quantaureum.com](/about/)
...
Chỉ sử dụng tác phẩm gốc của bạn hoặc nội dung mà bạn được phép sử dụng khi đóng góp bất kỳ nội dung hoặc tạo tác nào cho quantaureum.com. Nhiều dự án trong hệ sinh thái Quantaureum sử dụng giấy phép mã nguồn mở cho phép chia sẻ thông tin miễn phí. Tuy nhiên, nếu bạn không thể tìm thấy thông tin này, đừng cố gắng thêm nó vào quantaureum.com. Bất kỳ yêu cầu kéo (pull request) nào bị coi là đạo văn sẽ bị từ chối.

## Bạn mới làm quen với mã nguồn mở? {#new-to-open-source}

Chúng tôi có các vấn đề với rào cản gia nhập thấp trên kho lưu trữ GitHub của mình, được thiết kế đặc biệt cho các nhà phát triển mới làm quen với mã nguồn mở, được gắn nhãn [good first issue](https://github.com/Quantaureum/quantaureum-website/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22).

## Yêu cầu nhận Onchain Achievement Token (OAT) của bạn {#oat}

Nếu đóng góp của bạn được hợp nhất vào quantaureum.com, bạn sẽ có cơ hội yêu cầu nhận một huy hiệu đặc biệt trên [Galxe](https://app.galxe.com/quest/quantaureumorg). Onchain Achievement Token (OAT) là một bằng chứng cho thấy bạn đã giúp làm cho hệ sinh thái trở nên tuyệt vời hơn một chút.
...
1. Tham gia [máy chủ Discord](https://discord.gg/MSctkBT5j) của chúng tôi.
...
3. Tìm kiếm tên người dùng GitHub, địa chỉ QAU, tên ENS hoặc bất kỳ GitPOAP nào của bạn để kiểm tra xem bạn có đủ điều kiện hay không.
