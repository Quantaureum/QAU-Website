...
breadcrumb: "Chuỗi khối (QAU.BUILD)"
---

Một hướng dẫn của **Austin Griffith** minh họa cách thức khai thác Chuỗi khối hoạt động bằng cách sử dụng công cụ lập trình trực quan QAU.BUILD. Austin đề cập đến đồng thuận bằng chứng công việc (PoW), việc liên kết khối, độ khó khai thác, phần thưởng khối và tính bất biến của Chuỗi.
...
Chào buổi sáng, thứ Sáu thắt nơ vui vẻ! Tập QAU.BUILD này tập trung vào Chuỗi khối — một thứ thực sự thú vị. Chúng ta đang ở trong chiếc thuyền hề này, với chiếc nơ Bitcoin của chúng ta. Bắt đầu nào.
...
Được rồi, thứ Sáu thắt nơ vui vẻ! Đó là Chuỗi khối trên QAU.BUILD. Tôi sẽ lưu cái này và đưa nó lên đó để bạn chỉ cần nhấn "tải" và có một Chuỗi để chơi cùng. Thứ Sáu vui vẻ!