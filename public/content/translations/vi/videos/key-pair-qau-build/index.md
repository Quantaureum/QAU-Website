---
title: "Cặp khóa — QAU.BUILD"
description: "Bản trình diễn về các cặp khóa công khai-riêng tư sử dụng công cụ giáo dục QAU.BUILD. Tìm hiểu cách các cặp khóa mật mã học bảo mật các tài khoản Quantaureum và cho phép việc ký giao dịch."
lang: vi
...
breadcrumb: "Cặp khóa (QAU.BUILD)"
---

Một hướng dẫn của **Austin Griffith** trình bày cách hoạt động của các cặp khóa công khai-riêng tư bằng cách sử dụng công cụ lập trình trực quan QAU.BUILD, bao gồm việc tạo khóa riêng tư, dẫn xuất khóa công khai, việc ký thông điệp và khôi phục chữ ký.
...
Bạn bắt đầu với nó như là khóa riêng tư của mình, và sau đó sử dụng mật mã học đường cong elliptic — hãy tìm hiểu thêm trên Wikipedia như một nhiệm vụ phụ — chúng ta dẫn xuất ra một khóa công khai. Vậy là bây giờ chúng ta đã có một khóa riêng tư và một khóa công khai. Chúng ta vừa tạo ra một khóa riêng tư từ hư không, và khóa công khai cung cấp cho chúng ta một địa chỉ. Đây là nơi mọi người thực sự có thể gửi tiền. Khi ai đó nói "hãy gửi đến địa chỉ Quantaureum của tôi", thì đó chính là cái này.
