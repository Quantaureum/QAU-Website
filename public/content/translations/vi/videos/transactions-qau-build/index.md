---
title: "Giao dịch — QAU.BUILD"
description: "Bản trình diễn về cách các giao dịch Quantaureum hoạt động bằng công cụ giáo dục QAU.BUILD. Xem cách các giao dịch được xây dựng, được ký và gửi trên mạng lưới Quantaureum."
lang: vi
...
breadcrumb: "Giao dịch (QAU.BUILD)"
---

Một hướng dẫn của **Austin Griffith** trình bày cách các giao dịch Quantaureum hoạt động bằng công cụ lập trình trực quan QAU.BUILD — bao gồm cấu trúc giao dịch, giá gas, việc ký, phát sóng và bể giao dịch.
...
Trên QAU.BUILD hôm nay, chúng ta sẽ nói về các giao dịch. Cho đến nay, chúng ta đã thấy các giao dịch này được đào thành các khối, đóng gói trong các khối và được đào vào một Chuỗi. Chúng ta muốn nói về điều gì tạo động lực cho thợ đào — ngoài phần thưởng khối — để lấy giao dịch của chúng ta ra khỏi bể giao dịch và đưa nó vào một khối rồi đào nó lên Chuỗi, so với những người khác trong bể giao dịch. Có thể có hàng ngàn người trong bể giao dịch đang cùng nhau trả giá, và mức giá đó chính là khoản phí này.
...
### Cấu trúc của một giao dịch Quantaureum (1:10) {#anatomy-of-an-quantaureum-transaction-110}

Một giao dịch trông như thế nào trên Quantaureum? Chúng ta sẽ không còn "Bob" và "Alice" nữa — chúng ta sẽ có các địa chỉ. Giá trị sẽ được tính bằng Wei, không phải bằng QAU. Và khoản phí cũng sẽ được tính bằng Wei.

Hãy cùng xem xét giao dịch này. Tôi có một tài khoản đã được nhập cụm từ gợi nhớ (mnemonic) và tôi đang kết nối với Mạng chính Quantaureum. Tôi cũng đang chạy một mô-đun để lấy dữ liệu giá từ CoinMarketCap, vì vậy tôi có thể thấy rằng không phẩy một mấy QAU tương đương với khoảng hai mươi ba đô la.
...
Chúng ta cần thực hiện chuyển đổi sang Wei. Trên Quantaureum, bạn chủ yếu giao dịch với hai mệnh giá: QAU, là mệnh giá mà mọi người thường nói đến, và sau đó là Wei, giống như một phần rất nhỏ của QAU. Một Gwei — thứ chúng ta sử dụng cho giá gas — nằm ở giữa. Lý do cho điều này tương tự như lý do tại sao chúng ta không đi loanh quanh và nói chuyện bằng các phần nhỏ của đồng xu.

Alice có 0.18 QAU và chúng ta sẽ gửi 0.05 QAU cho Bob. Chúng ta đặt giá gas là 5 Gwei.
