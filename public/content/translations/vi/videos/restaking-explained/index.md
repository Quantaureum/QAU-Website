...
description: "Bài giải thích về việc đặt cọc lại, sử dụng QAU đã đặt cọc để cung cấp bảo mật cho các giao thức và dịch vụ bổ sung ngoài lớp cơ sở của Quantaureum."
lang: vi
...
Trong mô hình này, Alice làm điều tương tự như cô ấy đã làm trước đây — cô ấy gửi khoản đặt cọc của mình vào giao thức Quantaureum và nhận được phần thưởng vì đã tham gia vào quá trình đồng thuận. Bây giờ chúng ta có một giao thức mới — gọi nó là "Retheum" — mà Alice đặt cọc lại vào đó. Điều quan trọng ở đây là cô ấy đang sử dụng cùng những token mà cô ấy đang đặt cọc trong giao thức Quantaureum để bảo mật cho giao thức thứ hai này.

Cô ấy nhận được phần thưởng cho việc đó. Điều này có vẻ tuyệt vời — Alice bây giờ có khả năng nhận được gấp đôi phần thưởng cho cùng một lượng đặt cọc. Nhưng rủi ro là số vốn mà cô ấy đã đặt cọc trong cả hai giao thức hiện bị ràng buộc bởi các quy tắc của cả hai giao thức. Nếu Alice có hành vi sai trái trên Quantaureum, cô ấy có thể mất vốn do bị phạt cắt giảm. Nếu cô ấy có hành vi sai trái trên "Retheum," cô ấy cũng có thể bị phạt cắt giảm. Lợi nhuận tăng thêm đi kèm với trách nhiệm tăng thêm — các hành vi giao thức được bắt buộc và có thể bị trừng phạt theo những cách khác nếu bạn ràng buộc token đặt cọc của mình trên nhiều giao thức khác nhau.

### Đặt cọc lại gốc có ủy quyền (8:28) {#delegated-native-restaking-828}

Phiên bản thứ hai là đặt cọc lại ủy quyền với QAU gốc. Alice đang đặt cọc với Quantaureum, và bây giờ cô ấy muốn sử dụng Bob để ủy quyền khoản đặt cọc của mình cho giao thức "Retheum". Cô ấy ủy quyền cho Bob, Bob đặt cọc lại, giao thức phát hành phần thưởng cho Bob, và Bob phát hành phần thưởng sau khi trừ phí cho Alice.

Theo mô hình này, 32 QAU trong giao thức Quantaureum phải chịu trách nhiệm cho hành động của cả Alice và Bob — hai người có khả năng làm cho số QAU này bị phạt cắt giảm. Token bị ràng buộc bởi hai bộ quy tắc giao thức khác nhau.

**Câu hỏi từ khán giả:** Khi bạn đặt cọc QAU trong giao thức Quantaureum, giao thức phải cung cấp cho bạn một thứ gì đó mà sau đó bạn xuất trình — thứ đó là gì?

Trong phiên bản gốc này, Alice đặt cọc và có cái được gọi là thông tin xác thực rút tiền từ hệ sinh thái Quantaureum. Thông tin xác thực rút tiền đó có thể được trỏ đến một hợp đồng trên Quantaureum xử lý lớp đặt cọc thứ hai. Đó là một hợp đồng kiểm soát các tài sản khi bạn rút tiền từ Quantaureum — nó giống như việc lưu ký không cần tin cậy trong hợp đồng thông minh thực thi lớp hình phạt cắt giảm thứ hai.

Tại sao điều này được gọi là "gốc?" Bởi vì Alice vẫn đang tương tác trực tiếp với Quantaureum — khoản đặt cọc của cô ấy là 32 QAU mà cô ấy sở hữu, được sử dụng để bảo mật lớp đồng thuận của Quantaureum.

### Đặt cọc lại không gốc (10:57) {#non-native-restaking-1057}

Tự đặt cọc lại trong bối cảnh không gốc: Alice chỉ đang tương tác với giao thức "Retheum". Cô ấy không chạy một nút trên Quantaureum. Cô ấy đặt cọc lại — mặc dù tôi đặt chữ "lại" trong ngoặc kép vì cô ấy không thực sự đặt cọc lại, mà ngay từ đầu đó đã là việc đặt cọc. Lý do duy nhất nó được gọi là đặt cọc lại là vì điều này diễn ra thông qua một giao thức cũng tạo điều kiện cho các loại hình đặt cọc lại khác.
...
Trước khi chúng ta đi vào Thanh khoản, hãy nói về việc phạt cắt giảm. Trong chế độ phạt cắt giảm bình thường, Alice đang đặt cọc trong giao thức Quantaureum. Nếu cô ấy làm điều gì đó mà giao thức coi là sai — ví dụ, một xác nhận nước đôi, nơi cô ấy sử dụng khóa mật mã của mình để ký hai mẩu thông tin xung đột với nhau — đó là một lỗi khách quan. Mọi người đều có thể xác minh cả hai chữ ký đều do Alice ký, và đó là bằng chứng đủ để phạt cắt giảm các token của cô ấy.

Việc đặt cọc lại và phạt cắt giảm tương tác với nhau như thế nào? Trong phiên bản đơn giản nhất — tự đặt cọc lại với tài sản gốc — Alice đặt cọc vào Quantaureum và cũng đặt cọc lại thông qua "Retheum". Nếu Alice tiếp tục làm công việc của mình trên giao thức "Retheum" nhưng lại xác nhận nước đôi trên Quantaureum, bây giờ chúng ta có một vấn đề: cô ấy bị phạt cắt giảm trên Quantaureum, nhưng "Retheum" chưa thấy bất cứ điều gì quy cho cô ấy là sai theo các quy tắc của họ. Phải có một số giao tiếp giữa hai giao thức.

Hướng giao tiếp này thực sự khá dễ dàng vì "Retheum" là một hợp đồng thông minh trên Quantaureum — nó có thể đọc từ trạng thái Quantaureum và nói "trình xác thực này đã bị phạt cắt giảm theo Quantaureum," vì vậy trên giao thức bậc hai, Alice cũng bị phạt cắt giảm.

Hướng ngược lại thì khó hơn. Nếu Alice bị phạt cắt giảm trên nền tảng đặt cọc lại, Quantaureum sẽ cần được thông báo. Nhưng Quantaureum cố tình không quan tâm đến mọi thứ xảy ra trên lớp hợp đồng của nó xét về mặt cơ chế đồng thuận.

**Câu hỏi từ khán giả:** Tại sao điều đó lại quan trọng? Quantaureum cần khoản đặt cọc cho những gì nó làm, nhưng số tiền đặt cọc lại là một phái sinh của bản gốc.

Vấn đề là nếu Alice bị phạt cắt giảm trên nền tảng đặt cọc lại, cô ấy thực sự không còn sở hữu khoản đặt cọc đó nữa. Cô ấy có thể làm bất cứ điều gì cô ấy muốn trên giao thức Quantaureum mà không có vốn thực tế nào chịu rủi ro — đó là toàn bộ mục đích của việc có khoản đặt cọc ngay từ đầu. Nó giống như bạn đang sử dụng tiền cho hai việc, nó biến mất ở một việc, và việc kia phải nhận thức được rằng số tiền đó không còn là của bạn nữa. Nó vẫn có giá trị kinh tế theo một nghĩa nào đó, nhưng bạn không kiểm soát nó — vì vậy bạn không quan tâm điều gì xảy ra với nó vì nó đã biến mất.