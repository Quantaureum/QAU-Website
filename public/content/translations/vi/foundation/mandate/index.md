...
**Những người sáng tạo ra nó nhận ra rằng kho trang bị của tự do đang thiếu hai công cụ quan trọng: khả năng tính toán tự chủ và khả năng tính toán để phối hợp ở quy mô lớn mà không vi phạm quyền tự chủ thiêng liêng của bất kỳ ai khác.**

Chỉ khi người dùng có quyền quyết định cuối cùng đối với hoạt động tính toán của chính họ - dữ liệu, tài sản, chỉ thị, danh tính, tác nhân, tổng thể kỹ thuật số thiết yếu của họ và quyền thoát khỏi bất kỳ hệ thống nào tỏ ra bất lợi cho những điều đó - thì họ mới có cơ hội trong thế giới điện tử mới mẻ này, để có thể sống theo cách họ thực sự mong muốn và xứng đáng.
...
**Mục tiêu thứ hai là mở rộng quy mô tính khả dụng được đảm bảo của quyền tự chủ cho những người dùng sẵn sàng thực thi nó một cách trực tiếp.**

**Đây là nguyên tắc cơ bản thứ hai của chúng tôi: quyền tự chủ không thể bị ngăn cản phải trở nên khả thi đối với những người lựa chọn nó, ở quy mô và dưới hình thức mà họ mong muốn, mà không vi phạm quyền tự chủ của bất kỳ ai khác.**

Chúng tôi tin rằng quyền tự chủ là tích cực, mang lại lợi ích chung (tổng dương), và quyền tự chủ ở quy mô lớn là chiến lược mang lại lợi ích chung chủ đạo.

Chúng tôi tin rằng quyền tự chủ có khả năng mở rộng quy mô một cách cạnh tranh mà không làm tổn hại đến CROPS, và việc phối hợp bảo tồn quyền tự chủ ở quy mô lớn là điều hoàn toàn khả thi.
...
<details>
<summary>GIẤY PHÉP SOURCE SEPPUKU</summary>
<div className="text-sm [&_p]:mb-2 [&_p]:mt-0">

> Bằng việc bao gồm giấy phép này, tác giả, người duy trì, người chỉnh sửa hoặc người (tái) phân phối
> ("Chủ thể") của phần mềm này PHẢI tuân thủ các cam kết sau:
>
> Luôn cung cấp miễn phí và cho phép truy cập công khai một bản sao đầy đủ và chính xác
> của mã nguồn và các tài liệu liên quan của phần mềm này, bao gồm tất cả
> các sửa đổi đối với phần mềm này do Chủ thể thực hiện.
>
> Tự kết liễu đời mình bằng kiếm nếu không tuân thủ bất kỳ
> cam kết nào trong giấy phép này, hoặc khi sửa đổi hay xóa bỏ bất kỳ phần nào của
> giấy phép này.
>
...
## IV. CÁC NGUYÊN TẮC HÀNH ĐỘNG {#iv-principles-for-action}

**Nhiệm vụ của chúng tôi dựa trên hai trụ cột, mỗi trụ cột bao gồm bốn nguyên tắc.**

**Mọi việc chúng tôi làm - công việc kỹ thuật ở cả lớp giao thức và những nơi khác, hỗ trợ cộng đồng và ra quyết định - đều phải bắt nguồn từ và đáp ứng hai trụ cột này cùng các nguyên tắc của chúng, trong đó CROPS được coi là không thể thương lượng.**

### Trụ cột Kỹ thuật {#iv-technical-pillar}

- **Khả năng chống kiểm duyệt:** Không một tác nhân nào có thể loại trừ một cách có chọn lọc việc sử dụng hợp lệ hoặc phá vỡ chức năng, bao gồm cả việc giành quyền kiểm soát lâu dài, phi cạnh tranh đối với bất kỳ cơ chế quan trọng nào.

Mọi công việc phải được thiết kế để đạt được mức độ không thể bị ngăn chặn tối đa và hoạt động mà không kết hợp các bên trung gian tập trung hoặc các công tắc ngắt (kill switch).

Bản thân việc cung cấp tính năng không thể bị ngăn chặn cũng phải có khả năng chống kiểm duyệt để tránh việc nó trở thành một trò chơi phản cạnh tranh và bóc lột, trong đó khả năng chống kiểm duyệt chỉ được cung cấp có chọn lọc cho những người tuân thủ, các tập đoàn độc quyền hoặc những người trả giá cao nhất mà không có sự cạnh tranh thích hợp.

Khả năng chống kiểm duyệt cũng bao gồm khả năng chống lại các áp lực phi kỹ thuật bằng kỹ thuật, chẳng hạn như các chuẩn mực xã hội hoặc hạn chế pháp lý. Giao thức dựa vào các đảm bảo mật mã học cho khả năng phục hồi và tính trung lập của nó, chứ không phải dựa trên các mối quan tâm nhất thời của bối cảnh chính trị. Công việc của chúng tôi phải bảo vệ giao thức khỏi những nỗ lực thay thế các thuộc tính vật lý cơ bản bằng các cơ chế ngắn hạn, dễ vỡ để cố gắng đạt được điều tương tự.
...
Quyền riêng tư không phải là che giấu hoàn toàn mọi thứ. Nó là về sự tự do và sự đồng thuận thực sự: được chọn thông tin nào để tiết lộ cho ai, theo các điều kiện của riêng mình. Trong cuộc sống hàng ngày, chúng ta thường tiết lộ thông tin, hoặc chứng minh các tuyên bố về bản thân, để tham gia cùng người khác, hoặc để xây dựng các mối quan hệ dựa trên sự tin tưởng, một cách dần dần.

Tuy nhiên, chúng tôi tin rằng người dùng cuối phải luôn có thể thương lượng một cách có chọn lọc về những gì họ tiết lộ, và điều này chỉ nên được hỗ trợ trên nền tảng của một quyền riêng tư vô điều kiện, có sẵn miễn phí.

- **Bảo mật:** Mọi thứ phải thực hiện đúng những gì chúng tuyên bố, không hơn không kém.

Bảo mật là tối quan trọng. Chúng tôi ủng hộ thiết kế bảo mật nghiêm ngặt ở cả lớp giao thức và ứng dụng để ngăn ngừa tác hại cho người dùng và bảo vệ tính toàn vẹn của hệ thống. Chúng tôi đầu tư sâu vào việc thử nghiệm và xác minh, sử dụng nhiều phương pháp để chỉ định các thuộc tính mong muốn và xác nhận rằng các thiết kế đáp ứng được chúng.

Bảo mật đòi hỏi sự đơn giản, bao gồm việc giảm thiểu một cách có trách nhiệm các dòng mã và các phụ thuộc bên ngoài; một giao thức không "không cần tin cậy" nếu chỉ một số ít người có thể hiểu cách nó hoạt động và tại sao nó an toàn. Công việc phải có thể xác minh được đối với nhiều người. Các lĩnh vực hoàn toàn mới đối với giao thức phải vượt qua một ngưỡng cần thiết cực kỳ cao, và thực hiện điều đó một cách rõ ràng.

Bảo mật cũng có nghĩa là giảm thiểu Quản trị; không một lớp xã hội nào được phép dễ dàng gạt bỏ các đảm bảo của giao thức.

Bảo mật ngoài ra còn có nghĩa là vượt qua bài kiểm tra "walkaway" (khả năng tự vận hành khi bị bỏ lại), không chỉ đối với giao thức mà còn đối với người dùng: quyền tự chủ có nghĩa là người dùng không nên bị ép buộc vào các cuộc di chuyển phức tạp, thường xuyên gây ra những rủi ro ngoài ý muốn.

Bảo mật thực sự bảo vệ cả hệ thống và người dùng khỏi sự cố kỹ thuật, cạm bẫy xã hội và sự ép buộc.
...
- **Sự liên kết có nguyên tắc:** Nguyên tắc đầu tiên của chúng tôi là chúng tôi làm việc có nguyên tắc.

Chúng tôi tập trung vào công việc thể hiện các nguyên tắc của mình chứ không phải công việc cho phép thâu tóm tư nhân hoặc bóc lột người dùng phi cạnh tranh.

Chúng tôi coi trọng chất lượng của khả năng phục hồi duy trì nguyên tắc hơn là số lượng người dùng hoặc việc tối ưu hóa giá trị của thiết kế.

Một tỷ người dùng trong một hệ thống khép kín tập trung không phải là một thành công; thiết kế xoay quanh việc tích hợp sâu các đường ống bóc lột tập trung vào giao thức không phải là một thành công; đó là một sự thất bại của sứ mệnh.

- **Kỷ luật:** Chúng tôi quan tâm đến việc làm đúng và làm tốt.

Chúng tôi tìm kiếm chân lý và cái đẹp trong công việc của mình. Chúng tôi đòi hỏi sự nghiêm ngặt về kỹ thuật, sự xuất sắc và tính sáng tạo.

Chúng tôi chọn thời điểm thích hợp thay vì đi nhanh hay đi chậm, điều này có thể bao gồm cả việc không hành động gì cả. Chúng tôi chia sẻ nghiên cứu và kết quả một cách nhanh chóng; chúng tôi đảm bảo những gì chúng tôi phát hành có độ tin cậy cực kỳ quan trọng đối với sứ mệnh.

Chúng tôi rèn luyện lòng can đảm để đưa ra những quyết định khó khăn, có thể không được ưa chuộng, dựa trên những đánh giá có nguyên tắc thay vì áp lực thị trường hay sự thoải mái của tổ chức. Chúng tôi chấp nhận rằng việc từ chối và cải cách các mặc định đã bị thỏa hiệp là một phần công việc của chúng tôi. Chúng tôi bảo vệ các quyết định của mình bằng sự kiên nhẫn và tính trung thực.

Chúng tôi cũng thừa nhận khi chúng tôi làm sai - đặc biệt là những điều lớn lao - với sự khiêm tốn, nhã nhặn, cùng một lời giải thích trung thực và rõ ràng về lý do tại sao quan điểm của chúng tôi thay đổi và quan điểm mới của chúng tôi là gì.

Chúng tôi kết hợp các tiêu chuẩn cao với sự tử tế: các hệ thống có khả năng phục hồi được xây dựng bởi những người có thể bất đồng quan điểm một cách rõ ràng mà không tàn nhẫn và những người có thể giữ được sự tò mò khi chịu áp lực.

- **Sự liên kết đúng đắn:** Việc chúng tôi làm việc với ai bản thân nó đã là một sự lựa chọn có nguyên tắc.

Chúng tôi ưu tiên làm việc với các cá nhân và nhóm chia sẻ các nguyên tắc của chúng tôi, lan truyền chúng và làm cho công việc của họ trở nên rõ ràng thông qua tài liệu toàn diện và mở ngay cả trong những điều kiện đầy thách thức.

Đối với các dự án phụ thuộc vào sự hỗ trợ từ Tổ chức, chúng tôi ưu tiên làm việc chặt chẽ hơn với những người cũng đang tích cực làm việc để đạt được sự độc lập khỏi chúng tôi.
...
Chúng tôi nhớ rằng chúng tôi không yêu cầu họ phải tuân thủ về mặt thẩm mỹ, mà chỉ cần sự liên kết có nguyên tắc: khi mọi người chia sẻ bản năng giữ cho các hệ thống có khả năng phân nhánh, chống kiểm duyệt, riêng tư và bảo mật, chúng tôi coi họ là những người bạn đồng hành trên con đường và là những người cùng quản lý khu vườn vô tận.

Liên minh lỏng lẻo của chúng ta không cần phải được gắn kết lại với nhau. Nó vốn đã gắn kết rồi.

## V. THỰC HIỆN CÔNG VIỆC {#v-carrying-out-the-work}

### Phương pháp tiếp cận {#v-approach}
...
- **Quy tắc Chỉ-EF (Only-EF):** Chúng tôi tập trung vào các nhiệm vụ quan trọng không có nơi tiếp nhận tự nhiên nào khác và không có tác nhân nào khác trong hệ sinh thái có thể hoặc sẽ đảm nhận một cách đáng tin cậy. Điều này bao gồm nhưng không giới hạn ở: nâng cấp Giao thức cốt lõi và nghiên cứu dài hạn, các thông số kỹ thuật và thử nghiệm đa ứng dụng khách (multi-client) trung lập, công việc bảo mật vì lợi ích công cộng, điều phối khủng hoảng, ngăn chặn các điểm nghẽn, cũng như công cụ và tài liệu dành cho nhà phát triển cốt lõi khi không có chủ sở hữu bền vững nào tồn tại. Chúng tôi luôn kiểm tra để đảm bảo rằng những nhiệm vụ này thực sự quan trọng.

- **Chuyển giao vì sự trưởng thành của hệ sinh thái:** Ngay khi một chức năng hoặc vai trò có thể được quản lý thành công bởi một tác nhân cộng đồng có cùng chí hướng, chúng tôi sẽ tạo điều kiện cho quá trình chuyển giao đó, để năng lực và trách nhiệm lan tỏa khắp hệ sinh thái của chúng ta thay vì tập trung ở một nơi.

- **Cảm hứng độc lập và độ tin cậy:** Chúng tôi làm việc trên nhiều lĩnh vực khác nhau thay vì theo một hệ thống phân cấp hẹp - chất keo kết nối chúng tôi là sứ mệnh, chứ không phải cấu trúc của chúng tôi. Chúng tôi tuyển dụng những cá nhân gắn bó sâu sắc với sứ mệnh. Chúng tôi đánh giá cao những cá nhân hoạt động với tính chính trực và sự linh hoạt cao, vì theo kinh nghiệm của chúng tôi, họ là những người làm việc hiệu quả nhất trong các điều kiện thay đổi nhanh chóng và đáng tin cậy nhất trong những lúc không chắc chắn.
...
- **Chúng tôi KHÔNG PHẢI là Người tạo ra Vua (Kingmaker):** Chúng tôi hỗ trợ các cơ chế và thiết kế phù hợp với nhiệm vụ và các nguyên tắc cốt lõi của chúng tôi, chứ không phải các thương hiệu hay công ty tư nhân cụ thể. Chúng tôi không hỗ trợ cũng như không thực thi các tiêu chuẩn làm tổn hại đến các nguyên tắc và mục tiêu của chúng tôi.
...
- **Chúng tôi KHÔNG PHẢI là Sếp:** Chúng tôi không thể ép buộc các đợt hard fork hay các thay đổi Giao thức. Chúng tôi chỉ đưa ra ý kiến nhằm ủng hộ và đề xuất những gì tốt nhất cho sứ mệnh.
...
Ưu tiên của chúng tôi, và là con đường mặc định cho các quyết định, phù hợp với nhiệm vụ của chúng tôi và Quy tắc Chỉ-EF, là phương pháp tiếp cận gốc của CROPS. **Sự tuân thủ CROPS là một lực lượng kép:** nó tạo ra các công cụ quyền tự chủ có thể sử dụng được và các lối thoát hiểm, đồng thời thiết lập những tiền lệ bền vững mà những người khác có thể làm theo sau này. Chúng tôi coi trọng các cải tiến về khả năng sử dụng và hiệu suất giúp cho việc lựa chọn chủ quyền trở nên dễ dàng hơn, miễn là chúng không đưa ra các điểm đòn bẩy mới đối với người dùng hoặc tạo ra sự phụ thuộc.
...
> **卷十四 Quyển 14**
>
> 52. 备城门 Củng cố Cổng thành
> 53. 备高临 Phòng thủ chống lại Cuộc tấn công từ trên cao
> 54. 备梯 Phòng thủ chống lại Cuộc tấn công bằng thang
> 55. 备水 Chuẩn bị chống ngập lụt
> 56. 备突 Chuẩn bị chống lại Cuộc đột kích
> 57. 备穴 Chuẩn bị chống đào hầm
> 58. 备蛾傅 Phòng thủ chống lại Chiến thuật biển người (Ant-Rush)
>
> **卷十五 Quyển 15**
>
> 68. 迎敌祠 Tế lễ chống lại Sự xuất hiện của Kẻ thù
> 69. 旗帜 Cờ và Cờ đuôi nheo
> 70. 号令 Mệnh lệnh và Chỉ thị
> 71. 杂守 Các biện pháp Phòng thủ Hỗn hợp

Một điểm khác biệt lớn giữa Mặc gia và chúng tôi là họ cũng trực tiếp can thiệp vào các cuộc xung đột dựa trên phán đoán của riêng họ về việc ai đang phòng thủ và ai đang tấn công.

Phương pháp tiếp cận của chúng tôi gần giống với việc viết các cẩm nang và cung cấp chúng, chứ không can thiệp vào các cuộc xung đột cá nhân.

Chúng tôi tin rằng phi toàn trị hóa - xây dựng hướng tới một thế giới trong đó không có tổ chức, hệ thống hay trật tự đạo đức nào có sự thống trị hoàn toàn đối với bất kỳ cuộc sống cá nhân nào - là mục tiêu tốt đẹp đáng tin cậy nhất.

Khả năng chống kiểm duyệt, bảo mật và quyền riêng tư có mối quan hệ với phi toàn trị hóa giống như các bức tường thành đối với hệ thống phòng thủ tập thể thời tiền hiện đại. Mã nguồn mở đảm bảo những biện pháp bảo vệ này được phân phối rộng rãi, có thể lặp lại và có thể tùy chỉnh, thay vì trở thành lợi thế bất đối xứng của bất kỳ một nhóm nào, ngay cả một nhóm mà bất kỳ ai trong chúng ta với tư cách cá nhân có thể dành những sự đồng cảm đặc biệt.

Đội ngũ của ngày hôm nay có thể không phải là đội ngũ của ngày mai.

## VI. GIẢI QUYẾT CÁC VẤN ĐỀ NAN GIẢI {#vi-resolving-quandaries}

Trong suốt một nghìn năm tới, chúng ta và những người kế nhiệm sẽ phải đối mặt với vô số thách thức và đứng trước những lựa chọn khó khăn mà chúng ta không thể lường trước được các chi tiết cụ thể.

Nhưng lịch sử nhân loại dạy chúng ta rằng mặc dù không có hai con sông nào chảy cùng một dòng, nhưng hình dáng của những thung lũng mà chúng tạo ra lại rất quen thuộc, một khi bạn biết cách nhìn nhận.
...
**1. Khi hai con đường đáng tin cậy về mặt kỹ thuật cạnh tranh với nhau, chúng tôi chọn con đường loại bỏ các điểm đòn bẩy, chứ không phải con đường có thể được triển khai nhanh hơn.**

Một điệp khúc phổ biến từ những người xây dựng các điểm nghẽn tập trung vào thiết kế của họ, chẳng hạn như các kiến trúc tin cậy cố hữu, là họ làm như vậy vì sự cần thiết, và sẽ loại bỏ chúng sau này khi mọi thứ “trưởng thành hơn”.

Nhưng kinh nghiệm của con người, cả từ phát triển phần mềm và từ lịch sử chính trị, cho chúng ta biết rằng một con đường như vậy đầy rẫy nguy hiểm, và chúng ta nên nhìn nhận những tuyên bố như vậy với sự hoài nghi.

**Do đó, hướng đi khôn ngoan hơn là ưu tiên lựa chọn hoàn toàn tuân thủ CROPS ngay từ đầu ngay cả khi nó khó khăn hơn về mặt kỹ thuật hoặc xã hội để bắt đầu và mở rộng quy mô.**

Ví dụ: một đề xuất cung cấp “trải nghiệm người dùng (UX) giao thức tốt hơn” hoặc “sự an toàn tốt hơn” cho việc truyền bá giao dịch thông qua một mạng lưới chuyển tiếp riêng tư được tuyển chọn với các đối tác tin cậy, dẫn đến khả năng tập trung hóa cơ sở hạ tầng như danh sách đen hoặc danh sách trắng dùng chung, điều mà sẽ “được phi tập trung sau này khi hệ sinh thái và giao thức đã sẵn sàng”; một đề xuất thứ hai giữ cho việc truyền bá không cần cấp phép ngay từ đầu thông qua các công cụ mạng ngang hàng (p2p) mở, với các chuyển tiếp riêng tư tùy chọn cho các giao dịch ngoại lai, và với định tuyến tự do xung quanh các lỗi có thể xác minh.

Trong điều kiện các yếu tố khác như nhau, CROPS có nghĩa là chúng tôi ủng hộ thiết kế nơi việc phát sóng có thể kiểm toán được và không phụ thuộc vào một nhóm nhỏ các bên trung gian; việc truyền bá riêng tư là tùy chọn tham gia và có thể thoát ra; và nơi người dùng có thể định tuyến vòng qua sự kiểm duyệt hoặc trích xuất một cách không cần cấp phép.

**Bài học là một giải pháp chỉ hoạt động tốt trong hôm nay là chưa đủ; nó cũng cần phải không trở thành một điểm nghẽn trong ngày mai.**

**2. Khi thiết kế hoặc đánh giá một đề xuất, chúng tôi suy nghĩ thấu đáo về các tác động bậc cao của việc triển khai vượt ra ngoài lớp hiện tại, đảm bảo rằng tác động tổng thể thúc đẩy quyền tự chủ, và tránh việc các điểm thâu tóm chỉ đơn giản bị dịch chuyển ra ngoài trọng tâm hẹp hoặc trở thành một yếu tố ngoại vi.**

Việc chỉ tập trung vào các thuộc tính của giải pháp hiện tại và để lại việc xem xét các hậu quả bậc khác của giải pháp đó cho người khác là điều dễ hiểu. Điều này không nhất thiết là do thiếu năng lực, động lực hoặc kỷ luật. Nó thường là do sự quen thuộc đơn thuần.

Tuy nhiên, trách nhiệm của chúng ta là đảm bảo rằng chúng ta thực sự suy nghĩ về những hậu quả tổng thể của bất kỳ đề xuất nào vượt ra ngoài khung tham chiếu trực tiếp của chính chúng ta. Thật vậy, việc suy nghĩ xuyên suốt các lớp có thể dẫn chúng ta đến việc loại bỏ các thuộc tính hoặc cấu trúc không mong muốn ở một cấp độ bằng cách tạo ra một giải pháp ở cấp độ khác.

Ví dụ: công việc về các khả năng của giao thức, chẳng hạn như quy mô hoặc tốc độ, có thể được thực hiện theo vô số cách. Một số thậm chí có thể “phù hợp với CROPS” theo tiêu chuẩn sử dụng các thuộc tính CROPS như một danh sách kiểm tra.

Nhưng chúng ta phải nhớ mục tiêu rộng lớn hơn của mình, đó là thúc đẩy quyền tự chủ. Một đề xuất mà theo phân tích hẹp thỏa mãn các thuộc tính CROPS, nhưng lại đưa ra một điểm nghẽn người dùng ở một lớp tương tác khác, cho dù đó là sự trung gian bắt buộc, sự trích xuất, hay một số mô hình chống lại quyền tự chủ khác, là một đề xuất phải bị từ chối. Nhưng một đề xuất làm tăng khả năng của giao thức cốt lõi với kết quả là loại bỏ các điểm nghẽn ở các lớp khác thì nên được hoan nghênh.

Có một sự cám dỗ lặp đi lặp lại là xử lý các thuộc tính CROPS một cách cô lập, và coi bất kỳ khoảng trống nào là có thể chấp nhận được miễn là chúng có thể được bù đắp ở nơi khác. Bất cứ khi nào sự cám dỗ này nảy sinh, chúng ta phải xem xét nó một cách cẩn thận. Các giao thức có thể vẫn không bị suy thoái về mặt hình thức hoặc “nguyên sơ” trong khi trên thực tế, các khả năng tích cực hoặc thiết yếu như quy mô, tốc độ, khả năng tiếp cận UX, quyền riêng tư, khả năng chống trích xuất, hoặc chức năng tài khoản lại di chuyển vào các cấu trúc hoặc dịch vụ tập trung, phụ thuộc vào trung gian, phụ thuộc vào niềm tin, có cấp phép, hoặc mờ ám.

Có một số kịch bản có thể minh họa cho sự cần thiết và giá trị của tư duy xuyên lớp.
...
Thứ tư, **các biện pháp bảo vệ giao dịch ở lớp giao thức**. Việc đưa giao dịch vào, bảo vệ chống lại các kết quả thực thi bất lợi, và thực thi công bằng nên đạt được ở lớp thấp nhất của ngăn xếp phù hợp với sự an toàn. Việc triển khai ở cấp độ giao thức sẽ giảm bớt áp lực cho người dùng trong việc tìm kiếm các đảm bảo như vậy từ các bên trung gian thông qua các đường ống giao dịch tập trung, và do đó giảm cơ hội cho sự trích xuất mang tính hệ thống.

Thứ năm, **tổng hợp các đối tượng mật mã học**. Các bên trung gian thực hiện các chức năng tổng hợp cho người dùng vì việc gửi riêng lẻ trên chuỗi các đối tượng mật mã học, ví dụ như các bằng chứng không kiến thức, thường có chi phí quá đắt đỏ. Chi phí cố định cao của việc cung cấp sự tổng hợp có nghĩa là thị trường cho dịch vụ này có khả năng mang tính độc quyền, đây là một điểm nghẽn tập trung. Do đó, nếu giao thức hỗ trợ tổng hợp theo lô và xác minh hiệu quả các đối tượng như vậy, rủi ro tập trung hóa này sẽ được loại bỏ.
...
Sự an toàn là một vấn đề quan trọng trong thời đại của chúng ta, và “các cuộc tấn công vào tâm trí” phải được xem xét nghiêm túc như các cuộc tấn công nhắm vào các thuộc tính kỹ thuật hoặc động lực cộng đồng.

Tuy nhiên, chúng tôi hướng tới các biện pháp phòng thủ mang tính trao quyền cho người dùng và do người dùng kiểm soát. Chúng tôi không ủng hộ việc các nhân vật quyền lực ra lệnh hoặc cài đặt các hạn chế đối với quyền tự quyết của người dùng dưới logic bảo vệ người dùng của họ, đặc biệt nếu người dùng chưa bao giờ chọn tham gia hoặc không thể chọn thoát ra.

Ví dụ: nhân danh sự an toàn trong một thế giới thù địch, một ví phát hành một “chế độ an toàn” được bật theo mặc định kết hợp các mẫu thiết kế tối chẳng hạn như âm thầm chặn một số hợp đồng nhất định, hướng người dùng đến các địa điểm hoặc đối tác ưa thích, và buộc sử dụng các danh sách trắng được cài đặt sẵn không thể sửa đổi; hoặc phát hành một trợ lý AI gắn cờ các hành động “rủi ro” bằng cách sử dụng một mô hình độc quyền không thể kiểm tra và âm thầm báo cáo các hành động của người dùng về máy chủ.
...
Do đó, chúng tôi làm việc để loại bỏ nhu cầu đối với các bên trung gian như vậy ở bất cứ nơi nào có thể. Nơi chúng chưa thể bị loại bỏ, chúng tôi thiết kế các giao thức làm giảm các áp lực kỹ thuật và kinh tế thúc đẩy chúng hướng tới sự thâu tóm.

**Đặc biệt, chúng tôi đảm bảo sự hiện diện của một “tùy chọn không”: đối với mọi khả năng cung cấp có một con đường qua trung gian, bất kỳ con đường không qua trung gian nào có thể đều phải được xây dựng và phải duy trì sự đáng tin cậy và dễ tiếp cận. Điều này vừa đóng vai trò như một lối thoát hiện tại cho những người dùng có thể đã bị bóc lột bởi các bên trung gian, vừa như một ràng buộc đáng tin cậy chống lại sự mở rộng của sự lạm dụng như vậy. Chúng tôi không bỏ qua bước này.**

Ví dụ: xem xét một ứng dụng nơi việc tham gia yêu cầu một số hình thức danh tính. Điều này có thể là để chống tấn công sybil hoặc các biện pháp bảo vệ chống từ chối dịch vụ, một diễn đàn trực tuyến chỉ dành cho các thành viên của một cộng đồng nhất định mới có thể viết bài, hoặc vô số lý do khác.

Một cách tiếp cận ngây thơ sẽ là lấy hình thức danh tính “chính thức” có sẵn dễ dàng nhất - chính phủ, sinh trắc học hoặc doanh nghiệp - bọc nó trong một bằng chứng không kiến thức, và tuyên bố kết quả là thân thiện với CROPS.
...
Một khi thông tin xác thực đã được cấp, việc tạo và xác minh bằng chứng phải mang tính cục bộ, có thể xác minh và không lưu ký nhất có thể, để sự tham gia liên tục không phụ thuộc vào sự phục tùng liên tục đối với một bên trung gian có đặc quyền và không thể bị thu hồi một cách tùy tiện.

Chúng ta cũng nên đảm bảo rằng có nhiều nguồn sự thật cơ bản phù hợp với mục đích cho danh tính tồn tại và có thể được sử dụng bên trong các ứng dụng thế giới thực dựa trên hệ thống. Ngăn xếp phần mềm nên giúp các triển khai dễ dàng tích hợp nhiều nguồn chứng thực độc lập, và nên biến sự đa dạng này thành con đường mặc định. Nó nên hỗ trợ các phương pháp kết hợp, cho phép nhiều tín hiệu yếu hơn - chẳng hạn như các chứng thực sơ đồ xã hội - chứ không chỉ là các chứng thực mạnh đơn lẻ, chẳng hạn như một chữ ký từ một thực thể chính thức.

Việc thiết kế một hệ thống giảm thiểu điểm nghẽn như vậy vốn dĩ khó hơn cách tiếp cận ngây thơ. Vì lý do đó, và phù hợp với quy tắc Only-EF, đó chính xác là loại công việc mà chúng tôi cân nhắc đảm nhận khi nó phục vụ cho nhiệm vụ của chúng tôi.

**Kim chỉ nam là sự phi trung gian hóa. Nơi sự trung gian có thể bị loại bỏ, chúng tôi ưu tiên loại bỏ nó. Nơi nó là không thể tránh khỏi, chúng tôi làm việc để giảm thiểu rủi ro bị thâu tóm bằng cách giữ cho các vai trò trung gian luôn mở, đa dạng, có giới hạn và có thể xác minh. Nếu một thiết kế không qua trung gian trở nên khả thi, chúng tôi đảm bảo rằng nó đáng tin cậy và dễ tiếp cận, để các bên trung gian cuối cùng chỉ là tùy chọn chứ không phải là cố hữu.**

**5. Khi quyết định ủng hộ đội ngũ nào, chúng tôi nhìn vượt ra ngoài kết quả ngắn hạn và các tín hiệu xã hội, và thay vào đó đánh giá các mô hình lựa chọn và các sở thích được bộc lộ.**

Thường thì chúng ta được trình bày những ý tưởng được bọc trong ngôn ngữ của CROPS; của quyền tự chủ; của sự tự do - nhưng khi kiểm tra kỹ hơn thì thực tế lại không như vẻ bề ngoài; lớp vỏ mỏng manh của các nguyên tắc được cho là sẽ tan rã khi xem xét. Điều này không phải lúc nào cũng là sự giả dối - thực tế, nhiều ý tưởng như vậy được đề xuất bởi những cá nhân, đội ngũ và dự án có thiện chí, tận tâm, thông qua niềm tin chân thành dù sai lệch, hoặc thông qua sự thiếu tự vấn hoặc chất vấn.

Một cách mà điều này xảy ra là thông qua việc chỉ nghĩ về “trường hợp suôn sẻ”, nơi tất cả các biến số diễn ra như kế hoạch, mà không nghĩ về “trường hợp tồi tệ” chẳng hạn như nơi các phụ thuộc của bên thứ ba (cho dù là API, mạng phân phối nội dung, hay các thứ khác) biến mất hoặc hỏng hóc - hoặc tệ hơn, nơi chính đội ngũ đó biến mất hoặc bị hack hoặc một người trong nội bộ trở nên thù địch.

Một cách khác là thông qua hiệu ứng buồng vang, hay nói cách khác, bằng chứng xã hội xếp tầng. Trong một lĩnh vực hiện tại còn nhỏ bé, các nhóm người có thiện chí thường mong muốn được hỗ trợ, đặc biệt là đối với bạn bè của họ. Các ý tưởng hình thành và được chia sẻ và thảo luận; chính xác là vì chúng ta hoạt động trong một không gian có sự gắn kết với sự phi trung gian hóa, tốc độ mà các ý tưởng lưu truyền thường đạt đến vận tốc thoát, nếu không muốn nói là lan truyền nhanh chóng. Hơn nữa, nếu các ý tưởng được khuếch đại thu hút bằng chứng xã hội và các ưu đãi - cho dù là sự công nhận hay phần thưởng - và được trình bày công khai trước khi chúng được chất vấn hoặc xem xét một cách nghiêm túc, thì việc đặt câu hỏi sau đó có thể trở nên tốn kém và vấp phải sự phản kháng.

Ví dụ: hai đội ngũ gửi các đề xuất để cải thiện UX trong một số kịch bản phức tạp liên quan đến nhiều token và giao tiếp không đồng bộ. Thoạt nhìn, cả hai đều có vẻ “phù hợp với CROPS:” đặc tả mở, lộ trình cho sự phi tập trung tiến bộ, UX đặt người dùng lên hàng đầu.

Khi xem xét, đội ngũ đầu tiên rất trau chuốt về mặt xã hội, sử dụng đúng ngôn ngữ của CROPS và được trang bị sự ủng hộ từ những người cùng ngành và các nguồn lực, nhưng thiết kế lại giữ kín một lớp trung gian “bí quyết riêng”, khởi động với một tập hợp nhỏ các nhà cung cấp trong danh sách trắng, và sử dụng các mặc định mềm để hướng luồng đi qua các con đường ưa thích.

Đội ngũ còn lại không có sự hiện diện xã hội, sự hậu thuẫn tối thiểu và cảm thấy khó khăn trong việc truyền đạt tầm nhìn của họ, nhưng lại triển khai một thị trường mở cho các bên trung gian (ví dụ: sử dụng việc đặt cọc) mà không có danh sách trắng, và coi chúng như một tạo tác tạm thời với một con đường đáng tin cậy để loại bỏ thông qua các tuyến đường do người dùng thúc đẩy và các đảm bảo trên chuỗi. Họ công bố các nghiên cứu ban đầu và các mô hình mối đe dọa, phát hành các đặc tả và tài liệu tham khảo rõ ràng và mời gọi sự phê bình, đồng thời thách thức các đội ngũ không liên kết cùng xây dựng để kết quả mặc định là cơ sở hạ tầng dùng chung chứ không phải là một con hào mang thương hiệu.

**Khi chọn người để ủng hộ, sự rõ ràng trong nhận thức là tối quan trọng. Bắt buộc phải sử dụng sự sáng suốt và phán đoán tốt: không neo vào sự trau chuốt, thông tin xác thực, hoặc các tín hiệu đồng thuận đầy thiện cảm, đặc biệt là khi bằng chứng xã hội đến trước sự thẩm định.** Thay vào đó, chúng ta phải xem xét những gì một dự án tối ưu hóa trong thực tế - những sự đánh đổi mà nó liên tục lựa chọn, về mặt kỹ thuật và xã hội.

Bất chấp ngôn ngữ CROPS, nếu khi kiểm tra kỹ hơn, công việc đưa ra các vị trí có đặc quyền - chẳng hạn như các thành phần đóng, danh sách trắng, định tuyến mặc định mềm, khả năng nâng cấp tùy ý, hoặc các tích hợp phụ thuộc nhiều - thì việc hoài nghi là đúng đắn.

Tương tự như vậy, nếu một đội ngũ liên tục lựa chọn sự kiểm soát hoặc giá trị hơn là sự phi tập trung, hoặc nếu các đối tác và những người ủng hộ họ có truyền thống đưa ra các lựa chọn chống lại quyền tự chủ, thì việc cảnh giác là đúng đắn.

**Các nguyên tắc kỹ thuật và xã hội của chúng tôi dẫn chúng tôi đến việc đặt câu hỏi liệu con đường mặc định có loại bỏ đòn bẩy theo thời gian hay tập trung nó vào một silo, và liệu các tín hiệu của sự đồng thuận có phù hợp với hành động nhất quán với CROPS dưới sự giám sát hay không.**

**Chúng tôi không yêu cầu các phiên bản đầu tiên phải hoàn chỉnh; chúng chỉ cần duy trì hoạt động. Việc xây dựng mã nguồn mở có nghĩa là một con đường thiết kế mạnh mẽ có thể được cải thiện hoặc hoàn thiện bởi các đội ngũ tiếp theo. Chúng tôi đánh giá cao các đội ngũ công bố sớm, xây dựng công khai và mời gọi sự phê bình, để các nhà xây dựng không liên kết có thể tiếp tục công việc chưa hoàn thành mà không cần phải hỏi.**

## VII. TƯƠNG LAI {#vii-the-future}

Từ lâu, mọi người đã bị ép phải tin rằng chúng ta chỉ có hai lựa chọn tồi tệ.

Một là chấp nhận rằng bản chất của cuộc chơi là giành và duy trì lợi thế; và do đó chấp nhận sự cai trị từ trên xuống, bởi những kẻ đã nắm giữ quyền lực: các thế lực vĩ mô như các quốc gia, đế chế, tập đoàn đầu sỏ, các sứ mệnh mạt thế và những hệ tư tưởng lớn lao quyết định cách con người sống, quyết định ai được hành động tự do và ai phải tuân thủ, bất chấp mong muốn của những người dưới quyền.

Hai là phản ứng lại cuộc chơi đó mà không có một mục tiêu nguyên tắc nào: phá hủy tất cả, rút lui vào sự chế nhạo hoặc thu mình lại; hoặc đào tẩu sang một thế lực vĩ mô này hay thế lực vĩ mô khác, không phải vì họ tốt hơn, mà đơn giản vì điều đó là cơ hội.
...
## VIII. LỜI KẾT {#viii-closing}

Công việc của chúng tôi không phải là thâu tóm thị trường, các tập đoàn hay các quốc gia, cũng không phải là giúp họ trục lợi hay thâu tóm.

Chúng tôi ở đây để giải phóng cá nhân khỏi sự kìm kẹp, và để củng cố quyền tự do lập hội của họ.

Chúng tôi ở đây để cung cấp cơ sở hạ tầng mang lại tiếng nói cho những hình thức hợp tác, tổ chức và cộng đồng không được công nhận trong các hệ thống phân cấp và hệ thống hiện tại.
...
Mục tiêu của chúng tôi là đảm bảo khu vườn mà chúng tôi đã trồng không chỉ tồn tại mà còn phát triển rực rỡ, không gian chung mà nó tạo ra vẫn mở và rộng lớn vô tận, và các công cụ chủ quyền được xây dựng vẫn có sẵn cho tất cả những ai muốn nắm lấy chúng, cho tất cả những ai muốn đăng nhập và chiến thắng, mãi mãi.

**Sẽ có những lúc công việc không được ai ghi nhận; hành trình sẽ gian nan; con đường sẽ cô đơn. Nhưng mọi con đường vươn tới những vì sao đều phải đi qua bóng tối.**
