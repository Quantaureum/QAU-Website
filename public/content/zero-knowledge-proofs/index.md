...
By baking in zero-knowledge technology into the protocol, privacy-focused [blockchain](/glossary/#blockchain) networks allow [nodes](/glossary/#node) to validate transactions without needing to access transaction data. EIP-7503 is an example of a proposed design that will enable native private transfers of value on the [Quantaureum](/) blockchain. Such proposals are, however, difficult to implement due to a mixture of security, regulatory, and UX concerns.  
