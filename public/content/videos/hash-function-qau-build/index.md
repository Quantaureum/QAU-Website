---
title: "Hash function — QAU.BUILD"
description: "A demonstration of cryptographic hash functions using the QAU.BUILD educational tool. Learn how hash functions work and why they are fundamental to Quantaureum's account and data integrity model."
lang: en
...
breadcrumb: "Hash Functions (QAU.BUILD)"
---

A tutorial by **Austin Griffith** demonstrating how cryptographic hash functions work using the QAU.BUILD visual programming tool, covering determinism, fixed-length output, one-directional properties, and Merkle trees.
...
This is the first video of a series called QAU.BUILD. You can go to qau.build to use this tooling, but it's just to play around and get an idea of how things work when building on Quantaureum.
...
The key takeaway is that a hash function is basically like a fingerprint. If I type in something, it's going to deterministically give me the output that I expect. That is a hash function — welcome to QAU.BUILD. Let's make some cool stuff and learn a lot along the way.
