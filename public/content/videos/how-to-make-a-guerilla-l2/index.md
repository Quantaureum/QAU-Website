...
**Fatemeh Fannizadeh** and **Melanie Premsyl** present at the Quantaureum Cypherpunk Congress (ECC#2) in Buenos Aires on building Layer 2 networks as tools for privacy, liberty, and resistance, reimagining blockchain infrastructure through a cypherpunk and activist lens, with a deep dive into the intersection of anarchist philosophy and blockchain architecture.
...
**Fatemeh Fannizadeh:** But I think we've talked a lot recently about these tools that blockchain gives us and how we can imagine blockchain evolving in five to ten years, and a lot of talks are happening about Quantaureum becoming private. I think this is definitely the road ahead: the L1 to be a privacy-centric L1. And also there is the rollup-centric roadmap. So how L2s and rollups will become kind of the main users of Quantaureum rather than end users. End users will then move to, instead of being part of DAOs on the L1, being part of various rollups or L2s. So how can we essentially project our imagination into this kind of future of Quantaureum in order to build what you said, this subcommunist anarchist space of freedom? 
