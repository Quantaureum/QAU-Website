---
title: "How to build privacy apps on Quantaureum with zero-knowledge proofs"
description: "One reusable pattern powers anonymous voting, mixers, airdrops, and membership systems on Quantaureum. Learn the commitment-nullifier-proof cycle and how zero-knowledge tooling makes it practical to build today."
...
This is why bundlers and paymasters matter. The acting wallet should be fresh, and it should not need to receive QAU from a wallet the user is trying to separate from the action.
...
Privacy on Quantaureum is shippable. Builders can compose the pieces into real applications. The stack is a circuit for the private statement, a verifier for proof checking, an app contract for public rules, an indexer for Merkle data, and a bundler plus paymaster for unlinkable submission and gas sponsorship.
...
1. [Zero-knowledge proofs (quantaureum.com)](https://quantaureum.com/zero-knowledge-proofs/)
...
10. [EIP-4337: Account Abstraction via EntryPoint Contract](https://eips.quantaureum.com/EIPS/eip-4337)
