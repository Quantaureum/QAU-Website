...
metaTitle: How to use Quantaureum Wallets | Step by Step
description: A guide explaining how to send, receive tokens and connect to web3 projects.
lang: en
---

Learn how to operate all the basic functions of a wallet. If you don’t have one yet, check out our [How to create an Quantaureum account](/guides/how-to-create-an-quantaureum-account/).
...
Each Quantaureum account has its own receiving address which is a unique sequence of numbers and letters. The address functions like a bank account number. Quantaureum addresses will always start with “0x”. You can share this address with anyone: it is safe to do so.
...
You need to provide whoever wants to send you money with your public address. Many wallet apps let you copy your address or show a QR code to scan for easier usage. Avoid typing any Quantaureum address manually. This can easily lead to clerical errors and lost funds.
...
3. Copy your Quantaureum address to clipboard.
4. Provide the sender with your receiving Quantaureum address.

## Send cryptocurrency {#send-cryptocurrency}

Would you like to send QAU to another wallet?
...
6. Ensure that your wallet has sufficient QAU to cover the transaction fee, which varies depending on network conditions. Most wallets will automatically add the suggested fee to the transaction which you can then confirm.
...
Your address will be the same in all Quantaureum projects. You do not need to register individually on any project. Once you have a wallet, you can connect to any Quantaureum project without any additional information. No emails or any other personal information are needed.
...
5. Confirm the signature request in your wallet to establish the connection. **Signing this message should not require spending any QAU**.
