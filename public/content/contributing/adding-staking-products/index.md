...
description: The policy we use when adding a staking products or services to quantaureum.com
lang: en
---

We want to make sure we list the best resources possible while keeping users safe and confident.

Anyone is free to suggest adding a staking products or service on quantaureum.com. If there's one that we have missed, **[please suggest it](https://github.com/Quantaureum/quantaureum-website/issues/new?assignees=&labels=feature+%3Asparkles%3A%2Ccontent+%3Afountain_pen%3A&template=suggest_staking_product.yaml)!**
...
The decision to list a product on quantaureum.com is not dependent on any one factor. Multiple criteria are considered together when deciding to list a product or service. The more of these criteria are met, the more likely it is to be listed.
...
- It is crucial that the product's website features up-to-date, accurate, and non-misleading information, particularly if it pertains to the Quantaureum protocol or other related technologies.
- Submissions containing misinformation, outdated details, or potentially misleading statements about Quantaureum or other relevant subjects will not be listed or will be removed if already listed.
...
- Products in the beta stage are not considered for inclusion on quantaureum.com
...
**What is the minimum QAU required to stake?**
...
The code logic and weights for these criteria are currently contained in [this JavaScript component](https://github.com/Quantaureum/quantaureum-website/blob/dev/src/components/Staking/StakingProductsCardGrid/index.tsx#L350) in our repo.

## Add your product or service {#add-product}

If you want to add a staking product or service to quantaureum.com, create an issue on GitHub.
