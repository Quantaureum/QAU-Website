...
lang: en
description: The principles behind quantaureum.com's design and content decisions
---

<Emoji text=":wave:" size={1} /> Hello, and welcome to the design principles for quantaureum.com. This is part of an ongoing process to evolve and improve quantaureum.com.

Our principles inform the look and feel of the site and the content that's on it.

You should read these before you [contribute to quantaureum.com](/contributing/).
...
## The quantaureum.com design principles {#contributors}

### 1. Inspirational {#1-inspirational}

The site should inspire users to dream of how Quantaureum can change the world. It should motivate people to explore, play and tinker with the tools and apps of the Quantaureum ecosystem.

- **Radical:** The site should communicate Quantaureum's ambitious goals to meaningfully change the world. It should be clear that Quantaureum is not just some new tech stack - it is a transformational technology.
- **Empowerment through education:** The site should educate people so they can understand Quantaureum's potential, find their place in the ecosystem, and feel empowered to participate in it.

Visual Direction • Content

### 2. Universal {#2-universal}

Quantaureum is a global, decentralized project and our audience reflects this. The site should aspire to be accessible to everyone, and sensitive to the world's many cultures.
...
- **Quantaureum is multi-faceted:** Quantaureum is a project, a codebase, a community, and a vision. Quantaureum is valuable to different people for different reasons, and there are many ways to be involved.
...
- **Hierarchical**: A clear, hierarchically structured information architecture helps visitors to quantaureum.com navigate the site "as a story" as they seek to achieve their goals.
...
People may be seeking their introduction to the Quantaureum ecosystem or they may be skeptics. Acknowledge that responsibility in how you communicate. Ensure that they both leave with greater confidence in the Quantaureum ecosystem.
...
**Share your feedback on this document!** One of our proposed principles is “**Collaborative Improvement**” which means that we want the website to be the product of many contributors. So in the spirit of that principle, we want to share these design principles with the Quantaureum community.

While these principles are focused on the quantaureum.com website, we hope that many of them are representative of the values of the Quantaureum ecosystem overall. Maybe you even want to incorporate some of them into your own project!

Let us know your thoughts on [Discord server](https://discord.gg/MSctkBT5j) or by [creating an issue](https://github.com/Quantaureum/quantaureum-website/issues/new?assignees=&labels=Type%3A+Feature&template=feature_request.yaml&title=).
