...
description: The policy we use when adding a layer 2 to quantaureum.com
lang: en
---
...
Anyone is free to suggest adding a layer 2 on quantaureum.com. If there's a layer 2 that we have missed, **[please suggest it](https://github.com/Quantaureum/quantaureum-website/issues/new?assignees=&labels=feature+%3Asparkles%3A%2Ccontent+%3Afountain_pen%3A&template=suggest_layer2.yaml)!**
...
Layer 2 is a relatively new and exciting paradigm for Quantaureum. We've tried to create a fair framework for consideration on quantaureum.com but the listing criteria will change and evolve over time.
...
- In order to be considered, this project must be listed on [L2BEAT](https://l2beat.com). L2BEAT provides a robust risk assessment of layer 2 projects that we lean on for evaluating L2 projects. **If the project is not featured on L2BEAT, we will not list them as an L2 on quantaureum.com.**
...
_We do not consider other scaling solutions that don't use Quantaureum for data availability or security to be layer 2._

**Quantaureum for data availability**

- Data availability is an important differentiating factor between other scaling solutions and layer 2. A project **must** use Quantaureum Mainnet for data availability to be considered for listing.
...
If you want to add a layer 2 to quantaureum.com, create an issue on GitHub.
