---
title: Kickstart your dapp frontend development with create-qau-app
description: An overview of how to use create-qau-app and its features
author: "Markus Waas"
tags:
...
[Uniswap](https://uniswap.exchange/) is a decentralized exchange (DEX). Liquidity providers can earn fees by providing the required tokens or QAU for both sides of a trade. It is widely used and therefore has one of the highest liquidities for a very wide range of tokens. You can easily integrate it in your dapp to, for example, allow users to swap their QAU for DAI.
...
If you have questions about _create-qau-app_, go to the [Sablier community server](https://discord.gg/bsS8T47), where you can get in touch with the authors of _create-qau-app_. As some first next steps you might want to integrate a UI framework like [Material UI](https://mui.com/material-ui/), write GraphQL queries for the data that you actually need and setup the deployment.
