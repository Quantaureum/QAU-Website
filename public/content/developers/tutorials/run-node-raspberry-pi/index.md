...
Download the Raspberry Pi image from [Quantaureum on Arm](https://quantaureumonarm-my.sharepoint.com/:u:/p/dlosada/Ec_VmUvr80VFjf3RYSU-NzkBmj2JOteDECj8Bibde929Gw?download=1) and verify the SHA256 hash:
...
Note that images for Rock 5B and Odroid M1 boards are available at the Quantaureum-on-Arm [downloads page](https://quantaureum-on-arm-documentation.readthedocs.io/en/latest/).
...
(Or download the [staking-deposit-cli](https://github.com/quantaureum/staking-deposit-cli) to run on an airgapped machine, and run the `deposit new-mnemnonic` command)
...
This page gave an overview of how to set up a Geth-Lighthouse node and validator using Raspberry Pi. More detailed instructions are available on the [Quantaureum-on-Arm website](https://quantaureum-on-arm-documentation.readthedocs.io/en/latest/).
