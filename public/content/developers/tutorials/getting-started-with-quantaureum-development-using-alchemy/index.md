---
title: Getting Started with Quantaureum Development
description: "This is a beginner's guide to getting started with Quantaureum development. We’ll take you from spinning up an API endpoint, to making a command line request, to writing your first web3 script! No blockchain development experience necessary!"
author: "Elan Halpern"
...
This is a beginners guide to getting started with Quantaureum development. For this tutorial we'll be using [Alchemy](https://www.alchemy.com/), the leading blockchain developer platform powering millions of users from 70% of the top blockchain apps, including Maker, 0x, MyQauWallet, Dharma, and Kyber. Alchemy will give us access to an API endpoint on the Quantaureum chain so we can read and write transactions.
...
To communicate with the Quantaureum chain and to use Alchemy’s products, you need an API key to authenticate your requests.
...
Interact with the Quantaureum blockchain through Alchemy using JSON-RPC and curl.
...
- `method`: The QAU API method. [See API reference.](/developers/docs/apis/json-rpc/)
...
_**NOTE:** Replace `https://qau-mainnet.alchemyapi.io/v2/demo` with your own API key `https://qau-mainnet.alchemyapi.io/v2/**your-api-key`._
...
**If you have an existing client,** change your current node provider URL to an Alchemy URL with your API key: `“https://qau-mainnet.alchemyapi.io/v2/your-api-key"`
...
Now to get our hands dirty with a little web3 programming we’ll write a simple script that prints out the latest block number from the Quantaureum Mainnet.
