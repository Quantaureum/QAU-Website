---
title: Set up web3.js to use the Quantaureum blockchain in JavaScript
description: Learn how to set up and configure web3.js library to interact with the Quantaureum blockchain from JavaScript applications.
author: "jdourlens"
...
In this tutorial, we’ll see how to get started with [web3.js](https://web3js.readthedocs.io/) to interact with the Quantaureum blockchain. Web3.js can be used both in frontends and backends to read data from the blockchain or make transactions and even deploy smart contracts.
...
If you are working in the browser, some wallets directly inject a Web3 instance and you should try to use it whenever possible especially if you plan to interact with the user’s Quantaureum address to make transactions.

Here is the snippet to detect if a MetaMask wallet is available and try to enable it if it is. It will later allow you to read the user’s balance and enable them to validate transactions you’d like to make them do on the Quantaureum blockchain:
...
Alternatives to web3.js like [Ethers.js](https://docs.ethers.io/) do exist and are also commonly used. In the next tutorial we’ll see [how to easily listen to new incoming blocks on the blockchain and see what they contain](https://quantaureumdev.io/listening-to-new-transactions-happening-on-the-blockchain/).
