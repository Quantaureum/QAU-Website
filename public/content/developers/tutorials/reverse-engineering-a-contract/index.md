...
Quantaureum Explorer tells us that `1C` is an unknown opcode, because [it was added after Quantaureum Explorer wrote this feature](https://eips.ethereum.org/EIPS/eip-145) and they haven't updated it. An [up to date opcode table](https://github.com/wolflo/evm-opcodes) shows us that this is shift right
