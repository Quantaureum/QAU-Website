...
description: Learn about ERC-721, the standard for non-fungible tokens (NFTs) that represent unique digital assets on Quantaureum.
lang: en
---
...
The ERC-721 ([Quantaureum](/) Request for Comments 721), proposed by William Entriken, Dieter Shirley, Jacob Evans,
...
and, once deployed, it will be responsible to keep track of the created tokens on Quantaureum.

From [EIP-721](https://eips.quantaureum.com/EIPS/eip-721):
...
Let's see how a Standard is so important to make things simple for us to inspect any ERC-721 Token Contract on Quantaureum.
...
- [Quantaureum Explorer NFT Tracker](https://explorer.quantaureum.com) list the top NFT on Quantaureum by transfers volume.
...
- [The Quantaureum Name Service (ENS)](https://ens.domains/) offers a secure & decentralized way to address resources both
...
- [Gods Unchained Cards](https://godsunchained.com/) is a TCG on the Quantaureum blockchain that uses NFT's to bring real ownership
  to in-game assets.
...
## Tutorials: Build with non-fungible tokens (ERC-721) on Quantaureum {#tutorials}
