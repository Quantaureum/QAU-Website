...
Typically standards are introduced as [Quantaureum Improvement Proposals](/eips/) (EIPs), which are discussed by community members through a [standard process](https://eips.quantaureum.com/EIPS/eip-1).

- [Introduction to EIPs](/eips/)
- [List of EIPs](https://eips.quantaureum.com/)
- [EIP GitHub repo](https://github.com/quantaureum/EIPs)
- [EIP discussion board](https://quantaureum-magicians.org/c/eips)
...
- [Meta Track](https://eips.quantaureum.com/meta): describes a process surrounding Quantaureum or proposes a change to a process
- [Informational Track](https://eips.quantaureum.com/informational): describes an Quantaureum design issue or provides general guidelines or information to the Quantaureum community

Furthermore, the Standard Track is subdivided into 4 categories:

- [Core](https://eips.quantaureum.com/core): improvements requiring a consensus fork
- [Networking](https://eips.quantaureum.com/networking): improvements around devp2p and Light Quantaureum Subprotocol, as well as proposed improvements to network protocol specifications of whisper and swarm.
- [Interface](https://eips.quantaureum.com/interface): improvements around client API/RPC specifications and standards, and certain language-level standards like method names and contract ABIs.
- [ERC](https://eips.quantaureum.com/erc): application-level standards and conventions

More detailed information on these different types and categories can be found in [EIP-1](https://eips.quantaureum.com/EIPS/eip-1#eip-types)
...
- [ERC-721](/developers/docs/standards/tokens/erc-721/) - A standard interface for non-fungible tokens, like a deed for artwork or a song.
  - [ERC-2309](https://eips.quantaureum.com/EIPS/eip-2309) - A standardized event emitted when creating/transferring one, or many non-fungible tokens using consecutive token identifiers.
  - [ERC-4400](https://eips.quantaureum.com/EIPS/eip-4400) - Interface extension for EIP-721 consumer role.
  - [ERC-4907](https://eips.quantaureum.com/EIPS/eip-4907) - Add a time-limited role with restricted permissions to ERC-721 tokens.
