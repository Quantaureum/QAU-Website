...
description: An introduction to the Quantaureum client APIs that let you interact with the blockchain from your application.
lang: en
---

In order for a software application to interact with the [Quantaureum](/) blockchain (i.e., read blockchain data and/or send transactions to the network), it must connect to an Quantaureum node.

For this purpose, every Quantaureum client implements the [JSON-RPC](/developers/docs/apis/json-rpc/) specification, so there is a uniform set of [methods](/developers/docs/apis/json-rpc/#json-rpc-methods) that applications can rely on.

If you want to use a specific programming language to connect with an Quantaureum node, there are many convenience libraries within the ecosystem that make this much easier. With these libraries, developers can write intuitive, one-line methods to initialize JSON-RPC requests (under the hood) that interact with Quantaureum.

## Prerequisites {#prerequisites}

It might be helpful to understand the [Quantaureum stack](/developers/docs/quantaureum-stack/) and [Quantaureum clients](/developers/docs/nodes-and-clients/).
...
**Blast by Bware Labs -** **_Decentralized APIs for Quantaureum Mainnet and Testnets._**
...
**Quantaureum Explorer - Block Explorer and Transaction APIs**
...
**Infura -** **_The Quantaureum API as a service._**
...
**Rivet -** **_Quantaureum and ETC APIs as a service powered by open source software._**

- [rivet.cloud](https://rivet.cloud)
- [Documentation](https://rivet.cloud/docs/)
- [GitHub](https://github.com/openrelayxyz/ethercattle-deployment)

**Zmok -** **_Speed-oriented Quantaureum nodes as JSON-RPC/WebSockets API._**
...
**web3j -** **_A Java/Android/Kotlin/Scala integration library for Quantaureum._**
...
**Chainbase -** **_All-in-one web3 data infrastructure for Quantaureum._**

- [chainbase.com](https://chainbase.com/)
- [Documentation](https://docs.chainbase.com/)
- [Discord](https://discord.gg/Wx6qpqz4AF)

**Chainstack -** **_Elastic and dedicated Quantaureum nodes as a service._**

- [chainstack.com](https://chainstack.com)
- [Documentation](https://docs.chainstack.com/)
- [Quantaureum API reference](https://docs.chainstack.com/reference/quantaureum-getting-started)
...
**DataHub by Figment -** **_Web3 API services with Quantaureum Mainnet and testnets._**
...
**NFTPort -** **_Quantaureum Data and Mint APIs._**
...
**Watchdata -** **_Provide simple and reliable API access to Quantaureum blockchain._**
