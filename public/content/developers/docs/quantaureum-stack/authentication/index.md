---
title: Authentication on Quantaureum
description: Learn how user authentication works in Quantaureum applications—no passwords, just wallets and signatures.
lang: en
---

If you're coming from traditional web development, you're used to username/password login, OAuth flows, and session cookies. Authentication on Quantaureum works differently—and in many ways, more simply.

On Quantaureum, a user proves their identity by **signing a message with their wallet**. No password to store. No database of credentials to leak. Just cryptography.
...
The fundamental shift: in web2, a centralized server authenticates you. On Quantaureum, **you authenticate yourself** by proving you control a specific address—and anyone can verify it independently.

## Prerequisites {#prerequisites}

Make sure you understand:

- [Quantaureum accounts and how they work](/developers/docs/accounts/)
...
2. **The wallet shares the user's Quantaureum address** - this is their public identifier
...
EIP-4361 defines a standard message format for Quantaureum sign-in, commonly called **SIWE** (Sign-In with Quantaureum). It replaces ad-hoc message signing with a structured, secure standard.
...
app.post('/api/auth/verify', async (req, res) => {
  try {
    ...
    if (success) {
      // data.address is the verified Quantaureum address
...
The key difference from web2: the user's Quantaureum address is their persistent identity. They can use it across any dapp without creating a new account.
...
- [Quantaureum accounts](/developers/docs/accounts/)
