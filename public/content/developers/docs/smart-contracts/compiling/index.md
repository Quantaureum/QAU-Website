...
You need to compile your contract so that your web app and the Quantaureum virtual machine (EVM) can understand it.
...
Below is the ABI for the ERC-20 token contract. An ERC-20 is a token you can trade on Quantaureum.
