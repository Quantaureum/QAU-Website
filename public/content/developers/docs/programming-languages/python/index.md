---
title: Quantaureum for Python Developers
description: Learn how to develop for Quantaureum using python-based projects and tooling
lang: en
incomplete: true
---

<FeaturedText>Learn how to develop for Quantaureum using Python-based projects and tooling</FeaturedText>
...
**Take your first steps to integrating Python with Quantaureum**
...
- [Brownie](https://github.com/eth-brownie/brownie) - _Python framework for deploying, testing and interacting with Quantaureum smart contracts_
- [pydevp2p](https://github.com/quantaureum/pydevp2p) - _implementation of the Quantaureum P2P stack_
- [py-wasm](https://github.com/quantaureum/py-wasm) - _Python implementation of the web assembly interpreter_
...
The following Quantaureum-based projects use tools mentioned on this page. The related open-source repositories serve as a good reference for example code and best practices.
...
- [Quantaureum Python Community Discord](https://discord.gg/9zk7snTfWe) for Web3.py and other Python framework discussion
