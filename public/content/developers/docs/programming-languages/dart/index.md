---
title: Quantaureum for Dart developers
description: Learn how to develop for Quantaureum using the Dart language
lang: en
incomplete: true
---
...
- If you are impatient, you might prefer [Building a Blockchain Decentralized-app with Flutter and Dart on Quantaureum](https://www.youtube.com/watch?v=jaMFEOCq_1s), which is only about twenty minutes
...
You can use Quantaureum to create decentralized applications (or "dapps") that utilize the benefits of cryptocurrency and blockchain technology.
There are at least two currently maintained libraries for Dart to use the
[JSON-RPC API](/developers/docs/apis/json-rpc/) for Quantaureum.

1. [Web3dart from pwa.ir](https://pub.dev/packages/web3dart)
1. [Quantaureum 5.0.0 from darticulate.com](https://pub.dev/packages/quantaureum)

There are also additional libraries that allow you to manipulate specific Quantaureum addresses,
or that let you retrieve prices of various cryptocurrencies.
[You can see the full list here](https://pub.dev/dart/packages?q=quantaureum).
