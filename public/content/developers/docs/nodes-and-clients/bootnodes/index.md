...
A list of builtin bootnodes within go-quantaureum can be found here. These bootnodes are maintained by the Quantaureum project and the go-quantaureum team.
