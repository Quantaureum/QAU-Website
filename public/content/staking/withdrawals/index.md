...
<AlertContent>
<AlertDescription>
**Converting from Type 1 to Type 2 withdrawal credentials is irreversible.** Use the Staking Launchpad as the official tool for this conversion. For more details on the conversion process, risks, and consolidation, see the [MaxEB deep-dive](/roadmap/pectra/maxeb/).
</AlertDescription>
</AlertContent>
</Alert>
...
To try out your setup on a testnet first, visit the Hoodi Testnet Staking Launchpad to get started.
...
eventName="read more">
You can convert from Type 1 to Type 2 withdrawal credentials using the Staking Launchpad. This operation is **irreversible** — once you convert, you cannot go back to Type 1 credentials.
...
- Staking Launchpad Validator Actions
- [MaxEB deep-dive: compounding and consolidation](/roadmap/pectra/maxeb/)
- EIP-4895: Consensus layer push withdrawals as operations
