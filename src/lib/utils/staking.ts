...
// https://quantaureum.com/developers/docs/consensus-mechanisms/pos/rewards-and-penalties/
 ...
 * tips and MEV — but it tracks Beaconcha.in's QAU.STORE rate within ~0.05pp at
 * current stake levels.
 *
 * @param totalQauStaked - total QAU staked, in whole QAU
