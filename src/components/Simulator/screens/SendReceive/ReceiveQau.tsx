...
import QauGlyph from "@/components/icons/qau-glyph-solid.svg"
...
import QrImage from "@/public/images/qr-code-quantaureum-org.png"
    ...
    >
      ...
      >
        <div className="relative mx-auto mb-3 w-fit bg-background p-3 md:mb-5">
          ...
          <QauGlyph className="absolute top-1/2 left-1/2 size-6 -translate-x-1/2 -translate-y-1/2 transform text-white" />
        </div>
      </NotificationPopover>
